...
import {DataUtilsService} from '../data-utils/data-utils.service';
...
export class IhmBusinessService {
  ...
  getEntryPointsInput(identifiantsConfig: string[], identifiantPersonne: string): GetEntryPointsInput {
    const rep: GetEntryPointsInput = {
      flat: true,
      contextualData: {
