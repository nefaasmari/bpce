...
declare module ClotureTeleconseillerPro {
    var app: any;
}
...
/**
 * Contrôleur de la page de tests de la directive mw-teleconseiller-pro-cloture
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureTeleconseillerPro.Controleurs {
    /**
     * Déclaration du contrôleur
     */
    class PageDevMwTeleconseillerProClotureControleur {
        private $scope;
...
/**
 * Contrôleur de la directive mw-teleconseiller-pro-cloture
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureTeleconseillerPro.Controleurs {
    /**
     * Déclaration du contrôleur
     */
    class MwTeleconseillerProClotureControleur {
        private $scope;
        private serviceAgentExtended;
        ...
        constructor($scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, caracteristiqueAbonnementService: ComposantsCommunsDeiPro.Services.Application.IAvenantCaracteristiqueAbonnementService);
        miseEnGestion: GestionGeneriqueOffres.Types.IPointEntreeFonctionMiseEnGestion;
        /**
         * Méthode appelée pour la sauvegarde de la clôture de l'abonnement Teleconseiller Pro
        ...
        /**
         * Méthode appelée pour le traitement de la sauvegarde de la clôture de l'abonnement Téléconseiller Pro
...
/**
 * Directive pour l'affichage de la page de clôture de Teleconseiller Pro
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureTeleconseillerPro.Directives {
    function mwTeleconseillerProCloture(): ng.IDirective;
}
