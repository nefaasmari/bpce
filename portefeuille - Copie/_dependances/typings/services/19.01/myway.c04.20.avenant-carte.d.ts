...
declare module AvenantCarte.Controleurs {
    ...
    class AvenantProduitServiceCarteControleur {
        ...
        protected serviceTrace: myway.c0410.commun.ServiceTrace;
        ...
        constructor($scope: IAvenantProduitServiceCarteControleurScope, serviceAgent: MyWay.Services.ServiceAgent, i18n: ComposantsCommunsCarte.Services.II18nCarteService, contratCarteRechercheService: ComposantsCommunsCarte.Services.ContratCarteRechercheService, serviceTrace: myway.c0410.commun.ServiceTrace);
        /**
