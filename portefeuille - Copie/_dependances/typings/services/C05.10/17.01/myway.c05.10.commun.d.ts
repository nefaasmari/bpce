...
declare module myway.gestionEpargne.commun {
    ...
    class ResultatCommercialService {
         ...
         * @returns {ng.IPromise<IResultat>}
         */
        modifierResultatCommercialEcheancierPEL(numeroPersonne: number, identifiantProduitService: number, montantOperation: number): ng.IPromise<IResultatCommercial>;
        /**
         * /!\ ATTENTION /!\ PEL UNIQUEMENT
         * Requête POST
         ...
         * @returns {ng.IPromise<IResultat>}
         */
        modifierResultatCommercialDureePEL(numeroPersonne: number, identifiantProduitService: number): ng.IPromise<IResultatCommercial>;
        /**
         ...
         * @returns {ng.IPromise<IResultat>}
         */
        private modifierEcheancierPEL(numeroPersonne, identifiantProduitService, montantOperation);
        /**
         * /!\ ATTENTION /!\ PEL UNIQUEMENT
         * Créer la stucture qui permet d'enregistrer la modification du résultat commercial d'un PEL dû à un changement de sa durée
         * @param {number} numeroPersonne
         * @param {number} identifiantProduitService - IDEGPS
         * @param {number} montantOperation - montant du versement initial
         * @returns {ng.IPromise<IResultat>}
         */
        private modifierDureePEL(numeroPersonne, identifiantProduitService);
    }
}
