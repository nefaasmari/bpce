...
declare module myway.gestionEpargne.commun {
    class GgoService {
         ...
         */
        miseEnGestionKo(error: MyWay.Services.Erreur, tabErreursMiseEnGestion: GestionGeneriqueOffres.Types.ErreurGestionGeneriqueOffre[], nomProduit: string): GestionGeneriqueOffres.Types.ErreurGestionGeneriqueOffre[];
        /**
...
declare module myway.gestionEpargne.commun {
    class OffreUtilService {
         ...
         */
        miseEnGestionOffreOuverture(controleur: IControleur, codeProduit: string, codeTypeProduitService: string, libelleProduit: string, contractualisationActe: Myway.Ressource.ContractualisationActe.IContractualisationActe, montantAnnuelEcheancierPEL?: number): ng.IPromise<GestionGeneriqueOffres.Types.CompteRenduMiseEnGestion>;
        /**
         ...
         * @returns void
         */
        traitementPostMiseEnGestion(controleur: IControleur, eligibleSag: boolean, montantAnnuelEcheancierPEL?: number): ng.IPromise<void>;
...
declare module myway.gestionEpargne.commun {
    ...
    class ResultatCommercialService {
         ...
         * Requête POST
         * Permet d'enregistrer un résultat commercial de l'échéancier lors de l'ouverture d'un PEL
         * @param {number} numeroPersonne
         * @param {number} identifiantProduitService - IDEGPS
         * @param {number} montantOperation - montant du versement initial
         * @returns {ng.IPromise<IResultat>}
         */
        enregistrerResultatCommercialEcheancierPEL(numeroPersonne: number, identifiantProduitService: number, montantOperation: number): ng.IPromise<IResultatCommercial>;
        /**
        ...
        /**
         * /!\ ATTENTION /!\ PEL UNIQUEMENT
         * Créer la stucture qui permet d'enregistrer un résultat commercial de l'échéancier lors de l'ouverture d'un PEL
         * @param {number} numeroPersonne
         * @param {number} identifiantProduitService - IDEGPS
         * @param {number} montantOperation - montant du versement initial
         * @returns {ng.IPromise<IResultat>}
         */
        private creerResultatCommercialEcheancierPEL(numeroPersonne, identifiantProduitService, montantOperation);
    }
}
