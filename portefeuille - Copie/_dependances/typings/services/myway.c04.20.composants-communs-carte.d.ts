...
declare module ComposantsCommunsCarte.Modeles.ContratCarte.Information {
    ...
    interface IParametres {
        ...
        /**
         * Le paramètre versionSegment permet de choisir la version du segment à utiliser.
         */
        versionSegment: string;
    }
...
declare module ComposantsCommunsCarte.Modeles.Mdec {
    interface IDonneeSauvegardeProduitService {
        libelleCarte: string;
        libellePorteur: string;
        numeroCompte: string;
        codeDuProduitCarte: number;
        codeVisuelCarte: string;
        codeGuichetInterbancaire: string;
    ...
    interface IDonneeSauvegardeProduitServiceCarte {
        numeroDeCompte?: string;
        numeroDeLOffreSouscrite?: number;
        motDePasse?: string;
        codeDuModeDEnvoiDeLaCarteAEcheance?: string;
...
declare module ComposantsCommunsCarte.Services {
    ...
    class ContratCarteInformationService {
        ...
        /**
         * Méthode de détermination de la version du segment de clôture du contrat carte.
         * @param typeDeCloture Type de clôture à effectuer
         * @param isHorsOffre Indicateur de contrat carte hors offre
         * @return La version du segment à utiliser
         */
        private getVersionSegment(typeDeCloture, isHorsOffre);
    }
}
...
declare module ComposantsCommunsCarte.Services {
    ...
    class HelperContratCarteService {
         ...
         * @response Un modèle de donnée permettant d'alimenter le web service information
         */
        buildInformationFromClotureContratCarte(data: Modeles.ClotureContratCarte.IData): Modeles.ContratCarte.Information.IInformation;
        /**
...
declare module ComposantsCommunsCarte.Services {
    ...
    class HelperGgoCarteService {
         ...
         */
        extactNumeroCompteFromMiseEnGestion(data: GestionGeneriqueOffres.Types.DonneesContextuelles, codeDuTypeDeProduitOuService: string): string;
        /**
...
declare module ComposantsCommunsCarte.Controleurs {
    ...
    class LivraisonCarteControleur {
        ...
        private i18n;
        static $inject: string[];
        constructor($scope: ILivraisonCarteControleurScope, rechercheService: Services.StructureRechercheService, serviceAgent: MyWay.Services.ServiceAgent, i18n: Services.II18nCarteService);
        /**
         * Méthode d'initialisation des données du controleur.
         */
        initialiserData(): void;
...
declare module ComposantsCommunsCarte.Controleurs {
    ...
    class NomCarteControleur {
         ...
         * de la sélection.
         * Code mort pour le moment, attente de la création de la table
         */
        private sendRequest();
        /**
         * Méthode de construction de la liste des nom sur la carte
         */
        private buildListeNomSurLaCarte(data);
        /**
         * Méthode de validation de la sélection utilisateur
         */
...
declare module ComposantsCommunsCarte.Controleurs {
    ...
    class TutelleCarteControleur {
        ...
        static $inject: string[];
        constructor($scope: ITutelleCarteControleurScope, serviceAgent: MyWay.Services.ServiceAgent, tiersLiesService: Services.TiersParticulierTiersLiesService, particulierInformationService: Services.TiersParticulierInformationService, i18n: Services.II18nCarteService);
        /**
         * Méthode d'initialisation des données du controleur.
         */
        initialiserData(): void;
