...
declare module myway.comEds {
    class SaisirAgenceDestinataireController {
        ...
        selected: any;
        constructor($scope: ng.IScope, saisieAgenceDestinataireService: SaisieAgenceDestinataireService, serviceAgentExtended: core.AgentService, $element: ng.IAugmentedJQuery);
        /**
         * @alias onSelect.
         * @return {void}
...
declare module myway.comEds {
    class SaisirAgentController {
        ...
        ngFocus: boolean;
        _onSelect: any;
        constructor($scope: ng.IScope, $timeout: ng.ITimeoutService, saisieAgentService: myway.comEds.SaisieAgentService, serviceAgentExtended: core.AgentService, $q: angular.IQService, $element: ng.IAugmentedJQuery);
        /**
         * @alias rechercher
...
declare module myway.comEds {
    ...
    class RechercheEdsGuichetController {
        ...
        private onSelect;
        static $inject: string[];
        constructor($scope: ng.IScope, serviceAgentExtended: core.AgentService, rechercheEdsService: myway.comEds.RechercheEdsGuichetService);
        /**
...
declare module myway.comEds {
    ...
    class RechercheEdsGlobaleModaleController implements MyWay.UI.INavcolHandler {
        ...
        static $inject: string[];
        constructor($scope: ng.IScope, $timeout: ng.ITimeoutService, modale: ng.ui.bootstrap.IModalServiceInstance, serviceAgentExtended: core.AgentService, rechercheEdsService: myway.comEds.RechercheEdsGuichetService, edsRechercheGlobaleParam: MyWay.Model.EDSRechercheGlobaleParam, eds: MyWay.Model.EDSGlobal);
        /**
...
declare module myway.comEds {
    ...
    class RechercheEdsGuichetModaleController implements MyWay.UI.INavcolHandler {
        ...
        loading: ng.IPromise<any>;
        static $inject: string[];
        constructor($scope: ng.IScope, $timeout: ng.ITimeoutService, modale: ng.ui.bootstrap.IModalServiceInstance, serviceAgentExtended: core.AgentService, rechercheEdsService: myway.comEds.RechercheEdsGuichetService, edsRechercheGuichetParam: MyWay.Model.EDSRechercheGuichetParam, guichet: Guichet, $filter: ng.IFilterService, saisieAgenceDestinataireService: myway.comEds.SaisieAgenceDestinataireService);
        /**
         * @alias onSelectionChangeNavcolList
         * @return {any}
         * @param objet, colId
