...
declare module ComposantsCommunsChequier.Services {
    ...
    class HelperGgoChequierService {
         ...
         */
        extactNumeroCompteFromMiseEnGestion(data: GestionGeneriqueOffres.Types.DonneesContextuelles): string;
        /**
         * Méthode permettant de chercher dans le catalogue le code activité du compte
         * @param data Les données contextuelles de GGO.
         * @return Le code de l'activité du compte.
         */
        extractCodeActiviteCompteFromCatalogue(data: GestionGeneriqueOffres.Types.DonneesContextuelles): string;
        /**
         ...
         */
        extractNumeroCompteFromReferencesProduits(data: GestionGeneriqueOffres.Types.DonneesContextuelles): string;
        /**
         ...
         */
        extractReferenceCompteFromReferencesProduits(data: GestionGeneriqueOffres.Types.DonneesContextuelles): any;
