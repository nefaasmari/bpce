...
declare module ClotureTelephonePro {
    var app: any;
}
...
/**
 * Contrôleur de la page de tests de la directive mw-telephone-pro-cloture
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureTelephonePro.Controleurs {
    /**
     * Déclaration du contrôleur
     */
    class PageDevMwTelephoneProClotureControleur {
        private $scope;
...
/**
 * Contrôleur de la directive mw-telephone-pro-cloture
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureTelephonePro.Controleurs {
    /**
     * Déclaration du contrôleur
     */
    class MwTelephoneProClotureControleur {
        private $scope;
        private serviceAgentExtended;
        ...
        /**
         * Méthode appelée pour la sauvegarde de la clôture de l'abonnement Telephone Pro
        ...
        /**
         * Méthode appelée pour le traitement de la sauvegarde de la clôture de l'abonnement Telephone Pro
...
/**
 * Directive pour l'affichage de la page de clôture de Telephone Pro
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureTelephonePro.Directives {
    function mwTelephoneProCloture(): ng.IDirective;
}
