...
declare module myway.comContract.Services {
    ...
    class ContractualisationActeService {
         ...
         * @param codeCanal
         */
        private isDeployeSEMD(codeEtablissement, codeActeGestion, codeCanal);
        /**
         *
         * @param datas
         */
...
declare module myway.comContract.Services {
    ...
    class DossierNumeriqueService {
         ...
         */
        envoyerMail(typeMail: string, modeDiffusion: string, idPanier: string, idTransactionIcg: string, listeIdPersonnes: Array<string>): ng.IPromise<Array<Myway.Ressource.Signature.V3.IMailOutput>>;
        /**
         *
...
declare module myway.comContract.Signature {
    ...
    class SignatureRequestFactory {
        ...
        postMail(typeMail: string, modeDiffusion: string, idPanier: string, idTransactionIcg: string, listeIdPersonnes: Array<string>): MyWay.Services.IRequestSettings;
    }
}
