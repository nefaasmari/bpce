...
declare module instructionCredit {
    class EmissionDocumentsControleur implements MyWay.UI.ISelectionChangeHandler {
         ...
         * @param NavigationService: MyWay.UI.INavigationService
         */
        constructor($scope: ng.IScope, $q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, navigationService: MyWay.UI.INavigationService, modaleFactory: instructionCredit.Service.ModaleFactory, initialisationService: instructionCredit.Service.InitialisationService, formulaireFinancementService: instructionCredit.Service.FormulaireFinancementService, controleDossierService: Service.ControleDossierService);
         ...
         * @Param: identifiant de l'éléménet à ajouter (credit, plan...)
         */
...
declare module instructionCredit {
    class FormulaireClientControleur implements MyWay.UI.ITuileHandler {
         ...
         */
        chargementRevenuEtChargeEtSurfaceFinanciere(): ng.IPromise<any>;
        /**
         ...
         */
        majEmprunteurDepuisListePersonne(listePersonnePhysiqueMaj: Array<Modele.PersonnePhysiqueMaj>, listeRevenuParPersonne: Array<Array<Modele.RevenuPersonneMaj>>, listeChargeParPersonne: Array<Array<Modele.ChargePersonneMaj>>, listeIdPersonneSI: Array<string>, ajout: boolean): ng.IPromise<void>;
        /**
         ...
         */
        creationRevenusEtChargesTiers(idPersonneSI: string, idwsPersonnes: string[]): ng.IPromise<any>;
...
declare module instructionCredit {
    class FormulaireFinancementControleur implements MyWay.UI.ISelectionChangeHandler, MyWay.UI.ITuileHandler {
         ...
         */
        private chargementInitial(optim?);
        /**
         *  Liste des plans de Financement
         */
        private chargerPlanFinancementDetail();
        /**
         *  Charge l'emprunteur du dossier et calcul sa capacité de remboursement
         */
         ...
         */
        afficheAssurance(assuranceObj: Modele.IAssurance): void;
        /**
         * Fonction appellée au changement de proposition dans le panier
         */
        planFinancementChargement(index: number, optim?: Modele.IResultatPlanOptimisation): ng.IPromise<any>;
        /**
         ...
         */
        private creerAssurance(index, assurancesCreees, listeIdCreditCouvParAss, listeIdentifiantPersonne, idConventionAssurance, codeAssuranceObligatoire, quotientCouverture, montantCotisation, tauxCotisation, siren);
        /**
         ...
         */
        calculCapaciteRemboursement(avecLoader: boolean): void;
...
declare module instructionCredit {
    class FormulaireProjetControleur {
         ...
         * @param navigationService: MyWay.UI.INavigationService
         */
        constructor($scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, formulaireProjetService: instructionCredit.Service.FormulaireProjetService, navigationService: MyWay.UI.INavigationService, initialisationService: instructionCredit.Service.InitialisationService, modalService: MyWay.UI.IModalService, mwsfAdresseService: myway.comAdresseDqe.AdresseService, calculService: instructionCredit.Service.CalculService, clientService: Service.ClientService, financementService: Service.FormulaireFinancementService, $q: ng.IQService, controleDossierService: Service.ControleDossierService);
        /**
         ...
         */
        majModeOccupation(): void;
        private controlerDossier(dossierComplet);
...
declare module instructionCredit {
    class ModaleAjoutCreditIntRegroupementControleur implements MyWay.UI.ISelectionChangeHandler {
        ...
        creditsInternes: Array<Modele.IPretReamenagement>;
         ...
         * @param $modal: any
         */
        constructor($scope: ng.IScope, $modalInstance: any, data: any, $modal: any, formulaireProjetService: instructionCredit.Service.FormulaireProjetService, initialisationService: instructionCredit.Service.InitialisationService, modaleFactory: instructionCredit.Service.ModaleFactory);
        onSelectionChange(selectedObject: Object): void;
        /**
         * Permet de fermer la popin
         */
...
declare module instructionCredit {
    class ModaleCreditExtRegroupementControleur {
         ...
         * @param $modal: any
         */
        constructor($scope: ng.IScope, $modalInstance: any, data: any, $modal: any, formulaireProjetService: instructionCredit.Service.FormulaireProjetService, initialisationService: instructionCredit.Service.InitialisationService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $q: ng.IQService);
        /**
         * Permet de fermer la popin
         */
        close(): void;
...
declare module instructionCredit {
    class ModaleAssuranceControleur {
         ...
         * @param $modal: any
         */
        constructor($scope: ng.IScope, $modalInstance: any, data: any, $modal: any, initialisationService: instructionCredit.Service.InitialisationService, $q: ng.IQService, formulaireFinancementService: instructionCredit.Service.FormulaireFinancementService, $filter: any);
        ...
        onSelectionChangeNavcolList(selectionCol: any, colId: string): void;
        chargerConventions(selectionCol: any): ng.IPromise<any>;
...
declare module instructionCredit {
    class ModaleGarantieControleur {
         ...
         * @param $modal: any
         */
        constructor($scope: ng.IScope, $modalInstance: any, data: any, $modal: any, initialisationService: instructionCredit.Service.InitialisationService, $q: ng.IQService, formulaireFinancementService: instructionCredit.Service.FormulaireFinancementService, mwgcRechercherPersonneService: myway.comGestionClient.RechercherPersonneService, $filter: any);
        /**
         * Construction du tableau de crédits
         */
        initialisationTableauCredit(): MyWay.UI.ImwTableOptions;
        resetNatureGarantie(): void;
        resetConvention(): void;
        resetCouverture(): void;
        resetCotisation(): void;
        rechercheAvancee(): void;
        ...
        chargerConventions(index: number, idsConv: string[]): void;
        /**
...
declare module instructionCredit {
    class ModaleSituationBdfControleur {
         ...
         */
        private chargerOppositions();
        /**
         *  Récupération des libellés pour chacune des oppositions
         */
        private setLibellesForOppositions();
...
declare module instructionCredit.Modele {
    /**
     *   Modèle de l'objet qui permet de recenser les anomalies sur le dossier en cours
     */
    interface IAnomalieDossier {
        typeContrôle: number;
        idAno: string;
        libelleAno: string;
        typeAno: number;
    ...
    class AnomalieDossier implements IAnomalieDossier {
        typeContrôle: number;
        idAno: string;
        libelleAno: string;
        typeAno: number;
...
declare module instructionCredit.Service {
    class ClientService {
         ...
         * @param forcerRecuperation : boolean => Permet de récupèrer les dernières mise à jour
         * @return promise<Emprunteur>
         */
        getEmprunteur(identifiantDossier: string, forcerRecuperation: boolean): ng.IPromise<instructionCredit.Modele.IEmprunteur>;
        /**
...
declare module instructionCredit.Service {
    ...
    class ControleDossierService {
        ...
        private initialisationService;
        static $inject: string[];
        private _redirectionControleDemandee;
         ...
         */
        private redirectionObligatoire(listeControles, fermetureDossier);
        /**
...
declare module instructionCredit.Service {
    class FormulaireFinancementService {
         ...
         */
        listerTypesDeFraisGarantie(codeNatureGarantie: string): ng.IPromise<instructionCredit.Modele.ITypesDeFraisGarantie[]>;
        /**
...
declare module instructionCredit.Service {
    class FormulaireProjetService {
         ...
         */
        listerPretsReamenagebles(idDossier: string, idReamenagement: string, date: Date): ng.IPromise<Array<Modele.IPretReamenagement>>;
        /**
...
declare module instructionCredit.Service {
    class InitialisationService {
         ...
         * @param: canalDeCreation
         */
        editionPDF(identifiantDossier: string, identifiantDocument: string, identifiantWs: string, paramsEditiques: Array<Object>): ng.IPromise<any>;
        /**
         ...
         * @return promise<IParametreApplicatif>
         */
        listerTypeAccessoire(rubriquesFiltre: Array<string>, valeursFiltre: Array<string>): ng.IPromise<instructionCredit.Modele.IAccessoireType[]>;
        /**
