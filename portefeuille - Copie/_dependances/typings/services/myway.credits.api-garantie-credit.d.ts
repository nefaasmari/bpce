...
declare module GarantieCredit.Service {
    class CreditService {
        ...
        constructor(caracteristiqueCreditRestService: Rest.CaracteristiqueCreditRestService);
...
declare module GarantieCredit.Service {
    class GarantieService {
        ...
        constructor($q: ng.IQService, creditService: CreditService, garantieCreditRestService: Rest.GarantieCreditRestService, objetPorteGarantieRestService: Rest.ObjetPorteGarantieRestService, conventionRestService: Rest.ConventionRestService);
        /**
...
declare module GarantieCredit.Service {
    class ParametreService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, parametreRestService: Rest.ParametreRestService);
        /**
...
declare module GarantieCredit.Service.Rest {
    class CaracteristiqueCreditRestService {
        private serviceAgent;
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgentExtended);
        /**
...
declare module GarantieCredit.Service.Rest {
    class GarantieCreditRestService {
        private serviceAgent;
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgentExtended);
        /**
...
declare module GarantieCredit.Service.Rest {
    class JustificatifGarantieRestService {
        private serviceAgent;
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgentExtended);
...
declare module GarantieCredit.Service.Rest {
    class ObjetPorteGarantieRestService {
        private serviceAgent;
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgentExtended);
        /**
...
declare module GarantieCredit.DTO {
    ...
    interface IParametreReversementTiers {
        ...
        referenceUniqueMandat: string;
        dateSignatureMandat: Date;
        dateProchainReversementSurAppel: Date;
    ...
    interface ICritereValeurTva {
        dateDebutValiditeTva: Date;
        dateFinValiditeTva: Date;
    }
...
declare module GarantieCredit.Service.Rest {
    class SituationHypothequeRestService {
        private serviceAgent;
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgentExtended);
...
declare module GarantieCredit.Service.Rest {
    class VersementAttenduRestService {
        private serviceAgent;
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgentExtended);
