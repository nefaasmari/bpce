...
declare module myway.comContract.Services {
    class DossierContratService {
         ...
         */
        putDossierContrat(codeEtablissementFinancier: string, codeModeContractualisation: string, codeActeGestion: string, codeGuichet: string, numeroEntiteTitulaire: string, referenceContrat: string, referenceEDSInterneClient: string, referenceEDSExterneClient: string, listeActeSecondaires: Array<string>, nbPersonneEntiteTitulaire: number): ng.IPromise<boolean>;
    }
}
...
declare module myway.comContract.Services {
    ...
    class VenteVpcService {
         ...
         */
        private createTerminerActeVadInputObject(codeEtablissement, idActeIdn, codeApplication, listeDocumentsAttributaire);
        /**
...
declare module myway.comContract.signataire {
    class ListeDesignatairesController {
        ...
        private REFERENCE_IDENTITE_MAXLENGTH;
        private MESSAGE_ERREUR_REFERENCE_IDENTITE_REQUIRED;
        private MESSAGE_ERREUR_REFERENCE_IDENTITE_MINLENGTH;
        private MESSAGE_ERREUR_REFERENCE_IDENTITE_MAXLENGTH;
        ...
        static $inject: string[];
        constructor($scope: ng.IScope, $filter: ng.IFilterService, $q: ng.IQService, $timeout: ng.ITimeoutService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, signataireService: SignataireService);
        /**
         * fonction plierDeplier pour ouvrir et fermer la liste des signataires et traiter les cas de focus sur input-reference-identite
         */
        ...
        private verifierDonneesEntreeModeOperationFinanciere(donneesEntree);
...
declare module myway.comContract.Ressources.DossierContrat {
    class DossierContratFactory {
        private static CODE_APPLICATION;
        constructor();
        createDossierContrat(codeEtablissementFinancier: string, codeModeContractualisation: string, codeActeGestion: string, codeGuichet: string, numeroEntiteTitulaire: string, referenceContrat: string, referenceEDSInterneClient: string, referenceEDSExterneClient: string, listeActeSecondaires: Array<string>, nbPersonneEntiteTitulaire: number): Myway.Ressource.DossierContrat.IDonneesDossierContrat;
    }
}
...
declare module myway.comContract.Ressources.DossierContrat {
    class DossierContratRequestFactory {
        ...
        constructor(methode: MyWay.Services.MethodEnum, donneesDossierContrat: Myway.Ressource.DossierContrat.IDonneesDossierContrat);
        /**
