declare module MyWay.Services {
  ...
  interface IPromesse<T> {
     ...
     */
    then<TResult>(
      onFulfill: (value: T) => IPromesse<TResult> | TResult,
      onReject?: (reason: Erreur) => any,
      onProgress?: Function
    ): IPromesse<TResult>;
    then<TResult>(
      onFulfill: (value: T) => IPromesse<TResult> | TResult,
      onReject?: (reason: Erreur) => TResult,
      onProgress?: Function
    ): IPromesse<TResult>;
    /**
  ...
  class MaPromesse<T> implements IPromesse<T> {
    ...
    then<TResult>(
      onFulfill: (value: T) => IPromesse<TResult>,
      onReject?: (reason: Erreur) => any,
      onProgress?: Function
    ): IPromesse<TResult>;
    then<TResult>(
  ...
  class Promesses {
    ...
    static promesseTryCatch<T>(
      pCallback: (pDefer: IDeferred<T>) => any,
      pCallbackErreur?: (pErreur: Erreur, pDefer: IDeferred<T>) => any
    ): IPromesse<T>;
    promesseTryCatch<T>(
      pCallback: (pDefer: IDeferred<T>) => any,
      pCallbackErreur?: (pErreur: Erreur, pDefer: IDeferred<T>) => any
...
declare module MyWay.Services.Loggers {
  class FLASH {
    ...
    setValue(pCle: string, pValeur: any): void;
    getValue(pCle: string): any;
    setAll(pFlashs: { [key: string]: any }): void;
    getAll(): {
      [key: string]: any;
    };
  }
...
declare module MyWay.Services.Core {
  var override: <T, R>(
    ...
    pMethodeName: string,
    pContent: (pInstance: T, pOldMethod: any) => any
  ) => void;
  interface IGetterSetter<P> {
    get?: () => P;
    set?: (a: P) => void;
  }
  var defineProperty: <P>(
    pClass: {
      new (...args: any[]): any;
      prototype: any;
    },
    pProperty: string,
    pGetterSetter: IGetterSetter<P>
  ) => void;
}
...
declare module MyWay.Services.Components {
  ...
  abstract class AbstractRegistry<
    TClass extends IComponentConstructor<TInstance>,
    TInstance extends IComponent,
    TLibrary extends ILibraryBase
  > {
...
declare module MyWay.Services {
  ...
  class CoreCommon extends Components.ComponentBase implements Components.IComponentCommon {
    ...
    static addListenerOnAddMyWayHeaders(
      pCallback: (
        headers: {
          [key: string]: string;
        },
        settings: IRequestSettingsExtended
      ) => void
    ): void;
    static removeListenerOnAddMyWayHeaders(
      pCallback: (
        headers: {
          [key: string]: string;
        },
     ...
     */
    static EnumUtils: {
      getNamesAndValues<T extends number>(
        e: any
      ): {
        name: string;
        value: T;
...
declare module MyWay.Services.Common {
  class ArbreBinaire<T> {
    ...
    entreBornesAsc(
      pElementInferieur: T,
      pInclureElementInferieur: boolean,
      pElementSuperieur: T,
      pInclureElementSuperieur: boolean,
      pCallback: (pElement: T) => void
    ): void;
    entreBornesDesc(
      pElementInferieur: T,
      pInclureElementInferieur: boolean,
...
declare module MyWay.Services.Message {
  abstract class MessageBase {
    ...
    constructor(
      ...
      zoneName: string,
      library: Components.ILibraryCommon,
      canReceiveResponses: boolean,
      canReceiveNewMessages: boolean
    );
    private createMessage;
    send<SubjectType, ContentType>(
      pComponent: Components.ComponentType,
      pSubject: SubjectType,
      pContent: ContentType,
      targetWindow?: Window,
      targetDomain?: string,
      pIdFrame?: string
    ): IPromesse<void>;
    sendWithResponse<SubjectType, ContentType, ResponseType>(
      pComponent: Components.ComponentType,
      pSubject: SubjectType,
      pContent: ContentType,
      targetWindow?: Window,
      targetDomain?: string,
      pIdFrame?: string
    ): IPromesse<ResponseType>;
    protected abstract postMessage<SubjectType, ContentType>(
      pMessage: IFrameMessage<SubjectType, ContentType>,
      pTargetWindow: Window,
      pTargetDomain: string,
      pIdFrame: string
    ): void;
...
declare module MyWay.Services.Components {
  abstract class ComponentApiBase implements Components.IComponentApi {
    ...
    init(
      pCapabilities: DeviceCapabilities,
      pLibraryManager: Components.ILibraryManager,
      pApiInitializer: Components.IApiInitializer
    ): IPromesse<void>;
    dispose(): IPromesse<void>;
...
declare module MyWay.Services.Persistence {
  class StorageInstance<T> {
    ...
    constructor(
      pKeyStorage: string,
      pCallbackToDisposeListener: () => void,
      pCallbackToSave: (pObject: T) => void,
      pCallbackOnEvent: (pElement: T) => void
    );
...
declare module MyWay.Services.Components {
  class ComponentManagerBase<SubjectType, ContentType> extends ComponentBase implements IComponentManager<SubjectType, ContentType> {
    ...
    init(
      pManagerLibrary: ILibraryManager,
      pMessageService: Message.IMessageService,
      pManagerInitializer: IManagerInitializer,
      pApi?: IComponentApi
    ): IPromesse<void>;
    ...
    protected sendMessageWithFrame<ResponseType>(
      pSubject: SubjectType,
      pContent: ContentType,
      frame: MyWay.Services.Display.IFrameModel
    ): IPromesse<ResponseType>;
    dispose(): IPromesse<void>;
...
declare module MyWay.Services.Components {
  enum RegistryType {}
  class RegistryManager extends AbstractRegistry<IComponentManagerConstructor, IComponentManager<any, any>, ILibraryManager>
...
declare module MyWay.Services {
  class Evennements extends Components.ComponentManagerBase<any, any> {
    ...
    constructor();
    init(
      pManagerLibrary: Components.ILibraryManager,
      pMessageService: Message.IMessageService,
      pManagerInitializer: Components.IManagerInitializer,
      pApi?: Components.IComponentApi
    ): IPromesse<void>;
...
declare module MyWay.Services {
  ...
  class ServiceManager {
    ...
    static addActionOnInitialize(
      pActionName: string,
      pCallback: (pLibraryManager: Components.ILibraryManager) => IPromesse<void>,
      ...pActionsRequises: string[]
    ): void;
...
declare module MyWay.Services.BriqueCommunication {
  ...
  interface IBriqueCommunicationMessage
    extends Components.IMessage<BriqueCommunicationMessageSubject, IBriqueCommunicationMessageContent> {}
}
declare module MyWay.Services.BriqueCommunication {
...
declare module MyWay.Services.Acquisition {
  interface IPutDocumentInput {
    ...
    idntFonctionnelRegr: string;
    idntFonctionnelDoc: string;
  }
}
declare module MyWay.Services.Bug {}
declare module MyWay.Services.Acquisition {
...
declare module MyWay.Services.Components {
  class ComponentManagerMessageBase<
    ManagerClass extends IComponentManager<SubjectType, ContentType>,
    TypeMessage extends IMessage<SubjectType, ContentType>,
    SubjectType,
    ContentType
  > extends ComponentBase implements IComponentManagerMessage<ManagerClass, TypeMessage> {
...
declare module MyWay.Services.Components {
  interface IComponentManagerMessageConstructor
    extends IComponentConstructor<IComponentManagerMessage<IComponentManager<any, any>, IMessage<any, any>>> {}
  interface IComponentManagerMessage<ManagerClass extends IComponentManager<any, any>, MessageType extends IMessage<any, any>>
    extends IComponentConnected<MessageType> {
    init(pManager: ManagerClass, pLibCommon: ILibraryCommon): IPromesse<void>;
  }
}
declare module MyWay.Services.Components {
  ...
  class RegistryManagerMessage extends AbstractRegistry<
    IComponentManagerMessageConstructor,
    IComponentManagerMessage<any, any>,
    ILibraryCommon
  > {
    private static instance;
    private messageService;
...
declare module MyWay.Services.Loggers {
  class LoggerManagerMessage extends Components.ComponentManagerMessageBase<
    LoggerManager,
    ILoggersMessage,
    LoggersMessageSubject,
    ILoggersMessageContent
  > {
    constructor();
...
declare module MyWay.Services.Components {
  class ComponentManagerExtendedBase<TClass extends Components.IComponentManager<any, any>>
    implements Components.IComponentManagerExtended {
    private _name;
...
declare module MyWay.Services.Components {
  ...
  class RegistryManagerExtended extends AbstractRegistry<
    IComponentManagerExtendedConstructor,
    IComponentManagerExtended,
    ILibraryManagerExtended
  > {
    private static instance;
    constructor();
...
declare module MyWay.Services.Acquisition {
  class AcquisitionApiBase implements IAcquisitionApi {
    ...
    mergerDocuments(fileInfos: IFileInformation[], formatResultatMerge: any): IPromesse<string>;
    manipulerArchives(fileInfos: IFileInformation[], formatResultatMerge: any, typeOuvertureArchive: any): IPromesse<any>;
    ...
    retrieveGedDocument(
      applicationCode: string,
      gedDocumentParams: MyWay.Services.Acquisition.IGedDocumentParams,
      authentInfo: Context.AuthentificationInfo
    ): IPromesse<IGedDocument>;
...
declare module MyWay.Services.Acquisition {
  class AcquisitionApiFactory extends Components.ComponentApiBase implements IAcquisitionApiComponent {
    ...
    init(
      ...
      libraryManager: Components.ILibraryManager,
      apiInitializer: Components.IApiInitializer
    ): IPromesse<void>;
    initApi(libraryManagerApi: Components.ILibraryManager): void;
    recuperationImageKofax(fileInfos: IFileInformation[]): IPromesse<any>;
    creerImagesBitonales(base64List: string, pCreerImageBitonalParams: ICreerImageBitonalParams): IPromesse<any>;
...
declare module MyWay.Services.Acquisition {
  class AcquisitionApiWindows extends AcquisitionApiBase {
     ...
     */
    mergerDocuments(fileInfos: IFileInformation[], pFormatResultatMerge: any): IPromesse<string>;
    /**
     ...
     */
    manipulerArchives(fileInfos: IFileInformation[], pFormatResultatMerge: any, pTypeOuvertureArchive: any): IPromesse<any>;
    archiver(putDocumentInput: IPutDocumentInput, authentInfo: Context.AuthentificationInfo): IPromesse<any>;
    convertBase64ToBin(urls: string[]): IPromesse<any>;
    purge(hour: number): IPromesse<boolean>;
    fermetureSpiFactory(): IPromesse<boolean>;
    ...
    retrieveGedDocument(
      ...
      gedDocumentParams: MyWay.Services.Acquisition.IGedDocumentParams,
      authentInfo: Context.AuthentificationInfo
    ): MyWay.Services.IPromesse<IGedDocument>;
    saveDocument(document: IBase64File): MyWay.Services.IPromesse<string>;
    /**
     * @author : Benoît Ouvrié
     * @version : 20.03
...
declare module MyWay.Services.DonneesDelocalisees.Messages {
  ...
  interface IDonneesDelocaliseesMessage
    extends Components.IMessage<DonneesDelocaliseesMessageSubject, IDonneesDelocaliseesMessageContent> {}
}
/**
...
declare module MyWay.Test.V1.Services {
  ...
  function declareExterieurVersManagerMessageATester<EnumType>(
    pParamsDeclare: IDeclareExterieurVersManagerMessageATester<EnumType>
  ): {
    execute: () => void;
...
declare module MyWay.Services.BaseDeDonnees {
  class BaseDeDonneesManager extends Components.ComponentManagerBase<
    Messages.BaseDeDonneesMessageSubject,
    Messages.IBaseDeDonneesMessageContent
  > {
    private dbs;
    constructor();
    init(
...
declare module MyWay.Services.TraitementNsdk {
  ...
  class TraitementNsdkManager extends Components.ComponentManagerBase<TraitementNsdkMessageSubject, ITraitementNsdkMessageContent> {
    ...
    init(
      ...
      pMessageService: Message.IMessageService,
      pManagerInitializer: Components.IManagerInitializer,
      pApi?: ITraitementNsdkApiComponent
    ): IPromesse<void>;
    Lancer(traitement: string, data: string): IPromesse<string>;
  }
}
...
declare module MyWay.Test.V1.Services {
  interface IDeclareManagerExtendedATester {
    ...
    className: string;
    beforeEach?: (
      pManager: MyWay.Services.Components.IComponentManager<any, any>,
      pLibraryCommon: MyWay.Services.Components.ILibraryCommon
    ) => IPromesse<void>;
    afterEach?: (
      pManager: MyWay.Services.Components.IComponentManager<any, any>,
      pLibraryCommon: MyWay.Services.Components.ILibraryCommon
  ...
  function declareManagerExtendedATester(
    pParamsDeclare: IDeclareManagerExtendedATester
  ): {
    execute: () => void;
...
declare module MyWay.Services.Export {
  class ExportManagerMessage extends Components.ComponentManagerMessageBase<
    ExportManager,
    IExportMessage,
    ExportMessageSubject,
    IExportMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    constructor();
...
declare module MyWay.Services.Context {
  class ContextManager extends Components.ComponentManagerBase<ContextMessageSubject, IContextMessageContent> implements IContextCommon {
    ...
    GetListFromContext(
      keyArray: string[],
      useObjectPath?: boolean,
      returnEmptyIfNull?: boolean
    ): MyWay.Services.Context.IContextKeyValuePair[];
...
declare module MyWay.Services.Display {
  ...
  class DisplayManager extends Components.ComponentManagerBase<DisplayMessageSubject, IDisplayMessageContent> {
    ...
    onAffichageModalMessage: (
      TitreMessage: string,
      ContenuMessage: string,
      boutonsAAfficher: Object,
      delai: number,
      callback: (retour: any) => void,
      onModaleOuverte?: () => void
    ) => void;
    private formatObjectNotificationListeners;
    constructor();
    setFormatObjectNotificationListener(
      pEventType: Component.ManagerEventType,
      pListener: (pEvent: Component.ManagerEvent, pNotification: NotificationEvent<any>) => void
    ): void;
    init(
      pManagerLibrary: Components.ILibraryManager,
      pMessageService: Message.IMessageService,
...
declare module MyWay.Services.BaseDeDonnees {
  class BaseDeDonneesManagerMessage extends Components.ComponentManagerMessageBase<
    BaseDeDonneesManager,
    Messages.IBaseDeDonneesMessage,
    Messages.BaseDeDonneesMessageSubject,
    Messages.IBaseDeDonneesMessageContent
  > {
    constructor();
...
declare module MyWay.Services.TraitementNsdk {
  class TraitementNsdkManagerMessage extends Components.ComponentManagerMessageBase<
    TraitementNsdkManager,
    ITraitementNsdkMessage,
    TraitementNsdkMessageSubject,
    ITraitementNsdkMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    constructor();
...
declare module MyWay.Services.Interop {
  ...
  interface IInteropApi {
    ...
    lancer(
      executableWrapper: Interop.ExecutableWrapper,
      contexte: Interop.ContexteMyway,
      parametres: string[],
      sync: boolean,
      callback: ErreurCallback
    ): any;
    addToContextInterop(level: string, key: string, value: string, callback: (any: any) => void, errorCallback: ErreurCallback): any;
    addListToContextInterop(
      level: string,
      datas: MyWay.Services.Context.IContextKeyValuePair[],
      callback: (any: any) => void,
      errorCallback: ErreurCallback
    ): any;
    ...
    subscribeToEvent(
      onEvent: (event: MyWay.Services.Interop.InteropMessageEvent, callback: () => void) => void,
      onAcceptEvent: (event: MyWay.Services.Interop.InteropMessageEvent) => boolean,
    ...
    getListFromContextInterop(
      level: string,
      datas: string[],
      callback: (returnDatas: MyWay.Services.Context.IContextKeyValuePair[]) => void,
      errorCallback: ErreurCallback
    ): any;
...
declare module MyWay.Services.Habilitation {
  ...
  class HabilitationApi extends Components.ComponentApiBase implements IHabilitationApiComponent {
    ...
    GetHabilitations(
      ...
      iam: boolean,
      cultureNet: boolean,
      infosUserPoste: MyWay.Services.Context.InfosUserPoste,
      authentificationInfo: MyWay.Services.Context.AuthentificationInfo
    ): IPromesse<IHabilitationsDTO>;
  }
}
declare module MyWay.Services.Components {
  interface ILibraryApi {
...
declare module MyWay.Services.Communication {
  class CommunicationManager extends Components.ComponentManagerBase<CommunicationMessageSubject, ICommunicationMessageContent> {
    ...
    init(
      ...
      pMessageService: Message.IMessageService,
      pManagerInitializer: Components.IManagerInitializer,
      pApi?: ICommunicationApiComponent
    ): IPromesse<void>;
    /**
     * Permet d'envoyer un mail
     *
...
declare module MyWay.Services.ContexteClient {
  ...
  class ContexteClientManagerBase extends Components.ComponentManagerBase<ContextClientMessageSubject, IContextClientMessageContent> {
    ...
    init(
      ...
      pMessageService: Message.IMessageService,
      pManagerInitializer: Components.IManagerInitializer,
      pApi?: IContexteClientApiComponent
    ): IPromesse<void>;
    dispose(): IPromesse<void>;
    ...
    private save;
    private load;
    protected broadcastUpdateEvent(
      cle: string,
      sender: string,
      contexteClient: ContexteClientClass,
      type: Messages.MiseAJourContexteClientType
    ): void;
    protected broadcastUpdateEventByProcess(
      cle: string,
      sender: string,
      pProcess: Context.IProcess[],
      type: Messages.MiseAJourContexteClientType
    ): void;
  }
}
...
declare module MyWay.Services.BriqueCommunication {
  class BriqueCommunicationManager extends Components.ComponentManagerBase<
    BriqueCommunicationMessageSubject,
    IBriqueCommunicationMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    ...
    init(
      ...
      pMessageService: Message.IMessageService,
      pManagerInitializer: Components.IManagerInitializer,
      pApi?: IBriqueCommunicationApiComponent
    ): IPromesse<void>;
    ...
    ouvrirCanal<T>(
      pUrl: string,
      pDestination: string,
      pOptions: ICanalOptions,
      pAuthentificationInfo: Context.AuthentificationInfo
    ): MyWay.Services.IPromesse<ICanalControlerReadAndWrite<T>>;
    replaceTokens(
      pString: string,
      pValues: {
        [key: string]: string;
...
declare module MyWay.Services.BriqueCommunication.Chat {
  class ChatManagerBase extends Components.ComponentManagerBase<ChatMessageSubject, IChatMessageContent> {
    ...
    inviterPersonneARejoindreUneChatroomApi(
      pChatroomId: string,
      pUserDestinataire: string,
      pAuthentificationInfo: Context.AuthentificationInfo,
      ...pMembresConnus: string[]
    ): void;
...
declare module MyWay.Services.Acquisition {
   ...
   */
  class AcquisitionManager extends Components.ComponentManagerBase<
    Messages.AcquisitionMessageSubject,
    Messages.IAcquisitionMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    private api;
     ...
     *
     */
    onGetDocumentGedSaveAtAndOpen(params: any): IPromesse<string>;
    /**
     * @author : Benoît Ouvrié
     * @version : 20.03
     ...
     */
    onGetDocumentGEDAndOpen(params: any): IPromesse<string>;
    /**
     * @author : Benoît Ouvrié.
     * @version : 20.03
     * @description : liste des scanners accessibles depuis le poste.
...
declare module MyWay.Services.Preferences {
  class PreferencesManager extends Components.ComponentManagerBase<PreferencesMessageSubject, IPreferencesMessageContent> {
     ...
     * @param isChargerServeur booléen. Si true, le chargement se fera via le serveur uniquement, sinon préchargement par le cache
...
declare module MyWay.Services.ConfigurationPoste {
  class ConfigurationPosteManager extends Components.ComponentManagerBase<
    ConfigurationPosteMessageSubject,
    IConfigurationPosteMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    private api;
    ...
    init(
      ...
      pMessageService: Message.IMessageService,
      pManagerInitializer: Components.IManagerInitializer,
      pApi?: IConfigurationPosteApiComponent
    ): IPromesse<void>;
...
declare module MyWay.Services.Context {
  class ContextManagerMessage
    extends Components.ComponentManagerMessageBase<ContextManager, IContextMessage, ContextMessageSubject, IContextMessageContent>
    implements IContextCommon {
    private static CLASS_NAME;
    private static logger;
    constructor();
    getAuthentificationInfo(): MyWay.Services.IPromesse<AuthentificationInfo>;
...
declare module MyWay.Services.Display {
  class DisplayManagerMessage extends Components.ComponentManagerMessageBase<
    DisplayManager,
    IDisplayMessage,
    DisplayMessageSubject,
    IDisplayMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    constructor();
...
declare module MyWay.Services.Trace {
  ...
  class TraceDB implements BaseDeDonnees.IBaseDeDonneesTableInstance<TraceEnregistrement, number> {
    ...
    constructor(
      ...
      library: Components.ILibraryManager,
      onSizeChange: (pNewSize: number, pType: EventSizeChangeType) => void
    );
...
declare module MyWay.Services.Trace {
  ...
  class TraceManager extends Components.ComponentManagerBase<Messages.TraceMessageSubject, Messages.ITraceMessageContent>
    implements Messages.ITraceCommon, Loggers.Appenders.ILoggerPurge {
    private static CLASS_NAME;
    private static logger;
...
declare module MyWay.Services.Communication {
  class CommunicationManagerMessage extends Components.ComponentManagerMessageBase<
    CommunicationManager,
    ICommunicationMessage,
    CommunicationMessageSubject,
    ICommunicationMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    constructor();
...
declare module MyWay.Services.ContexteClient {
  class ContexteClientManagerMessage extends Components.ComponentManagerMessageBase<
    ContexteClientManagerBase,
    IContextClientMessage,
    ContextClientMessageSubject,
    IContextClientMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    constructor();
...
declare module MyWay.Services.BriqueCommunication.Chat {
  class ChatManagerMessage extends Components.ComponentManagerMessageBase<
    ChatManagerBase,
    IChatMessage,
    ChatMessageSubject,
    IChatMessageContent
...
declare module MyWay.Services.BriqueCommunication.Notification {
  class NotificationManagerMessage extends Components.ComponentManagerMessageBase<
...
declare module MyWay.Services.Acquisition {
  class AcquisitionManagerMessage extends Components.ComponentManagerMessageBase<
    AcquisitionManager,
    Messages.IAcquisitionMessage,
    Messages.AcquisitionMessageSubject,
    Messages.IAcquisitionMessageContent
  > {
    private static CLASS_NAME;
     ...
     * @returns Une promesse de type liste de IScannerAccessibleResult.
     */
    private onGetListeScanner(checkRemote): IPromesse<[IScannerAccessibleResult]>;
    /**
     * @author : Benoît Ouvrié.
     * @version : 20.03
     * @description : vérification de la prise en main (ou non) à distance du poste.
...
declare module MyWay.Services.Preferences {
   ...
   */
  class PreferencesManagerMessage extends Components.ComponentManagerMessageBase<
    PreferencesManager,
    IPreferencesMessage,
    PreferencesMessageSubject,
    IPreferencesMessageContent
  > {
    /**
     * Chemin complet de la classe PreferencesManager.
     */
...
declare module MyWay.Services.Libelle {
  class LibelleManagerMessage
    extends Components.ComponentManagerMessageBase<LibelleManager, ILibelleMessage, LibelleMessageSubject, ILibelleMessageContent>
    implements ILibelleBase {
    private static CLASS_NAME;
    private static logger;
    constructor();
    constituerLibelle(codeLibelle: string, valeurs?: string[]): IPromesse<string>;
...
declare module MyWay.Services.DonneesDelocalisees {
   ...
   */
  class DonneesDelocaliseesManager extends Components.ComponentManagerBase<
    Messages.DonneesDelocaliseesMessageSubject,
    Messages.IDonneesDelocaliseesMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    private api;
    ...
    init(
      ...
      pMessageService: Message.IMessageService,
      pManagerInitializer: Components.IManagerInitializer,
      pApi?: IDonneesDelocaliseesApiComponent
    ): IPromesse<void>;
    /**
...
declare module MyWay.Services.Trace {
  class TraceManagerMessage
    extends Components.ComponentManagerMessageBase<
      TraceManager,
      Messages.ITraceMessage,
      Messages.TraceMessageSubject,
      Messages.ITraceMessageContent
    >
    implements Messages.ITraceCommon {
    private static CLASS_NAME;
    private static logger;
    constructor();
...
declare module MyWay.Services.Aide {
  class AideManagerMessage extends Components.ComponentManagerMessageBase<
    AideManager,
    Messages.IAideMessage,
    Messages.AideMessageSubject,
    Messages.IAideMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    constructor();
...
declare module MyWay.Services.Fichier {
  class FichierManagerMessage extends Components.ComponentManagerMessageBase<
    FichierManager,
    IFichierMessage,
    FichierMessageSubject,
    IFichierMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    constructor();
...
declare module MyWay.Services.Numerisation {
  ...
  class NumerisationManager extends Components.ComponentManagerBase<NumerisationMessageSubject, INumerisationMessageContent> {
    ...
    init(
      ...
      pMessageService: Message.IMessageService,
      pManagerInitializer: Components.IManagerInitializer,
      pApi?: INumerisationApiComponent
    ): IPromesse<void>;
    /**
...
declare module MyWay.Services.DonneesDelocalisees {
  class DonneesDelocaliseesManagerMessage extends Components.ComponentManagerMessageBase<
    DonneesDelocaliseesManager,
    Messages.IDonneesDelocaliseesMessage,
    Messages.DonneesDelocaliseesMessageSubject,
    Messages.IDonneesDelocaliseesMessageContent
  > {
    private static CLASS_NAME;
...
declare module MyWay.Services.Numerisation {
  class NumerisationManagerMessage extends Components.ComponentManagerMessageBase<
    NumerisationManager,
    INumerisationMessage,
    NumerisationMessageSubject,
    INumerisationMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    constructor();
...
declare module MyWay.Services.Mobilite {
  class MobiliteManagerMessage extends Components.ComponentManagerMessageBase<
    MobiliteManager,
    Messages.IMobiliteMessage,
    Messages.MobiliteMessageSubject,
    Messages.IMobiliteMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    constructor();
...
declare module MyWay.Services.Impression {
  class ImpressionManagerMessage extends Components.ComponentManagerMessageBase<
    ImpressionManager,
    Messages.IImpressionMessage,
    Messages.ImpressionMessageSubject,
    Messages.IImpressionMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    constructor();
...
declare module MyWay.Services.TraceSuivi {
  class TraceSuiviManagerMessage extends Components.ComponentManagerMessageBase<
    TraceSuiviManager,
    Messages.ITraceSuiviMessage,
    Messages.TraceSuiviMessageSubject,
    Messages.ITraceSuiviMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    constructor();
...
declare module MyWay.Services.Habilitation {
  ...
  class HabilitationManager extends Components.ComponentManagerBase<HabilitationMessageSubject, IHabilitationMessageContent> {
    ...
    init(
      ...
      pMessageService: Message.IMessageService,
      pManagerInitializer: Components.IManagerInitializer,
      pApi?: IHabilitationApiComponent
    ): IPromesse<void>;
    /**
...
declare module MyWay.Services.Capacites {
  class CapacitesManagerMessage extends Components.ComponentManagerMessageBase<
    CapacitesManager,
    Messages.ICapacitesMessage,
    Messages.CapacitesMessageSubject,
    Messages.ICapacitesMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    constructor();
...
declare module MyWay.Services.Interop {
  class InteropManagerMessage extends Components.ComponentManagerMessageBase<
    InteropManager,
    Messages.IInteropMessage,
    Messages.InteropMessageSubject,
    Messages.IInteropMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    constructor();
...
declare module MyWay.Services.Lisa {
  class LisaManager extends Components.ComponentManagerBase<Messages.LisaMessageSubject, Messages.ILisaMessageContent> {
    ...
    startStandaloneProcessWithInitialisation(
      processCode: string,
      valeurDepart: number,
      initData: IInitialisationData
    ): IPromesse<LisaCallbackResult>;
    ...
    AddProcess(
      ...
      codeProcess: string,
      etapesConnues?: string[],
      options?: Context.IProcessOption,
      idContexteClient?: string
    ): Context.Process;
    AddSubProcess(
      processId: string,
      currentProcess: Context.IProcess,
      nomProcess: string,
      codeProcess: string,
      codeEtape: string,
      actions: Lisa.ActionResult[],
      etapesConnues?: string[],
      options?: Context.IProcessOption,
      optionsAsEtape?: Context.IStepOption
    ): void;
    ...
    AddStep(
      ...
      codeMetier: string,
      actions: Lisa.ActionResult[],
      contrats: Lisa.ContratResult[],
      nomApplication: string,
      url: string,
      valeurEntree: number,
      stepOptions?: Context.IStepOption,
      etapeResultAsString?: string
    ...
    AddBoundStep(
      previousStep: MyWay.Services.Context.IProcessStep,
      stepId: string,
      displayName: string,
      url: string,
      boundId: string,
...
declare module MyWay.Services.Habilitation {
  class HabilitationManagerMessage extends Components.ComponentManagerMessageBase<
    HabilitationManager,
    IHabilitationMessage,
    HabilitationMessageSubject,
    IHabilitationMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    constructor();
...
declare module MyWay.Services.Lisa {
  class LisaManagerMessage extends Components.ComponentManagerMessageBase<
    LisaManager,
    Messages.ILisaMessage,
    Messages.LisaMessageSubject,
    Messages.ILisaMessageContent
  > {
    private static CLASS_NAME;
    private static logger;
    constructor();
...
declare module MyWay.Services.Application {
   ...
   * Classe permettant la gestion des applications
   */
  class ApplicationManager extends Components.ComponentManagerBase<
    Messages.ApplicationMessageSubject,
    Messages.IApplicationMessageContent
  > {
    private contextKey;
    private isTotemCapable;
...
declare module MyWay.Services.Application {
  class ApplicationManagerMessage extends Components.ComponentManagerMessageBase<
    ApplicationManager,
