...
declare module myway.comOpesFinancieres.CarteTMF {
    class AlgorithmeDistributionService {
         ...
         *   restant de chaque cassette
         * @return {IRepartitionProposition} objet fourni en entrée alimenté en sortie par la ventilation en billets proposée
         */
        calcProposition(repProp: IRepartitionProposition): IRepartitionProposition;
        /**
        ...
        premiereRepartissionGabValide(listeRepartitionProposition: IRepartitionProposition[]): number;
    }
}
...
declare module myway.comOpesFinancieres.CarteTMF {
    ...
    class CarteTempoMultiFonctionsService {
        ...
        private impressionBordereauCarteTMFService;
        private contractualisationCarteTMFService;
        ...
        private isCompteAutoriseTMF(rice, mode, numeroPersonne?);
        /**
         * Vérifie si l'agence est ouverte pour les opérations sur carte TMF
         * @return {boolean} true si agence ouverte, false sinon
         */
        private isAgenceOuverteTMF();
        /**
         * Vérifie si on est dans la plage horaire d'ouverture de l'agence pour les opérations sur carte TMF
         * @param horairesEdsDate {IHoraireEdsDateDetail} plage horaire d'ouverture de l'agence
         * @param momentCourant {Moment} date et heure courante
         * @return {boolean} true si agence ouverte, false sinon
         */
        estPlageHoraireAgenceOuverteTMF(horairesEdsDate: IHoraireEdsDateDetail, momentCourant: moment.Moment): boolean;
        /**
         ...
         * @param estOadInterne {boolean} true si OAD Interne, false sinon
         * @return {IPromise<ICarteTmf>} promesse contenant la confirmation de création de carte TMF, ou null si non confirmée
         */
        validerRetraitTMF(operationFinanciere: Model.OperationFinanciere, estOAD?: boolean, estOadInterne?: boolean): ng.IPromise<ICarteTmf>;
        /**
        ...
        private getRolePersonneSurContrat(signataire);
    }
}
...
declare module myway.comOpesFinancieres {
    class BilletterieController {
        ...
        /** Fonctionnalite de l'opération. */
        fonctionnalite: MyWay.Model.Fonctionnalite;
        /** Libelle montant déposé ou retiré. */
        libelleMontantDeposeOuRetire: string;
        constructor($scope: ng.IScope);
        /**
...
declare module myway.comOpesFinancieres.Constantes {
    ...
    class IdentfiantsChampsOperationsFinancieres {
        ...
        static ID_MODE_FINANCIER: string;
        static ID_LIBELLE_COMPLEMENTAIRE: string;
    }
    /**
    ...
    class MessagesErreursChampsOperationsFinancieres {
        ...
        static MESSAGE_MODE_FINANCIER_VIDE: string;
        static MESSAGE_PLAFOND_VERSEMENT_DEPASSE: string;
        static MESSAGE_MONTANT_DEPASSE_MONTANT_MAXIMUM: string;
        static MESSAGE_LIBELLE_COMPLEMENTAIRE: string;
    }
}
...
declare module myway.comOpesFinancieres.Constantes {
    ...
    class LibelleRoleSignataire {
        static LIBELLE_ROLE_TITULAIRE: string;
        static LIBELLE_ROLE_COTITULAIRE: string;
        static LIBELLE_ROLE_PROCURATION_GENERALE: string;
        static LIBELLE_ROLE_PROCURATION_GENERALE_COMPTE: string;
        static LIBELLE_ROLE_REPRESENTANT_LEGAL: string;
        static LIBELLE_ROLE_REPRESENTANT_LEGAL_PERS_MORALE: string;
        static LIBELLE_ROLE_PROCURATION_GENERALE_PRO: string;
        static LIBELLE_ROLE_AUTRES: string;
        static LIBELLE_ROLE_MANDATAIRE: string;
    }
    class TableDelocaliseeDV7I {
        static NOM_TABLE_DV7I: string;
        static CODE_ETABLISSEMENT_RUBRIQUE_COCXBQ: string;
        static CODE_PRODUIT_SERVICE_RUBRIQUE_CODIPR: string;
        static IDENTIFIANT_PRODUIT_SERVICE_RUBRIQUE_IDEGPS: string;
        static CODE_MODE_GESTION_RUBRIQUE_CIGLDM: string;
    }
    class SuiviCommercial {
        static COMPTE_88_INTERDIT: string;
        static CODE_RESULTAT_COMMERCIAL_VERSEMENT: string;
        static CODE_RESULTAT_COMMERCIAL_RETRAIT: string;
        static CODE_NATURE_RESULTAT_COMMERCIAL_NORMALE: string;
        static CODE_NATURE_RESULTAT_COMMERCIAL_ANNULATION: string;
        static CODE_FAMILLE_RESULTAT_COMMERCIAL: string;
        static CODE_INDIC_RATTACHABLE_CRE_RESULTAT_COMMERCIAL: string;
        static CODE_MODE_GESTION_LIVRET_RESULTAT_COMMERCIAL: string;
        static CODE_ORIGINE_FONDS_DEFAUT_RESULTAT_COMMERCIAL: number;
        static CODE_ORIGINE_FONDS_ESPECES_CHB_RESULTAT_COMMERCIAL: number;
    }
    class JournalApplicatif {
        static CONTEXTE_NUM_PLAN: string;
        static CONTEXTE_MAJ_JAB: string;
        static CODE_TRANSACTION_MYWA: string;
    }
    class ModeFinancierOperationDiverse {
        static LIBELLE_MODE_FINANCIER_OD_LIJMMI: string;
        static CODE_MODE_FINANCIER_OD_CTGXMF: string;
    }
    class UrlRest {
        static URL_REST_RESULTAT_ENTETIEN: string;
    }
    class PlafondVersement {
        static MESSAGE_ERREUR_PLAFOND_DEPASSE: string;
        static TEXTE_BOUTON_OK: string;
        static TEXTE_BOUTON_OUI: string;
        static TEXTE_BOUTON_NON: string;
        static TITRE_MODAL_ATTENTION: string;
        static MESSAGE_CONFIRMATION_PLAFOND_DEPASSE: string;
    }
    class OperationFinanciere {
        ...
        static TEXTE_INTERNE_I: string;
        static TEXTE_EXTERNE_E: string;
        ...
        static LIBELLE_MONTANT_GLOBAL: string;
        static LIBELLE_VIREMENT_INTERNE_DEBITE_DEFAUT: string;
        static LIBELLE_VIREMENT_INTERNE_CREDITE: string;
        static TEXTE_LIBELLE_ANNULATION_DEPOT_ESP_NUMERO: string;
        static NOM_DONNEES_SAG_OPC: string;
        static CODE_SORTIE_SAG_OPC: number;
        static TEXTE_LIBELLE_ANN_EXTOURNE: string;
        static TEXTE_LIBELLE_ANNULATION_VIREMENT: string;
        static CODE_PRODUIT_00: string;
        static CODE_PRODUIT_17: string;
        static CODE_PTU_IMP_CHEQUE_BANQUE: string;
        static LIBELLE_DEFAUT_CHEQUE_BANQUE: string;
        static TEXTE_PLAFOND_VERSEMENT: string;
        static TEXTE_PLAFOND_RETRAIT: string;
    }
    class BordereauJab {
        static CODE_SAG: string;
        static CODE_PAP: string;
    }
    class Extourne {
        static TEXTE_SANS_RESERVE: string;
        static NOMBRE_JOURS_SANS_RESERVE_00: string;
        static TEXTE_JOURS: string;
        static FORMAT_DATE_DD_MM_YYYY: string;
        static TABLEAU_REPARTITION_CHB_TITRE_NUMERO_COMPTE: "Numéro de compte";
        static TABLEAU_REPARTITION_CHB_TITRE_MONTANT: "Montant";
    }
    class BordereauOperation {
        static LIBELLE_RET_VIREMENT_INTERNE: string;
        static LIBELLE_AN_RET_VIREMENT_INTERNE: string;
        static LIBELLE_DEBUT_RET_VIREMENT_INTERNE: string;
        static LIBELLE_DEBUT_ANN_RET_VIREMENT_INTERNE: string;
        static LIBELLE_CHEQUES_DEPOSES: string;
        static TEXTE_MONTANT_ESPECES_REMETTRE: string;
        static TEXTE_MONTANT_ESPECES_RECEVOIR: string;
        static TEXTE_BILLETTERIE_EUR_RETRAIT: string;
        static TEXTE_BILLETTERIE_EUR_DEPOT: string;
        static TEXTE_MONNAIE: string;
        static TEXTE_EUR: string;
        static TEXTE_EUR_SANS_ESPACE: string;
        static TEXTE_OD: string;
        static TEXTE_NUMERO_CHEQUE: string;
        static FORMAT_DATE_DD_MM_YYYY: string;
        static FORMAT_HEURE_HH_MM_SS: string;
        static TEXTE_OFFRE_NUMERO: string;
        static TITRE_DOCUMENT: string;
        static LIBELLE_PARTICIPANT_AUTRES: string;
        static CODE_ROLE_SIGNATAIRE_AUTRES: string;
        static CODE_ATOME_CLOTURE: string;
    }
    class MessageErreur {
        static TEXTE_MESSAGE_ERREUR_GENERATION_BORDEREAU: string;
        static TEXTE_MESSAGE_ERREUR_BORDEREAU_NON_CONTEXTE: string;
    }
    class Facturation {
        static LIBELLE_FRAIS_DELIVRANCE_VRAC: string;
        static LIBELLE_FRAIS_CHEQUE_BANQUE: string;
    }
    class Fonctionnalite {
        ...
        static TEXTE_OUVERTURE_CDD_CCOOP: string;
        ...
        static TEXTE_OPERATION_RETRAIT_HORS_CLIENTELE_COMPTE_88: string;
        static TEXTE_OPERATION_DEPOT_HORS_CLIENTELE_COMPTE_88: string;
        static TEXTE_OPERATION_DEPOT_COMPTE_88: string;
        static TEXTE_OPERATION_RETRAIT_COMPTE_88: string;
        static TEXTE_OUVERTURE: string[];
    }
    ...
    class CodeModeFinancier {
        ...
        static MODE_FINANCIER_OUVERTURE_ZERO: string;
    }
    class ChiffreString {
    ...
    class EtatCassette {
        static OK: number;
        static PRESQUE_VIDE: number;
        static VIDE: number;
        static EN_ERREUR: number;
        static ABSENTE: number;
    }
    class EtatGAB {
        static OK: string;
        static KO: string;
    }
    class EtatVentilation {
        static OK: number;
        static KO: number;
    }
    class CodeHabilitation {
        ...
        static CODE_HABILITATION_SHKG18: string;
        static CODE_HABILITATION_SHGXG9: string;
        static CODE_HABILITATION_SHGXHK: string;
    }
    class Segment {
    ...
    class TableDelocaliseesProduit {
        ...
        static PROPRIETE_TABLE_DELOC_IDEGPS: string;
    }
    ...
    class Billetterie {
        ...
        static LIBELLE_MONTANT_DEPOSE: string;
        static LIBELLE_MONTANT_RETIRE: string;
    }
    ...
    class CarteTMF {
        ...
        static TEXTE_CODE_COTITULAIRE_C: string;
        static TEXTE_CODE_MANDATAIRE: string;
        static TEXTE_CODE_REPRESENTANT: string;
        ...
        static TEXTE_ENTETE_CHOIX_BILLETTERIE_TMF: string;
        ...
        static TEXTE_MESSAGE_VENTILATION_NON_VALIDE: string;
    ...
    class CodeRoleSignataire {
        static CODE_ROLE_SIGNATAIRE_01: string;
        static CODE_ROLE_SIGNATAIRE_02: string;
        static CODE_ROLE_SIGNATAIRE_03: string;
        static CODE_ROLE_SIGNATAIRE_04: string;
        static CODE_ROLE_SIGNATAIRE_05: string;
        static CODE_ROLE_SIGNATAIRE_06: string;
        static CODE_ROLE_SIGNATAIRE_07: string;
        static CODE_ROLE_SIGNATAIRE_AUTRES_99: string;
    }
}

declare module myway.comOpesFinancieres.Filtres {
}
...
declare module myway.comOpesFinancieres {
    class InformationsComplementairesController {
        ...
        estLibelleOperationDesactive: boolean;
...
declare module myway.comOpesFinancieres {
    class JournalActiviteBancaireBordereauService {
        ...
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgentExtended, postOperationFinanciereService: myway.comOpesFinancieres.PostOperationFinanciereService, documentContenuService: myway.comOpesFinancieres.DocumentContenuService, $q: ng.IQService, serviceTrace: myway.comOpesFinancieres.ServiceTrace);
        /**
         * Permet de poster un bordereau dans le JAB via le service REST
         * @param bordereau Bordereau
         */
        postBordereauRest(bordereau: Model.JAB.Bordereau): ng.IPromise<Model.JAB.Bordereau>;
        /**
         * Permet de faire un POST du bordereau d'operation dans le JAB
         * @param bordereauOperation Bordereau operation
         * @param client Client
         * @param proprietesDoc Proprietes doc
         * @param identificationCodeApplication Identification code application
         * @param identifiantArchivage Identifiant archivage
         * @param signatureSag Indique si on est en signature sag
         */
        postBordereauOperationDansJournalActiviteBancaire(bordereauOperation: myway.comOpesFinancieres.Model.BordereauOperation, client: MyWay.Model.Client, identifiantBordereau: string, proprietesDoc?: MyWay.Services.Impression.ProprietesDoc, identificationCodeApplication?: string, identifiantArchivage?: string, signatureSag?: boolean): ng.IPromise<myway.comOpesFinancieres.Model.JAB.Bordereau>;
        /**
         * Récupère les informations du document
         * @param identificationCodeApplication Identification code application
         * @param identifiantArchivage Identifiant archivage
         */
        recuperationInformationsDocument(identificationCodeApplication: string, identifiantArchivage: string): ng.IPromise<ConsulterDocumentOutput>;
        /**
         * Gestion de la billetterie pour le bordereau JAB
         * @param bordereauOperation
         */
        gestionBilletterieBordereauJab(bordereauOperation: myway.comOpesFinancieres.Model.BordereauOperation): myway.comOpesFinancieres.Model.JAB.BilletterieJAB[];
        /**
         * Mappage de la billetterie Opéfi en billetterie Jab
         */
        creationValeurTableauBilletterieJab(typeOperation: string, billetterie: myway.comOpesFinancieres.Model.SegmentBilleterie): myway.comOpesFinancieres.Model.JAB.BilletterieJAB[];
        /**
         * Création d'un objet de Billetterie JAB
         * @param codeValeurFaciale Code valeur faciale
         * @param typeOperationBilletterie Type operation billetterie
         * @param nombreBillet Nombre de billet
         * @param montantMonnaie Montant de la monnaie
         * @param chiffreValeurBillet Chiffre valeur du billet
         */
        creationObjetBilletterieJab(codeValeurFaciale: string, typeOperationBilletterie: string, nombreBillet?: number, montantMonnaie?: number, chiffreValeurBillet?: number): myway.comOpesFinancieres.Model.JAB.BilletterieJAB;
    }
}
...
declare module myway.comOpesFinancieres {
    class JournalApplicatif {
        ...
        private serviceTrace;
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, modalService: MyWay.UI.ModalService, operationFinanciereService: myway.comOpesFinancieres.OperationFinanciereService, saisieRiceService: myway.comInterdomaine.SaisieRiceService, serviceTrace: myway.comOpesFinancieres.ServiceTrace);
        private stringDefi(donnee);
        /**
         * Vérifie dans le contexte si on est en aJabber
         */
        private getAJabber();
        /**
         * Récupère le numéro de plan dans le context
         */
        private getNumPlan();
        /**
         * Permet l'alimentation du buffer JAB d'une opération financière
         * @param operationFinanciere Operation Financiere
         * @param aJabber Indique si on est aJabber
         * @param identifiantBordereau Identifiant bordereau
         */
        private alimentationBufferJab(operationFinanciere, aJabber, identifiantBordereau, estRepartitionEnCoursTraitement?);
        /**
         * Permet l'alimentation du PTU (Jab PTU) et JAB Bordereau (si non SAG)
         * @param opefi Operation Financiere
         * @param eligibiliteSag Indique si on est éligible à la SAG ou non
         */
        alimenterPTUsansJAB(opefi: myway.comOpesFinancieres.Model.OperationFinanciere, eligibiliteSag: boolean): ng.IPromise<void>;
        /**
         * Permet l'alimentation du PTU (Jab PTU) et JAB Bordereau (si non SAG)
         * @param opefi Operation Financiere
         * @param eligibiliteSag Indique si on est éligible à la SAG ou non
         */
        alimenterPTU(opefi: myway.comOpesFinancieres.Model.OperationFinanciere, eligibiliteSag: boolean): ng.IPromise<void>;
        /**
         * Traitement de l'alimentation du JAB Bordereau + son enregistrement en central
         * @param bufferJab Buffer JAB
         * @param opefi Operation Financiere
         * @param eligibiliteSag Eligible SAG
         */
        private traitementAlimenterJabBordereauEtEnregistrer(bufferJab, opefi, eligibiliteSag, estRepartitionEnCoursTraitement?);
        private alimenterJabFacturation(operationFinanciere, aJabber, identifiantBordereau, eligibiliteSag, estVrac);
        /**
         * Transforme un RICE caractères en RICE Objet
         * @param chaine rice en chaine de caractères
         */
        transformeEnRice(chaine: string): MyWay.Model.Rice;
        /**
         * Alimentation du JAB Bordereau PTU
         * @param opefi Operation Financiere
         * @param eligibiliteSag Eligibilite SAG
         */
        private alimenterJabBordereauPTU(opefi, eligibiliteSag, estRepartitionEnCoursTraitement?);
    }
}
...
declare module myway.comOpesFinancieres.Model {
    ...
    class LigneBordereauOperation {
        ...
        /**
         * Tableau des montants de répartitions du chèque recu (Mode financier 02).
         */
        plusieursCheques: string[];
        /** Fonctionnalite de l'opération. */
        fonctionnalite: MyWay.Model.Fonctionnalite;
    }
    /**
    ...
    class BordereauOperation {
         ...
         */
        lignesBordereauOperation: LigneBordereauOperation[];
        /**
...
declare module myway.comOpesFinancieres {
    ...
    interface IParamCaracteristiqueEDS {
        codeEtablissement?: string;
        identifiantInterneEDS?: number;
        typeEDS?: string;
        referenceExterneEDS?: number;
...
declare module myway.comOpesFinancieres.Model {
    ...
    interface IApplicationInputContext {
         ...
         */
        donneesBordereau: IContexteCarteTempo | IContexteOperation;
    }
    ...
    interface IContexteCarteTempo {
        ...
        /**
         * Titre ou rôle de la personne
         */
        titreRolePersonne: string;
        /**
         * Libellé du code civilité
         */
        civilite: string;
        /**
        ...
        /**
         * Libellé code régime matrimonial
         */
         ...
         */
        operation: IContexteCarteTempoOperation[];
        /**
         * Libellé de l'agent signataire
         */
        libelleAgentSignataire: string;
        /**
         * Libellé de l'établissement signataire
         */
        libelleEtablissementSignataire: string;
    }
    interface IContexteCarteTempoOperation {
        /**
         * Numéro de compte
         */
        numeroCompte: string;
        /**
         * Type d'opération (dépôt ou retrait d'espèces)
         */
        typeOperation: string;
        /**
         * Montant de l'opération et devise
         */
        montant: string;
        /**
         * Titre du rôle du client signataire
         */
        titreRolePersonne: string;
    }
    interface IContexteOperation {
        /**
         * Référence de l'acte dans l'entête
         */
        referenceActe: string;
         ...
         */
        listeOperation: IContexteOperationDetailsOperation[];
        /**
         * Montant espèces dépôt
         */
        montantEspecesDepot: string;
        /**
         * Montant pièces de monnaie dépôt
         */
        montantMonnaieDepot: string;
        /**
         * Détails billetterie dépôt
         */
        detailsBilleterieDepot: IContexteOperationDetailsBilletterie;
        /**
         * Montant espèces retrait
         */
        montantEspecesRetrait: string;
        /**
         * Montant pièces de monnaie retrait
         */
        montantMonnaieRetrait: string;
        /**
         * Détails billetterie retrait
         */
        detailsBilleterieRetrait: IContexteOperationDetailsBilletterie;
        /**
         * Libellé de l'agent signataire
         */
        libelleAgentSignataire: string;
        ...
        numeroAgent: string;
        /**
         * Affichage du bloc avis
         */
        affichageAvis: boolean;
    }
    interface IContexteOperationDetailsOperation {
        /**
        ...
        /**
         * Sens d'imputation du compte ("+" ou "-")
         */
        ...
        montant: string;
        /**
         * Numéro de chèque de banque
         */
        numChequeBanque: string;
        /**
         * Liste des montants des chèques dans le cas d'un dépôt d'une remise de chèque avec plusieurs chèques
         */
        ...
        soldeCompte: string;
        /**
         * beneficiaireChequeBanque
         */
        beneficiaireChequeBanque: string;
    }
    interface IContexteOperationDetailsBilletterie {
        /**
        ...
        nbBillets100: string;
        /**
         * Nombre de billets de 200
         */
        nbBillets200: string;
        /**
         * Nombre de billets de 500
         */
        nbBillets500: string;
    }
    interface IContexteOperationMontantCheque {
        /**
         * Montant du chèque
         */
        montant: string;
...
declare module myway.comOpesFinancieres.Model {
    interface ITableUsageProduitServicesDV7I {
        /**
         * Rubrique COCXBQ - Code etablissement.
         */
        COCXBQ: string;
        /**
         * Rubrique IDEGPS - Identifiant produit service.
         */
        IDEGPS: string;
        /**
         * Rubrique CODIPR - Code type produit service.
         */
        CODIPR: string;
        /**
         * Rubrique COEXSP - Sous code produit.
         */
        COEXSP: string;
        /**
         * Rubrique CIGLDM - Code mode gestion livret.
         */
        CIGLDM: string;
        /**
         * Rubrique CODMPR - Type produit service.
         */
        CODMPR: string;
        /**
         * Rubrique CIDMPR - Indic remontee auto resultats.
         */
        CIDMPR: string;
    }
    interface IResultat {
         ...
         * 5 : Cloture
         *
         * Résultat sur échéancier (2)
         * 2 : Augmentation de l'échéance
         * 3 : Réduction de l'échéance
         * 4 : Création
         * 5 : Suppression
         *
         * Résultat sur équipement (3)
         * 4 : Souscription
         * 5 : Résiliation
         *
         * Résultat sur crédit (4)
         * 2 : Augmentation d'échéance
         * 3 : Réduction d'échéance
         * 4 : Ouverture
         * 5 : Cloture
         * 6 : Remboursement partiel
         *
         * Résultat sur les valeurs mobilières et les bons (5)
         * 2 : Rachat
         * 3 : Souscription
         *
         * Résultat sur immobilier (6)
         * 2 : Vente
         * 3 : Achat
         *
         * Résultats sur CRA       (7)
         ...
         * 4 : Rendez-vous
         *
         * Résultats réaction GERC sur produit  (8)
         * 2 : A relancer
         * 3 : Pas intéressé
         * 4 : Intéressé
         * 5 : Réfléchit
         ...
         * Correspond à un produit/service élémentaire ou à
         * un regroupement de P/S
         *
         * Détermine le format de la référence du contrat
         * (produit ou service en gestion : compte, crédit ...)
         *
         * Exemples de valeurs :
         *
         * A000     ASSURANCE SUR LIVRET A
         * B001     ASSURANCE COURT TERME PROF.
         * B002     ASSURANCE SUR COMPTE PROF.
         * C127     ASSISTANCE VIE
         * C135     RICOCHET
         * C858     NUANCES 3D
         * etc...
         ...
         * 01050    Tribu sur CDD
         * 01080    Retrait
         * 03200    Visa premier immédiat
         * 03230    Visa immédiat
         * 13200    Visa premier différé
         * 13230    Visa différé
         * 22140    CBN professionnel immédiat sans retrait
         */
 ...
 * Fichier généré le : 2017-01-09
 */
declare module myway.comOpesFinancieres.Model.JAB {
    class Bordereau {
...
declare module myway.comOpesFinancieres {
    ...
    interface IDonneeCommuneProduit {
        ...
        /**
         * cumul fonds mis à disposition instant payment.
         */
        cumulFondsMisADispoinstpay: number;
        /**
         * cumul réserve de fonds instant payment
         */
...
declare module myway.comOpesFinancieres.Model {
    ...
    class OperationFinanciere {
        /**
         * Le contexte de la saisie de l'opération financière contenant les informations de la caisse et agent : code établissement, agent, etc ...
         */
        ...
        modeFinancier: MyWay.Model.ModeFinancier;
        /**
         * Le code de l'opération financière, souvent "N" ou "A" pour une annulation/extourne
         */
        codeOperation: string;
        /**
        ...
        /**
         * Indique si l'opération financière saisie est valide en fonction de contrôles (montant, etc)
         */
        estValide: boolean;
        /**
         ...
         * sinon on affichera le champ de saisie
         */
        ...
        operationDiverse: MyWay.Model.OperationDiverse;
        /**
         * Contient la référence enveloppe (référence sac).
         */
        referenceEnveloppe: myway.comOpesFinancieres.Model.ReferenceEnveloppe;
        /**
         * Libelle bénéficiaire utilisé pour les bordereaux de virement immediats par exemple.
         */
        libelleBeneficiaire: string;
        /**
         * IBAN bénéficiaire utilisé pour les bordereaux de virement immediats par exemple.
         */
        ibanBeneficiaire: string;
        /**
         * BIC bénéficiaire utilisé pour les bordereaux de virement immediats par exemple.
         */
        bicBeneficiaire: string;
        /**
         * Contient la répartition du chèque de banque.
         */
        ...
        /**
         * Contient les données sur la facturation d'une prestation pour un retrait avec chèque de banque ou un vrac
         */
        facturationPrestation: myway.comOpesFinancieres.Model.FacturationPrestation;
        /**
         * Indique si un libelle d'opération a était personnalisé dans l'objet LibelleOperation.
         * Si oui on ne déclenchera pas le traitement qui récupère le libellé de la caisse dans la table délocalisée OU4A par son mode financier
         * au chargement.
         */
        ...
        referenceOAD: string;
        /**
         * Contient le compte à retirer de la liste des comptes du virement Interne.
         */
        compteAEnleverListeComptesVirementInterne: MyWay.Model.Contrat;
        /**
         * Indique si c'est une opération de régul.
         * Si oui on cache le vrac par exemple
         */
        estOperationRegularisation: boolean;
        /**
         * Indique si c'est une extourne avec répartition par chèque de banque.
         */
        estExtourneRepartitionChequeBanque: boolean;
        /**
         * Permet d'indiquer si on restitue la liste des comptes CCI dans la liste des comptes.
         */
        restituerCompteCCIPourListeComptes: boolean;
        /**
         * Contient le libelle complementaire pour les operations depot/retrait en compte 08.
         */
        libelleComplementaire2: string;
        /**
         * Plafond de versement.
         */
        plafondVersement: myway.comOpesFinancieres.Model.PlafondVersementParametre;
        /**
         * Permet de forcer l'affichage du RICE Saisie dans le composant virement interne au lancement de l'opération financière.
         */
        forcerAffichageRiceSaisieDansVirementInterne: boolean;
        /**
         *  la case Choix billetterie coché ou non
         */
        choixBilletterieTMF: boolean;
        /**
         *  liste des ventilation de billetterie choisi
         */
        listeRepartitionBilletterieTMF: Array<myway.comOpesFinancieres.CarteTMF.IRepartitionProposition>;
        /**
         *  Permet de distinguer les opterations d'ouvertures et de reprises
         */
        estRepriseOffre: boolean;
    }
    /**
...
declare module myway.comOpesFinancieres.Model {
    ...
    class PlafondVersementParametre {
        /**
         * Contient le plafond de versement de la ressource REST.
         */
        plafondVersementRest: IPlafondVersement;
        /**
         * Indique si on a déjà affiché la popup de plafond de versement.
         */
...
declare module myway.comOpesFinancieres.Model {
    ...
    class ParametreRepartition {
        ...
        repartitionMemorisee: myway.comOpesFinancieres.Model.Repartition;
        constructor(paramLC?: MyWay.Model.ParametresListeComptes, montantTotal?: MyWay.Model.MontantDevise, rice?: MyWay.Model.Rice, iban?: string, repartition?: myway.comOpesFinancieres.Model.Repartition);
    }
    class TableauRepartitionExtourne {
        numeroCompte: string;
        montant: number;
        libelle: string;
        constructor();
...
declare module myway.comOpesFinancieres.Model {
    interface ITableDelocaliseeGU4E {
        CDMBSR: string;
        CIGXRC: string;
        CODIPR: string;
        COHCBQ: string;
...
declare module myway.comOpesFinancieres {
    interface ITarificationPrestation {
        ...
        libelleCourtOperationComptable: string;
    }
}
...
declare module myway.comOpesFinancieres {
    class OperationDiverseService {
        ...
        /**
         * Mise en place fonction pour effectuer les 3 filtres
         * @param
         */
        estValideFiltre456(valueType: MyWay.Model.TypeOperationDiverse, nouvelleDate: string, decoupageCodeOperationDiverse: string, devise: string, codeFonctionnalite: string): boolean;
        /**
...
declare module myway.comOpesFinancieres {
    class OperationFinanciereExtourneController implements MyWay.UI.ISelectionChangeHandler {
        private $scope;
        private operationFinanciereService;
        private operationDiverseService;
        private $q;
        ...
        montantBilletterie: number;
        estRepartitionChequeBanque: boolean;
        afficherTableauRepartitionChequeBanque: boolean;
        tableauRepartitionChequeBanque: MyWay.UI.ImwTableOptions;
        montantGlobalRepartition: number;
        numeroRiceCompteCredite: string;
        afficherVirementInterne: boolean;
        afficherLibelleNonModifiable: boolean;
        constructor($scope: ng.IScope, operationFinanciereService: myway.comOpesFinancieres.OperationFinanciereService, operationDiverseService: myway.comOpesFinancieres.OperationDiverseService, $q: ng.IQService, postOperationFinanciere: PostOperationFinanciereService, miniProfilService: MiniProfilService);
        /**
         * Traitement pour le chèque de banque, mode financier 09
         * @param codeModeFinancier Code mode financier
         */
        traitementChequeBanque(codeModeFinancier: string): ng.IPromise<Model.Repartition>;
        private traitementRecuperationInformationsComptesRepartitionChequeBanque(rice, devise);
        onSelectionChange(selectedObject: Object): void;
        /**
         * Traitement pour mode financier virement interne 06
         * @param codeModeFinancier Code mode financier
         * @param segmentVirementInterne Segment virement interne
         */
        traitementVirementInterne(codeModeFinancier: string, segmentVirementInterne: myway.comOpesFinancieres.Model.SegmentPRVRIOUGR[]): void;
        /**
        ...
        private decoupageRicePourAffichage(rice);
    }
}
...
declare module myway.comOpesFinancieres {
    class OperationDiverseListeController {
        ...
        fonctionnalite: MyWay.Model.Fonctionnalite;
        devise: MyWay.Model.Devise;
        isAfficherLibelleNumerique: boolean;
        texteLibelleUlip06: string;
        texteLibelleUlip07: string;
        saisieLibelleUlip06: string;
        saisieLibelleUlip07: string;
        ...
        typeOdChoix: MyWay.Model.TypeOperationDiverse;
        familleOdChoix: MyWay.Model.FamilleOperationDiverse;
        isSchemaComptableMutliple: boolean;
        montantSchemaComptableMultiple: number;
        montantHorsTaxe: string;
        montantTVA: string;
        comjtc: string;
        montantTaux: string;
        constructor($scope: ng.IScope, operationDiverseService: OperationDiverseService, $q: ng.IQService);
...
declare module myway.comOpesFinancieres {
    class ReferenceEnveloppeOperationControleur {
        ...
        static MESSAGE_CONFIRMATION_REFERENCE_ENVELOPPE: string;
        fonctionnalite: MyWay.Model.Fonctionnalite;
        numeroReferenceEnveloppeSaisie: string;
        /**
         * Constructeur pour la directive référence enveloppe opération
         * @param $scope
         * @param $q
         * @param saisieReferenceEnveloppeService
         */
        constructor($scope: ng.IScope, $q: ng.IQService, saisieReferenceEnveloppeService: SaisieReferenceEnveloppeService);
        /**
         * Permet de récupérer les habilitations via le service agent.
         */
        recuperationHabilitation(): ng.IPromise<boolean>;
        /**
         * Force la mise à jour du modèle par la saisie
         */
        miseAJourSac(): void;
        /**
         * Afficher ou non le composant ReferenceEnveloppe en fonction du mode financier sélectionné et de l'habilitation.
         ...
         */
        afficherOuNonReference(modeFinancier: string): boolean;
        modificationNumeroEnveloppe(): void;
        /**
         * Ajout du chiffre 0 devant la reference enveloppe pour avoir un total de 10 chiffres.
         */
        affinerNumeroEnveloppe(): void;
    }
}
...
declare module myway.comOpesFinancieres {
    class RepartitionController {
        ...
        afficheRice2: boolean;
        afficheRice3: boolean;
        montantTotalRepartition: number;
        ...
        changementLibelleRepartition(): void;
        /**
        ...
        valider(): void;
        /**
         * Si la répartition mémorisée a en compte débité 2 "Autre Compte" on affiche le rice2
         */
        afficheRice2SiRepartitionMemorisee(): void;
        /**
         * Si la répartition mémorisée a en compte débité 3 "Autre Compte" on affiche le rice3
         */
        afficheRice3SiRepartitionMemorisee(): void;
        /**
         * Retourne la différence de la répartition
         */
        getDifferenceRepartition(): number;
        /**
         * Retourne le montant total de la repartition
         */
        getMontantTotalRepartition(): number;
    }
}
...
declare module myway.comOpesFinancieres {
    class SaisieOperationFinanciereController {
        ...
        private libelleComplementaire2Service;
        private operationFinanciereValueService;
        static $inject: string[];
        /**
         ...
         * private identifiantProcessus: string;
         */
        /**
        ...
        /**
         * Clé du mode financier
         */
        private cleModeFinancier;
        /**
        ...
        /**
         * Boolean qui indique si on desactive le mode financier.
         */
        modeFinancierDesactive: boolean;
        /**
        ...
        private estTraitementRiceInterneTermine;
        private estTraitementListeCompteTermine;
        /**  Libelle du montant. */
        libelleMontant: string;
        /**
        ...
        /**
         * case à chocher 'Choix billetterie'
         */
        habiliteChoixBilletterie: boolean;
        choixBilletterieChecked: boolean;
        loading: boolean;
        afficherLibelleComplementaire2ParFonctionnalite: boolean;
        afficherLibelleComplementaire2ParModeFinancier: boolean;
        estObligatoireSaisieLibelleComplementaire2: boolean;
        /**
         * Affiche ou non la référence OAD
         */
        afficherReferenceOAD: boolean;
        /**  Libelle du montant. */
        libelleVirementInterne: string;
        estPlacerFocusModeFinancierInitialisation: boolean;
        /**
         * Ajout de la possibilité de désactiver le mode financier et le libellé d'opération
         */
        estModeFinancierDesactive: boolean;
        estLibelleOperationDesactive: boolean;
        private authentificationInfo;
        afficheErreurChampMontant: boolean;
        modeFinancierPrecedent: MyWay.Model.ModeFinancier;
        modeFinancierModes: MyWay.Model.ModeFinancier[];
        initialisationInformationsComplementaires: boolean;
        constructor($scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, operationFinanciereService: myway.comOpesFinancieres.OperationFinanciereService, compteService: myway.comInterdomaine.CompteService, modeFinancierService: myway.comInterdomaine.ModeFinancierService, deviseService: myway.comInterdomaine.DeviseService, modalService: MyWay.UI.IModalService, interDomainCoreService: myway.comInterdomaine.InterDomainCoreService, $q: ng.IQService, repartitionService: myway.comOpesFinancieres.RepartitionService, plusieursChequesService: myway.comOpesFinancieres.PlusieursChequesService, facturationAutomatiqueService: myway.comOpesFinancieres.FacturationAutomatiqueService, miniProfilService: myway.comOpesFinancieres.MiniProfilService, carteTempoMultiFonctionsService: CarteTMF.CarteTempoMultiFonctionsService, caisseAutoService: CaisseAutoService, saisieRiceService: myway.comInterdomaine.SaisieRiceService, listeCompteService: myway.comInterdomaine.ListeCompteService, champsErreursOpeFiService: myway.comOpesFinancieres.ChampsErreursOpeFiService, libelleComplementaire2Service: LibelleComplementaire2Service, operationFinanciereValueService: myway.comOpesFinancieres.OperationFinanciereValueService);
        isFonctionOverture(): boolean;
        private getLibelleOperation();
        private getLibelleOperationMemorise();
         ...
         * @param {string} modeFinancier
         */
        affichageBlocsParModeFinancier(modeFinancier: string): ng.IPromise<void>;
        /**
        ...
        /**
         * Permet d'ouvrir la popup d'erreur pour le plafond de versement.
         */
        ouverturePopupErreurPlafondVersement(): void;
        /**
        ...
        /**
         * Se déclenche lors de la modification du libelle complementaire
         */
        modificationLibelleComplementaire(): void;
        /**
         ...
         */
        calculPlafondVersementService(): ng.IPromise<void>;
        /**
        ...
        /**
         * Traitement spécifiques à la cloture de compte
         */
        traitementSpecifiqueCloture(): void;
        /**
         * Traitement specifique pour afficher les composants depots ou retraits (En OAD ou non)
         */
        traitementSpecifiqueDepotRetrait(): void;
        /**
         * Traitement specifique pour retablir de bon fonctionnement des opérations multiples depots ou retraits.
         */
        traitementSpecifiqueDepotRetraitOpérationMultiple(): ng.IPromise<void>;
        ...
        /**
         * Traitement spécifique pour le libelle complementaire 2 des comptes 88
         */
        traitementSpecifiqueLibelleComplementaire2(): void;
        /**
         * Action sur la case 'Choix Billetterie'
         */
        actionCaseChoixBilletterie(): void;
        checkMemoSegmentPrvRio(segmentPrvRio: myway.comOpesFinancieres.Model.SegmentPRVRIO, provenance: String): myway.comOpesFinancieres.Model.SegmentPRVRIO;
        checkMemoOperationFinanciere(provenance: String): myway.comOpesFinancieres.Model.OperationFinanciere;
        estUneOuverture04VPC(): boolean;
        remplirModesFinancier(): void;
        labelModesFinancier(mode: MyWay.Model.ModeFinancier): string;
    }
}
...
declare module myway.comOpesFinancieres {
    class CaisseAutoService {
         ...
         */
        private getNumPlan();
        deposerEspeces(referenceExterneAgent: string, numeroPersonne: string, montantSaisie: number): ng.IPromise<number>;
...
declare module myway.comOpesFinancieres {
    class ChampsErreursOpeFiService {
        ...
        constructor();
        /**
         * Champ en erreur du mode financier
         */
        getChampErreurModeFinancierVide(): Model.ChampErreurOperationFinanciere;
        /**
         * Champ en erreur de la référence OAD (Retrait et Depot OAD)
         */
        getChampErreurReferenceOAD(): Model.ChampErreurOperationFinanciere;
        /**
         * Champ en erreur de plafond versement dépassé
         */
        getChampErreurPlafondVersementDepasse(): Model.ChampErreurOperationFinanciere;
        /**
         ...
         * Champ en erreur du titulaire du compte
         */
        getChampErreurLibelleComplementaire(): Model.ChampErreurOperationFinanciere;
        /**
        ...
        /**
         * Champ en erreur dépassement montant maximum
         */
        getChampErreurDepassementMontantMax(): Model.ChampErreurOperationFinanciere;
        /**
...
declare module myway.comOpesFinancieres {
    class EntretiencommercialResultatEntretienService {
        private serviceAgentExtended;
        private $q;
        private $filter;
        private operationFinanciereService;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $q: ng.IQService, $filter: ng.IFilterService, operationFinanciereService: OperationFinanciereService);
        /**
         * Post un suivi commercial
         * @param resultatEntretien Objet du resultat entretien en IResultat
         * @param versionTraitement Version du traitement
         */
        postResultatEntretien(resultatEntretien: Model.IResultat, versionTraitement?: string): ng.IPromise<Model.IResultat>;
        /**
         * Post le suivi commercial d'une repartition cheque de banque
         * @param operationFinanciere Operation Financiere
         * @param estDepot Indique si c'est un depot
         * @param estExtourne Indique si c'est une extourne
         */
        postSuiviCommercialRepartitionChequeBanque(operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere, estDepot: boolean, estExtourne: boolean): ng.IPromise<any>;
        /**
         * Post le suivi commercial d'une facturation
         * @param operationFinanciere Operation Financiere
         */
        postSuiviCommercialVirementInterneContrepartie(operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere, compteContrepartie: MyWay.Model.Compte, estExtourne: boolean, estDepot: boolean): ng.IPromise<void>;
        /**
         * Post le suivi commercial d'une facturation
         * @param operationFinanciere Operation Financiere
         * @param estExtourne Indique si c'est une extourne
         */
        postSuiviCommercialFacturation(operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere, estExtourne: boolean): ng.IPromise<void>;
        /**
         * Permet d'enregistrer via le service REST "entretiencommercial-v1/resultatEntretien" le suivi commercial d'une opération financière
         * @param operationFinanciere Operation Financiere
         * @param estExtourne Indique si c'est une extourne
         * @param estDepot Indique si c'est un dépôt
         */
        suiviCommercialOperationFinanciere(operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere, estExtourne: boolean, estDepot: boolean, estPresenceClient: boolean, estSuiviCommercialContrepartieVirementInterne?: boolean, compteContrepartieVirementInterne?: MyWay.Model.Compte): ng.IPromise<void>;
        /**
         * Permet d'alimenter un objet IResultat permettant le post du service REST
         * @param operationFinanciere Objet Operation Financiere
         * @param estDepot Indique si c'est un depot
         * @param estExtourne Indique si c'est une extourne
         * @param estFacturation Indique si c'est une facturation
         */
        private alimentationObjetEntretienCommercial(operationFinanciere, estDepot, estExtourne, estFacturation);
        /**
         * Permet de récupérer les données usages produits services de la table DV7I
         * @param codeEtablissement Rubrique COCXBQ
         * @param codeProduitService Rubrique CODIPR
         * @param identifiantProduitService Rubrique IDEGPS
         */
        recupererDonneesUsageProduitsServicesTableDV7I(codeEtablissement: string, codeProduitService: string, identifiantProduitService: string): ng.IPromise<Model.ITableUsageProduitServicesDV7I[]>;
    }
}

/**
 * Ressource : /tiers/v3/segmentCommercial
 * Lien Rest-it : http://restit-ref.sigcesie.caisse-epargne.fr/v3/tiers/segmentCommercial
 * Fichier généré le : 2018-02-14
 */
declare module myway.comOpesFinancieres {
    ...
    interface ISegmentCommercial {
        listeDetailRelations: Array<IDetailRelation>;
    }
    interface IObligationSecondLibelle {
        /**
         * Indicateur de saisie du second libellé sur opération versement espèce.
         */
        indicateurSaisieSecondLibelle: boolean;
    }
    interface IDetailRelation {
        /**
         * Code segmentation
         */
        codeSegmentation: string;
        /**
         * Code segment activation PRO
         */
        codeSegmentActivationPro: string;
        /**
         * Type segmentation SU mensuel
         */
        typeSegmentationSuMensuel: string;
        /**
         * Code segmentation SU mensuel
         */
 ...
 */
declare module myway.comOpesFinancieres {
    class LibelleComplementaire2Service {
        private serviceAgent;
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgentExtended);
        getIdentification(codeEtablissement: string, identifiantPersonne: number, eligibiliteEAI?: string, parametreAppel?: string): ng.IPromise<IIdentification>;
        getCodeObligationSecondLibelle(codeEtablissement: string, codeSegmentation: string): ng.IPromise<Array<IObligationSecondLibelle>>;
        /**
         * Permet de savoir si le libelle complementaire 2 (DEPOT/Retrait sur les compts 08) est obligatoire à la saisie
         * @param codeEtablissement Code etablissement
         * @param numeroPersonne Numero personne
         */
        estLibelleComplementaire2Obligatoire(codeEtablissement: string, numeroPersonne: number): ng.IPromise<boolean>;
    }
}
...
declare module myway.comOpesFinancieres {
    class MiniProfilService {
        ...
        /**
         * Récupère le solde minute compte d'un compte
         * @param rice RICE
         */
        getSoldeMinuteCompte(rice: string): ng.IPromise<number>;
    }
}
...
declare module myway.comOpesFinancieres {
    class OperationFinanciereService {
        ...
        determinerChampsEnErreurInitialisation(operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere, estOAD?: boolean): Model.ChampErreurOperationFinanciere[];
        /**
         * Retourne le libellé role (par exemple Titulaire, Cotitulaire, etc) du code role
         * @param codeRole Code role (par exemple 01, 02, etc)
         */
        libelleRoleSignataireParCodeRole(codeRole: string, codeRang?: number): string;
        /**
         * Retourne le code role modifie. La BAT Signataire utilisant ses propres codes rôles, opéfi utilisant les siens.
         * Il faut remapper pour correspondre à la table CODARM
         * @param codeRole Code role
         * @param codeRang Code Rang
         */
        mappingCodeRoleBatSignatairesVersOpefi(codeRole: string, codeRang: number): string;
        /**
         * Permet la création d'un ContexteSaisieOperationFinanciere
         */
        creationContexteSaisieOperationFinanciere(): ng.IPromise<myway.comOpesFinancieres.Model.ContexteSaisieOperationFinanciere>;
        /**
        ...
        /**
         * Permet de récupérer les caractéristiques d'un EDS.
         * @param codeEtablissement Code etablissement
         * @param referenceExterneEDS Reference externe EDS
         * @param typeEDS Type EDS
         * @param typeOrganisation Type Organisation
         */
        getCaracteristiquesEDS(codeEtablissement: string, referenceExterneEDS: number, typeEDS: string): ng.IPromise<ICaracteristiqueEDS>;
        /**
         * Modal d'OpeFi
         ...
         * @returns boolean
         */
        determinerActivationBoutonValiderEspecesDivers(montant: number, numeroReferenceEnveloppe: string, montantBilletterie: number, estDepassePlafondVersement: boolean, estLibelleOperationVide: boolean, estLibelleComplementaireObligatoire?: boolean, libelleComplementaire?: string): boolean;
        /**
         ...
         * @param {boolean} estModeDivers
         */
        initSegmentPrvRioOuvertureViaChoixUtilisateurs(operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere, devise: MyWay.Model.Devise, estModeDivers: boolean): myway.comOpesFinancieres.Model.SegmentPRVRIO;
        /**
        ...
        /**
         * Ajout du segment dans le context
         * @param segmentPrvRio Segment Prvrio
         * @param numeroPersonne Numéro de personne
         */
        ajoutSegmentDansContext(segmentPrvRio: myway.comOpesFinancieres.Model.SegmentPRVRIO, numeroPersonne: string): ng.IPromise<void>;
        /**
         * Traitement spécifique de reprise d'une opé OD par un choix UTIl
         * @param operationFinanciere
         * @param operationFinanciereChoixUtil
         */
        private traitementODPourRepriseChoixUtilVersOpefi(operationFinanciere, operationFinanciereChoixUtil);
        /**
         * Traitement spécifique de reprise d'un virement interne opéfi par choix util
         * @param operationFinanciere
         * @param operationFinanciereChoixUtil
         */
        private traitementVirementInternePourRepriseChoixUtilVersOpefi(operationFinanciere, operationFinanciereChoixUtil);
        /**
         ...
         */
        creationObjetParametreListeComptes(typeRecherche?: string, codeEtatRecherche?: string, listeNumerosPersonnes?: string[], numeroPersonne?: string, listeTypesProduits?: string[], codeDevise?: string, compteAEnlever?: MyWay.Model.Contrat, restituerCompteCCIPourListeComptes?: boolean): MyWay.Model.ParametresListeComptes;
        /**
...
declare module myway.comOpesFinancieres {
    class OperationFinanciereValueService {
        private serviceAgentExtended;
        static $inject: string[];
        private _operationFinanciere;
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere;
    }
}
...
declare module myway.comOpesFinancieres {
    ...
    class PostOperationFinanciereService implements IPostOperationFinanciereService {
        ...
        private miniProfilService;
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, journalApplicatif: myway.comOpesFinancieres.JournalApplicatif, identifiantBordereauService: myway.comInterdomaine.IdentifiantBordereauService, operationFinanciereService: myway.comOpesFinancieres.OperationFinanciereService, riceService: myway.comInterdomaine.SaisieRiceService, caisseAutoService: CaisseAutoService, $filter: ng.IFilterService, miniProfilService: MiniProfilService);
        /**
         * Permet de lancer de nouveau l'alimentation du bordereau pour le stocker dans le contexte.
         * @param operationFinanciere Operation Financière
         */
        repriseStockageBordereauOperationMyWay(operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere): ng.IPromise<void>;
        traitementPostOperationFinanciereSansPTU(operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere, eligibiliteSag: boolean): ng.IPromise<void>;
        traitementPostOperationFinanciereSansJABlocal(operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere, eligibiliteSag: boolean): ng.IPromise<void>;
         ...
         */
        private alimenterLigneBordereau(operationFinanciere);
        /**
         ...
         * @returns
         */
        recupererLibelleProduitPourUnCompte(codeEtablissement: string, codeProduit: string, codeDevise: string, codeGuichet: string, referenceProduitService: string): ng.IPromise<string>;
        ...
        private conversionDateSegmentEnFormatDateStandard(date);
    }
}
...
declare module myway.comOpesFinancieres {
    interface IControleCpteEmetteur {
        infoCompte: IInfoCompte;
    }
    interface IInfoCompte {
        /**
         * libellé donneur ordre
         */
...
declare module myway.comOpesFinancieres {
    class SoldeCompteController {
        ...
        soldeMinuteCompte: number;
        codeDevise: string;
        constructor($scope: ng.IScope, modalService: MyWay.UI.IModalService, miniProfilService: MiniProfilService, operationFinanciereService: OperationFinanciereService, soldeCompteService: SoldeCompteService);
        /**
        ...
        private traitementMiniProfil(riceCompte, codeGuichet, referenceProduitService);
        /**
    ...
    interface IDetailSoldeCompte {
        /** Montant du solde disponible venant de controleCpteEmmetteur. */
        ...
        /** Code devise. */
        codeDevise: string;
        /** Montant du solde disponible dans le detail de la popin (miniprofil). */
        soldeDisponibleDetail: number;
        /** Montant du cumul fonds mis à disposition. */
        fondsMisADisposition: number;
        /** Montant du cumul fonds réservés. */
...
declare module myway.comOpesFinancieres {
    class SoldeCompteService {
        private serviceAgent;
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgentExtended);
        getControleCpteEmetteur(codeEtablissement?: string, codeGuichet?: string, numeroCompteClientDonneurOrdre?: string, cleRibNumeroCompte?: string, typeVirementImmediat?: string): ng.IPromise<IControleCpteEmetteur>;
        /**
         * Récupère le solde en devise du compte
         * @param rice RICE du compte
         */
        getSoldeMinuteCompte(rice: string): ng.IPromise<number>;
    }
...
declare module myway.comOpesFinancieres {
    class TypeChequeController {
         ...
         */
        miseEnPlaceReserveEncaissementIHM(): void;
        /**
...
declare module myway.comOpesFinancieres {
    class TypeChequeService {
         ...
         * @returns number
         */
        calculerNombreJoursReserveEncaissement(nombreJours: number): number;
    }
}
...
declare module myway.comOpesFinancieres {
    class VracTarificationController {
        ...
        facturationPrestation: myway.comOpesFinancieres.Model.FacturationPrestation;
        constructor($q: ng.IQService, $scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, tarificationTarificationPrestationService: myway.comOpesFinancieres.TarificationTarificationPrestationService);
        /**
...
declare module myway.comOpesFinancieres {
    class VirementInterneController {
        ...
        codeGuichet: string;
        constructor($scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, operationFinanciereService: OperationFinanciereService);
        /**
         * Permet les traitements pour mettre a jour la liste des comptes en fonction des paramètres.
         */
        traitementRechercheComptes(): void;
        boutonSaisirCleanCompteSelectionne(): void;
        /**
...
declare module myway.comOpesFinancieres {
    class ChoixBilletterieController implements MyWay.UI.ISelectionChangeHandler {
        private $scope;
        private serviceAgentExtended;
        private gabEncaisseGabService;
        private algorithmeDistributionService;
        private carteTempoMultiFonctionsService;
        static $inject: string[];
        listeEncaisseGab: myway.comOpesFinancieres.CarteTMF.IEncaisseGabDetail[];
        listeRepartitionProposition: myway.comOpesFinancieres.CarteTMF.IRepartitionProposition[];
        listeRepartitionAffiche: myway.comOpesFinancieres.CarteTMF.IRepartitionProposition[];
        listeRepartition: myway.comOpesFinancieres.CarteTMF.IRepartitionProposition[];
        montantRetrait: number;
        montantDistribue: number;
        montantDifference: number;
        ventilationValide: boolean;
        ventilation10: number;
        ventilation20: number;
        ventilation50: number;
        ventilation100: number;
        estOuvertParDefaut: boolean;
        private indiceGabDistribuable;
        private modeChoixBilletterie;
        tableauHorsDirective: any;
        nombreColTable: string;
        nombreColEspace: string;
        constructor($scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, gabEncaisseGabService: myway.comOpesFinancieres.CarteTMF.GabEncaisseGabService, algorithmeDistributionService: myway.comOpesFinancieres.CarteTMF.AlgorithmeDistributionService, carteTempoMultiFonctionsService: CarteTMF.CarteTempoMultiFonctionsService);
        onSelectionChange(selectedObject: Object): void;
        /**
         * chercher les GAB
         */
        private initialiserBilletterie();
        /**
         * // calculer les repartition
         */
        private calculerlisteRepartition();
        /**
         * Vérification si le montant n'est pas 'undefined'
         */
        verifierUndefined(): void;
        /**
         * Vérification si le montant est correcte
         */
        verifierMontant(): void;
        /**
         * mettre à jour la liste des repartition sortant en fonction de la ventilation saisie
         */
        private miseAjourListeRepartition();
        /**
         * Liste des propositons affiché dans la page
         */
        private construireListeRepartitionAffiche();
    }
}

declare module myway.comOpesFinancieres {
    function mwsfChoixBilletterie(): ng.IDirective;
}
...
declare module myway.comOpesFinancieres.CarteTMF.impression {
    class ContractualisationCarteTMFService {
        private serviceAgentExtended;
        private $q;
        private $filter;
        private libelleCaisseService;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $q: ng.IQService, $filter: ng.IFilterService, libelleCaisseService: myway.comOpesFinancieres.CarteTMF.impression.LibelleCaisseService);
        /**
         * Appel de la SPA contractualisation pour la gestion et la génération du bordereau
         * @return void
         */
        routerVersSpaContractualisation(operationFinanciere: Model.OperationFinanciere, numeroCarte: string, estOAD?: boolean): ng.IPromise<void>;
        /**
...
declare module myway.comOpesFinancieres.CarteTMF.impression {
    ...
    class ImpressionBordereauCarteTMFService {
        ...
        private libelleCaisseService;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $q: ng.IQService, $filter: ng.IFilterService, libelleCaisseService: LibelleCaisseService);
        /**
...
declare module myway.comOpesFinancieres {
    class ModalInitialiserCarteTmfController {
        ...
        modalDatas: any;
        constructor($scope: ng.IScope, $modalInstance: ng.ui.bootstrap.IModalServiceInstance, modalService: MyWay.UI.ModalService, data: any);
        actionEntree(): void;
        /**
        ...
        /**
         * Dès qu'il y a une saisie dans le champ de texte
         */
        changementNumeroTmf(): void;
        /**
...
declare module myway.comOpesFinancieres.ImpressionBordereau {
    class ContractualisationOperationService {
        private serviceAgentExtended;
        private $q;
        private libelleCaisseService;
        private impressionBordereauService;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $q: ng.IQService, libelleCaisseService: myway.comOpesFinancieres.CarteTMF.impression.LibelleCaisseService, impressionBordereauService: ImpressionBordereauService);
        /**
         * Appel de la SPA contractualisation pour la gestion et la génération du bordereau
         * @return void
         */
        routerVersSpaContractualisation(client: MyWay.Model.Client, contexteSaisieOperationFinanciere: myway.comOpesFinancieres.Model.ContexteSaisieOperationFinanciere, operationFinanciere?: myway.comOpesFinancieres.Model.OperationFinanciere): ng.IPromise<void>;
        /**
         * Ressource qui permet de récupérer l'adresse d'un tiers.
         * @param {string} identifiantPersonne
         * @param {string} codeEtablissement
...
declare module myway.comOpesFinancieres.ImpressionBordereau {
    class GenerationBordereau {
        ...
        private constructionBlocOperationLigne2(blocLignes, lignesBordereauOperation, codeRole?);
        ...
        private constructionLignes3PlusieursCheques(blocLignes, plusieursCheques);
        /**
         * Permet la construction du bloc de synthese de billetterie pour le depot sans monnaie et billetterie.
         */
        private constructionBlocSyntheseBilletterieDepotSansMonnaieEtBilletterie(lignesBorderauOperation, montantBilletterieDepot);
        /**
         ...
         * Permet la construction du bloc de synthese de billetterie pour le depot.
         */
        private constructionBlocSyntheseBilletterieRetraitSansMonnaieEtBilletterie(lignesBorderauOperation, montantBilletterieRetrait);
        /**
         * Permet la construction du bloc de synthese de billetterie pour le depot.
         */
...
declare module myway.comOpesFinancieres {
    class ImpressionBordereauService {
        ...
        private serviceTrace;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, journalActiviteBancaireBordereauService: myway.comOpesFinancieres.JournalActiviteBancaireBordereauService, $q: ng.IQService, serviceTrace: myway.comOpesFinancieres.ServiceTrace);
        /**
