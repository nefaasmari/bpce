...
declare module MyWay.Contractualisation {
    ...
    interface IMediasSignatairesPro {
        ...
        listeAutresTitulairesCompte?: Array<IAutresTitulairesCompte>;
    }
    ...
    interface IAutresTitulairesCompte {
        titulaireCompte: ITitulaireCompte;
        listeSignataires: Array<ISignataireSimplifie>;
    }
}
...
declare module MyWay.Contractualisation {
    class DossierVenteService {
        ...
        private getSignataireFromListePersLiee(listePersonneLiee, listeSignataire);
...
declare module MyWay.Contractualisation {
    ...
    class ListerDossiersNumeriquesService {
         ...
         * @param multiDossierNumerique
         */
        createTitulaireCompte(multiDossierNumerique: IMultiDossiersNumeriques): ng.IPromise<MyWay.Contractualisation.ITitulaireCompte>;
        getInfosProEI(signataireEI: string): ng.IPromise<MyWay.Contractualisation.ITitulaireCompte>;
        getInfosProGMP(idPersonneEnLien: string): ng.IPromise<ITitulaireCompte>;
        createSignataireSimplifie(listeSignataires: Array<ISignataire>): ng.IPromise<Array<MyWay.Contractualisation.ISignataireSimplifie>>;
        /**
