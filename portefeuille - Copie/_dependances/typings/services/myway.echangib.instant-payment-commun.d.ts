...
declare module InstantPaymentCommun.Controleur {
    class IpFormPlafondsControleur {
        ...
        sousProduit: Modeles.Application.User.ISousProduit;
...
declare module InstantPaymentCommun.Controleur {
    class IpVirementControleur {
        ...
        isModeEcriture(): boolean;
        /**
         * Permet de récupérer le CONTEXTE_IP, soit les données entrées par l'utilisateur si il y en a
         */
        recupererContexteIp(): ng.IPromise<void>;
        /**
         * Initialisation valeurs par défaut des champs
         */
        initialiserDirective(): void;
...
declare module InstantPaymentCommun.Services.Application {
    interface IInstantPaymentService {
        ...
        getActeGestionOffre(codeActeGestion: string): Enum.ActeGestionEnum;
        formaterLibelleErreur(erreur: string): string;
    }
}
