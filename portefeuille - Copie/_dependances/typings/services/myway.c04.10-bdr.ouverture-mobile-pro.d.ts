...
declare module OuvertureMobilePro {
    var app: any;
}

/**
 * Contrôleur de la page d'ouverture MOBILE PRO
 * @author S0077536 (Arnaud Despalins)
 */
declare module OuvertureMobilePro.Controleurs {
    /**
     * Déclaration du contrôleur
     */
    class MobileProOuvertureControleur {
        private $scope;
...
/**
 * Contrôleur de la directive mw-mobile-pro-ouverture
 * @author S0077536 (Arnaud Despalins)
 */
declare module OuvertureMobilePro.Controleurs {
    /**
     * Déclaration du contrôleur
     */
    class MwMobileProOuvertureControleur {
        private $scope;
        private $rootScope;
        private serviceAgentExtended;
        private mobileProCaracteristiqueAbonnementService;
...
/**
 * Directive pour la gestion de l'affichage de la page d'ouverture Mobile PRO
 * @author S0077536 (Arnaud Despalins)
 */
declare module OuvertureMobilePro.Directives {
    /**
     * Déclarion du constructeur de la directive
     */
    function mwMobileProOuverture(): ng.IDirective;
}

/**
 * Service pour la gestion de l'objet issu du service REST "/contratbqdpro/v1/caracteristiqueAbonnement" pour MOBILE PRO Ouverture
 * @author S0077536 (Arnaud DESPALINS)
 */
declare module OuvertureMobilePro.Services.Application {
    /**
     * Interface du service
     */
    interface IMobileProOuvertureCaracteristiqueAbonnementService {
