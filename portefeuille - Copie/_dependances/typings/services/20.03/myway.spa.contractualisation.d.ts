...
declare module MyWay.Contractualisation {
    class RouteurControleur {
        ...
        constructor($scope: ng.IScope, routeurService: RouteurService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        estVisible: boolean;
    }
}
...
declare module MyWay.Contractualisation {
    class IdentificationSignControleur {
        ...
        private chargementLong;
        private titrePage;
        constructor($scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, contractualisationModaleService: ContractualisationModaleService, identificationSignService: IdentificationSignService);
    }
}
...
declare module MyWay.Contractualisation {
    ...
    class RemiseDocsSignesControleur {
        ...
        static $inject: string[];
        private isDocsSignesEnvoyesViaMsi;
        private chargementLong;
        private isOpenPanneauRetractable;
        isBouttonTerminerActive: boolean;
        private isPremierTentative;
        private isInitialise;
        private checkBoxOptions;
        multiDossiersNumeriques: IMultiDossiersNumeriques;
        constructor($scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, contractualisationModaleService: ContractualisationModaleService, remiseDocsSignesService: RemiseDocsSignesService);
        init(): void;
        mettreAJourAdresseEmail(): void;
        getDesignationSignataire(): string;
        isPlierPanneauRetractable(): boolean;
        checkboxModifier(): void;
        terminerAction(): void;
    }
}

declare module MyWay.Contractualisation {
    class RetourIcgControleur {
        private $scope;
        private serviceAgentExtended;
        static $inject: string[];
        private chargementLong;
...
declare module MyWay.Contractualisation {
    class ContractualisationModaleService {
        ...
        afficherModaleConfirm(headerText: string, bodyText: string, iconModale: string, boutonText: string): ng.IPromise<void>;
    }
}
...
declare module MyWay.Contractualisation {
    ...
    class IdentificationSignService {
         ...
         */
        private getDossierNumeriqueFromContractualisationActe(contractualisationActe);
        /**
         *
         * @param contractualisationActe
         */
         ...
         * @param contractualisationActe
         */
        private getMultiDossiersNumeriquesFromContractualisationActe(contractualisationActe);
        /**
         *
         * @param contractualisationActe
         */
        private getListeSignataireSEMDFromContractualisationActe(contractualisationActe);
        /**
         *
         * @param contractualisationActe
         */
        private getListeTitulaireDossierNumeriqueFromContractualisationActe(contractualisationActe);
        /**
         *
         * @param contractualisationActe
         */
        private getListeSignataireDossierNumeriqueFromContractualisationActe(contractualisationActe);
...
declare module MyWay.Contractualisation {
    ...
    class ImprimerDocsArchivesService {
        ...
        private sessionSignatureService;
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, imprimerDocsArchivesContexteService: ImprimerDocsArchivesContexteService, sessionSignatureService: SessionSignatureService);
        init(): ng.IPromise<void>;
        /**
         *
         */
        recupererDocumentsAImprimer(): ng.IPromise<Array<Myway.Ressource.DossierNumerique.IDocumentAImprimer>>;
        /**
         *
         * @param documentsAImprimer
         */
        imprimerDocumentsASignes(documentsAImprimer: Array<Myway.Ressource.DossierNumerique.IDocumentAImprimer>): ng.IPromise<boolean>;
        executerModeEchec(): void;
        /**
         *
         * @param valeurSortie
...
declare module MyWay.Contractualisation {
    ...
    class ListerDossiersNumeriquesService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, listerDossiersNumeriquesContexteService: ListerDossiersNumeriquesContexteService);
        init(): ng.IPromise<void>;
        /**
         *
         * @param valeurSortie
...
declare module MyWay.Contractualisation {
    ...
    class RemiseDocsSignesContexteModele implements IContractualisationContexteModele {
        multiDossiersNumeriques: IMultiDossiersNumeriques;
        authenficationInfo: MyWay.Services.Context.AuthentificationInfo;
        isAppelerConnaissanceClient: string;
        constructor(multiDossiersNumeriques: IMultiDossiersNumeriques, authenficationInfo: MyWay.Services.Context.AuthentificationInfo, isAppelerConnaissanceClient: string);
    }
}
...
declare module MyWay.Contractualisation {
    ...
    class RemiseDocsSignesService {
        ...
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, remiseDocsSignesContexteService: RemiseDocsSignesContexteService, adresseEmailSignataireService: AdresseEmailSignataireService);
        init(): ng.IPromise<void>;
        /**
         *
         */
        remiseDocumentsSignesViaMsi(): ng.IPromise<boolean>;
        /**
         *
         * @param imprimerDocsSignes
         * @param remiseDocsSignes
         */
        remiseDocumentsSignesViaAdresseMailPerso(imprimerDocsSignes: boolean, remiseDocsSignes: boolean): ng.IPromise<boolean>;
        /**
         *
         */
         ...
         * @param multiDossiersNumeriques
         */
        private getListeIdActeIdnFromMultiDossiersNumeriques(multiDossiersNumeriques);
        /**
         *
         * @param viaMsi
         * @param listeIdDossierNumerique
         * @param viaEmailPerso
         * @param emailSignataire
         * @param retournerDocuments
         * @param codeApplication
         * @param idTransactionIcg
         */
        private postRemiseDocumentsSignes(viaMsi, listeIdDossierNumerique, viaEmailPerso, emailSignataire, retournerDocuments, codeApplication, idTransactionIcg);
        /**
         * @param valeurSortie
         */
...
declare module MyWay.Contractualisation {
    class SessionSignatureService {
         ...
         * @param presenceTablette
         */
        postSessionSignature(codeApplication: string, listeIdActeIdn: Array<string>, codeModeContractualisation: string, identifiantSignataire: string, urlRetourIcg: string, presenceTablette: boolean): ng.IPromise<Myway.Ressource.DossierNumerique.ISessionSignature>;
        /**
         * putSessionSignature permet de mettre à jour une session de signature
         * @param sessionSignature
         */
        putSessionSignature(sessionSignature: Myway.Ressource.DossierNumerique.ISessionSignature): ng.IPromise<Myway.Ressource.DossierNumerique.ISessionSignature>;
        /**
         *
         * @param codeApplication
         * @param idTransactionIcg
...
declare module MyWay.Contractualisation {
    ...
    class SignerDocumentsElecService {
        ...
        static $inject: string[];
        sessionSingature: Myway.Ressource.DossierNumerique.ISessionSignature;
        constructor($q: ng.IQService, $window: ng.IWindowService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, sessionSignatureService: SessionSignatureService, signerDocumentsElecContexteService: SignerDocumentsElecContexteService);
        init(): ng.IPromise<void>;
        /**
         *
         * @param panier
         */
        initierSessionSignature(): ng.IPromise<void>;
        /**
         *
         * @param codeCanal
         */
         ...
         */
        private getListeIdentifiantIdn(listeDossierNumerique);
        updateSessionSignature(): ng.IPromise<void>;
...
declare module MyWay.Contractualisation {
    ...
    enum LisaCodeSortieEtapeIdnSignatairesEnum {
        ...
        CODE_LISA_PROCESSUS_MULTI_DOSSIER = 5,
    }
...
declare module MyWay.Contractualisation.Ressources.DossierContratServi {
    ...
    class DossierContratServiceInputFactory {
        ...
        createDossierContratServiceInputFromDossierNumerique(dossierNumerique: IDossierNumerique, codeEtablissementFinancier: string, codeModeContractualisation: string, codeGuichet: string, identifiantPorteurCarte: string, codeCanal: string): Myway.Ressource.DossierContratServi.IDossierContratServiceInput;
