...
declare module ComposantsCommunsCarte.Constantes {
    module Etablissement {
        const LIB_VALIDE_PAIEMENT: string;
        const LIB_DEI_PRO: string;
        const LIB_SOL_PRO_CAP: string;
        const LIB_ETAB_CAISSE_EPARGNE: string[];
        const LIB_ETAB_BCP: string[];
        const LIB_ETAB_CREDIT_COOP: string[];
        const LIB_ETAB_BTP: string[];
        const CODE_BCP: string;
        const CODE_CREDIT_COOP: string;
        const CODE_BTP: string;
        const LIBELLE_HABILITATION_INDEX: number;
        const LIBELLE_DEI_PRO_INDEX: number;
        const LIBELLE_SOL_PRO_CAP_INDEX: number;
    }
    module Carte {
        const TYPE_CARTE_PRO_IMMEDIAT: string;
        const TYPE_CARTE_PRO_DIFFERE: string;
        const TYPE_CARTE_RETRAIT: string;
        const TYPE_CARTE_DEPOT: string;
    }
}
...
declare module ComposantsCommunsCarte.Modeles.ContratCarte.Information {
    ...
    interface IContratCarte {
        ...
        /**
         * Indicateur choix envoi code confidentiel
         * 0 : Envoi avec mailer
         * 1 : Envoi sans mailer => consultation depuis web/mobile par le client
         */
        indicChoixEnvoiCodeConfidentiel: string;
        /**
         * Indicateur choix envoi code confidentiel à échéance
         * 0 : Envoi avec mailer
         * 1 : Envoi sans mailer => consultation depuis web/mobile par le client
         */
        indicChoixEcheanceCodeConf: string;
    }
    interface IOption {
        codeDuNiveauDeServiceDuContratCarte: string;
...
declare module ComposantsCommunsCarte.Modeles.ContratCarte.Recherche {
    ...
    interface IContratCarte {
        ...
        /**
         * " " - Service disponible mais jamais choisi
         * 0 - Le client a choisi de recevoir le mailer à échéance de la carte
         * 1 - Le client a choisi de ne pas recevoir le mailer avec son code pin (visualisation possible web et mobile)
         */
        indicChoixEcheanceCodeConf: string;
    }
    interface ICommandeDeLaCarte {
    ...
    interface ICarteDuContratCarte {
        ...
        codeDuProduitCarte: string;
        /**
         * Le numéro de série de la carte en cours correspond à l'identifiant sous lequel le client est connu chez le transporteur partenaire BPCE. Permet d'associer les titres de transport (à l'unité ou abonnement) en cours d'activité. Numéro de série unique par carte.
         */
        ...
        identifiantElementDeStructureDeDistribution: number;
        /**
         * Désignation décrivant l'élément de structure. Cette désignation est construite par concaténation du libellé court du type d'EDS (LCCEEL) et de la désignation de l'EDS (LICELI). Sauf si l'EDS est un PF on trouve alors le Nom+Prénom de l'Agent titulaire du PF.
         */
        ...
        /**
         * Indic éligib visu. code confidentiel
         * O = éligible
         * N = non éligible
         */
        indEligibleVisuCodeConf: string;
        /**
         * Indic choix envoi Code confidentiel
         * " " - Le service est dispo mais n'a jamais été choisi.
         * 0 - Choisi l'envoi du mailer pour le code pin
         * 1- Pas de mailer sur code pin (visualisation mobile / web)
         */
        indChoixEnvoiCodeConf: string;
    }
...
declare module ComposantsCommunsCarte.Modeles.ContratServiceBqd.SecurOpeEnLigne {
    interface ISecurisationOperationEnLigne {
        identificationSOL: IIdentificationSOL;
        caracteristiqueSOL: ICaracteristiqueSOL;
    }
    interface IIdentificationSOL {
        /**
         ...
         * Codification des Caisses d'Epargne : 1er car= 1 et le 5ème = 5
         *
         * Exemples :
    ...
    interface ICaracteristiqueSOL {
        /**
         * Détermine le système/support de sécurisation des opérations en ligne.
         *
         * Valeurs :
         *      'SMS'   :    SMS Particulier '01' ,
         *      'CAP'    :   CAP Particulier '02' ,
         *      'Cloudcard'    :   Sécur'Pass '06'
         */
        ...
        /**
         * Numéro de téléphone associé à l'enrôlement de type SMS.
         */
        ...
        /**
         * Heure de la demande de souscription (enrôlement) au  service SOL.
         */
        heureDemandeEnrolement: string;
        /**
         * Indicateur de demande d'envoi d'un SMS invitant le
         * client à finaliser la souscription, au service, initiée par le conseiller en agence.
         *
         * Valeurs :
         *    'O'        Oui - envoi demandé
         *    'N'        Non - envoi non demandé
         *    '  '        non concerné
         */
        invitationTransmise: string;
        /**
         * Code état de l'enrolement du moyen
         * Valeurs :
         * 1 = En attente d'activation
         * 2 = En cours d'activation
         * 3 = Actif
         * 4 = Bloqué à l'usage
         * 5 = Bloqué à l'enrolement
         * 6 = Résilié
         */
        codeStatutMoyen: string;
        /**
         * En cas de présence d'un délai d'ativation, c'est la date à partir de laquelle le moyen sera disponible.
         * Type date au format yyyy-MM-dd
         */
        dateDispoMoyen: string;
        /**
         * En cas de présence d'un délai d'ativation, c'est l'heure à partir de laquelle le moyen sera disponible. (en lien avec la date de disponibilité)
         */
        heureDispoMoyen: string;
        /**
         * Si le moyen est bloqué, c'est la date de fin du blocage.
         * Type date au format yyyy-MM-dd
         */
        dateFinBlocageMoyen: string;
        /**
         * Si le moyen est bloqué, c'est l'heure de fin de blocage (en lien avec la date de fin de blocage)
         */
        heureFinBlocageMoyen: string;
        /**
         * Permet de savoir si le moyen a été souscrit en agence ou en selfcare.
         */
        initieAgence: boolean;
    }
}
...
/**
 * Modèle de représentation des données du web service "demandemulticanal/recherche".
 * @author S0077965 (Martial BENOIST)
 */
declare module ComposantsCommunsCarte.Modeles.DemandeMultiCanal.Recherche {
    /**
     * Nom du module.
     * Pour info, cette exportation de variable est uniquement présent pour donner de la
     * visibilité aux interfaces dans les projets qui importent le composant commun.
    ...
    interface IDemande {
        ...
        /**
         * Identifiant porteur de la demande si
         * codeTypePorteurDemade = 1 (demande client) alors IdentifiantPorteur demande = Identifiant Personne
        ...
        dateCloture: string;
        /**
         * Correspond au statut ("Créée", "En cours", "Clôturée",  "Clôturée avec abandon" et « Abandonnée ») de la demande.
         *
         * Il est recommandé de s'appuyer sur le champ dateCloture pour permettre le filtrage des demandes terminées.
         */
        ...
        /**
         * Identifiant du statut de la demande
         *   - 0  : Sauvegardée
         *   - 1  : Créée
         *   - 2  : En Cours
         *   - 3  : Clôturée avec abandon
         *   - 4  : Abandonnée
         *   - 5  : Clôturée
         */
        idStatutDemande: string;
        /**
         * Canal d'origine de la demande (liste évolutive) : AGC, IMPT, DEI, EDEN, NEO, MYCG, LEP, GSET, MIF, ATAV, DRC, TRFT, SNUM, GCOC, EERD
         */
        canal: string;
    }
...
/**
 * Modèle de représentation des données du web service "demandemulticanal/tache".
 * @author S0077965 (Martial BENOIST)
 */
declare module ComposantsCommunsCarte.Modeles.DemandeMultiCanal.Tache {
    /**
     * Nom du module.
     * Pour info, cette exportation de variable est uniquement présent pour donner de la
     * visibilité aux interfaces dans les projets qui importent le composant commun.
...
declare module ComposantsCommunsCarte.Modeles.ProduitCarteParametre.CarteEtablissement {
    ...
    interface ICarteVisuelDeLaFamille {
         ...
         * CL : client
         */
        codeLieuAdressagePremiereCarte: string;
        /**
         * Indic éligib visu. code confidentiel O = éligible N = non éligible
         */
        indEligibleVisuCodeConf: string;
    }
...
/**
 * Modèle de représentation des données du web service "tiers/media".
 * @author S0077965
 */
declare module ComposantsCommunsCarte.Modeles.Tiers.Media {
    /**
     * Nom du module.
     * Pour info, cette exportation de variable est uniquement présent pour donner de la
     * visibilité aux interfaces dans les projets qui importent le composant commun.
    ...
    interface IIdentificationPersonne {
        ...
        identifiantPersonne: number;
        /**
         * Identifiant banque à distance de la personne interrogée
         */
...
declare module ComposantsCommunsCarte.Services {
    ...
    class ContratCarteInformationService {
        ...
        static VERSION_AVENANT_CARTE_AGIR: string;
        static VERSION_AVENANT_DOSSIER_VENTE: string;
...
declare module ComposantsCommunsCarte.Services {
    interface IContratServiceBqdSecurOpeEnLigneService {
        recupererSecurisationOperationEnLigne: (codeEtablissement: string, identifiantTiers: number) => MyWay.Services.IPromesse<ComposantsCommunsCarte.Modeles.ContratServiceBqd.SecurOpeEnLigne.ISecurisationOperationEnLigne>;
    }
    class ContratServiceBqdSecurOpeEnLigneService implements IContratServiceBqdSecurOpeEnLigneService {
        private serviceAgent;
        static serviceId: string;
        static $inject: string[];
        private restServiceUrl;
        private static CODE_TYPE_ENROLEMENT_SECURPASS;
        private static NUMERO_OFFRE_SOUSCRITE_DEFAUT;
        constructor(serviceAgent: MyWay.Services.ServiceAgent);
        recupererSecurisationOperationEnLigne(codeEtablissement: string, identifiantTiers: number): MyWay.Services.IPromesse<ComposantsCommunsCarte.Modeles.ContratServiceBqd.SecurOpeEnLigne.ISecurisationOperationEnLigne>;
    }
}
...
/**
 * Service de gestion de la ressource "demandemulticanal/recherche"
 * @author S0077965 (Martial BENOIST)
 */
declare module ComposantsCommunsCarte.Services {
    interface IDataRechercheTache {
        codeEtablissement: string;
     ...
     * Déclaration du service
     */
    class DemandeMultiCanalRechercheService {
        private serviceAgent;
        static CODE_TYPE_RECHERCHE_IDENTIFIANT_EXTERNE: string;
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgent);
        /**
         * Méthode de construction de l'url du web service
        ...
        url(): string;
        /**
         * Méthode d'appel du web service avec le verbe GET
         * @param data Données d'entrée du web service
         * @return Une promesse contenant un objet de type tache
         */
        sendGetRequest(params: IDataRechercheTache): ng.IPromise<Modeles.DemandeMultiCanal.Recherche.IRecherche>;
        /**
         * Méthode permettant de clôture une tache MyFlow.
         * @param data Données permettant la clôture d'une tâche.
         * @return Une promesse contenant un objet de type tache
         */
        rechercherTacheMyflowRequest(data: IDataRechercheTache): ng.IPromise<Modeles.DemandeMultiCanal.Recherche.IRecherche>;
    }
}

/**
 * Service de gestion de la ressource "demandemulticanal/tache"
 * @author S0077965 (Martial BENOIST)
 */
declare module ComposantsCommunsCarte.Services {
    interface IDataClotureTache {
        commentaire: string;
        codeEtablissement: string;
        identifiantAgentConnecte: string;
        identifiantDemande: string;
     ...
     * Déclaration du service
     */
    class DemandeMultiCanalTacheService {
        private serviceAgent;
        static TYPE_ACTION_TRAITER: string;
        static TYPE_CANAL_GCOC: string;
        static PREFIX_ID_MYFLOW: string;
        static STATUT_DEMANDE_CREE: string;
        static STATUT_DEMANDE_ENCOURS: string;
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgent);
        /**
         * Méthode de construction de l'url du web service
         ...
         * @return Une promesse contenant un objet de type tache
         */
        sendPutRequest(data: Modeles.DemandeMultiCanal.Tache.ITache): ng.IPromise<Modeles.DemandeMultiCanal.Tache.ITache>;
        /**
         * Méthode permettant de clôture une tache MyFlow.
         * @param data Données permettant la clôture d'une tâche.
         * @return Une promesse contenant un objet de type tache
         */
        cloturerTacheMyflowRequest(data: IDataClotureTache): ng.IPromise<Modeles.DemandeMultiCanal.Tache.ITache>;
    }
}
...
declare module ComposantsCommunsCarte.Services {
    ...
    class HelperGgoCarteService {
        ...
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgent);
        genereErreurOk(message: string, emetteur?: string, libelleEmetteur?: string, isVisible?: boolean): GestionGeneriqueOffres.Types.ErreurGestionGeneriqueOffre;
        genereErreurKo(message: string, emetteur?: string, libelleEmetteur?: string, isVisible?: boolean): GestionGeneriqueOffres.Types.ErreurGestionGeneriqueOffre;
        genereErreur(niveauErreur: GestionGeneriqueOffres.Types.NiveauErreur, code: number, message: string, emetteur?: string, libelleEmetteur?: string, isVisible?: boolean): GestionGeneriqueOffres.Types.ErreurGestionGeneriqueOffre;
        /**
...
/**
 * Service permettant la gestion des libellés associés à un établissement
 * @author S0077965
 */
declare module ComposantsCommunsCarte.Services {
    class LibelleEtablissementService {
        getLibelleValiderPaiement(): string;
        getLibelleHabilitation(codeEtablissement: string): string;
        getLibelleDeiPro(codeEtablissement: string): string;
        getLibelleSolProCap(codeEtablissement: string): string;
        affichageLigneDeiPro(codeEtablissement: string): boolean;
        private transcoLibelleEtablissement(codeEtablissement, index);
    }
}
...
/**
 * Service de gestion de la ressource "tiers/media"
 * @author S0077965
 */
declare module ComposantsCommunsCarte.Services {
    /**
    ...
    class TiersMediaService {
         ...
         * Méthode d'appel du service
         */
        sendGetRequest(data: ITiersMediaQuery): ng.IPromise<Modeles.Tiers.Media.IMedia>;
    }
}
...
/**
 * Contrôleur permettant d'afficher une gélule (avec en paramètre le texte à afficher et son statut).
 * @author S0077965
 */
declare module ComposantsCommunsCarte.Controleurs {
    /**
     ...
     * Interface du scope du contrôleur
     */
    interface IChipButtonControleurScope extends ng.IScope {
        idBloc: string;
        index: string;
        chipStatus?: string;
        chipLabel: string;
     ...
     * Déclaration du contrôleur
     */
    class ChipButtonControleur {
        private $scope;
        private serviceAgent;
        static $inject: string[];
        constructor($scope: IChipButtonControleurScope, serviceAgent: MyWay.Services.ServiceAgent);
        /**
...
/**
 * Directive permettant d'afficher une gélule (avec en paramètre le texte à afficher et son statut).
 * @author S0077965
 */
declare module ComposantsCommunsCarte.Directives {
    function mwChipButton(): ng.IDirective;
}
...
declare module ComposantsCommunsCarte.Controleurs {
     ...
     * Interface du scope du contrôleur
     */
    interface ICodePinControleurScope extends ng.IScope {
        idBloc: string;
        index: string;
        codeEtablissement: string;
        codeProduitCarte: number;
        modeEnvoi: string;
        show: boolean;
        modeEdition: boolean;
    ...
    /**
     * Interface du modèle de données exposé par le composant livraison
     */
    interface ICodePin {
        modeEnvoi: string;
        libelle: string;
    ...
    /**
     * Contrôleur permettant d'encapsuler la gestion du composant "Code Pin".
     */
    class CodePinControleur {
        ...
        private i18n;
        private $timeout;
        private contratServiceBqdSecurOpeEnLigneService;
        private tiersMediaService;
        private helperGgo;
        private static NOM_COMPOSANT;
        listeModeEnvoi: Array<ICodePin>;
        model: ICodePin;
        static $inject: string[];
        constructor($scope: ICodePinControleurScope, qService: ng.IQService, serviceAgent: MyWay.Services.ServiceAgent, modalService: MyWay.UI.ModalService, produitCarteParametreService: ComposantsCommunsCarte.Services.ProduitCarteParametreCarteEtablissementService, i18n: Services.II18nCarteService, $timeout: ng.ITimeoutService, contratServiceBqdSecurOpeEnLigneService: ComposantsCommunsCarte.Services.ContratServiceBqdSecurOpeEnLigneService, tiersMediaService: ComposantsCommunsCarte.Services.TiersMediaService, helperGgo: ComposantsCommunsCarte.Services.HelperGgoCarteService);
        /**
         * Méthode d'initialisation des données du controleur.
         */
        initialiserData(): void;
        /**
         * Permet de vérifier l'existence d'une adresse email et d'un numéro de téléphone mobile sécurisé
         */
        private checkEmailAndPhoneNumber();
        /**
         * Méthode de validation de la sélection utilisateur
         */
        private validerCodePin();
        private validerCodePinAvenant();
        private validerCodePinOuverture();
        popupInfo(): void;
        private afficherPopup();
        private afficherPopupBloquante();
        initListe(): void;
        positionnerListe(): void;
        /**
         * Méthode de rafraichissement de la sélection utilisateur.
         * Pb de rafraichissement du scope.
         */
        onChangeSelectionUtilisateur(data: ICodePin): void;
    }
}

declare module ComposantsCommunsCarte.Directives {
    /**
     * Directive permettant d'encapsuler la gestion du composant "Code Pin".
     * @author S0005369
     */
    function mwCodePin(): ng.IDirective;
}
...
/**
 * Contrôleur permettant d'afficher une gélule indiquant l'éligibilité au crédit renouvelable.
 * @author S0077965
 */
declare module ComposantsCommunsCarte.Controleurs {
    /**
     * Interface du scope du contrôleur
     */
    interface IEligibiliteCrControleurScope extends ng.IScope {
        idBloc: string;
        index: string;
        erreurComposant: boolean;
        messageErreur: string;
        indicateurChargementEligibiliteCR: boolean;
        codeEtablissement?: string;
        identifiantPersonne: number;
        statutEligibiliteCr: string;
        labelEligibiliteCr: string;
        tooltipInfo: string;
    }
    /**
     * Déclaration du contrôleur
     */
    class EligibiliteCrControleur {
        private $scope;
        private serviceAgentExtended;
        private revolvingCreditFolderOfferProposalService;
        static $inject: string[];
        constructor($scope: IEligibiliteCrControleurScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, revolvingCreditFolderOfferProposalService: Services.BAPI.RevolvingCreditFolderOfferProposalService);
        /**
         * Méthode d'initialisation des données du controleur.
         */
        initialiserData(): void;
...
/**
 * Directive permettant d'afficher une gélule indiquant l'éligibilité au crédit renouvelable.
 * @author S0077965
 */
declare module ComposantsCommunsCarte.Directives {
    function mwEligibiliteCr(): ng.IDirective;
}
...
declare module ComposantsCommunsCarte.Controleurs {
    ...
    class ModeEnvoiCarte {
        static ENVOI_CARTE_AU_GUICHET_DE_DISTRIBUTION: string;
        static ENVOI_CARTE_AU_CLIENT_EN_PLI_SIMPLE: string;
        static ENVOI_CARTE_AU_CLIENT_EN_PLI_RECOMMANDE: string;
    }
    /**
    ...
    class LivraisonCarteControleur {
        ...
        private i18n;
        static $inject: string[];
        constructor($scope: ILivraisonCarteControleurScope, rechercheService: Services.StructureRechercheService, serviceAgent: MyWay.Services.ServiceAgent, modalService: MyWay.UI.ModalService, produitCarteParametreService: ComposantsCommunsCarte.Services.ProduitCarteParametreCarteEtablissementService, i18n: Services.II18nCarteService);
        /**
         * Méthode d'initialisation des données du controleur.
         */
        initialiserData(): void;
...
/**
 * Directive permettant d'afficher un spinner personnalisé
 * @author S0077965
 */
declare module ComposantsCommunsCarte.Directives {
    interface IMWSpinnerAttributes extends ng.IAttributes {
        mwSpinner: string;
    }
    /**
     * Directive mw-spinner (custom mw-chargement). Attribut
     ...
     */
    function mwSpinner($q: ng.IQService, $templateCache: ng.ITemplateCacheService, $compile: ng.ICompileService): ng.IDirective;
}
...
declare module ComposantsCommunsCarte.Controleurs {
    ...
    class VisuelCarteControleur {
        ...
        static CODE_STATUT_CARTE_LIMITEE: string;
        static CODE_STATUT_CARTE_LIMITEE_USER: string;
        urlVisuelCarte: string;
        static $inject: string[];
        ...
        /**
         * Méthode permettant de savoir si la carte est au statut limitée.
         */
        isCarteLimitee(): boolean;
        getMessageAlert(): string;
    }
}
...
/**
 * Modèle de représentation des données de la BAPI "revolvingcreditfolder/offerproposal".
 * @author S0077965
 */
declare module ComposantsCommunsCarte.Modeles.BAPI.RevolvingCreditFolder.OfferProposal {
    /**
     * Nom du module.
     * Pour info, cette exportation de variable est uniquement présent pour donner de la
     * visibilité aux interfaces dans les projets qui importent le composant commun.
    ...
    var _path: string;
    /**
     * Proposition d'offre de crédit renouvelable
     */
    interface IOfferProposal {
        characteristics?: IOfferProposalCharacteristics;
        response?: IOfferProposalResponse;
    }
    /**
     * Api response for createRevolvingCreditFolderRevolvingCreditFoldersOfferProposalV1
     */
    interface ICreateRevolvingCreditFolderRevolvingCreditFoldersOfferProposalV1Response {
        offerProposal: IOfferProposal;
    }
    /**
     * Caractéristiques de la proposition d'offre CR
     */
    interface IOfferProposalCharacteristics {
        noticeOfDecision?: string;
        grantingNote?: string;
        grantingLabel?: string;
        revolvingCreditOfferId?: string;
        maximumCreditAllowedAmount?: IAmount;
        borrowers: IOfferProposalBorrowersItem[];
        minimumCreditAllowedAmount?: IAmount;
    }
    /**
     * Réponse de l'interaction Proposition d'offre CR
     */
    interface IOfferProposalResponse {
        interactionId?: string;
        code?: string;
        label?: string;
    }
    /**
     * Objet défaut pour les montants.
     */
    interface IAmount {
        value?: number;
        currencyCode?: string;
    ...
    /**
     * Participant au crédit conso
     */
    interface IOfferProposalBorrowersItem {
        role: string;
        personId: IIdentifier;
        suggestedInsurances?: IInsurance[];
    }
    /**
...
/**
 * Service de gestion de la BAPI "revolvingcreditfolder/offerproposal".
 * @author S0077965
 */
declare module ComposantsCommunsCarte.Services.BAPI {
     ...
     * Déclaration du service
     */
    class RevolvingCreditFolderOfferProposalService {
        private serviceAgentExtended;
        static $inject: string[];
        static NOTICE_OF_DECISION_VERT: string;
        static NOTICE_OF_DECISION_ORANGE: string;
        static NOTICE_OF_DECISION_ROUGE: string;
        static CR_AVIS_FAVORABLE: string;
        static CR_INFO_AVIS_FAVORABLE: string;
        static CR_AVIS_DEFAVORABLE: string;
        static CR_INFO_AVIS_DEFAVORABLE: string;
        private urlBapiRevolvingCreditFolder;
        private CLIENT_ID;
        private urlBapiDomain;
        private urlBapiAuthDomain;
        private headerXBPCEClientContext;
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        createRevolvingCreditFolderOfferProposal(data: Modeles.BAPI.RevolvingCreditFolder.OfferProposal.IOfferProposal): ng.IPromise<Modeles.BAPI.RevolvingCreditFolder.OfferProposal.ICreateRevolvingCreditFolderRevolvingCreditFoldersOfferProposalV1Response>;
    }
}

declare module ComposantsCommunsCarte.Controleurs {
    class ModalAlertNoSecurPassCtlr {
        private $modalInstance;
        private serviceAgent;
        static controleurId: string;
        static $inject: string[];
        constructor($modalInstance: angular.ui.bootstrap.IModalServiceInstance, serviceAgent: MyWay.Services.ServiceAgent);
        fermer(): void;
    }
}
