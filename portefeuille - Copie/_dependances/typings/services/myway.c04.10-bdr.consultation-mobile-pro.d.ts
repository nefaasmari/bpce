...
declare module ConsultationMobilePro {
    var app: any;
}

/**
 * Contrôleur de la page de consultation MOBILE PRO
...
declare module ConsultationMobilePro {
     ...
     */
    class MobileProConsultationControleur {
        private $scope;
...
declare module ConsultationMobilePro {
     ...
     * Déclaration du contrôleur
     */
    class MobileProConsultationRecetteControleur {
        private $scope;
        private $timeout;
        private caracteristiqueAbonnementService;
        static $inject: string[];
