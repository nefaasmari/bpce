...
declare module MyWay.Contractualisation {
    ...
    class Utils {
        ...
        static checkPanierObject(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, multiDossiersNumeriques: IMultiDossiersNumeriques): boolean;
...
declare module MyWay.Contractualisation {
    class ListerDossiersNumeriquesControleur {
        ...
        init(): void;
        constructTuilesDossier(listeDossierNumerique: Array<IDossierNumerique>): void;
        /**
...
declare module MyWay.Contractualisation {
    /**
     * L'objectif du service RecupererDocumentsIdnService est d'appeler la ressource
     * consultationIdn/recupererDocumentsIdn afin de récuperer les documents d'un dossier numérique Idn.
     * @author S0006664
     */
    class RecupererDocumentsIdnAttributaireService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        getDocumentsIdnAttributaire(idActeIdn: string, codeApplication: string): ng.IPromise<Myway.Ressource.ConsultationIdn.IRecupererDocumentsIdntAttributaireOutput>;
    }
}
...
declare module MyWay.Contractualisation {
    ...
    class DossierContratServiService {
        ...
        private convertListeDocumentsIdnToDocIDocument(recupererDocumentsIdntAttributaireOutput, dossierNumerique);
...
declare module MyWay.Contractualisation {
    ...
    class ListerDossiersNumeriquesService {
         ...
         */
        init(): ng.IPromise<void>;
        getDossierNumeriqueEnAttenteSignature(): ng.IPromise<Array<IDossierNumerique>>;
        getCiviliteSignataires(listeDossierNumerique: Array<IDossierNumerique>): ng.IPromise<Array<IDossierNumerique>>;
        getEtatDossierNumerique(listeDossierNumerique: Array<IDossierNumerique>): ng.IPromise<Array<IDossierNumerique>>;
        isEligibleRegroupement(listeDossierNumerique: Array<IDossierNumerique>): ng.IPromise<Array<IDossierNumerique>>;
        ...
        filtrerDossierEnCreation(listeDossiersNum: Array<IDossierNumerique>): Array<IDossierNumerique>;
        ...
        createSignataireSimplifie(multiDossierNumerique: IMultiDossiersNumeriques): Array<ISignataireSimplifie>;
        /**
