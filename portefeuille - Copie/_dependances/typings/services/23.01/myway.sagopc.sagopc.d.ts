...
declare module Myway.Sagopc {
    class DefautControleur {
        ...
        constructor($q: ng.IQService, $timeout: ng.ITimeoutService, sagopcService: SagopcService, eligibiliteService: EligibiliteService, contractualisationActeService: myway.comContract.Services.ContractualisationActeService, gcedocService: GcedocService, sagOpcServiceComContract: myway.comContract.Services.SagOpcService, serviceAgent: MyWay.Services.ServiceAgentExtended);
        /**
