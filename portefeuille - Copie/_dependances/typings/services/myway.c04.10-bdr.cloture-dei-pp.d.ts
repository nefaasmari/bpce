...
/**
 * Contrôleur de la page de tests de la directive mw-dei-pp-cloture
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureDeiPP.Controleurs {
    /**
     * Déclaration du contrôleur
     */
    class PageDevMwDeiPPClotureControleur {
...
/**
 * Contrôleur de la directive mw-dei-pp-cloture
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureDeiPP.Controleurs {
    /**
     * Déclaration du contrôleur
     */
    class MwDeiPPClotureControleur {
        private $scope;
        private serviceAgentExtended;
        ...
        /**
         * Méthode appelée pour la sauvegarde de la clôture de l'abonnement DEI PP
        ...
        /**
         * Méthode appelée pour le traitement de la sauvegarde de la clôture de l'abonnement DEI PP
...
/**
 * Directive pour l'affichage de la page de clôture de Dei PP
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureDeiPP.Directives {
    function mwDeiPpCloture(): ng.IDirective;
}
