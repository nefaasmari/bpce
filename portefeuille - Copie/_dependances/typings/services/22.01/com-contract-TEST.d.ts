...
declare module myway.comContract.Services {
    class RecupererDocumentsIdnService {
         ...
         */
        private getDocumentsAttributaire(idActeIdn, codeApplication);
        /**
         ...
         */
        recupererDocumentsAttributaires(idActeIdn: string, codeApplication: string): ng.IPromise<Array<Myway.Ressource.ConsultationIdn.IDocumentIdntAttributaire>>;
    }
}
