...
declare namespace myway.core {
    class ErreurService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, $window: ng.IWindowService, modalService: MyWay.UI.IModalService, loaderService: myway.core.LoaderService);
        /**
...
declare module myway.core {
    class TelephoneCodeRetourEnum extends LabelValueEnum<string> {
        static SUCCESS: TelephoneCodeRetourEnum;
        static NUMERO_NON_ALIMENTE: TelephoneCodeRetourEnum;
        static NUMERO_IMPOSSIBLE_À_JOINDRE: TelephoneCodeRetourEnum;
        static UTILISATEUR_NON_CONNECTE: TelephoneCodeRetourEnum;
        static CODE_RETOUR_INCONNU: TelephoneCodeRetourEnum;
        static COMBINE_DECROCHE_OU_APPEL_DEJA_EN_COURS: TelephoneCodeRetourEnum;
        static NUMERO_DESTINATAIRE_IMPOSSIBLE_A_JOINDRE: TelephoneCodeRetourEnum;
        static AUTHENTIFICATION_UTILISATEUR_IMPOSSIBLE: TelephoneCodeRetourEnum;
        static RACCROCHER_IMPOSSIBLE_POUR_ALCATEL: TelephoneCodeRetourEnum;
        static UTILISATEUR_ABSENT_DE_L_ANNUAIRE: TelephoneCodeRetourEnum;
    }
    interface IRetourTelephoneModel {
        codeEtat: string;
        messageEtat: string;
    }
    interface IUrlServiceTelephonie {
        url: string;
    }
    class TelephoneService {
        ...
        static $inject: string[];
        constructor($http: ng.IHttpService, $q: ng.IQService, agentService: AgentService);
        composerAppel(numeroDestinataire: string): ng.IPromise<void>;
        protected call(url: string, numeroDestinataire: string): ng.IPromise<string>;
        protected getUrl(): ng.IPromise<IUrlServiceTelephonie>;
    }
}
...
declare module myway.core {
    abstract class Utils {
        /**
         * Indique si le portail est exécuté dans en environnement de développement.
         */
        static isEnvironnementDev(): boolean;
        /**
         * Indique si le portail est exécuté dans en environnement de recette.
         */
...
declare namespace myway.core {
    ...
    class AgentService extends FrameworkService {
        ...
        private mailService;
        static $inject: string[];
        constructor($injector: ng.auto.IInjectorService, $q: ng.IQService, commonService: CommonService, contexteService: ContexteService, habilitationService: HabilitationService, lisaService: LisaService, mobiliteService: MobiliteService, processusService: ProcessusService, traceService: TraceService, mailService: MailService);
...
declare module myway.core {
    class HabilitationService extends FrameworkService {
        ...
        private contexteService;
        private commonService;
        private HABILITATIONS_CULTURE_NET_COMMUNAUTAIRES_CONTEXT_KEY;
        static $inject: string[];
        ...
        resetHabilitationsCommunautaires(): ng.IPromise<any>;
        /**
