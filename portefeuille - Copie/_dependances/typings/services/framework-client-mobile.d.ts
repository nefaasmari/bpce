...
declare module MyWay.Services {
    ...
    class FakeXhr {
        private headers;
        constructor(status: number, headers: {[key: string]: any}, response: any, responseType: "" | "arraybuffer" | "blob" | "document" | "json" | "text");
        response: any;
    ...
    class CoreCommon extends Components.ComponentBase implements Components.IComponentCommon {
        ...
        private _libraryCommon;
        private static _methodForSendRequest;
        private static _waitSendRequestBapi;
        static PreventMultipleJSONCalls: boolean;
        static VersionMySys: string;
        constructor();
        static ServiceDePromesse: IServiceDePromesse;
        init(pLibraryCommon: Components.ILibraryCommon): IPromesse<void>;
        ...
        */
        ...
        static registerMethodForSendRequest(method: (params: Core.ICoreMessageContentSendRequestResponse) => IPromesse<any>): void;
...
declare module MyWay.Services.Core {
    ...
    interface IBapiContext {
        domain: string;
        clientId: string;
        baseUrlAuthentication: string;
        scopes: string[];
        uniqueID: string;
    }
    interface ICoreMessageContentSendRequestRequest extends ICoreMessageContent {
        bapiContext?: IBapiContext;
        method?: MethodEnum;
        url?: string;
        params?: any;
        data?: any;
    ...
    interface ICoreMessageContentSendRequestResponse extends ICoreMessageContent {
    }
...
declare module MyWay.Services.Message {
    ...
    class PortailMyWayV2MessageAgent extends MessageAgentBase {
        private static CLASS_NAME;
        private static logger;
        private socket;
...
declare module MyWay.Services.Performance {
    interface IPerformanceTraceCalculated {
        stepId: string;
        label: string;
        totalStartDuration: number;
        totalUserDuration: number;
...
declare module MyWay.Services.Mobilite {
    interface IParamsPeripheriques {
        methode?: RECUP_INFO;
    }
    enum RECUP_INFO {
        FICHIER = 0,
...
declare module MyWay.Services.Mobilite {
    class TabletteSignature implements ITabletteSignature {
        ...
        typePeripherique: TYPE_PERIPHERIQUE;
        idMateriel: string;
        constructor(type: string, modele: string, codeModele: string, idMateriel?: string);
    }
}
declare module MyWay.Services.Bug {
}
    ...
    */
    interface DocumentGenere {
        ...
        */
        DateCrtn: string;
        /**
         * Code de retour de la génération
         */
        codeRetour: number;
    }
    /**
...
declare module MyWay.Services.ContexteClient {
    ...
    class ContexteClientAgent extends Components.ComponentAgentBase<IContextClientMessage, ContextClientMessageSubject, IContextClientMessageContent> {
        ...
        /**
         * Permet de s'abonner au raffraichissement auto d'un bloc métier listen (Voir avec Socle Fonctionnel pour obtenir des ID)
         * @param pIdBlocMetierListen identifiant du bloc métier listen.
         * @param pParams paramètres, sous format d'un objet Map.
         * @returns true sur OK, false sinon.
         */
        getRefresh(pIdBlocMetierListen: string, pParams: any): IPromesse<boolean>;
        /**
         * Permet d'initier le raffraichissement auto d'un bloc métier notify (Voir avec Socle Fonctionnel pour obtenir des ID)
         * @param pIdBlocMetierNotify identifiant du bloc métier notify.
         * @param pParams paramètres, sous format d'un objet Map.
         * @returns true sur OK, false sinon.
         */
        setDirty(pIdBlocMetierNotify: string, pParams: any): IPromesse<boolean>;
    }
}
declare module MyWay.Services {
    interface ServiceAgent {
...
declare module MyWay.Services.Performance {
    /**
     * Service Performance des agents du socle technique
     * Permet de mesurer le temps de chargement des processus
     * Peut être utilisé pour faire une mesure de temps manuelle
     */
    class PerformanceAgent extends Components.ComponentAgentBase<IPerformanceMessage, PerformanceMessageSubject, IPerformanceMessageContent> {
        private static CLASS_NAME;
        private static logger;
        /**
         * ConstrMucteur de la classe PreferencesAgent.
         */
        constructor();
        /**
         * Ajoute une étape dans une mesure, ou démarre une nouvelle mesure si l’id n’existe pas
         * Cette méthode peut être appelée plusieurs fois avec le même id, pour générer des étapes dans la mesure
         * @param id id de la mesure (unique)
         * @param nom Nom de l'étape (par exemple "Clic sur ajouter")
         */
        etape(id: string, nom: string): IPromesse<void>;
        /**
         * Met fin à une mesure (génère une trace)
         * @param id id de la mesure (l'id utilisé lors de l'appel à etape)
         * @param nom Nom de l'étape (par exemple "ajout")
         */
        fin(id: string, nom: string): IPromesse<void>;
        /**
         * Annule une mesure (aucune trace ne sera générée)
         * @param id id de la mesure
         */
        annuler(id: string): IPromesse<void>;
        /**
         * Met fin à la mesure de chargement (génère une trace)
         * A utiliser uniquement si l'agent ne parvient pas à détecter la fin de chargement de l'application
         */
        finChargementManuel(): IPromesse<void>;
        /**
         * La génération de l'identifiant de base est bonne.
         * Sécurisation de l'identifiant dans le cas où cette identifiant ne peut être généré.
         */
        private getId;
    }
}
    ...
    */
    class MobiliteAgent extends Components.ComponentAgentBase<Messages.IMobiliteMessage, Messages.MobiliteMessageSubject, Messages.IMobiliteMessageContent> {
        ...
        **/
         ...
         * ~~~
         */
        getTablettesSignature(params?: IParamsPeripheriques): IPromesse<ITabletteSignature[]>;
    }
}
declare module MyWay.Services {
    interface ServiceAgent {
...
declare module MyWay.Services.Acquisition {
    ...
    */
    class AcquisitionAgent extends Components.ComponentAgentBase<Messages.IAcquisitionMessage, Messages.AcquisitionMessageSubject, Messages.IAcquisitionMessageContent> {
         ...
         * @return boolean true si tout s'est bien passé sinon false
         */
        getDocumentGedAndOpen(params: IGedOneParams): IPromesse<IProcessingTasks>;
        private defers;
        /**
         ...
         * @param content
         */
        isDocumentSigne(fileinfos: IFileInformation): IPromesse<string>;
    }
}
/**
 * Module de gestion de la numérisation
...
declare module MyWay.Services.Acquisition {
    class AcquisitionApiFactory extends Components.ComponentApiBase implements IAcquisitionApiComponent {
        ...
        */
         ...
         * @param content
         */
        isDocumentSigne(filesinfos: IFileInformation): IPromesse<boolean>;
    }
}
declare module MyWay.Services.Acquisition {
    class AcquisitionApiFullWeb implements IAcquisitionApi {
        ...
        */
         ...
         * @param fileInfos
         */
        isDocumentSigne(fileInfos: IFileInformation): IPromesse<boolean>;
    }
}
declare module MyWay.Services.Acquisition {
...
declare module MyWay.Services.Mobilite {
    interface IMobiliteApi {
        ...
        listeTablettesSignatures(params?: IParamsPeripheriques): IPromesse<Mobilite.ITabletteSignature[]>;
...
declare module MyWay.Services.Mobilite {
    ...
    */
    class MobiliteApiWindows extends MobiliteApiBase {
         ...
         */
        listeTablettesSignatures(params?: IParamsPeripheriques): IPromesse<ITabletteSignature[]>;
        /**
...
declare module MyWay.Services.Components {
    interface ILibraryApi {
        Performance: Performance.IPerformanceApi;
    }
}
declare module MyWay.Services.Performance {
    interface IPerformanceApiComponent extends Components.IComponentApi, IPerformanceApi {
    }
    interface IPerformanceApi {
        send(traces: IPerformanceTraceCalculated[]): IPromesse<void>;
    }
}
declare module MyWay.Services.Bug {
}
declare module MyWay.Services.Performance {
    class PerformanceApi extends Components.ComponentApiBase implements IPerformanceApiComponent {
        private _isIE;
        constructor();
        init(pCapabilities: DeviceCapabilities, pLibraryManager: Components.ILibraryManager, pApiInitializer: Components.IApiInitializer): IPromesse<void>;
        send(traces: IPerformanceTraceCalculated[]): IPromesse<void>;
...
declare module MyWay.Services.Lisa {
    ...
    class FakeLisaApi implements ILisaApi {
        ...
        */
        ...
        DemarrerSousProcessusExterne(codeProcessus: string, delegationPortail: boolean, initData: Lisa.IInitialisationData, valeurDepart: string, horsPortail: boolean, surTablette: boolean, nameDevice?: string): IPromesse<boolean>;
...
declare module MyWay.Services.Impression {
    ...
    interface IImpressionApi {
        ...
        getJsonConverti(data: any): IPromesse<string>;
        imprimerDocument(data: any, params: any): IPromesse<number>;
        imprimerDocumentLot(data: DocumentImpressionLot[], parametresActiveXGlobaux?: IParametresActiveXGlobauxREST): IPromesse<number>;
...
declare module MyWay.Services.Mobilite {
    ...
    */
    class MobiliteManager extends Components.ComponentManagerBase<Messages.MobiliteMessageSubject, Messages.IMobiliteMessageContent> {
         ...
         * ~~~
         */
        getPeripheriques(params?: IParamsPeripheriques): IPromesse<IPeripherique[]>;
        /**
         ...
         * ~~~
         */
        getPeripheriquesParType<T extends IPeripherique>(type: TYPE_PERIPHERIQUE, params?: IParamsPeripheriques): IPromesse<T[]>;
        /**
...
declare module MyWay.Services.Performance {
    interface IPerformanceTraces {
        id: string;
        traces: IPerformanceTrace[];
        timeout: any;
        startAt: number;
    }
    interface IPerformanceTrace {
        label: string;
        timestamp: number;
        type?: PerformanceType;
    }
...
declare module MyWay.Services.Performance {
    /**
    * Classe gestion des traces de performance
    * @classe PerformanceManager
    * fonction : step – public - Permet d'ajouter une étape à un scénario de traces de performance
    * fonction : cancel – public - Annule l'envoi des traces de performance
    * fonction : end - public - Signale la fin d'un scénario de traces de performance
    */
    class PerformanceManager extends Components.ComponentManagerBase<PerformanceMessageSubject, IPerformanceMessageContent> {
        private static CLASS_NAME;
        private static logger;
        private static TIMEOUT;
        private api;
        private tracesInProgress;
        constructor();
        init(pManagerLibrary: Components.ILibraryManager, pMessageService: Message.IMessageService, pManagerInitializer: Components.IManagerInitializer, pApi?: IPerformanceApiComponent): IPromesse<void>;
        step(id: string, label: string, type?: PerformanceType): IPromesse<void>;
        end(id: string, label: string): IPromesse<void>;
        cancel(id: string): IPromesse<void>;
...
declare module MyWay.Services.Impression {
    ...
    */
    class ImpressionManager extends Components.ComponentManagerBase<Messages.ImpressionMessageSubject, Messages.IImpressionMessageContent> {
        ...
        * @param impressionParams {ImpressionParams} Paramètres d'impression du document
        */
        imprimer(data: any, impressionParams: ImpressionParams): IPromesse<number>;
        /**
        * Permet de lancer une impression de document par lot
        * @param data {DocumentImpressionLot[]} Lot de documents à envoyer pour l'impression (uniquement PDF, avec possibilité de les récupérer en GED)
        * @param parametresActiveXGlobaux {ParametresActiveXGlobaux} Paramètres globaux de l'ActiveX d'impression
        */
        imprimerLot(data: DocumentImpressionLot[], parametresActiveXGlobaux: ParametresActiveXGlobaux): IPromesse<number>;
        /**
...
declare module MyWay.Services.Performance {
    class PerformanceManagerMessage extends Components.ComponentManagerMessageBase<PerformanceManager, IPerformanceMessage, PerformanceMessageSubject, IPerformanceMessageContent> {
        private static CLASS_NAME;
        private static logger;
        constructor();
        reception(pMessage: IPerformanceMessage): IPromesse<any>;
    }
}
