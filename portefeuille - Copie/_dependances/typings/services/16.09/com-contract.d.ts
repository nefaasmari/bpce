...
declare module myway.comContract.Services {
    ...
    class ContractualisationActeService {
         ...
         */
        verifierEligibiliteSAGSEDReduit(acte: ContractualisationActe.Modeles.IActe, listeSignataires: Array<modeles.ISignataire>): ng.IPromise<ContractualisationActe.Modeles.IContractualisationActe>;
        /**
         * @ngdoc method
         ...
         * @returns {ng.IPromise<ContractualisationActe.Modeles.IContractualisationActe>}
         */
        verifierEligibiliteSAGSEDComplet(acte: ContractualisationActe.Modeles.IActe, listeSignataires: Array<modeles.ISignataire>, listeTitulaires: Array<ContractualisationActe.Modeles.ITitulaire>): ng.IPromise<ContractualisationActe.Modeles.IContractualisationActe>;
        /**
         * @ngdoc method
         * @name getMateriels
         * @description
...
declare module myway.comContract.Services {
    class SignatureElectroniqueService {
        ...
        private isBasculeSAG001(datas, objetGestionPrincipal, serveurAgenceRattachement);
...
declare module myway.comContract.ContractualisationActe {
    ...
    class ActeGestionFactory {
         ...
         */
        create(acte: Modeles.IActe, listeSignataires: Array<modeles.ISignataire>, listeTitulaires: Array<Modeles.ITitulaire>): Modeles.IActeGestion;
    }
}
...
declare module myway.comContract.ContractualisationActe {
    ...
    class ContractualisationActeFactory {
         ...
         */
        createContractualisationActe(indicateurPapier: boolean, acteGestion: Modeles.IActeGestion, libelleNonEligibilite: string, listeMateriels: Array<Modeles.IMateriel>): Modeles.IContractualisationActe;
    }
}
...
declare module myway.comContract.ContractualisationActe {
    ...
    class ContractualisationActeInputFactory {
         ...
         */
        create(acte: Modeles.IActe, listeSignataires: Array<modeles.ISignataire>, indicateurAgenceDeployee: boolean, indicateurCaisseAuto: boolean, listeMateriels: Array<Modeles.IMateriel>, listeTitulaires: Array<Modeles.ITitulaire>): Modeles.IContractualisationActeInput;
    }
}
...
declare module myway.comContract.ContractualisationActe {
    ...
    class ContractualisationActeRequestFactory {
         ...
         * @constructor
         */
        constructor(methode: MyWay.Services.MethodEnum, contractualisationActeInput: ContractualisationActe.Modeles.IContractualisationActeInput);
        /**
         * @ngdoc method
         * @name create
         * @description
...
declare module myway.comContract.ContractualisationActe {
    ...
    class OperationFinanciereFactory {
         ...
         * @returns {Modeles.ISignataireActe}
         */
        createOperationFinanciere(modeOperationFinanciere: string): Modeles.IOperationFinanciere;
        /**
         * @ngdoc method
         ...
         */
        createListeOperationsFinanaciere(listeModeOperationsFinanciere: Array<string>): Array<Modeles.IOperationFinanciere>;
    }
}
...
declare module myway.comContract.ContractualisationActe {
    ...
    class SignataireActeFactory {
         ...
         * @returns {Modeles.ISignataireActe}
         */
        createSignataireActeFromSignataire(signataire: modeles.ISignataire): ContractualisationActe.Modeles.ISignataireActe;
        /**
         * @ngdoc method
         * @name createListeSignatairesActeFromListeSignataire
         * @description
         ...
         * @returns {Array<Modeles.ISignataireActe>}
         */
        createListeSignatairesActeFromListeSignataire(listeSignataires: Array<modeles.ISignataire>): Array<Modeles.ISignataireActe>;
    }
}
...
declare module myway.comContract.ContractualisationActe {
    ...
    class TitulaireActeFactory {
         ...
         */
        createTitulaireActeFromTitulaire(titulaire: Modeles.ITitulaire): Modeles.ITitulaireActe;
        /**
         * @ngdoc method
         ...
         */
        createListeTitulairesActeFromListeTitulaires(listeTitulaires: Array<Modeles.ITitulaire>): Array<Modeles.ITitulaireActe>;
    }
}
