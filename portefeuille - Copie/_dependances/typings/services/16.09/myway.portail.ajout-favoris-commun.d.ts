...
declare module AjoutFavorisCommun {
    ...
    class ModalCategoriesControleur {
        ...
        constructor($q: ng.IQService, $rootScope: IModalScope, $filter: ng.IFilterService, $window: ng.IWindowService, modalCategoriesService: AjoutFavorisCommun.ModalCategoriesService, mwNotificationService: MyWay.UI.IMwNotificationService, favorisService: FavorisService, lireEcrireService: LireEcrireService);
        ...
        /**
         * Fermer la fenêtre modal (volet d'affichage des catégories)
         * @function
         * @return {void}
         */
        closeModal: () => void;
...
declare module AjoutFavorisCommun {
    ...
    class FavorisService {
        ...
        URL_FAVORIS: string;
        static $inject: string[];
        constructor($q: ng.IQService, $filter: ng.IFilterService, lireEcrireService: AjoutFavorisCommun.LireEcrireService);
