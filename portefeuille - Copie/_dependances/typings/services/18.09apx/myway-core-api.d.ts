...
declare module myway.core {
    class LoaderService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, $templateCache: ng.ITemplateCacheService, $compile: ng.ICompileService, $document: ng.IDocumentService, $timeout: ng.ITimeoutService);
        /**
...
declare module myway.core {
    abstract class ArrayUtils {
         ...
         */
        static differenceBy<T>(array1: T[], array2: T[], iteratee: (item: T) => any): T[];
    }
}
