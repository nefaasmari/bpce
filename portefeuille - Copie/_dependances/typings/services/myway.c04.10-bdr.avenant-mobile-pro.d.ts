...
declare module AvenantMobilePro {
    var app: any;
}

/**
 * Contrôleur de la page d'avenant MOBILE PRO
...
declare module AvenantMobilePro {
     ...
     */
    class MobileProAvenantControleur {
        private $scope;
...
/**
 * Contrôleur de la directive mw-mobile-pro-avenant
 * @author S0077536 (Arnaud Despalins)
 */
declare module AvenantMobilePro.Controleurs {
    /**
     * Déclaration du contrôleur
     */
    class MwMobileProAvenantControleur {
        private $scope;
        private $rootScope;
        private $q;
        private mobileProValiderAvenantService;
         ...
         * Constructeur
         */
        constructor($scope: ng.IScope, $rootScope: ng.IRootScopeService, $q: ng.IQService, mobileProValiderAvenantService: Services.Application.IMobileProValiderAvenantService, caracteristiqueAbonnementService: ComposantsCommunsDeiPro.Services.Application.IAvenantCaracteristiqueAbonnementService, serviceAgent: MyWay.Services.ServiceAgentExtended);
        /**
         * Méthode qui déclenche le chargement des informations venant du portail et de GGO
         */
        chargerAvenantMobilePro(): void;
        /**
         * Permet de valider les données de l'avenant MOBILE PRO
        ...
        /**
         * Méthode pour valider les modifications d'un abonnement Mobile Pro
...
/**
 * Directive pour la gestion de l'affichage de la page d'avenant MOBILE PRO
 * @author S0077536 (Arnaud Despalins)
 */
declare module AvenantMobilePro.Directives {
    /**
     * Déclarion du constructeur de la directive
     */
    function mwMobileProAvenant(): ng.IDirective;
}

/**
 * Service contenant les fonctionnalités pour la sauvegarde des modifications sur la page d'avenant MOBILE PRO
 * @author S0077536 (Arnaud Despalins)
 */
declare module AvenantMobilePro.Services.Application {
    /**
     * Interface du service
     */
    interface IMobileProValiderAvenantService {
