...
declare module ComposantCommunSecurExpress.Modeles.Contrat {
    ...
    /**
     * Interface de la requête au service REST "servicesecurexpress/v1/contrat" de type GET
     */
    interface ISecurExpressContratRestServiceGetQuery {
        identifiantContrat: string;
    }
    /**
...
declare module ComposantCommunSecurExpress.Services {
     ...
     * Classe du service
     */
    class InformationsGlobalesForSecurExpressService implements IInformationsGlobalesForSecurExpressService {
     ...
     */
    interface IInformationsGlobalesForSecurExpressService {
        sendGetRequest(query: Modeles.InformationsGlobales.IInformationsGlobalesRestServiceGetQuery): ng.IPromise<Modeles.InformationsGlobales.IInformationGlobale>;
    }
}
...
declare module ComposantCommunSecurExpress.Services {
    ...
    class SecurExpressContratService implements ISecurExpressContratService {
         ...
         * @param {Modeles.Contrat.ISecurExpressContratRestServiceGetQuery} query - le modèle de donnée de la requête
         * @return {MyWay.Services.IPromesse<Modeles.Contrat.IContrat>} La promesse contenant les résultats
         */
        sendGetRequest(query: Modeles.Contrat.ISecurExpressContratRestServiceGetQuery): ng.IPromise<Modeles.Contrat.IContrat>;
        /**
