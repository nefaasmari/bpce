...
declare module GestionGeneriqueOffres.Types {
    ...
    class DonneesProduit {
        ...
        constructor(detenteur: Types.InformationEntiteTitulaire | Types.Tiers.Personne, produit: Types.ProduitService, invisible: boolean, idProducteur: string, repris: boolean, produitSelectionne: Types.CleValeur, donneesSelectionAssemblage: any, pointsEntree: Types.PointsEntree);
    }
    ...
    class DonneesContextuelles {
         ...
         */
        donneesProduit: DonneesProduit;
        constructor(modeAcces: ModeAcces, modeAffichage: ModeAffichage, personnes: Personne[], entitesTitulaires: InformationEntiteTitulaire[], offreSouscrite: OffreSouscrite, etablissement: Etablissement, dossierVente: DossierVente, donneesGeneriques: Types.DonneesGeneriques, catalogue: Types.CatalogueNode, composition: Types.CompositionOffre, donneesProduit: DonneesProduit);
    }
}
