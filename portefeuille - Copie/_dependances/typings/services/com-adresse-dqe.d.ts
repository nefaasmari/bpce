...
declare module myway.comAdresseDqe {
    class ComAdresseDqeConstantes {
         ...
         */
        static REGEXP_CP_INSEE_VILLE: RegExp;
        /**
        ...
        /**
         * Le nombre de correspondances maximum faites par l'expression régulière REGEXP_CP_INSEE_VILLE
         */
        static REGEXP_CP_VILLE_MATCHES_LENGTH: number;
        /**
         * Le nombre de correspondances maximum faites par l'expression régulière REGEXP_CP_INCOMPLET
         */
        static REGEXP_CP_INCOMPLET_MATCHES_LENGTH: number;
        /**
         * L'index indiquant la correspondance avec le code postal pour l'expression régulière REGEXP_CP_INSEE_VILLE
         */
        static REGEXP_CP_VILLE_MATCH_CP_INDEX: number;
        /**
         * L'index indiquant la correspondance avec le code INSEE pour l'expression régulière REGEXP_CP_INSEE_VILLE
         */
        static REGEXP_CP_VILLE_MATCH_INSEE_INDEX: number;
        /**
         * L'index indiquant la correspondance avec la localité pour l'expression régulière REGEXP_CP_INSEE_VILLE
         */
        static REGEXP_CP_VILLE_MATCH_VILLE_INDEX: number;
        /**
         * L'index indiquant la correspondance avec le code postal pour l'expression régulière REGEXP_CP_INCOMPLET
         */
        static REGEXP_CP_INCOMPLET_MATCH_CP_INDEX: number;
        /**
...
declare module myway.comAdresseDqe {
    ...
    class SaisieCommuneNaissanceController {
        ...
        private insee;
        constructor($q: ng.IQService, $scope: ng.IScope, $timeout: ng.ITimeoutService, adresseService: AdresseService, traceService: ITraceService);
...
declare module myway.comAdresseDqe {
    ...
    class AdresseService {
         ...
         * @param saisie
         * @return IRegExpSaisieResult Un objet contenant le code postal, le code INSEE et la ville extraits
         */
        extractCPInseeVilleFromSaisie(saisie: string): IRegExpSaisieResult;
        /**
