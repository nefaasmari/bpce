...
declare module instructionCredit {
    class AjoutCompteHorsCeControleur {
        ...
        affichePersonnes(item: string): boolean;
        affectationsGroupes(item: Object): string;
        private selectAffectation();
        changeAffectation(idws: string): void;
...
declare module instructionCredit {
    class FormulaireClientControleur implements MyWay.UI.ITuileHandler {
        ...
        personnesPhysiques: Array<instructionCredit.Modele.IPersonne>;
        ...
        /**
         * Suppression d'une personne physique
         */
        supprimerPersonnePhysique(confirm?: boolean): void;
        /**
         * Affiche la popin de selection du client bancaire
         */
        popinClientsBancaires(): void;
        private creerTotem();
        /**
...
declare module instructionCredit {
    class FormulaireFinancementControleur implements MyWay.UI.ISelectionChangeHandler, MyWay.UI.ITuileHandler {
        ...
        /**
         * Création d'une assurance (ajout + mise à jour)
         */
        private creerAssurance(listeIdCreditCouvParAss, listeIdentifiantPersonne, idConventionAssurance, codeAssuranceObligatoire, montantCouverture, quotientCouverture);
        private majCouvertureCreditAssurance(codeAssuranceObligatoire, montantCouverture, quotientCouverture, assuranceCreee);
        /**
         ...
         */
        private creerCreditInterne(idProduitFinancier);
        /**
...
declare module instructionCredit {
    class FormulaireProjetControleur {
        ...
        complementDossier: instructionCredit.Modele.IComplementDossier;
        ...
        formulaireProjetDelais: Array<instructionCredit.Modele.IFormulaireProjetDelais>;
        ...
        predicatFilterDestination(): (value: Modele.ISelectboxNumber, index: number, array: Modele.ISelectboxNumber[]) => boolean;
        controleSurfaceHabitable(): void;
    }
}
...
declare module instructionCredit {
    class ModaleBlocNotesControleur {
        private $scope;
        private $modalInstance;
        static $inject: string[];
        modalDatas: any;
...
declare module instructionCredit {
    class ModaleAssuranceControleur {
        ...
        listeIdentifiantProduit: Array<string>;
        ...
        conventionSelectionnee: instructionCredit.Modele.IConventionAssurance;
        conventionResume: instructionCredit.Modele.IConventionAssurance;
         ...
         * @param $modal: any
         */
        constructor($scope: ng.IScope, $modalInstance: any, data: any, $modal: any, formulaireFinancementService: instructionCredit.Service.FormulaireFinancementService);
        resetConvention(): void;
        majListeIdProduit(): void;
...
declare module instructionCredit {
    class ModaleRechercheClientBancaireControleur implements MyWay.UI.ISelectionChangeHandler {
        ...
        close(): void;
        /**
         * Permet d'ajouter une personne dans le cas d'une liste des clients bancaires vide
         */
        creerPersonne(): void;
    }
}
...
declare module instructionCredit {
    class ModaleSituationBdfControleur {
        ...
        enModification: boolean;
        libelleCodeInscriptionFcc: string;
        libelleCodeInscriptionFicp: string;
         ...
         * @param $modal: any
         */
        constructor($scope: ng.IScope, $modalInstance: any, clientService: instructionCredit.Service.ClientService, data: any, $modal: any);
        /**
...
declare module instructionCredit.Modele {
    class Constantes {
        ...
        static listeDelaisRealisation: instructionCredit.Modele.IFormulaireProjetDelais[];
        static emoluments: instructionCredit.Modele.IEmolument[];
        static dateTraitement: Date;
...
declare module instructionCredit.Service {
    class ClientService {
         ...
         */
        getInformationsEntiteTitulaire(codeEtablissement: string, identifiantEntiteTitulaire: string): ng.IPromise<Modele.IInformationEntiteTitulaire>;
        /**
        ...
        /**
         * Permet d'ajouter la personne créée par creerPersonne() à l'emprunteur
         * @param idDosser: string
         * @param personne: instructionCreditModel.IPersonne
         */
        ajouterPersonne(personne: instructionCredit.Modele.IPersonne): void;
    }
}
...
declare module instructionCredit.Service {
    class FormulaireFinancementService {
         ...
         */
        listerConventionsAssurance(listeIdentifiantProduit: Array<string>): ng.IPromise<instructionCredit.Modele.IConventionAssurance[]>;
        /**
         ...
         */
        calculOptimisationAvancee(idDossier: string, idPlan: string, montantEcheanceMaximum: number, inclPATZ: boolean): ng.IPromise<any>;
        /**
         ...
         */
        consulterDossierSmac(idDossier: string, numeroPlanFinanacement: number): ng.IPromise<instructionCredit.Modele.IDossierSmac>;
        /**
...
declare module instructionCredit.Service {
    class InitialisationService {
         ...
         */
        calculerEligibilite(entreeEligibilite: Modele.EntreeEligibilite): ng.IPromise<Modele.IResultatEligibilite>;
        /**
...
declare module instructionCredit.Modele {
    interface IConventionAssurance {
        ...
        listeCotisation?: Array<ICotisationAssurance>;
...
declare module instructionCredit.Modele {
    interface ICreditInterne {
        ...
        tauxInitial?: instructionCredit.Modele.ITauxInteretAnnuel;
...
declare module instructionCredit.Modele {
    ...
    interface IProjetSmac {
        ...
        numeroPlanFinancement: number;
        numeroEntiteTitulaire: string;
        ilYAUnApporteurDAffaire: boolean;
        montant: number;
        marche: string;
...
declare module instructionCredit.Modele {
    interface IBatimentHabitableFinance {
        ...
        montantFrsNegocie: number;
        dateAcqsBatimentHabitation: number;
