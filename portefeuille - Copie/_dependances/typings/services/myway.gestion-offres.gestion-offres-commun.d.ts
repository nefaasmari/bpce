...
declare module GestionGeneriqueOffres.Types {
    ...
    class DonneesProduit {
        ...
        constructor(detenteur: Types.InformationEntiteTitulaire | Types.Tiers.Personne, produit: Types.ProduitService, invisible: boolean, idProducteur: Producteur, repris: boolean, produitSelectionne: Types.CleValeur, donneesSelectionAssemblage: any, pointsEntree: Types.PointsEntree, idBlocProduitSupport: string);
    }
