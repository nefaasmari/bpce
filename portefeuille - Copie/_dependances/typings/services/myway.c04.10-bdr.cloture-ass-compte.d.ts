...
declare module ClotureAssuranceCompte {
    var app: ng.IModule;
}
...
/**
 * Contrôleur de la page de test de la directive de clôture de l'Assurance Compte Professionels
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureAssuranceCompte.Controleurs {
    /**
     * Déclaration du contrôleur
     */
    class PageDevAssCompteClotureControleur {
        static $inject: any[];
        /**
...
declare module ClotureAssuranceCompte.Controleurs {
     ...
     * Déclaration du contrôleur
     */
    class PageDevAssCompteClotureSansIhmControleur {
        static $inject: any[];
        /**
         * Code établissement issu du contexte GGO
         */
 ...
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureAssuranceCompte.Services.Application {
    /**
     * Interface du service
     */
    interface IClotureAssuranceCompteService {
        sauvegarderClotureSurCompte(contexte: GestionGeneriqueOffres.Types.DonneesContextuelles, indicateurCloture: string, codeMotifCloture: string, libelleMotifCloture: string, codeMotifClotureCCE: string): MyWay.Services.IPromesse<ComposantsCommunsAssuranceCompteCourtTerme.Modeles.Application.Commun.IErreurService>;
    }
}

/**
 * Contrôleur de la directive mw-ass-compte-pro-cloture
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureAssuranceCompte.Controleurs {
    /**
     * Déclaration du contrôleur
     */
    class MwAssCompteClotureControleur {
        private $scope;
        private assuranceCompteService;
        private serviceAgent;
        private resilierPersonneService;
        private clotureAssuranceCompteService;
         ...
         * Constructeur
         */
        constructor($scope: ng.IScope, assuranceCompteService: ComposantsCommunsAssuranceCompteCourtTerme.Services.Application.IAssuranceCompteService, serviceAgent: MyWay.Services.ServiceAgentExtended, resilierPersonneService: ComposantsCommunsAssuranceCompteCourtTerme.Services.Application.IResilierPersonneService, clotureAssuranceCompteService: Services.Application.IClotureAssuranceCompteService);
        /**
...
/**
 * Directive pour la gestion de l'affichage de la directive de clôture de l'Assurance Compte Professionnels
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureAssuranceCompte.Directives {
    /**
     * Déclarion du constructeur de la directive
     */
    function mwAssCompteProCloture(): ng.IDirective;
}

/**
 * Contrôleur de la directive mw-ass-compte-pro-cloture-sans-ihm
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureAssuranceCompte.Controleurs {
    /**
     * Déclaration du contrôleur
     */
    class MwAssCompteClotureSansIhmControleur {
        private $scope;
        private assuranceCompteService;
        private serviceAgent;
        private clotureAssuranceCompteService;
         ...
         * Constructeur
         */
        constructor($scope: ng.IScope, assuranceCompteService: ComposantsCommunsAssuranceCompteCourtTerme.Services.Application.IAssuranceCompteService, serviceAgent: MyWay.Services.ServiceAgentExtended, clotureAssuranceCompteService: Services.Application.IClotureAssuranceCompteService);
        /**
         * Méthode pour le chargement de l'objet assuranceSurCompte depuis le service
         */
        private chargerAssuranceSurCompte();
...
/**
 * Directive pour la gestion de l'affichage de la directive sans IHM de clôture de l'Assurance Compte Professionnels
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureAssuranceCompte.Directives {
    /**
     * Déclarion du constructeur de la directive
     */
    function mwAssCompteProClotureSansIhm(): ng.IDirective;
}
