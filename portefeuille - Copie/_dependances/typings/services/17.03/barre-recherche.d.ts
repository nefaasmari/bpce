...
declare module myway.comServiceRecherche.Communs {
    ...
    interface ISendRequest {
        <T>(settings: MyWay.Services.IRequestSettings, resultType?: string): ng.IPromise<T>;
    }
    interface IEstHabilite {
        (codesHabilitation: string[]): ng.IPromise<boolean[]>;
    }
...
declare module myway.comServiceRecherche.Communs {
    ...
    class AnnuaireAgenceService {
        private sendRequest;
        private $q;
        constructor(sendRequest: ISendRequest, $q: ng.IQService);
...
declare module myway.comServiceRecherche.Communs {
    ...
    class AnnuaireService implements IAnnuaireAutocompletionService {
        ...
        constructor(sendRequest: ISendRequest, annuaireAgenceService: AnnuaireAgenceService, $q: ng.IQService);
...
declare module myway.comServiceRecherche.Communs {
    ...
    interface IApplicationModele {
        ...
        codeBesoinOuvertureGuichet: string;
        codeClientIdentifie: string;
...
declare module myway.comServiceRecherche.Communs {
    class ApplicationService implements IApplicationAutocompletionService {
        private sendRequest;
        private habilitationService;
        private $q;
        private cacheApplications;
        constructor(sendRequest: ISendRequest, habilitationService: HabilitationService, $q: ng.IQService);
        chargerApplicationPourAutocompletion(codeEtablissement: string, codeAgent: string, motCle: string): ng.IPromise<IApplicationModele[]>;
        chargerResultats(codeEtablissement: string, typeRecherche: TypeRecherche, motClef: string): ng.IPromise<IApplicationModele[]>;
    }
}
...
declare module myway.comServiceRecherche.Communs {
    ...
    interface IApplicationAutocompletionService {
        chargerApplicationPourAutocompletion(codeEtablissement: string, codeAgent: string, motCle: string): ng.IPromise<IApplicationModele[]>;
    }
}
...
declare module myway.comServiceRecherche.Communs {
    class EtablissementService {
        ...
        constructor(sendRequest: ISendRequest);
...
declare module myway.comServiceRecherche.Communs {
    class HabilitationService {
        private estHabilite;
        constructor(estHabilite: IEstHabilite);
        filtrerParHabilitations(applications: IApplicationModele[]): ng.IPromise<IApplicationModele[]>;
        possedeHabilitation(codeHabilitation: string): ng.IPromise<boolean>;
    }
}
