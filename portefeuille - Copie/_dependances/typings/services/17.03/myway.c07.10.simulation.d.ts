...
declare module instructionCredit {
    class FormulaireFinancementControleur implements MyWay.UI.ISelectionChangeHandler, MyWay.UI.ITuileHandler {
        ...
        /**
         * Permet de mettre à jour le totem en fonction des crédits ajoutés ou pas
         * Methode appelée lors du chargement des crédits et et de l'ajout ou suppression d'un crédit
         */
