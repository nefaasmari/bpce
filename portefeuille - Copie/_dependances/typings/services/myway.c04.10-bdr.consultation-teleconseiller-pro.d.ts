...
declare module ConsultationTeleconseillerPro {
    var app: any;
}
...
/**
 * Contrôleur de la page de consultation TELECONSEILLER PRO
...
declare module ConsultationTeleconseillerPro {
     ...
     */
    class TeleconseillerProConsultationControleur {
        private $scope;
...
declare module ConsultationTeleconseillerPro {
     ...
     * Déclaration du contrôleur
     */
    class TeleconseillerProConsultationRecetteControleur {
        private $scope;
        private $timeout;
        private caracteristiqueAbonnementService;
        static $inject: string[];
