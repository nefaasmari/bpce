...
declare module myway.comContract.Services {
    ...
    class DossierNumeriqueService {
        ...
        /**
         * Retourne une nouvelle valeur à partir des informations stockées coté Front dans le Session Storage.
         * @param baseUrl valeur de base calculée par MySign.
         */
        private updateUrlSessionSignature(baseUrl);
...
declare module myway.comContract.Services {
    /**
     * SagOpcService est un service angularJs a pour objectif d'exposer les services
...
declare module myway.comContract.utils {
    /**
     * Classe introduite car la version Typescript utilisée ne permet pas d'utiliser les types URL, ou URLSearchParams.
     */
    class UrlUtils {
        /**
         * Retoure une nouvelle chaine de caractère représentant une URL, avec la nouvelle paire paramètre + valeur.
         * Remplace la valeur existante si le paramètre est déjà présent.
         * @param url valeur initiale
         * @param param paramètre à ajouter
         * @param paramVal valeur du paramètre
         */
...
declare module myway.comContract.RecapSignataires {
    class RoleSignataireEnum extends MyWay.Services.StringEnum {
        static VISA_COLLABORATEUR: RoleSignataireEnum;
...
declare namespace myway.comContract.Signataire.Constantes.Commun {
    ...
    const MESSAGE_ERREUR_CHECKBOX_VC_CONFIRM: string;
    const CHANGED_EVENTNAME: string;
    const SESSION_STORAGE_MYWAY_CONTAINER_ID: string;
    const PARAM_MYWAY_CONTAINER_ID: string;
...
declare module myway.comContract.signataire {
    class ListeDesignatairesController {
        ...
        private messageErreurCheckboxVcConfirm;
        private isTabVcSelected;
        private checkboxVcConfirm;
        ...
        constructor($scope: ng.IScope, $filter: ng.IFilterService, $parse: ng.IParseService, $q: ng.IQService, $timeout: ng.ITimeoutService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, signataireService: SignataireService);
        /**
        ...
        private existVisaCollabInSignataireReponse();
        ...
        onSelectTabSignataires(): void;
        onSelectTabVc(): void;
        onCheckVcConfirm(isCoche: boolean): void;
        ...
        /**
         * Vérifie le max signataire
         * Evolution Visa Collaborateur : ne pas le compter dans les signataires pour controle du max
         */
        ...
        private setErreurCheckboxConfirmVc(message?);
