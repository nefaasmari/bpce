...
declare module decouvert {
    ...
    class ListeDecouvertsControleur {
        ...
        static $inject: string[];
        afficherListeDecouverts: boolean;
        codeAction: string;
        ...
        constructor($scope: IListeDecouvertsControleurScope, $location: ng.ILocationService, decouvertService: IDecouvertService, modalService: MyWay.UI.IModalService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        ...
        private isTaciteReconduction();
        /** cette méthode précise si la ligne sélectionné du tableau est un découvert dont l'état est annulé ou échu */
        private isDecouvertAnnuleEchu();
        private isOkPourImpression();
        private isModifiableOuSupprimable();
        ...
        private ouvrirModificationDecouvert(decouvertsSelectionnes);
        private supprimerDecouvert(decouvertsSelectionnes);
        private imprimerLettreDecouvert(decouvertsSelectionnes);
    }
}
...
declare module Decouvert.Editique.SIPCGCE_Forfait_Pro.Service {
    ...
    function createDocument(objQuelconque: Object, authentification: MyWay.Services.Context.AuthentificationInfo, parametresComptables: MyWay.Services.Context.ParametresComptables): Modele.SIPCGCE_Forfait_Pro;
}
...
declare module decouvert {
    interface ICommonService {
        ...
        getLibelleTypeLettreConfirmation: (cle: string) => string;
    ...
    class CommonService implements ICommonService {
        ...
        /** Cette métthode retoure le libellé associé à l'indicateurEditionLettreConfirmation d'un découvert */
        private getTypeLettreConfirmation(indicateurEditionLettreConfirmation);
        ...
        /** Cette métthode construit le libellé associé au taux d'intérêt d'un découvert */
        private getLibelleTauxInteret(libelleTauxDebiteur, variationBareme);
        ...
        /** Cette méthode permet de récupérer le code associé au type de lettre de confirmation d'un découvert. */
        private getCodeLettreConfirmation(typeLettreConfirmation);
...
declare module decouvert {
    interface IDecouvertService extends ICommonService {
        ...
        getListeDeDecouverts: (context: any) => ng.IPromise<Array<Object>>;
...
declare module decouvert {
    class ReferentielDecouvert {
        ...
        static typesLettreConfirmation: any;
    }
}
...
declare module decouvert.creationDecouvert {
    ...
    class CreationDecouvertControleur {
        ...
        private static SANS_LETTRE_CONFIRMATION;
        private static LETTRE_DUREE_DETERMINEE;
        private static LETTRE_DUREE_INDETERMINEE;
        static $inject: string[];
        private decouvert;
        private typesDecouvert;
        private typesCommission;
        private typesLettreConfirmation;
        private showButtonImprimer;
        private helpInfoBullLettre;
        private helpInfoBullMontant;
        authentification: MyWay.Services.Context.AuthentificationInfo;
        parametresComptables: MyWay.Services.Context.ParametresComptables;
        constructor($location: ng.ILocationService, $timeout: ng.ITimeoutService, creationDecouvertService: ICreationDecouvertService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        /** Mise à jour de l'agent connecté */
        private setAuthenticatedAgent();
        /** Initialisation du contexte depuis le Scope */
        private initialiserContexte();
        ...
        private initialiserTypesLettreConfirmation();
        private initialiserinfoBullData();
        getTypesDecouvert(): Object[];
        getTypesCommission(): Object[];
        private getTypeDecouvert(cle);
        private getTypeCommission(cle);
        private getTypeLettreConfirmation(cle);
        private afficherTaux(choix);
        private afficherPeriodicite(choix);
        private afficherConditionsArretes();
        private afficherGarantie();
        /** Indique si on affiche où non le champ pourcentage CA confié à l'entreprise */
        private affichePourcentageCAConfie();
        private imprimerLettreDecouvert();
        changerTypeLettreConfirmation(): void;
        /** Indique si on peut modifier la date de fin d'un découvert de type tacite reconduction */
        private canEditDateDeFin();
        ...
        private creerNouveauDecouvert();
        /** Retour à la page d'accueil, liste des découvert */
        private revenirListeDecouverts();
        /**
         * Méthode appelée pour l'annulation de la création de l'autorisation de découvert
...
declare module decouvert.creationDecouvert {
    interface ICreationDecouvertService extends ICommonService {
        ...
        getListeTypeLettreConfirmation: () => string[];
...
declare module decouvert.decouvert {
    ...
    class DecouvertControleur {
        ...
        numeroOffreSouscrite: number;
        afficherListeDecouverts: boolean;
        constructor($scope: IDecouvertControleurScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
    }
}
