...
declare module myway.comContract.Services {
    ...
    class ContractualisationActeService {
        ...
        /**
        */
        private getVerifierEligiblitePanier();
        /**
         * @ngdoc method
...
declare module myway.comContract.ContractualisationActe.Modeles {
    interface IActe {
        ...
        /**
         * V20.01  Libelle du motif de non eligibilité à la signature élec envoyé par le producteur (pr l'instant crédit conso)
         */
