...
declare module myway.comInterdomaine {
    class SaisirAdvancedSelectController {
         ...
         * @returns {void}.
         */
        bindingModel(itemValue: Object): void;
        regexData(itemValue: string): void;
        reajusterValeur(itemValue: string): void;
        /**
         * @ngdoc method
...
declare module myway.comInterdomaine {
    class MwsfInfobulleAideController {
        ...
        private closeEvent;
        static $inject: string[];
        constructor($scope: ng.IScope, $q: ng.IQService, $document: ng.IDocumentService, $timeout: ng.ITimeoutService, $element: ng.IAugmentedJQuery, $attrs: IInfobulleAttributes, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, infobulleAideService: InfobulleAideService);
        toggleOuvert(): void;
...
declare module myway.comInterdomaine {
    class ListeCompteIbanController {
        private $scope;
        private serviceAgentExtended;
        private listeCompteIbanService;
        private $q;
        static $inject: string[];
        listeCompteIban: MyWay.Model.IConsultationIBAN[];
        parametres: MyWay.Model.ParametresListeComptesIban;
        compteSelectionne: MyWay.Model.IConsultationIBAN;
        placeHolder: string;
        listeGrisee: boolean;
        _onSelect: any;
        _onBottomAction: any;
        errorService: MyWay.Services.Erreur;
        constructor($scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, listeCompteIbanService: myway.comInterdomaine.ListeCompteIbanService, $q: ng.IQService);
        private getListeComptesIban();
        private determinerPlaceHolder(listeCompteIban);
        onSelect(item: MyWay.Model.IConsultationIBAN): void;
        onBottomAction(item: MyWay.Model.IConsultationIBAN): void;
    }
}
...
declare module myway.comInterdomaine {
    class ListeCompteIbanService {
        private serviceAgentExtended;
        private $q;
        private static CCIE_RESSOURCE;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $q: ng.IQService);
        getListCompteIban(codeEtablissement: string, codeGuichetInterbancaire: string, numeroComptePS: string, codeAction: string): ng.IPromise<MyWay.Model.IIbanContrat>;
    }
}
...
declare module myway.comInterdomaine {
    class ListeCompteController {
        ...
        estAuthorize: boolean;
        initialisation: boolean;
        compteInitialisation: boolean;
        constructor($scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, listeCompteService: myway.comInterdomaine.ListeCompteService, mwsfDeviseService: myway.comInterdomaine.DeviseService, $q: ng.IQService);
        /**
         * @alias : padLeftZero
        ...
        private createIbanAuthorize();
        private createSansContrepartie();
        /**
...
declare module myway.comInterdomaine {
    class ListeCompteService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, saisieRiceService: myway.comInterdomaine.SaisieRiceService, compteService: myway.comInterdomaine.CompteService, $filter: ng.IFilterService);
        /**
        ...
        private isContratElligibleFiltrageProduits(filtrageCommunATousLesClients, produits, produitsArray, produitsTab, index, cont);
        private getContratAvecLibelle(cont, etab);
        /**
        ...
        getInformationsCompte(comptes: MyWay.Model.Contrat[], compteListeVide: MyWay.Model.Contrat): ng.IPromise<MyWay.Model.Contrat>;
    }
}
...
declare module MyWay.Model {
    ...
    class ParametresListeComptesIban {
        codeEtablissement: string;
        codeGuichetInterbancaire: string;
        numeroComptePS: string;
        constructor(codeEtablissement: string, codeGuichetInterbancaire: string, numeroComptePS: string);
    }
    class ParametresListeComptes {
        identifiantsPersonnes: string[];
        identifiantsEntitesTitulaires: string[];
        typesProduits: string[] | Array<String>[];
        typeRecherche: string;
        codeEtatRecherche: string;
        codeDevise: string;
        itemSupplementaire: ItemSupplementaireListeCompte;
        itemBottomText: string;
        itemSupplementaireBis: ItemSupplementaireListeCompte;
        listeComptesExternes: IParametreComptesExternes[];
        compteAEnlever: MyWay.Model.Contrat;
        parametreComptesCCI: ParametreComptesCCI;
        compteListeVide: MyWay.Model.Contrat;
        compteAppelOrigine: string;
        compteEtranger: boolean;
        constructor();
        constructor(identifiantsPersonnes: string[], typeRecherche: string, codeEtatRecherche: string);
        constructor(identifiantsPersonnes: string[], typeRecherche: string, codeEtatRecherche: string, typesProduits: string[] | Array<String>[], codeDevise?: string);
        constructor(identifiantsPersonnes: string[], typeRecherche: string, codeEtatRecherche: string, typesProduits: string[] | Array<String>[], codeDevise?: string, itemSup?: ItemSupplementaireListeCompte);
        constructor(identifiantsPersonnes: string[], typeRecherche: string, codeEtatRecherche: string, typesProduits: string[] | Array<String>[], codeDevise?: string, itemSup?: ItemSupplementaireListeCompte, itemBottom?: string);
        constructor(identifiantsPersonnes?: string[], typeRecherche?: string, codeEtatRecherche?: string, typesProduits?: string[] | Array<String>[], codeDevise?: string, itemSup?: ItemSupplementaireListeCompte, itemBottom?: string, listeExternes?: IParametreComptesExternes[]);
        constructor(identifiantsPersonnes?: string[], typeRecherche?: string, codeEtatRecherche?: string, typesProduits?: string[] | Array<String>[], codeDevise?: string, itemSup?: ItemSupplementaireListeCompte, itemBottom?: string, listeExternes?: IParametreComptesExternes[], compteAEnlever?: MyWay.Model.Contrat);
        constructor(identifiantsPersonnes?: string[], typeRecherche?: string, codeEtatRecherche?: string, typesProduits?: string[] | Array<String>[], codeDevise?: string, itemSup?: ItemSupplementaireListeCompte, itemBottom?: string, listeExternes?: IParametreComptesExternes[], compteAEnlever?: MyWay.Model.Contrat, identifiantsEntitesTitulaires?: string[]);
        ...
        constructor(identifiantsPersonnes?: string[], typeRecherche?: string, codeEtatRecherche?: string, typesProduits?: string[] | Array<String>[], codeDevise?: string, itemSup?: ItemSupplementaireListeCompte, itemBottom?: string, listeExternes?: IParametreComptesExternes[], compteAEnlever?: MyWay.Model.Contrat, identifiantsEntitesTitulaires?: string[], parametreComptesCCI?: ParametreComptesCCI, compteListeVide?: MyWay.Model.Contrat);
        constructor(identifiantsPersonnes?: string[], typeRecherche?: string, codeEtatRecherche?: string, typesProduits?: string[] | Array<String>[], codeDevise?: string, itemSup?: ItemSupplementaireListeCompte, itemBottom?: string, listeExternes?: IParametreComptesExternes[], compteAEnlever?: MyWay.Model.Contrat, identifiantsEntitesTitulaires?: string[], parametreComptesCCI?: ParametreComptesCCI, compteListeVide?: MyWay.Model.Contrat, itemSupBis?: ItemSupplementaireListeCompte);
        constructor(identifiantsPersonnes?: string[], typeRecherche?: string, codeEtatRecherche?: string, typesProduits?: string[] | Array<String>[], codeDevise?: string, itemSup?: ItemSupplementaireListeCompte, itemBottom?: string, listeExternes?: IParametreComptesExternes[], compteAEnlever?: MyWay.Model.Contrat, identifiantsEntitesTitulaires?: string[], parametreComptesCCI?: ParametreComptesCCI, compteListeVide?: MyWay.Model.Contrat, itemSupBis?: ItemSupplementaireListeCompte, compteAppelOrigine?: string);
        constructor(identifiantsPersonnes?: string[], typeRecherche?: string, codeEtatRecherche?: string, typesProduits?: string[] | Array<String>[], codeDevise?: string, itemSup?: ItemSupplementaireListeCompte, itemBottom?: string, listeExternes?: IParametreComptesExternes[], compteAEnlever?: MyWay.Model.Contrat, identifiantsEntitesTitulaires?: string[], parametreComptesCCI?: ParametreComptesCCI, compteListeVide?: MyWay.Model.Contrat, itemSupBis?: ItemSupplementaireListeCompte, compteAppelOrigine?: string, compteEtranger?: boolean);
...
declare module MyWay.Model {
    ...
    interface IDonneeSpecifiqueProfilComplet {
        ...
        /**
         * Le montant à régulariser correspond à tout ce qui n'a pas été versé depuis l'ouverture jusqu'à la date de l'opération e en ajoutant au solde de début de la
         * période considérée le cumul des opérations de débit et de crédit réalisées.
         * Elle est obtenue en ajoutant au solde de début de la période considérée le cumul des opérations de débit et de crédit réalisées.
         * Le solde calculé 'fin de période' sert de base pour établir celui de la période suivante.
         */
...
declare module myway.comInterdomaine.Model {
    ...
    interface IRequeteFamilleOpposition {
        codeEtablissement: string;
    }
    interface IRechercheFamilleOpposition {
        codeFamille: string;
        libelleFamille: string;
        listeMotifOpposition: IlisteMotifOpposition[];
    }
    interface IlisteMotifOpposition {
        codeMotif: string;
        libelleCourt: string;
        libelleLong: string;
        codeNiveau: string;
        ...
        codePrestationTarifaire: number;
        codeOppositionNationale: string;
        indicateurUnicite: string;
        indicateurForcageOpposition: boolean;
    }
    interface IRequeteOppositionRecherche {
        identifiantPersonne: number;
        indicateurOppoActive: string;
        indicateurRechercheCompteClos: boolean;
    }
    interface IRechercheOpposition {
        listeMessageAvertissement: Array<string>;
        personne: IPersonne;
        listeOppositionActive: Array<IOpposition>;
        listeOppositionEchue: Array<IOpposition>;
        listeOppositionProgrammee: Array<IOpposition>;
    }
    interface IPersonne {
        codeEtablissement: string;
        identifiantPersonne: number;
    ...
    interface ITableDelocXX51MOPO {
        id: string;
        referentiel: string;
        nom: string;
        datemaj: string;
        donnees: IDonneeDelocaliseeXX51MOPO[];
    }
    interface IDonneeDelocaliseeXX51MOPO {
        UDDXE1: string;
        UCOPNL: string;
        UCGPUN: string;
        UVTPNS: string;
...
declare module myway.comInterdomaine.Service {
    class OppositionService {
        ...
        static $inject: string[];
        codeDevise: string;
        oppositionData: myway.comInterdomaine.Model.IRechercheOpposition;
        oppositionFamille: myway.comInterdomaine.Model.IRechercheFamilleOpposition[];
        tableCapaciteJuridique: Model.ITableDelocDU2C;
        tableCodeMotifOppo: Model.ITableDelocXX51MOPO;
        listeOppositionActive: myway.comInterdomaine.Model.IOpposition[];
         ...
         */
        requeteOpposition(codeEtablissement: string, codeGuichet: string, numeroCompte: string, numeroPersonne: number, numeroEntiteTitulaire: number): ng.IPromise<myway.comInterdomaine.Model.IRechercheOpposition>;
        findCapaciteJuridique(capacitejuridique: string): string;
        formattedToday(oppositionDate: string): string;
    }
}
...
declare module myway.comInterdomaine {
    class SaisirRibController {
        ...
        private modeSupp;
        static $inject: string[];
        constructor($scope: ng.IScope, saisieRiceService: SaisieRiceService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $timeout: ng.ITimeoutService);
        /**
         * @alias keydown
         * @description : event keydown
         * @param {event}
...
declare module myway.comInterdomaine {
    class AffectationRadicalService {
        ...
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, saisieRiceService: myway.comInterdomaine.SaisieRiceService);
        /**
...
declare module myway.comInterdomaine {
    class CompteService {
        ...
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, saisieRiceService: myway.comInterdomaine.SaisieRiceService);
        /**
         * OBSOLETE
...
declare module myway.comInterdomaine {
    ...
    class InterDomainCoreServiceProvider implements ng.IServiceProvider {
        constructor();
        $get($q: ng.IQService, $http: ng.IHttpService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended): InterDomainCoreService;
    }
