...
declare module ajoutFavorisCommun {
    ...
    class ModalCategoriesControleur {
         ...
         */
        enregistrerFavoris: (favoris: IFavorisCollection) => ng.IPromise<string>;
        /**
...
declare module ajoutFavorisCommun {
    ...
    class LireEcrireService {
         ...
         * @return {boolean}
         */
        ajouterFavoris: (favori: IFavoris, favoris: IFavorisCollection) => boolean;
        /**
         ...
         * @return {ng.IPromise<string>}
         */
        ecrireFavoris: (favoris: IFavorisCollection) => ng.IPromise<string>;
        /**
...
declare module ajoutFavorisCommun {
    interface IApplicationTuile extends myway.ressources.portailmyway.rechercheapplication.IApplication {
        description: string;
    }
    class ModalCategoriesService {
        selectedTuile: IApplicationTuile;
        tuileText: string;
        private _categories;
        private _favoris;
        private _ajout;
         ...
         */
        getIdCommun: (tuile: myway.ressources.portailmyway.rechercheapplication.IApplication) => string;
        /**
         ...
         * @return {void}
         */
        openModal: (tuile: IApplicationTuile, categories: ICategories[], favoris: IFavorisCollection, ajout: boolean, bulle?: boolean) => void;
    }
}
