...
declare module myway.comEditiqueNumerisation.Services {
    ...
    class JustificatifService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, pieceJointeService: MyWay.PieceJointe.PieceJointeService, gedService: MyWay.PieceJointe.GedService, dossierPropagationService: DossierPropagationService);
        /**
         ...
         */
        setDocumentJustificatifContexte(document: IDocumentJustificatif, save?: boolean): ng.IPromise<void>;
        /**
...
declare module myway.comEditiqueNumerisation.Services {
    ...
    class NumerisationService {
        ...
        private authentificationInfos;
        static $inject: string[];
        constructor($q: ng.IQService, modalService: MyWay.UI.ModalService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, communService: Services.CommunService, justificatifService: JustificatifService);
        /**
...
declare module myway.comEditiqueNumerisation.Services {
    interface IAppelClasseurClientParams {
    }
}
...
declare module myway.comEditiqueNumerisation {
    class RemiseConditionsGeneralesController {
        ...
        static $inject: string[];
        constructor($scope: ng.IScope, $rootScope: ng.IScope, $q: ng.IQService, $timeout: ng.ITimeoutService, serviceAgent: MyWay.Services.ServiceAgentExtended, modalService: MyWay.UI.ModalService, cgService: Services.ConditionsGeneralesService, editiqueService: Services.EditiqueService);
        private init();
