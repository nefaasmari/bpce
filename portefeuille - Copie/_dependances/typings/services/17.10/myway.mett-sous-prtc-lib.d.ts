...
declare module libMettSousPrtc {
    class MiseSousProtectionControleur {
        ...
        constructor(serviceAgent: MyWay.Services.ServiceAgentExtended, miseSousProtectionService: MiseSousProtectionService, utilService: UtilService, $modalInstance: ng.ui.bootstrap.IModalServiceInstance, $q: ng.IQService, messageService: MessageService);
...
declare module libMettSousPrtc {
    class MiseSousProtectionService {
        ...
        private utilService;
        private modalService;
        private synchroSyntheseService;
        static $inject: string[];
        personneProtege: modeles.Personne;
        codeEtablissement: string;
        identifiantPersonne: string;
        codeGuichet: string;
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $q: ng.IQService, urlPPTutelle: string, urlEquipementClient: string, urlCompteExclus: string, utilService: UtilService, modalService: MyWay.UI.IModalService, synchroSyntheseService: libSynchroSynthese.SynchroSyntheseService);
        /**
