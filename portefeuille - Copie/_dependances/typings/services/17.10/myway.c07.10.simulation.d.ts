...
declare module instructionCredit {
    class FormulaireClientControleur implements MyWay.UI.ITuileHandler {
        ...
        libelleStatutOccupationLogementEmprunteur: string;
         ...
         */
        private supprimerRevenuFiscal(idwsRevenuFiscal);
        /**
        ...
        /**
         * Retourne la ligne des montants sur la tuile d'une épargne dans l'établissement
         */
...
declare module instructionCredit {
    class FormulaireEditionOffreControleur {
        private $timeout;
        private $location;
        private modalService;
        private initialisationService;
        ...
        ajouterClauseEstOuvert: boolean;
        listeClauses: Array<any>;
        constructor($timeout: ng.ITimeoutService, $location: ng.ILocationService, modalService: MyWay.UI.IModalService, initialisationService: Service.InitialisationService, cheminFerService: Service.CheminFerService, navigationInterneService: Service.NavigationInterneService);
        /**
         * Gère l'action toogle du bouton riche "+ ajouter une clause"
         * @param {boolean} open
         */
        ouvertureBoutonClause(open: boolean): void;
        /**
         * Ajoute une classe emprunteur
         */
        ajouterClauseEmprunteur(): void;
        /**
         * Ajoute une classe Rédacteur d'acte
         */
        ajouterClauseRedacteurActe(): void;
        /**
         * Ouverture d ela popin permettant l'édition d'une clause
         * @param dataClause
         * @param estClauseEmprunteur
         */
        majClause(dataClause: any, estClauseEmprunteur: boolean): void;
        /**
         * Demande confirmation puis supprimer la clause
         * @param clause
         */
        supprimerClause(clause: any): void;
        /**
         *
         */
        consulterDecisions(): void;
        /**
         * Clique sur le lien hypertexte « Consulter dossier » déclenche le débranchement sur le dossier en consultation
         */
        consulterDossier(): void;
        majDossier(): void;
        annulerAccordPreteur(): void;
        editerOffre(): void;
        /**
         * Ouverture de la popin prmettant d'ajouter une clause
         */
        private popinClause(data);
    }
}

declare module instructionCredit {
    class FormulaireDecisionPreteurControleur {
        private $timeout;
        private $location;
        private modalService;
        private initialisationService;
        ...
        dateDecison: Date;
        btnActionRicheOuvert: boolean;
        estDelegataire: boolean;
        dossierTransfere: boolean;
        constructor($timeout: ng.ITimeoutService, $location: ng.ILocationService, modalService: MyWay.UI.IModalService, initialisationService: Service.InitialisationService, cheminFerService: Service.CheminFerService, navigationInterneService: Service.NavigationInterneService);
        /**
         * Gère l'action toogle du bouton riche
         * @param {boolean} open
         */
        ouvertureBtnActionRiche(open: boolean): void;
        /**
         * Clique sur le lien hypertexte « Consulter dossier » déclenche le débranchement sur le dossier en consultation
         */
        consulterDossier(): void;
        controler(): void;
        transfererPourAvis(): void;
        /**
         * recherche du délégataire pour transférer
         */
        transfererPourDecision(): void;
        retournerPourMaj(): void;
        refuserFinancement(): void;
        /**
         * Ouverture de la popin permettant d'accorder le financement
         */
        accorderFinancement(): void;
        /**
         * Dans le cas où le menu ne s'active pas automatiquement, force l'activation
         */
        private gestionActivationTotem();
    }
}
...
declare module instructionCredit {
    class FormulaireFinancementControleur implements MyWay.UI.ISelectionChangeHandler, MyWay.UI.ITuileHandler {
        ...
        /**
         * Génère le libellé de la 2ème ligne à afficher pour la tuile de crédit interne
         */
        getLibelleLigneDeuxCreditInterne(creditInterne: Modele.ICreditInterne): string;
        /**
         * Génère le libellé de la 3ème ligne à afficher pour la tuile de crédit interne
         */
        getLibelleLigneTroisCreditInterne(creditInterne: Modele.ICreditInterne): string;
        /**
         ...
         */
        popinGarantie(idsCreditSelectionne?: string[]): void;
        /**
         * Afifchage de la popin de création de garantie crédit logement
         */
        popinGarantieCreditLogement(idsCreditSelectionne: string[]): void;
        /**
         ...
         */
        private gestionPopinCreditInternePtz(creditInterne, creditASupprimer, creditAMaj, result);
        /**
         * Mets-à-jour l'IHM suite à des actions sur les crédits
         */
        private majDependancesCredit(planFinancement, estPTZ);
        /**
...
declare module instructionCredit {
    class FormulaireCreditInterneEpargneLogementControleur {
        ...
        valider(): void;
        /**
         * redirige evrs la page du financement
         */
        private redirectionPageFinancement();
        /**
...
declare module instructionCredit {
    class SyntheseControleur {
        ...
        constructor($q: ng.IQService, $timeout: ng.ITimeoutService, $document: ng.IDocumentService, $location: ng.ILocationService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, navigationInterneService: Service.NavigationInterneService, initialisationService: Service.InitialisationService, financementService: Service.FinancementService, projetService: Service.ProjetService, syntheseService: Service.SyntheseService, personnalisationService: Service.PersonnalisationService, controleDossierService: Service.ControleDossierService, modalService: MyWay.UI.IModalService);
        /**
...
declare module instructionCredit {
    class FormulaireProjetControleur {
        ...
        performancesEnergetiques: Modele.ISelectbox[];
        performanceEnergetiqueSelectionnee: Modele.ISelectbox;
        ...
        /**
         *  Permet de mettre à jour la performance énergétique
         */
        majPerformanceEnergetique(): void;
    }
}

declare module instructionCredit {
    class FormulaireGestionAdministrativeControleur {
        private $timeout;
        private $location;
        private initialisationService;
        private frmGestionAdministrativeService;
        private cheminFerService;
        private navigationInterneService;
        static $inject: Array<string>;
        constructor($timeout: ng.ITimeoutService, $location: ng.ILocationService, initialisationService: Service.InitialisationService, frmGestionAdministrativeService: Service.FormulaireGestionAdministrativeService, cheminFerService: Service.CheminFerService, navigationInterneService: Service.NavigationInterneService);
        /**
         * Charge le dossier et les éléments de la page
         */
        private chargerDossier();
        /**
         * Déclenche le passage de l’étape du  dossier à l’étape « Décision ».
         */
        decider(): void;
        /**
         * Dans le cas où le menu ne s'active pas automatiquement, force l'activation
...
declare module instructionCredit.Service {
    class FormulaireGestionAdministrativeService {
        private $q;
        private initialisationService;
        static $inject: Array<string>;
        chargementEnCours: boolean;
        listeAssurances: Array<Modele.IAssurance>;
        listeGarantiesReelles: Array<Modele.IGarantieReelle>;
        listePayeurs: Array<Modele.IPayeur>;
        listeInterditsBancaires: Array<Modele.IInterditBancaire>;
        constructor($q: ng.IQService, initialisationService: Service.InitialisationService);
        /**
         * Récupère le dossier et charge les élements utilisées dans la page
         */
        chargerDossier(): ng.IPromise<void>;
    }
}

declare module instructionCredit {
    class FormulaireSignatureOffreControleur {
        private $timeout;
        private $location;
        private modalService;
        private initialisationService;
        ...
        tableauIntervenantsValide: MyWay.UI.ImwTableOptions;
        intervenants: Array<any>;
        listeReponsesChoix: Array<Modele.ISelectbox>;
        constructor($timeout: ng.ITimeoutService, $location: ng.ILocationService, modalService: MyWay.UI.IModalService, initialisationService: Service.InitialisationService, navigationInterneService: Service.NavigationInterneService);
        /**
         * Intogation sur la situation BDF
         * @param intervenant
         */
        interrogerBdf(intervenant: any): void;
        /**
         * Après la saisie, vérification si la date est autorisé
         */
        verificationDate(intervenant: any): void;
        /**
         * Enregistrement de la réponse des intervenants
         */
        enregistrerSignature(): void;
        /**
         * Génère la structure du tableau récapitulatif des intervenants sur le dossier
         */
        private creationTableauIntervenantsValide();
    }
}

declare module instructionCredit {
    class FormulaireRemiseOffreControleur {
        private $timeout;
        private $location;
        private modalService;
        private initialisationService;
        ...
        static $inject: string[];
        chargementEnCours: boolean;
        openDateRemiseOffre: boolean;
        dateRemiseOffre: Date;
        calculerDateFinValiditeOffre: boolean;
        dateFinValiditeOffre: Date;
        constructor($timeout: ng.ITimeoutService, $location: ng.ILocationService, modalService: MyWay.UI.IModalService, initialisationService: Service.InitialisationService, cheminFerService: Service.CheminFerService, navigationInterneService: Service.NavigationInterneService);
        /**
         * Calcul la date de fin de validité de l'offre
         */
        calculerDateValidite(): void;
        /**
         *
         */
        consulterDecisions(): void;
        ...
        consulterDossier(): void;
        consulterOffre(): void;
        validerDateRemiseOffre(): void;
        retourEditionOffre(): void;
        validerRemiseOffre(): void;
    }
}
...
declare module instructionCredit {
    class EncoursControleur {
        ...
        private emprunteur;
        private idwsProjet;
        residencesEncours: Modele.ISelectboxNumber[];
        residenceEncoursSelectionnee: Modele.ISelectboxNumber;
        residenceEncoursTmp: Modele.ISelectboxNumber;
        resultatCalculEnCoursEL: Modele.IResultatCalculEnCoursEL;
        restePel: number;
        resteCel: number;
        montantEncoursEpLogement: Modele.IMontantEncoursEpargneLogement;
        encoursLoader: boolean;
        /**
         * Constructeur
         */
        ...
        /**
         * Action d'effectuer le Rafraichissement des encours
         */
        rafraichirEncours(): void;
        /**
        ...
        /**
         * Récupère les montants réglementaires des encours épargne logement
         */
        private initMontantEnCours();
    }
}
...
declare module instructionCredit {
    class ModaleCompteHorsCeControleur {
        private $scope;
        private $modalInstance;
        private serviceAgentExtended;
        private initialisationService;
...
declare module instructionCredit {
    class ModaleEpargneHorsCeControleur {
        private $scope;
        private $modalInstance;
        private serviceAgentExtended;
        private initialisationService;
...
declare module instructionCredit {
    class ModaleContratEpargneLogementControleur {
        ...
        etapeSuivante(): void;
        /**
         * Ouvre la popin de confirmation de modification des dates
         */
        private popinModificationDates();
        /**
...
declare module instructionCredit {
    class ModaleRevenuFiscalControleur {
        private $scope;
        private $modalInstance;
        private serviceAgentExtended;
        static $inject: Array<string>;
...
declare module instructionCredit {
    class AvisDecisionControleur {
        private modalService;
        private avisDecisionService;
        static $inject: string[];
        etapeMontage: boolean;
        constructor(modalService: MyWay.UI.IModalService, avisDecisionService: Service.AvisDecisionService);
        /**
         * Ajoute un avis à la décisision
         */
        ajouterAvis(): void;
        /**
         * Modifie un avis
         */
        majAvis(dataAvis: any): void;
        /**
         * Ouverture de la popin permattant d'éditer lavis
         * @param data
         */
        private popinAvis(data);
    }
}
...
declare module instructionCredit {
    class CheminDeFerControleur {
        private cheminFerService;
        static $inject: Array<string>;
        constructor(cheminFerService: Service.CheminFerService);
    }
}
...
declare module instructionCredit.Service {
    class CheminFerService {
        ...
        cssEtapeCinq: string;
        cssEtapeSix: string;
        constructor(navigationInterneService: Service.NavigationInterneService);
        /**
         * En fonction de l'étape, gère le style de l'étape active et le responsive
         * @param sousEtatDossier
         */
        majChemin(sousEtatDossier: number): void;
        /**
...
declare module instructionCredit {
    class LienConsulterDossierControleur {
        private $location;
        private navigationInterneService;
        private navigationService;
        static $inject: Array<string>;
...
declare module instructionCredit {
    class ModaleErreurCreationDossierControleur {
        private $modalInstance;
        static $inject: Array<string>;
        libelleErreur: string;
        constructor(data: any, $modalInstance: ng.ui.bootstrap.IModalServiceInstance);
        /**
         * Ferme la popin
         */
        close(): void;
...
declare module instructionCredit.Service {
    ...
    class NavigationInterneService {
        ...
        /**
         * Force l'activation dans le menu
         */
         ...
         */
        creerTotemPrincipal(sousEtatDossier: number): void;
        /**
         * Génrère le totem pour la partie proposition
         */
        creerTotemProposition(): void;
        /**
         ...
         */
        majTotemSignature(): void;
        /**
         * Création du totem de la page secondaire Crédit en fonction de la présence ou non d'un compte courant
         */
        initTotemSecondaireCredit(libelleCredit: string, compteCourant: boolean): void;
        /**
...
declare module instructionCredit {
    class RouteurControleur {
        ...
        private cheminFerService;
        static $inject: Array<string>;
        constructor($q: ng.IQService, $location: ng.ILocationService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, initialisationService: Service.InitialisationService, navigationInterneService: Service.NavigationInterneService, cheminFerService: Service.CheminFerService);
        /**
         * Récupére la code de la page à accéder
         */
        private getPageVuePrincipale();
        /**
         * Si ce n'est pas un débranchement particulier, il faut connaitre la page correspondante à l'étape du dossier
         * @param sousEtatDossier
         */
        private getVueByEtape(sousEtatDossier);
    }
}
...
declare module instructionCredit {
    class TexteLongControleur {
        ...
        /**
         * Vérifie si le etxte est trop long, affcihage du lien permattant de voir plus
         * La donnée de référence est la donnée du CSS /!\ il faut être iso
         * @param hauteurElement
         * @param majFenetre
         */
        gererTexteTropLong(hauteurElement: number, majFenetre: boolean): void;
    }
}
    ...
    module Navigation {
        ...
        module Page {
            ...
            class VuePrincipale extends MyWay.Services.StringEnum {
                ...
                static conformite: VuePrincipale;
                static mrh: VuePrincipale;
                static blocNotes: VuePrincipale;
                static historique: VuePrincipale;
            ...
            class VueSecondaireFinancement extends MyWay.Services.StringEnum {
                static creditDetail: VueSecondaireFinancement;
...
declare module instructionCredit.Modele {
    class Constantes {
        ...
        static performancesEnergetiquesLogementAncien: instructionCredit.Modele.ISelectbox[];
        static performancesEnergetiquesLogementNeuf: instructionCredit.Modele.ISelectbox[];
        ...
        static statutsOccupationLogementEmprunteur: instructionCredit.Modele.ISelectboxNumber[];
...
declare module instructionCredit.Service {
    ...
    class AuthentificationService {
        ...
        _initDevise: boolean;
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, navigationService: MyWay.UI.INavigationService, $location: ng.ILocationService, initialisationService: Service.InitialisationService, clientService: Service.ClientService, projetService: Service.ProjetService, financementService: Service.FinancementService, controleDossierService: Service.ControleDossierService, cookieFactory: Service.CookieFactory, navigationInterneService: Service.NavigationInterneService, personnalisationService: Service.PersonnalisationService, modalService: MyWay.UI.IModalService);
        /**
         * Initialise la session si ce n'est pas encore fait
         */
        initContext(): ng.IPromise<any>;
        /**
         * Initialise les données nécessaire pour naviguer dans toute l'application
         * @returns boolean
         */
        initDonneesSession(): ng.IPromise<boolean>;
        /**
         *   Initialise les données pour la reprise de dossier en cas de fermeture intempestive
         */
        private repriseDossier(valeursCookie);
        /**
        ...
        /**
         * Crée un dossier
         * @returns True si la création s'est bien passé, false une erreur
         */
        ...
        /**
         * Lors de la création d'un dossier, si une arrive se produit ouverture de la popin et redirection vers recherche
         */
        private popinErreurCreationDossier(erreur);
        /**
         * Permet d'initialiser la devise
         */
        private initDevise(codeDevise);
    }
}
...
declare module instructionCredit.Service {
    ...
    class ContratEpargneLogementService {
         ...
         */
        listerMontantEncoursEpLogement(): ng.IPromise<Modele.IMontantEncoursEpargneLogement>;
        /**
...
declare module instructionCredit.Service {
    ...
    class ControleDossierService {
        ...
        constructor($q: ng.IQService, $location: ng.ILocationService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, modalService: MyWay.UI.IModalService, navigationService: MyWay.UI.INavigationService, initialisationService: Service.InitialisationService, navigationInterneService: Service.NavigationInterneService);
        /**
...
declare module instructionCredit.Service {
    class CreditConsoService {
        ...
        constructor($q: ng.IQService, initialisationService: Service.InitialisationService);
        /**
         * Mise à jour du crédit existant dans sa globalité
...
declare module instructionCredit.Service {
    class FinancementService {
         ...
         */
        listerProdEtFamAuto(identifiantDossier: string, identifiantProjet: string, idPlanFinancement: string, codeDevise: string, optim: boolean): ng.IPromise<Modele.IFamillesProduits[]>;
        /**
         * Permet de récupérer la liste des produits autorisés pour le projet
         */
...
declare module instructionCredit.Service {
    class GarantieService {
         ...
         * @return promise<IConventionGarantie[]>
         */
        listerConventionsGarantieParCredit(identifiantDossier: string, listeIdwsCredit: string[], cdfcod: string, cdfcng: string, libelleLong: string, topGarantie: boolean): ng.IPromise<Modele.IScConventionGarantie[]>;
        /**
...
declare module instructionCredit.Service {
    class InitialisationService {
         ...
         */
        creerProjet(toc: string, tor: string, canalDeCreation: string, codeDevise: string, idClientBancaire?: string): ng.IPromise<Modele.IDossierSchema>;
        /**
         ...
         *
         */
        listerDocuments(idDossier: string, idProposition: string): ng.IPromise<Modele.IResultatListerDocuments>;
        /**
        ...
        estLoiConso(): boolean;
        /**
         * Contrôle si la caisse est paramétrée multi-devise
         */
        controleMultiDevise(): ng.IPromise<void>;
        /**
         * Permet de contrôler l'activation d'un paramètre applicatif
         */
        controleActivationParametre(codeParametre: string, valeurActivation: String): boolean;
        /**
         * Permet de récupérer les paramètres applicatifs
         */
        getActivationParametresApplicatifs(parametreApplicatif: Modele.IParametreApplicatif, valeurActivation: String): boolean;
    }
}
...
declare module instructionCredit.Service {
    class ManipulationOffreService {
         ...
         */
        ajouterClausePersonnalisee(idDossier: string, clausePersonnaliseeMaj: Modele.IClausePersonnaliseeMaj): ng.IPromise<Modele.IClausePersonnalisee>;
        /**
         ...
         * @param idPlan
         */
        calculerPiecesEtControles(idDossier: string, idPlan: string): ng.IPromise<Modele.IResultatPiecesEtControles>;
        /**
         * L’état  du  dossier  passe   à  l’état « Offre éditée en attente de remise emprunteur»
         * @param idDossier
         */
        controlerEditionOffre(idDossier: string): ng.IPromise<void>;
        /**
...
declare module instructionCredit.Service {
    class MontageService {
        ...
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        /**
         * Ajoute un payeau pour un crédit
         * @param idDossier
         * @param idCredit
         * @param idPersonne
         * @param payeurMaj
...
declare module instructionCredit.Service {
    class ProjetService {
         ...
         */
        getDevises(): ng.IPromise<Modele.IScDevise[]>;
        /**
...
declare module instructionCredit.DonneesModale {
    /**
     * Données pour l'ouvertue de la popin de clause lors de l'édition
     */
    interface IDataClauseEntree {
        enCreation: boolean;
        clauseEmprunteur: boolean;
        clause: any;
    }
...
declare module instructionCredit {
    class BtnRetourMontageControleur {
        static $inject: any[];
        constructor();
        /**
         * Revient à l'étape précedente, le dossier est de nouveau en mode mofification
         */
        retourMontage(): void;
    }
}
...
declare module instructionCredit {
    class ModaleAccorderFinancementControleur {
        private $modalInstance;
        static $inject: Array<string>;
        avis: string;
        ...
        close(): void;
        /**
         * Enregistrement de l'avis et accord du financement
         */
        accorder(): void;
    }
}
...
declare module instructionCredit {
    class DetailPalierContraintControleur implements MyWay.UI.ITuileHandler {
         ...
         */
        constructor($q: ng.IQService, financementService: Service.FinancementService, initialisationService: Service.InitialisationService, modalService: MyWay.UI.IModalService, modaleFactory: Service.ModaleFactory);
        /**
...
declare module instructionCredit {
    class ModaleAssuranceControleur {
        ...
        erreurs: string[];
        constructor($scope: ng.IScope, $modalInstance: ng.ui.bootstrap.IModalServiceInstance, data: any, initialisationService: Service.InitialisationService, $q: ng.IQService, $filter: ng.IFilterService, assuranceService: Service.AssuranceService, modaleFactory: Service.ModaleFactory);
        ...
        /**
         * Permet de récupérer les crédits sélectionnés
         */
        private getCreditsSelectionnes();
        /**
         * Contrôle si les crédits selectionnés ont la même devise
         */
        private controleDeviseCredits();
        /**
         * Contrôle si les crédits selectionnés ont la même devise
         */
        private deselectionCreditsAutreDevise();
        /**
...
declare module instructionCredit {
    class ModaleGarantieControleur {
        ...
        listeConvention: Modele.IScConventionGarantie[];
        tableauConvention: MyWay.UI.ImwTableOptions;
        conventionTmp: Modele.IScConventionGarantie;
        conventionSelectionnee: Modele.IScConventionGarantie;
        ...
        etatBoutonValiderCouverture: boolean;
         ...
         */
        private getLibelleTypeFrais(cotisation);
        /**
        ...
        private getCreditsSelectionnes();
        /**
         * Permet de récupérer les ids des crédits sélectionnés
         */
        private getIdCreditsSelectionnes();
        /**
         * Permet de contrôler que les crédits sélectionnés ont la même devise
         */
        private controleDeviseCredits();
        /**
         * Contrôle si les crédits selectionnés ont la même devise
        ...
        private deselectionCreditsAutreDevise();
        /**
         * Permet de récupérer les ids des cotisations
         */
        private getIdsCotisation(garantie);
        /**
         ...
         */
        validerLigneCouvertureSP(majCouverture: boolean, majCotisation: boolean, cotisationEnTaux: boolean): void;
        /**
        ...
        /**
         * Initialisation de la checkbox financé
         */
        private initFinance(cotisation);
        /**
        ...
        /**
         * Permet de contrôler les éléments de garantie à la validation de la popin
         */
        private controleValidationGarantie();
        /**
        ...
        /**
         * Mise à jour des éléments Couverture et/ou Cotisation
         */
        private majElementsGarantie(typeObjetsMaj, objetsMaj, garantieSchema);
        /**
         * Calcul des crédits manuels => pour calculer les frais en fonction du taux ou montant
         */
        private calculCreditsManuels();
    }
}
...
declare module instructionCredit {
    class ModaleTocTorControleur implements MyWay.UI.INavcolHandler {
         ...
         * @param $modal: any
         */
        constructor($scope: ng.IScope, $modalInstance: ng.ui.bootstrap.IModalServiceInstance, data: any, $modal: any, $filter: any, initialisationService: Service.InitialisationService);
...
declare module instructionCredit {
    class GestionAdministrativeAssurancesControleur {
        private $q;
        private initialisationService;
        private frmGestionAdministrativeService;
        static $inject: Array<string>;
        constructor($q: ng.IQService, initialisationService: Service.InitialisationService, frmGestionAdministrativeService: Service.FormulaireGestionAdministrativeService);
        /**
         * Récupérer le crédit interne  de la proposition retenue
         * Identifier l’assurance sur le dossier
         * Mettre à jour l’assurance avec l’avis et  la réponse CNP
         */
        majAssurances(): void;
        /**
         * Effectue la mise à jour des données des assurances
         * @param listeIdwsAssurances
         * @param listeIdentifiants
         * @param listeElementsMaj
         */
        private majDonnees(listeIdwsAssurances, listeIdentifiants, listeElementsMaj);
    }
}
...
declare module instructionCredit {
    class GestionAdminAvisAvantDecisionControleur {
        private $q;
        private initialisationService;
        private frmGestionAdministrativeService;
        private gestionAdminAvisAvantDecisionService;
        static $inject: Array<string>;
        constructor($q: ng.IQService, initialisationService: Service.InitialisationService, frmGestionAdministrativeService: Service.FormulaireGestionAdministrativeService, gestionAdminAvisAvantDecisionService: Service.GestionAdminAvisAvantDecisionService);
        /**
         * Ce bouton est  utilisé temporairement afin de déclencher les traitements suivants :
         * - Compléter les informations relatives au  projet
         * - Définir le rédacteur d’acte
         * - Compléter les informations relatives aux  emprunteurs
         */
        completion(): void;
    }
}
...
declare module instructionCredit.Service {
    class GestionAdminAvisAvantDecisionService {
        private $q;
        private serviceAgentExtended;
        private initialisationService;
        private montageService;
        static $inject: Array<string>;
        private _listePayeursTemp;
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, initialisationService: Service.InitialisationService, montageService: Service.MontageService);
        /**
         * Mise à jour de l’estimation vénale du bien
         */
        majEstimationVelane(projetImmobilierMaj: Object): ng.IPromise<void>;
        /**
         * Maj de la surface habitable
         */
        majSurfaceHabitable(batimentHabitableFinanceMaj: Object): ng.IPromise<void>;
        /**
         * Définition du rédacteur d’acte
         */
        definirRedacteurActe(redacteurActeMaj: Modele.IRedacteurActeMaj): ng.IPromise<void>;
        /**
         * Mise à jour des informations BDF
         */
        majInfosBdf(listeInterditsBancaires: Array<Modele.IInterditBancaire>): ng.IPromise<void>;
    }
}

declare module instructionCredit {
    class GestionAdministrativeGarantiesControleur {
        private $q;
        private initialisationService;
        private frmGestionAdministrativeService;
        static $inject: Array<string>;
        ...
        /**
         * Récupérer le crédit interne de la proposition retenue
         * Identifier la garantie sur le dossier
         * Mettre à jour la garantie avec l’avis et la réponse SACCEF
         */
        majGaranties(): void;
        /**
         * Effectue la mise à jour des données des garanties
         * @param listeIdwsGaranties
         * @param listeIdentifiants
         * @param listeElementsMaj
         */
        private majDonnees(listeIdwsGaranties, listeIdentifiants, listeElementsMaj);
    }
}
...
declare module instructionCredit {
    class GestionAdministrativeModalitesControleur {
        private $q;
        private initialisationService;
        private frmGestionAdministrativeService;
        private gestionAdminModalitesService;
        static $inject: Array<string>;
        constructor($q: ng.IQService, initialisationService: Service.InitialisationService, frmGestionAdministrativeService: Service.FormulaireGestionAdministrativeService, gestionAdminModalitesService: Service.GestionAdminModalitesService);
        /**
         * Ajout d’un payeur principal
         * Ajout d’un payeur de secours
         * Identification du crédit interne
         * Mise à jour du crédit interne avec la date de prélèvement.
...
declare module instructionCredit.Service {
    class GestionAdminModalitesService {
        private $q;
        private initialisationService;
        private montageService;
        static $inject: Array<string>;
        private _listePayeursTemp;
        constructor($q: ng.IQService, initialisationService: Service.InitialisationService, montageService: Service.MontageService);
        /**
         * Ajoute les payeurs pour chaque crédit
         * @param idPersonne
         * @param payeurMaj
         * @param listeIdwsCredits
         */
        ajouterPayeursForCredits(idPersonne: string, payeurMaj: Modele.IPayeurMaj, listeIdwsCredits: Array<string>): ng.IPromise<Array<Modele.IPayeur>>;
        /**
         * Ajout d’un payeur de secours via la mise à jour du dossier
         */
        ajouterPayeurSecours(): ng.IPromise<void>;
        /**
         * Ajoute de façon synchrone les payeurs pour chaque crédit interne
         * @param idPersonne
         * @param payeurMaj
         * @param listeIdwsCredit
         * @param indexMaj
         */
        private ajouterMultiPayeurs(idPersonne, payeurMaj, listeIdwsCredit, indexMaj);
        /**
         * Met à jour de façon synchrone les crédits internes
         * @param listeIdwsCredit
         * @param indexMaj
         */
        enregistrerPrelevementsForCredits(listeIdwsCredit: Array<string>, indexMaj: number): ng.IPromise<void>;
    }
}

declare module instructionCredit {
    class EditionChargeControleur {
        private clientService;
        static $inject: string[];
...
declare module instructionCredit {
    class ModaleAvisDecisionControleur {
        private dataAvisDecision;
        private $modalInstance;
        private authentificationService;
        static $inject: Array<string>;
        loader: boolean;
        ...
        libelleAgent: string;
        avis: string;
        constructor(dataAvisDecision: DonneesModale.IDataAvisDecisionEntree, $modalInstance: ng.ui.bootstrap.IModalServiceInstance, authentificationService: Service.AuthentificationService);
        /**
         * Ferme la popin
         */
        close(): void;
...
declare module instructionCredit.DonneesModale {
    /**
     * Données pour l'ouvertue de la popin d'avis
     */
    interface IDataAvisDecisionEntree {
        enCreation: boolean;
        avis: any;
    }
    /**
     * Données lors de la fermeture
     */
    interface IDataAvisDecisionSortie {
        enCreation: boolean;
        avis: any;
    }
}
...
declare module instructionCredit {
    class BtnQuitterDossierControleur {
        ...
        private cookieFactory;
        static $inject: string[];
        constructor($scope: any, $q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, modalService: MyWay.UI.IModalService, initialisationService: instructionCredit.Service.InitialisationService, clientService: instructionCredit.Service.ClientService, projetService: instructionCredit.Service.ProjetService, controleDossierService: instructionCredit.Service.ControleDossierService, navigationInterneService: Service.NavigationInterneService, cheminFerService: Service.CheminFerService, modaleFactory: instructionCredit.Service.ModaleFactory, cookieFactory: instructionCredit.Service.CookieFactory);
        ...
        /**
         * Enregistre puis ferme le dossier et dirige vers la recherche de dossiers
         */
        private enregistrerFermerDossier(sauvegarde);
    }
}
...
declare module instructionCredit {
    class DetailSyntheseFinanciereControleur {
        private $scope;
        private initialisationService;
        static $inject: string[];
        endettement: Modele.IEndettement;
...
declare module instructionCredit {
    class GraphiqueSyntheseFinanciereControleur {
        private $scope;
        static $inject: string[];
        endettement: Modele.IEndettement;
        private donnees;
...
declare module instructionCredit {
    class ModaleModificationCreditInterneControleur {
        ...
        validerPtz(): void;
        /**
         * Permet d'effetuer les maj sur le Ptz
         */
        private majPtz();
        /**
         * Permet de contrôler la validation du PTZ
         */
        private controleValidationPtz();
        /**
        ...
        /**
         * Contrôle si des modifications ont été effectuées sur le ptz
         */
        private controleModificationsPtz();
        /**
         * Gestion de la popin de confirmation d'annulation
         */
        private gestionPopinConfirmationAnnulation();
        ...
        close(): void;
        /**
         * Permet d'annuler les modifications faites sur un crédit manuel
         */
...
declare module instructionCredit {
    /**
     * Dans le cas où la charge est de type crédit existant, l'investissement locatif est affiché
     */
    class UsageLocatifCreditExistantControleur {
