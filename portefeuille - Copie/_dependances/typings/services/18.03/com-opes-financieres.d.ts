...
declare module myway.comOpesFinancieres {
    class JournalActiviteBancaireBordereauService {
        ...
        private $q;
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgentExtended, postOperationFinanciereService: myway.comOpesFinancieres.PostOperationFinanciereService, documentContenuService: myway.comOpesFinancieres.DocumentContenuService, $q: ng.IQService);
        /**
...
declare module myway.comOpesFinancieres {
    class SaisieOperationFinanciereController {
        ...
        /**
         * Boolean qui indique si le mode financier est désactivé
         */
...
declare module myway.comOpesFinancieres {
    class EntretiencommercialResultatEntretienService {
         ...
         * @param operationFinanciere Operation Financiere
         */
        postSuiviCommercialVirementInterneContrepartie(operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere, compteContrepartie: MyWay.Model.Compte): ng.IPromise<void>;
        /**
         * Post le suivi commercial d'une facturation
         * @param operationFinanciere Operation Financiere
         * @param estExtourne Indique si c'est une extourne
...
declare module myway.comOpesFinancieres.CarteTMF.impression {
    ...
    interface IApplicationInputContext {
         ...
         */
        donneesBordereau: IContexteCarteTempo;
    }
