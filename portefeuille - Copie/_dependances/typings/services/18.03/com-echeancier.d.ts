...
declare module myway.comEcheancier {
    class EcheancierImpressionService {
         ...
         */
        imprimerEcheancier(contenu: myway.comEcheancier.impression.ParametreEcheancierPourImpression, archivage: myway.comEcheancier.impression.ArchivageEcheancier, codeCanal?: string): ng.IPromise<MyWay.Services.Impression.DocumentGenere>;
        /**
         ...
         * @Return {MyWay.Services.Impression.DocumentGenere}.
         */
        imprimerEcheancierUnit(contenu: myway.comEcheancier.impression.ParametreEcheancierPourImpression, archivage: myway.comEcheancier.impression.ArchivageEcheancier): ng.IPromise<MyWay.Services.Impression.DocumentGenere>;
        /**
         ...
         * @Return {void}.
         */
        private mappeEcheancierRessourcePourImpression(fromRessource, pourImpression);
        /**
         * @Alias getInfoEds.
...
declare module MyWay.Model {
    ...
    class ParametreVersementPeriodique {
        ...
        afficheRice: boolean;
        codeDevise: string;
        constructor(periodicites?: MyWay.Model.Periodicite[], periodiciteParDefaut?: string, riceVirement?: MyWay.Model.Rice, cacherCompteVirement?: boolean, paramListeCompte?: MyWay.Model.ParametresListeComptes, ricePrelev?: MyWay.Model.Rice, cacherComptePrelev?: boolean, codeDevise?: string, afficheRice?: boolean);
    }
