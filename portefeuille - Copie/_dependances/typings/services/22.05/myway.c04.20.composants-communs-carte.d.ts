...
declare module ComposantsCommunsCarte.Controleurs {
    ...
    class CodePinControleur {
        ...
        model: ICodePin;
        static $inject: string[];
        constructor($scope: ICodePinControleurScope, serviceAgent: MyWay.Services.ServiceAgent, modalService: MyWay.UI.ModalService, produitCarteParametreService: ComposantsCommunsCarte.Services.ProduitCarteParametreCarteEtablissementService, i18n: Services.II18nCarteService, $timeout: ng.ITimeoutService);
        /**
         * Méthode d'initialisation des données du controleur.
         */
        initialiserData(): void;
