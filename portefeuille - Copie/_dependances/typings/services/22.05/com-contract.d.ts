...
declare module myway.comContract.Services {
    /**
     * Le service RecupererDocumentsIdnService  a pour objectif d'appeler la ressource
     * recupererDocumentsIdntAttributaire.
     * @author S0076222
     */
...
declare module myway.comContract.Services {
     ...
     * terminerActeVad afin de finaliser le contrat.
     * @author S0076222
     */
    class TerminerActeVadService {
        ...
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        /**
         * La méthode postTerminerActeVad consomme la ressource /dossiernumerique/v3/dossiernumerique/documentsAttributaire
         ...
         */
        postTerminerActeVad(documentsAttributaireInput: Myway.Ressource.DossierNumerique.V3.IDocumentsAttributaireInput): ng.IPromise<Boolean>;
    }
}
...
declare module myway.comContract.Services {
    ...
    class VenteVpcService {
        ...
        /**
         * La méthode mettreAJourDossier appelle le service postTerminerActeVad
         ...
         */
        private createDocumentsAttributaireInput(idDossierNumerique, codeApplication, referenceContrat, listeDocumentsAttributaire);
        /**
...
declare namespace myway.comContract.Signataire.Constantes.Commun {
    ...
    const MESSAGE_ERREUR_MP_ONE_GMP_REQUIRED: string;
    const MESSAGE_ERREUR_MP_SIGNATAIRE_REQUIRED: string;
...
declare module myway.comContract.signataire {
    class ListeDesignatairesController {
        ...
        private controleMessageErreur(message?);
...
declare module myway.comContract.signataire {
    class SignataireService {
        ...
        static CODE_CANAL_FACE_A_FACE: string;
        static CODE_OUVERTURE_TRANSFERT_ACTE: string;
