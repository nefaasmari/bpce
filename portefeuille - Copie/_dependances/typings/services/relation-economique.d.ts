...
declare module RelationEconomique.Controleur {
    class RecoRelationPersonneControleur {
        ...
        private static CLASS_NAME;
        private static logger;
        listePersonne: Modele.Application.IPersonneEnRelation;
        titre: string;
        static $inject: string[];
...
declare module RelationEconomique.Services {
    ...
    class RelationEconomiqueService implements IRelationEconomiqueService {
        ...
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, popupService: Services.Utils.IPopupService, relationEconomiqueRestService: Services.Rest.RelationEconomique.IRelationEconomiqueService, portailService: myway.portail.api.PortailService, $q: angular.IQService);
        ...
        recupererLienEstPersonne(personne: Modele.Application.IPersonneEnRelation): ng.IPromise<Array<Modele.Application.IPersonneEnRelation>>;
        relationEconomique: Modele.Application.IRelationEconomique;
        debranchementVersSynthese(personne: Modele.Application.IPersonneEnRelation): ng.IPromise<any>;
    }
    interface IRelationEconomiqueService {
        ...
        chargerRelationEconomique(identifiantPersonne: number, codeEtablissement: string, majPersonneEnlien?: Modele.Application.IPersonneEnRelation): ng.IPromise<void>;
        relationEconomique: Modele.Application.IRelationEconomique;
        debranchementVersSynthese(personne: Modele.Application.IPersonneEnRelation): void;
        recupererLienEstPersonne(personne: Modele.Application.IPersonneEnRelation): ng.IPromise<Array<Modele.Application.IPersonneEnRelation>>;
    }
}
