...
declare module myway.comContract.Services {
    ...
    class ContractualisationActeService {
       ...
       /**
		 ...
		 * signataires: Array<ContractualisationActe.Modeles.OPC.ISignataireSagOpc>
		 * @returns {ng.IPromise<ContractualisationActe.Modeles.OPC.IDonneesSAGOpc}
         */
        verifierEligibiliteSAGOPC(identifiantPersonne: number, codeActeGestion: string, libelleActeGestion: string, codeCanal: string, codeModeMiseGestion: string, codeTypeMarcheEntreprise: string, signataires: Array<SAGOPC.Modeles.ISignataireSagOpc>,
            operationsFinancieres: Array<SAGOPC.Modeles.IOperationsFinancieres>, typeBordereau: myway.comContract.OPC.Enums.TypeBordereau, donneesBordereau: comContract.SAGOPC.Modeles.IDonneesBordereau): ng.IPromise<SAGOPC.Modeles.IDonneesSAGOpc>
        verifierEligibiliteSAGOPC2(identifiantPersonne: number, codeActeGestion: string, libelleActeGestion: string, codeCanal: string, codeModeMiseGestion: string, codeTypeMarcheEntreprise: string, signataires: Array<SAGOPC.Modeles.ISignataireSagOpc>,
            operationsFinancieres: Array<SAGOPC.Modeles.IOperationsFinancieres>, typeBordereau: OPC.Enums.TypeBordereau, donneesBordereau: SAGOPC.Modeles.IDonneesBordereau): ng.IPromise<SAGOPC.Modeles.IDonneesSAGOpc>
         ...
         * @param codeCanal
         */
        private isDeployeSEMD(codeEtablissement, codeActeGestion, codeCanal, typeProfessionnel);
        /**
         *
         * @param codeEtablissement
         * @param codeActeGestion
         ...
         */
		private isDeployeBulleConfiance(codeEtablissement, codeActeGestion, codeCanal, typeProfessionnel, isDeployeMySign)
		/**
         *
         * @param datas
         */
         ...
         * @param codeCanal
         */
        private isDeployeMYSIGN(codeEtablissement, codeActeGestion, codeCanal, typeProfessionnel);
        /**
         * @ngdoc method
    ...
    class SagOpcService {
        ...
        getDocumentParametre(actes: Array<string>, codeCanal: string, codeModeMiseGestion: string,
            codeTypeMarcheEntreprise: string, codeTypeSousMarcheDocEntreprise: string)
            : ng.IPromise<Array<Myway.Ressource.DocumentParametre.IDocumentActe>>
...
declare module myway.comContract.SAGOPC.Modeles {
    ...
    interface IDonneesSAGOpc {
     ...
     interface IDonneesVirement {
        /*
         * intitulé virement  + date du jour
         * Exemple : VIREMENT INTERNATIONAL 11082020,  VIREMENT 11082020 (virement immédiat)
         * 
         */
     ...
     interface IDonneesVirementImmediat extends IDonneesVirement {
         ...
         * [libellé compte débité] -  [RIB + clé compte débité] [Clé RIB]
         * Exemple : COMPTE DE DEPOT - 11315 00001 04 0000365 87 27
         */
        intituleCompteDebite: string;
     ...
     interface IDonneesEcheancier {
        /*
         * intitulé écheancier + date du jour
         * Exemple :  ECHEANCIER 11082020
         */
     ...
     class TypeBordereau {
        public static OPERATION_FINANCIERE: string ;
        public static REMISE_CARTE_TEMPO: string ;
        public static REMISE_CARTE_BANCAIRE: string ;
        public static VISITE_COFFRE: string ;
        public static OPPOSITION_CARTE_BANCAIRE: string;
		public static VIREMENT_IMMEDIAT: string ;
        public static VIREMENT_INTERNE: string ;
        public static VIREMENT_INTERNATIONAL: string;
        public static ECHEANCIER_VIREMENT_SEPA: string ;
        public static ECHEANCIER_VIREMENT_INTERNATIONAL: string;
        public static AVENANT_ECHEANCIER_VIREMENT_SEPA: string;
        public static AVENANT_ECHEANCIER_VIREMENT_INTERNATIONAL: string ;
        public static CLOTURE_ECHEANCIER_VIREMENT_SEPA: string ;
        public static CLOTURE_ECHEANCIER_VIREMENT_INTERNATIONAL: string ;
        public static SUSPENSION_ECHEANCIER_VIREMENT_SEPA: string ;
        public static REACTIVATION_ECHEANCIER_VIREMENT_SEPA: string ;
    }
    ...
    interface IDonneesGCEDOC {
      ...
      */
    export interface IDeploiementSAGOPC {
