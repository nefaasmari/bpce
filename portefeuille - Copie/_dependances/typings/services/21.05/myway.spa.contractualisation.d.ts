...
declare module MyWay.Contractualisation {
    class ListerDossiersNumeriquesControleur {
        ...
        private genererGroupesSignataires(listeDossierNumerique, listeDDV);
    }
}
...
declare module MyWay.Contractualisation {
    ...
    class AlimenterDossierNumeriqueService {
         ...
         */
        getIdentificationSignataireContexte(): AlimenterDossierNumeriqueContexteModele;
         ...
         * @param titulaire
         */
        private getPrenomTitulaire(contractualisationActe, titulaire);
        /**
         *
         * @param contractualisationActe
         * @param titulaire
         */
        private getNomTitulaire(contractualisationActe, titulaire);
        /**
         *
         * @param contractualisationActe
         */
...
declare module MyWay.Contractualisation {
    class DocumentParametreService {
		 ...
		 * @param CodeTypeSousMarcheDocEntreprise
...
declare module MyWay.Contractualisation {
    class DossierVenteService {
         ...
         * @param
         */
        getDVsEnAttenteSignature(recherche: Myway.Ressource.DossierVente.Recherche.IRecherche): ng.IPromise<Array<Myway.Ressource.DossierVente.Recherche.IDossierVente>>;
        /**
         *
         * @param contractualisationActe
         * @param modeSignature
...
declare module MyWay.Contractualisation {
    ...
    class ListerDossiersNumeriquesContexteModele implements IContractualisationContexteModele {
        ...
        codeCanal: string;
        constructor(multiDossiersNumeriques: IMultiDossiersNumeriques, authenficationInfo: MyWay.Services.Context.AuthentificationInfo, identifiantPersonne: number, codeCanal: string);
    }
}
...
declare module MyWay.Contractualisation {
    ...
    class ListerDossiersNumeriquesService {
         ...
         * @param valeurSortie
         */
        nextEtape(valeurSortie: number, multiDossierNumerique: IMultiDossiersNumeriques): void;
        multiDossiersNumeriques: IMultiDossiersNumeriques;
        codeCanal: string;
        identifiantPersonne: number;
...
declare module MyWay.Contractualisation {
    class SignatureElecService {
         ...
         * @param idSignataire
         */
        initierSignatureElectronique(listeDossierNumerique: Array<string>, codeApplication: string, urlRetourIcg: string, idSignataire: string): ng.IPromise<Myway.Ressource.Signature.V3.ISignatureElectronique>;
        /**
         *
...
declare module MyWay.Contractualisation.Ressources.DossierVente {
    ...
    class DossierVenteConstants {
        ...
        static MOMENT_VIE: string;
        static PERSONNE_SIGNATAIRE: string;
        static DATE_FIN_SIGNATURE: string;
