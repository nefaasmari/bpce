...
declare module ComposantsCommunsCarte.Controleurs {
    ...
    class CodePinControleur {
        ...
        private achhicherPopupBloquante();
        initListe(): void;
...
declare module ComposantsCommunsCarte.Controleurs {
    ...
    class EligibiliteCrControleur {
        ...
        private $timeout;
        static $inject: string[];
        private indicateurChargementEligibiliteCR;
        private promise;
        constructor($scope: IEligibiliteCrControleurScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, revolvingCreditFolderOfferProposalService: Services.BAPI.RevolvingCreditFolderOfferProposalService, $timeout: ng.ITimeoutService);
        /**
         * Méthode d'initialisation des données du controleur.
         */
        initialiserData(): void;
