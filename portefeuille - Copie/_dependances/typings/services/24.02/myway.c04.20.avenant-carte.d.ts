 ...
 * @author S0076105 (Nicolas Le Roux), pour tester le build forcé
 */
declare module AvenantCarte.Controleurs {
    /**
     * Interface du scope du contrôleur   pour compile
     */
    ...
    class AvenantProduitServiceCarteControleur {
         ...
         */
        sendContratCarteRechercheRequest(): ng.IPromise<boolean>;
