...
declare module GestionGeneriqueOffres.Constantes {
    ...
    class ValeursInjectees {
        static ID_URL_COMPOSANTS_GGO: string;
    ...
    class EvenementsComposantsProduitsService {
        ...
        static CSPR_PREREQUIS_EFFECTUE: string;
    }
...
declare module GestionGeneriqueOffres.Types {
    interface ICatalogueNode {
         ...
         */
        testerProduitParDefautAssemblage(): boolean;
        /**
    ...
    class CatalogueNode implements ICatalogueNode {
        ...
        private _visible;
        /**
         * Le fait que la tuile soit affichée ou pas (filtrage personnes)
         */
        visible: boolean;
        private _ascendant;
        /**
         ...
         * - Un resultat de n'importe quel type qui sera au final restitué par parcoursCatalogue.
...
declare module GestionGeneriqueOffres.Types {
    interface ICompositionOffreEntitePersonneMock {
    ...
    class CompositionOffreEntitePersonne {
         ...
         */
        getLibelle(): string;
        supprimerProduitParCodeProduitService: (detenteur: Types.InformationEntiteTitulaire | Types.Tiers.Personne, codeProduitService: number) => void;
...
declare module GestionGeneriqueOffres.Types {
    ...
    interface ICompositionOffreProduitMock {
        detenteur?: Types.InformationEntiteTitulaire | Types.Tiers.Personne;
    ...
    class CompositionOffreProduit {
         ...
         * - soit p.x, avec p, n° d'ordre dans la composition de niveau 1 et x, n° d'ordre
        ...
        /** Le produit détenu par le détenteur */
        produitServiceDetenu: Types.ProduitService;
        private _ascendant;
         ...
         */
        donneesSelectionAssemblage: DonneesAssemblage;
        private _prioriteMiseEnGestion;
        /**
         * Niveau de priorité de mise en gestion de ce produit service. A fixer par le produit service.
         * Valeur : min 0, max +oo
         * Les P/S ne fixant pas de priorité seront mis en gestion en dernier.
         * Plus le niveau est haut, plus le produit sera mis en gestion tôt dans le processus.
         */
        prioriteMiseEnGestion: PrioriteMiseEnGestion;
        private _codeMiseEnGestion;
        /**
        ...
        /**
         * Suppression d'un produit de la composition
         * Si le produit vient d'être ajouté (ex, en souscription), le supprime purement et simplement
         * Si le produit est déjà ouvert dans le SI, le marque comme a clôturer (non codé)
         */
        supprimerProduitParCodeProduitService: (detenteur: Types.InformationEntiteTitulaire | Types.Tiers.Personne, codeProduitService: number) => void;
        /**
         * Recherche un bloc produit par son id de bloc.
         */
        constructor(id: string, contexteGgo: Types.ContexteGgo, modeAjoutProduit: Types.ModeAjoutProduitDansOffre, origineProduit: Types.OrigineProduit, detenteur: Types.InformationEntiteTitulaire | Types.Tiers.Personne, produitServiceDetenu: Types.ProduitService, ascendant: CompositionOffreProduit | CompositionOffreEntitePersonne, descendants: CompositionOffreProduit[], afficherInfoDetenteur: number, directives: Types.DirectivesMetier, donneesSelectionAssemblage?: Types.DonneesAssemblage);
    }
}
...
declare module GestionGeneriqueOffres.Types {
    ...
    interface ICompositionOffre {
        /**
         * Parcourt la composition, renvoie le bloc produit d'id passé en paramètre
         */
        /**
         *  Insère le produit au niveau entité, pour les produits gérés en mode entité
         */
        insererProduitEnModeEntite(contexte: Types.ContexteGgo, modeAjoutProduit: ModeAjoutProduitDansOffre, origine: OrigineProduit, produit: Types.ProduitService, entite: Types.InformationEntiteTitulaire, donneesSelectionAssemblage?: Types.DonneesAssemblage): CompositionOffreProduit;
        /**
         * Insère le produit au niveau entité, pour les produits gérés en mode personne
         */
        insererProduitEnModePersonne(contexte: Types.ContexteGgo, modeAjoutProduit: ModeAjoutProduitDansOffre, origine: OrigineProduit, produit: Types.ProduitService, detenteur: Types.InformationEntiteTitulaire | Types.Tiers.Personne): CompositionOffreProduit;
        /**
         * Insère le produit au niveau entité, pour les produits gérés en mode personne
         */
        insererProduitEnModeCompte(contexte: Types.ContexteGgo, modeAjoutProduit: ModeAjoutProduitDansOffre, origine: OrigineProduit, produit: Types.ProduitService, produitSupport: CompositionOffreProduit, detenteur: Types.InformationEntiteTitulaire | Types.Tiers.Personne, donneesSelectionAssemblage?: Types.DonneesAssemblage, noeud?: CompositionOffreEntitePersonne): CompositionOffreProduit;
        /**
         * Insère un P/S dans la composition qui sera sous un autre produit (support), sous tous les P/S qui sont
         * susceptibles de l'accueillir.
         * Exemple : si on a trois comptes sous une entité et que le produit est le découvert, on va insérer 3 découverts
         */
        insererPlusieursProduitEnModeCompte(contexte: Types.ContexteGgo, modeAjoutProduit: ModeAjoutProduitDansOffre, origine: OrigineProduit, produit: Types.ProduitService, entite: Types.InformationEntiteTitulaire, personne?: Types.Tiers.Personne, donneesSelectionAssemblage?: Types.DonneesAssemblage): void;
    }
    /** Niveau 0 (racine) de la composition */
    class CompositionOffre implements ICompositionOffre {
         ...
         * Renvoie l'élément de la composition correspondant au produit inséré
         */
        insererProduitEnModePersonne: (contexte: Types.ContexteGgo, modeAjoutProduit: ModeAjoutProduitDansOffre, origine: OrigineProduit, produit: Types.ProduitService, detenteur: Types.InformationEntiteTitulaire | Types.Tiers.Personne, donneesSelectionAssemblage?: Types.DonneesAssemblage) => CompositionOffreProduit;
        /**
        ...
        /**
         * Détermine si le produit est détenu par l'entité
         */
         ...
         * sélectionnant ce qui est obligatoire et poussé.
         */
        constructor(contexte: Types.ContexteGgo, entites: Types.InformationEntiteTitulaire[], personnes: Types.Tiers.Personne[], catalogue: Types.CatalogueNode, paramBlocs: Types.ParametrageBlocs, produitsAReprendre: any[], options: IOptionsCreationComposition);
    }
}
...
declare module GestionGeneriqueOffres.Types {
    ...
    class Contexte {
        ...
        private _numeroPersonneIdentifiee;
        /**
         * N° de personne identifiée dans la synthèse client. Utilité ?
         */
        numeroPersonneIdentifiee: number;
...
declare module GestionGeneriqueOffres.Types {
    ...
    import DossierVente = GestionGeneriqueOffres.Types.DossierVente;
    enum NiveauErreur {
        Ok = 0,
        Warning = 1,
        Erreur = 2,
    ...
    interface IDonneesMiseEnGestionMock {
        idBloc?: string;
        codeTypeProduitService?: string;
        identifiantProduitService?: number;
        codeSousFamilleActeGestion?: string;
    ...
    /**
     * Point d'entrée dédié à la fonction de mise en gestion du bloc métier
    ...
    class PointsEntree {
        ...
        /**
         * Procède à la mise en gestion
         */
        mettreEnGestion: IPointEntreeFonctionMiseEnGestion;
        constructor();
    }
    interface IDonneesProduitMock {
        detenteur?: Types.InformationEntiteTitulaire | Types.Tiers.Personne;
    ...
    class DonneesProduit {
        ...
        constructor(detenteur: Types.InformationEntiteTitulaire | Types.Tiers.Personne, produit: Types.ProduitService, invisible: boolean, idProducteur: Producteur, prioriteMiseEnGestion: PrioriteMiseEnGestion, repris: boolean, produitSelectionne: Types.CleValeur, donneesSelectionAssemblage: any, pointsEntree: Types.PointsEntree, idBlocProduitSupport: string);
    }
    interface IDonneesContextuellesMock {
        modeAcces?: ModeAcces;
    ...
    class DonneesContextuelles {
         ...
         */
        donneesProduit: DonneesProduit;
        constructor(modeAcces: ModeAcces, modeAffichage: ModeAffichage, personnes: Personne[], entitesTitulaires: InformationEntiteTitulaire[], offreSouscrite: OffreSouscrite, etablissement: Etablissement, dossierVente: DossierVente, donneesGeneriques: Types.DonneesGeneriques, catalogue: Types.CatalogueNode, composition: Types.CompositionOffre, donneesMiseEnGestion: Types.DonneesMiseEnGestion[], donneesProduit: DonneesProduit);
    }
}
...
declare module GestionGeneriqueOffres.Types {
    ...
    interface IInformationEntiteTitulaireMock {
        /**
         *   Caractéristiques de l'entité titulaire (libellé, mode de composition, code usage, ...)
         */
        caracteristiqueEntiteTitulaire?: CaracteristiqueEntiteTitulaire;
    ...
    interface ICompositionEntiteTitulaireMock {
        /**
         * Numéro d'identification de la personne dans le SI d'un Etablissement.
         * Référence interne MYSYS.
         * Personne référencée comme client, tiers ou prospect.
    ...
    interface ICaracteristiqueEntiteTitulaireMock {
        /**
         * Désignation courte de l'entité titulaire, optionnelle et choisie au niveau de l'entité titulaire,
         * lorsque la désignation bancaire calculée sur 32 caractères ne convient pas au client (cas de forçage).
         * Cette désignation sera utilisée dans la ligne V1 de l'adresse.
...
declare module GestionGeneriqueOffres.Types {
    ...
    class DescriptionFichier {
        ...
        /**
         * Type de fichier : js, css, html (peut-être) ?
         */
        typeFichier: string;
        ...
        constructor(typeFichier: string, cheminAccesFichier: string);
    }
    /**
...
declare module GestionGeneriqueOffres.Types.Tiers {
    ...
    interface IParticulierInformationMock {
        identifiantPersonne?: number;
        codeEtablissement?: string;
        libelleCivilite?: string;
        libelleSexe?: string;
...
declare module GestionGeneriqueOffres.Types.Tiers {
    ...
    interface IParticulierTiersLieMock {
        codeEtablissement?: string;
        identifiantPersonne?: number;
        codeTypeLienInterPersonne?: string;
        codeSensLienInterPersonne?: string;
...
declare module GestionGeneriqueOffres.Types {
    ...
    interface IProduitCaracteristiqueMock {
        identifiantProduitService?: number;
        libelleProduitService?: string;
        codeTypeProduitService?: string;
        libelleLongProduitService?: string;
    ...
    interface IProduitCatalogueMock {
        codeProduitServiceExterne?: string;
        nombreMiniExemplairesProduitService?: number;
        nombreMaxiExemplairesProduitService?: number;
        numeroSequenceOuverture?: number;
    ...
    class ProduitCatalogue {
         ...
         *    -------------------------
         *    Cette information est importante : il faut veiller
         *    à ce que la logique d'ouverture des produits/services
         *    de l'offre soit respectée en renseignant cette
         *    information.Par exemple, le CDD doit être ouvert
         *    avant la souscription du contrat carte.Par conséquent
         *    il faut que le numéro d'ordre du CDD soit inférieur
         *    au numéro d'ordre de la carte.
         *    Par convention, le produit/ service par défaut
         *    (dans le cas où il y a des produits/ services
         *    de substitution) aura un numéro de séquence
         *    valorisé avec la valeur '10'.
         *    Il faut afficher en premier les P/ S obligatoires.
         *    Il faut également placer les P/ S en mode compte
         *    derrière leur produit support (et surtout pas
         *    derrière un autre produit support).
         *    Les cartes ne doivent pas être placés directement
         *    derrière le CDD.
         */
        numeroSequenceOuverture: number;
         ...
         *            en amont par la QR, ne sera jamais vu par la GGO
         */
        codeNatureProduitServiceAssocie: string;
        private _indicateurProduitServiceObligatoireOffre;
        /**
    ...
    interface IPropositionRepriseMock {
        numeroEntiteTitulaire?: number;
        numeroPersonne?: number;
        identifiantProduitServiceSupport?: number;
        modeTraitementProduitService?: number;
