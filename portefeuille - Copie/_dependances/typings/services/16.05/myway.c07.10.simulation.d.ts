...
declare module instructionCredit {
    class FormulaireClientControleur implements MyWay.UI.ITuileHandler {
         ...
         * @param NavigationService: MyWay.UI.INavigationService
         */
        constructor($scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, navigationService: MyWay.UI.INavigationService, modalService: MyWay.UI.IModalService, clientService: instructionCredit.Service.ClientService, calculService: instructionCredit.Service.CalculService, initialisationService: instructionCredit.Service.InitialisationService, mwgcRechercherPersonneService: myway.comGestionClient.RechercherPersonneService, $q: ng.IQService, mwsfAdresseService: myway.comAdresseDqe.AdresseService, projetService: instructionCredit.Service.FormulaireProjetService, $filter: ng.IFilterService, financementService: Service.FormulaireFinancementService, controleDossierService: Service.ControleDossierService, modaleFactory: instructionCredit.Service.ModaleFactory, authentificationService: Service.AuthentificationService);
        /**
...
declare module instructionCredit {
    class FormulaireProjetControleur {
         ...
         * @param navigationService: MyWay.UI.INavigationService
         */
        constructor($scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, formulaireProjetService: instructionCredit.Service.FormulaireProjetService, navigationService: MyWay.UI.INavigationService, initialisationService: instructionCredit.Service.InitialisationService, modalService: MyWay.UI.IModalService, mwsfAdresseService: myway.comAdresseDqe.AdresseService, calculService: instructionCredit.Service.CalculService, clientService: Service.ClientService, financementService: Service.FormulaireFinancementService, $q: ng.IQService, controleDossierService: Service.ControleDossierService, authentificationService: Service.AuthentificationService);
        /**
...
declare module instructionCredit {
    class NavigationControleur {
        ...
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, scope: ng.IScope, $rootScope: ng.IRootScopeService, $location: ng.ILocationService, navigationService: MyWay.UI.INavigationService, modalService: MyWay.UI.IModalService, initialisationService: instructionCredit.Service.InitialisationService, clientService: instructionCredit.Service.ClientService, financementService: Service.FormulaireFinancementService, projetService: instructionCredit.Service.FormulaireProjetService, controleDossierService: instructionCredit.Service.ControleDossierService, modaleFactory: instructionCredit.Service.ModaleFactory);
        /**
...
declare module instructionCredit.Service {
    ...
    class AuthentificationService {
         ...
         * Constructeur
         */
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, navigationService: MyWay.UI.INavigationService, $location: ng.ILocationService, initialisationService: Service.InitialisationService, clientService: Service.ClientService, projetService: instructionCredit.Service.FormulaireProjetService, financementService: Service.FormulaireFinancementService, controleDossierService: instructionCredit.Service.ControleDossierService);
        /**
...
declare module instructionCredit.Service {
    class InitialisationService {
         ...
         */
        listerParametresApplicatifs(rubriquesFiltreSouhaitees: Array<string>, valeursFiltreSouhaitees: Array<string>): ng.IPromise<instructionCredit.Modele.IParametreApplicatif[]>;
        /**
         ...
         * @return ng.IPromise<Array<IParametreApplicatif>>
         */
        private getParametresApplicatifs(rubriquesFiltre, valeursFiltre);
        /**
         * Récupère les paramètres applicatifs demandées en se basant sur les paramètres applicatifs chargées en session
         * @return Array<IParametreApplicatif>
         */
        private filtrerParametresApplicatifs(rubriquesFiltre, valeursFiltre);
    }
}
