...
declare module OuvertureCarte.Controleurs {
    ...
    class PersonnalisationProduitServiceCarteControleur {
        ...
        constructor($scope: IPersonnalisationProduitServiceCarteControleurScope, serviceAgent: MyWay.Services.ServiceAgent, i18n: ComposantsCommunsCarte.Services.II18nCarteService);
        /**
