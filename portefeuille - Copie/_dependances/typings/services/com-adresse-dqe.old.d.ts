...
declare module myway.comAdresseDqe {
    class SaisieCommuneNaissanceController {
        ...
        onChangeFunction: ($item?: CommuneNaissance, $model?: CommuneNaissance, $label?: CommuneNaissance, $event?: MouseEvent) => void;
        private errorDQE;
        private isSaisieValide;
        private commune;
        ...
        inputFormatter(commune: CommuneNaissance): string;
        onSelect($item: CommuneNaissance, $model: CommuneNaissance, $label: CommuneNaissance, $event: MouseEvent): void;
        private validerSaisie();
        private initialiserCommune(cp, localite, insee, pays, statut);
        private creerObjetCommune(cp, localite, insee, pays, statut);
    }
}
...
declare module myway.comAdresseDqe {
    ...
    class AdresseService {
        ...
        getCommunesNaissance(dateNaissance: string, saisie: string, settings: IAdresseSettings): ng.IPromise<CommuneNaissance[]>;
        /**
...
declare module myway.comAdresseDqe {
    ...
    class ServiceDQEConstantes {
        ...
        /**
         * Le nombre de caractères requis pour laner une recherche
         */
