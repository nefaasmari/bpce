...
declare module instructionCredit {
    class FormulaireGestionAdministrativeControleur {
        ...
        static $inject: string[];
        chargementEnCours: boolean;
        constructor($timeout: ng.ITimeoutService, $location: ng.ILocationService, initialisationService: Service.InitialisationService, navigationInterneService: Service.NavigationInterneService);
        majAssurances(): void;
        majGaranties(): void;
        majModalites(): void;
        /**
...
declare module instructionCredit.Service {
    class InitialisationService {
         ...
         */
        creerProjet(toc: string, tor: string, canalDeCreation: string, codeDevise: string, idClientBancaire?: string): ng.IPromise<any>;
        /**
...
declare module instructionCredit {
    /**
     * TODO, à voir si ce métier ne sera pas déplacé dans un service pour être appelé à chaque récupération du dossier/ dossierSchema
     */
    class CheminDeFerControleur {
        ...
        private navigationInterneService;
        static $inject: string[];
        private _chemineImage;
        src: string;
        alt: string;
        constructor($rootScope: ng.IRootScopeService, initialisationService: Service.InitialisationService, navigationInterneService: Service.NavigationInterneService);
        /**
         * Gère l'affichage du chemin de fer selon l'état du dossier
         * @param etatDossier
         */
        private setCheminDeFer(etatDossier);
        /**
         * Cas particulier pour la proposition qui comprends aussi la page synthèse
         */
        private cheminForProposition();
    }
}
