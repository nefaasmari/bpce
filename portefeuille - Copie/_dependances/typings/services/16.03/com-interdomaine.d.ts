...
declare module myway.comInterdomaine {
    class ListeCompteClientController {
        private $scope;
        ...
        exclusionCompteIdentique: boolean;
        selectionComptePrincipal: boolean;
        exclusionIntituleCompte: boolean;
        placeHolder: string;
        listeGrisee: boolean;
        constructor($scope: ng.IScope, compteService: myway.comInterdomaine.CompteService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        private determinerPlaceHolder(listeCompte);
        private selectionCompteParDefaut();
    }
}
...
declare module MyWay.Model {
    class ParticipantInformationClient {
        ...
        codePersonnaliteJuridique: string;
        constructor(codeRole: string, identifiantParticipant: string, dateNaissance: string, nomParticipant: string, prenomParticipant: string, codePersonnaliteJuridique: string, designationCourte?: string);
    }
}
...
declare module MyWay.Model {
    interface ISignataireDocument {
        caracteristiqueOperationFinancier: CaracteristiqueOperationFinancier;
        caracteristiqueValidationSignataire: CaracteristiqueValidationSignataire;
        listPersonne: Array<Personne>;
        listSignataire: Array<Signataire>;
    }
    interface ICaracteristiqueOperationFinancier {
        codeEtablissement: string;
        identifiantEntiteTitulaire: number;
        identifiantPersonne: Array<number>;
        codeGuichet: string;
        codeProduitService: string;
        codeCanal: string;
        codeTypeCapaciteJuridique: string;
        codeTypeEntiteTitulaire: string;
        codeSousFamilleActe: string;
    ...
    interface IPersonne {
        ...
        dateDecesPersonne: Date;
        dateNaissance: Date;
        premierEtatCivil: string;
        codePersonnaliteJuridique: string;
        nom: string;
        identifiantPersonne: string;
        prenom: string;
        indiceResponsableComptesET: string;
    ...
    interface ICaracteristiqueValidationSignataire {
        nombreMinimumSignataire: number;
        nombreMaximumSignataire: number;
        nombreMinimumRepresantantLegal: number;
        nombreMaximumRepresantantLegal: number;
        nombreMaximumSignataireElectronique: number;
        libelleInformation: string;
        autreSignataire: boolean;
    }
    interface ISignataire {
        identifiantPersonne: string;
        etatSignataire: string;
        defautSignataire: boolean;
    }
    class SignatairesDocument implements ISignataireDocument {
        caracteristiqueOperationFinancier: CaracteristiqueOperationFinancier;
        listPersonne: Array<Personne>;
        caracteristiqueValidationSignataire: CaracteristiqueValidationSignataire;
        listSignataire: Array<Signataire>;
        constructor();
        constructor(caracteristiqueOperationFinancier: CaracteristiqueOperationFinancier, listPersonne: Array<Personne>, caracterisitiqueValidationSignataire: CaracteristiqueValidationSignataire, listSignataire: Array<Signataire>);
    }
    class CaracteristiqueOperationFinancier implements ICaracteristiqueOperationFinancier {
        codeEtablissement: string;
        identifiantEntiteTitulaire: number;
        identifiantPersonne: Array<number>;
        codeGuichet: string;
    ...
    class CaracteristiqueValidationSignataire implements ICaracteristiqueValidationSignataire {
        nombreMinimumSignataire: number;
        nombreMaximumSignataire: number;
        nombreMinimumRepresantantLegal: number;
        nombreMaximumRepresantantLegal: number;
    ...
    class SignataireSelectionne {
        ...
        selectionne: boolean;
        constructor();
        constructor(signataireSelectionne: SignataireSelectionne);
    }
    class SignataireAffiche {
        nom: string;
        prenom: string;
        etatCivil: string;
        designation: string;
        ordreDesignation: string;
        identifiantPersonne: string;
        obligatoire: boolean;
        check: boolean;
        disabled: boolean;
...
declare module myway.comInterdomaine {
    ...
    class MwsfMontantController {
        ...
        blurEvent(inputElement: HTMLInputElement): void;
        clickEvent(inputElement: HTMLInputElement): void;
...
declare module myway.comInterdomaine {
    class SaisirRiceController {
        ...
        static $inject: string[];
        constructor($scope: ng.IScope, saisieRiceService: SaisieRiceService, $timeout: ng.ITimeoutService);
...
declare module myway.comInterdomaine {
    class ListeDesignatairesController {
        private $scope;
        private listeDesignatairesService;
        private serviceAgentExtended;
        private codeEtablissement;
        private identifiantEntiteTitulaire;
        private identifiantPersonne;
        private rib;
        private codeCanal;
        private codeTypeCapaciteJuridique;
        private codeTypeEntiteTitulaire;
        private codeSousFamilleActe;
        private listePersonnes;
        private ngModel;
        private signatairesDocumentEntre;
        private signatairesDocumentSortie;
        private compteur;
        private compteurMax;
        private compteurMin;
        private chargement;
        ...
        private messageErreurEntree;
        private messageErreurControle;
        private afficherMessageRegle;
        private afficherListeSignataire;
        private listeDesignataires;
        private listeSignataireSelectionne;
        private civilites;
        static $inject: string[];
        constructor($scope: ng.IScope, listeDesignatairesService: ListeDesignatairesService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        private onCheckedSignataires();
        private disableSignataires();
        private initialisationCheckboxSignataires();
        private controllerMapperEntree();
        private mapperSignataire(signatire);
        private mapperSignataireSelectionne();
        private getLibelle(tab, cle, code, rub);
    }
}
...
declare module myway.comInterdomaine {
    interface IGetListeSignatairesService {
        envoyerRequetPOST(data: MyWay.Model.ISignataireDocument): ng.IPromise<MyWay.Model.ISignataireDocument>;
    }
    class ListeDesignatairesService implements IGetListeSignatairesService {
        private serviceAgentExtended;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        url(): string;
        envoyerRequetPOST(data: MyWay.Model.ISignataireDocument): ng.IPromise<MyWay.Model.ISignataireDocument>;
        getCodeEtablissment(): ng.IPromise<string>;
        getDonneesDelocalisees(codeEtablissement: string, nomTable: string): ng.IPromise<Object>;
    }
}
...
declare module myway.comInterdomaine {
    interface IMwsfTotemAideControllerScope extends ng.IScope {
        id: string;
        /**
        ...
        modeBouchon?: boolean;
        bouchonDate?: string;
        bouchonProcessus?: string;
        bouchonEtape?: string;
        bouchonCleSecondaire?: string;
        bouchonCleTertiaire?: string;
    }
    /**
     * Classe modélisant une tuile du totem d'aide. Par défaut, cette tuile n'est pas marquée comme favori.
     */
    class TotemAideTuile {
        bagage: MyWay.Model.IBagageDTO;
        favori: boolean;
        config: MyWay.UI.iMwConfigTuile;
        constructor(bagage: MyWay.Model.IBagageDTO, handler: MyWay.UI.ITuileHandler);
    }
    class MwsfTotemAideControleur implements MyWay.UI.ITuileHandler {
        protected $scope: IMwsfTotemAideControllerScope;
        ...
        canauxAssistance: MyWay.Model.IBagageDTO[];
        flash: MyWay.Model.IFlashPartielDTO;
        referentielAide: any;
        constructor($scope: IMwsfTotemAideControllerScope, totemAideService: MwsfTotemAideService, modalService: MyWay.UI.IModalService, $window: ng.IWindowService, $q: ng.IQService);
        /**
         * Chargement des bagages du totem
         */
        loadTotemBagagesData(): MyWay.Services.IPromesse<void>;
        /**
         * Chargement du message flash
         */
        loadTotemFlashData(): MyWay.Services.IPromesse<void>;
        /**
         * Chargement du référentiel de l'aide et mise en forme de l'objet pour l'affichage arborescent.
         */
        loadReferentielAideData(): MyWay.Services.IPromesse<void>;
        /**
        ...
        /**
         * Formatte un objet Date en string "dd-MM-yyyy"
         */
        formatDateInddMMyyyy(date: Date): string;
        /**
         * Formatte une string date (ISO 8601) en string dd-MM-yyyy"
         */
        formatStringDateInddMMyyyy(date: string): string;
...
declare module myway.comInterdomaine {
    class MwsfTotemAideService {
        ...
        private serviceAgentExtended;
        static $inject: string[];
        private promesseCodeEtablissement;
        private promesseCleSecondaire;
        private promesseCleTertiaire;
         ...
         */
        getTuilesEtCanaux(modeBouchon: boolean, processus: string, etape: string, cleSecondaire: string, cleTertiaire: string): MyWay.Services.IPromesse<Array<MyWay.Model.IBagageDTO>>;
        /**
         * Récupère le messge flash
         */
        getFlash(modeBouchon: boolean, processus: string, etape: string, date: string): MyWay.Services.IPromesse<MyWay.Model.IFlashPartielDTO>;
        /**
         * Construit et envoi la requête pour la recherche des bagages du totem
         */
        sendRequestRechercheBagageTotem(processus: string, etape: string, cleSecondaire: string, cleTertiaire: string): MyWay.Services.IPromesse<Array<MyWay.Model.IBagageDTO>>;
        /**
         ...
         */
        sendRequestRechercheFlash(codeEtablissement: string, processus: string, etape: string, date?: string): MyWay.Services.IPromesse<MyWay.Model.IFlashPartielDTO>;
        /**
         * Construit et envoi a requête pour la recherche des bagages d'un établissement.
         */
        sendRequestRechercheBagageEtablissement(): MyWay.Services.IPromesse<Array<MyWay.Model.IBagageDTO>>;
        /**
         * Deprecated : Cette fonctionnalité n'est plus d'actualité
         */
        getCategorie(idCategorie: number): MyWay.Services.IPromesse<Object>;
        /**
         * Récupère la date du moment au format ISO (attendu par le service Rest).
         */
        private getDatePourAccesRest();
        private getPromessesPourAccesRest();
    }
}
