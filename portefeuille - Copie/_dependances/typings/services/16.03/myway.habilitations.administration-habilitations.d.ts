...
declare module MonApplication.Service {
    class ProfilDetailFonctionsService {
        ...
        autorisationAssociationFonction: boolean;
        constructor(profilDetailServiceDonnees: Service.ProfilDetailServiceDonnees, $q: ng.IQService, mwNotificationService: MyWay.UI.IMwNotificationService, fonctionService: Service.FonctionService, profilService: Service.ProfilService, serviceHabilitationsUtilisateur: HabilitationsUtilisateur.ServiceHabilitationsUtilisateur);
...
declare module MonApplication.Service {
    class ProfilDetailHabilitationsService {
        ...
        tabHabsAffecteesActif: boolean;
        chargementHabilitationsEnCours: boolean;
        constructor(profilDetailServiceDonnees: Service.ProfilDetailServiceDonnees, $q: ng.IQService, profilService: Service.ProfilService, habilitationService: Service.HabilitationService, mwNotificationService: MyWay.UI.IMwNotificationService);
        ...
        private avertirUtilisateur(etatsRetour, messageOk, messageReussitePartielle, messageErreur);
    }
}
...
declare module MonApplication.Service {
    interface IAgentService {
        ...
        supprimerPersonnalisationAgentProfil: (identifiantAgent: string, codeProfil: string, dateDebutValidite: string, dateFinValidite: string) => ng.IPromise<any>;
