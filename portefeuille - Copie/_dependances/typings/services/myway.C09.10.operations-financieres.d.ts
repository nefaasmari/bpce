...
declare module myway.operationsFinancieres {
    class BilletsPresumesFauxOuMutiles {
        ...
        constructor($scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $timeout: ng.ITimeoutService, commonService: myway.operationsFinancieres.CommonService, operationsDiversesService: myway.composantsCommuns.OperationsDiversesService, modalService: MyWay.UI.IModalService, gcedocService: myway.composantsCommuns.GcedocService, identifiantBordereauService: myway.comInterdomaine.IdentifiantBordereauService);
    }
}
...
declare module myway.operationsFinancieres {
    class DelestageFondsControleur {
        ...
        private identifiantBordereauService;
        static $inject: string[];
        constructor($scope: ng.IScope, $timeout: ng.ITimeoutService, initialisationService: myway.composantsCommuns.InitialisationService, modalService: MyWay.UI.IModalService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, operationsDiversesService: myway.composantsCommuns.OperationsDiversesService, commonService: myway.operationsFinancieres.CommonService, gcedocService: myway.composantsCommuns.GcedocService, identifiantBordereauService: myway.comInterdomaine.IdentifiantBordereauService);
    }
}
...
declare module myway.operationsFinancieres {
    class ReceptionFondsControleur {
        ...
        private parametresComptables;
        constructor($scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $timeout: ng.ITimeoutService, commonService: myway.operationsFinancieres.CommonService);
    }
}
...
declare module myway.operationsFinancieres {
    class MwDifferencesCaissesControleur {
        ...
        constructor($scope: ng.IScope, $timeout: ng.ITimeoutService, $q: ng.IQService, modalService: MyWay.UI.IModalService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, initialisationService: myway.composantsCommuns.InitialisationService, operationsDiversesService: myway.composantsCommuns.OperationsDiversesService, commonService: myway.operationsFinancieres.CommonService, gcedocService: myway.composantsCommuns.GcedocService, identifiantBordereauService: myway.comInterdomaine.IdentifiantBordereauService);
...
declare module myway.operationsFinancieres {
    class ReceptionFondsControleur1006 {
        ...
        private identifiantBordereau;
        dataTransfertFondImpression: any;
        constructor($scope: ng.IScope, initialisationService: myway.composantsCommuns.InitialisationService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, modalService: MyWay.UI.IModalService, operationsDiversesService: myway.composantsCommuns.OperationsDiversesService, $q: ng.IQService, gcedocService: myway.composantsCommuns.GcedocService, identifiantBordereauService: myway.comInterdomaine.IdentifiantBordereauService, commonService: myway.operationsFinancieres.CommonService);
...
declare module myway.operationsFinancieres {
    class ReceptionFondsControleur1198 {
        ...
        private identifiantBordereau;
        dataTransfertFondImpression: any;
        constructor($scope: ng.IScope, initialisationService: myway.composantsCommuns.InitialisationService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, modalService: MyWay.UI.IModalService, operationsDiversesService: myway.composantsCommuns.OperationsDiversesService, gcedocService: myway.composantsCommuns.GcedocService, identifiantBordereauService: myway.comInterdomaine.IdentifiantBordereauService, commonService: myway.operationsFinancieres.CommonService);
