...
declare module myway.c0410.commun {
     ...
     */
    abstract class ProduitServiceControleur<F extends myway.c0410.commun.ObjetGenerique> {
        ...
        protected detenteur: GestionGeneriqueOffres.Types.InformationEntiteTitulaire;
        ...
        protected initialiserComposant(): ng.IPromise<boolean>;
        protected initPointEntree(): void;
        protected chargementTermine(): void;
