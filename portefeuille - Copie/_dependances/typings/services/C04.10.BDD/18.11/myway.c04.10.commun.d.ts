...
declare module myway.c0410.commun {
    class ProduitServiceTimers {
        static $inject: string[];
        constructor();
        initTimer(libelle: string, verbe?: string, url?: string): commun.ITimerServicePS;
...
declare module myway.c0410.commun {
    interface IServiceDonneesDelocalisees {
        getDonneesDelocalisees(codeEtablissement: string, codeServiceBadTableDelocalise: string): void;
    }
    class ServiceDonneesDelocalisees {
        private $q;
        private $timeout;
        private serviceAgentExtended;
        ...
        static $inject: string[];
        constructor($q: ng.IQService, $timeout: ng.ITimeoutService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, serviceTrace: myway.c0410.commun.ServiceTrace);
        getDonneesDelocalisees(codeEtablissement: any, codeServiceBadTableDelocalise: any): ng.IPromise<any>;
        finRequeteEncours(nomRequete: string): void;
        ajouterRequeteEncours(nomRequete: string, promise?: MyWay.Services.IPromesse<any>): void;
        existRequeteEncours(): boolean;
    }
}
