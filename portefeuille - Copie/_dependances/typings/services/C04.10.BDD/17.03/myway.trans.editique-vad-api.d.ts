...
declare module myway.trans.offreCommun.editique {
    class ParametrageLettreAccompagnementService {
        ...
        static $inject: string[];
        private nomPrenomAgent;
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, creationLettreAccompagnementService: lettreAccompagnement.CreationLettreAccompagnementService);
        /**
