...
declare module myway.c0410.compteDeDepot {
    class CompteDepotFormulaire extends myway.c0410.commun.Formulaire {
        ...
        private initialiserOperationFinanciere(codeBanque, codeGuichet, produit, libelleOffre, listeNumerosPersonnes, numeroPersonneIdentifiee, _mode?, identifiantProduitService?, codeCanal?, modeVpc?, codeFamille?, codeModeFinancier?);
         ...
         */
        getModeFinancier(codeEtab: any): GestionGeneriqueOffres.Types.DossierDeVente.IModeFinancier;
