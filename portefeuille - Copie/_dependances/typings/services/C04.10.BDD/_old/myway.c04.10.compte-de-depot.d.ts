...
declare module myway.c0410.compteDeDepot {
    class CompteDepotControleur {
        ...
        rattacheServiceLSE(listeMessageErreurs: GestionGeneriqueOffres.Types.ErreurGestionGeneriqueOffre[]): ng.IPromise<GestionGeneriqueOffres.Types.CompteRenduMiseEnGestion>;
