...
declare module myway.trans.offreCommun.editique.PreContratVPC {
    ...
    interface IsibgceVpcpreContratSection1 {
        ...
        blPrdServiceChequierVpc: IsibgceVpcpreContratSection1OptionChequier[];
    ...
    interface IsibgceVpcpreContratSection1BlEpargne {
        ...
        specifiqueCel: IsibgceVpcpreContratSection1BlEpargneSpecifiqueCel;
    ...
    interface IsibgceVpcpreContratSection1BlEpargneSpecifiqueCel {
    }
    ...
    interface IsibgceVpcpreContratSection1BlEpargneLivretTracableTauxNet {
        taux: string;
    }
    ...
    interface IsibgceVpcpreContratSection1BlPrdCarte {
        ...
        blPrdProduitPersonneVpc: IsibgceVpcpreContratSection1BlPrdCarteBlPrdProduitPersonneVpc[];
    }
    ...
    interface IsibgceVpcpreContratSection1BlPrdCarteBlPrdProduitPersonneVpc {
        civNomPrenomPersonne: string;
        ligneProduitAvecDetail: IsibgceVpcpreContratSection1BlPrdCarteBlPrdProduitPersonneVpcLigneProduitAvecDetail[];
        ligneProduitSansDetail: IsibgceVpcpreContratSection1BlPrdCarteBlPrdProduitPersonneVpcLigneProduitSansDetail[];
    }
    interface IsibgceVpcpreContratSection1BlPrdCarteBlPrdProduitPersonneVpcLigneProduitAvecDetail {
        titreProduit: string;
        detail: string;
    }
    interface IsibgceVpcpreContratSection1BlPrdCarteBlPrdProduitPersonneVpcLigneProduitSansDetail {
        titreProduit: string;
    }
    interface IsibgceVpcpreContratSection1OptionChequier {
        libelleOptionChequier: string;
    }
...
declare module myway.trans.offreCommun.editique.PreContratVPC {
    ...
    class MappingModelGceVpcPreContratService {
        ...
        private insererElementDuBlocPrdAlerteSms(bloc);
        private insererElementDuBlocPrdAlerteSmsDeclarationCgAlerteSms(bloc);
        private insererElementDuBlocPrdSolSms(bloc);
        private insererElementDuBlocPrdSolSmsDeclarationCgSolSms(bloc);
