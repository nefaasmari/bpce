...
declare module myway.c0410.compteDeDepot {
    class CompteDepotService {
        ...
        putLibreServiceEcureuil(contratLibreServiceEcureuil: IContratLibreServiceEcureuil): ng.IPromise<IContratLibreServiceEcureuil>;
...
declare module myway.c0410.compteDeDepot {
    class CompteDepotFormulaire extends myway.c0410.commun.ObjetGenerique {
        ...
        constructor(identifiantFormulaire: string, codeBanque?: string, codeGuichet?: string, produit?: GestionGeneriqueOffres.Types.ProduitCaracteristique, libelleOffre?: string, listeIdPersonnes?: string[], numeroPersonneIdentifiee?: string, _mode?: string, identifiantProduitService?: number, codeCanal?: string, modeVpc?: boolean);
        ...
        private initialiserOperationFinanciere(codeBanque, codeGuichet, produit, libelleOffre, listeNumerosPersonnes, numeroPersonneIdentifiee, _mode?, identifiantProduitService?, codeCanal?, modeVpc?);
