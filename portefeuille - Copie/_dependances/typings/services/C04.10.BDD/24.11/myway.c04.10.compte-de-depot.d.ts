...
declare module myway.c0410.compteDeDepot {
    namespace Constantes {
        const CLOTURE_TITRE_LABEL: string;
        const CLOTURE_TYPE: Array<string>;
        const HABILITATION_CTX: string;
        const HABILITATION_PERTE: string;
        const LIBELLE_ERREUR_HAB_AV: string;
        const LIBELLE_ERREUR_HAB_CL: string;
        const LIBELLE_ERREUR_HAB_OUV: string;
        const CODE_TYPE_PRODUIT_SERVICE_GCP_TABLE_DELOCALISE: string;
        const REFERENCE_PRODUIT_PRINCIPAL: string;
        const CSPR_DEFINIR_ROUTAGE_EDITIQUE: string;
        const CODE_HABILITATION_OUVERTURE_AVENANT_CLOTURE: string;
        const CODE_HABILITATION_MODIFICATION_LIBELLE_PERSONNALISE: string;
        const CODE_HABILITATION_LECTURE_LIBELLE_PERSONNALISE: string;
        const CODE_HABILITATION_FORCAGE_OPERATION_FINANCIERE: string;
        const CODE_HABILITATION_MODIFICATION_REVERSEMENT_AGIO: string;
        const CODE_HABILITATION_LECTURE_REVERSEMENT_AGIO: string;
        const CODE_ACTION_DONNEES_DOSSIER_COMMERCIAL_ET_PERSONNE: string;
        const NIVEAU_MESSAGE_ERREUR_BLOCANT: string;
        const NIVEAU_MESSAGE_ERREUR_INFORMATIF: string;
        const CODE_LIBELLE_MSG_FORCE: string;
        const CODE_LIBELLE_FORCAGE: string;
        const CODE_LIBELLE_OPERATIONFINANCIERE_IMPOSSIBLE: string;
        const MODE_PRECEDENT: string;
        const CODE_FORCAGE: string;
        const CODE_MODE_FINANCIER_VIREMENT_OD: string;
        const CODE_MODE_FINANCIER_ESP: string;
        const CODE_MODE_FINANCIER_CHEQUE_RECU: string;
        const CODE_MODE_FINANCIER_VIR_INTERNE: string;
        const CODE_MODE_FINANCIER_VERSEMENT_ESP: string;
        const CODE_MODE_FINANCIER_DIVERS: string;
        const CODE_MODE_FINANCIER_OUVERTURE_A_ZERO: string;
        const TEXTE_BOUTON_OUI: string;
        const TEXTE_BOUTON_NON: string;
        const TITRE_MODAL_ATTENTION: string;
        const MESSAGE_CONFIRMATION_PLAFOND_DEPASSE: string;
        const MONTANT_SUPERIEUR: number;
        const TEXTE_BOUTON_VALIDER: string;
        const TEXTE_BOUTON_ANNULER: string;
        const TITRE_MODAL_MISEENPERTE: string;
        const MESSAGE_CONFIRMATION_MISEENPERTE: string;
        const MISE_EN_PERTE: string;
        const MISE_EN_CONTENTIEUX: string;
        const CODE_OPERATION_OBLIGATOIRE: string;
    }
}

declare module myway.c0410.compteDeDepot {
    class CompteDepotService extends myway.c0410.commun.ProduitService {
        private $q;
        ...
        private _agiosRemun;
        private _guichetInterbancaire;
        erreurPromiseAgios: MyWay.Services.Erreur;
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, espaceGlobalService: myway.c0410.commun.EspaceGlobalService, serviceTrace: myway.c0410.commun.ServiceTrace);
        creerCompteDepot(numeroEntiteTitulaire: number, numeroOffreSouscrite: number, identifiantProduitService: number, donneesCompteDeDepot: DonneesCompteDeDepot, bordereau: number, codeFamilleGestionProduitService: string, codeUniversTracabilite?: string, forcage?: string, nodape?: number): ng.IPromise<DonneesCompteDeDepot>;
        ...
        toJmaString(): string;
        /** Requête GET
         *  Permet dans le cadre des opérations de clôturer et d'annuler d'ouvrir d'identifier les produits et services rattachés à un compte
         *  @return promise<ReleveCompteIListePsRattache>
         */
        getPrerequisClotureCDD(numeroOffreSouscrite: number, codeGuichetInterbancaire: string, codeEtablissement: string, codeTypeProduitService: string, referenceProduitService: string, miseAjourRmp: boolean): ng.IPromise<IListePsRattache>;
        /** Requête GET
        ...
        setAgiosRemun(agiosRemu: ICalculAgiosRemun): void;
        getAgiosRemun(): ICalculAgiosRemun;
        setCodeGuichetInterbancaire(guichetInterbancaire: string): void;
        getCodeGuichetInterbancaire(): string;
    }
}
...
declare module myway.c0410.compteDeDepot {
    ...
    class CompteDepotControleur extends commun.ProduitServiceControleur<CompteDepotFormulaire, GestionGeneriqueOffres.Types.InformationEntiteTitulaire> {
        protected $scope: ng.IScope;
        protected $q: ng.IQService;
        protected compteDepotService: CompteDepotService;
        ...
        private eventPS;
        private listeErreursBloquantesCloture;
        private listeErreursBloquantesAgiosCloture;
        private errotab;
        private _contratCDDCloture;
        private _contratLSE;
        detailSoldeOpefi: myway.comOpesFinancieres.IDetailSoldeCompte;
        boolEndCfn: boolean;
        isLoaded: boolean;
        isDossierVenteEnCours: boolean;
        isCddGSM: boolean;
        constructor($scope: ng.IScope, $q: ng.IQService, compteDepotService: CompteDepotService, espaceGlobalService: myway.c0410.commun.EspaceGlobalService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, affectationRadicalService: myway.comInterdomaine.AffectationRadicalService, compteBddCommunService: myway.c0410.commun.CompteBddCommunService, modalService: MyWay.UI.ModalService, postOperationFinanciere: myway.comOpesFinancieres.PostOperationFinanciereService, produitEngageService: myway.transProduitEngage.ProduitEngageService, identifiantBordereauService: myway.comInterdomaine.IdentifiantBordereauService, libreServiceEcureuilService: myway.c0410.commun.LibreServiceEcureuilCommunService, operationFinanciereService: myway.comOpesFinancieres.OperationFinanciereService, resultsCommerciauxService: myway.c0410.commun.ResultsCommerciauxService, chequeBanqueService: myway.comOpesFinancieres.ChequeBanqueService, serviceTrace: myway.c0410.commun.ServiceTrace);
        private isCrossCanal();
        private isModeFinancierPresentTLEtFF(modeFinancier);
        /**
        ...
        private initFormulaireEnOuverture();
        /**
        ...
        private initFormulaireEnAvenant(cdd);
        /**
         * Permet de lancer le Compte de depot en mode Cloture
         */
        protected initialiserEnCloture(): ng.IPromise<boolean>;
        private initFormulaireEnCloture(cdd);
        private initFormulaireClotureEnPerte();
        private getCompteDeDepot();
        private estLibelleVide();
        private EstHabiliteMultiple(habilitations);
        private EstHabilite(habilitation);
        /**
         ...
         */
        verifierPrerequis(enOuverture: boolean, majRmp: boolean, isBloque?: boolean): ng.IPromise<GestionGeneriqueOffres.Types.ErreurGestionGeneriqueOffre[]>;
        ...
        showPopupMiseEnPerte: (isEnPerte?: boolean) => void;
        /**
        ...
        private ouverturePopupConfirmationMontant();
        private ouverturePopupConfirmationMiseEnPerte();
        /**
        ...
        gererErreurQRGenerique(error: MyWay.Services.Erreur): ng.IPromise<GestionGeneriqueOffres.Types.CompteRenduMiseEnGestion>;
        /**
        ...
        private imprimerChequeDeBanque();
        /**
         ...
         */
        private getDonneesSauvegardeOperationFinanciere(modeFinancierNumerique);
        /**
         ...
         */
        lancerPopupOperationFinanciere(isHabiliteForcage: boolean, formulaire: any, messagesErreurs?: GestionGeneriqueOffres.Types.ErreurGestionGeneriqueOffre[]): ng.IPromise<GestionGeneriqueOffres.Types.CompteRenduMiseEnGestion>;
...
declare module myway.c0410.compteDeDepot {
    class CompteDepotFormulaire extends myway.c0410.commun.Formulaire {
        ...
        setDonneesModeFinancierDefaut(modeFinancier: string, codeCanal: string): void;
         ...
         */
        getModeFinancier(codeEtablissement: string): GestionGeneriqueOffres.Types.DossierDeVente.IModeFinancier;
        setModeFinancierDonneesSauvegardeOpeFiCasOuvertureAZero(donneesSauvegardeOpeFi: myway.comOpesFinancieres.Model.ChoixUtilisateurOpeFi, modeFinancierNumerique: string): void;
        /**
         * Permet de restaurer le l'operation financiere en cas de sauvegarde et de restauration de produit/service en VAD
         */
        restaureOperationFinanciere(operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere, estRepriseOffre: boolean): void;
    }
