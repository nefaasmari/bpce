...
declare module myway.c0410.compteDeDepot {
    class CompteDepotService {
        ...
        supprimerCompteDepot(contratCDD: ContratCDDCloture, numeroOffreSouscrite: number, identifiantPersonne: number, numeroEntiteTitulaire: number, identifiantProduitService: number, bordereau: number, forcage: string, indicateurChoixTracabilite: string, codeUniversTracabilite: string): ng.IPromise<void>;
...
declare module myway.c0410.compteDeDepot {
    ...
    class CompteDepotControleur {
        ...
        /**
         * Cette permet de verifier les prerequis pour le compte de depot. Elle est appelée au niveau de l'initialisation du CDD et
         * rejouée au niveau de la validation de formulaire. Si l'on est en cloture on emet un message d'erreur, si l'on est en validation ou
         * en mise en gestion on rajoute la liste des messages d'erreur du prerequis dans le compte rendu de mise en gestion
         */
        /**
...
declare module myway.c0410.compteDeDepot {
    class CompteDepotFormulaire extends myway.c0410.commun.ObjetGenerique {
        ...
        constructor(identifiantFormulaire: string, codeBanque?: string, codeGuichet?: string, produit?: GestionGeneriqueOffres.Types.ProduitCaracteristique, libelleOffre?: string, listeIdPersonnes?: string[], numeroPersonneIdentifiee?: string, _mode?: string);
        ...
        private initialiserOperationFinanciere(codeBanque, codeGuichet, produit, libelleOffre, listeNumerosPersonnes, numeroPersonneIdentifiee, _mode?);
...
declare module myway.c0410.compteDeDepot {
    ...
    interface IContratCDDCloture {
        listeServices: Array<IService>;
        codeActionModeCloture: string;
        nomBeneficiaire: string;
        detailSolde: IDetailSolde;
        referenceProduitService: string;
    }
    class ContratCDDCloture implements IContratCDDCloture {
        listeServices: Array<IService>;
        codeActionModeCloture: string;
        nomBeneficiaire: string;
        detailSolde: IDetailSolde;
