...
declare module myway.c0410.commun {
    ...
    class Formulaire extends ObjetGenerique {
        ...
        addChamps<T extends Object>(libelle: string, valeur: T, estModifie?: boolean): void;
        getChamps(libelle: string): ChampsFormulaire<Object>;
        getValeurChamps(libelle: string): Object;
        setValeurChamps(libelle: string, valeur: Object): void;
    ...
    class ChampsFormulaire<T extends Object> {
        ...
        private valeur;
        private estModifie;
        constructor(libelle: string, valeur: T, estModifie?: boolean);
        isValide(): boolean;
...
declare module myway.c0410.commun {
     ...
     */
    abstract class ProduitServiceControleur<F extends myway.c0410.commun.Formulaire, D extends GestionGeneriqueOffres.Types.IDetenteur> {
        ...
        protected abstract initialiserEnOuverture(): ng.IPromise<void>;
        protected abstract initialiserEnAvenant(): ng.IPromise<void>;
        protected abstract initialiserEnCloture(): ng.IPromise<void>;
