...
declare module myway.c0410.compteDeDepot {
    class CompteDepotService extends myway.c0410.commun.ProduitService {
        ...
        creerCompteDepot(numeroEntiteTitulaire: number, numeroOffreSouscrite: number, identifiantProduitService: number, donneesCompteDeDepot: DonneesCompteDeDepot, bordereau: number, codeFamilleGestionProduitService: string, codeUniversTracabilite?: string, forcage?: string): ng.IPromise<DonneesCompteDeDepot>;
