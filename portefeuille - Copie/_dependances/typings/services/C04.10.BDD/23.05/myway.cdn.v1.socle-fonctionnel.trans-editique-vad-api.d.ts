...
declare module myway.trans.offreCommun.editique.BordereauRetractation {
    ...
    interface IbordereauDeRetractationCorpsDocument {
        ...
        blTutelleRenonciation: IbordereauDeRetractationCorpsDocumentBlTutelleRenonciation[];
        blPersMajeur: number;
        blPersMinHorsLj: IbordereauDeRetractationCorpsDocumentBlPersMinHorsLj[];
        blPersMinLj1: number;
        blTutelleSignaturePm: IbordereauDeRetractationCorpsDocumentBlTutelleSignaturePm[];
    ...
    interface IbordereauDeRetractationCorpsDocumentBlTutelleRenonciation {
        nomCaisse: string;
    }
    ...
    interface IbordereauDeRetractationCorpsDocumentBlTutelleSignaturePm {
        civilitePersonneTutelle: string;
        prenomPersonneTutelle: string;
        nomPersonneTutelle: string;
    }
...
declare module myway.trans.offreCommun.editique.BordereauRetractation {
    ...
    interface IElementPourEdition {
        ...
        blPersMajeur: string;
        blTutelleRenonciation: IBlTutelleRenonciation;
        blPersMinHorsLJ: IBlPersMinHorsLJ;
        blTutelleSignaturePM: IBlTutelleSignaturePM;
        blPersMinLJ1: string;
    ...
    interface IBlTutelleRenonciation {
        nomCaisse: string;
    }
    ...
    interface IBlTutelleSignaturePM {
        civilitePersonneTutelle: string;
        prenomPersonneTutelle: string;
        nomPersonneTutelle: string;
    }
...
declare module myway.trans.offreCommun.editique.lettreAccompagnement {
    ...
    enum BlocLettreAccompagnement {
        ...
        BlOcfChequier,
        BlRecepDocAlertecureuil,
        BlRecepDocCommunLigneSeule,
    }
...
declare module myway.trans.offreCommun.editique.lettreAccompagnement {
    ...
    interface Ich061 {
        blModRecLiasSansSign: IlettreAccompagnementCorpsDocumentBlModRecLiasSansSign;
    }
    interface Ich062 {
        blConfMegiavEpargne: number;
    }
    interface Ich063 {
        blOcfChequier: IlettreAccompagnementCorpsDocumentBlOcfChequier;
    }
    interface Ich064 {
        blRecepDocAlertecureuil: number;
    }
    interface Ich065 {
        blRecepDocCommunLigneSeule: number;
    }
    ...
    interface IlettreAccompagnementCorpsDocumentBlModRecLiasSansSign {
        exemplaireDocument: string;
        nomOffre: string;
    }
    ...
    interface IlettreAccompagnementCorpsDocumentBlOcfChequier {
        etablissement: string;
    }
...
declare module myway.trans.offreCommun.editique.PreContratVPC {
    ...
    interface IBlocOcPhraseIntro extends IBloc {
        map: {
            LIB_ANCIENNE_OFFRE: string;
            ID_ANCIENNE_OFFRE: string;
            LIB_NOUVELLE_OFFRE: string;
            ID_NOUVELLE_OFFRE: string;
        };
    }
    interface IblocOcClot extends IBloc {
        map: {
            CIV_NOM_PRENOM_PERSONNE: string;
            CONJUG_PERSONNE: string;
            BL_OC_PRDT_CLOT: IblOcClotBlOcPrdtClot;
        };
    }
    interface IblOcClotBlOcPrdtClot extends IBloc {
        map: {
            TITRE_PRODUIT: string;
            REF_PRDT: string;
        };
    }
    interface IblocOcRepris extends IBloc {
        map: {
            CIV_NOM_PRENOM_PERSONNE: string;
            LIGNE_PRODUIT_AVEC_DETAIL: IblocOcReprisLigneProduitAvecDetail;
        };
    }
    interface IblocOcReprisLigneProduitAvecDetail extends IBloc {
        map: {
            TITRE_PRODUIT: string;
            DETAIL: string;
        };
    }
    interface IblocOcSouscrit extends IBloc {
        map: {
            CIV_NOM_PRENOM_PERSONNE: string;
            LIGNE_PRODUIT_AVEC_DETAIL: IblocOcSouscritLigneProduitAvecDetail;
        };
    }
    interface IblocOcSouscritLigneProduitAvecDetail extends IBloc {
        map: {
            TITRE_PRODUIT: string;
            DETAIL: string;
        };
    ...
    interface IBlocPrdCddVpc extends IBloc {
        map: {
            ...
            ETAB: string;
            BL_DTE_OUV_CDD_REPRIS: IBlocPrdCddDteOuvCddReprise;
        };
    }
    interface IBlocPrdCddDteOuvCddReprise extends IBloc {
        map: {
            BL_DTE_OUV_CDD: string;
        };
    }
    ...
    interface IBlocPrdServiceChequierVpc extends IBloc {
        map: {
            ...
            INFO_TELEPHONE: string;
            INFO_TELEPHONE_SUITE: string;
        };
    }
    ...
    interface IBlocAssuranceMoyenPaiementVpc extends IBloc {
        map: {
            TITRE: string;
            CLECONTROLE: string;
            COMPTE: string;
    ...
    interface IBlocServiceOppositionVpc extends IBloc {
        map: {
            TITRE: string;
            CLECONTROLE: string;
            COMPTE: string;
    ...
    interface IBlocSatellisAssuranceVpc extends IBloc {
        map: {
            TITRE: string;
            CLECONTROLE: string;
            COMPTE: string;
    ...
    interface IBlocAsscompte extends IBloc {
        map: {
            LIB_LALE_ETS_1: string;
            LIB_LALE_ETS_2: string;
        };
    ...
    interface IBlocCertifCddCeVpc extends IBloc {
        map: {
            LIB_LALE_ETS: string;
            DATE_CONVENTION_CDD: string;
            LIB_CDD_DEVISE: string;
            LIB_CDD_DEVISE2: string;
            LIB_DELADU_ETS: string;
            LIB_DIT: string;
            LIB_CDD_DEVISE3: string;
            LIB_DELADU_ETS_2: string;
            LIB_DIT2: string;
            NOM_SERVICE_INTERNET_LONG: string;
            LIB_LALE_ETS_2: string;
            URL_ETS: string;
            LIB_LALE_ETS_3: string;
        };
    }
    interface IblocBlPrdAlertesmsVpc extends IBloc {
        map: {
            TITRE_ALERTE: string;
            COMPTE_FACTURATION: string;
            NOM_ALERTE: string;
        };
    }
    interface IBlocPrdAlertesmsVpcParametreAlerte extends IBloc {
        map: {
            LIBELLE_ALERTE: string;
        };
    }
    interface IblocBlReprelegCdd extends IBloc {
        map: {
            LIB_LALE_ETS: string;
            LIB_LALE_ETS_2: string;
        };
    }
    interface IblocBlPrdCarteCondChoixCode extends IBloc {
        map: {
            PHRASE_CHOIX: string;
        };
    }
    interface IblocBlPrdCarteCondBlocageDistanceDemat extends IBloc {
        map: {
            LIB_DELADU_ETS: string;
            LIB_ALAAU_ETS: string;
        };
...
declare module myway.trans.offreCommun.editique.PreContratVPC {
    ...
    interface IsibgceVpcpreContratSection1 {
        blocChoiceJson: (Ich00 | Ich01 | Ich02 | Ich03 | Ich04 | Ich05 | Ich06 | Ich07 | Ich08 | Ich09 | Ich010 | Ich011 | Ich012 | Ich013 | Ich014 | Ich015 | Ich016 | Ich017 | Ich018 | Ich019 | Ich020 | Ich021 | Ich022 | Ich023 | Ich024 | Ich025 | Ich026 | Ich027 | Ich028 | Ich029 | Ich030 | Ich031 | Ich032 | Ich033 | Ich034 | Ich035 | Ich036 | Ich037 | Ich038 | Ich039 | Ich040 | Ich041 | Ich042 | Ich043 | Ich044 | Ich045 | Ich046 | Ich047 | Ich048 | Ich049 | Ich050 | Ich051 | Ich052 | Ich053 | Ich054 | Ich055 | Ich056 | Ich057 | Ich058 | Ich059 | Ich060 | Ich061 | Ich062 | Ich063 | Ich064 | Ich065 | Ich066 | Ich067 | Ich068 | Ich069 | Ich070 | Ich071 | Ich072 | Ich073 | Ich074 | Ich075 | Ich076 | Ich077 | Ich078 | Ich079 | Ich080 | Ich081 | Ich082 | Ich083 | Ich084 | Ich085 | Ich086 | Ich087 | Ich088 | Ich089 | Ich090 | Ich091 | Ich092 | Ich093 | Ich094 | Ich095)[];
    }
    interface Ich00 {
    ...
    interface Ich043 {
        blAsscompte: IsibgceVpcpreContratSection1BlAsscompte;
    }
    interface Ich044 {
    ...
    interface Ich067 {
        certifStdBancaVpcRgpd: IsibgceVpcpreContratSection1CertifStdBancaVpcRgpd;
    }
    interface Ich068 {
        blOcTitreCondition: number;
    }
    interface Ich069 {
        blOcPhraseIntro: IsibgceVpcpreContratSection1BlOcPhraseIntro;
    }
    interface Ich070 {
        blOcClot: IsibgceVpcpreContratSection1BlOcClot;
    }
    interface Ich071 {
        blOcRepris: IsibgceVpcpreContratSection1BlOcRepris;
    }
    interface Ich072 {
        blOcSouscrit: IsibgceVpcpreContratSection1BlOcSouscrit;
    }
    interface Ich073 {
        blOcPrdCarte: IsibgceVpcpreContratSection1BlPrdCarte;
    }
    interface Ich074 {
        blOcPhraseIntro2: boolean;
    }
    interface Ich075 {
        blOcSouscritPrdDomilisVpc: boolean;
    }
    interface Ich076 {
        blOcSouscritRefusDomilisVpc: boolean;
    }
    interface Ich077 {
        blOcSouscritRefusAlertecureuilVpc: boolean;
    }
    interface Ich078 {
        blPrdServiceEparOcVpc: IsibgceVpcpreContratSection1BlPrdServiceEparVpc;
    }
    interface Ich079 {
        blOcPrdServiceChequierVpc: IsibgceVpcpreContratSection1BlPrdServiceChequierVpc;
    }
    interface Ich080 {
        blOcPrdServiceFranchiseAgiosVpc: IsibgceVpcpreContratSection1BlPrdServiceFranchiseAgiosVpc;
    }
    interface Ich081 {
        blOcPrdDecouvertVpc: IsibgceVpcpreContratSection1BlPrdDecouvertVpc;
    }
    interface Ich082 {
        blOcPrdRemunerationVpc: IsibgceVpcpreContratSection1BlPrdRemunerationVpc;
    }
    interface Ich083 {
        blOcPrdOpCouranteIllimiteeVpc: IsibgceVpcpreContratSection1BlPrdOpCouranteIllimiteeVpc;
    }
    interface Ich084 {
        blOcPrdOptionInternationaleVpc: IsibgceVpcpreContratSection1BlPrdOptionInternationaleVpc;
    }
    interface Ich085 {
        blOcPrdRetraitDeplaceVpc: IsibgceVpcpreContratSection1BlPrdRetraitDeplaceVpc;
    }
    interface Ich086 {
        blOcPrdCoffreFortJointVpc: IsibgceVpcpreContratSection1BlPrdCoffreFortJointVpc;
    }
    interface Ich087 {
        blOcPrdCoffreFortSimpleVpc: IsibgceVpcpreContratSection1BlPrdCoffreFortSimpleVpc;
    }
    interface Ich088 {
        blOcPrdAssuranceSurCompteVpc: IsibgceVpcpreContratSection1BlPrdAssuranceSurCompteVpc;
    }
    interface Ich089 {
        certifCddCeVpc: IsibgceVpcpreContratSection1CertifCddCeVpc;
    }
    interface Ich090 {
        blPrdAlertesmsVpc: IsibgceVpcpreContratSection1BlPrdAlertesmsVpc;
    }
    interface Ich091 {
        blOcPrdAlertesmsVpc: IsibgceVpcpreContratSection1BlOcPrdAlertesmsVpc;
    }
    interface Ich092 {
        blReprlegCdd: IsibgceVpcpreContratSection1BlReprlegCdd;
    }
    interface Ich093 {
        blPrdAssuranceMoyenPaiementVpc: IpreContratVpcSection1BlPrdAssuranceMoyenPaiementVpc;
    }
    interface Ich094 {
        blPrdServiceOppositionVpc: IpreContratVpcSection1BlPrdServiceOppositionVpc;
    }
    interface Ich095 {
        blPrdSatellisAssuranceVpc: IpreContratVpcSection1BlPrdSatellisAssuranceVpc;
    }
    interface IgenericEnteteets {
        logoEtablissement: IgenericEnteteetsLogoEtablissement;
        libelleAgence: string;
    ...
    interface IsibgceVpcpreContratSection1BlAsscompte {
        libLaleEts1: string;
        libLaleEts2: string;
    }
    ...
    interface IgenericInfoPpListePersonnes {
        blocChoiceJson: (Ich10 | Ich11 | Ich12 | Ich13 | Ich14 | Ich15)[];
    }
    interface Ich10 {
    ...
    interface Ich15 {
        infosPers4: IgenericInfoPpListePersonnesInfosPers4;
    }
    ...
    interface IgenericInfoPpListePersonnesInfosPers3 {
        ...
        capaciteJuridique3: string;
    }
    interface IgenericInfoPpListePersonnesInfosPers4 {
        dadatj: string;
        idnsbd: string;
        lidars: string;
        lidgv26: string;
    ...
    interface IsibgceVpcpreContratSection1BlOcPhraseIntro {
        libAncienneOffre: string;
        idAncienneOffre: string;
        libNouvelleOffre: string;
        idNouvelleOffre: string;
    }
    interface IsibgceVpcpreContratSection1BlOcClot {
        civNomPrenomPersonne: string;
        conjugPersonne: string;
        blOcPrdtClot: IsibgceVpcpreContratSection1BlOcClotBlOcPrdtClot[];
    }
    interface IsibgceVpcpreContratSection1BlOcClotBlOcPrdtClot {
        titreProduit: string;
        refPrdt: string;
    }
    interface IsibgceVpcpreContratSection1BlOcRepris {
        civNomPrenomPersonne: string;
        ligneProduitAvecDetail: IsibgceVpcpreContratSection1BlOcReprisLigneProduitAvecDetail[];
    }
    interface IsibgceVpcpreContratSection1BlOcReprisLigneProduitAvecDetail {
        titreProduit: string;
        detail: string;
    }
    interface IsibgceVpcpreContratSection1BlOcSouscrit {
        civNomPrenomPersonne: string;
        ligneProduitAvecDetail: IsibgceVpcpreContratSection1BlOcSouscritLigneProduitAvecDetail[];
    }
    interface IsibgceVpcpreContratSection1BlOcSouscritLigneProduitAvecDetail {
        titreProduit: string;
        detail: string;
    }
    ...
    interface IsibgceVpcpreContratSection1BlPrdCarte {
        civilite: string;
        nomPrenom: string;
        lblDemandeOuPossede: string;
        carte: string;
        lignePlafond: IsibgceVpcpreContratSection1BlPrdCarteLignePlafond[];
        condDebitDiff: boolean;
        condMineur: boolean;
        condCartecredit: boolean;
        condChoixCode: IsibgceVpcpreContratSection1BlPrdCarteCondChoixCode;
        condBlocageDistanceDemat: IsibgceVpcpreContratSection1BlPrdCarteCondBlocageDistanceDemat;
        condPaiementMobile: boolean;
        carteAgir: IsibgceVpcpreContratSection1BlPrdCarteCarteAgir[];
    }
    interface IsibgceVpcpreContratSection1BlPrdCarteCondChoixCode {
        phraseChoix: string;
    }
    ...
    interface IsibgceVpcpreContratSection1BlPrdCarteCondBlocageDistanceDemat {
        libDeladuEts: string;
        libAlaauEts: string;
    }
    ...
    interface IsibgceVpcpreContratSection1BlPrdCddVpc {
        ...
        nomProduit: string;
        etab: string;
        blDteOuvCddRepris: IsibgceVpcpreContratSection1BlPrdCddVpcBlDteOuvCddReprise;
    }
    interface IsibgceVpcpreContratSection1BlPrdCddVpcBlDteOuvCddReprise {
        blDteOuvCdd: string;
    }
    ...
    interface IsibgceVpcpreContratSection1BlVersementEpargne {
        ...
        livretPartage: IsibgceVpcpreContratSection1BlVersementEpargneLivretPartage;
    }
    ...
    interface IsibgceVpcpreContratSection1BlVersementEpargneLivretPartage {
        organismePartage: string;
        tauxPartage: string;
        nomProduit: string;
        libAlaauEts1: string;
    ...
    interface IsibgceVpcpreContratSection1CertifCddCeVpc {
        libLaleEts: string;
        dateConventionCdd: string;
        libCddDevise: string;
        libCddDevise2: string;
        libDeladuEts: string;
        libDit: string;
    ...
    interface IsibgceVpcpreContratSection1BlPrdAlertesmsVpc {
        titreAlerte: string;
        compteFacturation: string;
        nomAlerte: string;
        parametreAlerte: IsibgceVpcpreContratSection1BlPrdAlertesmsVpcParametreAlerte[];
    }
    interface IsibgceVpcpreContratSection1BlPrdAlertesmsVpcParametreAlerte {
        libelleAlerte: string;
    }
    interface IsibgceVpcpreContratSection1BlOcPrdAlertesmsVpc {
        titreAlerte: string;
        compteFacturation: string;
        nomAlerte: string;
        parametreAlerte: IsibgceVpcpreContratSection1BlOcPrdAlertesmsVpcParametreAlerte[];
    }
    interface IsibgceVpcpreContratSection1BlOcPrdAlertesmsVpcParametreAlerte {
        libelleAlerte: string;
    }
    interface IsibgceVpcpreContratSection1BlReprlegCdd {
        libLaleEts: string;
        libLaleEts2: string;
    }
    interface IpreContratVpcSection1BlPrdAssuranceMoyenPaiementVpc {
        titre: string;
        libLaleEts: string;
    }
    interface IpreContratVpcSection1BlPrdServiceOppositionVpc {
        titre: string;
        clecontrole: string;
        compte: string;
        libLaleEts: string;
    }
    interface IpreContratVpcSection1BlPrdSatellisAssuranceVpc {
        titre: string;
        clecontrole: string;
        compte: string;
        libLaleEts: string;
...
declare module myway.trans.offreCommun.editique.lettreAccompagnement {
    class CreationLettreAccompagnementService {
        ...
        /** Construit le bloc de reception des liasse sans signature  */
        private constuireBlocBlocModaliteRecepLiasseSansSign(blocsLettreAccomapagnement, liasse);
        /** Construit le bloc blblEngagMonoDetPersMajQuad */
        private construireBlocBlConfMEGIAvEpargne(blocsLettreAccomapagnement);
        ...
        /** Construit le bloc recep doc Alerte Ecureuil */
        private construireBlocRecepDocAlertecureuil(blocsLettreAccomapagnement);
        ...
        private construireBlocOuvertureOcfChequier(blocsLettreAccomapagnement, OcfChequier);
        /** Construit le bloc recep doc commun */
        private construireBlocRecepDocCommunLigneSeule(blocsLettreAccomapagnement);
        private construireEntete(document, codeBarre, numRefDoc, refActe);
        /**
        * @description Construction de l'entête du document
        *
...
declare module myway.trans.offreCommun.editique.lettreAccompagnement {
    class ParametrageLettreAccompagnementService {
      ...
      */
        ...
        private getLettreAccompagnementArchiverGenererParams(documentAImprimer, authenticationInfo, contexteEditique);
    }
}
...
declare module myway.trans.offreCommun.editique.PreContratVPC {
    class BlocModeleVpcPreContrat {
        ...
        static BLOC_REPRESENTANT_LEGAL: string;
        ...
        static BL_OC_CLOT: string;
        static BL_OC_REPRIS: string;
        static BL_OC_SOUSCRIT: string;
        static BL_OC_PRD_CARTE: string;
        static BLOC_OC_PRD_ASSURANCE_SUR_COMPTE_VPC: string;
        static BLOC_PRD_ALERTESMS_VPC: string;
        static BLOC_OC_PRD_ALERTESMS_VPC: string;
    }
    class InstanceBlocEdition {
        ...
        static BL_OC_TITRE_CONDITION: string;
        static BL_OC_PHRASE_INTRO: string;
        static BL_OC_PHRASE_INTRO_2: string;
        static BL_OC_SOUSCRIT_PRD_DOMILIS_VPC: string;
        static BL_OC_SOUSCRIT_REFUS_DOMILIS_VPC: string;
        static BL_OC_SOUSCRIT_REFUS_ALERTECUREUIL_VPC: string;
        static BL_PRD_SERVICE_EPAR_OC_VPC: string;
        static BL_OC_PRD_SERVICE_CHEQUIER_VPC: string;
        static BL_OC_PRD_DECOUVERT_VPC: string;
        static BL_OC_PRD_REMUNERATION_VPC: string;
        static BL_OC_PRD_OP_COURANTE_ILLIMITEE_VPC: string;
        static BL_OC_PRD_OPTION_INTERNATIONALE_VPC: string;
        static BL_OC_PRD_RETRAIT_DEPLACE_VPC: string;
        static BL_OC_PRD_COFFRE_FORT_JOINT_VPC: string;
        static BL_OC_PRD_COFFRE_FORT_SIMPLE_VPC: string;
        static BL_OC_PRD_SERVICE_FRANCHISE_AGIOS_VPC: string;
        static CERTIF_CDD_CE_VPC: string;
        static BL_REPRLEG_CDD: string;
        static BL_PRD_ASSURANCE_MOYEN_PAIEMENT_VPC: string;
        static BL_PRD_SERVICE_OPPOSITION_VPC: string;
        static BL_PRD_SATELLIS_ASSURANCE_VPC: string;
    }
    ...
    class InstanceBlocPrdCddVpc {
        ...
        static VERSEMENT_VIR_INTERNE: string;
        static BL_DTE_OUV_CDD_REPRIS: string;
    }
    ...
    class InstanceBlocPrdCarte {
        ...
        static BL_OC_PRD_CARTE: string;
        static COND_MINEUR: string;
        static COND_PAIEMENT_MOBILE: string;
        static COND_CHOIX_CODE: string;
    }
    ...
    class InstanceBlocOcPrdAssuranceSurCompteVpc {
        static BL_OC_PRD_ASSURANCE_SUR_COMPTE_VPC: string;
        static LIGNE_BENEFICIAIRE: string;
    }
    ...
    class InstanceBlocOcClot {
        static BL_OC_CLOT: string;
        static BL_OC_PRDT_CLOT: string;
    }
    class InstanceBlocOcRepris {
        static BL_OC_REPRIS: string;
        static LIGNE_PRODUIT_AVEC_DETAIL: string;
    }
    class InstanceBlocOcSouscrit {
        static BL_OC_SOUSCRIT: string;
        static LIGNE_PRODUIT_AVEC_DETAIL: string;
    }
    class InstanceBlocPrdAlertesmsVpc {
        static BL_PRD_ALERTESMS_VPC: string;
        static PARAMETRE_ALERTE: string;
    }
    class InstanceBlocOcPrdAlertesmsVpc {
        static BL_OC_PRD_ALERTESMS_VPC: string;
        static PARAMETRE_ALERTE: string;
    }
    class MappingModelGceVpcPreContratService {
        ...
        private blocGlobalOcCarte;
        private blocGlobalAssuranceSurCompteVpc;
        private blocGlobalOcAssuranceSurCompteVpc;
        private blocGlobalProduitPersonneVpc;
        private blocGlobalOcClot;
        private blocGlobalOcRepris;
        private blocGlobalOcSouscrit;
        private blocGlobalAlertesmsVpc;
        private blocGlobalOcAlertesmsVpc;
        private document;
        ...
        private mapperInfosPers4(infosPers4Org);
        ...
        private insererElementDuBlocOcPrdCarte(bloc);
        private insererElementDuBlocPrdCarte(bloc);
        private insererElementDuBlocPrdAssuranceSurCompteVpc(bloc);
        private insererElementDuBlocOcPrdAssuranceSurCompteVpc(bloc);
        private insererElementDuBlocPrdProduitPersonneVpc(bloc);
        private insererElementDuBlocOcClot(bloc);
        private insererElementDuBlocOcRepris(bloc);
        private insererElementDuBlocOcSouscrit(bloc);
        private insererElementDuBlocPrdAlertesmsVpc(bloc);
        private insererElementDuBlocOcPrdAlertesmsVpc(bloc);
...
declare module myway.trans.offreCommun.editique.PreContratVPC {
    ...
    class EditPreContratVPCRessourceService {
        ...
        preparerBodyRessourcePreContrat(contexteEditique: GestionGeneriqueOffres.Types.IContexteEditique, offreSource?: modeleCommun.IAncienneOffre): IPreContratVPC;
        ...
        putEditPreContratVPC(query: IEditPreContratVPCQuery, editPreContratVPC: IPreContratVPC): ng.IPromise<IPreContratVPC>;
    }
}
...
declare module myway.trans.offreCommun.editique.PreContratVPC {
    class EditPreContratVPCService {
        ...
        obtenirDocumentMappe(contexteEditique: GestionGeneriqueOffres.Types.IContexteEditique, offreSource?: modeleCommun.IAncienneOffre): ng.IPromise<IsibgceVpcpreContrat>;
        getDocument(documentAImprimer: modeleCommun.IDocumentAImprimer, contexteEditique: GestionGeneriqueOffres.Types.IContexteEditique, authenticationInfo: MyWay.Services.Context.AuthentificationInfo, offreSource?: modeleCommun.IAncienneOffre): ng.IPromise<modeleCommun.IDocumentAGenerer>;
