...
declare module myway.c0410.compteDeDepot {
    class CompteDepotControleur {
        ...
        donneesSauvegardeCompteDepot: IDonneesSauvegardeCompteDepot;
...
declare module myway.c0410.compteDeDepot {
    class CompteDepotFormulaire extends myway.c0410.commun.ObjetGenerique {
         ...
         */
        restaureDonneesSauvegardeProduitService(donneeSauvegardeProduitService: IDonneesSauvegardeCompteDepot): GestionGeneriqueOffres.Types.ErreurGestionGeneriqueOffre[];
    }
}
...
declare module myway.c0410.compteDeDepot {
     ...
     *
     */
    interface IDonneesSauvegardeCompteDepot extends GestionGeneriqueOffres.Types.DossierDeVente.IDonneeSauvegardeProduitService {
        identifiant: string;
        intitule: string;
        reversementAgio: boolean;
        operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere;
