...
declare module ComposantsCommunsChequier.Services {
    ...
    class ContratChequeInformationService {
        ...
        static CODE_ERREUR_OPTION_ROUTAGE_INTERDITE: string;
...
declare module ComposantsCommunsChequier.Controleurs {
    ...
    class LieuLivraisonChequierControleur {
        ...
        static CODE_ENVOI_SIMPLE: string;
        static CODE_ENVOI_RECOMMANDE_SANS_AR: string;
        static CODE_ENVOI_RECOMMANDE_AVEC_AR: string;
        static sauvegardeNumeroAgenceDistributionAutreAgence: number;
        static $inject: string[];
         ...
         */
        static fillModelWithLieuLivraisonCommun(model: ComposantsCommunsChequier.Controleurs.ILieuLivraisonItem, chequierAEditer: ComposantsCommunsChequier.Modeles.CreationChequier.ICreationChequier, edsDomiciliation: number, numeroAgenceDistribution: number): ComposantsCommunsChequier.Modeles.CreationChequier.ICreationChequier;
        static sauverNumeroAgenceDistributionAutreAgence(numeroAgenceDistribution: number): number;
    }
}
...
declare module ComposantsCommunsChequier.Controleurs {
    ...
    class PeriodeSuspensionChequierControleur {
         ...
         */
        onChangeDateDebutDePeriode(dateDebut: string): void;
        /**
         * Méthode de callback suite à la modification de la date de fin de la période de suspension.
         */
        onChangeDateFinDePeriode(dateFin: string): void;
        /**
