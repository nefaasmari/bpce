...
/**
 * Contrôleur de la page de tests de la directive mw-dei-pro-cloture
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureDeiPro.Controleurs {
    /**
     * Déclaration du contrôleur
     */
    class PageDevMwDeiProClotureControleur {
...
/**
 * Contrôleur de la directive mw-dei-pro-cloture
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureDeiPro.Controleurs {
    /**
     * Déclaration du contrôleur
     */
    class MwDeiProClotureControleur {
        private $scope;
        private serviceAgentExtended;
        ...
        /**
         * Méthode appelée pour le traitement de la sauvegarde de la clôture de l'abonnement DEI Pro
...
/**
 * Directive pour l'affichage de la page de clôture de Dei Pro
 * @author S0077536 (Arnaud Despalins)
 */
declare module ClotureDeiPro.Directives {
    function mwDeiProCloture(): ng.IDirective;
}
