...
declare namespace ContentieuxServices.Constantes.Inject {
    ...
    namespace Services {
        ...
        const garantiePGEService: string;
...
declare namespace ContentieuxServices.Constantes.Dossier {
    ...
    namespace Commun {
        const TITRE_POPUP_PAS_DE_DOSSIER: string;
        const MESSAGE_POPUP_PAS_DE_DOSSIER: string;
        const BOUTON_CREER_DOSSIER: string;
    }
}
...
declare namespace ContentieuxServices.Constantes.Echeancier {
    ...
    const ECHEANCIER_VAD_STATUT_ACTIF: string;
}
...
declare namespace ContentieuxServices.Constantes.Garantie {
    namespace Garantie {
        ...
        const INDICATEUR_GARANTIE_ETAT_PGE_OUI: string;
        const INDICATEUR_GARANTIE_ETAT_PGE_NON: string;
        const CALCUL_VERSEMENT_GARANTIE_PGE: string;
        const CALCUL_REMBOURSEMENT_GARANTIE_PGE: string;
    }
}
...
declare namespace ContentieuxServices.Constantes {
    namespace ContentieuxHabilitations {
        ...
        type Habilitations = "decomptesGestion" | "decomptesConsultation" | "garantiesGestion" | "garantiesConsultation" | "provisionGestion" | "provisionConsultation" | "creanceDossierGestion" | "creanceDossierConsultation" | "accesEdg";
        const DECOMPTES_GESTION: string;
        const DECOMPTES_CONSULTATION: string;
        const GARANTIE_GESTION: string;
        const GARANTIE_CONSULTATION: string;
        const PROVISION_GESTION: string;
        const PROVISION_CONSULTATION: string;
        const CREANCE_DOSSIER_GESTION: string;
        const CREANCE_DOSSIER_CONSULTATION: string;
        const ACCES_EDG: string;
    }
}
...
declare namespace ContentieuxServices.Constantes.Paiement {
    ...
    namespace Cheque {
        ...
        namespace OperationDiverse {
            ...
            const CODE_FAMILLE_OPERATION_DIVERSE_PGE: string;
        }
    }
}
...
declare namespace ContentieuxServices.Constantes.Processus {
    ...
    const listecodeProduitServicePGE: string[];
    const listeCodeProduitServiceDecheanceTerme: string[];
    const creditOrigineGECCO: string;
    const listeCodeProduitServiceNonAutoriseDecheanceContrat: string[];
    const decheanceTermeTypeTerme: string;
    const decheanceTermeTypeRetour: string;
    const decheanceTermeTypeContrat: string;
    const creanceEDG: string;
    const listeCodeProduitServiceEDG: string[];
...
declare namespace ContentieuxServices.Constantes.Solde {
    ...
    namespace PCTX {
        ...
        const libelleMontant1: string;
        const libelleMontant2: string;
        const listeCodeProduitServiceBilletsFinanciers: string[];
    }
}

declare namespace ContentieuxServices.Constantes.Surendettement {
    namespace BDF {
        const listeCodeNotificationRecevabilite: string[];
        const listeCodeNotificationPlan: string[];
    }
}
...
declare namespace ContentieuxServices.Services.Creance {
    class CreanceService implements ICreanceService {
        ...
        /**
         * Indique s'il existe des échéanciers VAD (non actif)
         * @param identifiantCreance
         * @param numeroDossier
         */
        getListeEcheanciersClosVAD(identifiantCreance: number, numeroDossier: number): ng.IPromise<number>;
        /**
...
declare namespace ContentieuxServices.Services.Creance {
    interface ICreanceService {
        ...
        getListeComptesSupport(codeEtablissement: string, identifiantCreance: number): ng.IPromise<Modeles.Creance.ICompteSupport[]>;
        /**
         * Retourne la liste des échéanciers VAD de la créance
         */
        getListeEcheanciersClosVAD(identifiantCreance: number, numeroDossier: number): ng.IPromise<number>;
    }
}
...
declare namespace ContentieuxServices.Services.Dossier {
    interface IDossierSyntheseService {
        ...
        getContratsVarioNonDechusLeves(codeEtablissement: string, numeroDossier: number, numeroInterneEds: string, idEntiteTitulaire: string, fromCache?: boolean): ng.IPromise<Modeles.Contrat.IContratTuile[]>;
        ...
        getContratsProduitsMySys(codeEtablissement: string, idEntiteTitulaire: string, fromCache?: boolean): ng.IPromise<boolean>;
    ...
    class DossierSyntheseService implements IDossierSyntheseService {
        ...
        getContratsVario(codeEtablissement: string, numeroDossier: number, numeroInterneEds: string, idEntiteTitulaire: string, fromCache?: boolean): ng.IPromise<Modeles.Contrat.IContratTuile[]>;
        /**
         * 2024 - Contrats Vario du dossier
         * @param codeEtablissement
         * @param numeroDossier
         * @param numeroInterneEds
         * @param fromCache
        ...
        getContratsMySys(codeEtablissement: string, idEntiteTitulaire: string, fromCache?: boolean): ng.IPromise<[Modeles.Contrat.IContratMySysParticipants]>;
        /**
         * get les contrats produits MySys de l'entité titulaire
        ...
        private isPGE(codeProduitService);
        /**
         * Indique si la garantie pour un PGE a été mise en jeu
         * Ajout 2021
         */
        private affecterGarantiePGE(contrat, numeroDossier);
        /**
...
declare namespace ContentieuxServices.Services.GarantiePGE {
    class GarantiePGEService implements IGarantiePGEService {
        private garantieRestService;
        private creanceRestService;
        static $inject: string[];
        constructor(garantieRestService: Contentieux.RestServices.Services.InformationGarantiePGEService, creanceRestService: Contentieux.RestServices.Services.CreanceService);
        getInformationGarantie(codeEtablissement: string, identifiantCredit: string): ng.IPromise<Modeles.GarantiePGE.IGarantiePGE>;
        /**
         * Calcul du montant de la garantie
         * @param codeEtablissement
         * @param params
         */
        calculerMontantGarantiePGE(codeEtablissement: string, params: Modeles.GarantiePGE.IParamCalculMontant): ng.IPromise<number>;
    }
}
...
declare namespace ContentieuxServices.Services.GarantiePGE {
    interface IGarantiePGEService {
        getInformationGarantie(codeEtablissement: string, identifiantCredit: string): ng.IPromise<Modeles.GarantiePGE.IGarantiePGE>;
        calculerMontantGarantiePGE(codeEtablissement: string, type: Modeles.GarantiePGE.IParamCalculMontant): ng.IPromise<number>;
    }
}
...
declare namespace ContentieuxServices.Services.Habilitations {
    class HabilitationsService implements IHabilitationsService {
        ...
        private isHabiliteDecompteGestion();
        private isHabiliteDecompteConsultation();
        private isHabiliteGarantieGestion();
        private isHabiliteGarantieConsultation();
        private isHabiliteProvisionGestion();
        private isHabiliteProvisionConsultation();
        private isHabiliteCreanceDossierGestion();
        private isHabiliteCreanceDossierConsultation();
        private isHabiliteAccesEDG();
        isHabilite(role: Constantes.ContentieuxHabilitations.Roles): MyWay.Services.IPromesse<boolean>;
        isHabiliteFonction(role: Constantes.ContentieuxHabilitations.Habilitations): MyWay.Services.IPromesse<boolean>;
...
declare namespace ContentieuxServices.Services.Paiement {
    interface IPaiement {
        ...
        getCompteCCIE(codeEtablissement: string): ng.IPromise<Modeles.Paiement.ICompteCCIE>;
    }
    class Paiement implements IPaiement {
        ...
        private entiteTitulaireService;
        private compteCCIEService;
        static $inject: string[];
        constructor($q: ng.IQService, paiementService: Contentieux.RestServices.Services.IPaiementService, dossierSyntheseService: ContentieuxServices.Services.Dossier.IDossierSyntheseService, garantieService: ContentieuxServices.Services.Garantie.IGarantieService, dossierService: Contentieux.RestServices.Services.IDossierService, entiteTitulaireService: ContentieuxServices.Services.EntiteTitulaire.IEntiteTitulaireService, compteCCIEService: Contentieux.RestServices.Services.ICompteCCIEService);
        getEligibiliteModePaiement(codeEtablissement: string, numeroDossier: number, identifiantCreance: string): ng.IPromise<Modeles.Paiement.IEligibiliteModePaimt>;
        /**
        ...
        getlistePayeurCB(codeEtablissement: string, numeroDossier: number, identifiantCreance: string, idEntiteTitulaire: number, avecGaranties: boolean): ng.IPromise<Modeles.Paiement.PaiementCheque.IPayeur[]>;
        /**
         * Retourne le compte CCIE d'un établissement
         * Evol 2021 pour Mise en jeu PGE
         * @param codeEtablissement
         */
        getCompteCCIE(codeEtablissement: string): ng.IPromise<Modeles.Paiement.ICompteCCIE>;
        /**
...
declare namespace ContentieuxServices.Services.Processus {
    class ProcessusService implements IProcessusService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, dossierNumeriqueService: Services.DossierNumerique.DossierNumeriqueService, habilitationsService: ContentieuxServices.Services.Habilitations.IHabilitationsService);
        getListeProcessusPourContratMySys(habilitations: ContentieuxServices.Modeles.Habilitations.IHabilitations, dossier: Modeles.Dossier.IDossierSynthese, contrat: Modeles.Contrat.IContratTuile): Modeles.Processus.IProcessusADebrancher[];
        /**
         * Les pushs sont à faire dans l'ordre d'affichage sur le débranchement des tuiles
         * @param habilitations
         * @param dossier
         * @param contrat
         */
        ...
        private getProcessusGererEcheancierCB(dossier, contrat, clos);
        private getProcessusGererDecomptes(dossier, contrat);
        private getProcessusCreditSynchro(dossier, contrat);
        private getProcessusPGEConsulterDonnees(dossier, contrat);
        private getProcessusPGESaisieProvisionnel(dossier, contrat);
        private getProcessusPGEGarantieMiseEnJeu(dossier, contrat);
        private getProcessusPGEGarantieVisualisation(dossier, contrat);
        private getProcessusCreanceGererDetail(dossier, contrat);
        private getProcessusCreancePreparerProvision(dossier, contrat);
        private getProcessusCreanceDechoir(dossier, contrat, type);
        private getProcessusCreanceEDG(dossier, contrat);
        private isAutoriseDecheanceTerme(codeProduitService, origineCredit);
        private isAutoriseDecheanceContrat(codeProduitService);
        private isAutoriseEDG(codeProduitService, origineCredit);
...
declare namespace ContentieuxServices.Services.RechercheBDF {
    interface IRechercheBDFService {
        /**
         * Retourne la recherche Banque De France
         */
        getRechercheBDF(codeEtablissement: string, identifiantEntiteTitulaire: string): ng.IPromise<Modeles.RechercheBDF.IRechercheBDF[]>;
    }
}

declare namespace ContentieuxServices.Services.RechercheBDF {
    class RechercheBDFService implements IRechercheBDFService {
        private rechercheRestService;
        static $inject: string[];
        constructor(rechercheRestService: Contentieux.RestServices.Services.RechercheBDFService);
        /**
         * Consulte l'échéancier
         */
        getRechercheBDF(codeEtablissement: string, identifiantEntiteTitulaire: string): ng.IPromise<Modeles.RechercheBDF.IRechercheBDF[]>;
...
declare namespace ContentieuxServices.Services.Tiers {
    interface ITiersService {
        ...
        getIdentificationTiers(codeEtablissement: string, numeroPersonne: number): ng.IPromise<Modeles.Tiers.IIdentification>;
    }
}
...
declare namespace ContentieuxServices.Services.Tiers {
    class TiersService implements ITiersService {
        ...
        getDesignationPersonne(codeEtablissement: string, numeroPersonne: number): ng.IPromise<string>;
        /**
         * retourne l'identification d'un tiers
         * @param codeEtablissement
         * @param numeroPersonne
         */
        getIdentificationTiers(codeEtablissement: string, numeroPersonne: number): ng.IPromise<Modeles.Tiers.IIdentification>;
...
declare namespace ContentieuxServices.Modeles.Contrat {
    ...
    interface IContratTuile {
        ...
        isImpayeSynchro: boolean;
        topMiseEnJeuGarantiePGE: boolean;
        messageErreur: string;
        indicateurPerteIrrecouvrable: boolean;
    }
    /**
...
declare namespace ContentieuxServices.Modeles.GarantiePGE {
    type typeCalculPGE = "Versement" | "Remboursement";
    interface IGarantiePGE {
        montantEcretageProvisionnel: number;
        montantProvisionnelInitial: number;
        dateVersementProvisionnel: Date;
        dateVersementEcretage: Date;
        type: string;
        dateAffectationGarantie: Date;
        dateFinAffectationGarantie: Date;
        codeSens: typeCalculPGE;
        montantAppelFinal: number;
        dateVersementFinal: Date;
        identifiant: string;
    }
    interface IParamCalculMontant {
        codeSens: typeCalculPGE;
        identifiantCreance: string;
        montantAppelFinal: number;
...
declare namespace ContentieuxServices.Modeles.PGE {
    /**
     * Paramètres d'entrée Query String PGE
     */
    interface IInputPGE {
        numeroDossier: number;
        identifiantCreance: number;
...
declare namespace ContentieuxServices.Modeles.Habilitations {
    interface IHabilitations {
        ...
        decomptesGestion: boolean;
        decomptesConsultation: boolean;
        garantiesGestion: boolean;
        garantiesConsultation: boolean;
        provisionGestion: boolean;
        provisionConsultation: boolean;
        creanceDossierGestion: boolean;
        creanceDossierConsultation: boolean;
        accesEdg: boolean;
    }
}
...
declare namespace ContentieuxServices.Modeles.Portefeuille {
    ...
    interface IInputEDSPortefeuille {
...
declare namespace ContentieuxServices.Modeles.Processus {
    class ProcessusCreanceGererDetail implements IProcessus {
        code: string;
        libelle: string;
        valeurDepart: string;
        ...
        numeroDossier: string;
        identifiantCreance: string;
        constructor(numeroDossier: string, identifiantCreance: string);
    }
    class ProcessusCreancePreparerProvision implements IProcessus {
        code: string;
        libelle: string;
        valeurDepart: string;
        initData: MyWay.Services.Lisa.IInitialisationData;
    ...
    class ProcessusCreanceDechoir implements IProcessus {
        code: string;
        libelle: string;
        valeurDepart: string;
        initData: MyWay.Services.Lisa.IInitialisationData;
        ...
        identifiantCreance: string;
        typeContrat: string;
        constructor(numeroDossier: string, identifiantCreance: string, typeContrat: string);
    }
    class ProcessusCreanceEDG implements IProcessus {
        code: string;
        libelle: string;
        valeurDepart: string;
        initData: MyWay.Services.Lisa.IInitialisationData;
...
declare namespace ContentieuxServices.Modeles.Processus {
    class ProcessusGererDecomptes implements IProcessus {
        code: string;
        libelle: string;
        valeurDepart: string;
        initData: MyWay.Services.Lisa.IInitialisationData;
...
declare namespace ContentieuxServices.Modeles.Processus {
    class ProcessusGererEcheancier implements IProcessus {
        ...
        private createProcessusVisualisationCB(identifiantEntiteTitulaire, numeroDossier, identifiantCreance, clos, typeEcheancier);
    }
}

declare namespace ContentieuxServices.Modeles.Processus {
    class ProcessusPGEConsulterDonnees implements IProcessus {
        code: string;
        libelle: string;
        valeurDepart: string;
        initData: MyWay.Services.Lisa.IInitialisationData;
    ...
    class ProcessusPGESaisieProvisionnel implements IProcessus {
        code: string;
        libelle: string;
        valeurDepart: string;
        initData: MyWay.Services.Lisa.IInitialisationData;
    ...
    class ProcessusPGEGarantie implements IProcessus {
        code: string;
        libelle: string;
        valeurDepart: string;
        initData: MyWay.Services.Lisa.IInitialisationData;
        ...
        numeroDossier: string;
        identifiantCreance: string;
        constructor(identifiantEntiteTitulaire: string, numeroDossier: string, identifiantCreance: string, identifiantCredit: string);
    }
    class ProcessusPGEGarantieVisualisation implements IProcessus {
        code: string;
        libelle: string;
        valeurDepart: string;
        initData: MyWay.Services.Lisa.IInitialisationData;
...
declare namespace ContentieuxServices.Modeles.Processus {
    class ProcessusSuivreGarantiesCreance implements IProcessus {
        code: string;
        libelle: string;
        valeurDepart: string;
        initData: MyWay.Services.Lisa.IInitialisationData;
    ...
    class ProcessusGererGarantiesCreance implements IProcessus {
        code: string;
        libelle: string;
        valeurDepart: string;
        initData: MyWay.Services.Lisa.IInitialisationData;
        ...
        constructor(numeroDossier: string, identifiantCreance: string, identifiantGarantie: string);
    }
}
...
declare namespace ContentieuxServices.Modeles.RechercheBDF {
    interface IRechercheBDF {
        /**
...
declare namespace ContentieuxServices.Modeles.Tiers {
...
declare namespace ContentieuxServices.Services.Paiement.PaiementPrelevement {
    interface IPaiementPrelevementService {
        ...
        effectuerPaiementParPrelevementPGE(input: Modeles.Paiement.PaiementPrelevement.IPrelevement): ng.IPromise<any>;
    }
    class PaiementPrelevement implements IPaiementPrelevementService {
        ...
        /**
         * Specifique appel pour PGE, Mise à jour BCG
         * M17QBQ00.MQS97Q
         * Sans mise en jeu de la garantie
         * @param input
         */
        effectuerPaiementParPrelevementPGE(input: Modeles.Paiement.PaiementPrelevement.IPrelevement): ng.IPromise<any>;
    }
