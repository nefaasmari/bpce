...
declare namespace ContentieuxParametrage.Constantes {
    ...
    namespace ContentieuxMetier {
        ...
        const etiquettePerteIrrecouvrable: string;
        ...
        const echeancierCBCaduc: string;
        const echeancierCBSupprime: string;
        const echeancierCBTermine: string;
...
declare namespace ContentieuxParametrage.Constantes.Processus {
    ...
    namespace processusGererEcheancier {
        ...
        const libelleVisualisationCBCLos: string;
        ...
        const modeVisualisationCBClos: string;
    }
    ...
    namespace processusBDF {
        const code: string;
        const libelleRecevabilite: string;
        const libelleActionRecevabilite: string;
        const valeurDepartRecevabilite: string;
        const libellePlan: string;
        const libelleActionPlan: string;
        const valeurDepartPlan: string;
    }
    namespace processusDossier {
        const code: string;
        const libelleModifier: string;
        const libelleActionModifier: string;
        const valeurDepartModifier: string;
        const libelleConsulter: string;
        const libelleActionConsulter: string;
        const valeurDepartConsulterr: string;
        const libellePrioriser: string;
        const libelleActionPrioriser: string;
        const valeurDepartPrioriser: string;
        const libelleConsulterPrioriser: string;
        const libelleActionConsulterPrioriser: string;
        const valeurDepartConsulterPrioriser: string;
        const libelleExporterDecomptes: string;
        const libelleActionExporterDecomptes: string;
        const valeurDepartExporterDecomptes: string;
    }
}
