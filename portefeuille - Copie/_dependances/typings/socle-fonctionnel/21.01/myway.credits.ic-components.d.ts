...
declare namespace ICCreditComponents.Services {
    interface IAnomalieService {
         ...
         */
        afficherModaleAnomalieControleAvecGestionForcage(codeEtablissement: string, anomalies: ICBusiness.Models.Edition.IAnomaliesControleEdition, idElementStructureInstruction: string, numeroInterneEdsAgent: string, titreModaleAnomalie: string): ng.IPromise<boolean>;
    }
...
declare namespace ICCreditComponents.Services {
    ...
    class EditionOffreService implements IEditionOffreService {
         ...
         * @param numeroInterneEdsAgent
         */
        private traiterControleAvantEditionOffre(donneesDossier, codeEtablissement, numeroInterneEdsAgent);
        /**
...
declare namespace ICCreditComponents.Services {
    interface ISaccefService {
        ...
        verifierEtatCEGC(dateTraitement: string, codeEtab: string, idDossier: string, avecInterval: boolean, navigationService: Navigation.INavigationCreditService): ng.IPromise<boolean>;
    }
    class SaccefService implements ISaccefService {
         ...
         * Retourne true si le traitement s'est effectué correctement pour indiquer si la redirection a été faite
         * @param idDossier
         * @param navigationService
         */
...
declare namespace ICCreditComponents.Services {
    ...
    class TransfertConformiteService implements ITransfertConformiteService {
         ...
         * @param dateTraitement date de traitement
         */
        transfertConformite(codeEtab: string, idDossier: string, idElementStructureInstruction: string, numeroInterneEds: string): ng.IPromise<boolean>;
    }
}
...
declare namespace ICCreditComponents.Services {
    interface IFooterCreditService {
        ...
        editerOffreIndusEnabled(delegate: () => boolean): void;
    ...
    class FooterCreditService implements IFooterCreditService {
        ...
        private _editerOffreIndusEnabled;
...
declare namespace ICCreditComponents.Navigation {
    class TotemChapitreActionsComplementaires {
        ...
        private labelService;
        private suiviEditionsService;
        constructor(context: ICBusiness.Models.Common.IContext, etatDossierService: ICBusiness.Services.Dossier.IEtatDossierService, paramApplicatifRemanentService: ICBusiness.Services.ParametrageApplicatif.IParametrageAppicatifRemanentService, controleSyntheseService: Controle.IControleSyntheseService, navigationService: INavigationCreditService, labelService: Services.IlabelService, suiviEditionsService: ICBusiness.Services.SuiviEditions.ISuiviEditionsService);
