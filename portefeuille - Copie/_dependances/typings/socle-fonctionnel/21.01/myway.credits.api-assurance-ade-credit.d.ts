...
declare namespace AssuranceAdeCredit {
    class AssuranceAdeControleur {
        ...
        continue(): void;
        deleteFromSyntheseCredit(id: string, isCredit: boolean, idPersonne?: string): void;
        deleteFromSynthPersonne(id: string, isPersonne: boolean, idCredit?: string): void;
        ...
        actualiser(isSubmit?: boolean): any;
...
declare namespace AssuranceAdeCredit.Services.FormSettings {
    ...
    interface IAdeFormSettingsService {
        getSettings(isConsultation: boolean, isCreation: boolean, assurance: Modeles.IAssuranceForm, viewModel: Modeles.IViewModel, listCollectivite: Modeles.ICodeLabel<string>[]): IAdeFormSettings;
    }
