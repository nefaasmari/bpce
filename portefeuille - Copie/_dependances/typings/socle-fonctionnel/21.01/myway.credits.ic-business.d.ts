...
declare namespace ICBusiness.Constantes {
    namespace RisqueEpargne {
        const rubriqueFiltreHorsCE: string;
        const valeurFiltreHorsCE: string;
        const valeurFiltreCE: string;
    }
}
...
declare namespace ICBusiness.ModelsTransformers {
    class Anomalie {
         ...
         * @param anomalie
         */
        static mapAnomalie(anomalie: ICRest.Modeles.LireElement.IAnomalieLecture | ICRest.Modeles.DefinirBlocNotes.IAnomalieLecture | ICRest.Modeles.CalculerFraisNotaire.IAnomalieLecture): ICBusiness.Models.Common.IAnomalieLecture;
        /**
...
declare namespace ICBusiness.ModelsTransformers {
    ...
    class DonneesComplementaires {
        ...
        static mapDonneesComplementaires(saisiesComplementaires: RestModel.ISaisiesComplementaireLecture, idTheoriqueDocument: string, isFirstEdition: boolean, traiterNotices: boolean): Models.Edition.IDonneeComplementaire[];
         ...
         */
        static mapElementSaisiesComplementairesMaj(identifiantDossier: string, donneesComplementaires: Models.Edition.IDonneeComplementaire[]): ICRest.Modeles.MajElement.ISaisiesComplementaireMaj;
        /**
         * Méthode pour créer les données listes d'éléments de mise à jour des données complémentaires
         * @param identifiantDossier identifiant du dossier en instruction
         * @param donneesComplementaires données complémentaires à traiter
         */
        static mapListeSaisiesComplementairesMaj(identifiantDossier: string, donneesComplementaires: Models.Edition.IDonneeComplementaire[]): ICRest.Modeles.MajElement.ISaisiesComplementaireMaj;
...
declare namespace ICBusiness.ModelsTransformers {
    ...
    class Credit {
        ...
        static majCredit(credit: Models.Financement.ICreditInterne, codeDeviseDossier: string): ICRest.Modeles.MajElement.ICreditInterneMaj;
...
declare namespace ICBusiness.ModelsTransformers {
    ...
    import RestModel = ICRest.Modeles;
    class Synthese {
        static mapSyntheseFinancement(syntheseComplet: RestModel.SchemaComplet.ISynthesePlanFinancementComplet): Models.Financement.ISyntheseFinancement;
        ...
        private static mapSyntheseFinanciere(synthese);
    }
}
...
declare namespace ICBusiness.ModelsTransformers {
    ...
    class Projet {
         ...
         * @param projet
         */
        private static mapUniqueProjetImmo(projet);
        /**
         * Map les données d'affichage des controles
         * @param projet
         */
...
declare namespace ICBusiness.ModelsTransformers {
     ...
     */
    class SuiviEditions {
        static mapSuiviEditions(suiviEditionsComplet: RestModel.SchemaComplet.ISuiviEditionComplet, isEditionDocument: boolean): Models.SuiviEditions.ISuiviDocument[];
...
declare namespace ICBusiness.Services.Catalogue {
    interface ICatalogueService {
         ...
         * @param horsCE
         */
        getListeRisqueEpargne(dateDeTraitement: string, codeEtablissement: number, horsCE: boolean): ng.IPromise<Models.Common.ICodeLabel<string>[]>;
        /**
...
declare namespace ICBusiness.Services.Decision {
    ...
    class DecisionService implements IDecisionService {
        ...
        private avisService;
        static $inject: string[];
        constructor($q: ng.IQService, schemaService: Services.Common.IElementSchemaService, dossierService: ICRest.Services.Dossier.DossierService, decisionService: ICRest.Services.Dossier.DecisionService, avisService: Services.Avis.IAvisService);
        /**
...
declare namespace ICBusiness.Services.Dossier {
    ...
    type FiltreListerConstante = "FiltrePrimoPTZ" | "FiltreStatutOccupationLogement" | "FiltreUsageDuBien" | "FiltreModeOccupation" | "FiltreCadreFiscal" | "FiltrePerformanceEnergetique" | "FiltreCategorieEmprunteur" | "FiltreStatutOccupationPersonne" | "FiltreLienAvecEmprunteur" | "FiltreNatureTravaux" | "FiltreCodeExistenceRC";
...
declare namespace ICBusiness.Services.Edition {
    ...
    class ContexteEditionService implements IContexteEditionService {
        ...
        private mapContexteEditionDemandeCredit(contexteSignatureElectronique, dossierLecture);
        private mapContexteEditionOffre(contexteSignatureElectronique, contexteEditionIndustrialisee, dossierLecture);
        /**
         ...
         */
        private mapContexteEditionAnnexePTZ(contexteAnnexe, dossierLecture);
...
declare namespace ICBusiness.Services.Edition {
    interface IEditionOffreService {
         ...
         */
        autorisationForcageEditionOffre(codeEtablissement: string, anomaliesBloquantes: ICBusiness.Models.Common.IAnomalieLecture[], habilitationsAgent: ICBusiness.Models.Habilitation.IHabilitation): ng.IPromise<boolean>;
        /**
...
declare namespace ICBusiness.Services.SaisiesComplementaires {
    interface ISaisiesComplementairesService {
         ...
         */
        getSaisiesComplementaires(idDossier: string, idTheoriqueDocument: string, isFirstEdition: boolean, traiterNotices: boolean): ng.IPromise<Models.Edition.IDonneeComplementaire[]>;
        /**
         ...
         */
        mettreAJourElementSaisiesComplementaires(identifiantDossier: string, donneesComplementaires: Models.Edition.IDonneeComplementaire[]): ng.IPromise<void>;
        /**
...
declare namespace ICBusiness.Services.Financement {
    interface ICreditComplementaireService {
        ...
        /**
         * Permet de calculer le montant catalogue du crédit complémentaire
         * @param identifiantDossier
         * @param idProjet
         * @param idsCreditInterne
         * @param idsGarantie
         */
        getMontantCatalogue(identifiantDossier: string, idProjet: string, idsCreditInterne: string[], idsGarantie: string[]): ng.IPromise<number>;
        /**
    ...
    class CreditComplementaireService implements ICreditComplementaireService {
        ...
        private $q;
        static $inject: string[];
        constructor(creditService: ICRest.CreditService.Services.ICreditService, elementService: ICRest.Services.Element.IElementService, dossierCreditService: ICRest.Services.Dossier.ICreditService, clientService: ICRest.Services.Dossier.IClientService, $q: ng.IQService);
        getCreditComplementaire(identifiantDossier: string, creditComplementaire: Models.Financement.ICreditComplementaire, produitFinancier: Models.Financement.IProduitFinancier, codeDevise: string): ng.IPromise<Models.Financement.ICreditComplementaireDetail>;
        /**
         * Créé un objet creditComplementaire pour la création
         * @param produitFinancier
        ...
        getNewCreditComplementaire(produitFinancier: Models.Financement.IProduitFinancier, codeDevise: string, montantCatalogue: number): Models.Financement.ICreditComplementaireDetail;
        /**
         * TODO: Voir si la donnée peut être récupéré du socle dans le planFInancementComplet
         * Permet de calculer le montant catalogue du crédit complémentaire
         * @param identifiantDossier
         * @param idProjet
         * @param idsCreditInterne
...
declare namespace ICBusiness.Services.Financement {
    interface ICreditService {
         ...
         */
        majCreditInterne(idDossier: string, credit: Models.Financement.ICreditInterne, codeDeviseDossier: string): ng.IPromise<void>;
        /**
...
declare namespace ICBusiness.Services.Financement {
    interface IPlanFinancementService {
        ...
        getSyntheseFinancement(idDossier: string, idSyntheses: string[]): ng.IPromise<Models.Financement.ISyntheseFinancement[]>;
...
declare namespace ICBusiness.Services.InterroBdf {
    ...
    class InterroBdfService implements IInterroBdfService {
         ...
         * @param codeApplication
         */
        private ficpInterditRules(personne, loi, isPersonneMoraleEmprunteur, typeMarche, categorieEmprunteur, natureProjetPro, codeApplication);
        /**
...
declare namespace ICBusiness.Services.Projet {
    interface IObjetFinanceService {
         ...
         * @param famille
         */
        getlistTypeObjetCommercialisationBienSousJacent(dateInstruction: string, typeObjetFinancier: string, famille?: ICBusiness.Enum.NatureProjetEnum): ng.IPromise<Models.Common.ICodeLabel<string>[]>;
        /**
...
declare namespace ICBusiness.Services.Projet {
    interface IProjetImmoService {
        ...
        updateProjetImmo(idDossier: string, initialProjet: Models.ProjetImmo.IProjetImmo, projet: Models.ProjetImmo.IProjetImmo, updateProjet: boolean, updateBienFinance: boolean): ng.IPromise<void>;
...
declare namespace ICBusiness.Services.SuiviEditions {
    ...
    interface ISuiviEditionsService {
         ...
         */
        getSuiviEditions(idDossier: string, isEdition: boolean): ng.IPromise<Models.SuiviEditions.ISuiviDocument[]>;
        /**
