...
declare module LibrairieAffairesCreBdr.Services.Application {
    interface IAffairesService {
        ...
        identiteRelationEcoMenage: number;
        libelleIntituleRelation: string;
        clientProspectListe: Array<LibrairieAffairesCreBdr.Modeles.Application.IClientProspect>;
        affaireExisteDeja(affaire: LibrairieAffairesCreBdr.Modeles.Application.IAffaire): boolean;
        setCreExistant(): void;
    }
}
