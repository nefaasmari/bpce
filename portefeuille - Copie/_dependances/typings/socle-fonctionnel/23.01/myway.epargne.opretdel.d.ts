...
declare module operationRetraitDepot.Services {
    ...
    interface ITypeOperationDiverse extends MyWay.Model.TypeOperationDiverse {
        /**
         * Valeur TVA
         */
        TXERVA: string;
    }
    interface IFamilleOperationDiverse extends MyWay.Model.FamilleOperationDiverse {
        COMJTC: string;
        MTJOHT: string;
        MTJOTV: string;
    }
