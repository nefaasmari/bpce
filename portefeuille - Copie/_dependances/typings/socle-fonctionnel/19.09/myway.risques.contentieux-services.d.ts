...
declare namespace ContentieuxServices.Services.Echeancier {
    class EcheancierService implements IEcheancierService {
        ...
        private $q;
        static $inject: string[];
        constructor(echeancierRestService: Contentieux.RestServices.Services.EcheancierService, cacheService: Services.Commun.ICacheService, riceService: myway.comInterdomaine.SaisieRiceService, $q: ng.IQService);
        /**
         ...
         */
        getListeEcheanciers(codeEtablissement: string, numeroDossier: number, identifianCreance: string, codeProduitService: string, typeEcheancier: Modeles.Echeancier.Type): ng.IPromise<[ContentieuxServices.Modeles.Echeancier.IEcheancier[], ContentieuxServices.Modeles.Echeancier.IEcheancier[]]>;
        /**
        ...
        private mappeEcheancier(restEcheancier, inputEcheancier?);
        private mappeStatut(codeEtatPlanApurement);
        private mappePanel(echeancier);
...
declare namespace ContentieuxServices.Services.PointBudget {
    class PointBudgetService implements IPointBudgetService {
        ...
        getPointBudget(codeEtablissement: string, numeroDossier: number, identifiantCreance: string, codeProduitService: string, typeEcheancier: string, numeroHistoAccord: number): ContentieuxServices.Modeles.PointBudget.PointBudget;
    }
}
...
declare namespace ContentieuxServices.Services.Processus {
    class ProcessusService implements IProcessusService {
        ...
        private isAutoriseNonDechuPlanReglement(codeProduitService);
