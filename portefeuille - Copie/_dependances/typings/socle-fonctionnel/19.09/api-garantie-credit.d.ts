...
declare module GarantieCredit.Constantes {
    ...
    module codeStatutJustificatif {
        const RECU: string;
        const CLOS: string;
    }
    module CodeNatureGarantie {
        /** Gage sur véhicule automobile '02' */
        const gageVehicule: string;
        /** Hypothèque sur aéronef '04' */
        const hypothequeAeronef: string;
        /** Hypothèque fluviale '05' */
        const hypothequeFluviale: string;
        /** Hypothèque maritime '07'  */
        const hypothequeMaritime: string;
    }
    module EstimationObjetPorterEnGarantie {
        module Type {
            const VALEUR_VENALE: string;
        }
    }
}
...
declare module GarantieCredit.Modele {
    ...
    interface IGarantiePourListe extends DTO.IGarantieCredit {
        ...
        libelleEmprunteur?: string;
        checked?: boolean;
        hypotheque?: DTO.IGarantieHypotheque;
    }
    ...
    interface IObjetPorteGarantieWrapper {
        identifiantDossier?: string;
        /**
         * Id technique instruction crédit
         */
        idws?: string;
...
declare module GarantieCredit.Service {
    class GarantieService {
        ...
        garantieSelectionnee: Modele.IGarantiePourListe;
        private garantieCreditRestService;
        private objetPorteGarantieRestService;
        private conventionRestService;
        constructor($q: ng.IQService, creditService: CreditService, serviceLocatorRouteur: Service.ServiceLocator.ServiceRouteur, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $filter: ng.IFilterService);
        /**
        ...
        getMontantCompta(codeEtablissement: number, identifiantCredit: string, identifiantGarantie: string, identifiantObjet: string): ng.IPromise<DTO.IMontantComptaGlobal>;
        /**
        ...
        ImprimerGaranties(garanties: Modele.IGarantiePourListe[]): void;
    }
}
...
declare module GarantieCredit.Modele {
    interface ISelectionGarantieHandler {
        onSelectionGarantie: (garantie: Modele.IGarantiePourListe) => any;
    }
...
declare module GestionCredit.Editique.Garanties {
    const codeEtablissementEditique: number;
    const idntAttrbEditique: number;
    function createArchiverParams(): GarantiesArchiverParams;
    function createGenererParams(): GarantiesGenererParams;
    function createArchiverGenererParams(): GarantiesArchiverGenererParams;
    function createImpressionParams(): GarantiesImpressionParams;
    function createArchiverImpressionParams(): GarantiesArchiverImpressionParams;
    function createImpressionLotParams(): GarantiesImpressionLotParams;
}

declare module GestionCredit.Editique.Garanties {
    interface Igaranties {
        garantie: GestionCredit.Editique.Garanties.IgarantiesGarantie[];
        entete: GestionCredit.Editique.Garanties.IgarantiesEntete;
        dateImpression: string;
        heureImpression: string;
        attributeId: string;
        attributeXmlns: string;
        attributeCamel: string;
    }
    interface IgarantiesGarantie {
        lgSansConvention: GestionCredit.Editique.Garanties.IgarantiesGarantieLgSansConvention;
        lgAvecConvention: GestionCredit.Editique.Garanties.IgarantiesGarantieLgAvecConvention;
        numGarantie: string;
        garant: string;
        numPersonne: string;
        montantGarantie: string;
        montantAffecte: string;
        lgMontantFrais: GestionCredit.Editique.Garanties.IgarantiesGarantieLgMontantFrais[];
        debutValidite: string;
        finValidite: string;
        dureeValidite: string;
        formeActe: string;
        pourcentageCreditCouvert: string;
        commentaire: string;
        numExtGarantie: string;
        idGarantieOrigine: string;
        dateDernierArrete: string;
        dernierMontantCompta: string;
        lgRedacteurActe: GestionCredit.Editique.Garanties.IgarantiesGarantieLgRedacteurActe[];
        lgSuretesPersonnelles: GestionCredit.Editique.Garanties.IgarantiesGarantieLgSuretesPersonnelles[];
        lgRangsHypo: GestionCredit.Editique.Garanties.IgarantiesGarantieLgRangsHypo[];
        lgMontantPacteHypo: GestionCredit.Editique.Garanties.IgarantiesGarantieLgMontantPacteHypo[];
        lgMontantsHypo: GestionCredit.Editique.Garanties.IgarantiesGarantieLgMontantsHypo[];
        lgRechargeabiliteHypo: GestionCredit.Editique.Garanties.IgarantiesGarantieLgRechargeabiliteHypo[];
    }
    interface IgarantiesGarantieLgSansConvention {
        natureGarantie: string;
    }
    interface IgarantiesGarantieLgAvecConvention {
        natureGarantie: string;
        convention: string;
    }
    interface IgarantiesGarantieLgMontantFrais {
        montantFrais: string;
    }
    interface IgarantiesGarantieLgRedacteurActe {
        redacteurActe: string;
    }
    interface IgarantiesGarantieLgSuretesPersonnelles {
        typeCautionnement: string;
        dureeEngagement: string;
    }
    interface IgarantiesGarantieLgRangsHypo {
        rangHypothque: string;
        rangSecondaireHypo: string;
    }
    interface IgarantiesGarantieLgMontantPacteHypo {
        montantHypoRangAnt: string;
        pacteCommissoire: string;
    }
    interface IgarantiesGarantieLgMontantsHypo {
        montantDisponible: string;
        montantUtilise: string;
    }
    interface IgarantiesGarantieLgRechargeabiliteHypo {
        rechargeabilite: string;
    }
    interface IgarantiesEntete {
        numEtablissement: string;
        numCredit: string;
        numEmprunteur: string;
        intituleEmprunteur: string;
    }
    class Garanties implements Igaranties {
        garantie: GestionCredit.Editique.Garanties.IgarantiesGarantie[];
        entete: GestionCredit.Editique.Garanties.IgarantiesEntete;
        dateImpression: string;
        heureImpression: string;
    ...
    class GarantiesGenererParams {
        systeme: MyWay.Services.Impression.ParametresGenerationSysteme;
        obligatoires: MyWay.Services.Impression.ParametresGenerationObligatoires;
        optionnels: MyWay.Services.Impression.ParametresGenerationOptionnels;
        constructor();
    }
    class GarantiesArchiverGenererParams {
        systeme: MyWay.Services.Impression.ParametresGenerationSysteme;
        obligatoires: MyWay.Services.Impression.ParametresGenerationObligatoires;
        optionnels: MyWay.Services.Impression.ParametresGenerationOptionnels;
        constructor();
    }
    class GarantiesImpressionParams {
        systeme: MyWay.Services.Impression.ParametresGenerationSysteme;
    ...
    class GarantiesArchiverImpressionParams {
        systeme: MyWay.Services.Impression.ParametresGenerationSysteme;
        obligatoires: MyWay.Services.Impression.ParametresGenerationImpressionObligatoires;
        optionnels: MyWay.Services.Impression.ParametresGenerationImpressionOptionnels;
        constructor();
    }
    class GarantiesImpressionLotParams {
...
declare module GarantieCredit {
    class CreationVersementAttenduTraitement extends Service.Traitement.Traitement {
        versementAttenduRestService: Service.Rest.VersementAttenduRestService;
        objetPorteGarantieWrapper: Modele.IObjetPorteGarantieWrapper;
        versementAttenduCreation: DTO.VersementAttendu.IMajVersementAttendu;
        private majVerementAttenduGlobal;
        constructor(versementAttenduRestService: Service.Rest.VersementAttenduRestService, objetPorteGarantieWrapper: Modele.IObjetPorteGarantieWrapper, versementAttenduCreation: DTO.VersementAttendu.IMajVersementAttendu);
        messageImpossible: string;
        titreConfirmation: string;
        preparerDonnees(): void;
        appelerQrInitiale(): ng.IPromise<any>;
...
declare module GarantieCredit {
    class SuppressionVersementAttenduTraitement extends Service.Traitement.Traitement {
        versementAttenduRestService: Service.Rest.VersementAttenduRestService;
        objetPorteGarantieWrapper: Modele.IObjetPorteGarantieWrapper;
        majVersementAttenduASupprimer: DTO.VersementAttendu.IMajVersementAttendu;
        private majVerementAttenduGlobal;
        constructor(versementAttenduRestService: Service.Rest.VersementAttenduRestService, objetPorteGarantieWrapper: Modele.IObjetPorteGarantieWrapper, majVersementAttenduASupprimer: DTO.VersementAttendu.IMajVersementAttendu);
        messageImpossible: string;
        titreConfirmation: string;
        preparerDonnees(): void;
        appelerQrInitiale(): ng.IPromise<any>;
...
declare module GarantieCredit.DTO {
    interface IDonneeHypothequeGenerale {
        identifiantCredit: string;
        codeEtablissement: number;
        codeDevise: string;
        compteurMiseAJour: number;
        ...
        libelleTiers: string;
        codeBlocageActeGestion: string;
        listeDonneeHypotheque: Array<IDonneeHypotheque>;
        retourQR: Array<IRetourQR>;
    }
    interface IDonneeHypotheque {
        identifiantGarantie: string;
        codeNatureGarantie: string;
        libelleNatureGarantie: string;
        codeHypothequeRechargeable: string;
        montantGarantie: number;
        numeroSecondRang: number;
        codeCessionRang: string;
        rangHypotheque: number;
...
declare module GarantieCredit.Service.Rest {
    class DonneeHypothequeRestService implements ServiceLocator.Interfaces.IDonneeHypothequeRest {
        private serviceAgent;
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgentExtended);
        getDonneeHypotheque(codeEtablissement: number, identifiantCredit: string): ng.IPromise<DTO.IDonneeHypothequeGenerale>;
    }
}
...
declare module GarantieCredit.DTO {
    interface IGarantieCredit {
        ...
        indicConventionFondsGaranti: string;
        codeNatureGarantie: string;
        indicImpactAssietteCommissi: string;
    }
...
declare module GarantieCredit.Service.Rest {
    class GarantieCreditRestService implements ServiceLocator.Interfaces.IGarantieCreditRest {
        ...
        sendRequestGetMontantCompta(codeEtablissement: number, identifiantCredit: string, identifiantGarantie: string, identifiantObjet: string): ng.IPromise<DTO.IMontantComptaGlobal>;
        /**
...
declare module GarantieCredit.Service.Rest {
    class ParametreRestService implements ServiceLocator.Interfaces.IParametreRest {
         ...
         * @returns
         */
        private getTypologies(codeEtablissement, numeroCredit, typeTypologie?);
...
declare module GarantieCredit.Service.ServiceLocator.Interfaces {
    interface IDonneeHypothequeRest {
        getDonneeHypotheque(codeEtablissement: number, identifiantCredit: string): ng.IPromise<DTO.IDonneeHypothequeGenerale>;
    }
}
...
declare module GarantieCredit.Estimation {
    interface ISettings {
        /**
         * Le bloc estimation vénale est requis (oui par défaut)
         */
        blocEstimationVenale: boolean;
        /**
         * Le bloc estimation prudentielle est requis (non par défaut)
         */
        blocEstimationPrudentielle: boolean;
        /**
         * Indicateur de valorisation d'un montant à 0. Si true, les montants à 0 sont considérés comme une valeur saisie.
         */
        montantZeroValorise: boolean;
    }
}
