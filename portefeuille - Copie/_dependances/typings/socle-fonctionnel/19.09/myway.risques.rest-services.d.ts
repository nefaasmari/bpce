...
declare namespace Contentieux.RestServices.Services {
    interface IAlerteService {
        ...
        putAlerte(codeEtablissement: string, codeTypeEvenement: string, codeSousTypeEvenement: string, numeroEvenementSousType: number): ng.IPromise<any>;
    }
...
declare namespace Contentieux.RestServices.Services {
    interface ICreanceService {
        ...
        postGarantie(topCreationLienHistoFiGarantie: string, garantie: Modeles.IGarantie): ng.IPromise<any>;
...
declare namespace Contentieux.RestServices.Services {
    interface IEcheancierService {
        ...
        getEcheancier(codeEtablissement: string, numeroDossier: number, identifianCreance: string, codeProduitService: string, typeEcheancier: string, numeroHistoAccord: number): ng.IPromise<Modeles.IEcheancier[]>;
    }
    class EcheancierService implements IEcheancierService {
        ...
        getEcheancier(codeEtablissement: string, numeroDossier: number, identifiantCreance: string, codeProduitService: string, typeEcheancier: string, numeroHistoAccord: number): ng.IPromise<Modeles.IEcheancier[]>;
    }
}
