...
declare module Avenants.Commun.Enum {
    enum TypeAvenant {
        ...
        Quantieme = 2,
        ReportFinPret = 3,
        AmenagementTemporaireEcheances = 4,
        Inconnu = 5,
    }
    /**
...
declare module Avenants.Commun.Services {
    class FichierService {
         ...
         */
        convertirBase64Pdf(fluxDonnees: string, nomDocument: string, identifiantDossier: string): MyWay.Services.IPromesse<boolean>;
    }
}
...
declare module Avenants.Commun.ToolsFunctionals {
    ...
    class ParamsLisa {
         ...
         */
        static getParamsTypeAvenant(liste: Array<Enum.TypeAvenant>): string;
        /**
         * Les éléments sont concaténés dans une chaine avec un séparateur
         * @param listeTypeByParamUrl
         */
        static getListeTypeAvenant(listeTypeByParamUrl: string): Array<Enum.TypeAvenant>;
        /**
