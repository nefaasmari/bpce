...
declare namespace ContentieuxDirectives.Services.PointBudget {
    interface IPointBudgetService {
        ouvrirModalePointBudget(isModeLecture: boolean): ng.IPromise<any>;
    }
    class PointBudgetService implements IPointBudgetService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, modalService: MyWay.UI.IModalService);
        ouvrirModalePointBudget(isModeLecture: boolean): ng.IPromise<boolean>;
    }
}
...
declare namespace ContentieuxDirectives {
    class PointBudgetModalControleur {
        ...
        static parametres: ContentieuxCommun.Controleur.IControleurParametre;
        static $inject: Array<string>;
        constructor($modalInstance: angular.ui.bootstrap.IModalServiceInstance, isModeLecture: boolean, pointBudgetService: ContentieuxServices.Services.PointBudget.PointBudgetService);
        /**
         * Initialise le point budget
         * @param pointBudget
         * @param isModeLecture
         */
        initPointBudget(isModeLecture: boolean): ContentieuxServices.Modeles.PointBudget.PointBudget;
        /**
         * Somme les revenus
         * @param autresRevenus
