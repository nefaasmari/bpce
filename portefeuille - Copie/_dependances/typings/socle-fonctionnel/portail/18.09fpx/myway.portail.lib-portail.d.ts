...
declare module myway.portail.api {
    class ApplicationService {
         ...
         */
        getApplications(applicationParams?: ressources.portailmyway.rechercheapplication.IGetQueryParams): ng.IPromise<Application[]>;
...
declare module myway.portail.api.favori {
    class MigrationFavoriService {
        ...
        start(context: api.application.Context): ng.IPromise<void>;
        /**
...
declare module myway.portail.api.lien {
    interface ILien extends preference.IObjectStatut {
        /**
         * Identifiant
         */
        id: string;
...
declare module myway.portail.api.modele {
     ...
     */
    abstract class ItemList<T extends preference.IObjectStatut, U> {
        items: T[];
        private backupItems;
        constructor(items: T[]);
        addAll(items: T[]): void;
...
declare module myway.portail.api.preference {
     ...
     */
    abstract class PreferenceInstance<T extends preference.IObjectStatut, U extends modele.ItemList<T, W>, V, W> {
        protected $q: ng.IQService;
...
declare module myway.portail.api.ui {
    ...
    interface IApplicationsFavorisStartApplicationLocals {
        application: Application;
    }
    interface IApplicationsFavorisStartLienLocals {
        lien: lien.ILien;
    }
}
...
declare module myway.portail.api.ui {
    class ApplicationsLiensControleur {
        ...
        applicationsFiltrees: Application[];
...
declare module myway.portail.api.favori {
    interface ICategoriePerso extends preference.IObjectStatut {
        id: string;
        titre: string;
        position: number;
    }
...
declare module myway.portail.api.favori {
    ...
    interface IFavori extends preference.IObjectStatut {
        /**
         * Identifiant
         */
        id: string;
...
declare module myway.portail.api.favori {
    ...
    class CategoriePersoList extends modele.ItemList<ICategoriePerso, string> {
        ...
        getItemId(item: ICategoriePerso): string;
