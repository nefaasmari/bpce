...
declare namespace myway.portail.api.Media {
    class MediaControleur {
        ...
        mails: Modeles.Mail[];
        static $inject: string[];
        constructor(telephoneService: TelephoneService, mwNotificationService: MyWay.UI.IMwNotificationService, $modalInstance: ng.ui.bootstrap.IModalServiceInstance, medias: Modeles.Media[], identifiantPersonne: number, libellePersonne: string, adresse: Modeles.IAdresse);
        composerAppel(telephone: Modeles.Telephone): void;
        closeModale(): void;
    }
}
...
declare namespace myway.portail.api.Media {
    class MediaService {
        ...
        private agentService;
        static $inject: string[];
        constructor(modalService: MyWay.UI.IModalService, personneRestService: IPersonneService, agentService: myway.core.AgentService);
...
declare namespace myway.portail.api.Media {
    class TelephoneService {
        ...
        private $http;
        static $inject: string[];
        constructor($q: ng.IQService, agentService: myway.core.AgentService, boiteOutilService: IBoiteOutilService, $http: ng.IHttpService);
        ...
        protected getUrlTelephonie(): ng.IPromise<Modeles.IUrl>;
    }
}
