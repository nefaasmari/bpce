...
declare module myway.portail.api {
    class ApplicationService {
        ...
        private applicationsPromise;
        static $inject: string[];
        constructor($q: ng.IQService, agentService: core.AgentService, mobiliteService: core.MobiliteService, logger: core.LoggerService, habilitationService: HabilitationService, favoriPersoService: favori.FavoriPersoService, modalService: MyWay.UI.IModalService);
        ...
        /**
         * Renvoie une liste d'applications enrichies et filtre la liste à partir des habilitations.
         */
        private buildDTOApplications(apps, codeEtablissement);
    }
}
...
declare module myway.portail.api {
    ...
    class SelectionEntiteTitulaireControleur implements MyWay.UI.ISelectionChangeHandler {
        ...
        tableauSelectionEntiteTitulaire: TableauEntiteTitulaire;
        traitementEnCours: boolean;
        /** Initialisation */
        constructor($scope: ng.IScope, data: any, $modalInstance: ng.ui.bootstrap.IModalServiceInstance, agentService: core.AgentService, $q: ng.IQService);
...
declare module myway.portail.api {
    class CultureNetService {
        ...
        private logger;
        static $inject: string[];
        constructor($q: ng.IQService, $http: ng.IHttpService, agentService: core.AgentService, logger: core.LoggerService);
        /**
         * Récupération des habilitations Culture.Net et stockage dans le contexte.
         */
        recupererHabilitations(): ng.IPromise<any>;
        /**
         * Mise à jour des habilitations Culture.Net
         */
        private updateHabilitationsCommunautaires();
        /**
         ...
         */
        getUneBPCE(): ng.IPromise<IRubriqueCultureNet[]>;
    }
}
...
declare module myway.portail.api.favori {
    class MigrationFavoriService {
        ...
        start(context: api.application.IContext): ng.IPromise<void>;
        /**
...
declare module myway.portail.api {
    class ContexteLisaService {
        ...
        private modalService;
        static $inject: string[];
        constructor($q: ng.IQService, $parse: ng.IParseService, $interpolate: ng.IInterpolateService, logger: core.LoggerService, agentService: core.AgentService, modalService: MyWay.UI.ModalService);
...
declare module myway.portail.api {
    class DeviceCompatible {
        ...
        constructor(libelleDeviceCompatible: string, allPlateformes: core.IPlateforme[]);
...
declare module myway.portail.api.modele {
    ...
    abstract class ItemList<T, U> {
        ...
        /**
         * Renvoie l'identifiant d'une entité donnée.
         */
        protected abstract getItemId(item: T): U;
    }
}
...
declare module myway.portail.api.preference {
     ...
     */
    abstract class PreferenceInstance<T, U extends modele.ItemList<T, W>, V, W> {
        protected $q: ng.IQService;
...
declare module myway.portail.api {
    ...
    abstract class ApplicationPortail {
        ...
        static APPLICATIONS_BDR: IApplicationPortail;
    }
}
...
declare module myway.portail.api {
    class PortailService {
         ...
         */
        lancerApplication(application: Application, zoneId?: string): ng.IPromise<any>;
        /**
         ...
         */
        getApplicationContext(): ng.IPromise<api.application.IContext>;
        /**
...
declare module myway.portail.api.application {
    interface IContext {
        ...
        applicationsMetiers?: Application[];
...
declare module myway.portail.api {
    class Application {
        ...
        constructor();
        constructor(application: ressources.portailmyway.rechercheapplication.IApplication, device: DeviceCompatible, listeElementsConf: IElementConfigurationPortail[], listeElementsZone: IElementConfigurationZone[], listeZonePortail: IZonePortail[]);
...
declare module myway.portail.api.application {
    class FamilleList {
        ...
        private familles;
        private famillesSpeciales;
        constructor(familles: myway.ressources.portailmyway.recherchefamille.IFamille[], precoEtablissement?: boolean, liens?: boolean);
...
declare module myway.portail.api.ui {
    class ApplicationsLiensControleur {
        ...
        private lienService;
        settings: IApplicationsLiensSettings;
        applications: Application[];
        navigationSettings: ui.navigation.INavigationSettings<application.Famille, application.SousFamille>;
        tuileApplicationConfig: ui.tuile.ITuileSettings<Application>;
        tuileLienConfig: ui.tuile.ITuileSettings<lien.ILien>;
        mode: ApplicationsFavorisModeEnum;
        private onStartAjoutFavoris;
        private onEndAjoutFavoris;
        private onStartEditionLiens;
        private onEndEditionLiens;
        static $inject: string[];
        constructor($rootScope: ng.IRootScopeService, $timeout: ng.ITimeoutService, $element: ng.IAugmentedJQuery, $q: ng.IQService, loaderService: core.LoaderService, erreurService: core.ErreurService, applicationService: api.ApplicationService, portailService: api.PortailService, lienService: lien.LienService);
        ...
        supprimerLien(lien: lien.ILien, index: number): void;
...
declare module myway.portail.api.ui {
    interface IApplicationsLiensSettings {
        searchMode?: boolean;
        titre?: string;
        zone?: string;
        applications?: Application[];
        favorisMetiers?: Application[];
        liens?: lien.ILien[];
        favoriList?: favori.FavoriPersoList;
        categoriePersoList: favori.CategoriePersoList;
...
declare module myway.portail.api.ui {
    class ApplicationsFavorisControleur {
        ...
        private lienService;
        private favoriPersoService;
        settings: IApplicationsFavorisSettings;
        mode: ApplicationsFavorisModeEnum;
        favorisSettings: IFavorisSettings;
        applicationsLiensSettings: IApplicationsLiensSettings;
        private MESSAGE_AVERTISSEMENT;
        static $inject: string[];
        constructor($scope: ng.IScope, $rootScope: ng.IRootScopeService, $timeout: ng.ITimeoutService, $element: ng.IAugmentedJQuery, notificationService: MyWay.UI.IMwNotificationService, logger: core.LoggerService, loaderService: core.LoaderService, erreurService: core.ErreurService, applicationService: api.ApplicationService, portailService: api.PortailService, lienService: api.lien.LienService, favoriPersoService: api.favori.FavoriPersoService);
        ...
        private restoreLiens();
        private saveLiens();
        private restoreFavoris();
        private saveFavoris();
    }
}
...
declare module myway.portail.api.ui {
    interface IApplicationsFavorisSettings {
        titre?: string;
        zone?: string;
        categoriePersoList: favori.CategoriePersoList;
        favoriList: favori.FavoriPersoList;
    ...
    const enum ApplicationsFavorisModeEnum {
        CONSULTATION = 0,
        EDITION_FAVORIS = 1,
        AJOUT_FAVORIS = 2,
        EDITION_LIENS = 3,
    }
    interface IApplicationsFavorisEndActionLocals {
        /**
...
declare module myway.portail.api.ui {
    class FavorisControleur {
        ...
        static $inject: string[];
        constructor($scope: ng.IScope, $rootScope: ng.IRootScopeService, $timeout: ng.ITimeoutService, $element: ng.IAugmentedJQuery, notificationService: MyWay.UI.IMwNotificationService, loaderService: core.LoaderService, erreurService: core.ErreurService, applicationService: api.ApplicationService, portailService: api.PortailService, lienService: api.lien.LienService, favoriPersoService: api.favori.FavoriPersoService);
        isEdition: boolean;
        isAjout: boolean;
        isEditionLiens: boolean;
        favorisPersos: favori.IFavori[];
        isDeviceCompatible(fav: favori.IFavori): boolean;
        ...
        private swapFavoris(index1, index2);
        private initConfigTuiles();
    }
}
...
declare module myway.portail.api.ui {
    interface IFavorisSettings {
        titre?: string;
        zone?: string;
        favoriPersoList?: favori.FavoriPersoList;
        favorisMetiers?: Application[];
        /**
         * Indicateur d'ouverture du panneau rétractable
         */
...
declare module myway.portail.api.ui.tuile {
    class TuileControleur<T> {
        ...
        index: number;
        private onAction;
        private onActionEdition;
        private onActionBackdrop;
        private onAction1;
        private onAction2;
        private onAction3;
        private onAction4;
        private onActionGauche;
        private onActionDroite;
        static $inject: string[];
...
declare module myway.portail.api.ui.tuile {
    ...
    interface IAttributes extends ng.IAttributes {
        ...
        data: string;
        onAction: string;
        onActionBackdrop: string;
        onAction1: string;
        onAction2: string;
        onAction3: string;
        onAction4: string;
        onActionGauche: string;
        onActionDroite: string;
    }
    ...
    interface IBoutonAction<T> {
        ...
        onAction?: (locals: IActionLocals<T>) => void;
        visible?: (data: T, index?: number) => boolean;
    }
}
...
declare module myway.portail.api.favori {
    ...
    const enum StatutFavoriEnum {
        ENREGISTRE = 0,
        AJOUTE = 1,
        MODIFIE = 2,
        SUPPRIME = 3,
        /**
         * Orphelin: l'application ou le lien correspondant n'a pas été trouvé (probablement lié à un problème d'habilitation)
         */
        ORPHELIN = 4,
    }
    interface IFavori {
        ...
        type: TypeFavoriEnum;
        /**
         * Statut du favori (temporaire signifie qu'il n'a pas été enregistré et qu'il peut encore être annulé)
         */
        statut: StatutFavoriEnum;
        /**
         * Identifiant de l'application
         */
        codeApplication?: string;
...
declare module myway.portail.api.favori {
    class FavoriPersoService {
        ...
        getFavorisMetier(): ng.IPromise<IFavori[]>;
...
declare module myway.portail.api.lien {
    ...
    class LienList extends modele.ItemList<ILien, string> {
        protected getItemId(item: ILien): string;
    }
}
...
declare module myway.portail.api.favori {
    ...
    class CategoriePersoList extends modele.ItemList<ICategoriePerso, string> {
        ...
        protected getItemId(item: ICategoriePerso): string;
    }
}
...
declare module myway.portail.api.favori {
    ...
    class FavoriPersoList extends modele.ItemList<IFavori, string> {
        ...
        /**
         * Renvoie les favoris de type application métier (préconisation établissement)
         */
        favorisMetier: IFavori[];
        /**
         * Renvoie les favoris de type application et métier (préconisation établissement)
         */
        favorisApplicationEtMetier: IFavori[];
        /**
        ...
        getFavoriByCodeApplication(codeApplication: string): IFavori;
        getFavoriByIdLien(idLien: string): IFavori;
        createFavoriTemplate(type: TypeFavoriEnum, idCategorie: string): IFavori;
        /**
         ...
         * Si une catégorie est précisée, ce sera la position au sein de la catégorie.
         */
        getNextAvailableGlobalePosition(idCategorie?: string): number;
        protected getItemId(item: IFavori): string;
    }
}
