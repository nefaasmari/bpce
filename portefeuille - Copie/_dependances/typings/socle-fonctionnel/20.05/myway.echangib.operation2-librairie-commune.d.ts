...
declare module Operation2Librairie.Modeles.Rest.SepaPaiement.ExportTransInstruction {
    ...
    interface IExportTrnInstruction {
        ...
        sensEchangeABS: boolean;
        /**
         * rechTransInstruction - transactionInterne
         */
        transactionInterne: boolean;
        /**
        ...
        dateReglementTransaction: string;
        /**
         * rechTransInstruction- classificationPaiement
         */
        classificationPaiement: string;
        /**
         * rechTransInstruction - typeTransactionConnexe
         */
        typeTransactionConnexe: string;
        /**
         * rechTransInstruction - bicClientDebiteur
         */
        bicClientDebiteur: string;
        /**
         * rechTransInstruction - bicClientCrediteur
         */
        ...
        statusTransaction: string;
        /**
         * rechTransInstruction - codeEtablissement
         */
        codeEtablissement: string;
        /**
         * rechTransInstruction- refClientBoutEnBout
         */
        refClientBoutEnBout: string;
        /**
         * rechTransInstruction - ibanDebiteur
         */
        ibanDebiteur: string;
        /**
         * rechTransInstruction - ibanCrediteur
         */
        ibanCrediteur: string;
        /**
         * rechTransInstruction- schemaTransaction
         */
        schemaTransaction: string;
        /**
        ...
        offreClient: string;
        /**
         * rechTransInstruction - canalAcquisition
         */
        canalAcquisition: string;
        /**
         * rechTransInstruction - sousCanalAcquisition
         */
        sousCanalAcquisition: string;
        /**
         * rechTransInstruction - codeIdentificationScheme
         */
        codeIdentificationScheme: string;
        /**
         * rechTransInstruction - referenceMandatSDD
         */
        referenceMandatSDD: string;
        /**
         * rechTransInstruction - nomDebiteur
         */
        nomDebiteur: string;
        /**
         * rechTransInstruction - nomCrediteur
         */
        nomCrediteur: string;
        /**
         * rechTransInstruction - libelleTransaction
         */
        libelleTransaction: string;
        /**
         * rechTransInstruction - identifiantCreancierSepa
         */
        identifiantCreancierSepa: string;
        /**
        ...
        bicEmetteur: string;
        /**
         * rechTransInstruction - nomEmetteur
         */
        nomEmetteur: string;
        /**
        ...
        bicDestinataire: string;
        /**
         * rechTransInstruction - nomDestinataire
         */
        nomDestinataire: string;
        /**
         * rechTransInstruction - origineRappel
         */
        origineRappel: string;
    }
}
