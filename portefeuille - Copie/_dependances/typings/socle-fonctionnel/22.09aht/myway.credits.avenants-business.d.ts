...
declare module Avenants.Business.Modeles {
    ...
    class Assurance implements IAssurance {
        ...
        private _dureeRestanteMaxCreditMois;
        idIhm: number;
...
declare module Avenants.Business.Modeles {
    ...
    class CaracteristiqueFinanAccessoireBuilder {
        ...
        private static getGererAccessoiresAnnexesFutureAvenant(dataCommonCaraFinan, codeTypeAcces, accAnnexe, listeAccessoiresAnnexes, credit, dateEffet);
        private static getNouveauNumeroAccessoireAnnexe(listeAccessoiresAnnexes);
        private static getCreerAccessoiresAnnexesFutureAvenant(acc, listeAccessoiresAnnexes, credit);
