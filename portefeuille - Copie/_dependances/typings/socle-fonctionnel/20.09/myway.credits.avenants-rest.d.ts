...
declare module Avenants.Rest.Services {
    ...
    interface IAvenantService {
         ...
         */
        getCriteresCreationChangePdt(codeEtablissement: string, dateTraitement: string, idCredit: string, idEmprunteur: string, dateEffet: string, numeroAvenantSimulation: number, compteurMiseJour: number, codeAvenantSimulation: Commun.Enum.CodeAvenantSimulation, listeModificationCredit: Array<Commun.Enum.ModificationCredit>, credit: ModelAvenant.CaracteristiqueFinan.ICredit, codeTypeAcces: Commun.Enum.CodeTypeAcces): ModelAvenant.CaracteristiqueFinan.ICriteresCreationChangePdt;
        ...
        getCaracteristiqueAssu(codeEtablissement: string, dateTraitement: string, idCredit: string, idEmprunteur: string, dateEffet: string, numeroAvenantSimulation: number, codeAvenantSimulation: Commun.Enum.CodeAvenantSimulation, isChangementProduit: boolean): ng.IPromise<ModelAvenant.CaracteristiqueAssu.ICaracteristiqueAssu>;
...
declare module Avenants.Rest.Services {
    ...
    interface ISignatureService {
        ...
        putHistoSignatureElectronique(codeEtablissement: string, dateTraitement: string, idCredit: string, numeroRelatif: number, idGeneriqueSecondDossierCredit: string, motif: string, typeContrat?: string): ng.IPromise<ModelAvenant.Caracteristique.ICaracteristique>;
        ...
        deleteSignElectronique(codeEtablissement: string, idDossierCredit: string, typeContrat: string, numero: number, numeroRenegociation: number): ng.IPromise<boolean>;
        putTraceTopEligibiliteSignatureElectronique(codeEtablissement: string, dateTraitement: string, idCredit: string, numeroRelatif: number, libelleEligibiliteSignature: string): ng.IPromise<ModelAvenant.Caracteristique.ICaracteristique>;
    }
...
declare module Avenants.Rest.Services {
    ...
    interface ISyntheseImpactAvenantService {
        getSyntheseImpactAvenant(codeEtablissement: string, identifiantCredit: string, dateTraitement: string, dateEffet: Date, numeroAvenantSimulation: number, codeAvenantSimulation: Commun.Enum.CodeAvenantSimulation, codeTypeAcces: string, isChangementProduit: boolean): ng.IPromise<AvenantModel.SynthesImpactAvenant.ISynthesImpactAvenant>;
    }
}
...
declare module Avenants.Rest.Modeles.AvenantCreditService.AjustementEcheances {
    ...
    interface ICriteresAppel {
        ...
        nouveauTaux: number;
        /**
         * Détermine quel algorithme sera appliqué. 1 : modification échéances ; 2 : modification durée ; 3 : saisie libre
         */
        typeCalcul: number;
        /**
