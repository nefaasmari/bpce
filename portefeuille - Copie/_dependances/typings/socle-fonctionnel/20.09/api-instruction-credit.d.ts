...
declare module ApiInstuctionCredit.Constantes.Inject {
    namespace Modale {
        const data: string;
    }
}
...
declare namespace ApiInstuctionCredit.Enum {
    /**
     *  Code application
     */
...
declare module ApiInstuctionCredit.Modeles {
    class IContext {
        /**
         ...
         */
        dossierSchema: ApiInstuctionCredit.Modeles.Dossier.IDossierSchema;
...
declare module ApiInstuctionCredit.Service.Data {
    class PiecoService {
         ...
         * Edition de plusieurs documents PDF
         */
        editionDocumentsAvecAno(identifiantDossier: string, identifiantDocument: string, identifiantWs: string, paramsEditiques: Modele.IParamEditique[], niveauTraitement: number, formatEditique: number, codeSignature?: ApiInstuctionCredit.Constantes.Dossier.CodeSignatureElectronique): ng.IPromise<Modele.IResultatEditionDocumentsData>;
        /**
...
declare module ApiInstuctionCredit.Control {
...
declare namespace ApiInstuctionCredit.Modeles.Dossier {
...
declare module ApiInstuctionCredit.Modele.Parametrage {
    interface IBT95Codes {
        ...
        cantUseRessourceV7?: IBT95CodeDatas;
    }
...
declare namespace ApiInstuctionCredit.ContexteEdition {
    ...
    class ModaleContexteEditionControleur {
        ...
        private erreurService;
        loading: boolean;
        static parametres: ApiInstuctionCredit.Control.IControleurParametre;
        static $inject: string[];
