...
declare module Mad.Rest.MouvAttenteDecision.Modele.InfoSpecifiqueETMad {
    interface IParametreGet {
        ...
        identifiantEntiteTitulaire: number;
        /** Boolean => O/N. Précise si la recherche d'informations doit inclure les données utiles pour le moteur de délégation Adelys V2. */
        topEligibiliteAdelysET: string;
    }
    interface IEntiteTitulaire {
        /**
         * Identifiant d'un client bancaire détenteur de contrats de produit/service.
    ...
    interface IIncident {
        /**
         * Liste de code déterminant la nature d'un incident bancaire. '01' - inscription de privilège sur compte interne à l'établissement '04' - impayé sur prêt '08' - rejet de prélèvement
         */
        codeTypeIncident: string;
    }
}
...
declare module Mad.Rest.MouvAttenteDecision.Modele.RechercheMadDuJour {
    ...
    interface IMouvementMad {
        ...
        codeTypeDecision: string;
        /**
         * Indicateur permettant de dire si un mouvement MAD est éligible au contrôle de délégation du nouveau moteur Adelys V2.
         * 'O' - Eligible au contrôle de délégation Adelys V2
         * 'N' - Non éligible au contrôle de délégation Adelys V2
         */
        topEligibiliteAdelysMvt: boolean;
...
declare module Mad.Rest.MouvAttenteDecision {
    interface IDecisionRestService {
        preparerParametreDecision(entite: Modele.Decision.IEntiteTitulaire): ng.IPromise<Modele.Decision.IDecision>;
