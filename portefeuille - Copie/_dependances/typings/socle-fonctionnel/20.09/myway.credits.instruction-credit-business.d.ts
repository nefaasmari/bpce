...
declare namespace ICBusiness.Models.Financement {
    ...
    interface IAccessoireProduitFinancierConfig {
...
declare namespace ICBusiness.Services.Financement {
    interface IAccessoiresService {
        ...
        /** Récupération des taux minimum et maximum pour controler la validiter des données */
        getAccessoireFinancierConfig(dateDeTraitement: string, codeEtablissement: number, idProduitFinancier: string, accessoire: Models.Financement.IAccessoire): ng.IPromise<Models.Financement.IAccessoireProduitFinancierConfig>;
    }
...
declare namespace ICBusiness.Services.SignatureElectronique {
    interface ISignatureElectroniqueService {
         ...
         */
        annulerActSigneElec(idDossier: string, motifAnnulation: string): ng.IPromise<void>;
