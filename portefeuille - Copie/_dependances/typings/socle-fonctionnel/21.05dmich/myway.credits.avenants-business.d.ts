...
declare module Avenants.Business.Modeles {
    ...
    class EcheanceALaCarteV2 implements IEcheanceALaCarte {
        ...
        protected getMontantEcheanceMaj(palier: RestAvenantAjustEcheance.IPalier, numeroEcheanceScission: number): number;
...
declare module Avenants.Business.Modeles {
    ...
    class PalierProgAmor implements IPalierProgAmor {
        ...
        numeroPremiereEcheance: number;
        numeroDerniereEcheance: number;
        constructor(p: RestGestion.InformationCredit.IPalierTauxAmortissement, avecChangementProduit: boolean, codeTypeAcces: Commun.Enum.CodeTypeAcces);
    }
}
...
declare module Avenants.Business.Modeles {
    ...
    class Phase implements IPhase {
        ...
        getPalierProgAmor(paliersTauxAmortissement: Array<RestGestion.InformationCredit.IPalierTauxAmortissement>, isChangementProduit: boolean, codeTypeAcces: Commun.Enum.CodeTypeAcces): Array<Modeles.IPalierProgAmor>;
    }
}
...
declare module Avenants.Business.ToolsFunctionals {
    ...
    import RestGestion = Avenants.Rest.Modeles.DossierCreditGestion;
    class ScissionPhase {
        static scissionPhaseEnCours(phaseSelectionne: Modeles.IPhase, phaseAvailables: Array<Modeles.IPhase>, credit: RestGestion.InformationCredit.ICredit, nuepDebutPhase: number, nuepFinPhase: number, listeAccessoires: Array<RestAvenantParam.Produit.IAccessoire>, produitCodeProduitRevisable: string): Array<Modeles.IPhase>;
