...
declare module GestionGeneriqueOffres.Types {
    ...
    class CompositionOffre {
         ...
         */
        constructor(contexte: Types.ContexteGgo | ContexteGgho, entites: Types.InformationEntiteTitulaire[] | Types.InformationEntiteTitulaireBdr[], personnes: Types.Tiers.Personne[] | Types.Tiers.PersonneMorale[], catalogue: Types.CatalogueNode | Types.Cloture.CatalogueNode, paramBlocs: Types.ParametrageBlocs | Types.ParametrageBlocsGgho, options: IOptionsCreationComposition, dv: Types.DossierDeVente.GestionDossierVente, mandataires?: Types.Tiers.Procuration[]);
    }
}
