...
declare module GestionGeneriqueOffres.Types.Cloture {
    ...
    class CompositionOffre {
         ...
         */
        private produitEstDetenu(produit, detenteur, produitSupport?, noeudDeRattachement?);
        /**
        ...
        * @return : void
        */
        private inserer(produitAInserer, listeProduits);
        /**
        ...
        */
        private attribuerIdBloc(idNiveauSuperieur, listeProduits);
    }
}
