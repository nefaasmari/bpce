...
declare module GestionGeneriqueOffres.Types {
    interface IContexteEditiqueGgho extends IContexteEditique {
        ...
        contexteEditiqueDAT?: IContexteEditiqueDAT;
        contexteEditiqueCarte?: ContexteEditiqueCarte;
    }
    ...
    class ContexteEditiqueCarte {
        ...
        dateCloture: string;
        codeMotifBlocageContratCartes: string;
        dateDeFinDeValiditeDeLaCarte: string;
    }
    interface IContexteEditiqueDAT {
        numeroPersonne: string;
        numeroEntiteTitulaire: string;
        numeroRICEDAT: string;
    }
    class ContexteEditiqueDAT implements IContexteEditiqueDAT {
        numeroPersonne: string;
        numeroEntiteTitulaire: string;
        numeroRICEDAT: string;
        constructor();
...
declare module GestionGeneriqueOffres.Types.Tiers {
    ...
    class Personne {
        ...
        getLibelle: string;
        getLibelleAbrege(): string;
        constructor(identification: Identification | Types.TiersV3.Identification, particulierInformation: ParticulierInformation | Types.TiersV3.InformationParticulier, listeMedias: Media[], particulierTiersLies: Tiers.ParticulierTiersLie[] | Types.TiersV3.IInformationTiersLie[]);
    }
}

declare module GestionGeneriqueOffres.Types.Tiers {
    interface IListeProcuration {
        listeProcuration: Array<IProcuration>;
    }
