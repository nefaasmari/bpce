...
declare module GestionGeneriqueOffres.Types {
    ...
    class CompositionOffre {
         ...
         */
        constructor(contexte: Types.ContexteGgo | ContexteGgho, entites: Types.InformationEntiteTitulaire[] | Types.InformationEntiteTitulaireBdr[], personnes: Types.Tiers.Personne[] | Types.Tiers.PersonneMorale[], catalogue: Types.CatalogueNode | Types.Cloture.CatalogueNode, paramBlocs: Types.ParametrageBlocs | Types.ParametrageBlocsGgho, options: IOptionsCreationComposition, dv: Types.DossierDeVente.GestionDossierVente, mandataires?: Types.Tiers.ListeProcuration);
    }
}
...
declare module GestionGeneriqueOffres.Types {
    ...
    class DonneesContextuelles {
         ...
         */
        catalogue: Types.CatalogueNode | Types.Cloture.CatalogueNode;
        private _composition;
        /**
        ...
        private _libTitreProduit;
        libTitreProduit: string;
        constructor(modeAcces: ModeAcces, modeAffichage: ModeAffichage, contexteAppel: ContexteAppel, appelant: AppelantsGgo, personnes: Personne[] | PersonneMorale[], entitesTitulaires: InformationEntiteTitulaire[] | InformationEntiteTitulaireBdr[], offreSouscrite: OffreSouscrite, etablissement: Etablissement, indicateurDossierVenteAutorise: boolean, dossierVente: DossierDeVente.GestionDossierVente, donneesGeneriquesTousProduits: DossierDeVente.IDonneesGeneriques[], donneesGeneriques: Types.DossierDeVente.IDonneesGeneriques[], catalogue: Types.CatalogueNode | Types.Cloture.CatalogueNode, composition: Types.CompositionOffre, donneesMiseEnGestion: Types.DonneesMiseEnGestion[], donneesProduit: DonneesProduit, referencesProduits: ReferenceProduit[], listeSignataires: myway.comContract.modeles.ISignataireComplet[], lienVersComposition: Types.CompositionOffreProduit, libTitreProduit?: string);
    }
}
