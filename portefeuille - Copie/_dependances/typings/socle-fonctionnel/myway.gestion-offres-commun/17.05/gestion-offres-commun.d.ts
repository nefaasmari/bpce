...
declare module GestionGeneriqueOffres.Types {
    ...
    class CompositionOffre {
         ...
         */
        insererProduitEnModeEntite: (contexte: Types.ContexteGgo | Types.ContexteGgho, modeAjoutProduit: ModeAjoutProduitDansOffre, origine: OrigineProduit, node: Types.CatalogueNode, entite: Types.InformationEntiteTitulaire, donneesSelectionAssemblage?: Types.DonneesAssemblage) => CompositionOffreProduit;
        /**
         * Insère un P/S géré en mode personne dans la composition, directement sous l'entité. Ex : LSE
         * Renvoie l'élément de la composition correspondant au produit inséré
         */
        insererProduitEnModePersonne: (contexte: Types.ContexteGgo | Types.ContexteGgho, modeAjoutProduit: ModeAjoutProduitDansOffre, origine: OrigineProduit, node: Types.CatalogueNode, detenteur: Types.InformationEntiteTitulaire | Types.Tiers.Personne, donneesSelectionAssemblage?: Types.DonneesAssemblage) => CompositionOffreProduit;
        /**
         ...
         * Renvoie l'élément de la composition correspondant au produit inséré
         */
        insererProduitEnModeCompte: (contexte: Types.ContexteGgo | Types.ContexteGgho, modeAjoutProduit: ModeAjoutProduitDansOffre, origine: OrigineProduit, node: Types.CatalogueNode, produitSupport: CompositionOffreProduit, detenteur: Types.InformationEntiteTitulaire | Types.Tiers.Personne, donneesSelectionAssemblage?: Types.DonneesAssemblage, noeud?: CompositionOffreEntitePersonne) => CompositionOffreProduit;
        /**
         ...
         */
        insererPlusieursProduitEnModeCompte: (contexte: Types.ContexteGgo | Types.ContexteGgho, modeAjoutProduit: ModeAjoutProduitDansOffre, origine: OrigineProduit, node: Types.CatalogueNode, entite: Types.InformationEntiteTitulaire, personne?: Types.Tiers.Personne, donneesSelectionAssemblage?: Types.DonneesAssemblage) => Types.EvenementProduit[];
        /**
         ...
         */
        constructor(contexte: Types.ContexteGgo | Types.ContexteGgho, entites: Types.InformationEntiteTitulaire[], personnes: Types.Tiers.Personne[], catalogue: Types.CatalogueNode, paramBlocs: Types.ParametrageBlocs, options: IOptionsCreationComposition);
    }
}
...
declare module GestionGeneriqueOffres.Types {
    ...
    class DonneesContextuelles {
        ...
        constructor(modeAcces: ModeAcces, modeAffichage: ModeAffichage, contexteAppel: ContexteAppel, personnes: Personne[], entitesTitulaires: InformationEntiteTitulaire[], offreSouscrite: OffreSouscrite, etablissement: Etablissement, dossierVente: DossierVente, donneesGeneriques: Types.DonneesGeneriques, catalogue: Types.CatalogueNode, composition: Types.CompositionOffre, donneesMiseEnGestion: Types.DonneesMiseEnGestion[], donneesProduit: DonneesProduit, referencesProduits: ReferenceProduit[], listeSignataires: myway.comContract.modeles.ISignataireComplet[], lienVersComposition: Types.CompositionOffreProduit);
    }
}
...
declare module GestionGeneriqueOffres.Types {
    interface IParametrageBloc {
        codeTypeProduitService: string;
        codeSousFamilleActeGestion: string;
        identifiantComposantProduitService: string;
        fichiersComposantProduitService: Array<IDescriptionFichier>;
        identifiantProduitService: number;
    }
    interface IDescriptionFichier {
        typeFichier: string;
    ...
    interface IHorsOffreParametre {
        parametrageBlocsData: Array<IParametrageBloc>;
    }
}
