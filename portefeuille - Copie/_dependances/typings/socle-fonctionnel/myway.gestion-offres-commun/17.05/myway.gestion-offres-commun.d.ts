...
declare module GestionGeneriqueOffres.Types {
    ...
    class CompositionOffre {
         ...
         */
        constructor(contexte: Types.ContexteGgo, entites: Types.InformationEntiteTitulaire[] | Types.InformationEntiteTitulaireBdr[], personnes: Types.Tiers.Personne[], catalogue: Types.CatalogueNode, paramBlocs: Types.ParametrageBlocs, options: IOptionsCreationComposition, dv: Types.DossierDeVente.GestionDossierVente);
    }
}
...
declare module GestionGeneriqueOffres.Types.DossierDeVente {
    ...
    interface ICompositionCaracteristique {
        ...
        /**
         * Indique si le produit est un produit repris ou pas (O/N)
         */
        indicateurProduitRepris: string;
        /**
         * Indique si le produit est modifié ou pas (O/N)
         */
