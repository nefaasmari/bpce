...
declare module GestionGeneriqueOffres.Types.Changement {
    ...
    interface IPsReprise extends IPSOffreSourceBO27 {
        ...
        indicateurAssObligatoire?: string;
    }
...
declare module GestionGeneriqueOffres.Types {
    ...
    class CompositionOffreEntitePersonne {
        ...
        _produitServiceDetenu: Types.ProduitService;
        /**
...
declare module GestionGeneriqueOffres.Types {
    ...
    class CompositionOffreProduit {
         ...
         * Remet à zéro _getCodeSousFamilleActeGestionPourDirective afin d'en repermettre le calcul par getCodeSousFamilleActeGestionPourDirective
         */
        resetCodeSousFamilleActeGestionPourDirectiveGgho(): void;
        /**
         * Recherche un bloc produit par son id de bloc.
         */
...
declare module GestionGeneriqueOffres.Types {
    ...
    class ContexteGgo {
         ...
         */
        typeTitulaire: string;
        private _riceContrat;
        /**
         * RICE du contrat
         */
        riceContrat: string;
        private _isPanierDesactive;
        /**
         * affichage du panier signature
         */
        isPanierDesactive: boolean;
...
declare module GestionGeneriqueOffres.Types {
    interface IContexteEditique {
        ...
        listePorteursSolCap?: IPorteurServiceSolCap[];
    }
    ...
    interface IPorteurServiceSolCap {
        identifiantPersonne: number;
...
declare module GestionGeneriqueOffres.Types {
    interface ISauvegardeContexteEditiqueGgho {
        contexte?: ContexteEditiqueDAT | ContexteEditiqueCarte | ContexteEditiqueTitre | ContexteEditiqueDecouvert;
    }
    ...
    class ContexteEditiqueDecouvert {
        typeProduit: string;
        numeroCompte: string;
        ...
        montantTotalDuDecouvert: string;
        fraisDuDecouvert: number;
        codeMonnaieDecouvert: string;
        valeurDuTauxDecouvert: string;
...
declare module GestionGeneriqueOffres.Types.DossierDeVente {
    ...
    interface ICheminAvancement {
        /**
         * Le code jalon balise le chemin d'avancement. Le chemin d'avancement est le chemin que parcourt un dossier de vente. Il est ponctué d'étapes appelées jalons.
         * Le chemin d'avancement et les jalons permettent à l'utilisateur de visualiser le parcours ainsi que les étapes franchies, à franchir...pour le dossier de vente sur l'application Myway.
         * Exemples :
         * - 'PROP' = Proposition
        ...
        codeJalon: string;
        /**
         * Ce libellé est associé au code jalon. Le code jalon balise le chemin d'avancement. Le chemin d'avancement est le chemin que parcourt un dossier de vente. Il est ponctué d'étapes appelées jalons.
         * Le chemin d'avancement et les jalons permettent à l'utilisateur de visualiser le parcours, ainsi que les étapes franchies, à franchir..., pour le dossier de vente sur l'application Myway.
         * Exemples :
         * - 'Proposition'
         * - 'Documents envoyés'
        ...
        libelleJalon: string;
        /**
         * Cet indicateur caractérise le jalon du chemin d'avancement dans une situation donnée. Le chemin d'avancement, et les jalons permettent de visualiser de façon synthétique  l'avancement du dossier de vente sur l'application Myway.
         * A chaque statut d'un processus de vente, sont associés un chemin d'avancement et un jalon.
         * Lors de cette association, le jalon est enrichi de l' indicateur franchissement qui précise la façon dont il doit être mis à jour. Le jalon pourra être franchi, non franchi...
         * Exemples :
    ...
    interface ICompositionCaracteristique {
         ...
         * Un dossier de vente peut être composé de plusieurs clients bancaires, de plusieurs sous-actes de gestion. Un rang chronologique ou identifiant est attribué à chacun d'eux.
         * Le sous-acte de gestion peut-être rattaché à un autre sous-acte de gestion composant le dossier de vente. L'identifiant père composition permet de faire le rattachement.
         ...
         * - ' ' = non concerné
         * Par exemple : si clôture de carte suite à montée en gamme, il y aura ouverture d’une autre carte, le codeNatureActeGestion de l’acte de gestion de clôture de l'ancienne carte devra être topé à  ‘I’.
         * Idem pour Eparfix remplacé par Eparplus.
         ...
         * via un compte (découvert, relevé, chéquier...), via une entité titulaire (livret, assurance, prêt), via une personne ( VDX, Phonécureuil...)
         * Valeurs :
         * - 'C'        Compte
         * - 'E'        Entité titulaire
         * - 'P'        Personne
        ...
        codeModeFinancier: string;
        /**
         * Etablissement gestionnaire du compte d'imputation de l'opération ou du mouvement, à partir duquel il y a eu virement. Cette rubrique complète la rubrique codeModeFinancier,
         * afin de déterminer si le virement a  été effectué à partir d'un compte interne ou externe à l'Etablissement bancaire.
         * Si codeModeFinancier = "00" ou "10" et codeEtablissementOperation renseigné (différent de blanc) et différent du code établissement bancaire du dossier de vente, le virement sera considéré "externe".
         * Exemple :
         * - '13135'
         *
    ...
    interface IDonneePrincipale {
        ...
        codeModeVente: string;
        /**
         * Détermine si une offre de vente dans le cadre d'un acte de gestion (souscription , avenant, opération...) doit faire l'objet d'une signature de la part du client.
         * Il est  déterminé en fonction de la composition de l'offre et est attribué au dossier de vente.
         * Valeurs :
         * - 'O' = Obligatoire
         * - 'F' = Facultatif
         * - 'S' = Sans signature
        ...
        /**
         * Cet indicateur, permet ou non de bloquer la finalisation du dossier de vente. En cas de signature client, en fonction de cet indicateur, le processus de vente sera différent.
         * Par exemple, pour une Izicarte, lorsque le client a signé, si l’indicateur est valorisé à Non, le statut du dossier de vente sera « Vente finalisée » ;
         * si le l’indicateur est valorisé à Oui, le statut du dossier de vente sera « Crédit à octroyer ».
         *
         * Valeurs :
         * - 'O' = oui
         * - 'N' = non
    ...
    interface IEtapeEnCours {
        /**
         * Cette rubrique spécifie le canal de vente sur lequel a eu lieu la dernière modification du dossier de vente,
         * ou sur lequel on souhaite effectuer une simulation (méthode GET, codeActionContexte COCA)
         *
         * Exemples :
         * - 'TL' = Téléphone
         * - 'FF' = Face à face
        ...
        /**
         * Cette rubrique spécifie le sens de la communication dans lequel a eu lieu la dernière modification du dossier de vente,
         * ou dans lequel on souhaite effectuer une simulation (méthode GET, codeActionContexte COCA).
    ...
    interface IPersonneLiee {
        ...
        /**
         * Numéro de personne en lien (PM) dans le cas d'un signataire GMP
         * Si non GMP, on valorise à 0
         */
...
declare module GestionGeneriqueOffres.Types {
    ...
    class ProduitCatalogue {
         ...
         */
        indicateurProduitServiceObligatoireOffre: string;
        private _indicateurAssObligatoire;
        indicateurAssObligatoire: string;
        private _indicateurProduitServiceInclusForfait;
        /**
         * Indicateur P/S inclus Forfait (CIEGIF). indique pour un P/S inclus dans un Forfait la tarification appliquée au P/S
        ...
        niveauPriorite: number;
        /**
         * Valeur incrémentée de 1 à nnnn permettant de connaitre l'ordre de gestion des produits/services.
         * Il est généré en fonction des segments remontés par le central.
         * Création suite à des difficultés de réordonner simplement le panier après manipulation des PS sous GGO.
         * Cette information ne viendra pas du central et sera interprétée uniquement par la ressource et l'ihm.
         *  public get ordreSimplePS(): number {
         *    return this._ordreSimplePS;
         * }
         */
        constructor(pc: IProduitCatalogue);
    }
...
declare module GestionGeneriqueOffres.Types.DossierDeVente {
    ...
    interface IResultatDossierVente {
        listeActionPossible: Array<IActionPossible>;
        listeCompositionDossier: Array<ICompositionDonneeDetail>;
        donneeDossier: IDonneeDossier;
        listeDonneePersonne: Array<IDonneePersonne>;
        donneeSignature: IContractualisationSignature;
        etatDossier: IEtatDossier;
        referenceDossierVente: IReferenceDossierVente;
    }
    interface IRechercheDossierVente {
        critereConsultation: ICritereConsultation;
        listeDossierVente: Array<IResultatDossierVente>;
    }
...
declare module GestionGeneriqueOffres.Constantes {
    ...
    class IndicateurAssObligatoire {
        OBLIGATOIRE: string;
        FACULTATIF: string;
    }
    ...
    class CodeRolePersonne {
        ...
        GESTIONNAIRE_MESURE_PROTECTION: string;
        REPRESENTANT_LEGAL_PRO: string;
        VISA_COLLABORATEUR: string;
    }
    class TypeAppelant {
        IHM_CAISSE: string;
        IHM_CLIENT: string;
    ...
    class Libelles {
        ERREUR_DV_OC_VPC_EXISTANT: string;
    }
    class Definitions {
        ...
        IndicateurAssObligatoire: IndicateurAssObligatoire;
