...
declare module GestionGeneriqueOffres.Types {
    interface ICatalogueNode {
         ...
         * @returns Rien
         */
        gererEtatTuile(detenteurs: Tiers.Personne[] | Types.Tiers.PersonneMorale[] | InformationEntiteTitulaire[] | Types.InformationEntiteTitulaireBdr[], composition: CompositionOffre, assemblage: CatalogueNode): void;
    }
    /**
...
declare module GestionGeneriqueOffres.Types {
    ...
    class CompositionOffreProduit {
         ...
         *   Si dans la liste figure un code OU, on renvoie celui-ci.
...
declare module GestionGeneriqueOffres.Types {
    ...
    class CompositionOffre {
         ...
         */
        insererProduitEnModePersonne: (contexte: Types.ContexteGgo | ContexteGgho, modeAjoutProduit: ModeAjoutProduitDansOffre, origine: OrigineProduit, node: Types.CatalogueNode, detenteur: Types.InformationEntiteTitulaire | Types.Tiers.Personne | Types.Tiers.PersonneMorale | Types.InformationEntiteTitulaireBdr, donneesSelectionAssemblage?: Types.DonneesAssemblage) => CompositionOffreProduit;
        /**
         ...
         * @returns Le produit inséré dans le panier, undefined si rien n'est inséré
         */
        insererProduitEnModeCompte: (contexte: Types.ContexteGgo | Types.ContexteGgho, modeAjoutProduit: ModeAjoutProduitDansOffre, origine: OrigineProduit, node: Types.CatalogueNode, produitSupport: CompositionOffreProduit, detenteur: Types.InformationEntiteTitulaire | Types.Tiers.Personne | Types.Tiers.PersonneMorale | Types.InformationEntiteTitulaireBdr, donneesSelectionAssemblage?: Types.DonneesAssemblage, noeud?: CompositionOffreEntitePersonne) => CompositionOffreProduit;
        /**
         ...
         */
        insererPlusieursProduitEnModeCompte: (contexte: Types.ContexteGgo | ContexteGgho, modeAjoutProduit: ModeAjoutProduitDansOffre, origine: OrigineProduit, node: Types.CatalogueNode, entite: Types.InformationEntiteTitulaire | Types.InformationEntiteTitulaireBdr, personne?: Types.Tiers.Personne | Types.Tiers.PersonneMorale, donneesSelectionAssemblage?: Types.DonneesAssemblage) => Types.EvenementProduit[];
        /**
         ...
         */
        testerAssemblageDejaDetenu: (assemblage: Types.CatalogueNode, detenteur: Types.InformationEntiteTitulaire | Types.Tiers.Personne | Types.InformationEntiteTitulaireBdr | Types.Tiers.PersonneMorale, testFunc?: (compositionOffreProduit: Types.CompositionOffreProduit) => boolean) => Types.CompositionOffreProduit[] | Types.CompositionOffreProduit;
        /**
         ...
         */
        constructor(contexte: Types.ContexteGgo | ContexteGgho, entites: Types.InformationEntiteTitulaire[] | Types.InformationEntiteTitulaireBdr[], personnes: Types.Tiers.Personne[] | Types.Tiers.PersonneMorale[], catalogue: Types.CatalogueNode, paramBlocs: Types.ParametrageBlocs | Types.ParametrageBlocsGgho, options: IOptionsCreationComposition, dv: Types.DossierDeVente.GestionDossierVente);
    }
}
...
declare module GestionGeneriqueOffres.Types {
    ...
    class ContexteGgo {
        ...
        /**
         * Code acte de gestion COELAG, deux lettres OU AV CL OC suivi de 8 chiffres.
         */
        codeActeGestion: string;
...
declare module GestionGeneriqueOffres.Types {
    interface IContexte {
        ...
        libProduitTitre?: string;
        zoneLibreProduit?: string;
    }
    /**
    ...
    class Contexte {
        ...
        /** Code produit service IDEGPS de l'offre à souscrire */
        codeProduitService: number;
        private _libProduitTitre;
        /** Libellé produit titre */
        libProduitTitre: string;
        private _zoneLibreProduit;
        /** Libellé produit titre */
        zoneLibreProduit: string;
...
declare module GestionGeneriqueOffres.Types {
    ...
    class DonneesContextuelles {
        ...
        private _referenceProduitServiceContrat;
        /**
         * N° de compte : renseigné en cas d'avenant ou clôture
         */
        referenceProduitServiceContrat: string;
        private _codeTypeProduitServiceContrat;
        /**
         * N° de compte (CODIPR) : renseigné en cas d'avenant ou clôture
         * CODIPR transmis par qui  NSDK  ou Catalogue ? (exemple: 0004, 0001)
         */
        codeTypeProduitServiceContrat: string;
        private _zoneLibreProduit;
        /**
...
declare module GestionGeneriqueOffres.Types {
    ...
    class ParametrageBlocGgho {
         ...
         */
        nomEditique: string;
        constructor(codeTypeProduitService: string, identifiantProduitService: number, codeSousFamilleActeGestion: string, identifiantComposantProduitService: string, fichiersComposantProduitService: DescriptionFichierGgho[], nomEditique: string);
    }
...
declare module GestionGeneriqueOffres.Types {
    ...
    class PropositionReprise {
        ...
        /**
         * Le code process vente est présent sur chaque propositionReprise mais toutes les valeurs sont identiques et la seule
         * propositionReprise où on va chercher le code process vente est celle associée à l'offre.
