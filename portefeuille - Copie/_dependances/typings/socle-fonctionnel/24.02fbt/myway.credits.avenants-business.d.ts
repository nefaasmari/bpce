...
declare module Avenants.Business.Enum {
    ...
    const enum TypeAmortissementCombine {
        Quotite = 0,
        Montant = 1,
    }
}
...
declare module Avenants.Business.Modeles {
    ...
    class Assurance implements IAssurance {
        ...
        private _isAssuranceExterne;
        private _isShowCout8Ans;
        ...
        private _creditCaraFinan;
        private _creditObjet;
        private _phasesByCreditCaraFinan;
        private _isChangementProduit;
        private _numCompagnieInitiale;
        private _phaseModifiables;
        private _libelleErreurCoutTotal;
        private _creditAvenantFinancier;
        private _dureeRestanteCreditMois;
        private _listeEncoursPersonneAssu;
        private _quotite;
        idIhm: number;
        ...
        coutHuitAns: number;
        coutTotal: number;
        onChangeCoutHuitAns(): void;
        onChangeCoutTotals(): void;
        montant: number;
        ...
        codeGrilleTarifaire: Commun.Enum.CodeGrilleTarifaire;
        sommeAllTauxAccessoireBeforeAvenant: number;
        isPhaseEnCoursPeriodiciteScinde: boolean;
        isAvenantPeriodicite: boolean;
        codeAssuranceObligatoireInit: String;
        montantEncoursAssureHorsCredit: number;
        montantEncoursAssure: number;
        getCodeGrilleTarifaireInit(): Avenants.Commun.Enum.CodeGrilleTarifaire;
        quotite: number;
        ...
        isAssuranceExterne: boolean;
        isShowCout8Ans: boolean;
        isShowCout8AnsConsult: boolean;
        isShowCoutTotalConsult: boolean;
        ...
        /**
         * Obligatoire si l'assurance possèdent des composantes assurances et n'est pas A341H
         */
        isObligatoire: boolean;
        showTypeAssurance: boolean;
        /**
         * Détermine s'il faut afficher la donnée Questionnaire de Santé lors de la présentation de l'assurance en visu
         */
        showTopQSConsultation: boolean;
        showTopQSSaisissable: boolean;
        showMontantEncoursAssure: boolean;
        interdit: boolean;
        isLoiLemoine_novembre2023_applicable: boolean;
        libelleErreurCoutTotal: string;
        constructor(idIhm: number, idNouvelleAssurance: number, listePersonne: Array<IPersonneAssurableGarant>, listeCompagnie: Array<ICompagnieApplicable>, listeReserveExclusion: Array<IReserveExclusion>, devise: string, dateEffet: Date, dateTraitement: Date, dateFinCredit: Date, dataForAssurance: IDataForAssurance, creditInfos: RestInfoCredit.ICredit, creditCaraFinan: RestCaraFinan.ICredit, isChangementProduit: boolean, isPhaseEnCoursPeriodiciteScinde: boolean, isAvenantPeriodicite: boolean, phaseModifiables: Array<Modeles.IPhase>, assr: RestCaraFinan.IAssurance, creditAvenantFinancier: ICreditAvenantFinancier, listeEncoursPersonneAssu: Array<Avenants.Rest.Modeles.AssuranceCredit.Recherche.IEncoursPersonneAssu>, creditObjet: Rest.Modeles.DossierCreditAvenant.InformationObjet.ICreditObjet);
        private getTypeAssuranceCreation(newConvention);
        isQuotiteValid(): boolean;
        isMontantValid(): boolean;
        isNewAssuranceModeEdition: boolean;
        isNewAssuranceExterne: boolean;
        getShowCout8Ans(): boolean;
        isCoutHuitAnsValid(): boolean;
        isCoutTotalValid(): boolean;
        isErreurCoutTotal(): boolean;
        /**
        ...
        /**
         * Somme des taux des accessoires x quotité
         * Accessoire ayant une règle d’application NRFCEL=A03 (’Accessoire périodique intégrant l’échéance’ ) et un type d’assiette 33 (’CRD Théorique’)
         */
        getSommeAllTauxAccessoire(): number;
        ...
        private setAssuranceExterne(conventionSelected);
...
declare module Avenants.Business.Modeles {
    ...
    class ConventionApplicable implements IConventionApplicable {
        ...
        estExterne: boolean;
        estPerteEmploi: boolean;
        estLoiLemoine202311: boolean;
        estGereeEnComposantes: boolean;
...
declare module Avenants.Business.Modeles {
    ...
    class AccessoireAnnexe extends AbstractAccessoire implements IAccessoireAnnexe {
        ...
        dateFin: Date;
        tauxOrigine: number;
        dateFinOrigine: string;
        libellePeriodiciteApplicationElement: string;
        ...
        static isAccessoiresAnnexesEquals(acc1: Modeles.IAccessoireAnnexe, acc2: Modeles.IAccessoireAnnexe): boolean;
        static isAccessoiresAnnexesEqualsCaracteristiqueFinanAccessoire(acc2: Modeles.IAccessoireAnnexe, acc1: Avenants.Rest.Modeles.DossierCreditAvenant.CaracteristiqueFinan.IAccessoire): boolean;
        static isExistAccessoiresAnnexesSurPhase(listeAccessoiresAnnexes: Array<Modeles.IAccessoireAnnexe>, newAcc: Avenants.Rest.Modeles.DossierCreditAvenant.CaracteristiqueFinan.IAccessoire): boolean;
        static FindAccessoireAnnexeSurPhase(listeAccessoiresAnnexes: Array<Modeles.IAccessoireAnnexe>, newAcc: Avenants.Rest.Modeles.DossierCreditAvenant.CaracteristiqueFinan.IAccessoire): Modeles.IAccessoireAnnexe;
    }
}
...
declare module Avenants.Business.Modeles {
    ...
    class AccessoireAssurance extends AbstractAccessoire implements IAccessoireAssurance {
        ...
        constructor(idIhm: number, idAssuranceIhm: number, accessoireParConvention: RestAvenant.CaracteristiqueFinan.IAccessoireParConvention, eltCalculAccessoire: RestAvenant.CaracteristiqueFinan.IElementCalculAccessoire, codeTypeAccessoireConvention: string, periodiciteCalculInteretsByPhase: string, devise: string, isChangementProduit: boolean);
...
declare module Avenants.Business.Modeles {
    ...
    interface IObjetAvecListeAccessoire {
        identifiant: string;
        listeAccessoire: Array<IAccessoire>;
        etatManipulation: Enum.EtatManipulation;
    }
}
...
declare module Avenants.Business.Modeles {
    ...
    class CreditInfosHelper {
        ...
        static getCreditHasNineOrMorePhase(listePhase: Array<RestCaraCredit.IInformationPhaseCredit>): boolean;
        static getIsCreditTitrise(infoGeneraleCredit: RestCaraCredit.IInformationGeneraleCredit): boolean;
    }
}
...
declare module Avenants.Business.Modeles {
    interface ICreditInfosByCaraCredit {
        ...
        isCreditInPrefinancement: boolean;
        creditHasNineOrMorePhase: boolean;
        isCreditTitrise: boolean;
    }
}
...
declare module Avenants.Business.Modeles {
    import RestAvenant = Avenants.Rest.Modeles.DossierCreditAvenant;
    import RestAssuranceCredit = Avenants.Rest.Modeles.AssuranceCredit;
    class PersonneAssurableGarantBuilder {
        static getResult(p: RestAvenant.CaracteristiqueFinan.IPersonneAssurableOuGarant | RestAvenant.Garanties.IPersonneAssurableOuGarantCatalogue, listeEncoursPersonneAssu: Array<RestAssuranceCredit.Recherche.IEncoursPersonneAssu>): IPersonneAssurableGarant;
        private static getDescriptionAge(dateNaissance);
        static getResultByRecherchePersonne(recherchePersonneRetour: myway.comGestionClient.RecherchePersonneRetour, listeEncoursPersonneAssu: Array<RestAssuranceCredit.Recherche.IEncoursPersonneAssu>): IPersonneAssurableGarant;
        private static getLibelleTiersPersonne(p);
        private static getLibelleTiersWithComplement(p);
        static getResultByPersonneEmprunteur(p: IPersonneEmprunteur, listeEncoursPersonneAssu: Array<RestAssuranceCredit.Recherche.IEncoursPersonneAssu>): IPersonneAssurableGarant;
        static getEncoursPersonneAssu(listeEncoursPersonneAssu: Array<RestAssuranceCredit.Recherche.IEncoursPersonneAssu>, identifiantPersonneEstAssu: string): RestAssuranceCredit.Recherche.IEncoursPersonneAssu;
        static existEncoursPersonneAssu(listeEncoursPersonneAssu: Array<RestAssuranceCredit.Recherche.IEncoursPersonneAssu>, identifiantPersonneEstAssu: string): boolean;
    }
}
...
declare module Avenants.Business.Modeles {
    ...
    interface IPhase {
        ...
        pretsCombinesPhases: Array<IPretCombinePhase>;
        showEncartPretCombinesPhase: boolean;
    }
...
declare module Avenants.Business.Modeles {
    ...
    class Phase implements IPhase {
         ...
         */
        reportNouvelleDureeToDernierePhase(newDuree: number, isAmortissementALaCarte: boolean): void;
        setLastPalierTauxAmortissement(): void;
        ...
        /**
         * Dans le cas d'un avenant sans changement de produit, on force la durée mini à 1 périodicité d'expression de durée
         * pour ne pas empecher une scission de phase en cas de renégociation de périodicite
         * @param codeRoleCreditAvenant:permet de déterminer s'il y a un changement de produit (U,P,C)
         * @param dureePhaseProduit:duree min a utiliser si changement de produit
         * @returns 1 si changement de produit. dureePhaseProduit sinon.
         */
        private getDureeMinPhase(codeRoleCreditAvenant, dureePhaseProduit);
        ...
        getPretsCombinesPhase(p: RestGestion.InformationCredit.IPhase): Array<Modeles.IPretCombinePhase>;
    }
}

declare module Avenants.Business.Modeles {
    import RestGestion = Avenants.Rest.Modeles.DossierCreditGestion;
    class PretCombinePhase implements IPretCombinePhase {
        codeEtablissement: number;
        identifiantCredit: string;
        numeroRelatif: number;
        codeRoleCreditAvenant: string;
        ...
        quotiteCapitalAAmortir: number;
        amortissementSuppFinPhase: number;
        constructor(pc: RestGestion.InformationCredit.IPretCombine);
    }
}
...
declare module Avenants.Business.ToolsFunctionals {
    ...
    import RestAvenant = Avenants.Rest.Modeles.DossierCreditAvenant;
    import RestGestion = Avenants.Rest.Modeles.DossierCreditGestion;
    interface IElementDatesPhaseSansDateAppelAccessoire {
        /**
    ...
    class ScissionPhase {
        ...
        static alimenterDatesPhase(listeElementDatesPhase: Array<IElementDatesPhaseSansDateAppelAccessoire>, dateMiseRecouvrementZero: string, phasesM: Array<Modeles.IPhase>): void;
        static alimenterDatesPhaseAvecDateAppelAccessoire(listeElementDatesPhase: Array<IElementDatesPhase>, dateMiseRecouvrementZero: string, phasesM: Array<Modeles.IPhase>): void;
        private static alimenterDateAppelAccessoire(listeElementDatesPhase);
...
declare module Avenants.Business.ToolsFunctionals {
    ...
    class PeriodicitePhase {
        ...
        static impactPeriodicitePhase(phaseSel: Modeles.IPhase, phasesOrigine: Array<Modeles.IPhase>, credit: RestGestion.InformationCredit.ICredit, isChangementProduit: boolean, nuepDebutPhase: number, nuepFinPhase: number, listeAccessoires: Array<RestAvenantParam.Produit.IAccessoire>, produitCodeProduitRevisable: string, isReportPeriodeUnePhase: boolean, listeElementCalculServicesObjet: Array<RestAvenant.ServicesObjet.IElementCalcul>): Array<Modeles.IPhase>;
        static controlerReportPeriodicite(phaseSel: Modeles.IPhase, phases: Array<Modeles.IPhase>, isChangementProduit: boolean, isReportPeriodeUnePhase: boolean): boolean;
        ...
        private static reportPeriodicitePhase(phaseSel, phase);
        private static reportPeriodiciteTemporairePhase(phaseSel, phase);
        ...
        static majPeriodiciteCreditChangePdt(creditChangePdt: Rest.Modeles.DossierCreditGestion.InformationCredit.ICredit, listePhaseStock: Array<Business.Modeles.IPhase>): void;
...
declare module Avenants.Business.Modeles {
    ...
    interface IDatesReglesAccessoireCalcul {
...
declare module Avenants.Business.Modeles {
    ...
    class CaracteristiqueFinanAccessoireBuilder {
        ...
        private static getAccessoireAnnexeAvenantFutur(dataCommonCaraFinan, codeTypeAcces, credit, a, dateEffet);
        private static getDateDebutApplicationElement(a, dateEffet);
        private static getDateFinApplicationElement(a, dateEffet, accessoireAnnexe, numeroPhase);
        private static getGererAccessoiresAnnexesFutureAvenant(dataCommonCaraFinan, codeTypeAcces, accAnnexe, listeAccessoiresAnnexes, credit, dateEffet, nouveauNumeroRelatif, listePhaseStock);
        private static getNouveauNumeroAccessoireAnnexe(listeAccessoiresAnnexes);
        private static getNouveauNumeroAccessoire(listeAccessoires);
        private static getCreerAccessoiresAnnexesFutureAvenant(acc, nouveauNumeroRelatif, listePhaseStock);
        private static getModifierAccessoiresAnnexesFutureAvenant(acc, credit, listeAccessoiresFuturesAnnexes);
        private static getAccessoiresAnnexesFuturesAvenant(dataCommonCaraFinan, codeTypeAcces, credit, acc, dateEffet, listeAccessoireAnnexe);
        ...
        private static getPeriodiciteApplicationElement(a, phase);
...
declare module Avenants.Business.ToolsFunctionals {
    class CaraFinan {
         ...
         */
        static getCodeTypeModificationCredit(listeModificationCredit: Array<Commun.Enum.ModificationCredit>, isTopCalculatrice: boolean, isAvecChangementProduit: boolean, isCreditInPrefinancement: boolean, isSecurisationOpenByReportFinPret: boolean): string;
    }
}
...
declare module Avenants.Business.Modeles {
    ...
    class AvenantDescriptionFactory {
         ...
         */
        private getDataRestAvenant(codeEtablissement, caraFinan, creditCurrentInfoCredit, produitCredit, listeIndice, palierCredit, dataPersonnes, dataObjet, dataGaranties, vraiCreditOrigine, listeTypesSinistres, dataServiceObjet, dataEltCalulServicesObjet, listeEncoursPersonneAssuHorsCreditEncours);
    }
}
...
declare module Avenants.Business.Modeles {
    ...
    class AvenantDescription extends AvenantDescriptionBehavior implements IAvenantDescription {
        ...
        isCreditLissage: boolean;
        isWithAssuranceCRDIn: boolean;
        isMaintienProfilAmortissement: boolean;
        ...
        isModificationPretCombine: boolean;
        ...
        setDataAssurancesForCalculatrice(): void;
        ...
        private getListeAccessoireAnnexe(listeAccessoiresAnnexes, dateEffet);
        findAccessoireAnnexeFantome(dateFinPriseEnCharge: Date, numeroPhaseCurrentInfoCredit: number): IAccessoireAnnexe;
        addAccessoireAnnexe(accessoireAnnexe: Business.Modeles.IAccessoireAnnexe): void;
        setAccessoireAnnexeEdition(accessoireAnnexe: Business.Modeles.IAccessoireAnnexe, action: Enum.ActionManipulationElement, listeAccessoiresAnnexes?: Business.Modeles.IAccessoireAnnexe[]): void;
        private setAccessoireAnnexeEdition2(accessoireAnnexe, action, listeAccessoiresAnnexes);
        ...
        static getNumEcheanceDebutFinPhase(creditOrigine: RestGestion.InformationCredit.ICredit): Array<number>;
        /**
...
declare module Avenants.Business.Modeles {
    ...
    interface IDataAvenantAssurances {
        ...
        listeEncoursPersonneAssuHorsCreditEncours: Array<Avenants.Rest.Modeles.AssuranceCredit.Recherche.IEncoursPersonneAssu>;
...
declare module Avenants.Business.Modeles {
    ...
    class AvenantResumeBuilder {
        ...
        private static getnumeroQuantiemeDateEcheance(elt);
    }
}
...
declare module Avenants.Business.Modeles {
    ...
    interface IDataBuildAvenantResume {
        ...
        listeEligibleSedEtablissement: _.Dictionary<boolean>;
    }
    /**
...
declare module Avenants.Business.Modeles {
     ...
     */
    interface IGarantie extends IObjetAvecListeAccessoire {
        etatManipulation: Enum.EtatManipulation;
        idGarantie: string;
        idIhmNouvelleGarantie: number;
        isCreationFirstEdition: boolean;
...
declare module Avenants.Business.Modeles {
    ...
    class CaracteristiqueFinanGarantieExistanteBuilder {
        ...
        private static getGarantieExistante(dataCommonCaraFinan, g, isAvenantAte);
        private static isGarantieModifieParAte(g);
        /**
        ...
        private static getListeCompleteElementCalculGarantie(dataCommonCaraFinan, g, isAvenantAte);
        /**
         * Gère la liste des  accessoires d'une sûreté personnelle
         */
        private static getListeElementCalculGarantie(dataCommonCaraFinan, g, isAvenantAte);
        /**
...
declare module Avenants.Business.ToolsFunctionals {
    class Assurance {
        static getAssuranceContientCrdIn(listeAssurances: Array<Business.Modeles.IAssurance>): boolean;
        private static getAccessoiresContientCrdIn(listeAccessoire);
        static estCreditLoiLemoine202311_2(credit: Avenants.Rest.Modeles.DossierCreditAvenant.CaracteristiqueFinan.ICredit | Avenants.Rest.Modeles.DossierCreditGestion.InformationCredit.ICredit, creditObjet: Rest.Modeles.DossierCreditAvenant.InformationObjet.ICreditObjet): boolean;
        static estCreditLoiLemoine202311(credit: Avenants.Rest.Modeles.DossierCreditAvenant.CaracteristiqueFinan.ICredit, credit2: Avenants.Rest.Modeles.DossierCreditAvenant.CaracteristiqueFinan.ICredit | Avenants.Rest.Modeles.DossierCreditGestion.InformationCredit.ICredit, creditObjet: Rest.Modeles.DossierCreditAvenant.InformationObjet.ICreditObjet): boolean;
        static estCreditTravauxAmeliorationLoiLemoine202311_2(credit: Avenants.Rest.Modeles.DossierCreditAvenant.CaracteristiqueFinan.ICredit | Avenants.Rest.Modeles.DossierCreditGestion.InformationCredit.ICredit, creditObjet: Rest.Modeles.DossierCreditAvenant.InformationObjet.ICreditObjet): boolean;
        static estCreditTravauxAmeliorationLoiLemoine202311(credit: Avenants.Rest.Modeles.DossierCreditAvenant.CaracteristiqueFinan.ICredit, credit2: Avenants.Rest.Modeles.DossierCreditAvenant.CaracteristiqueFinan.ICredit | Avenants.Rest.Modeles.DossierCreditGestion.InformationCredit.ICredit, creditObjet: Rest.Modeles.DossierCreditAvenant.InformationObjet.ICreditObjet): boolean;
    }
}
...
declare module Avenants.Business.ToolsFunctionals {
    ...
    class FonctionsAte {
        ...
        private static dupplicationAccessoireNouvellePhase(accessoireAssu, numeroPhaseEnCours);
        static scissionAccessoiresComplementaires(listeAccessoireOrigine: Array<Modeles.IAccessoireAnnexe>, numeroPhaseEnCours: number, isPremiereScissionAte: boolean): Array<Modeles.IAccessoire>;
        static scissionListeObjetAvecListeAccessoire(listeObjetAvecListeAccessoire: Array<Modeles.IObjetAvecListeAccessoire>, numeroPhaseEnCours: number, isSecondeScissionAte: boolean, isPremiereScissionAte: boolean): Array<Modeles.IObjetAvecListeAccessoire>;
        private static SetAccessoireAnnexeIndicateurAccessoireValide(accessoire);
...
declare module Avenants.Business.ToolsFunctionals {
    class Avenant {
        /**
         * Indique si l'avenant doit passer par la page d'ajustement des échéances et ainsi déclencher la calculatrice
         */
        static getIsTopCalculatrice(avenantDescription: Modeles.IAvenantDescription): boolean;
        static getDonneeIsCreditWithAjustementEcheances(avenantDescription: Modeles.IAvenantDescription): boolean;
    }
}
...
declare module Avenants.Business.ToolsFunctionals {
    ...
    import RestAssuranceCredit = Avenants.Rest.Modeles.AssuranceCredit;
    class Garantie {
        static getListeGarant(listePersonneAssurableOuGarant: Array<RestGaranties.IPersonneAssurableOuGarant>, listePersonneAssurableOuGarantCatalogue: Array<RestGaranties.IPersonneAssurableOuGarantCatalogue>, listeEncoursPersonneAssu: Array<RestAssuranceCredit.Recherche.IEncoursPersonneAssu>): Array<Modeles.IPersonneAssurableGarant>;
        /**
...
declare module Avenants.Business.ToolsFunctionals {
    class FonctionsPretCombine {
        static scissionPhaseEnCours(phaseEnCours: Modeles.IPhase, numeroEcheanceCreditS882: number, numeroEcheanceDebutPhase: number, numeroEcheanceFinPhase: number): Array<Modeles.IPhase>;
    }
}
...
declare module Avenants.Business.Modeles {
    ...
    abstract class AvenantDecorateur implements IAvenantDescription {
        ...
        isModificationPeriodicitePhaseFirst: boolean;
        isModificationPretCombine: boolean;
        isModificationPretCombin: boolean;
        isAmortissementALaCarte: boolean;
        typeCalculAjustementEcheances: Enum.TypeCalculAjustementEcheancesTaux;
        palierTauxInteretAvantCalculettes: Array<Business.Modeles.IPalier>;
...
declare module Avenants.Business.Modeles {
    ...
    class AvenantAssuranceDecorateur extends AvenantDecorateur {
        ...
        getDisabledValider(): boolean;
        /**
         * Recalcule les valeurs des données utilises à la calculatrice pour les données assurances
         */
        setDataAssurancesForCalculatrice(): void;
        /**
         * Somme des taux des accessoires x quotité
         * Prendre en compte les accessoires assurances + accessoires complémentaires
         *      Accessoire ayant une règle d’application NRFCEL=A03 (’Accessoire périodique intégrant l’échéance’ ) et un type d’assiette 33 (’CRD Théorique’)
         */
        private getIsMaintienProfilAmortissement();
        /**
         *  Avant avenant : somme de tous les accessoires des assurances et des accessoires complémentaires
         *      Accessoires qui sont intégrés au CRDIn
         */
        private getSommeAccessoireBeforeAvenant(nbPhase, listeAccComp);
        /**
         *  Après avenant : somme de tous les accessoires des assurances et des accessoires complémentaires
         *      Accessoires qui sont intégrés au CRDIn
         */
        private getSommeAccessoireAfterAvenant(nbPhase, listeAccComp);
        /**
         *  Pour avoir une même base de calcul pour comparer un accessoire d'une assurance et un accessoire complémentaire :
         *      De plus il faut prendre en compte le nombre de phases actives: pour savoir combien de fois l'accessoire complémentaire doit être compatibilité
         *      Dans l'objet il n'y a qu'un seul accessoire affiché, mais il est périodique donc il sera positionné sur toutes les phases..
         */
        private getTauxAccessoireComplementaire(taux, nbPhase);
    }
}
...
declare module Avenants.Business.Modeles {
    class AvenantAteDecorateur extends AvenantDecorateur {
        ...
        private isAccessoiresEquals(accOrigine, accessoireProduit);
        private modifAccessoireSansProduit(listeAccProduit, accOrigine);
...
declare module Avenants.Business.Modeles {
    ...
    class AvenantCreditDecorateur extends AvenantDecorateur {
        ...
        private getPhases(creditByInfoCredit, produitCredit, listeIndice, palierCredit, dateTraitement, dateFinPrefinancementReelle, creditChangePdt, listePhases, creditAvenantFinancier, nouvellePhaseAMSupOrigine, isAvenantRecouvrement, codeTypeAcces);
...
declare module Avenants.Business.Modeles {
    ...
    class GarantieSuretePersonnelle implements IGarantieSuretePersonnelle {
        ...
        private getIsQuotiteModifiable(c, cautionnementGarantie);
