...
declare namespace ICBusiness.Constantes {
    ...
    namespace Personne {
         ...
         *  - M : Personne morale
         */
        const codeTypesPersonne: (newSearchActivated: boolean) => Models.Common.ICodeLabel<number>[];
...
declare namespace ICBusiness.Constantes.ParametrageApplicatif {
    ...
    namespace RedacteurActe {
        const bt95DesactivationNewSearch: string;
    }
    namespace Green {
...
declare namespace ICBusiness.Services.Green {
    interface IDossierGreenService {
        ...
        getContextLisa(dossierGreen: ICBusiness.Models.Green.IDossierGreen, projet: ICBusiness.Models.Projet.IProjet, codeEtablissement: string, mode: ICBusiness.Enum.ModeOuvertureDossier): ICBusiness.Models.Navigation.LisaContract.ADD.IGreenContext;
    }
...
declare namespace ICBusiness.Services.ParametrageApplicatif {
    interface IParametrageAppicatifService {
        ...
        desactivationNewSearchNotaire(dateDeTraitement: string, codeEtablissement: string): ng.IPromise<boolean>;
