...
declare module GestionGeneriqueOffres.Types.Authentification {
    ...
    interface IClientSignataireAuthentification extends myway.comContract.modeles.ISignataireComplet {
        ...
        idUsager?: string;
        /**
         * identifiant BAD du titulaire PM/EI en lien avec le signataire
         */
        idBadTitulaire?: string;
    }
...
declare module GGOCommunEpi.Modele {
    ...
    class IndicateurPourPrioriteAfficherMedia {
        static ISSU_DE_LIEN: string;
        static PROF_ISSU_DE_PART: string;
        static PERSO_ISSU_DE_PART: string;
    }
}
...
declare module GGOCommunEpi.Modele {
    ...
    interface IMediasSignatairesPros {
        ...
        listeAutresTitulairesCompte?: Array<IAutreTitulaireCompte>;
        estBlocagePapierActif?: boolean;
    }
    ...
    interface IAutreTitulaireCompte {
        titulaireCompte: ITitulaireCompte;
        listeSignataires: Array<ISignataireSimplifie>;
    }
    /**
    ...
    interface IProfilMediaSignataire {
        valeurMedia: string;
        IndicateurPrioriteMedia: GGOCommunEpi.Modele.IndicateurPourPrioriteAfficherMedia;
    }
}
...
declare module GGOCommunEpi {
    ...
    module AuthentificationIhmConst {
        const LIB_MODE_SIGNATURE_ELECTRONIQUE: string;
    ...
    class MediasEsignature {
        ...
        raisonForcagePapier: string;
        figerModesSignature: boolean;
        figerDestinatairesMail: boolean;
        figerSignatairesMail: boolean;
        ...
        presenceSignatairePersProt: boolean;
        numeroPersonneProtegee: number;
        listeAutresTitulairesCompte: Array<GGOCommunEpi.Modele.IAutreTitulaireCompte>;
        private presenceAutresTitulairesCompte;
        private indexAutresTitulairesCompte;
        private listeClientsSignatairesPartielle;
        estBlocagePapierActif: boolean;
        appliquerBlocagePapier: boolean;
        ...
        /**
         * Indique si le n° de téléphone passé en paramètre est déjà présent dans la liste. Si le n° n'y est pas encore, on retourne true.
         * @param listeTelAdminPro
         * @param numTel
         */
        ...
        valider(): void;
        private rechargerTitulaireCompte(titulaireCompte);
        private rechargerListeSignataires(listeSignataires);
        ...
        desactiverModePapier(): boolean;
        desactiverModeElectronique(): boolean;
        desactiverDestinataireMailOperant(): boolean;
        desactiverDestinataireMailSuiviPar(): boolean;
        desactiverSignataireMailOperant(): boolean;
    }
}
