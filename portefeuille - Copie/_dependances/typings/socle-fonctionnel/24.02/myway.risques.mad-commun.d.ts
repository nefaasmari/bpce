...
declare namespace Mad.Commun.Constantes.DecisionSiege {
    const EXTOURNE: string;
    const FORCAGE_SIMPLE: string;
    const FORCAGE_AUTRE_RIB: string;
    const PERTE_PROFIT: string;
    const COMPENSATION: string;
    const TRAITEMENT_CHEQUE_BANQUE: string;
    const TRANSFERT_AUTRE_SERVICE: string;
    const SORTIE_COMPTABLE: string;
}
declare namespace Mad.Commun.Constantes.OrigineDecision {
    const SIEGE: string;
    const AGENCE: string;
}
...
declare namespace Mad.Commun.Constantes.Lisa {
    ...
    const SYNTH_ROUT_VERS_SYNT: number;
...
declare module Mad.Commun.Enum {
    ...
    enum CodeTypeDecisionSiegeEnum {
        EXTOURNE = "E",
        FORCAGE_SIMPLE = "F",
        FORCAGE_AUTRE_RIB = "T",
        PERTE_PROFIT = "P",
        COMPENSATION = "R",
        SORTIE_COMPTABLE = "S",
        TRAITEMENT_CHEQUE_BANQUE = "C",
        TRANSFERT_AUTRE_SERVICE = "Z"
    }
...
declare namespace Mad.Commun.Directive {
    class MadInfoEntiteControleur {
         ...
         */
        debrancherSyntheseClient(identifiantPersonne: number): void;
        /**
        ...
        /**
         * Débranche vers La gestion des opposition du compte de la personne
         */
        debrancherVersOppositions(identifiantPersonne: number): ng.IPromise<void>;
...
declare namespace Mad.Commun.Services {
    import ModeleRest = Rest.MouvAttenteDecision.Modele.InfoSpecifiqueETMad;
    interface IInformationsEntiteService {
        getInformationsEntite(param: ModeleRest.IParametreGet): ng.IPromise<Modeles.Application.IInformationsEntiteTitulaire>;
    }
}
...
declare namespace Mad.Commun.Services {
    interface IDecisionsUtilsService {
        ...
        getLibelleDecisionSiege(codeDecision: string): string;
