...
declare namespace AssuranceAdeCredit.Services {
    interface IPropositionAssuranceService {
        ...
        creerPropositionAssurance(idDossier: string, idPersonnes: string[], idCredits: string[], codeCollectivite: string, estParcoursManuel: boolean, estResidentFiscal: boolean, recuperationArgumentaire: boolean, quotite: number, tarifDerogatoire: boolean): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
        /** Récupère les données de la proposition d'assurance (sans mise à jour) */
        lirePropositionAssurance(idDossier: string, idCredits: string[], nomPropositions: Modeles.INomProposition[], estParcoursManuel: boolean, estResidentFiscal: boolean, quotite: number): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
        /**
         ...
         * @param recuperationArgumentaire
         */
        majPropositionAssurance(idDossier: string, idCredits: string[], nomPropositions: Modeles.INomProposition[], quotite: number, tarifDerogatoire: boolean, actualQuotite: number, estParcoursManuel: boolean, estResidentFiscal: boolean, recuperationArgumentaire: boolean): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
        /**
         ...
         * @param recuperationArgumentaire
         */
        mapDatasEntreesPropAssurancesAfterDelete(propositionAssurance: Modeles.Proposition.IPropositionsAssurance, deletedAssuranceByAssure: Modeles.Proposition.IDeletedAssuranceByAssure[], idDossier: string, tarificationDerogatoireValue: boolean, quotite: number, estParcoursManuel: boolean, estResidentFiscal: boolean, recuperationArgumentaire: boolean): Modeles.Rest.MajPropAssurance.IEntreePropositionAssurances[];
        /**
    ...
    class PropositionAssuranceService implements IPropositionAssuranceService {
        ...
        mapDatasEntreesPropAssurancesAfterDelete(propositionAssurance: Modeles.Proposition.IPropositionsAssurance, deletedAssuranceByAssure: Modeles.Proposition.IDeletedAssuranceByAssure[], idDossier: string, tarificationDerogatoireValue: boolean, quotite: number, estParcoursManuel: boolean, estResidentFiscal: boolean, recuperationArgumentaire?: boolean): Modeles.Rest.MajPropAssurance.IEntreePropositionAssurances[];
        majPropositionAssuranceAfterDelete(entreesPropAss: Modeles.Rest.MajPropAssurance.IEntreePropositionAssurances[], defaultQuotite: number): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
        majPropositionAssurance(idDossier: string, idCredits: string[], nomPropositions: Modeles.INomProposition[], quotite: number, tarificationDerogatoire: boolean, actualQuotite: number, estParcoursManuel: boolean, estResidentFiscal: boolean, recuperationArgumentaire?: boolean): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
        enregistrerPersonnalisationAssurance(idDossier: string, proposition: Modeles.Proposition.IPropositionsAssurance, estSaisieManuelle: boolean): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
        /**
         ...
         */
        private getDataEntree(idDossier, nomProposition, idCredits, estParcoursManuel, estResidentFiscal, recuperationArgumentaire, quotite?, tarificationDerogatoire?);
        /**
         ...
         */
        private getDataCreerEntree(idDossier, idPersonne, idCredits, idProposition, codeCollectivite, estParcoursManuel, estResidentFiscal, recuperationArgumentaire, quotite?, tarificationDerogatoire?);
