...
declare module Avenants.Commun.Enum {
    ...
    class MotifDeliaisonAssurance extends MyWay.Services.StringEnum {
        static aucun: MotifDeliaisonAssurance;
    ...
    class CodeGrilleTarifaire extends MyWay.Services.StringEnum {
        static tarifImmoStandard: CodeGrilleTarifaire;
        static tarifImmoCollaborateur: CodeGrilleTarifaire;
        static tarifImmoCasden: CodeGrilleTarifaire;
        static tarifConsoStandard: CodeGrilleTarifaire;
        static tarifConsoCollaborateur: CodeGrilleTarifaire;
        static tarifConsoCasden: CodeGrilleTarifaire;
        static tarifCOD: CodeGrilleTarifaire;
        static tarifCHF: CodeGrilleTarifaire;
        static tarifLocatif: CodeGrilleTarifaire;
        static tarifAvecQuestionnaireSante: CodeGrilleTarifaire;
        static tarifSansQuestionnaireSante: CodeGrilleTarifaire;
    }
}
...
declare module Avenants.Commun.Constantes {
    module Donnees {
        ...
        const codeParameApplicatifSignatureElecLoiImmo: string;
        const codeParameApplicatifSignatureElecLoiConso: string;
        const codeParameApplicatifSignatureElecAutreLoiPart: string;
        const codeParameApplicatifSignatureElecPro: string;
        /**
...
declare module Avenants.Commun.Services {
    interface ICacheService {
         ...
         * Utiliser pour les méthodes qui consomment des appels ROA
         * @param key
         * @param promise
        ...
        /**
         * Tente de récupérer des objets mis en session
         * Utiliser par exemple pour passer des élements lors d'un débranchement
         */
        getObjectsSession<T>(listeKey: Array<string>): ng.IPromise<Array<T>>;
        /**
         * Stocke un élément dans la session sous forme de promesse
         * Pas en objet simple car après impossible de le récupérer avce tous les éléments souhaités
         */
        setObjectSession<T>(key: string, object: T): void;
    }
}
...
declare module Avenants.Commun.ToolsFunctionals {
    class Accessoire {
        static getLibelleTypeAssiette(codeTypeAssiette: string, numeroRegleApplicationElement?: string): string;
...
declare module Avenants.Commun.ToolsFunctionals {
    class Assurance {
        ...
        static getCodeGrilleTarifaireByCode(code: string): Enum.CodeGrilleTarifaire;
        /**
         * Est-ce que le code type d'assurance correspond à une assurance perte emploi?
         */
        static estCodeTypeAssurancePerteEmploi(code: string): boolean;
        static estCodeTypeAssuranceLoiLemoine202311(code: string): boolean;
    }
}
...
declare module Avenants.Commun.ToolsFunctionals {
    class Avenant {
        ...
        /**
         * @param codeRoleCreditAvenant: CTFNCA
         * @returns (codeRoleCreditAvenant === "U" || codeRoleCreditAvenant === "P" || codeRoleCreditAvenant === "C")
         */
        static isChangementProduit(codeRoleCreditAvenant: string): boolean;
    }
}
...
declare module Avenants.Commun.ToolsFunctionals {
    ...
    class DateEffetHelper {
        ...
        /**
         * Pour les avenants technique et recouvrement, la date d'effet doit dans certains cas être positionné au quantième
...
declare module Avenants.Commun.ToolsFunctionals {
    class Duree {
        /**
         * Créer la chaine d'aide pour la sélection d'une durée
         * (Mode expression de la durée de type "Une ou plusieurs périodes renseignées")
         * @param dureesCatalogues: tableau des durées autorisées par ordre croissant.
         * @returns string de la forme [<duree1>, <duree2>, <duree3>]
         */
        static getLibelleHelpDuree(dureesCatalogues: number[]): string;
    }
}
