...
declare module libPortail {
    class Application {
         ...
         */
        private getValueElementByIdZoneAndIdElement(elementId, zoneId);
        /**
         * Renvoie la valeur d'un élément pour une zone donnée.
         * Si cette valeur n'est pas définie, on remonte dans les zones parentes jusqu'à trouver une valeur.
         * Renvoie null si aucune n'est trouvée.
         * @param elementId Identifiant de l'élément
         * @param zoneId Identifiant de la zone
         */
        private getValeurElementByIdAndZone(elementId, zoneId);
        /**
         * Renvoie la valeur par défaut d'un élément pour une zone donnée.
         * Si cette valeur n'est pas définie, on remonte dans les zones parentes jusqu'à trouver une valeur.
         * Renvoie null si aucune n'est trouvée.
         * @param elementId Identifiant de l'élément
         * @param zoneId Identifiant de la zone
         */
        private getValeurDefautByElementAndZone(elementId, zoneId);
        /**
        ...
        /**
         * Cast d'une valeur à partir de son type
         */
...
declare module libPortail {
    class ApplicationService {
        ...
        getApplication(params: myway.ressources.portailmyway.application.IGetQueryParams): ng.IPromise<myway.ressources.portailmyway.application.IApplication>;
...
declare module libPortail {
    class ContexteClientService extends myway.core.FrameworkService {
        ...
        private edsService;
        static $inject: string[];
        constructor($injector: ng.auto.IInjectorService, $q: ng.IQService, $parse: ng.IParseService, logger: myway.core.LoggerService, agentService: myway.core.AgentService, tiersService: TiersService, edsService: EdsService);
        /**
...
declare module libPortail {
    class ProcessusService {
         ...
         * @param idZone Identifiant de la zone (constantes Zone)
         * @param scope Scope applicable au contexte Lisa
         */
        lancerApplication(application: Application, idZone: string, scope?: IScopeContexteLisa): ng.IPromise<void>;
        /**
         * Démarrer un processus à partir d'un code et d'autres paramètres
         */
        lancerProcessus(params: IStartProcess, application?: fwkManager.Services.Application.ApplicationDTO): ng.IPromise<void>;
        /**
...
declare module libPortail {
    class ContexteLisaService {
        ...
        private agentService;
        static $inject: string[];
        constructor($q: ng.IQService, $parse: ng.IParseService, $interpolate: ng.IInterpolateService, logger: myway.core.LoggerService, agentService: myway.core.AgentService);
