...
declare module myway.gestionEpargne.commun {
     ...
     */
    abstract class ProduitServiceControleur<D extends GestionGeneriqueOffres.Types.IDetenteur, S extends GestionGeneriqueOffres.Types.DossierDeVente.IDonneeSauvegardeProduitService> implements IControleur {
        protected $q: ng.IQService;
        protected $scope: ng.IScope;
        protected serviceAgentExtended: MyWay.Services.ServiceAgentExtended;
        protected creerDossierDeVenteService: myway.gestionEpargne.commun.CreerDossierDeVenteService;
        protected epargneCommunService: EpargneCommunService;
        protected ggoService: GgoService;
        protected offreUtilService: OffreUtilService;
        protected psEpargne: string;
        protected psService: ProduitService;
        protected serviceTrace: ServiceTrace;
        private constructorTimer;
        idBloc: string;
        modeAcces: string;
        ...
        protected abstract getVueMDEC(): GestionGeneriqueOffres.Types.DossierDeVente.BlocMDEC;
        ...
        abstract initQueryAndBodyCaracteristiqueGeneral(modeFonctionnement: string): void;
        abstract miseEnGestionOffreOuverture(): ng.IPromise<GestionGeneriqueOffres.Types.ErreurGestionGeneriqueOffre[]>;
        validerDonneesOuverture: GestionGeneriqueOffres.Types.IPointEntreeFonctionValidation;
        miseEnGestionOuverture: GestionGeneriqueOffres.Types.IPointEntreeFonctionMiseEnGestion;
        validerDonneesAvenant: GestionGeneriqueOffres.Types.IPointEntreeFonctionValidation;
        miseEnGestionAvenant: GestionGeneriqueOffres.Types.IPointEntreeFonctionMiseEnGestion;
        chargementTermine: boolean;
        constructor($q: ng.IQService, $scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, creerDossierDeVenteService: myway.gestionEpargne.commun.CreerDossierDeVenteService, epargneCommunService: EpargneCommunService, ggoService: GgoService, offreUtilService: OffreUtilService, psEpargne: string, psService: ProduitService, serviceTrace: ServiceTrace);
        protected getIdegps(): number;
        protected initialiserComposant(): ng.IPromise<void>;
        private initialiser();
        protected initPointEntree(): void;
        private notifieChargementTermine();
         ...
         * @Return: un object contenant deux blocs:
        ...
        protected isForcageVPC(): boolean;
        protected getCodeActeGestionComplet(): string;
        /**
         * Envoie un événement à GGO contenant la référence produit, si la mise en gestion s'est bien passée
         */
        emitReferenceProduit(forceEmit?: boolean): void;
        private emitRoutageEditique();
        emitErreur(tabErreurs: GestionGeneriqueOffres.Types.ErreurGestionGeneriqueOffre[]): void;
    }
}
...
declare module myway.gestionEpargne.commun {
    class DemandeFicobaService {
        ...
        constructor($q: ng.IQService, produitService: ProduitService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        /**
...
declare module myway.gestionEpargne.commun {
    interface IEligibiliteLivretParams {
        /**
         * Code canal SEPA
         * 'PTU' 	Poste de travail
         * 'DEI' 	Direct Ecureuil Internet
         * 'CEN' 	CENET
         * 'MOB' 	Mobile
         * 'P2P' 	P2P
         * 'TEL' 	Serveur vocal
         * 'SBS' 	Batch SBS
         */
        codeCanalSepa: string;
        /**
         * Numéro IBAN compte émetteur
         */
        numibanCompteEmetteur: string;
        /**
         * Code sens échange
         * "E": Emetteur , "R" : Récepteur
         */
        codeSensEchange: string;
        /**
         * Type de fonction brique éligibilité
         */
        typeFonctionBriqueEligibilite: string;
        /**
         * Code BANQUE compte récepteur
         */
        ...
        /**
         * Numéro Entité titulaire bénéficiaire
         */
        numEntiteTitulaireBeneficiaire: string;
        /**
         * Indicateur de virement permanent
         * "O" : quand la date de 1ère échéance est différente de la date de dernière échéance
         * "N" : dans tous les autres cas
         */
        indicateurVirementPermanent: string;
    }
    interface IEligibiliteLivretReponse extends IEligibiliteLivretParams {
        /**
         * Code réponse brique éligibilité virement
         * "O": le virement est accepté, passer à la suite du traitement existant
         * "N": refuser le virement et afficher le message adéquat au client
         */
        codeReponse: string;
        /**
         * Code motif refus brique éligibilité
         * Code à traduire par un libellé à afficher au client : tableau de correspondance ci-après.
         * Si la correspondance n’existe pas alors afficher :
         * ‘Ce virement n’est pas conforme.’
         */
        codeMotifRefus: string;
        /**
         * Libellé réponse brique éligibilité
         * Libellé à afficher directement au client, éventuellement.
         */
...
declare module myway.gestionEpargne.commun {
    ...
    class GgoService {
        ...
        formulaireKoValidation(error: string, tabErreurs: GestionGeneriqueOffres.Types.ErreurGestionGeneriqueOffre[], bloquant?: boolean): GestionGeneriqueOffres.Types.ErreurGestionGeneriqueOffre[];
        /**
...
declare module myway.gestionEpargne.commun {
    class OffreUtilService {
        ...
        private operationFinanciereService;
        private serviceTrace;
        private eligibiliteLivretService;
        static $inject: string[];
        ...
        controlerVersements(versementPeriodique: MyWay.Model.VersementPeriodique, operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere, contexte: GestionGeneriqueOffres.Types.DonneesContextuelles, libelleProduit: string): ng.IPromise<GestionGeneriqueOffres.Types.ErreurGestionGeneriqueOffre[]>;
        private isVersementPeriodiqueOK(libelleProduit, versementPeriodique, contexte);
        private isOperationFinanciereOK(operationFinanciere, contexte);
        /**
         ...
         * @returns {ng.IPromise<GestionGeneriqueOffres.Types.ErreurGestionGeneriqueOffre[]>} tableau des possibles erreurs survenues lors de la transaction pour renvoi à GGO
         */
        validerOffreAvenantSimple(controleur: IControleur, libelleProduit?: string, modalOptions?: any): ng.IPromise<GestionGeneriqueOffres.Types.ErreurGestionGeneriqueOffre[]>;
        /**
        ...
        /**
         * @deprecated utiliser initDonneesProduitEngage
        ...
        /**
         * Initialise les données pour le credit COOP
         * @param {GestionGeneriqueOffres.Types.DonneesContextuelles} contexte - le contexte du produit transmis par GGO
         * @param {boolean} modeRevenir - indique si l'on a fait retour
         * @param {boolean} enModification - indique si l'on est en avenant
         * @param {string} codeSousFamilleActeGestion - OU, AV, CL
         * @param {string} codeProduit - CODIPR
         * @returns {IPromise<void>}
         */
        initDonneesProduitEngage(contexte: GestionGeneriqueOffres.Types.DonneesContextuelles, modeRevenir: boolean, enModification: boolean, codeSousFamilleActeGestion: string, codeProduit: string): ng.IPromise<transProduitEngage.Model.DonneesProduitEngage>;
        /**
...
declare module myway.gestionEpargne.commun {
    ...
    class ProduitService {
        private timers;
        constructor();
        initTimer(libelle: string, verbe?: string, url?: string): GestionGeneriqueOffres.Types.ITimerServicesRest;
        updateTimer(timer: GestionGeneriqueOffres.Types.ITimerServicesRest): GestionGeneriqueOffres.Types.ITimerServicesRest;
        getTimers: () => GestionGeneriqueOffres.Types.ITimerServicesRest[];
    }
}
...
declare module myway.gestionEpargne.commun {
    ...
    class ServiceTrace {
         ...
         * @return {void}
         */
        log(message?: string, object?: any, logType?: LogType): void;
        /**
        ...
        traceServiceLogger(logType: LogType, message: string, object?: any): void;
        private getTime();
    }
}
...
declare module myway.gestionEpargne.commun {
    class EligibiliteLivretService {
        private $q;
        private serviceAgentExtended;
        private serviceTrace;
        static $inject: string[];
        private restServiceUrl;
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, serviceTrace: myway.gestionEpargne.commun.ServiceTrace);
        isCompteEligible(codeEtablissement: string, idEntitieTitulaire: string, codeTypeProduit: string, contrat: MyWay.Model.Contrat, rice: MyWay.Model.Rice, isVirementPermanent?: boolean): ng.IPromise<boolean>;
        private postEligibiliteLivret(compte, codeEtablissement, codeTypeProduit, idEntitieTitulaire, isVirementPermanent);
    }
}
