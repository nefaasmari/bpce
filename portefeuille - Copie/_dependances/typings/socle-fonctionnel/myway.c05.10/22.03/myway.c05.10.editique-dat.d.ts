...
declare module myway.gestionEpargne.editiqueDat {
    ...
    class EditiqueDatControleur {
        ...
        static CONTEXTE_ESIGNATURE_EPI: string;
        static CONTRACTUALISATION_ACTE: string;
        private contexteEditiqueGGHO;
        private contexteESignatureEPI;
...
declare module myway.gestionEpargne.editiqueDat {
    ...
    interface IContexteSignature {
        liasses: ILiasse[];
        entiteTitulaire: IEntite;
        codeGuichetContrat: string;
        codeEtablissementContrat: string;
        referenceProduitServiceContrat: string;
        codeDebranchement: string;
        contexteEditique: any;
        cleContexteEditique: string;
        titulaire: number;
        listePersonneLiees?: GestionGeneriqueOffres.Types.DossierDeVente.PersonneLiee[];
        agentSignataire?: myway.comContract.Enums.SignatureAgentEmailEnum;
        pointEntree?: number;
    ...
    interface ILiasse {
        ...
        dvACompleter?: GestionGeneriqueOffres.Types.DossierDeVente.BlocMDEC;
    }
    interface IEntite {
