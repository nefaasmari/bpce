...
declare module myway.gestionEpargne.gghoCommun {
    ...
    class DonneesSauvegardeProduitServiceDATService {
        private enregistrerOpeFiDansDVService;
        static $inject: string[];
        constructor(enregistrerOpeFiDansDVService: myway.gestionEpargne.gghoCommun.EnregistrerOpeFiDansDVService);
        /**
         ...
         */
        creerDonneesSauvegardeProduitServiceDAT(operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere): GestionGeneriqueOffres.Types.DossierDeVente.IDonneeSauvegardeProduitService;
    }
}
...
declare module myway.gestionEpargne.gghoCommun {
    class EnregistrerDonneeOuvertureDansDVService {
        ...
        private recherchePieceJustifService;
        static $inject: string[];
        constructor($q: ng.IQService, operationFinanciereService: myway.comOpesFinancieres.OperationFinanciereService, recherchePieceJustifService: myway.gestionEpargne.gghoCommun.RecherchePieceJustifService);
        /**
         ...
         * @returns {GestionGeneriqueOffres.Types.DossierDeVente.BlocMDEC}
         */
        getVueMDECDonneeOuvertureQuadreto(donneesOuverture: horsOffre.commun.DonneesOuvertureQuadreto, contexte: GestionGeneriqueOffres.Types.DonneesContextuelles): ng.IPromise<GestionGeneriqueOffres.Types.DossierDeVente.BlocMDEC>;
...
declare module myway.gestionEpargne.gghoCommun {
    class EnregistrerOpeFiDansDVService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, operationFinanciereService: myway.comOpesFinancieres.OperationFinanciereService, epargneCommunService: EpargneCommunService);
        /**
...
declare module myway.gestionEpargne.gghoCommun {
     ...
     */
    class RecherchePieceJustifService {
        private $q;
        private serviceAgentExtended;
        static $inject: string[];
        private restServiceUrl;
         ...
         */
        putPieceJusificatif(iRecherchePieceJustif: IRecherchePieceJustif, tauxVersementComplementaire?: number): ng.IPromise<IRecherchePieceJustif>;
    }
}
