...
declare module myway.gestionEpargne.horsOffre.commun {
     ...
     */
    const CONTEXTE_PROCESSUS_DAT: string;
...
declare module myway.gestionEpargne.horsOffre.commun {
    ...
    class ContexteProcessusService {
        ...
        /**
         * Définit le contexte processus
         * @param {DonneesContextellesDAT} donneesContextuellesDAT
         * @param {DonneesProduitDAT} donneesProduitDAT
         * @param {string} codeOptionRegimeGeneral - code fiscalité client issu de la simulation
         * @returns {ng.IPromise<void>}
         */
        setContexteProcessusDAT(donneesContextuellesDAT: DonneesContextellesDAT, donneesProduitDAT: DonneesProduitDAT, codeOptionRegimeGeneral: string): ng.IPromise<void>;
        /**
         * Recupère les données du DAT à ouvrir
         * @returns {ng.IPromise<DonneesOuvertureDAT>}
         */
        getDonneesDAT(): ng.IPromise<DonneesOuvertureDAT>;
        /**
         * Instancie l'objet de données DAT
         * @returns {ng.IPromise<DonneesOuvertureDAT>}
         */
        private initialiserDonneesDAT();
    }
}
...
declare module myway.gestionEpargne.horsOffre.commun {
    /**
     * Structure de données du contexte processus
     */
    class ContexteProcessusDAT {
        /**
