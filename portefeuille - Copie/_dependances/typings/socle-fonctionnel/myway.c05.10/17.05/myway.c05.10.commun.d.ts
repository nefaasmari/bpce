...
declare module myway.gestionEpargne.commun {
    class LibelleProduitEpargneService {
        static COMPOSANT_COMPTE_ATTENTE: string;
        static COMPOSANT_COMPTE_EPARGNE_LOGEMENT: string;
        static COMPOSANT_LIVRET_B: string;
        static COMPOSANT_LIVRET_DEVELOPPEMENT_DURABLE: string;
        static COMPOSANT_LIVRET_EPARGNE_POPULAIRE: string;
        static COMPOSANT_LIVRET_GRAND_PRIX: string;
        static COMPOSANT_LIVRET_JEUNE: string;
        static COMPOSANT_PLAN_EPARGNE_LOGEMENT: string;
        static COMPOSANT_RELEVE_LIVRET: string;
