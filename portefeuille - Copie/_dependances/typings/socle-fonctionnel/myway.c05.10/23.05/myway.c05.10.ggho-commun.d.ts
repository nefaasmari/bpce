...
declare module myway.gestionEpargne.gghoCommun {
    ...
    class OuvertureProduitControleur {
        ...
        constructor($scope: ng.IScope, $q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, contexteProcessusService: myway.gestionEpargne.horsOffre.commun.ContexteProcessusService, identifiantBordereauService: myway.comInterdomaine.IdentifiantBordereauService, saisieRiceService: myway.comInterdomaine.SaisieRiceService, postOperationFinanciere: myway.comOpesFinancieres.PostOperationFinanciereService, opeFiService: OpeFiService, ouvertureProduitService: OuvertureProduitService, gghoService: GghoService, resultatCommercialService: ResultatCommercialService, blocMDECDATService: myway.gestionEpargne.gghoCommun.BlocMDECDATService, creerDossierDeVenteService: myway.gestionEpargne.gghoCommun.CreerDossierDeVenteService, donneesSauvegardeProduitServiceDATService: myway.gestionEpargne.gghoCommun.DonneesSauvegardeProduitServiceDATService, modalService: MyWay.UI.ModalService);
        ...
        private verifierListeSignataires();
        /**
...
declare module myway.gestionEpargne.gghoCommun {
    class OpeFiService {
         ...
         */
        initialiserOperationFinancierePourComposant(codeTypeProduit: string, numeroPersonne: string, compte: MyWay.Model.Compte, codeCanal?: string, codeFonctionnalite?: string, codeModeDeVenteCalcule?: string): myway.comOpesFinancieres.Model.OperationFinanciere;
        private paddy(n, p, c);
...
declare module myway.gestionEpargne.gghoCommun {
    ...
    class AdapteurOuvertureProduit {
        protected saisieRiceService: myway.comInterdomaine.SaisieRiceService;
        protected operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere;
        protected serviceAgentExtended: MyWay.Services.ServiceAgentExtended;
        ...
        constructor(saisieRiceService: myway.comInterdomaine.SaisieRiceService, operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        /**
         ...
         */
        initialiserOperationFinancierePourRessource(segmentPRVRIO: myway.comOpesFinancieres.Model.SegmentPRVRIO, segmentPRJO: myway.comOpesFinancieres.Model.SegmentPRJO, serviceAgentExtended: MyWay.Services.ServiceAgentExtended): IOperationFinanciere;
        /**
...
declare module myway.gestionEpargne.gghoCommun {
    class EligibiliteLivretService {
        ...
        private restServiceUrl;
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        isCompteEligible(codeEtablissement: string, idEntitieTitulaire: string, contrat: MyWay.Model.Contrat, rice: MyWay.Model.Rice): ng.IPromise<boolean>;
        postEligibiliteLivret(compte: string, codeEtablissement: string, idEntitieTitulaire: string): ng.IPromise<boolean>;
    }
}
