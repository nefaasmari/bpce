...
declare module myway.gestionEpargne.commun {
    class DemandeFicobaService {
        ...
        private $scope;
        private serviceAgentExtended;
        private rechercheDossierDeVenteService;
        private modalService;
        static $inject: string[];
        ...
        constructor($q: ng.IQService, $scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, rechercheDossierDeVenteService: myway.gestionEpargne.commun.RechercheDossierDeVenteService, modalService: MyWay.UI.ModalService);
        /**
        ...
        messageErreur(errorBody: string, erreur?: MyWay.Services.Erreur): ng.IPromise<any>;
        private paddy(n, p, c);
    }
}
...
declare module myway.gestionEpargne.commun {
    class RechercheDossierDeVenteService {
        private $q;
        private $scope;
        private serviceAgentExtended;
        private modalService;
        ...
        private contexte;
        private errotab;
        flagDeRecherche: boolean;
        constructor($q: ng.IQService, $scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, modalService: MyWay.UI.ModalService);
        rechercheDansDossierDeVente(): ng.IPromise<Array<IDossierVente>>;
        /**
         * Permet d'obtenir les info du service rest ou du cache local
         * @param {IRecherche} criteres
         * @returns {ng.IPromise<IDossierVente>}
         */
        sendRechercheRequest(criteres: IRecherche): ng.IPromise<Array<IDossierVente>>;
        /**
         * M�thode alimentation des crit�res de recherche dossier de vente.
         * @param {numeroInterneEds: string} data : numeroInterneEds
         * @param {statutEtape: string} data : EAMS, EAPS
         * @param {codeActeGestion?: string} data : codeActeGestion : SV00008107 OPTIN, SV00001157 CSEP, SV00008040 PPE
         */
        remplissageCriteresRechercheDV(numeroInterneEds: string, statutEtape: string, codeActeGestion?: string, momentDeVie?: string): any;
        messageErreur(erreur: MyWay.Services.Erreur, errorBody: string): ng.IPromise<any>;
    }
}
...
declare module myway.gestionEpargne.commun {
    class EpargneCommunService {
        ...
        static $inject: string[];
        contexte: GestionGeneriqueOffres.Types.DonneesContextuelles;
        constructor(espaceGlobalService: myway.c0410.commun.EspaceGlobalService, controlePersonneProtegeService: myway.gestionEpargne.commun.ControlePersonneProtegeService);
        /**
...
declare module myway.gestionEpargne.commun {
    ...
    class FiltreCodeProduitService {
        ...
        getFiltreProduit(produit: string, isAppelBdr?: boolean, isSpecifiqueMineur?: boolean): string[];
        private filtreBDDHorsCompteAttente(isSpecifiqueMineur?);
        private filtreBDD();
        private filtreBDR();
...
declare module myway.gestionEpargne.commun {
    class SignataireVersementPeriodiqueService {
        ...
        getListeComptesAutorises(identifiantPersonneTitulaire: string, identifiantsPersonnes: myway.comContract.modeles.ISignataireComplet[], enVAD: boolean): myway.gestionEpargne.commun.ListeSignataires;
    }
}
