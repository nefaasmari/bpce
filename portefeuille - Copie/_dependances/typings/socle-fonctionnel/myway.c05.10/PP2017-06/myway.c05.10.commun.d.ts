...
declare module myway.gestionEpargne.commun {
    ...
    interface IControleur {
         ...
         */
        indicPartageTracab?: myway.transProduitEngage.IIndicPartageTracab;
        /**
...
declare module myway.gestionEpargne.commun {
    class BatOpeFiService {
         ...
         */
        initialiserOperationFinanciere(codeProduit: string, contexte: GestionGeneriqueOffres.Types.DonneesContextuelles, codeTypeProduit: string, codeCanal?: string, codeFonctionnalite?: string): myway.comOpesFinancieres.Model.OperationFinanciere;
...
declare module myway.gestionEpargne.commun {
    ...
    class GgoService {
         ...
         * @returns {boolean}
         */
        determinerRestitutionDV(contexte: GestionGeneriqueOffres.Types.DonneesContextuelles): boolean;
    }
}
...
declare module myway.gestionEpargne.commun {
    class CreerDossierDeVenteService {
         ...
         */
        creerDossierDeVente(donneesMDEC: GestionGeneriqueOffres.Types.DossierDeVente.BlocMDEC, donneesSauvegardeProduitService: GestionGeneriqueOffres.Types.DossierDeVente.IDonneeSauvegardeProduitService, operationFinanciere?: myway.comOpesFinancieres.Model.OperationFinanciere): ng.IPromise<GestionGeneriqueOffres.Types.DossierDeVente.ISauvegardeDonneesGeneriques>;
    }
}
...
declare module myway.gestionEpargne.commun {
    class EnregistrerOpeFiDansDVService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, epargneCommunService: EpargneCommunService, operationFinanciereService: myway.comOpesFinancieres.OperationFinanciereService);
        /**
...
declare module myway.gestionEpargne.commun {
    class RestituerVersementPeriodiqueService {
        ...
        private epargneCommunService;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $q: ng.IQService, filtreCodeProduitService: FiltreCodeProduitService, epargneCommunService: EpargneCommunService);
        /**
         ...
         * @returns {MyWay.Model.ParametreVersementPeriodique}
         */
        restituerParametreVersementPeriodique(versementPeriodiqueDV: VesementPeriodiqueDV, contexte: GestionGeneriqueOffres.Types.DonneesContextuelles): MyWay.Model.ParametreVersementPeriodique;
        /**
