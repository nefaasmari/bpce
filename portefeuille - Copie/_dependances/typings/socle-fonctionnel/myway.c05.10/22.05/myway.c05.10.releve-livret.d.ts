...
declare module myway.gestionEpargne.releveLivret {
    ...
    class ReleveCompteControleur {
        ...
        restituerDonneeViaDemandeFicoba(): void;
        restituerDVRMP(): void;
        /**
