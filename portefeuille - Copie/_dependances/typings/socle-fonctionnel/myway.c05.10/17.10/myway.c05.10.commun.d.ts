...
declare module myway.gestionEpargne.commun {
    class BatOpeFiService {
         ...
         */
        initialiserOperationFinanciere(codeProduit: string, contexte: GestionGeneriqueOffres.Types.DonneesContextuelles, codeTypeProduit: string, codeCanal?: string, codeFonctionnalite?: string, libelleOperation?: string): myway.comOpesFinancieres.Model.OperationFinanciere;
...
declare module myway.gestionEpargne.commun {
    class CreerDossierDeVenteService {
         ...
         */
        creerDossierDeVente(donneesMDEC: GestionGeneriqueOffres.Types.DossierDeVente.BlocMDEC, donneesSauvegardeProduitService: GestionGeneriqueOffres.Types.DossierDeVente.IDonneeSauvegardeProduitService, operationFinanciere?: myway.comOpesFinancieres.Model.OperationFinanciere, estModifie?: boolean): ng.IPromise<GestionGeneriqueOffres.Types.DossierDeVente.ISauvegardeDonneesGeneriques>;
    }
}
