...
declare module myway.gestionEpargne.horsOffre.commun {
    ...
    class ContexteDatService {
         ...
         */
        contexte: DonneesContextellesDAT;
...
declare module myway.gestionEpargne.horsOffre.commun {
    ...
    class ContexteProcessusService {
         ...
         */
        private setContexteProcessusDAT<P>(donneesContextuellesDAT, codeOptionRegimeGeneral);
        /**
...
declare module myway.gestionEpargne.horsOffre.commun {
     ...
     */
    interface IContexteProcessus<P extends DonneesProduit> {
        produit: P;
        detenteur: Detenteur;
        /**
    ...
    interface IContexteProcessusCAT extends IContexteProcessus<DonneesProduitDAT> {
    }
    interface IContexteProcessusQuadreto extends IContexteProcessus<DonneesProduitQuadreto> {
    }
}
...
declare module myway.gestionEpargne.horsOffre.commun {
    ...
    class DonneesContextellesDAT {
        ...
        /**
         * Code capacité juridique : CTDECA
         */
        codeCapaciteJuridique: string;
        constructor();
    }
...
declare module myway.gestionEpargne.horsOffre.commun {
    class DonneesOuverture<P extends DonneesProduit> {
        /**
     ...
     */
    class DonneesOuvertureDAT extends DonneesOuverture<DonneesProduitDAT> {
        constructor();
    }
    /**
     * Données nécessaire à l'ouverture du Quadreto
     */
    class DonneesOuvertureQuadreto extends DonneesOuverture<DonneesProduitQuadreto> {
        constructor();
    }
    class Etablissement {
        /**
    ...
    class DonneesProduitDAT extends DonneesProduit {
        /**
         * Code signe (+/-)
         */
        ...
        /**
         * Cette rubrique permet de connaitre le Cap (taux maximal garantie) associé à un CAT Révisable
         */
        codeEtatPresenceFloorCap: string;
        /**
         * Cette rubrique permet de connaitre le Floor (taux minimal garantie) associé à un CAT Révisable
         */
        tauxInteretMinimum: number;
        /**
         * Cette rubrique permet de connaitre le Cap (taux maximal garantie) associé à un CAT Révisable
         */
        tauxInteretMaximum: number;
        constructor();
    }
    class DonneesProduitQuadreto extends DonneesProduit {
        /**
...
declare module myway.gestionEpargne.horsOffre.commun {
    ...
    class InfosVersement {
        ...
        /**
         * Ind autor modif Floor Cap
         */
        autorisationFloorCap: string;
        constructor();
    }
    class Informations {
        /**
