...
declare module myway.gestionEpargne.editiqueDat.sipxgceDatRembNpy5o01 {
    ...
    interface IsipxgceDatRembNpy5o01Section1 {
        blocChoiceJson: (Ich00 | Ich01 | Ich02 | Ich03 | Ich04 | Ich05 | Ich06 | Ich07 | Ich08 | Ich09 | Ich010 | Ich011 | Ich012 | Ich013 | Ich014 | Ich015 | Ich016 | Ich018 | Ich021 | Ich022 | Ich023 | Ich024 | Ich025 | Ich026 | Ich027 | Ich028 | IchBlCatRenouv)[];
    }
    interface Ich00 {
    ...
    interface Ich05 {
        bl11: IsipxgceDatRembNpy5o01Section1Bl11;
    }
    interface Ich06 {
    ...
    interface Ich016 {
        blCatr21: IsipxgceDatRembNpy5o01Section1BlCatr21;
    }
    interface Ich017 {
    ...
    interface Ich020 {
        blPdpJustifieRgpd: IsipxgceDatRembNpy5o01Section1BlPdpJustifieRgpd;
    }
    interface Ich021 {
    ...
    interface IsipxgceDatRembNpy5o01Section1Bl11 {
        d2: string;
    }
    ...
    interface IsipxgceDatRembNpy5o01Section1BlCatr21 {
        listeCatr: sipxgceDatRembNpy5o01.IsipxgceDatRembNpy5o01Section1BlCatr21ListeCatr[];
    }
    interface IsipxgceDatRembNpy5o01Section1BlCatr21ListeCatr {
        ligne1: sipxgceDatRembNpy5o01.IsipxgceDatRembNpy5o01Section1BlCatr21ListeCatrLigne1[];
        ligne2: sipxgceDatRembNpy5o01.IsipxgceDatRembNpy5o01Section1BlCatr21ListeCatrLigne2[];
    }
    interface IsipxgceDatRembNpy5o01Section1BlCatr21ListeCatrLigne1 {
        d0: string;
    }
    interface IsipxgceDatRembNpy5o01Section1BlCatr21ListeCatrLigne2 {
        d1: string;
        d2: string;
    }
...
declare module myway.gestionEpargne.editiqueDat.sibcgcePrecontractuelles {
    interface IsibcgcePrecontractuelles {
        ...
        catrenouvelable: sibcgcePrecontractuelles.IsibcgcePrecontractuellesCatrenouvelable[];
    ...
    interface IgenericInfoPpListePersonnes {
        blocChoiceJson: (Ich340 | Ich341 | Ich342 | Ich343 | Ich344)[];
    }
    interface Ich340 {
        titreRole: IgenericInfoPpListePersonnesTitreRole;
    }
    ...
    interface IsibcgcePrecontractuellesCatrenouvelable {
        blocChoiceJson: Ich310[];
    }
    interface Ich310 {
        blDataFixeRenouvelable: IsibcgcePrecontractuellesCatrenouvelableBlDataFixeRenouvelable;
    }
    interface IsibcgcePrecontractuellesCatrenouvelableBlDataFixeRenouvelable {
        a504Var00020Lbidva: string;
        a504Var00001Lbidva: string;
        a504Var00002Lbidva: string;
        a504Var00003Lbidva: string;
        a504Var00004Lbidva: string;
        a504Var00004Lbidva1: string;
        a505Var00021Lbidim: string;
        a504Var00008Lbidva: string;
        lbRet: sibcgcePrecontractuelles.IsibcgcePrecontractuellesCatrenouvelableBlDataFixeRenouvelableLbRet[];
        lbTraab: sibcgcePrecontractuelles.IsibcgcePrecontractuellesCatrenouvelableBlDataFixeRenouvelableLbTraab[];
        dtDateVigueur: string;
    }
    interface IsibcgcePrecontractuellesCatrenouvelableBlDataFixeRenouvelableLbRet {
        blocChoiceJson: Ich320[];
    }
    interface Ich320 {
        lgRet: IsibcgcePrecontractuellesCatrenouvelableBlDataFixeRenouvelableLbRetLgRet;
    }
    interface IsibcgcePrecontractuellesCatrenouvelableBlDataFixeRenouvelableLbRetLgRet {
        a505Var00009Lbidim: string;
    }
    interface IsibcgcePrecontractuellesCatrenouvelableBlDataFixeRenouvelableLbTraab {
        lgEntete: number;
        lgData: IsibcgcePrecontractuellesCatrenouvelableBlDataFixeRenouvelableLbTraabLgData[];
        a504Var00011Lbidva: string;
        a504Var00011Lbidv1: string;
    }
    ...
    interface IsibcgcePrecontractuellesCatrenouvelableBlDataFixeRenouvelableLbTraabLgData {
        a504Var00010Lbidva: string;
        a504Var00010Lbidv1: string;
    }
...
declare module myway.gestionEpargne.editiqueDat {
    class BlCatRenouvelable {
         ...
         */
        construireBlCatRenouvelable(map: any[]): sipxgceDatRembNpy5o01.IchBlCatRenouv;
        /**
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocBlCatr1Service {
         ...
         */
        construireBlocBlCatr1(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich015;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocBlCatr2Service {
         ...
         * @param {any} ligne
         * @returns {sipxgceDatRembNpy5o01.Ich014}
         */
        construireBlocBlCatr2(ligneMap: any[]): sipxgceDatRembNpy5o01.Ich016;
        /**
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocBlDemarchageService {
         ...
         * @param {sipxgceDatRembNpy5o01.BlocGenerique} contenu
         * @returns {sipxgceDatRembNpy5o01.Ich026}
         */
        construireBlocBlDemarchage(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich021;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocBl10Service {
         ...
         */
        construireBlocBl10(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich06;
    }
}

declare module myway.gestionEpargne.editiqueDat {
    class BlocBl11Service {
        static $inject: string[];
        constructor();
        /**
         * Permet de construire le Bloc Bl11 en entier
         * @param {sipxgceDatRembNpy5o01.BlocGenerique} contenu
         * @returns {sipxgceDatRembNpy5o01.Ich05}
         */
        construireBlocBl11(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich05;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocBl3crService {
         ...
         */
        construireBlocBl3cr(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich010;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocBl4Service {
         ...
         */
        construireBlocBl4(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich08;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocBl5Service {
         ...
         */
        construireBlocBl5(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich09;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocBl6Service {
         ...
         */
        construireBlocBl6(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich011;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocBl7Service {
         ...
         */
        construireBlocBl7(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich012;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocBl8Service {
         ...
         * @returns {sipxgceDatRembNpy5o01.Ich013}
         */
        construireBlocBl8(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich013;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocBl9Service {
         ...
         * @returns {sipxgceDatRembNpy5o01.Ich014}
         */
        construireBlocBl9(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich014;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocCertifStdCatService {
         ...
         */
        construireBlocCertifStdCat(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich024;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocCertifStdQuadretoService {
         ...
         */
        construireBlocCertifStdQuadreto(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich023;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocGenericCertifStdProduitService {
         ...
         */
        construireGenericCertifStdProduit(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich022;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocGenericLigneVideService {
         ...
         * @param {sipxgceDatRembNpy5o01.BlocGenerique} contenu
         * @returns {sipxgceDatRembNpy5o01.Ich025}
         */
        construireBlocGenericLigneVide(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich025;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocGenericSignatureStdService {
         ...
         * @returns {sipxgceDatRembNpy5o01.Ich026}
         */
        construireGenericSignatureStd(contenu: sipxgceDatRembNpy5o01.BlocGenerique, prenomNomAgent: string): sipxgceDatRembNpy5o01.Ich026;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocBlPdpJustifieService {
         ...
         * @returns {sipxgceDatRembNpy5o01.Ich018}
         */
        construireBlocBlPdpJustifie(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich018;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocBlReprlegTitreService {
         ...
         */
        construireBlocBlReprlegTitre(contenu: sipxgceDatRembNpy5o01.BlocGenerique): sipxgceDatRembNpy5o01.Ich07;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocSignatureSansCnilMegiService {
         ...
         * @param {sipxgceDatRembNpy5o01.BlocGenerique} contenu
         * @returns {sipxgceDatRembNpy5o01.Ich028}
         */
        construireBlocSignatureSansCnilMegi(contenu: sipxgceDatRembNpy5o01.BlocGenerique, prenomNomAgent: string, signataires: GestionGeneriqueOffres.Types.ISignataire[], codeEtablissement: string): sipxgceDatRembNpy5o01.Ich028;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocSignatureSansCnilService {
         ...
         * Permet de construire le Bloc signature sans CNIL en entier
         * @param {sipxgceDatRembNpy5o01.BlocGenerique} contenu
         * @returns {sipxgceDatRembNpy5o01.Ich027}
         */
        construireBlocSignatureSansCnil(contenu: sipxgceDatRembNpy5o01.BlocGenerique, prenomNomAgent: string, signataires: GestionGeneriqueOffres.Types.ISignataire[], estPro: boolean): sipxgceDatRembNpy5o01.Ich027;
    }
}
...
declare module myway.gestionEpargne.editiqueDat {
    class BlocCatrenouvelableService {
        static $inject: string[];
        static BL_DATA_AVEC_PREAVIS_RENOUVELABLE: string;
        static BL_DATA_SANS_PREAVIS_RENOUVELABLE: string;
        static LB_RET: string;
        ...
        constructor();
        /**
         * Permet de construire le Bloc CatRenouvelable en entier
         * @param {IContenuBloc} contenu
         * @returns {sibcgcePrecontractuelles.IsibcgcePrecontractuellesCatrenouvelable}
         */
        construireBlocCatrenouvelable(contenu: IContenuBloc): sibcgcePrecontractuelles.IsibcgcePrecontractuellesCatrenouvelable;
        /**
         * Permet de construire le bloc data CAT renouvelable
         * @param {IContenuBloc} contenu
         * @returns {sibcgcePrecontractuelles.IsibcgcePrecontractuellesCatrenouvelable}
         */
        construireBlocDataRenouvelable(contenu: IContenuBloc): sibcgcePrecontractuelles.IsibcgcePrecontractuellesCatrenouvelableBlDataFixeRenouvelable;
        /**
         * Permet de construire le bloc lb RET
         * @param {IContenuBloc} contenu
         * @returns {sibcgcePrecontractuelles.IsibcgcePrecontractuellesCatslrBlDataSlrLbRet}
         */
        private construireBlocRenouvelableLbRet(contenu);
        /**
...
declare module myway.gestionEpargne.editiqueDat {
    class MappingModelGcePreContratRestService {
        ...
        private blocCatrenouvelableService;
        ...
        private listeSignatairesDelegataires;
        private estPro;
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, genericEnteteEtsPreContratService: GenericEnteteEtsPreContratService, blocBandeauClientService: BlocBandeauClientService, blocCapcielService: BlocCapcielService, blocPrestanceService: BlocPrestanceService, blocCroissanceService: BlocCroissanceService, blocCatslrService: BlocCatslrService, blocCatrenouvelableService: BlocCatrenouvelableService, blocInflationeService: BlocInflationeService, blocQuad0203Service: BlocQuad0203Service, blocQuadretoService: BlocQuadretoService, dossierNumeriqueSignataireService: IDossierNumeriqueSignataireService, tiersNoyauService: ITiersNoyauService, utileCommunService: UtileCommunService);
        /**
         * Permet de mapper le modèle GCE doc avec le retour du service REST
         * @param {EditPreContratDAT} editPreContratDAT
         * @returns {ng.IPromise<sibcgcePrecontractuelles.SibcgcePrecontractuelles>}
