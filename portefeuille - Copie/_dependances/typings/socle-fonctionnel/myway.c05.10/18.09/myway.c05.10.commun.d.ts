...
declare module myway.gestionEpargne.commun {
    class CreerCompteService {
         ...
         */
        estEnVpcEtNecessiteForcage(enVAD: boolean, restitutionDV: boolean, codeModeVente: string, compteRenduMiseEnGestion: GestionGeneriqueOffres.Types.CompteRenduMiseEnGestion): boolean;
        /**
         *
         * @param {string} numeroCompte
