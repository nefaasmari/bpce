...
declare namespace ICBusiness.Models.Edition {
    ...
    interface IFCM17OME extends IDonneesComplementairesSpecifiques {
...
declare namespace ICBusiness.ModelsTransformers {
    ...
    class Dossier {
        ...
        static mapRestAnomalieToBusinessAnomalie(anomalie: ICRest.Modeles.IAnomalieLecture): Models.Dossier.IAnomalie;
    }
}
...
declare namespace ICBusiness.ModelsTransformers {
    ...
    class DonneesComplementaires {
        ...
        static mapElementFCM17OMEMaj(identifiantDossier: string, source: Models.Edition.IFCM17OME): ICRest.Modeles.MajElement.ISaisiesComplementaireMaj;
...
declare namespace ICBusiness.Services.Edition {
    ...
    class ContexteEditionService implements IContexteEditionService {
        ...
        private mapContexteEditionOffre(contexteSignatureElectronique, contexteEditionIndustrialisee, autoriserEditionOffreAgence, autorisationEditionOffre, dossierLecture);
        /**
...
declare namespace ICBusiness.Services.Eds {
    interface IEdsService {
        ...
        getContextePoste(codeEtablissement: string, identifiantPosteFonctionnel: string, identifiantGuichetOperation: string): ng.IPromise<ICBusiness.Models.Eds.IContextePoste>;
    }
...
declare namespace ICBusiness.Services.ParametrageApplicatif {
    interface IParametrageAppicatifService {
        ...
        /**
         * Vérification activation BT95 pour primo accédant (SCF)
         * @param codeEtablissement
         * @param date
         */
        indicateurPrimoAccessionSCFActif(codeEtablissement: string, date: string): ng.IPromise<boolean>;
        /**
...
declare namespace ICBusiness.Services.ParametrageApplicatif {
    class ParametrageAppicatifService implements IParametrageAppicatifService {
        ...
        /**
         * Call listerParametrageApplicatif and compare valeurParametre with Array of comparedValues
         * @param codeEtablissement
         * @param date
         * @param codeParam
         * @param comparedValue
         */
        private getBooleanCompareToArrayParamApplicatif(codeEtablissement, date, codeParam, comparedValues);
