...
declare module ApiInstuctionCredit.Constantes {
    module Assurance {
        module ReponseAssureur {
            module ErreurSaisie {
                const DATE_ACCEPTATION: string;
            }
        }
        module NumeroExterneConvention {
            const conventionAde: string;
            const conventionApe: string;
        }
    }
}
...
declare module ApiInstuctionCredit.Constantes {
    class Client {
         ...
         */
        static listeModesDeComposition: Array<ApiInstuctionCredit.Modele.ISelectboxNumber>;
        static getListeModeDeComposition(): Array<ApiInstuctionCredit.Modele.ISelectboxNumber>;
        /**
...
declare module ApiInstuctionCredit.Constantes {
    ...
    class Donnees {
        ...
        static dateFinAppDefaut: string;
        static minDateEntreePatrEtDateAcq: string;
        static maxDateEntreePatrEtDateAcq: string;
        static codeTypologieCadreFiscalLmp: string;
        static dateDuJour: string;
        static dateJourPlusUn: string;
        /** 99999999999.99 */
        static valeurMaximumChampsMontant: number;
        ...
        static listeNouveauContratAssurance: Array<string>;
    ...
    class CodeEvenementRefusClient {
        static REFUS_CLIENT: string;
    }
    class TypeBlocNotes {
...
declare module ApiInstuctionCredit.Constantes {
    class Edition {
        ...
        static demandeCreditDoc: {
            numDoc: string;
        };
        static condServSignElecDoc: {
            numDoc: string;
        };
        ...
        static libelleLoiConso: string;
        static libelleLoiImmo: string;
        static libelleAutreLoi: string;
        static libelleEditionAgenceOuBo: string;
        static messageEditionAgenceOuBoObligatoire: string;
    }
    module Edition {
        ...
        class NomSaisieCompl {
            ...
            static fCX50ACA: string;
            static listeDonneesCreditAModifierACA: string;
            static listeDonneesCreditAModifier: string;
        }
    }
}
...
declare module ApiInstuctionCredit.Constantes {
    class Parametrage {
        ...
        static bT95Codes: Modele.Parametrage.IBT95Codes;
    }
    ...
    class CodeHabilitationAgent {
        static accesNewMyc: string;
    }
}
...
declare module ApiInstuctionCredit.Constantes {
    module NatureTravaux {
        const TYPE_TRAVAUX_ECOBOUQUET: string;
        const TYPE_TRAVAUX_ECOPERFENE: string;
        const TYPE_TRAVAUX_ECOSYSASSE: string;
    }
    class Projet {
        /**
         * 49
        ...
        static listeNatureTravauxEcoPtz: Array<ApiInstuctionCredit.Modele.ISelectbox>;
        /**
        ...
        /**
         * Valeur maximale surface objet financé
         */
        static maxValueSurfaceHabitable: number;
        /**
         * Valeur maximale surface terrain
         */
        static maxValueSurfaceTerrain: number;
        /**
         * Message erreur valeur surface objet financé
         */
        static messageErreurValSurfHabitable: string;
        /**
         * Message erreur valeur surface terrain
         */
        static messageErreurValSurfTerrain: string;
        /**
         * Message erreur date d'acquisition
         */
        static messageErreurDateAcquisition: string;
        /**
         * Message erreur date d'estimation
         */
        static messageErreurDateEstimation: string;
        /**
         * Message erreur date du suivi planifié
         */
        static messageErreurDateSuiviPlanifie: string;
    }
}
...
declare module ApiInstuctionCredit.Constantes {
    ...
    class Service {
        ...
        static restStructureV2: string;
        static operationInstructservV7: string;
        static dossierCreditInstructionV7: string;
        static dossierCreditInstrucV7: string;
        static elementInstructServV7: string;
        static editionInstructServV7: string;
        static dossierInstructServV7: string;
    }
}
...
declare namespace ApiInstuctionCredit.Constantes.WebServiceUrls {
    namespace OperationSurDossier {
        const urlAccepterImportWeb: string;
        const urlAccorderAccessoire: string;
        const urlAnnulerAccordPreteur: string;
        const urlAnnulerTrfViaDossRes: string;
        const urlAnnulerTrfViaIdDoss: string;
        const urlControlerDecision: string;
        const urlControlerEditionOffr: string;
        const urlFermerDossier: string;
        const urlModificationAccPretr: string;
        const urlPasserAccordPreteur: string;
        const urlPasserDossierSsSuite: string;
        const urlPasserEnOffreConclue: string;
        const urlPasserEnOffreEditee: string;
        const urlProrogationDossier: string;
        const urlRefuserAccordPreteur: string;
        const urlRefuserImportWeb: string;
        const urlRemettreOffre: string;
        const urlRendreDossierViaId: string;
        const urlRetenirPlanOptimise: string;
        const urlSignatureOffre: string;
        const urlSignerOffrePret: string;
        const urlTransfererDossierDansNEO: string;
        const urlTransfererDossViaId: string;
        const urlTransfererDossViaRes: string;
        const urlTransfererMyCredimmo: string;
        const urlTransfererProprDos: string;
    ...
    namespace Dossier {
        ...
        const urlAjouterAccessoireComp: string;
        const urlAjouterAccessoireLieProduit: string;
        const urlAjouterAssAvcControl: string;
        const urlAjouterAssurance: string;
        ...
        const urlAjouterGarantiePersoConv: string;
        const urlAjouterGarantieV2: string;
        const urlAjouterGarAvecCtrl: string;
        const urlAjouterGarPersConvCt: string;
        const urlAjouterMandat: string;
        const urlAjouterMandatPayeur: string;
        ...
        const urlAjouterRefusAssExt: string;
        ...
        const urlAnnulerMandatSecours: string;
        const urlAnnulerMandatSurPayeur: string;
        const urlCalculerBonification: string;
        const urlCalculerCredit: string;
        const urlCalculerCreditEL: string;
        const urlCalculerCreditIntern: string;
        ...
        const urlCalculerHypotheseCap: string;
        const urlCalculerModulCredit: string;
        const urlCalculerRevision: string;
        const urlChargerRefusAssExt: string;
        const urlConstruireTableauAmortissement: string;
        const urlControlerCompletude: string;
        const urlControlerDossier: string;
        const urlCopierPlanFinancemnt: string;
        const urlCtrlAvantAppelCegc: string;
        const urlCtrlAvantEditOffre: string;
        const urlCtrlCompletudeGarAss: string;
        const urlDefinirBienAVendre: string;
        const urlDefinirBienPorteGar: string;
        const urlDefinirBlocNotes: string;
        const urlDefinirCharges: string;
        const urlDefinirComplementDossier: string;
        const urlDefinirDetailCoutObj: string;
        const urlDefinirOrigineApport: string;
        const urlDefinirPhase: string;
        const urlDefinirPoolEPS: string;
        const urlDefinirProjet: string;
        const urlDefinirReamenagement: string;
        const urlDefinirRedacteurActe: string;
        const urlDefinirRemise: string;
        const urlDefinirRemiseTaux: string;
        const urlDefinirRessources: string;
        const urlDefinirVersement: string;
        const urlDefPaliersContraints: string;
        const urlEnregistrerComPieces: string;
        const urlImpactsEligibilite: string;
        const urlInitSaisiesComp: string;
        const urlListeChargeRelation: string;
        ...
        const urlListerMandats: string;
        const urlListerPretsRea: string;
        const urlListerProdEtFamAuto: string;
        const urlListerProduitsAutorises: string;
        const urlListerScConvAss: string;
        const urlListerSynthese: string;
        const urlMiseAJourAccessComp: string;
        const urlMiseAJourAccLieProd: string;
        const urlMiseAJourDossNum: string;
        ...
        const urlSupprimerTiersAccCmp: string;
        const urlValiderPiecesJustif: string;
        const urlVerifierEdsDecision: string;
    }
    namespace Externe {
        const urlAjouterDocumentsDansDossierEdition: string;
        const urlAjouterPersAvecCtrl: string;
        const urlAjouterPersonne: string;
        const urlAjouterPersonnes: string;
        const urlAlimDossSignElecGene: string;
        const urlAlimenterDossierSignatureElectronique: string;
        const urlAnnActeSignElecGen: string;
        const urlAnnulerActeSignatureElectronique: string;
        const urlAnnulerDossierEditio: string;
        const urlCalculerOptimisationAvancee: string;
        const urlCalculerPiecesEtControles: string;
        const urlConsulterDocsDossCNP: string;
        ...
        const urlEligibleSignaElec: string;
        const urlEligibleSignaElecGen: string;
        const urlEnvoyerSACCEF: string;
        const urlExecuterAnalyseRisqu: string;
        const urlExecuterBale2: string;
        const urlExecuterCalcDelegDec: string;
        const urlLancerAppelSGFGAS: string;
        const urlLancerProceSignaElec: string;
        const urlLancerProSignElecGen: string;
        ...
        const urlListerCollectivitCNP: string;
        const urlTransmettrePropCnp: string;
        const urlListerDroitsAcquisEL: string;
        const urlListerDroitsAPretEL: string;
        const urlListerPersonnes: string;
        const urlRafraichirEmprDoss: string;
        const urlRapatrierContratEL: string;
        const urlRecupererCntxtEditio: string;
    ...
    namespace CreditParametre {
        ...
        const urlListerModalitImpayes: string;
        const urlListerModCalculAccesComp: string;
        const urlListerModCalculHorsConvParProd: string;
        const urlListerModTiersTypRol: string;
        const urlListerModTypeDeRoleTiersParAcces: string;
        const urlListerMontantEncoursEpLogement: string;
        ...
        const urlListerParamApplicatif: string;
        const urlListerParamCadreFiscal: string;
        const urlListerParamCoutTravauxEcoPtz: string;
        const urlListerParamEtab: string;
        const urlListerParamGarantie: string;
        const urlListerParamOriginApp: string;
        const urlListerParamTypeDeLogement: string;
        const urlListerParamTypeDuree: string;
        const urlListerProduitsAutorises: string;
        const urlListerRmbAnticipe: string;
        ...
        const urlListerTypeDeSinistreParConv: string;
        const urlListerTypeLogement: string;
        const urlListerTypeObjetCommercial: string;
        const urlListerTypeObjetReglemente: string;
        const urlListerTypeReglement: string;
        const urlListerTypeRessource: string;
        const urlListerTypeRole: string;
        const urlListerTypesDeFraisGarantie: string;
        const urlListerTypeSituationFamiliale: string;
        const urlListerTypologiesInstruction: string;
    }
    namespace CreditService {
        const urlCalculerCapaciteRemboursement: string;
        const urlCalculerCaracteristiqueCredit: string;
        const urlCalculerFraisNotaire: string;
        const urlConsultationDossierSmac: string;
        const urlLireBaleII: string;
...
declare module ApiInstuctionCredit.Enum {
    module ParametreRouteur {
        ...
        enum CodePageEnum {
            ...
            gestionAdminSuivisPlanifies = 705,
            decisionPreteur = 8,
...
declare module ApiInstuctionCredit.Modele.ConsulterAssurCnp {
...
declare module ApiInstuctionCredit.Modele {
    interface IResultatTraitementCegc {
         ...
         */
        identifiantSaccefDossier: string;
        /**
...
declare module ApiInstuctionCredit.Modele.TransmettrePropCnp {
    interface IEntreeTransmissionProposition {
        /**
         * IdntDoss
         */
...
declare module ApiInstuctionCredit.Service {
    class EditerDocumentService {
         ...
         */
        getResultatEditionOffreDescription(idDossier: string, infoDocument: Modele.IInfoDocument, withSaisiesComplementaires: boolean, modeEdition: Enum.Edition.Mode, formatEditique: number, codeSignature: number): ng.IPromise<Modele.IResultatEditionOffreDescription>;
        private editerOffrePret(idDossier, infoDocument, modeEdition, formatEditique, codeSignature);
...
declare module ApiInstuctionCredit.Service {
    class FichierService {
        ...
        convertirFluxToTxt(fluxDonnees: string, nomDocument: string, identifiantDossier?: string): void;
    }
}
...
declare module ApiInstuctionCredit.Service {
    ...
    class PlanFinancementService {
        ...
        /**
         * Récupère le taux TEG / TAEG du crédit
         * @param creditInterne
         */
        getTegAlertMessage(creditInterne: ApiModel.ICreditInterne, codeCategorieEmprunteur?: string): string;
        /**
         * Vérifie si la valeur TEG/TAEG est plus grande que le taux d'usure
         * @param creditInterne
         */
        hasErrorTeg(creditInterne: ApiModel.ICreditInterne, codeCategorieEmprunteur?: string): boolean;
    }
}
...
declare module ApiInstuctionCredit.Service {
    interface ITraceService {
        ...
        setOffTrace(): ng.IPromise<void>;
    }
    const TRACE_COOKIE: string;
    const TRACE_DEBUG_LEVEL: number;
    enum MYWAY_DEBUG_LOGGER_VALUES {
        NONE = -1,
        ERROR = 1,
        WARN = 2,
        INFO = 3,
    ...
    class TraceService {
        private $q;
        private traceDataService;
        private fichierService;
        private serviceAgentExtended;
        private modalService;
        static $inject: Array<string>;
        constructor($q: ng.IQService, traceDataService: ApiInstuctionCredit.Service.Data.TraceDataService, fichierService: ApiInstuctionCredit.Service.FichierService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, modalService: MyWay.UI.IModalService);
        setOnTrace(): ng.IPromise<void>;
...
declare module ApiInstuctionCredit.Service.Data {
    class AssuranceService {
        ...
        consulterAssurCnp(idDossier: string): ng.IPromise<ApiInstuctionCredit.Modele.IResultatDecisionCNP>;
    }
}
...
declare module ApiInstuctionCredit.Service.Data {
    class ClientService {
         ...
         * @param numeroCompte : numero compte, reprend le code établissement en première partie
         */
        addComptePersonne(idDossier: string, idEmprunteur: string, compte: Modele.ComptePersonneMaj, numeroCompte?: string): ng.IPromise<Modele.IComptePersonne>;
        /**
...
declare module ApiInstuctionCredit.Service.Data {
    class CnpService {
        ...
        static $inject: Array<string>;
        constructor($q: ng.IQService, wsService: ApiInstuctionCredit.Service.Data.WsService);
        transmettrePropositionCnp(idDossier: string, assurance: Modele.IAssurance, forcerControle: boolean): ng.IPromise<Modele.TransmettrePropCnp.IResultatCreationDossierCNP>;
        /**
...
declare module ApiInstuctionCredit.Service.Data {
    class FinancementService {
        ...
        /**
         * Permet de récupérer les informations complémentaires du ptz s'il en existe sur le dossier
         * @param {string} identifiantDossier
         * @param {string} idPlanFinancier
         */
        recupererInfoCompPTZ(identifiantDossier: string, idPlan: string): ng.IPromise<Modele.ISortieRecuperationInfoPTZ>;
    }
}
...
declare module ApiInstuctionCredit.Service.Data {
    class GarantieService {
        ...
        /**
         * Permet de récupérer la réponse de la CEGC
         * @param identifiantDossier
         */
        traiterReponseCEGC(identifiantDossier: string): ng.IPromise<Modele.IResultatTraitementCegc>;
        /**
         * Teste si une réponse de la CEGC est présente
         * @param identifiantDossier
         */
        testerPresRepCEGC(identifiantDossier: string): ng.IPromise<boolean>;
        /**
...
declare module ApiInstuctionCredit.Service.Data {
    class OffreService {
         ...
         * @param infoTransfert
         */
        tranfererDossierViaIdentifiant(idDossier: string, infoTransfert: Modele.ISdInformationTransfert, bLancerControleDossier?: boolean): ng.IPromise<Modele.IRetourTranfererDossier>;
        /**
         ...
         */
        editerOffrePret(idDossier: string, document: Modele.IInfoDocument, modeEdition: Enum.Edition.Mode, formatEditique: number, forcerGestion: boolean, codeSignature: number, forcerEdition?: boolean): ng.IPromise<Modele.IResultatEditionOffreDescription>;
        /**
         ...
         */
        signerMandat(idDossier: string, referenceMandat: string, dateSignature: string): ng.IPromise<void>;
    }
}
...
declare module ApiInstuctionCredit.Service.Data {
    class OffreSignatureElectroniqueService {
        ...
        lancerProcessusSignatureElectroniqueGen(idDossier: string, codeSignature: number): ng.IPromise<Modele.IResultatOffreSignatureElectronique>;
...
declare module ApiInstuctionCredit.Service.Data {
    class PiecoService {
         ...
         */
        editionDocuments(identifiantDossier: string, identifiantDocument: string, identifiantWs: string, paramsEditiques: Modele.IParamEditique[], niveauTraitement: number, formatEditique: number, codeSignature: number): ng.IPromise<Modele.IDocument[]>;
        /**
         * Edition de plusieurs documents PDF
         */
        editionDocumentsAvecAno(identifiantDossier: string, identifiantDocument: string, identifiantWs: string, paramsEditiques: Modele.IParamEditique[], niveauTraitement: number, formatEditique: number, codeSignature: number): ng.IPromise<Modele.IResultatEditionDocumentsData>;
        /**
         * Une série de documents doivent être remis par le client
         * @param idDossier
         * @param idPlan
         */
        calculerPiecesEtControles(idDossier: string, idPlan: number, estConsulterDNCSeulement?: boolean): ng.IPromise<Modele.IResultatPiecesEtControles>;
        /**
...
declare module ApiInstuctionCredit.Service.Data {
    class StructureService {
        ...
        /**
         * Récupère le contexte du poste. Ce service est utilisé pour la constitution du SA20.
         * @param codeEtablissement code établissement
         * @param identifiantPosteFonctionnel identifiant poste fonctionnel
         * @param identifiantGuichetOperation identifiant guichet operation
         */
        getContextePoste(codeEtablissement: string, identifiantPosteFonctionnel: string, identifiantGuichetOperation: string): ng.IPromise<Modele.IContextePoste>;
    }
}
...
declare module ApiInstuctionCredit.Service.Data {
    class TraceDataService {
        ...
        static $inject: Array<string>;
        constructor($q: ng.IQService, wsService: ApiInstuctionCredit.Service.Data.WsService);
        setOnTrace(): ng.IPromise<Modele.Trace.ISortieDebug>;
        setOffTrace(isRecherche?: boolean): ng.IPromise<Modele.Trace.ISortieDebug>;
    }
}
...
declare module ApiInstuctionCredit.ContexteEdition {
...
declare module ApiInstuctionCredit.ContexteEdition {
    interface IContexteEditionBusinessService {
        getContexteEdition(idDossier: string): ng.IPromise<IContextEditionDocument>;
    }
    class ContexteEditionBusinessService implements IContexteEditionBusinessService {
        private $q;
        private contexteEditionService;
        private elementService;
        static $inject: string[];
        constructor($q: ng.IQService, contexteEditionService: Service.Data.PiecoService, elementService: Service.Data.DossierService);
        getContexteEdition(idDossier: string): ng.IPromise<IContextEditionDocument>;
...
declare namespace ApiInstuctionCredit.ContexteEdition {
    interface IContexteEditionService {
        /** Dernier Contexte d'édition récupéré */
        contexteEdition: IContextEditionDocument;
         ...
         * @param idDossier
         */
        getContextEdition(idDossier: string): ng.IPromise<IContextEditionDocument>;
        /**
    ...
    class ContexteEditionService implements IContexteEditionService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, contexteEditionService: IContexteEditionBusinessService, modalService: MyWay.UI.IModalService);
        /**
...
declare module ApiInstuctionCredit {
    class EmissionDocumentsControleur implements MyWay.UI.ISelectionChangeHandler {
        ...
        codeEtablissement: string;
        consultation: boolean;
        printSendDocumentsByMailButton: boolean;
        signatureElectroniqueEligible: boolean;
...
declare module ApiInstuctionCredit {
    class RemiseOffreControleur {
        ...
        listeCreditsInternes: ApiInstuctionCredit.Modele.ICreditInterne[];
        constructor();
    }
}
...
declare module ApiInstuctionCredit.Modele.Catalogue {
    ...
    interface IBaseCriteresFiltreRequest {
        versionWsdl: number;
        dateDeTraitement: string;
        codeEtablissement?: string;
    }
    interface ICriteresFiltreRequest extends IBaseCriteresFiltreRequest {
...
declare module ApiInstuctionCredit.Modele {
    ...
    class ParametreUrlApplicationImpulse {
        ...
        constructor(SIGLE: string, CDORGNFINNACTRETAB: string, CDPRFLASSR: string, IDTIER: string, IDEDSACTRETAB: string, NOMUSGACTRETAB: string, IDACTRETAB: string, CDAPPLIAPL: string, CDTYPECANLDISTN: string, CDTYPEPERIMENT: string, CDETABFINNTIER: string, IdDossierBienImmo: string);
    }
}
...
declare module ApiInstuctionCredit.Modele {
    ...
    class DetailAssure implements IDetailAssure {
        ...
        libelleStatut: string;
        listeAssurances: Array<Modele.IAssurance>;
        constructor(pPersonne: Modele.IPersonne, libelleCompagnie: string, pListeAssurance: Array<Modele.IAssurance>, pListeTypesRole?: Array<Modele.IScTypeRole>);
        /**
         ...
         * @param nbAssurance
         */
        static getLibelleAssurance(personne: Modele.IPersonne, compagnie: string, nbAssurance: number, listeTypeRole?: Array<Modele.IScTypeRole>): string;
        /**
         * Récupération du libellé du type de rôle de la personne
         * @param typeRole
         */
        static getTypeRolePersonne(typeRole: string, listeTypeRole?: Array<Modele.IScTypeRole>): string;
         ...
         * En CNP : Dossier en attente de création, Décision Accordée, Décision Refusée
         * Non CNP : Décision En attente, Décision Accordée
         * @param listeAssurances
         * @param personne
         */
        private getStatutDecisionCreerDossCNP(personne, listeAssurances);
    }
}
...
declare module ApiInstuctionCredit.Modele.Parametrage {
    interface IBT95Codes {
        historisationBDF?: IBT95CodeDatas;
        propositionByMail?: IBT95CodeDatas;
        activationNewMYC?: IBT95CodeDatas;
    }
    interface IBT95CodeDatas {
        codeValue: string;
...
declare module ApiInstuctionCredit.Modele {
    class PiecoBuilder {
        ...
        rafraichirDonneesPiecesEtControles(dataPieco: IPieco, resultats: ICustomDataToRefreshPieco): IPieco;
        private updateAcquisitionValue(piece, listePiece);
    }
}
...
declare module ApiInstuctionCredit.Modele {
    ...
    interface IControleManuelDescription extends IPieceControleDescription {
        ...
        commentaire: string;
        histControle?: Array<IControleManuelDescription>;
        ancienStatutAgence: string;
        ancienStatutBoOuConformite: string;
        ancienAvisAgence: string;
        ancienAvisBoOuConformite: string;
    }
    ...
    interface ICustomDataToRefreshPieco {
        resultatPiecesEtControles: IResultatPiecesEtControles;
        listeIdPersonne: string[];
    }
}
...
declare module ApiInstuctionCredit.Modele.Route {
    interface IInstructionCreditUrlParams {
        codeApplication: Enum.ParametreRouteur.CodeApplicationEnum;
        dateInstruction: string;
        idCompteDe: string;
        idDossier: string;
        mode: Enum.ParametreRouteur.ModeOuvertureDossier;
        page: Enum.ParametreRouteur.CodePageEnum;
    }
}

declare module ApiInstuctionCredit.Modele.SetDebug {
...
declare module ApiInstuctionCredit.Modele.Trace {
    interface ISortieDebug {
        /**
         * Success
         */
...
declare module ApiInstuctionCredit.Service.Data {
    ...
    class CatalogueCommunService {
         ...
         */
        getListeDevises(dateTraitement: string, rubriquesFiltre: string, valeursFiltre: string, rubriquesTri: string, valeurTri: string, deviseInstructible?: boolean, codeEtablissement?: string): ng.IPromise<Array<Modele.IScDevise>>;
        /**
         ...
         */
        private appelleListerDevisePost(dateTraitement, rubriquesFiltre, valeursFiltre, rubriquesTri, valeurTri);
        private appelleListerDeviseGet(dateTraitement, codeEtablissement);
        /**
...
declare module ApiInstuctionCredit.Service.Data {
    ...
    class CatalogueProjetService {
         ...
         */
        listerInfoAgent(identifiantEntiteConnecte: string, codeTypeElementStructure: string, identifiantElementStructure: string, codeCategorieEmprunteur: string, estTranfertNeoActive?: string): ng.IPromise<Modele.IInformationAgent>;
        /**
...
declare namespace ApiInstuctionCredit.ModelsTransformers {
    /**
     * Classe des 'mappers' pour le Controle manuel description
     */
    class ControleManuelDescription {
        private static _codeActeurAgent;
        private static _codeActeurBoOuConformite;
        /**
         * Map ControleManuel to ControleManuelDescription
         * @param controle
         * @param oProcessus
         */
        static mapControleManuelDescription(controle: Modele.IControleManuel, oProcessus: Modele.IProcessusMetier): Modele.IControleManuelDescription;
        private static getLibelleStatutControle(stttPieceControle);
        /**
         * Récupération de liste des historiques de contrôle et alimentation
         * @param histControles
         * @param oProcessus
         */
        private static getHistControle(histControles, oProcessus);
        /**
...
declare namespace ApiInstuctionCredit.ContexteEdition {
    ...
    interface ITaleauContextData {
        label: string;
        contexteEdition: IContexteEdition;
        listeAnomalies: string[];
    }
    class ModaleContexteEditionControleur {
        ...
        loading: boolean;
        static $inject: string[];
        constructor($modalInstance: ng.ui.bootstrap.IModalServiceInstance, contextEditiqueService: IContexteEditionService, erreurService: Service.ErreurService, data: IModaleContexteEditionControleurData);
...
declare module ApiInstuctionCredit {
    ...
    class PiecoControlesControleur {
        ...
        /**
         * Récupération ancien état de controle stocké dans histControle
         * @param controle
         */
        getAncienEtat(controle: ApiModel.IControleManuelDescription): string;
        /**
         * Vérification de l'existence de commentaire lié à l'ancien état de contrôle
         * @param controle
         */
        isCommentaireAncienEtatExiste(controle: ApiModel.IControleManuelDescription): boolean;
        /**
         * Permet d'afficher l'ancien commentaire de contrôle s'il existe
         * @param controle
         */
        afficherAncienControle(controle: ApiModel.IControleManuelDescription): void;
        /**
         * CSS Ancien état de contrôle
         * @param controle
         */
        getClassAncienEtat(etat: string): string;
    }
}
...
declare module ApiInstuctionCredit {
    class SignatureTableauIntervenantsControleur {
        ...
        dateTraitement: string;
        constructor();
        defineDateRefus(intervenant: ApiInstuctionCredit.Modele.IIntervenantSignature): void;
    }
}
...
declare module ApiInstuctionCredit {
    class SignatureValidationMandatsControleur {
        ...
        constructor();
        /**
         * Vérifivation de l'existence d'un refus
         */
        getRefus(): boolean;
    }
}
...
declare module ApiInstuctionCredit {
    ...
    class ModaleEditionSaisieComplementaireControleur {
        ...
        isListeDonneesCreditAModifier(proprieteName: string): boolean;
        /**
...
declare module ApiInstuctionCredit {
    class EditionOffreClausesPersonnaliseesControleur {
        ...
        constructor(erreurService: Service.ErreurService, modalClauseService: Service.ModaleClauseService, clausesPersonnaliseesService: Service.EditionOffreClausesPersonnaliseesService, caracteristiquesService: Service.EditionOffreCaracteristiquesService);
        /**
         * Ajoute une clause
         */
...
declare module ApiInstuctionCredit {
    class ChampSaisieComplementaireControleur {
        elt: Object;
        libelleEditionAgenceOuBo: string;
        messageEditionAgenceOuBoObligatoire: string;
        indexElement: number;
        constructor();
    }
}
