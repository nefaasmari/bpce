...
declare namespace ContentieuxDirectives.Services.Sms {
    interface ISmsService {
        ...
        envoyerSMS(inputData: Contentieux.RestServices.Modeles.IInfoSmsAEmettreParamEntree): ng.IPromise<void>;
        getListeModelesSMS(codeEtablissement: string, numeroDossier: number, identifiantCreance: string): ng.IPromise<Contentieux.RestServices.Modeles.IModeleSms[]>;
    }
    ...
    class SmsService implements ISmsService {
        ...
        constructor($q: ng.IQService, modalService: MyWay.UI.IModalService, smsService: Contentieux.RestServices.Services.ISmsService, personneService: Contentieux.RestServices.Services.IPersonneService, mwNotificationService: MyWay.UI.IMwNotificationService);
