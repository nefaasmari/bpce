...
declare module Operation2Librairie.Services.Application {
    ...
    interface IGestionListeParametreService {
        ...
        getListeListeTypeInstructionAllerSdd(): Array<Operation2Librairie.Modeles.Application.ListeParametrage.ICleValeur>;
...
declare module Operation2Librairie.Services.Rest.SyntheseService {
    ...
    interface IEquipementClientService {
        postEquipementClient(body: Operation2Librairie.Modeles.Rest.SyntheseService.EquipementClient.IClient, query: IParametreAppel): ng.IPromise<Operation2Librairie.Modeles.Rest.SyntheseService.EquipementClient.IEquipementClient>;
    }
}
...
declare module Operation2Librairie.Modeles.Rest.SepaPaiement.AnnMultiVirement {
    ...
    interface IAffectation {
        ...
        /**
         * "Propriété de l'annulation de virement pour identifier si les frais bancaires éventuels des banques consoeurs seront
         * supportés par le client bénéficiaire du virement ou par l'établissement du client bénéficiaire.
         *
         * Cette propriété n'est pas liée à un WEB SERVICE ABS
         *
         *
        ...
        /**
         * "Propriété de l'annulation de virement pour identifier si l'envoi de l'annulation est à tarifer, si oui,
         * cette tarification est supportée par le client bénéficiaire du virement.
         *
         * Cette propriété n'est pas liée à un WEB SERVICE ABS
         *
        ...
        /**
         * "Propriété de l'annulation de virement pour identifier si un courrier est à produire, à destination du client bénéficiaire
         * du virement initial, lors de la réception de réponses négatives ou positives suite une annulation de virement.
         *
         * Cette propriété n'est pas liée à un WEB SERVICE ABS
         *
...
declare module Operation2Librairie.Modeles.Rest.SepaPaiement.ExportTransaction {
    ...
    interface IExportTransaction {
        ...
        typeConnexe: string;
        /**
         * detailTransaction - dateReglementTransaction
         * Type date au format yyyy-MM-dd
         */
        dateReglementTransaction: string;
        /**
         * detailTransaction - dateExecution
         * Type date au format yyyy-MM-dd
         */
        dateExecution: string;
        /**
        ...
        offreClient: string;
        /**
         * detailTransaction - canalAcquisition
         */
        canalAcquisition: string;
        /**
        ...
        ibanDebiteur: string;
        /**
         * detailTransaction - bicClientCrediteur
         */
        bicClientCrediteur: string;
        /**
         * detailTransaction - bicClientDebiteur
         */
        bicClientDebiteur: string;
        /**
        ...
        ibanCrediteur: string;
        /**
         * detailTransaction - referenceMessageEntrant
         */
        referenceMessageEntrant: string;
        /**
         * detailTransaction - typeIdentCreancierSepa
         */
        typeIdentCreancierSepa: string;
        /**
         * detailTransaction - referenceMandatSDD
         */
        referenceMandatSDD: string;
        /**
         * detailTransaction - libelleTransaction
         */
        libelleTransaction: string;
        /**
         * detailTransaction - typeReponseRecall
         */
