...
declare namespace AssuranceAdeCredit.Services {
    interface IPropositionAssuranceService {
        ...
        creerPropositionAssurance(idDossier: string, idPersonnes: string[], idCredits: string[], codeCollectivite: string, estParcoursManuel: boolean, quotite: number, tarifDerogatoire: boolean): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
         ...
         */
        majPropositionAssurance(idDossier: string, idCredits: string[], nomPropositions: Modeles.INomProposition[], quotite: number, tarifDerogatoire: boolean, actualQuotite: number, estParcoursManuel: boolean): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
        /**
    ...
    class PropositionAssuranceService implements IPropositionAssuranceService {
        ...
        mapDatasEntreesPropAssurancesAfterDelete(propositionAssurance: Modeles.Proposition.IPropositionsAssurance, deletedAssuranceByAssure: Modeles.Proposition.IDeletedAssuranceByAssure[], idDossier: string, tarificationDerogatoireValue: boolean, estParcoursManuel: boolean): Modeles.Rest.MajPropAssurance.IEntreePropositionAssurances[];
        majPropositionAssuranceAfterDelete(entreesPropAss: Modeles.Rest.MajPropAssurance.IEntreePropositionAssurances[], defaultQuotite: number): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
        majPropositionAssurance(idDossier: string, idCredits: string[], nomPropositions: Modeles.INomProposition[], quotite: number, tarificationDerogatoire: boolean, actualQuotite: number, estParcoursManuel: boolean): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
        enregistrerPersonnalisationAssurance(idDossier: string, proposition: Modeles.Proposition.IPropositionsAssurance, estSaisieManuelle: boolean): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
        /**
         ...
         */
        private getDataEntree(idDossier, nomProposition, idCredits, estParcoursManuel, quotite?, tarificationDerogatoire?);
        /**
         ...
         */
        private getDataCreerEntree(idDossier, idPersonne, idCredits, idProposition, codeCollectivite, estParcoursManuel, quotite?, tarificationDerogatoire?);
