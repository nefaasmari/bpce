...
declare namespace ICCreditComponents.Navigation {
    class TotemChapitreActionsComplementaires {
        ...
        private _estConseillerDeProximite;
        private _habilitationsDejaAppelee;
        private agentConseillerDeProximite();
