...
declare namespace ICBusiness.Services.InterroBdf {
    interface IInterroBdfService {
        ...
        /**
         * Permet de précharger les donnees utiles à l'extraction des rules Ficp et d'éviter un appel par emprunteur
         * @param idDossier
         * @param idProjet
         * @param idEmprunteur
         */
        getDonneesUtilesFicpRules(idDossier: string, idProjet: string, idEmprunteur: string): any;
        /**
         * Définit si l'interro FICP est interdite
         * @param personne
         * @param codeApplication
         * @param isPersonneMoraleEmprunteur
         * @param donneesUtilesFicpRules
         */
        getFicpInterditRules(personne: Models.Emprunteur.IPersonne, codeApplication: number, isPersonneMoraleEmprunteur: boolean, donneesUtilesFicpRules: IDonneesUtilesFicpRules): Enum.FicpRules;
        /**
    ...
    interface IDonneesUtilesFicpRules {
        codeTypeMarche: number;
    ...
    class InterroBdfService implements IInterroBdfService {
        ...
        deduireInscription(reponse: string, statut: string): string;
        getDonneesUtilesFicpRules(idDossier: string, idProjet: string, idEmprunteur: string): ng.IPromise<IDonneesUtilesFicpRules>;
        getFicpInterditRules(personne: ICBusiness.Models.Emprunteur.IPersonnePhysique, codeApplication: number, isPersonneMoraleEmprunteur: boolean, donneesUtilesFicpRules: IDonneesUtilesFicpRules): Enum.FicpRules;
        /**
         ...
         * @param codeApplication
         */
        private ficpInterditRules(personne, isPersonneMoraleEmprunteur, typeMarche, categorieEmprunteur, natureProjetPro, codeApplication);
        /**
...
declare namespace ICBusiness.Services.SignatureOffre {
    ...
    class SignatureOffreService implements ISignatureOffreService {
        ...
        private mapValidationMantat(c, p, estPayeursSecours?);
        getSignatureOffre(identifiantDossier: string, dateDeTraitement: string): ng.IPromise<SignatureOffreModels.ISignatureOffre>;
