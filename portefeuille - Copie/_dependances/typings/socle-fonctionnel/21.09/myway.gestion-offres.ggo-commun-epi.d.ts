...
declare module GGOCommunEpi.Services {
    ...
    interface IMediaEsignatureService {
        ...
        recupererDonneesContexte(): ng.IPromise<Modele.IContexteEntree>;
...
declare module GGOCommunEpi {
    ...
    class MediasEsignature {
        ...
        static $inject: string[];
        constructor($scope: ng.IScope, $q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, servicesAuth: Services.IAuthentificationService, mediaEsignatureService: Services.IMediaEsignatureService, modalService: MyWay.UI.IModalService);
