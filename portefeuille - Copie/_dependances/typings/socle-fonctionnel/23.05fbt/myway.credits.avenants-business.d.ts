...
declare module Avenants.Business.Modeles {
    ...
    class CaracteristiqueFinanAccessoireBuilder {
        ...
        private static getCreerAccessoiresAnnexesFutureAvenant(acc, nouveauNumeroRelatif, listePhaseStock, listeAccessoiresAnnexes);
...
declare module Avenants.Business.ToolsFunctionals {
    ...
    class FonctionsAte {
        ...
        static scissionAccessoireGaranie(garanties: Array<Modeles.IGarantie>, isSecondeScissionAte: boolean, isPremiereScissionAte: boolean, dernierePhase: number): Array<Modeles.IGarantie>;
