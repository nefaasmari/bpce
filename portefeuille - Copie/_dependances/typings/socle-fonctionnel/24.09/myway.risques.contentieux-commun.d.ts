...
declare namespace ContentieuxCommun.Constantes.Metier {
    namespace Contrat {
        ...
        const PERTE_RECOUVRABLE: string;
        const PERTE_IRRECOUVRABLE: string;
    }
}
...
declare namespace ContentieuxCommun.Metier {
    class ContratUtils {
        ...
        /**
         * Indique si la créance est en perte irrecouvrable
         *  Irrecouvrable ==> indicateurPerteRecouvrable = N
         */
        static isPerteIrrecouvrable(indicateurPerteRecouvrable: string): boolean;
    }
}
