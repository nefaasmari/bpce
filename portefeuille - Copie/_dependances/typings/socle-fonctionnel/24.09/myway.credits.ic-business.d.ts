...
declare namespace ICBusiness.Constantes.ParametrageApplicatif {
    ...
    namespace NAdePro {
        ...
        const bt95DesactivationPafoBoutons: string;
    ...
    namespace Credit {
        const bt95DesactivationNbCreditOptim: string;
    }
    namespace LBO {
...
declare namespace ICBusiness.Services.ParametrageApplicatif {
    interface IParametrageAppicatifService {
        ...
        desactivationNadeProBoutons(dateDeTraitement: string, codeEtablissement: string): ng.IPromise<boolean>;
        ...
        desactivationNbCreditOptim(dateDeTraitement: string, codeEtablissement: string): ng.IPromise<boolean>;
