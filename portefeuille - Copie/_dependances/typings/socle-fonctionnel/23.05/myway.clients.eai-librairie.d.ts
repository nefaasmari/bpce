...
declare module libEAI.Constantes {
    ...
    module Services {
        ...
        const sauvegarderContextService: string;
        const classeurClientService: string;
        const rechercheActeGestionService: string;
        const dossierContratService: string;
        const interstitielSelfcareService: string;
    }
    module UrlRest {
        ...
        const urlClasseurClientRecherche: string;
        const urlRechercheActeGestion: string;
        const urlDossierContratServ: string;
        const urlInterstitielSelfcare: string;
    }
    module MyWay {
    ...
    module CodeProcessusLisa {
        ...
        const CODE_LISA_LISTE_SAIS_EAI: number;
        const CODE_LISA_ENTREE_SAISIE: number;
        const CODE_LISA_ENTREE_SELFCARE: number;
        const CODE_LISA_RET_LIST_EAI: number;
        const CODE_LISA_ENTR_SPA_EDTQ: number;
        const CODE_LISA_ENTR_RETOUR_APPELANT: number;
        const CODE_LISA_ENTR_CONTRACT: number;
        const CODE_LISA_MAJ_STAT_EAI: number;
        const CODE_LISA_GGHO: number;
        const CODE_LISA_GGO: number;
        const CODE_LISA_CONTINUER: number;
        const CODE_LISA_ACQR_DOC_DOSS_CLACLI: number;
        const CODE_LISA_RETOUR_NUMERISATION_VERS_LISTE: number;
        const CODE_LISA_RETOUR_GENERATION_INTERSTITIEL: number;
        const CODE_LISA_RETOUR_GENERATION_INTERSTITIEL_ANNULER: number;
    }
    module CleProcessusLisa {
        ...
        const CLE_RETOUR_EDITIQUE: string;
        const CLE_LISTE_PERSONNES_A_NUM: string;
        const CLE_CONTEXTE_OUVR_DAT: string;
        const CLE_CONTEXTE_OUVR_QUADRETO: string;
    }
    module Contexte {
        ...
        const MODE_ENVOI_DOC: {
            MANUEL: string;
            HUBMAIL: string;
            NON_CONCERNE: string;
        };
        const INDIC_IMPRESSION: {
            OUI: string;
            NON: string;
        };
    }
    module CodeActionRessource {
        const CONTROLE_VRAISEM: string;
        const SAIS_MSG: string;
        const IMPRESSION: string;
        const REMEDIATION: string;
        const ANNULATION: string;
        const VALIDATION: string;
        const NUMERISATION: string;
    }
}
...
declare module libEAI.EditiqueContract.Modeles {
    interface IContexteSaisieEAI {
        numeroPersonneIdentifiee: number;
        codeAction?: string;
        codeSensCommunication: string;
        codeCanal: string;
    }
    interface IContexteListeEAI {
        numeroPersonneIdentifiee: number;
    ...
    interface IRetourEditique {
        codeRetourGeneEditique: string;
        dictionnaireIdntPJ: IContexteIdntPJ[];
    }
    interface IContexteEAI {
        numeroPersonne: string;
        codeCanal: string;
        libelleSousTitre: string;
    }
    ...
    interface IContexteContractualisationActe {
        documentsAImprimer: Myway.Ressource.ContractualisationActe.IDocumentAProduire[];
        indicateurPapier: boolean;
        signataires: ISignataire[];
    }
    interface IContexteEditque {
        eai: IContexteEAI;
        contractualisationActe: IContexteContractualisationActe;
    }
    class ObjetContexteEdique implements IContexteEditque {
        eai: IContexteEAI;
        contractualisationActe: IContexteContractualisationActe;
        constructor();
    }
...
declare module libEAI.Services {
    ...
    interface IEditiqueContractService {
        verifierEligibiliteComplet(personne: modelTiers.ITiersNoyau, codeActeGestion: string, representant?: EditiqueContract.Modeles.IRepresentantLegal): ng.IPromise<Myway.Ressource.ContractualisationActe.IContractualisationActe>;
        creerContextEditique(contractualisationActe: Myway.Ressource.ContractualisationActe.IContractualisationActe, libelleSousTitre: string): EditiqueContract.Modeles.IContexteEditque;
        creerContexteContractualisation(tiersNoyau: modelTiers.ITiersNoyau, contractualisationActe: Myway.Ressource.ContractualisationActe.IContractualisationActe): Myway.Ressource.ContractualisationActe.IContractualisationActe;
        preparerContratContractualisation(contractualisationActe: Myway.Ressource.ContractualisationActe.IContractualisationActe, documentsGeneres: EditiqueContract.Modeles.IRetourEditique): ng.IPromise<any[]>;
    }
    class EditiqueContractService implements IEditiqueContractService {
        ...
        private logger;
        static $inject: string[];
        constructor(contractualisationActeService: myway.comContract.Services.ContractualisationActeService, $q: ng.IQService, initService: Services.IInitialisationService, utilService: Services.IUtilitaireService, lisaService: Services.ILisaService, profilClient: Services.IProfilClientService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, logger: Logger.ILogger);
        /**
         * Reuperation de la liste des signataires
         * @param personne
         * @param representantLegal
         */
        recupererListeSignataire(titulaire: modelTiers.ITiersNoyau, personneLieeSignataire?: EditiqueContract.Modeles.IRepresentantLegal): myway.comContract.modeles.ISignataire[];
        /**
         ...
         * @param representantLegal
         */
        getDonneesEligibilite(titulaire: modelTiers.ITiersNoyau, codeActeGestion: string, representantLegal?: EditiqueContract.Modeles.IRepresentantLegal): EditiqueContract.Modeles.ParametresAppelSagSed;
        /**
        ...
        verifierEligibiliteComplet(personne: modelTiers.ITiersNoyau, codeActeGestion: string, representant?: EditiqueContract.Modeles.IRepresentantLegal): ng.IPromise<Myway.Ressource.ContractualisationActe.IContractualisationActe>;
        /**
         * creation du contexte Editique
         * @param contractualisationActe
         */
        creerContextEditique(contractualisationActe: Myway.Ressource.ContractualisationActe.IContractualisationActe, _libelleSousTitre: string): EditiqueContract.Modeles.IContexteEditque;
        /***
         * construction signataire par document
         * @param docAProduire
         * @param signatairesActe
         */
        constructionSignatairesParDocument(docAProduire: Myway.Ressource.ContractualisationActe.IDocumentAProduire, signatairesActe: Myway.Ressource.ContractualisationActe.ISignataireActe[]): Myway.Ressource.ContractualisationActe.ISignataireDocument[];
        /**
         * fonction appeler avant le debranchement vers la SPA editique
         * @param contractualisationActe
         */
        creerContexteContractualisation(tiersNoyau: modelTiers.ITiersNoyau, contractualisationActe: Myway.Ressource.ContractualisationActe.IContractualisationActe): Myway.Ressource.ContractualisationActe.IContractualisationActe;
        /**
         * fonction à appeler en retour de l'éditique afin de transmettre l'ID GED temporaire à la contract
...
declare module libEAI.Services {
    ...
    interface IInitialisationService {
        ...
        setCodeEtablissement(codeEtab: string): any;
        getNumeroPersonne(): number;
        setNumeroPersonne(numero: number): void;
        getNumeroPersonneSignataire(): number;
        setNumeroPersonneSignataire(numero: number): void;
        ...
        setCodeEntite(code: string): void;
        getContratListeEAI(): any;
        setContratListeEAI(objet: any): void;
        getContratSaisEAI(): any;
        setContratSaisEAI(objet: any): void;
        getContratRetEditique(): EditiqueContract.Modeles.IRetourEditique;
        setContratRetEditique(objet: EditiqueContract.Modeles.IRetourEditique): void;
        getDossClaCli(): string;
        setDossClaCli(dossier: string): void;
        getModeSignature(): string;
        setModeSignature(mode: string): void;
        getIndicateurImpression(): string;
        setIndicateurImpression(m: string): void;
        getListePersonnesANumeriser(): string[];
        setListePersonnesANumeriser(listePersonne: string[]): any;
        getIndicateurDernierePersonneVAD(): boolean;
        setIndicateurDernierePersonneVAD(indicateur: boolean): any;
    }
    class InitialisationService implements IInitialisationService {
        private _numeroPersonne;
        private _numeroPersonneSignataire;
        ...
        private _codeEntite;
        private _contratListeEAI;
        private _contratSaisieEAI;
        private _contratRetEditique;
        private _dossierClaCli;
        private _modeSignature;
        private _indicateurImpression;
        private _listePersonneANumeriser;
        private _indicateurDernierePersonneVAD;
        static $inject: string[];
        constructor();
        /**
        ...
        setObjetOriginalEAI(objet: libEAI.Rest.Modeles.EntiteTitulaire.InfoFiscale.IInformationEAI): void;
        /**
         * Contrat d'entree saisie/liste EAI
         */
        getContratListeEAI(): any;
        setContratListeEAI(objet: any): void;
        getContratSaisEAI(): any;
        ...
        setDossClaCli(dossier: string): void;
        getModeSignature(): string;
        setModeSignature(m: string): void;
        getIndicateurImpression(): string;
        setIndicateurImpression(m: string): void;
        getListePersonnesANumeriser(): string[];
        setListePersonnesANumeriser(m: string[]): void;
        getIndicateurDernierePersonneVAD(): boolean;
        setIndicateurDernierePersonneVAD(indicateur: boolean): void;
    }
}
...
declare module libEAI.Services {
    interface ISauvegarderContextService {
        sauvegarderContextContractualisation(contract: Myway.Ressource.ContractualisationActe.IContractualisationActe): ng.IPromise<any>;
    }
    class SauvegarderContextService implements ISauvegarderContextService {
        private initService;
        private serviceAgentExtended;
        private $q;
        private utilService;
        static $inject: string[];
        constructor(initService: Services.IInitialisationService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $q: ng.IQService, utilService: Services.IUtilitaireService);
        /**
         * Sauvegarde du contexte contractualisation acte
         * @param contract
         */
        sauvegarderContextContractualisation(contract: Myway.Ressource.ContractualisationActe.IContractualisationActe): ng.IPromise<any>;
    }
...
declare module libEAI.Services {
    ...
    interface IUtilitaireService {
        ...
        getValeurEntreeCourante(): number;
        setValeurEntreeCourante(n: number): void;
        loadPromise(promises: any): ng.IPromise<any>;
    }
    class UtilitaireService implements IUtilitaireService {
        ...
        private _valeurEntreeElig;
        static $inject: string[];
        constructor(modalService: MyWay.UI.IModalService, notificationService: MyWay.UI.IMwNotificationService, $q: ng.IQService);
        /**
         * Chargement de la liste des promesses
         * @param promises
         */
        loadPromise(promises: any): ng.IPromise<any>;
        /**
        ...
        setNotificationSaisieEAI(n: boolean): void;
        getValeurEntreeCourante(): number;
        setValeurEntreeCourante(val: number): void;
    }
}
...
declare module libEAI.Directive {
    interface IScopeRepresentantLegal extends ng.IScope {
        idPage: string;
        listeRepresentant: Params.Modeles.IRepresentantLegal[];
        modele: string;
        isErreur: string;
    }
...
declare module libEAI.Directive {
    ...
    class DeclarationPersonneControleur {
        ...
        idPersonne: string;
        static $inject: string[];
        constructor($scope: IScopeResidenceFiscale, declarationFiscaleService: Services.IDeclarationFiscaleService, $timeout: ng.ITimeoutService);
        /**
         * Affichage des "etats-unis" si la valeur estAmericain est à true
         */
        changerPays(): void;
...
declare module libEAI.Rest.Modeles.ClasseurClient {
    interface IPorteur {
        /**
         * Idnt
         */
...
declare module libEAI.Rest.Modeles.DossierContrat {
    ...
    interface IDossierContratServiceInput {
        /**
         * CodeEtablissement
         */
        codeEtablissement: string;
         ...
         *
         * Identifiant géré par les applications en amont permettant de regrouper les documents à rattacher à un même dossier
         * Classeur Client. Cet identifiant permet également de faire le lien entre un document et l’acte de gestion qui l’a créé.
         * Dans le contexte Signature Electronique cet identifiant est fourni par l’application IDN.
         */
        idActe: string;
        /**
    ...
    interface IDossierContratServiceOutput {
        /**
    ...
    interface IDossierClasseurClient {
        /**
...
declare module libEAI.Rest.Modeles.EntiteTitulaire.InfoFiscale {
    interface IInfosPersonnePhysique {
        ...
        /**
         * Référence interne de l'EDS de domiciliation de la personne. En général un point de vente / agence.
         */
    ...
    interface IInformationEAI {
        ...
        /**
         * Indique si un client est éligible au SELFCARE
         * 'O'  Le client est éligible
         * 'N'  Le client n'est pas éligible
         */
        indicateurEligibiliteSelfcare: boolean;
        donneesMessageAC: string;
    }
...
declare module libEAI.Rest.Modeles.Rechercheactegestion {
    interface IRechercheActeGestioninput {
        /**
         * Code action en mise à jour
         */
        codeTypeConsultation: string;
        /**
         * Code objet acte gestion
         */
        codeObjetActeGestion: string;
        /**
         * Libellé objet acte gestion
         */
        libelleObjetActeGestion: string;
        /**
         * Identifiant Produit / Service
         */
        codeProduitService: number;
        /**
         * Code élément gestion
         */
        codeElementGestion: string;
        /**
         * Date début validité
         * Type date au format yyyy-MM-dd
         */
    ...
    interface IRechercheActeGestionoutput {
        /**
         * Code objet acte gestion
         */
        codeObjetActeGestion: string;
...
declare module libEAI.Rest.Services {
    import ModelClasseurClient = libEAI.Rest.Modeles.ClasseurClient;
    interface IClasseurClientService {
        getRechercheDossier(identifiantPersonne: string): ng.IPromise<ModelClasseurClient.IRechercherDossierOutput>;
    }
    interface IRechercheDossierParams {
        idPersonne: string;
        typeDossierCC: string;
        evenementMetier: string;
    }
    class ClasseurClientService implements IClasseurClientService {
        private restService;
        static $inject: Array<string>;
        constructor(restService: Rest.Services.IRestService);
        /**
         * Appel REST (GET) Recherche de dossier classeur client à partir d'un identifiant personne NODAPE
         * @param identifiantPersonne
         */
        getRechercheDossier(idPersonne: string): ng.IPromise<libEAI.Rest.Modeles.ClasseurClient.IRechercherDossierOutput>;
    }
}
...
declare module libEAI.Rest.Services {
    ...
    interface IControleInfoFiscaleService {
        getControleInfoFiscale(codeEtablissement: string, identifiantEntiteTitulaire: number, identifiantPersonne: number, isNumerisationAControler: boolean): ng.IPromise<ModelEntiteTitulaire.IInformationFiscaleEntiteTitulaire>;
    }
    interface IControleInfoFiscaleParams {
        codeEtablissement: string;
        identifiantEntiteTitulaire: number;
        identifiantPersonne: number;
        isNumerisationAControler: boolean;
    }
...
declare module libEAI.Rest.Services {
    class ObjetDossierContrat implements Modeles.DossierContrat.IDossierContratServiceInput {
        agentEDS: string;
        appOrigine: string;
        codeAgent: number;
        codeCanal: string;
        ...
        idActe: string;
        modeContractualisation: string;
        listeActe: Array<Modeles.DossierContrat.IActeGestion>;
        listeDocuments: Array<Modeles.DossierContrat.IDocuments>;
        listeReferenceExternes: Array<Modeles.DossierContrat.IReferenceExterne>;
    }
    interface IDossierContratService {
        creerDossierContrat(idPersonne: number, agentEDS: string): ng.IPromise<Modeles.DossierContrat.IDossierContratServiceOutput>;
    }
    class DossierContratService implements IDossierContratService {
        private restService;
        private rechercheActeGestionService;
        private initService;
        private utilService;
        static $inject: Array<string>;
        constructor(restService: Rest.Services.IRestService, rechercheActeGestionService: Rest.Services.IRechercheActeGestionService, initService: libEAI.Services.IInitialisationService, utilService: libEAI.Services.IUtilitaireService);
        /**
         * Permet de céer des numeros de dossier CLACLI
         * @param data
         */
        creerDossierContrat(idPersonne: number, agentEDS: string): ng.IPromise<Modeles.DossierContrat.IDossierContratServiceOutput>;
    }
...
declare module libEAI.Rest.Services {
    ...
    interface IInformationEAIService {
        ...
        recuperObjetOriginalEAI(): ng.IPromise<ModelEntiteTitulaire.InfoFiscale.IInformationEAI>;
    }
    ...
    class InformationEAIService implements IInformationEAIService {
        ...
        suppressionInformationEAI(indicateurAccesEAIviaVAD: boolean, data: ModelEntiteTitulaire.InfoFiscale.IInformationEAI): ng.IPromise<ModelEntiteTitulaire.InfoFiscale.IInformationEAI>;
        /**
         * Recuperation de l'objet original en cours de saisie en mode simple
         */
        recuperObjetOriginalEAI(): ng.IPromise<ModelEntiteTitulaire.InfoFiscale.IInformationEAI>;
...
declare module libEAI.Rest.Services {
    class InterstitielSelfcare {
        ...
        referenceInterneEDSRattachement: number;
        /**
         * Détermine une action a effectuer: 'B' pour BAPI 'M' pour MYWAY
         */
        codeAction: string;
        /**
         * Libellé descriptif d'un message informationnel
         */
        donneesMessageAC: string;
    }
    interface IInterstitielSelfcareService {
        creerInterstitiel(idPersonne: number, referenceInterneGuichet: string, referenceInterneEDSRattachement: string): ng.IPromise<InterstitielSelfcare>;
    }
    class InterstitielSelfcareService implements IInterstitielSelfcareService {
        private restService;
        private initService;
        private utilService;
        static $inject: Array<string>;
        constructor(restService: Rest.Services.IRestService, initService: libEAI.Services.IInitialisationService, utilService: libEAI.Services.IUtilitaireService);
        /**
         * Cette ressource permet de générer un interstitiel lors de l'EAI en vente à distance.
         * Un interstitiel concerne une ou plusieurs questions transmises directement au client lorsqu'il se connecte pour accéder à ces comptes sur internet.
         * Soit via le site internet soit par l'application BANXO. Si le client confirme sa résidence fiscale, son auto-certification sera générée
         *
         * @param data
         */
        creerInterstitiel(idPersonne: number, referenceInterneGuichet: string, referenceInterneEDSRattachement: string): ng.IPromise<InterstitielSelfcare>;
...
declare module libEAI.Rest.Services {
    interface IRechercheActeGestionService {
        rechercherActeGestion(): ng.IPromise<Modeles.Rechercheactegestion.IRechercheActeGestionoutput>;
    }
    class RechercheActeGestionService implements IRechercheActeGestionService {
        private restService;
        static $inject: Array<string>;
        constructor(restService: Rest.Services.IRestService);
        /**
         * Permet de récupérer un acte de gestion à travers la QR E17L0500
         * @param data
         */
        rechercherActeGestion(): ng.IPromise<Modeles.Rechercheactegestion.IRechercheActeGestionoutput>;
    }
