...
declare module LibrairieAffairesCreBdr.Montants.Filter {
     ...
     */
    function montantNa(): (valeur: number) => string;
}
...
declare module LibrairieAffairesCreBdr.Controleurs.TemplateModale {
    class CreationAffaireControleur {
        ...
        fermer(): void;
        /**
         * Ferme la popup et retourne l'affaire à créer
         */
        valider(): void;
        /**
        ...
        /**
         * Indique si le bouton Valider doit être activé ou non (=> true si inactivable)
         */
        boutonValiderEstInActivable(): boolean;
        /**
         * Indique si les données saisies dans la popin sont valides (true si valides)
         */
        private donneesSaisiesSontOk();
    }
}
...
declare module LibrairieAffairesCreBdr.Controleurs.TemplateModale {
    class ModificationAffaireControleur {
        ...
        fermer(): void;
        /**
         * Ferme la popup et retourne l'affaire modifiée
         */
        valider(): void;
        /**
         * Annule les changements effectués par l'utilisateur et affiche l'affaire telle qu'elle était à l'ouverture de la popup
         ...
         * Détermine si l'utilisateur a modifié l'affaire en cours (true si modifiée)
         */
        modificationEstEnCours(): boolean;
        /**
         * Indique si le bouton Valider doit être activé ou non (=> true si inactivable)
         */
        boutonValiderEstInActivable(): boolean;
...
declare module LibrairieAffairesCreBdr.Directives.GestionAffaires.Controleur {
    class LibAffGestionAffairesControleur implements MyWay.UI.ISelectionChangeHandler {
        ...
        /**
         * Grise/dégrise le bouton Supprimer => Dépend de la sélection/non sélection d'une ligne du tableau
         */
        inactiverBoutonSupprimer(): boolean;
        /**
...
declare module LibrairieAffairesCreBdr.Services.Application {
    interface IAffairesService {
        rechercherAffaires(critere: LibrairieAffairesCreBdr.Modeles.Application.ICritereRechercheAffaire): ng.IPromise<Array<LibrairieAffairesCreBdr.Modeles.Application.IAffaire>>;
        enregistrerAffaires(identifiantPersonne: number, identifiantCre: number, dateCreationCre: string, listeAffairesAEnregistrer: Array<LibrairieAffairesCreBdr.Modeles.Application.IAffaire>): ng.IPromise<Array<LibrairieAffairesCreBdr.Modeles.Application.IAffaire>>;
        affairesSontIdentiques(affaire1: LibrairieAffairesCreBdr.Modeles.Application.IAffaire, affaire2: LibrairieAffairesCreBdr.Modeles.Application.IAffaire): boolean;
