...
declare module Avenants.Rest.Constantes.Inject {
    module Services {
        ...
        const prestationService: string;
...
declare module Avenants.Rest.Services {
    ...
    interface IAjustementEcheancesService {
        getAjustementEcheances(codeEtablissement: string, dateTraitement: string, idCredit: string, dateEffet: string, tauxRenego: number, crdInAvant: boolean, tauxAssuranceAvant: number): ng.IPromise<ModelAvenantService.AjustementEcheances.IAjustementEcheances>;
        getAjustementEcheancesTauxDuree(codeEtablissement: string, dateTraitement: string, idCredit: string, dateEffet: string, numeroRelatif: number, codeAvenantSimulation: Commun.Enum.CodeAvenantSimulation, codeTypeAcces: Commun.Enum.CodeTypeAcces, nouveauTaux: number, montantCrd: number, typeCalcul: number, tauxAssuranceAvant: number): ng.IPromise<ModelAvenantService.AjustementEcheances.IAjustementEcheances>;
    }
}
...
declare module Avenants.Rest.Services {
    ...
    interface IAvenantService {
        ...
        getCaracteristiqueAssu(codeEtablissement: string, dateTraitement: string, idCredit: string, idEmprunteur: string, dateEffet: string, numeroAvenantSimulation: number, codeAvenantSimulation: Commun.Enum.CodeAvenantSimulation): ng.IPromise<ModelAvenant.CaracteristiqueAssu.ICaracteristiqueAssu>;
    }
...
declare module Avenants.Rest.Services {
    import ModelGestion = Modeles.DossierCreditGestion;
    import ModelInfoEntiteTitulaire = Modeles.EntiteTitulaire.InformationEntiteTitulaire;
    ...
    interface IEmprunteurService {
        ...
        getInformationEntiteTitulaire(codeEtablissement: string, idEmprunteur: string): ng.IPromise<ModelInfoEntiteTitulaire.IInformationEntiteTitulaire>;
    }
...
declare module Avenants.Rest.Services {
    interface IGarantieService {
        ...
        getGaranties(codeEtablissement: string, identifiantCredit: string, dateTraitement: string, idEmprunteur: string, dateEffet: string, codeAvenantSimulation: Commun.Enum.CodeAvenantSimulation, codeTypeAcces: Commun.Enum.CodeTypeAcces, typeAvenant: Commun.Enum.TypeAvenant, numeroSimulationAvenant: number): ng.IPromise<Modeles.DossierCreditAvenant.Garanties.IGaranties>;
    }
...
declare module Avenants.Rest.Services {
    ...
    interface IParametresService {
        getParamsStandard(codeEtablissement: string, dateTraitement: string, numeroCredit: string): ng.IPromise<ModelGestion.Parametre.IParametre>;
    }
...
declare module Avenants.Rest.Services {
    interface IPrestationService {
        getPrestation(codeEtt: string, identifiantCredit: string): ng.IPromise<Modeles.DossierCreditAvenant.Prestation.IPrestation>;
    }
    interface IPrestationParams {
        codeEtablissement: string;
        identifiantCredit: string;
    }
    class PrestationService implements IPrestationService {
        private restService;
        static $inject: Array<string>;
        constructor(restService: Services.IRestService);
        getPrestation(codeEtt: string, identifiantCredit: string): ng.IPromise<Modeles.DossierCreditAvenant.Prestation.IPrestation>;
...
declare module Avenants.Rest.Services {
    ...
    interface ISignatureService {
        getEligibilite(codeEtablissement: string, dateTraitement: string, idCredit: string, caraFinan: ModelAvenant.CaracteristiqueFinan.ICaracteristiqueFinan, avenant: ModelAvenant.Recherche.IAvenant, codeNatureFinancementCredit: string, isEligibilite: boolean, typeEdition: Commun.Enum.TypeEdition, isEcureuilCredit: boolean): ng.IPromise<ModelEligibilite.IEligibilite>;
        ...
        putHistoSignatureElectronique(codeEtablissement: string, dateTraitement: string, idCredit: string, numeroRelatif: number, idGeneriqueSecondDossierCredit: string, motif: string): ng.IPromise<ModelAvenant.Caracteristique.ICaracteristique>;
        putAnnulerSignatureElectronique(codeEtablissement: string, dateTraitement: string, idCredit: string, numeroRelatif: number, annulerSed: boolean): ng.IPromise<ModelAvenant.Caracteristique.ICaracteristique>;
    ...
    class SignatureService implements ISignatureService {
        ...
        getSignatureElectronique(codeEtablissement: string, dateTraitement: string, idCredit: string, numeroRelatif: number): ng.IPromise<ModelAvenant.Caracteristique.ICaracteristique>;
        /**
         * Ajout d'un évenement historique pour la SED
         */
        putHistoSignatureElectronique(codeEtablissement: string, dateTraitement: string, idCredit: string, numeroRelatif: number, idGeneriqueSecondDossierCredit: string, motif: string): ng.IPromise<ModelAvenant.Caracteristique.ICaracteristique>;
        /**
         * Annule la SED pour cet avenant
         */
        putAnnulerSignatureElectronique(codeEtablissement: string, dateTraitement: string, idCredit: string, numeroRelatif: number, annulerSed: boolean): ng.IPromise<ModelAvenant.Caracteristique.ICaracteristique>;
        putSignatureElectronique(codeEtablissement: string, dateTraitement: string, idCredit: string, histoMiseAJour: ModelAvenant.Caracteristique.IHistoMiseAJour, indicateurInitMAJ: ModelAvenant.Caracteristique.IIndicateurInitMAJ): ng.IPromise<ModelAvenant.Caracteristique.ICaracteristique>;
        deleteDossierIdn(codeEtablissement: string, idActeIDN: string): ng.IPromise<ModelIDN.DossierNumerique.IReponseAnnulationDossier>;
    }
}
...
declare module Avenants.Rest.Constantes {
    module Services {
        ...
        module Avenant {
            ...
            const urlAjustementEcheancesTauxDuree: string;
            const urlCaracteristique: string;
...
declare module Avenants.Rest.Modeles.AvenantCreditParam.Eligibilite {
    ...
    class CriteresAppelBuilder {
        getResult(codeEtablissement: number, dateTraitement: string, idCredit: string, caraFinan: RestAvenant.CaracteristiqueFinan.ICaracteristiqueFinan, avenant: RestAvenant.Recherche.IAvenant, codeNatureFinancementCredit: string, isEligibilite: boolean, typeEdition: Commun.Enum.TypeEdition, isEcureuilCredit: boolean): ICriteresAppel;
        private getDonneesGeneral(codeEtablissement, dateTraitement, isEligibilite, typeEdition, isEcureuilCredit);
        private isIndusBPCESC(typeEdition, isEcureuilCredit);
        /**
         * Création de la liste complète
         */
        private getListeDonneesUnCarac(idCredit, codeExistenceCreditTxRevisable, credit, listeIdGarantie, listeIdAssurance, typeEdition, isEcureuilCredit);
        private getCodePourCreationLoiDossierDonneesUnCarac(typeLoi);
        private getParametragePiecoFlyer(typeEdition, isEcureuilCredit, idCredit);
        /**
        ...
        private getListeDonneesDixCarac(idCredit, codeNatureFinancementCredit);
        private getDonneesDixCarac(codeTypeEntite, identifiantEntiteComparaison, idElement, identifiantDonnee, zoneBanalisee);
        private getDonneesCinquanteCarac(idCredit);
        private getListeDonneesNumerique(credit, nbEmprunteur);
...
declare module Avenants.Rest.Modeles.DossierCreditAvenant.Garanties {
    interface IGaranties extends IElementGestion {
        ...
        listeAccessoireParConvention: Array<IListeAccessoireParConvention>;
        listeConventionApplicableCredit: Array<IListeConventionApplicableCredit>;
        listeFraisGarantieParNature: Array<IListeFraisGarantieParNature>;
        listeGarantieApplicables: Array<IListeGarantiesApplicables>;
        listeMotifsEstimation: Array<IListeMotifsEstimation>;
        listeObjetsCommerciaux: Array<IListeObjetsCommerciaux>;
        listeObjetsNatureGarantie: Array<IListeObjetsNatureGarantie>;
        listeObjetsReglementeParCategorie: Array<IListeObjetsReglementeParCategorie>;
        listeObjetsReglementes: Array<IListeObjetsReglementes>;
        listePays: Array<IListePays>;
        listePersonneAssurableOuGarant: Array<IListePersonneAssurableOuGarant>;
        listeTypologieInstruction: Array<IListeTypologiesInstruction>;
    ...
    interface IListeTypologiesInstruction {
        /**
         * TYPE DE TYPOLOGIE
         */
        typeTypologie: string;
    ...
    interface IListePersonneAssurableOuGarant {
        /**
         * IDENTIFIANT CAISSE EPARGNE
         */
        codeEtablissement: number;
    ...
    interface IListeConventionApplicableCredit {
        /**
         * IDENTIFIANT CAISSE EPARGNE
         */
        codeEtablissement: number;
    ...
    interface IListeAccessoireParConvention {
        /**
         * IDENTIFIANT CAISSE EPARGNE
         */
        codeEtablissement: number;
    ...
    interface IListeGarantiesApplicables {
        /**
         * IDENTIFIANT CAISSE EPARGNE
         */
        codeEtablissement: number;
    ...
    interface IListeObjetsCommerciaux {
        /**
         * IDENTIFIANT CAISSE EPARGNE
         */
        codeEtablissement: number;
    ...
    interface IListeObjetsReglementes {
        /**
         * IDENTIFIANT CAISSE EPARGNE
         */
        codeEtablissement: number;
    ...
    interface IListeObjetsNatureGarantie {
        /**
         * IDENTIFIANT CAISSE EPARGNE
         */
        codeEtablissement: number;
    ...
    interface IListeFraisGarantieParNature {
        /**
         * IDENTIFIANT CAISSE EPARGNE
         */
        codeEtablissement: number;
    ...
    interface IListeObjetsReglementeParCategorie {
        /**
         * IDENTIFIANT CAISSE EPARGNE
         */
        codeEtablissement: number;
    ...
    interface IListeMotifsEstimation {
        /**
         * CODE MOTIF RE ESTIMATION
         */
        codeMotifReEstimation: string;
...
declare module Avenants.Rest.Modeles.DossierCreditAvenant.Prestation {
    interface IPrestation {
        numeroPrestation: INumeroPrestation;
        retourQR: Array<IRetourQR>;
    }
    interface INumeroPrestation {
        /**
         * Code retour Echanges
         */
        codeRetour: number;
        /**
         * Numéro enregistrement prestation
         */
        numeroEnregistrementPrestation: number;
    }
    interface IRetourQR {
        messageRetour: Array<string>;
        codeRetour: number;
