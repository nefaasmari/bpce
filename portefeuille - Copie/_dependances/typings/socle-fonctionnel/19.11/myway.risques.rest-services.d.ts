...
declare namespace Contentieux.RestServices.Services {
    interface IEcheancierService {
        ...
        deleteEcheancier(codeEtablissement: string, numeroDossier: number, identifiantCreance: string, typeEcheancier: string, numeroHistoAccord: number): ng.IPromise<Modeles.IEcheancier>;
    }
