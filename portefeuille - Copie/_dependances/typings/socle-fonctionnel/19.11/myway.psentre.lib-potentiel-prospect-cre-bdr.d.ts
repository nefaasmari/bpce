...
declare module LibrairiePotentielProspectCreBdr.Directives.PotentielProspect.Controleur {
    class LibPotentielPropectCreControleur {
        ...
        constructor($q: ng.IQService, $scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, potentielProspectService: Services.Rest.TiersCorporateV1.Potentielprospect.IPotentielProspectService, gestionPotentielService: Services.IGestionPotentielService);
        majNote(): void;
    }
}
