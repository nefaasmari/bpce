...
declare namespace Mad.Commun.Modeles.Application {
    interface IInformationsEntiteTitulaire {
        ...
        /**
         * Mode de relation des personnes composant une entité titulaire. Valeurs :
         * 1 mode simple
...
declare namespace Mad.Commun.Directive {
    class MadInfoEntiteControleur {
        ...
        participantSelectionne: Modeles.Application.IPersonne;
        formSelectionParticipant: ng.IFormController;
        private static CLASS_NAME;
        private static logger;
        constructor(serviceAgent: MyWay.Services.ServiceAgentExtended, $scope: ng.IScope, popupCommunService: Services.IPopupCommunService, portailService: myway.portail.api.PortailService, lisaService: PdtEntreprise.Services.ILisaService);
...
declare namespace Mad.Commun.Services {
    interface IInformationsEntiteService {
        getInformationsEntite(identifiantEI: number): ng.IPromise<Modeles.Application.IInformationsEntiteTitulaire>;
    }
}
...
declare namespace Mad.Commun.Services {
    ...
    interface IRestToAppCommunService {
        ...
        /**
         * Transforme un objet issu de la ressource informationsEntiteTitulaire vers un objet utilisé par l'appli
         * @param infosEntiteRest REST
         */
