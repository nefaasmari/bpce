...
declare module MyWay.Clients.ParametrageLettresVad.Lib {
    class Referentiel {
        ...
        static restDocumentV1Caracteristique: string;
    }
    class Reference {
...
declare module MyWay.Clients.ParametrageLettresVad.Lib.Rest.DocTypeParametreJeuParametre {
    ...
    class JeuParametre {
        static filtrerDateFinNonPassee(liste: Array<Lib.Rest.DocTypeParametreJeuParametre.ICaracteristiqueJeu>, idNonFiltre?: number): Array<Lib.Rest.DocTypeParametreJeuParametre.ICaracteristiqueJeu>;
    }
}
...
declare module MyWay.Clients.ParametrageLettresVad.Lib.Rest.DocTypeParametreJeuParametre {
    class DocTypeParametreJeuParametreService extends MyWay.Clients.ParametrageLettresVad.Lib.Rest.RacineRestService {
        ...
        supprimerJeuParametre(jeuParametre: ICaracteristiqueJeu): ng.IPromise<ICaracteristiqueJeu>;
...
declare module MyWay.Clients.ParametrageLettresVad.Lib.Rest.DocTypeParametreOptionDocument {
    /**
     * Nom du module.
     * Pour info, cette exportation de variable est uniquement présent pour donner de la
     * visibilité aux interfaces dans les projets qui importent le composant commun.
     */
    var _path: string;
    interface IGetDocTypeParametreOptionDocument {
        codeEtablissement: string;
        typeDocument?: string;
        dateTraitement?: Date | string;
    }
    interface IJeuDetail {
        ...
        dateDebutValiditeParam: Date | string;
        dateFinValiditeParam: Date | string;
        dateMajEnrgParam: Date | string;
    ...
    interface IOptionDocument {
        ...
        entiteVente: IEntite;
        jeuDetailPourMaj: IJeuDetail;
    }
    interface IJeuDocumentDetail {
        codeEtablissement: string;
        typeDocument: string;
        identJeuParametre: number;
        dateDebutValiditeJeuDoc: Date | string;
        dateFinValiditeJeuDoc: Date | string;
        dateMajEnrgJeuDoc: Date | string;
    ...
    interface IAdresseRetourDetail {
        ...
        ligne5Adresse: string;
        ligne6Adresse: string;
        dateDebutValiditeAdresse: Date | string;
        dateFinValiditeAdresse: Date | string;
        dateMajEnrgAdresse: Date | string;
        referenceExterneAgentDerModAdre: number;
    }
    interface IJeuParametreCaracteristique {
        codeEtablissement: string;
        libelleJeuParametre: string;
        identifiantJeuParametre: number;
        dateDebutValiditeJeu: Date | string;
        dateFinValiditeJeu: Date | string;
        dateMajEnrgJeu: Date | string;
...
declare module MyWay.Clients.ParametrageLettresVad.Lib.Rest.DocTypeParametreOptionDocument {
    class DocTypeParametreOptionDocumentService extends MyWay.Clients.ParametrageLettresVad.Lib.Rest.RacineRestService {
        static $inject: string[];
        constructor($q: ng.IQService, $timeout: ng.ITimeoutService, svcAgent: MyWay.Services.ServiceAgentExtended);
        formatterOptionDocument(objet: IJeuDetail): void;
        preparerOptionDocument(objet: IJeuDetail): void;
        majOptionDocument(codeEtablissement: string, identifiantJeuParametre: number, codeEntiteVente: string, parametre: Rest.DocTypeParametreJeuParametre.IJeuDetail): ng.IPromise<Rest.DocTypeParametreJeuParametre.IJeuDetail>;
    }
}
...
declare module MyWay.Clients.ParametrageLettresVad.Lib.Rest.DocTypeParametreSignataire {
    class DocTypeParametreSignataireService extends MyWay.Clients.ParametrageLettresVad.Lib.Rest.RacineRestService {
        static $inject: string[];
        constructor($q: ng.IQService, $timeout: ng.ITimeoutService, svcAgent: MyWay.Services.ServiceAgentExtended);
...
declare module MyWay.Clients.ParametrageLettresVad.Lib.Rest.DocumentV1Caracteristique {
    /**
     * Nom du module.
     * Pour info, cette exportation de variable est uniquement présent pour donner de la
     * visibilité aux interfaces dans les projets qui importent le composant commun.
    ...
    class Caracteristique {
        static getCodeFamille(liste: ICaracteristique, typeDocument: string): string;
        data: ICaracteristique;
        constructor(data: ICaracteristique);
        getCodeFamille(typeDocument: string): string;
    }
}
...
declare module MyWay.Clients.ParametrageLettresVad.Lib.Rest.DocumentV1Caracteristique {
     ...
     */
    var _path: string;
    interface IGetDocumentCaracteristique {
        typeDocument?: string;
        dateStandard?: Date | string;
        codeTypeICG?: string;
    }
    interface ICaracteristique {
        listeDetailDocument: Array<IDetailDocument>;
    }
    interface IDetailDocument {
        codeRetour: number;
        ...
        indicateurNonMaterialisation: string;
        dateDebutValidite: Date | string;
        dateFinValidite: Date | string;
        typeAttributaireClasseurClient: string;
        indicateurDocumentEntreprise: string;
        typeMaquette: string;
        codeFamilleUnDocument: string;
        codeApplicationTechniqueEdition: string;
        libelleTypeMaquette: string;
        codeTechniqueMaquette: string;
        dateDebutValidite1: Date | string;
        dateFinValidite1: Date | string;
        codeAgent: number;
        typeDocument: string;
        libelleDocument: string;
        dateCreationMaj: Date | string;
    }
}

declare module MyWay.Clients.ParametrageLettresVad.Lib.Rest.DocumentV1Caracteristique {
    class Service extends MyWay.Clients.ParametrageLettresVad.Lib.Rest.RacineRestService {
        static $inject: string[];
        constructor($q: ng.IQService, $timeout: ng.ITimeoutService, svcAgent: MyWay.Services.ServiceAgentExtended);
        formatterOptionDocument(objet: IDetailDocument): void;
        getDocuments(typeDocument: string, dateStandard: Date, codeTypeICG: string): ng.IPromise<ICaracteristique>;
    }
}
