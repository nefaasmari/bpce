...
declare module syntheseClient {
    class ChargementControleur {
        ...
        private syntheseClientChargementService;
        private syntheseToolsService;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, syntheseClientChargementService: syntheseClient.Service.SyntheseClientChargementService, syntheseToolsService: Service.SyntheseToolsService);
        init(): void;
    }
}
...
declare module syntheseClient {
    ...
    class RechercheControleur {
        ...
        private watcher;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, syntheseInitialisationService: syntheseClient.Service.SyntheseInitialisationService, $scope: IRechercheScope);
...
declare module syntheseClient {
    class VueDetailCommercialControleur {
        ...
        genererTableauComposition(): Modeles.Commercial.IListeDetailRelations[];
        getTableauComposition(): ng.IPromise<void>;
        ouvrirDetailSegmenation(): void;
    }
}
...
declare module syntheseClient {
    class SyntheseMainControleur {
        ...
        urlProduits: string;
        routeChange: boolean;
        constructor(syntheseClientDonneesService: syntheseClient.Service.SyntheseClientDonneesService, $route: ng.route.IRouteService, syntheseInitialisationService: syntheseClient.Service.SyntheseInitialisationService, syntheseClientUtilitaireService: Service.SyntheseClientUtilitaireService, $q: ng.IQService, $location: ng.ILocationService, $rootScope: ng.IRootScopeService, $anchorScroll: ng.IAnchorScrollService, syntheseClientChargementService: Service.SyntheseClientChargementService);
        init(): void;
        getDetailUrlBase(vue: string, typePersonne: string): string;
        /**
         * provoque le scroll sur un element, via le hash passé
         * @param id{string} : l'id du bloc sur lequel scroller
         */
...
declare module syntheseClient.Service {
    ...
    class SyntheseClientChargementService {
        ...
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, syntheseClientUtilitaireService: syntheseClient.Service.SyntheseClientUtilitaireService, syntheseInitialisationService: syntheseClient.Service.SyntheseInitialisationService, syntheseClientDonneesService: syntheseClient.Service.SyntheseClientDonneesService, $q: ng.IQService, syntheseImpressionService: syntheseClient.Service.ISyntheseImpressionService, mwNotificationService: MyWay.UI.IMwNotificationService, $timeout: ng.ITimeoutService, contexteClientService: libPortail.ContexteClientService);
        /**
         ...
         */
        initialisationChargement(rechargement?: boolean, indicateurSynchroSynthese?: libPortail.IndicateurSynchroSyntheseEnum): void;
        /**
         ...
         */
        rafraichirSynthese(valeur: INotification): void;
        /**
         * Mise en avant du retour d'erreur depuis un service REST
         * @param {string} erreur
         */
        erreur(erreur: string): void;
        /**
         * méthode annulant le loader
         */
...
declare module syntheseClient.Service {
    ...
    class SyntheseInitialisationService {
        ...
        getCriteresClient(): MyWay.Model.Client;
...
declare module syntheseClient.Service {
    class SyntheseProduitLancementService {
        ...
        private syntheseInitialisationService;
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, libPortail: libPortail.PortailService, erreurService: myway.core.ErreurService, logger: myway.core.LoggerService, syntheseInitialisationService: syntheseClient.Service.SyntheseInitialisationService);
        /**
         * Retourne les informations du produit ou service appelé avec les paramétres pour lancer le processus LISA
         * @param produit
         */
        getProcessusReadyToStart(produit: IScopeScElementProduit, dateNaissance?: string): IProduitDetails;
        /**
         * Retourne la liste des produits avec un passage de paramétres de type LISA pour lancer le processus associé
         * @param produit
         * @return IProduit
         */
        getDefineProduits(produit: IScopeScElementProduit, dateNaissance?: string): IProduit;
    }
}
...
declare module syntheseClient.Service {
    class SyntheseClientDonneesService {
        ...
        indicateurSynchroSynthese: libPortail.IndicateurSynchroSyntheseEnum;
        modeleMessage: Modeles.AlertesMessagesService.IModeleConteneurMessageService;
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, urlSyntheseClient: string, urlListeDesSyntheses: string, urlListeDesBlocs: string, $q: ng.IQService, syntheseToolsService: Service.SyntheseToolsService, urlSegmentationMarche: string, urlCaracteristiqueAgence: string, urlSyntheseServices: string, urlListeMessagesService: string, urlOffresEnInstance: string, syntheseErreurService: syntheseClient.Service.ErreursManagement, urlSegmentCommercial: string, urlNoteBale2: string, syntheseInitialisationService: Service.SyntheseInitialisationService, urlEntiteTitulaire: string, mwNotificationService: MyWay.UI.IMwNotificationService, contexteClientService: libPortail.ContexteClientService, $timeout: ng.ITimeoutService);
        ...
        setDonneeProduits(objet: syntheseClient.Modeles.SyntheseGlobale.ISyntheseDonneesClient): Modeles.SyntheseGlobale.ISyntheseDonneesClient;
        ...
        recupererSyntheseClient(codeAgent: number, numeroPersonne: number, idEdsInterne: number, forcer?: boolean): ng.IPromise<syntheseClient.Modeles.SyntheseGlobale.ISyntheseDonneesClient>;
        checkAppel(codeAgent: number, numeroPersonne: number, idEdsInterne: number, forcer?: boolean): ng.IPromise<Modeles.SyntheseGlobale.ISyntheseDonneesClient>;
...
declare module syntheseClient.Service {
    class SyntheseClientRisquesAlertesService {
        ...
        modeleMessage: Modeles.AlertesMessagesService.IModeleConteneurMessageService;
        static $inject: string[];
        constructor(syntheseClientUtilitaireService: SyntheseClientUtilitaireService, syntheseInitialisationService: Service.SyntheseInitialisationService, syntheseClientDonneesDelocService: Service.SyntheseClientDonneesDelocService, syntheseClientDonneesService: Service.SyntheseClientDonneesService);
        init(): void;
        /**
         ...
         */
        afficherQcf(codeNiveauConnaissanceClient: string, dateDernEvaluationConnaissance: string): string;
        /**
...
declare module syntheseClient.Directive {
    class SyntheseBlocProduitsControleur {
        ...
        static $inject: string[];
        constructor(serviceInit: Service.SyntheseInitialisationService, syntheseProduitService: Service.SyntheseProduitService, syntheseClientUtilitaireService: Service.SyntheseClientUtilitaireService, syntheseClientConstantes: Constantes.Constantes, $scope: ng.IScope, $timeout: ng.ITimeoutService);
        typeProduitSelectionne: string;
        /**
         * Permet d'initialiser les données du service REST
         */
        initialisation(): void;
        initialiserCibleCriteres(): void;
        /**
         * obtenir le titre de l'onglet produit en fonction du codeEtatProduitService
         */
        titreOngletProduit: {
...
declare module syntheseClient.Directive {
    class SyntheseFooterControleur {
        ...
        /**
         * contexte client, texte de raffraichissement
         */
        texteContexteChargement: string;
    }
}
...
declare module syntheseClient.Directive {
    class SyntheseHeaderControleur {
        ...
        private libPortail;
        static $inject: string[];
        constructor(syntheseInitialisationService: syntheseClient.Service.SyntheseInitialisationService, $location: ng.ILocationService, $timeout: ng.ITimeoutService, syntheseToolsService: syntheseClient.Service.SyntheseToolsService, syntheseClientDonneesService: syntheseClient.Service.SyntheseClientDonneesService, $scope: ng.IScope, syntheseClientProfilService: Service.SyntheseClientProfilService, libPortail: libPortail.PortailService);
        libelleEntrepreneurIndividuel: string;
        getListeActions(): Modeles.Vues.IVueSynthese[];
        vueCourante: syntheseClient.Modeles.Vues.IEnteteObjet;
