...
declare module myway.core {
    class MobiliteService extends FrameworkService {
         ...
         */
        getApplicationsContexteMobilite(applications: myway.ressources.portailmyway.rechercheapplication.IApplication[]): ng.IPromise<{
            [codeApplication: string]: boolean;
        }>;
        /**
         * Extraire les valeurs des clés de l'application pour le contexte de mobilité
         */
        private getStringFromServiceMobilite(value, id);
        toLibelleDeviceCompatible(): string;
        fromLibelleDeviceCompatible(value: string, plateformes: IPlateforme[]): string;
        getPlateformesFromLibelleDeviceCompatible(value: string, plateformes: IPlateforme[]): IPlateforme[];
        getResolutionMinimaleMywayFromLibelleDeviceCompatible(value: string): boolean;
        getEcranTactileFromLibelleDeviceCompatible(value: string): boolean;
        /**
