...
declare namespace ICCreditComponents.Directives.RedacteurActe {
    class RedacteurActeControleur {
        ...
        static $inject: string[];
        constructor(redacteurActeService: ICBusiness.Services.RedacteurActe.IRedacteurActeService, popinService: Services.IPopinService, redacteurActeFormSettingsService: IRedacteurActeFormSettingsService);
...
declare namespace ICCreditComponents.Directives.RedacteurActe {
    ...
    interface IRedacteurActeViewModel {
        ...
        redacteurActeInitial: ICBusiness.Models.RedacteurActe.IRedacteurActe;
        adresseRedacteurActe: ICCreditComponents.Forms.IAddress;
    ...
    class RedacteurActeViewModel implements IRedacteurActeViewModel {
        ...
        ligne6Rules: ICBusiness.Rules.IValidationRule[];
        nomRules: ICBusiness.Rules.IValidationRule[];
        constructor(context: BusinessModel.Common.IContext);
        hasChanged: boolean;
        isValid: boolean;
        private getRules();
        private isEmpty;
...
declare namespace ICCreditComponents.Directives.Garantie {
    ...
    class DetailGarantieAdminControleur {
        ...
        garantiePersonnelleSettings: IDetailGarantiePersonnelleFormSettings;
...
declare namespace ICCreditComponents.Directives.Garantie {
    interface IDetailGarantiePersonnelleFormSettings {
    ...
    class DetailGarantieSettingsService {
        getDetailsGarantiePersonnelleSettings(context: ICBusiness.Models.Common.IContext, garantie: ICBusiness.Models.Garanties.IGarantie): IDetailGarantiePersonnelleFormSettings;
