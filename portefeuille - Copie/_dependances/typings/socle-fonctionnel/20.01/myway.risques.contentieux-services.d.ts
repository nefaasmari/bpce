...
declare namespace ContentieuxServices.Modeles.Participant {
    type TypeRole = "Titulaire" | "Caution" | "Mandataire" | "Client Bancaire" | "Autre";
    class Participant {
        designation: string;
        idPersonne: number;
        role: TypeRole;
...
declare namespace ContentieuxServices.Services.Echeancier {
    class EcheancierService implements IEcheancierService {
        ...
        private smsService;
        static $inject: string[];
        constructor(echeancierRestService: Contentieux.RestServices.Services.EcheancierService, cacheService: Services.Commun.ICacheService, riceService: myway.comInterdomaine.SaisieRiceService, $q: ng.IQService, entiteTitulaireService: ContentieuxServices.Services.EntiteTitulaire.IEntiteTitulaireService, tiersService: ContentieuxServices.Services.Tiers.TiersService, smsService: ContentieuxServices.Services.SMS.SMSService);
        /**
         ...
         * @param identifiantEntiteTitulaire
         */
        private mappeListeEcheanciers(listeRest, identifiantEntiteTitulaire, isEcheancierActif);
        /**
         * Mappe Echancier
         ...
         * @param inputEcheancier
         */
        private mappeEcheancier(restEcheancier, identifiantEntiteTitulaire, isEcheancierActif, inputEcheancier?);
        /**
         * Mappage du statut
         ...
         * @param restPalier
         */
        private mappePalier(restPalier, typeEcheancier, isEcheancierActif, mode);
        /**
         * Indique si le palier est en cours
         * @param dateDebutPalier
         * @param dateFinPalier
         */
        private isPalierEnCours(dateDebutPalier, dateFinPalier);
        /**
         * Mappage de la liste de paliers : récupération du nom du titulaire
         * @param listeRest
         * @param identifiantEntiteTitulaire
         */
        private mappeListePaliers(listeRest, typeEcheancier, isEcheancierActif, mode);
        /**
         * Mappage d'un panel
         * @param echeancier
         * @param codeEtablissement
         ...
         * @param typeEcheancier
         */
        private getCodeTypeEcheancier(typeEcheancier, isPartiel);
        /**
         * Retourne le code type de l'échéancier en fonction du type de paiement
         * @param typeEcheancier
         */
        ...
        /**
         * Retourne les infos du payeu
         * On a qu'un numéro d'ET ou de personne sur l'échéancier...
         * @param codeEtablissement
         * @param numeroTitulaire
         */
        getPayeur(codeEtablissement: string, numeroTitulaire: number, identifiantEntiteTitulaire: string): ng.IPromise<ContentieuxServices.Modeles.Participant.Participant>;
        /**
         * Point budget
         * @param codeEtablissement
         * @param numeroDossier
