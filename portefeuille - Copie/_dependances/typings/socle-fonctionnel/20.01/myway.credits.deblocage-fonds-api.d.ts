...
declare module DeblocageFonds.Commun.Services {
    class MyFlowServices {
         ...
         */
        recupereEvenementsTacheMyFlow(codeEtablissement: number, identifiantDossierInstruction: string, dateTraitement: string, codeEvenement: string, dateSignatureDossier: string, identifiantAgent?: string): ng.IPromise<Modeles.EvtTacheMyFlow.IEvtTacheMyFlow>;
        /**
