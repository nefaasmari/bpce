...
declare namespace ContentieuxEditique.Services.EDS {
    class EDSService {
        ...
        getEditiqueEDS(echeancier: ContentieuxEditique.Modeles.IEcheancierEditique): ng.IPromise<[ContentieuxServices.Modeles.EDS.IEDSInterne, string]>;
...
declare namespace ContentieuxEditique.Services.Echeancier {
    class EcheancierEditiqueService implements IEcheancierEditiqueService {
        ...
        setEditiqueDonneesEds(infosEds: ContentieuxServices.Modeles.EDS.IEDSInterne, libelleLongEtablissement: string): ContentieuxEditique.Modeles.IEditiqueEDS;
    }
}
