...
declare module Avenants.Rest.Services {
    ...
    class RestService implements IRestService {
        ...
        private getData<T, U, V>(typeMethode, urlService, params?, data?, timeout?);
        /**
...
declare module Avenants.Rest.Constantes {
    module Mock {
        const avenantRecherche: Modeles.DossierCreditAvenant.Recherche.IRecherche;
        const avenantCaraSignaElect: Modeles.DossierCreditAvenant.Caracteristique.ICaracteristique;
        const creditCaraCredit: Modeles.DossierCreditGestion.CaracteristiqueCredit.IListeCredits;
        const posteFonctionnelAgent: Modeles.Structure.PosteFonctionnelAgent.IPosteFonctionnelAgent;
        const creditListeHabGlobal: Array<Modeles.DossierCreditGestion.HabilitationCredit.IHabilitation>;
        const creditInfoCredit: Modeles.DossierCreditGestion.InformationCredit.IInformationCredit;
        const produit: Modeles.AvenantCreditParam.Produit.IProduit;
        const infoAvenantbyCaraFinan: Modeles.DossierCreditAvenant.CaracteristiqueFinan.ICaracteristiqueFinan;
        const infoEntiteTitulaire: Modeles.EntiteTitulaire.InformationEntiteTitulaire.IInformationEntiteTitulaire;
        const contraParametre: Modeles.DocumentParametre.ContractualisationParametre.IContractualisationParametre;
        const eligibiliteA: Modeles.AvenantCreditParam.Eligibilite.IEligibilite;
        const eligibiliteB: Modeles.AvenantCreditParam.Eligibilite.IEligibilite;
        const garantiesNatures: Modeles.DossierCreditAvenant.Garanties.IGaranties;
        const listeParamApplicatif: Array<Modeles.CreditParametre.ListerParamApplicatif.IScParamApplicatif>;
        const impressionDossier: Modeles.AvenantCreditService.ImpressionDossier.IImpressionDossier;
        const palierCredit: Modeles.DossierCreditGestion.PalierCredit.IPalierCredit;
        const justicatifCredit: Modeles.DossierCreditGestion.CaracteristiqueCredit.IDonneeCredit;
    }
}

declare module Avenants.Rest.Constantes {
    module Mock {
        const carafinan: Modeles.DossierCreditAvenant.CaracteristiqueFinan.ICaracteristiqueFinan;
    }
}
...
declare module Avenants.Rest.Modeles.AvenantCreditParam.Eligibilite {
    ...
    class CriteresAppelBuilder {
        ...
        private static getDonneesGeneral(codeEtablissement, dateTraitement, isEligibilite, typeEdition, isEcureuilCredit);
        private static isIndusBPCESC(typeEdition, isEcureuilCredit);
        /**
         * Création de la liste complète
         */
        private static getListeDonneesUnCarac(idCredit, codeExistenceCreditTxRevisable, credit, listeIdGarantie, listeIdAssurance, typeEdition, isEcureuilCredit);
        private static getCodePourCreationLoiDossierDonneesUnCarac(typeLoi);
        private static getParametragePiecoFlyer(typeEdition, isEcureuilCredit, idCredit);
        /**
         * Pour chaque garantie de l'avenant, il faut créer 2 nouveaux DonneesUnCarac
         */
        private static getListeDonneesUnCaracForGaranties(idCredit, listeIdGarantie);
        ...
        private static getListeDonneesDixCarac(idCredit, codeNatureFinancementCredit);
        private static getDonneesDixCarac(codeTypeEntite, identifiantEntiteComparaison, idElement, identifiantDonnee, zoneBanalisee);
...
declare module Avenants.Rest.Modeles.DossierCreditAvenant.CaracteristiqueGar {
    ...
    interface ICaracteristiqueGar extends IElementGestion {
        criteresRecherche: ICriteresRecherche;
        dossier: IDossier;
        credit: ICredit;
        personnesAssurableOuGarant: Array<IPersonneAssurableOuGarant>;
