...
declare module Mad.Rest.MouvAttenteDecision.Modele.AnnulationDecision {
    interface IMouvementMad {
        /**
         * Détermine l'origine de traitement d'un mouvement MAD.
         * 'A'       MAD agence
         * 'S'       MAD siège
         */
        codeOrigine: string;
        /**
         * Identifiant unique interne d'un mouvement MAD agence.
         */
        identifiantMouvementMadAgence: number;
        /**
         * identifiantMouvementMadSiege
         */
...
declare module Mad.Rest.MouvAttenteDecision.Modele.Caracteristique {
    ...
    interface ICourrier {
        ...
        /**
         * En remplacement de "indicateurDemandeAutoMurcef" qui devient obsolète
         * 1- envoi courrier Murcef automatique
         * 2- envoi courrier "Mise en garde" automatique
         */
        codeEnvoiCourrierAutomatique: string;
        libelleEnvoiCourrierAutomatique: string;
        /**
         * 1- envoi sms Murcef automatique
         * 2- envoi sms "Mise en garde" automatique
         */
    ...
    interface IDecision {
        ...
        motifRejet: string;
        /**
         * Détermine le motif complémentaire pour lequel un mouvement entré au MAD a été rejeté pour l'utilisateur. '01 : OPPOSITION POUR VOL '02' : OPPOSITION POUR PERTE '03' : UTILISATION FRAUDULEUSE '12' : COORDONNES ERRONEES
         *                                                                                                          '14' : COMPTE SOLDE
         */
...
declare module Mad.Rest.MouvAttenteDecision.Modele.DemandeDelegation {
    interface IDemandeControleDelegation {
        /**
         * Code établissement de l'utilisateur.
         */
        codeEtablissement: string;
        /**
         * Code de l'application appelant le service de délégation.
         * '01' - NEO
         * '02' - MAD
         */
        codeApplicationAppelante: string;
        /**
         * Date et heure de la demande de contrôle de délégation
         * Type date au format yyyy-MM-dd'T'HH:mm:ss.SSSZ
         */
    ...
    interface IAgent {
        ...
        codeAgent: number;
        /**
         * Code de la fonction de l'agent
         */
        typeFonctionAgent: string;
        /**
         * Identifiant du poste fonctionnel de l'agent. Correspond à l'identifiant interne.
         */
        identifiantPosteFonctionnel: number;
    }
    interface IQuestion {
...
declare module Mad.Rest.MouvAttenteDecision.Modele.InfoSpecifiqueETMad {
    interface IParametreGet {
        ...
        /** Code établissement du compte bancaire sur lequel on effectue la recherche de mouvements. */
        codeEtablissement: string;
        /** Identifiant de l'entité titulaire pour laquelle on recherche des informations. */
        identifiantEntiteTitulaire: number;
        /** Précise si la recherche d'informations doit inclure les données utiles pour le moteur de délégation Adelys V2. */
    ...
    interface IEntiteTitulaire {
         ...
         * true : note obsolète
         * false : note valide
         * Déterminé suivant le code CEMBNO du segment réponse S958 :
         * '4' : obsolète
         * sinon: valide
         */
        indicateurNoteObsolete: boolean;
        /**
         * Catégorisation de la clientèle selon la segmentation de marché. Permet de déduire les segmentations risque et marché. 'CC000001' : personnel Groupe 'CC000002' : dirigeant de société de capitaux profession libérale
         */
        codeCategorieClient: string;
    ...
    interface IPersonne {
        ...
        codePaysResidence: string;
        /**
         * Identifie un département ou une collectivité d'outre-mer dans la nomenclature INSEE. 01/96 : correspondent aux départements métropolitains 2A : corse du Sud 2B : haute Corse
         */
        codeDepartementResidence: string;
        /**
         * Détermine la branche d'activité du Profressionnel selon la nomenclature NAF Révision 2,2008 de l'INSEE.
        ...
        codeNafInsee: string;
        /**
         * Cotation attribuée à une entreprise donnée par la Banque de France. Exemples : 3, 3+, 3++, 4, 4+,...
         */
        cotationFibenEntreprise: string;
        /**
         * Cotation attribuée à un dirigeant donné pour une personne morale donnée par la Banque de France. '000' : pas de réserve
         * '040' : attention particulière '050' : réserves
         * '060' : réserves sérieuses
         */
        cotationFibenDirigeant: string;
        /**
         * Détermine la situation de fichage d'une personne à une date donnée, situation enregistrée dans le fichier FCC de la BDF.
         * 'O' : fiché au FCC => '1' interdiction bancaire d'origine interne => '2' interdiction bancaire BdF 'N' : non fiché au FCC => autres cas
         */
        codeFichageFcc: boolean;
        /**
         * Détermine la situation de fichage d'une personne à une date donnée, situation enregistrée dans le fichier FICP de la BDF. 'O' : fiché au FICP => '0' actif 'N' : non fiché au FICP => autres cas
         */
        codeFichageFicp: boolean;
        /**
         * Indique si la personne est topée Watch List Locale (liste de surveillance). 'O' : la personne est topée Watch List Locale 'N' : la personne n'est pas topée Watch List Locale
         */
        indicateurWatchListLocale: boolean;
        /**
         * Détermine le niveau de Watch List Locale. '1' : encours sain et significatif '2' : risque dégradé '3' : risque de défaillance
         */
        codeNiveauWatchListLocale: string;
        /**
         * Indique si la personne est topée Watch List Nationale. 'O' : la personne est topée Watch List Nationale 'N' : la personne n'est pas topée Watch List Nationale
         */
        indicateurWatchListNationale: boolean;
        /**
         * Détermine le niveau de Watch List Nationale. 'S' : saine
         * 'D' : douteuse
         */
        codeNiveauWatchListNationale: string;
        /**
         * Indique si la personne est topée Watch List Banque Référente. 'O' : la personne est topée Watch List Banque Référente 'N' : la personne n'est pas topée Watch List Banque Référente
         */
        indicateurWatchListBanqueRef: boolean;
        /**
         * Détermine le niveau de Watch List Banque Référente. 'S' : saine
         * 'D' : douteuse
         */
        codeNiveauWatchListBanqueRef: string;
        /**
...
declare module Mad.Rest.MouvAttenteDecision.Modele.Journal {
    ...
    interface IDecision {
        ...
        datePriseDecision: string;
        /**
         * Code indiquant l'origine de la prise de décision.
         * 'A' - décision prise du Mad agence
         * 'S' - décision prise du Mad siège
         */
    ...
    interface IMouvementMad {
        ...
        timestampDecisionMouvement: string;
        /**
         * Date et heure précise à la microseconde prêt d'enregistrement de l'annulation de la décision.
         */
    ...
    interface IInfoStructure {
        ...
        libelleEdsDecidePar: string;
        /**
         * Identifiant interne de l'agent ayant annulé une décision du jour.
         */
        identifiantEdsAnnulation: number;
        /**
         * Désignation de l'agent ayant annulé une décision du jour.
         */
...
declare module Mad.Rest.MouvAttenteDecision.Modele.RechercheHistorique {
    ...
    interface IMouvementMad {
        ...
        identifiantMouvement: number;
        /**
         * Identifiant unique interne d'une opération entrée au MAD Siège, devenant ainsi un mouvement MAD à gérer.
         */
        identifiantMouvementMadSiege: string;
        /**
         * Date à laquelle une opération, rejetée de l'imputation, est entrée au MAD.
...
declare module Mad.Rest.MouvAttenteDecision.Modele.RechercheMadDuJour {
    ...
    interface IRechercheMadDuJour {
        ...
        listeCompteBancaire: Array<ICompteBancaire>;
        /**
         * Indique une situation d'alerte au niveau de l'entité titulaire pour laquelle l'analyse de la décision gestionnaire du mouvement est obligatoire. 'O' - true 'N' - false
         */
        evaluationRisqueMad: IEvaluationRisqueMad;
    }
    interface IEvaluationRisqueMad {
        /**
         * Indique une situation d'alerte au niveau de l'entité titulaire pour laquelle l'analyse de la décision gestionnaire du mouvement est obligatoire.
         * true - au moins un des indicateurs d'alerte est valorisé à true false - sinon
         */
        indicateurEvaluationRisque: boolean;
    ...
    interface IAlerteRisque {
        /**
         * true - alerte active false - sinon
         */
        indicateurAlerte: boolean;
        /**
         * Libelle court de l'alerte à afficher
         */
        libelleCourtAlerte: string;
    }
    interface IPreconisationIAMad {
        /**
         * Détermine la décision brute préconisée par le moteur IA-MAD.
         */
        codeTypeDecisionPrecoBrute: string;
        /**
         * Détermine la décision finale préconisée à l'utilisateur Elle est basée sur la décision préconisée brute du moteur IA-MAD revue avec des filtres de gestion règlementaires, etc...
         */
        codeTypeDecisionPrecoFinale: string;
        /**
         * Indique le pourcentage de confiance de la préconisation finale.
         */
        tauxDeConfiancePrecoFinale: number;
        /**
         * 1er libellé permettant de justifier la préconisation finale.
         */
        libelleJustificatifPreco1: string;
        /**
         * 2ème libellé permettant de justifier la préconisation finale.
         */
        libelleJustificatifPreco2: string;
        /**
         * 3ème libellé permettant de justifier la préconisation finale.
         */
        libelleJustificatifPreco3: string;
        /**
         * 1er libellé permettant de justifier la préconisation finale au niveau gestionnaire.
         */
        libelleJustificatifGestion1: string;
        /**
         * 2ème libellé permettant de justifier la préconisation finale au niveau gestionnaire.
         */
        libelleJustificatifGestion2: string;
        /**
         * 3ème libellé permettant de justifier la préconisation finale au niveau gestionnaire.
         */
        libelleJustificatifGestion3: string;
        /**
         * Code associé à niveauAnalyseDuTaux ci-dessous. 'R' - rouge par défaut 'O' - orange 'V' - vert
         */
        codeNiveauAnalyseDuTaux: string;
        /**
         * Indique la couleur du niveau d'analyse déterminée uniquement par le taux de confiance de la préconisation finale par rapport aux seuils paramétrés par l'établissement (MV14). 'R' - rouge 'O' - orange 'V' - vert
         */
        niveauAnalyseDuTaux: string;
        /**
         * Code associé à niveauAnalyseGlobal ci-dessous. 'R' - rouge par défaut 'O' - orange 'V' - vert
         */
        codeNiveauAnalyseGlobal: string;
        /**
         * Indique la couleur du niveau d'analyse global déterminée par :
         *
         * le taux de confiance de la préconisation finale par rapport aux seuils paramétrés par l'établissement (MV14).
         * le Top Risque
         * 'R' - rouge si le TopRisqueMad = 'O' (oui) Sinon = niveauAnalyseDuTaux
         */
...
declare module Mad.Rest.MouvAttenteDecision.Modele.SoldeDisponible {
    ...
    interface ICompositionEnDevise {
        ...
        /**
         * soldeCompteEnDevise
         * (+) mtDecouvertAutoriseEnDevise
         * (-) mtReserveEncaissementEnDevise
         * (-) mtImpayeCreditSynchroEnDevise
         * (+) mtReserveEncaissementEnDevise
         * (+) mtPlanReglementVarioEnDevise
         */
        soldeDisponibleEnDevise: number;
        /**
         * Solde du compte bancaire à un instant donné en devise.
         */
        soldeCompteEnDevise: number;
        /**
         * Montant du découvert autorisé sur un compte bancaire en devise.
         */
        mtDecouvertAutoriseEnDevise: number;
        /**
         * Montant des impayés crédit Synchro en devise.
         */
        mtImpayeCreditSynchroEnDevise: number;
        /**
         * Montant des réserves d'encaissement en devise.
         */
        mtReserveEncaissementEnDevise: number;
        /**
         * Montant des plans de règlement Vario en devise.
         */
    ...
    interface ICompositionEnEuro {
        ...
        /**
         * soldeCompteEnEuro
         * (+) mtDecouvertAutoriseEnEuro
         * (-) mtReserveEncaissementEnEuro
         * (-) mtImpayeCreditSynchroEnEuro
         * (+) mtReserveEncaissementEnEuro
         * (+) mtPlanReglementVarioEnEuro
         */
        soldeDisponibleEnEuro: number;
        /**
         * Solde du compte bancaire à un instant donné en euro.
         */
        soldeCompteEnEuro: number;
        /**
         * Montant du découvert autorisé sur un compte bancaire en euro.
         */
        mtDecouvertAutoriseEnEuro: number;
        /**
         * Montant des impayés crédit Synchro en euro.
         */
        mtImpayeCreditSynchroEnEuro: number;
        /**
         * Montant des réserves d'encaissement en euro.
         */
        mtReserveEncaissementEnEuro: number;
        /**
         * Montant des plans de règlement Vario en euro.
         */
...
declare module Mad.Rest.MouvAttenteDecisionParam.Modele.TableParam {
    ...
    interface IEnregistrementTableMV12 {
        ...
        codeProduit: string;
        /**
         * Détermine l'acte de gestion relatif à une prise décision sur la gestion d'un mouvement du MAD. 'A' : décision en attente 'F' : forçage 'R' : rejet 'T' : forçage autre RIB sans correction RIB au créancier
         *                                                                                                'S' : forçage autre RIB avec correction RIB au créancier ' ' : sans décision (valeur par défaut) 'H' : transfert Mad Siège
         */
        codeTypeDecision: string;
        /**
         * Détermine le motif pour lequel une opération a été rejetée suite à une imputation pour entrer ensuite au MAD.
    ...
    interface IEnregistrementTableMV11 {
        /**
         * Détermine le motif pour lequel un mouvement entré au MAD a été rejeté par l'utilisateur.
         */
        codeMotifRejet: string;
        /**
         * Détermine le motif complémentaire pour lequel un mouvement entré au MAD a été rejeté parl'utilisateur.
         */
        codeMotifRejetComplementaire: string;
        dateCreationMiseAJour: string;
    }
    ...
    interface IEnregistrementTableMV5B {
        ...
        codeTypeDecision: string;
        /**
         * Cas d'un rejet 'R'  = code motif de rejet
         * Autres cas = code motif d'entrée au Mad
         */
