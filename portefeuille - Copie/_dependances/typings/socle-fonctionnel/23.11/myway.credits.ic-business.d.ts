...
declare namespace ICBusiness.Models.Navigation.LisaContract.ADD {
    interface IGreenContext {
        identifiantGreen: string;
        identifiantDossier: string;
        identifiantDefi: string;
        toc: string;
        tor: string;
        montant: number;
        modeConsultation: number;
    }
}
...
declare namespace ICBusiness.Services.ParametrageApplicatif {
    interface IParametrageAppicatifRemanentService {
        ...
        /**
         * Méthode pour savoir si le totem MRH est affiché (retourne faux en attendant le résultat de la promesse)
         * @param idDossier
         * @param idProjet
         */
        getTotemMRHVisibilite(idDossier: string, idProjet: string): boolean;
        /**
         * Permet de supprimer le paramètre applicatif remanent lié au totem MRH
         */
        supprimerPafoTotemMRHFromCache(): void;
    }
    /**
...
declare namespace ICBusiness.Services.ParametreFonctionnel {
    interface IParametreFonctionnelService {
         ...
         * @param idProjet
         */
        getTotemMRHParametreFonctionnel(idDossier: string, idProjet: string): ng.IPromise<Models.ParametreFonctionnel.IParametreFonctionnel>;
        /**
