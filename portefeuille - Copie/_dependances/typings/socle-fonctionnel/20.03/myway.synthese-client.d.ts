...
declare module syntheseClient.Modeles.Commercial {
    ...
    interface ISyntheseClientAbonnementEDoc {
        libelleEDoc: string;
    }
...
declare module syntheseClient.Modeles.SyntheseGlobale {
    ...
    interface ISyntheseClientDonneesSignaletiques {
        syntheseClientAbonnementEDoc: syntheseClient.Modeles.Commercial.ISyntheseClientAbonnementEDoc;
...
declare module syntheseClient.Modeles.Produits {
    interface ISyntheseProduitsInfoCommune extends ISyntheseClientServicesInfoCom, IIndicateurTypeAppelProcessus {
        codeDevise: string;
        codeGuichet: string;
        codeProduit: string;
        identifiantProduitService: number;
    ...
    interface IIndicateurTypeAppelProcessus {
        typeAppel: string;
        codeListeOrigine: string;
    ...
    interface ISyntheseClientProdAssCNP extends ISyntheseClientProduitInfoCommune, IIndicateurTypeAppelProcessus {
        numeroContratCnp: string;
    ...
    interface ISyntheseClientProdAssNatixis extends ISyntheseClientProduitInfoCommune, IIndicateurTypeAppelProcessus {
        numeroRibCompte: string;
        valeurRachat: number;
...
declare module syntheseClient.Modeles.DetailServices {
    ...
    interface ISyntheseServiceInfoPaylib extends ISyntheseServiceInfosCommune {
        referenceSrvAbonnPaylib: string;
        identifiantBad: string;
        identifiantAdherentPaylib: string;
        designBancPaylib: string;
        dateDebutValiditePaylib: Date;
        dateFinValiditePaylib: Date;
    }
...
declare module syntheseClient.Modeles.Services {
    interface ISyntheseClientServicesInfoTuile extends ISyntheseClientServicesTuile {
        ...
        dateDebutValiditePaylib: string;
    ...
    interface ISyntheseServiceInfoPaylib extends ISyntheseServiceInfoCommuneService {
        referenceSrvAbonnPaylib: string;
        identifiantBad: string;
        identifiantAdherentPaylib: string;
        dateDebutValiditePaylib: Date;
    ...
    interface ISyntheseClientEntiteTitulaireService {
        ...
        listeSyntheseServiceInfoPaylib: Array<ISyntheseServiceInfoPaylib>;
    }
...
declare module syntheseClient.Service {
    ...
    class SyntheseDetailServiceService {
        ...
        getDetailServiceInfoPaylib(objetOriginal: Modeles.Services.ISyntheseServiceInfoPaylib): IDetailService;
...
declare module syntheseClient.Service {
    class SyntheseClientDonneesService {
        ...
        /**
         * @private
         * @param {syntheseClient.Modeles.SyntheseGlobale.ISyntheseDonneesClient} syntheseClient : La synthèse Client fraîchement récupéré dont on souhaite arranger les produits Natixis et CNP
         * @return {ng.IPromise<syntheseClient.Modeles.SyntheseGlobale.ISyntheseDonneesClient>} : La synthèse qui a été arrangée pour bien débrancher vers les processus Natixis et CNP
         * Méthode controleur qui permet de lancer le "processus" de recalibrage des objets SyntheseClientProdAssCNP et SyntheseClientProdAssNatixis en fonction du typeAppel ("P" = CNP et "V" = Natixis)
         * @author SCHMIDT Jonathan
         * @since 20/03/2020
         */
        private gestionPositionnementProdAssNatixisProdAssCNP(syntheseClient);
        private traitementDuRepositionnementProduit(listeSyntheseClientCodeEtatProduit);
        private reorganisationObjetProdAssNatixisProdAssCNP(entiteTitulaireProduit);
        private transfererProdAssCNPVersProdAssNatixis(prodAssCNP);
        private transfererProdAssNatixisVersProdAssCNP(prodAssNatixis);
...
declare module syntheseClient.Service {
    class SyntheseServicesService {
        ...
        /**
         * @public
         * @param objetOriginal: Modeles.Services.ISyntheseServiceInfoPaylib ---> Je ne sais pas à quoi ça sert
         * @return Modeles.DetailServices.ISyntheseServiceInfoPaylib ---> Valorisé a null car jamais utilisé (POUR LE MOMENT, ENCORE À DÉTERMINER)
         * Permet de vérifier l'existence du Service Info Paylib, si cette méthode existe, sa seule existence permet de valider le fait que c'est un service, donc initialisé dans la vue
         * @author SCHMIDT Jonathan et REILAND Julien
         * @since 28/10/2019
         */
        listeSyntheseServiceInfoPaylib(objetOriginal: Modeles.Services.ISyntheseServiceInfoPaylib): Modeles.DetailServices.ISyntheseServiceInfoPaylib;
        /**
...
declare module syntheseClient.Service {
    class SyntheseClientSuiviService {
         ...
         * @return indicateurDematClient{string}
         */
        afficherDiversCaracteristique(libelleEDoc: string): string;
    }
}
