...
declare namespace ContentieuxServices.Modeles.Echeancier {
    ...
    type Type = "Degressivite" | "PaiementTotal" | "PaiementPartiel" | "S" | "A";
...
declare namespace ContentieuxServices.Services.Echeancier {
    class Mappage {
         ...
         */
        static mappeDossier(restEcheancier: Contentieux.RestServices.Modeles.IEcheancier): Modeles.Echeancier.IDossierEcheancier;
        /**
...
declare namespace ContentieuxServices.Services.Echeancier {
    class EcheancierService implements IEcheancierService {
        ...
        private smsService;
        static $inject: string[];
        constructor($q: ng.IQService, cacheService: Services.Commun.ICacheService, echeancierRestService: Contentieux.RestServices.Services.EcheancierService, riceService: myway.comInterdomaine.SaisieRiceService, entiteTitulaireService: ContentieuxServices.Services.EntiteTitulaire.IEntiteTitulaireService, tiersService: ContentieuxServices.Services.Tiers.TiersService, smsService: ContentieuxServices.Services.SMS.SMSService);
        /**
         ...
         */
        private mappePanel(echeancier, params, numeroTitulaire, statut);
        /**
         ...
         * @param numeroTitulaire
         */
        getPayeur(codeEtablissement: string, numeroTitulaire: number, identifiantEntiteTitulaire: number): ng.IPromise<Modeles.Participant.Participant>;
    }
}
