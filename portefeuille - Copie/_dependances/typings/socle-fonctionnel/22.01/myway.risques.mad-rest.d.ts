...
declare module Mad.Rest.MouvAttenteDecision.Modele.Caracteristique {
    ...
    interface IDecision {
        ...
        motifRejet: string;
        /**
         * Détermine le motif complémentaire pour lequel un mouvement entré au MAD a été rejeté pour l'utilisateur. '01 : OPPOSITION POUR VOL '02' : OPPOSITION POUR PERTE '03' : UTILISATION FRAUDULEUSE '12' : COORDONNES ERRONEES '14' : COMPTE SOLDE
         */
...
declare module Mad.Rest.MouvAttenteDecisionParam.Modele.TableParam {
    ...
    interface IEnregistrementTableMV12 {
        ...
        codeProduit: string;
        /**
         * Détermine l'acte de gestion relatif à une prise décision sur la gestion d'un mouvement du MAD. 'A' : décision en attente 'F' : forçage 'R' : rejet 'T' : forçage autre RIB sans correction RIB au créancier 'S' : forçage autre RIB avec correction RIB au créancier ' ' : sans décision (valeur par défaut) 'H' : transfert Mad Siège
         */
        codeTypeDecision: string;
        /**
         * Détermine le motif pour lequel une opération a été rejetée suite à une imputation pour entrer ensuite au MAD.
