...
declare module propoClient.Directive {
    class PropoClientFooterControleur {
        ...
        private propoClientRestService;
        static $inject: string[];
        constructor($scope: IScopeEcpElementProduit, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, propoCompteursDossiersRestService: Service.PropoCompteursDossiersRestService, propoClientRestService: Service.PropoClientRestService);
        goToSignature(): void;
        goToGestionPanier(): void;
        goToSignaturePanier(): void;
        nbDossiers(): number;
