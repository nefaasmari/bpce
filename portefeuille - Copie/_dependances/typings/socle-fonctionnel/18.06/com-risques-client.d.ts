...
declare module myway.comRisquesClient {
    class InterroBDFService {
         ...
         */
        getInterroFICPManuelle(cleBdf: string, codeOrigine: string, sousCle: string): ng.IPromise<any>;
        getInterroFICPDecouvertCredit(cleBdf: string, codeOrigine: string, sousCle: string, idTiers: string, codeProduitService: string, designation: string, referenceProduit: string): ng.IPromise<any>;
        getInterroFICPCarte(cleBdf: string, codeOrigine: string, sousCle: string, idTiers: string, codeProduitService: string, designation: string, referenceProduit: string, codeProduitCarte: string): ng.IPromise<any>;
        getInterroFICPCheque(cleBdf: string, codeOrigine: string, sousCle: string, idTiers: string, codeProduitService: string, designation: string, referenceProduit: string, codeTypeChequier: string, nombreChequier: number, codeFamilleChequier: string): ng.IPromise<any>;
    }
}
...
declare module myway.comRisquesClient {
    class GenereCleBDFService {
         ...
         * @param {string} : nom
         */
        genereCleBDF(dateNaiss: Date, nom: string): string;
        /**
