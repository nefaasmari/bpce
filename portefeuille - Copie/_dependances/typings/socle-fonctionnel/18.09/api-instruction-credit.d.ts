...
declare module ApiInstuctionCredit.Service {
    class EditerDocumentService {
         ...
         */
        getListeDocumentDescriptionByDocument(idDossier: string, infoDocument: Modele.IInfoDocument, listeIdwsCredits: Array<string>, withSaisiesComplementaires: boolean, formatEditique: number): ng.IPromise<Array<Modele.IDocumentDescription>>;
        /**
         ...
         */
        private getFluxForDocumentsSynchrone(listeInfoDocument, idDossier, idPlan, listeIdwsCredits, indexDoc, resultatEditionDocuments, formatEditique);
        /**
         * Pour un document, génération des flux associés
         */
        private getListeFluxForDocument(infoDocument, idDossier, idElement, listeIdwsCredits, formatEditique);
        /**
         * Obtient les flux des documents associés à un type de document
         */
        private getFluxForDocument(idDossier, infoDocument, identifiant, paramsEditiques, formatEditique);
        /**
...
declare module ApiInstuctionCredit.Service.Data {
    class PiecoService {
         ...
         */
        editionDocuments(identifiantDossier: string, identifiantDocument: string, identifiantWs: string, paramsEditiques: Modele.IParamEditique[], niveauTraitement: number, formatEditique: number): ng.IPromise<Modele.IDocument[]>;
        /**
