...
declare module syntheseClient {
    ...
    class RechercheControleur {
        ...
        private watcher;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, syntheseInitialisationService: syntheseClient.Service.SyntheseInitialisationService, $scope: IRechercheScope, $q: ng.IQService);
...
declare module syntheseClient.Service {
    ...
    class SyntheseClientChargementService {
         ...
         */
        initialisationChargement(rechargement?: boolean, indicateurSynchroSynthese?: myway.portail.api.IndicateurSynchroSyntheseEnum): void;
        /**
...
declare module syntheseClient.Service {
    class SyntheseProduitLancementService {
         ...
         * @return IProduit
         */
        getDefineProduits(produit: IScopeScElementProduit, dateNaissance?: string, refExterneAgent?: string): IProduit;
        /**
...
declare module syntheseClient.Service {
    class SyntheseClientDonneesService {
        ...
        checkAppel(codeAgent: number, numeroPersonne: number, idEdsInterne: number, forcer?: boolean, numeroCompte?: string, identifiantCredit?: string): ng.IPromise<Modeles.SyntheseGlobale.ISyntheseDonneesClient>;
