...
declare module libMettSousPrtc {
    class Constantes {
        ...
        static INFOBULLE_DATE_FIN_JUGEMENT: string;
        ...
        static identifiantChampsRequis: {
            ...
            IDENTIFIANT_DATE_FIN_JUGEMENT: string;
        };
...
declare module libMettSousPrtc {
    class MiseSousProtectionControleur {
        ...
        formCJ: ng.IFormController;
        moisChoisi: any;
        titre: string;
        estHabiliteModifier: boolean;
        panelComOpen: boolean;
        private _finChargement;
        finChargement: boolean;
        private _estHabiliteConsulter;
        private infoBulleMessageDateFin;
        constructor(serviceAgent: MyWay.Services.ServiceAgentExtended, miseSousProtectionService: MiseSousProtectionService, utilService: UtilService, $modalInstance: ng.ui.bootstrap.IModalServiceInstance, $q: ng.IQService, messageService: MessageService, $rootScope: ng.IRootScopeService, $document: ng.IDocumentService, mwEvents: MyWay.UI.IMwEvents, modalService: MyWay.UI.IModalService);
        getLibelle(contrat: modeles.ContratCommGerant): string;
        isCDD(compteOppo: modeles.ContratCommGerant): boolean;
        trierListeCompteExclusion(listeAvantTri: Array<modeles.ContratCommGerant>): Array<modeles.ContratCommGerant>;
        init(): void;
        changementMois($item: any, $model: modeles.Mois, $label: string, $event: any): void;
        valider(): void;
        /**
...
declare module libMettSousPrtc.modeles {
    ...
    class ContratCommGerant extends Contrat {
        ...
        codeTypeProduitService: string;
        codeGuichet: string;
        constructor(contratBase: Contrat, estInclus: boolean, numeroContrat: string, codeTypeProduitService: string, codeGuichet: string);
    }
}
...
declare module libMettSousPrtc.modeles {
    class Tutelle implements ITutelle {
        ...
        dateJugement: string;
        nomDelegue: string;
        dateDerniereModificationMesure: string;
        motifDerniereModification: string;
        dateDebutApplicationMesure: string;
        moisReddition: string;
        dateReceptionMesure: string;
        conditionRepresentation: string;
        dateFinApplicationMesure: string;
        codeTypeCapaciteJuridique: string;
...
declare module libMettSousPrtc {
    ...
    class HistoriqueCapaciteJuridiqueService {
        ...
        codeEtablissement: string;
        identifiantPersonne: string;
        recupererListeHistoriqueCJ(codeEtablissement: string, identifiantPersonne: string): ng.IPromise<Array<modeles.ICapaciteJuridique>>;
        /**
         * Affiche la popin
         */
        afficherHistoriqueCJ(codeEtablissement: string, identifiantPersonne: string, sousTitre: string): void;
    }
}
...
declare module libMettSousPrtc {
    class MiseSousProtectionService {
        ...
        recupererHabilitations(): MyWay.Services.IPromesse<boolean[]>;
        /**
        ...
        /**
         * Fonction permettant de récupérer la liste des comptes à communiquer ou à exclure
         * @param codeEtablissement {string} le codeEtablissement de la personne courante
         * @param identifiantPersonne {string} l'identifiant de la personne courante
         */
        ...
        /**
         * Affiche la popin des caractéristiques de jugement
         * @param codeEtablissement {string} le codeEtablissement de la personne courante
         * @param identifiantPersonne {string} l'id de la personne courante
         * @param boutonFermerActif {string} true si le bouton Fermer est actif, false si on doit désactiver le bouton Fermer et afficher un message d'erreur
         * @param sousTitre {string} le sous-titre de la popup composé de la désignation et de l'id de la personne courante
         * @return {ng.IPromise<Date>} une promesse contenant la date de début d'application du jugement
         */
        afficherCaracteristiquesJugement(codeEtablissement: string, identifiantPersonne: string, boutonFermerActif: boolean, sousTitre: string): ng.IPromise<Date>;
        /**
         * caracteristique de jugement de mise sous protection via Q/R
         * @param tutelle {modeles.Tutelle} Les informations de la tutelle
         */
        modificationTutelle(tutelle: modeles.Tutelle): ng.IPromise<modeles.Tutelle>;
        /**
         * Fonction permettant d'enregistrer les modifications apportées aux comptes
         * @param listeCompteCommGerant {Array<modeles.ContratCommGerant>} la liste des comptes
         */
