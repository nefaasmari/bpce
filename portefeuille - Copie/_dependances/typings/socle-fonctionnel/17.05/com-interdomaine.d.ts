...
declare module myway.comInterdomaine {
    class InfobulleAideService {
        ...
        ecrirePreferenceUtilisateurInfobulle(idChamp: number): ng.IPromise<boolean>;
...
declare module myway.comInterdomaine {
    class ListeCompteController {
        ...
        constructor($scope: ng.IScope, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, listeCompteService: myway.comInterdomaine.ListeCompteService, mwsfDeviseService: myway.comInterdomaine.DeviseService);
        /**
         * @alias : padLeftZero
...
declare module myway.comInterdomaine {
    class ListeCompteService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, saisieRiceService: myway.comInterdomaine.SaisieRiceService, $filter: ng.IFilterService);
        /**
...
declare module myway.comInterdomaine {
    ...
    class ModeFinancierService {
         ...
         * @return {boolean}
         */
        getHabilitationSHJM25(): ng.IPromise<boolean>;
        /**
