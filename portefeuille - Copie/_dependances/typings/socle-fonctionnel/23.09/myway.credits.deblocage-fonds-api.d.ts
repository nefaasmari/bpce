...
declare module DeblocageFonds.Commun.Services {
    class PiecoServices {
         ...
         * @param listeCredit
         */
        getListeModeVersement(codeEtablissement: string, listeCredit: Array<Modeles.CaracteristiqueCredit.ICaracteristiqueCredit>, informationCredit: Modeles.Informationcredit.IInformationCredit): ng.IPromise<Array<Modeles.Pieco.IModeVersement>>;
        /**
         * Permet de recupérer les modes de versement des crédits dans pieco à partir des informations des crédits
