...
declare module Myway.Sagopc {
    class DefautControleur {
        ...
        constructor($q: ng.IQService, $timeout: ng.ITimeoutService, sagopcService: SagopcService, eligibiliteService: EligibiliteService, contractualisationActeService: myway.comContract.Services.ContractualisationActeService, gcedocService: GcedocService, sagOpcServiceComContract: myway.comContract.Services.SagOpcService, smartNumService: SmartNumService, serviceAgent: MyWay.Services.ServiceAgentExtended);
        /**
         * Réalise l'opération de routage en fonction des informations LISA ou bien des informations du contexte dans le cadre de Visa Collaborateur.
         * @param lisaEntree 1, 2 ou 3
         */
        aiguillerProcessus(lisaEntree: LisaCodeEntreeEnum): void;
        /**
         * Débranche vers le processus d'acquisition de pièce justificative pour Visa Collab (SmartNum).
         */
        private debrancherVersAcquisition();
        /**
        ...
        /**
         * @ngdoc method
         * @name verifParamsObligatoires
         * @description
         * Vérifier que les paramètres en entrée sont bien renseignés
         * Les Logs sont mises en warn car l'appel est non bloquant pour la suite du processus
         * @returns void
         */
        private verifParamsObligatoires(isSAGOPCHistorique);
        private mettreAJourContexte(context, retourEligSAGOPC);
        private mettreAJourContexteAvantAppelEligibilite();
        private startProcessSignatureElectronique(isSAGOPCHistorique);
        private startProcessSignaturePapier(isSAGOPCHistorique?, codeProcessus?);
        /**
        ...
        /**
         * Détermine via le code role signataire si on est dans le mode Visa Collaborateur.
         * En effet, aucune information spécifique LISA n'est prévue dans ce cadre.
         */
        private isVisaModeCollaborateur();
    }
}
...
declare module Myway.Sagopc {
    class MessageErreur {
        ...
        static PREPARER_DOC_XML_ERROR: string;
...
declare module Myway.Sagopc {
    class SignataireFactorySAGOPC {
        private static CLASS_NAME;
        private static WARN_SIGNATAIRE_FILTRE;
        /**
         * Transforme une liste de signataires de type SagOpc (nouveau système), en une liste de signataires pour appel à DossierNumérique V3.
         * Attention, les input qui ne possèdent pas de 'numeroPersonne' sont ignorés.
         * @param listeSignataireSagopc
         */
        static createSignatairesFromSagopcInput(listeSignataireSagopc: Array<myway.comContract.SAGOPC.Modeles.ISignataireSagOpc>): Array<Myway.Ressource.DossierNumerique.V3.ISignataire>;
        /**
         * Transforme une liste de signataires de type Acte (ancien système), en une liste de signataires pour appel à DossierNumérique V3.
         * Attention, les input qui ne possèdent pas de 'numeroPersonne' sont ignorés.
         * @param listeSignataireActe
         */
        static createSignatairesFromActeInput(listeSignataireActe: Array<ISignataireActe>): Array<Myway.Ressource.DossierNumerique.V3.ISignataire>;
    }
}

declare module Myway.Sagopc {
    class SmartNumFactorySagopc {
        private static CLASS_NAME;
        /**
         * Créé un document d'entrée SmartNum à partir d'un document d'acte.
         * @param identifiantAttributaire : Numéro de personne si c'est une personne. Attention à bien conserver les 0 s'ils y en a devant.
         * @param doc : document acte
         */
        static createDocumentEntree(identifiantAttributaire: string, doc: Myway.Ressource.DocumentParametre.IDocumentActe): SmartNum.IDocumentEntree;
        /**
         * Créé un objet d'entrée vers le processus SmartNum en vu d'un débranchement.
         * @param codeEtablissement
         * @param docs
         */
        static createAcquisitionEntree(codeEtablissement: string, docs: Array<SmartNum.IDocumentEntree>): SmartNum.IAcquisitionEntree;
        static createLisaCtxtKeyValue(contratSmartNum: SmartNum.IAcquisitionEntree): MyWay.Services.Context.IContextKeyValuePair;
    }
}
...
declare module Myway.Sagopc {
    class TitulaireFactorySAGOPC {
        private static CLASS_NAME;
        static createTitulaireFromTitulaireActe(titulaireActe: Myway.Ressource.ContractualisationActe.ITitulaireActe): Myway.Ressource.DossierNumerique.V3.ITitulaire;
        static createListTitulaireFromListTitulaireActeSagopc(listeTitulaireActe: Array<Myway.Ressource.ContractualisationActe.ITitulaireActe>): Array<Myway.Ressource.DossierNumerique.V3.ITitulaire>;
    }
}
...
declare module Myway.Sagopc {
    class DocumentFactory {
        ...
        private static getDocumentFromActe(context);
    }
}
...
declare module Myway.Sagopc {
    class DossierFactory {
        ...
        /**
         * Construit un acte à partir des informations du contexte, en fonction du mode historique ou non.
         * @param context
         * @param isSAGOPCHistorique    utiliés notamment pour différencier la source d'information pour la construction des signataires
         */
        private static createActe(context, isSAGOPCHistorique);
        private static createOperationsFinancieres(contexte);
        private static createReferencesActe(acte);
        private static getModeContractualisation(context);
    }
}
...
declare module Myway.Sagopc {
    ...
    class EligibiliteService {
        ...
        private static CLASS_NAME;
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, ressourcesService: RessourcesService);
        /**
...
declare module Myway.Sagopc {
    class GcedocService {
        ...
        /**
         *
         * cette methode vérifie si le bordereaux fait partie de cette liste de
         * virement parce que dans ce cas le document est déja generé et on va le recupérer
         * depuis son identifiant Ged
         * la liste contient création/Modification/cloture des virements
         * @param typeBordereau
         */
        isVirement(typeBordereau: TypeBordereauEnum): boolean;
        /**
...
declare module Myway.Sagopc {
    class Loggers {
        ...
        static getLogMessage(loggerName: string, methodName: string, message: string): string;
...
declare module Myway.Sagopc {
    /**
     * MultiDossierNumeriquesService est un service angularJs permet de créer un multidossiernumerique.
     */
    class MultiDossierNumeriqueService {
        ...
        private static CLASS_NAME;
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, tiersNoyauService: TiersNoyauService);
...
declare module Myway.Sagopc {
    class RessourcesService {
         ...
         */
        putDossierNumerique(data: Myway.Ressource.DossierNumerique.V3.IDossierNumerique): ng.IPromise<string>;
        /**
         * Appelle la ressource dossierNumerique et renvoie l'identifiant IDN.
         */
...
declare module Myway.Sagopc {
    ...
    class SagopcService {
        ...
        protected dossierNumeriqueService: myway.comContract.Services.DossierNumeriqueService;
        private static CLASS_NAME;
        protected documentParametreRestUrl: string;
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, ressourcesService: RessourcesService, identificationSignataireService: IdentificationSignataireService, eligibiliteService: EligibiliteService, gcedocService: GcedocService, dossierPropagationService: myway.comEditiqueNumerisation.Services.DossierPropagationService, multiDossierNumeriqueService: MultiDossierNumeriqueService, dossierNumeriqueService: myway.comContract.Services.DossierNumeriqueService);
        processSignature(context: IApplicationContext, isSAGOPCHistorique?: boolean, codeProcessus?: string): ng.IPromise<void>;
        private nextLisaEtape(context, isSAGOPCHistorique?, codeProcessus?);
        private createMultiDossNumerique(context, isSAGOPCHistorique?, codeProcessus?);
        private majDossierNumerique(context, isSAGOPCHistorique?);
        private processDocument(context);
        private majContextByIndicateurPaPier(context);
        private recupSignataireIdentity(context);
        /**
         ...
         */
        putDossierNumerique(context: IApplicationContext, isSAGOPCHistorique?: boolean): ng.IPromise<void>;
        /**
         * Renvoie le contexte de l'application
         */
        getApplicationContext(): ng.IPromise<IApplicationContext>;
        lancerSignaturePapier(context: IApplicationContext, isSAGOPCHistorique?: boolean, codeProcessus?: string): ng.IPromise<void>;
...
declare module Myway.Sagopc {
    class SmartNumService {
         ...
         * @param identifiantAttributaire
         * @param codeEtablissement
         * @param docs : liste des documents de l'acte
         */
        createContratEntreeSmartNum(identifiantAttributaire: string, codeEtablissement: string, docs: Array<Myway.Ressource.DocumentParametre.IDocumentActe>): MyWay.Services.Context.IContextKeyValuePair;
    }
}
...
declare module Myway.Sagopc {
    ...
    class IdentificationSignataireController {
        ...
        static $inject: string[];
        constructor(modale: ng.ui.bootstrap.IModalServiceInstance, $q: ng.IQService, identificationSignataireService: IdentificationSignataireService, sagopcService: SagopcService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, ressourcesService: RessourcesService);
