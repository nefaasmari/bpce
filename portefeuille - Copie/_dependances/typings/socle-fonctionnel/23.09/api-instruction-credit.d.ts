...
declare namespace ApiInstuctionCredit.Constantes.WebServiceUrls {
    namespace OperationSurDossier {
        ...
        const urlTransfererDossierDansApp: string;
...
declare module ApiInstuctionCredit.Service.Data {
    class DossierService {
        ...
        /**
         * Transfert le dossier dans application
         */
        transfererDossierDansApp(idDossier: string, codeVisibilite: boolean, typeTransfertApplication: number): ng.IPromise<any>;
        /**
...
declare module ApiInstuctionCredit.Modele.Parametrage {
    interface IBT95Codes {
        ...
        activationMYCV2?: IBT95CodeDatas;
    }
