...
declare module Avenants.Rest.Modeles.AvenantCreditParam.Eligibilite {
    ...
    class CriteresAppelBuilder {
         ...
         */
        private static getListeDonneesUnCarac(idCredit, codeExistenceCreditTxRevisable, credit, listeGarantieExistante, listeIdAssurance, typeEditionPieco, isEcureuilCredit);
         ...
         */
        private static getListeDonneesUnCaracForGaranties(idCredit, listeGarantieExistante);
        ...
        private static getListeDonneesDixCarac(idCredit, codeNatureFinancementCredit, listeGarantieExistante);
