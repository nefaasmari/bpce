...
declare module syntheseClient.Directive {
    class SyntheseBlocProduitsControleur {
        ...
        listeEntiteTitulaire: Array<Modeles.Profil.ISyntheseClientEntiteTitulaire>;
        static $inject: string[];
        constructor(serviceInit: Service.SyntheseInitialisationService, syntheseProduitService: Service.SyntheseProduitService, syntheseClientUtilitaireService: Service.SyntheseClientUtilitaireService, syntheseClientConstantes: Constantes.Constantes, $scope: ng.IScope, $timeout: ng.ITimeoutService, $q: ng.IQService, contexteClientService: myway.core.ContexteClientService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        typeProduitSelectionne: string;
        /**
