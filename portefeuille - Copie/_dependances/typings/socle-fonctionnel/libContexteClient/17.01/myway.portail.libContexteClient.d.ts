...
declare module libContexteClient {
    interface IProcessClient {
        id: string;
        libelle: string;
    }
    class ProcessClient implements IProcessClient {
        id: string;
        libelle: string;
...
declare module libContexteClient {
    ...
    class ProcessPortail implements IProcessPortail {
        _p: MyWay.Services.Context.Process;
        constructor(p: MyWay.Services.Context.Process);
        processStep: MyWay.Services.Context.ProcessStep;
        id: string;
        flagProcessClient: boolean;
        identifiantPersonne: number;
...
declare module libContexteClient {
    interface IProcessusService {
        ...
        getListeProcessClient: (idPersonne: number) => Array<IProcessClient>;
        getCurrentProcessClient: (l: Array<IProcessClient>) => IProcessClient;
    ...
    class ProcessusService implements IProcessusService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, global: IGlobal, ccm: MyWay.Services.ContexteClient.ContexteClientManager);
        getListeProcess(): Array<IProcessPortail>;
        majListeProcess(): void;
        getListeIdPersonne(): Array<string>;
        getProcessusCourant(): IProcessPortail;
