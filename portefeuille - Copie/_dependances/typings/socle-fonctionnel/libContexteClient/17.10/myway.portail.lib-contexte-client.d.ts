...
declare module libContexteClient {
    class BandeauClientService {
        ...
        lancerProcessusAgenda(data: DataBandeauClient): ng.IPromise<fwkManager.Services.Lisa.LisaCallbackResult>;
        lancerProcessusClasseurClient(data: DataBandeauClient): ng.IPromise<fwkManager.Services.Lisa.LisaCallbackResult>;
        lancerProcessusPlanClassement(data: DataBandeauClient): ng.IPromise<fwkManager.Services.Lisa.LisaCallbackResult>;
        lancerProcessusCompteRenduEntretien(data: DataBandeauClient, auth: MyWay.Services.Context.AuthentificationInfo): ng.IPromise<fwkManager.Services.Lisa.LisaCallbackResult>;
        lancerProcessusAidePreparationEntretien(data: DataBandeauClient, auth: MyWay.Services.Context.AuthentificationInfo): ng.IPromise<fwkManager.Services.Lisa.LisaCallbackResult>;
        /**
...
declare module libContexteClient {
    ...
    class BandeauClientController {
        ...
        startProcess(bouton: IBandeauClientBouton, process: libPortail.ParamProcess): ng.IPromise<any>;
        startActionRapide(process: libPortail.ParamProcess): void;
        /**
         * Bascule vers le processus s'il existe et renvoie true si la bascule a été exécutée.
         * @param codeProcess
         */
        private trySwitchProcess(codeProcess);
        /**
...
declare module libContexteClient {
    ...
    class DataBandeauClient {
        ...
        listeActionRapideClient: libPortail.ParamProcess[];
        listeActionRapideNonClient: libPortail.ParamProcess[];
