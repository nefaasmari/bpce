...
declare module libContexteClient {
    class Constantes {
        ...
        static CODE_LISA_CRE: string;
        static CODE_LISA_APE: string;
...
declare module libContexteClient {
    ...
    class Global implements IGlobal {
        ...
        constructor($q: ng.IQService, serviceManager: MyWay.Services.ServiceManagerExtended, toolsService: ITools);
        init(flagMessage?: boolean): ng.IPromise<MyWay.Services.Context.IPortalContext>;
        registerEventListener(l: IEventListener): void;
        unRegisterEventListener(l: IEventListener): void;
    }
...
declare module libContexteClient {
    interface ITools {
        ...
        getIdentifiantEDS(id: number): string;
    }
...
declare module libContexteClient.eds {
    class TypeEds {
...
declare module libContexteClient {
    class BandeauClientService {
        ...
        private edsService;
        static $inject: string[];
        constructor($q: ng.IQService, global: IGlobal, tools: ITools, navigationManager: INavigationManager, processusService: IProcessusService, PersonnePhysiqueService: IPersonnePhysiqueService, detailPersonneService: IDetailPersonneService, edsService: EdsService);
        lancerProcessusAgenda(data: IDataBandeauClient): ng.IPromise<MyWay.Services.Lisa.LisaCallbackResult>;
        /**
         * Prépare le contexte agenda dans le cas où le codeAgentSuiviPar est égal à 0.
         */
        private preparerContexteAgenda(data, param);
        /**
         * Enrichit les données du contexte client par l'appel de certains services.
         * Le contexte est ensuite mis à jour.
         */
        private consolidationContexteClient(process);
    }
}
...
declare module libContexteClient {
    interface IProcessusService {
        ...
        supprimerContextesClients(): void;
        ...
        lancerProcessusLisa(paramsLisa: IStartProcess): ng.IPromise<boolean>;
        ...
        updateClient(processClient: IProcessPortail): ng.IPromise<void>;
    }
    class ProcessusService implements IProcessusService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, $parse: ng.IParseService, global: IGlobal, PersonnePhysiqueService: IPersonnePhysiqueService, toolsService: ITools, navigationManager: INavigationManager);
        /**
        ...
        closeAllProcess: () => void;
        getListeProcess(): Array<IProcessPortail>;
        majListeProcess(from?: MyWay.Services.Component.ManagerEventType): ng.IPromise<void>;
        private sortTime(tab);
        private createProcessPortail(p);
        private consolidePersonne(pp, def);
        updateClient(process: IProcessPortail): ng.IPromise<void>;
        getListeIdPersonne(): Array<string>;
        getProcessusCourant(): IProcessPortail;
        ...
        lancerProcessusUrl(url: string): void;
        /**
         * Permet de lancer un processus LISA à partir du portail
         * @param params
         * @return boolean
         */
        lancerProcessusLisa(params: IStartProcess): ng.IPromise<boolean>;
        lancerProcessusCode(code: string, param?: IParamLisa, valeurDepart?: number, idPersonne?: number): ng.IPromise<MyWay.Services.Lisa.LisaCallbackResult>;
        getListeProcessClient(idPersonne: number): Array<IProcessPortail>;
        /**
...
declare module libContexteClient {
     ...
     */
    class BandeauClientController implements IEventListener {
        private $q;
        private environnementMyWay;
        private global;
        private tools;
        ...
        data: IDataBandeauClient;
        flagWait: boolean;
        onEvent: (event: MyWay.Services.Component.ManagerEvent) => void;
        private onSelectPersonneRelation;
        private tabReferentielProcess;
        private promiseReferentielProcess;
        static $inject: string[];
        constructor($q: ng.IQService, environnementMyWay: string, global: IGlobal, tools: ITools, bandeauClientService: BandeauClientService, navigationManager: INavigationManager, processusService: IProcessusService, referentielProcessusService: IReferentielProcessusService, relationEconomiqueService: IRelationEconomiqueService, personnePhysiqueService: IPersonnePhysiqueService, detailPersonneService: IDetailPersonneService, printInfoPersonneService: IPrintInfoPersonneService);
        changeProcessClient(p: IProcessPortail): void;
        startActionRapide(p: IParamProcess): void;
        /**
         * fonction de demarrage de l'agenda dans le bandeau client
         */
        startAgenda(): void;
        ...
        dlgBoxRelation(): void;
        dlgBoxMedia(): void;
        isActionValide(): boolean;
        getInfoBulleRelation(): string;
        getInfoBulleAgenda(): string;
        getInfoBulleMedia(): string;
        getInfoBullePrint(): string;
        getInfoBulleCRE(): string;
        getInfoBulleAPE(): string;
        private refresh(nrEvent?);
        private verifDoublon(nrEvent?);
        private initActionRapide();
        private printInfoClient();
        confirmationFermeture(p: IProcessPortail): void;
        closeAll(): void;
        private initReferentielProcess();
        private formatLibelleClient(libelle);
        startProcessusCRE(): void;
        startProcessusAPE(): void;
    }
}
...
declare module libContexteClient {
    interface IOnSelectPersonneRelationLocals {
        p: IPersonneRelationEconomique;
    }
    interface IDataBandeauClient {
        identifiantPersonne: number;
        processClientCourant: IProcessPortail;
        listeProcessClient: Array<IProcessPortail>;
        listeProcess: Array<IProcessPortail>;
        listeActionRapideClient: Array<IParamProcess>;
        listeActionRapideNonClient: Array<IParamProcess>;
        flagDUA: boolean;
        libelleClient: string;
    }
    class DataBandeauClient implements IDataBandeauClient {
        identifiantPersonne: number;
        processClientCourant: IProcessPortail;
        listeProcessClient: Array<IProcessPortail>;
        listeProcess: Array<IProcessPortail>;
