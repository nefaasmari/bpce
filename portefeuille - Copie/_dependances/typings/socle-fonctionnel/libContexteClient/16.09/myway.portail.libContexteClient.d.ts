...
declare module libContexteClient {
    ...
    class ElementNodePersonne implements IElementNodePersonne {
        ...
        static COLOR_PERSONNE_SELECT: string;
        static COLOR_PERSONNE_UNSELECT: string;
        static COLOR_PERSONNE_HORS_RELATION: string;
        static CODE_PERSONNE_PHYSIQUE: string;
        static CODE_PERSONNE_MORALE: string;
        static BRUSH_BK: go.Brush;
        static BRUSH_BK_HR: go.Brush;
        key: string;
        category: string;
        categorySave: string;
