...
declare module Avenants.Business.ToolsFunctionals {
    class CaraFinan {
         ...
         */
        static getCodeTypeModificationCredit(listeModificationCredit: Array<Commun.Enum.ModificationCredit>, isTopCalculatrice: boolean, isAvecChangementProduit: boolean, isCreditInPrefinancement: boolean, isSecurisationOpenByReportFinPret: boolean, isEntierementVerse: boolean): string;
    }
}
...
declare module Avenants.Business.Modeles {
    ...
    class AvenantAssuranceDecorateur extends AvenantDecorateur {
         ...
         *      Il faut multiplier par 100 le taux de l'accessoire complémentaire (quotité complète)
