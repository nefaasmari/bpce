...
declare module ApiInstuctionCredit.Constantes.Dossier {
    class Action {
        static ACTION_DOSSIER_CONSULTATION: string;
        static ACTION_DOSSIER_INSTRUCTION: string;
        static ACTION_DOSSIER_DECISION: string;
        static ACTION_DOSSIER_CONFORMITE: string;
        static ACTION_DOSSIER_PRISE_EN_CHARGE_BACK_OFFICE: string;
    }
    class TypeSignature {
...
declare module ApiInstuctionCredit.Service {
    class EditerDocumentService {
        ...
        constructor($q: ng.IQService, modalService: MyWay.UI.IModalService, wsPiecoService: Service.Data.PiecoService, wsOffreService: Service.Data.OffreService);
        /**
         * Génére les flux d'édition pour une liste de document
         */
        getResultatEditionDocuments(listeInfoDocument: Array<Modele.IInfoDocument>, idDossier: string, idPlan: string, listeIdwsCredits: Array<string>, setLoader: (value: boolean) => void): ng.IPromise<Modele.IResultatEditionDocuments>;
        /**
         * Génére les flux d'édition pour un seul document
         */
        getListeDocumentDescriptionByDocument(idDossier: string, infoDocument: Modele.IInfoDocument, idPlan: string, listeIdwsCredits: Array<string>, withSaisiesComplementaires: boolean): ng.IPromise<Array<Modele.IDocumentDescription>>;
        /**
         * Génére les flux d'édition pour un seul document de type offre
         */
        getResultatEditionOffreDescription(idDossier: string, infoDocument: Modele.IInfoDocument, withSaisiesComplementaires: boolean, modeEdition: Enum.Edition.Mode): ng.IPromise<Modele.IResultatEditionOffreDescription>;
        /**
         * Génération de façon synchrone des flux de documents
         */
        private getFluxForDocumentsSynchrone(listeInfoDocument, idDossier, idPlan, listeIdwsCredits, indexDoc, resultatEditionDocuments);
        /**
         * Pour un document, génération des flux associés
         */
        private getListeFluxForDocument(infoDocument, idDossier, idPlan, listeIdwsCredits);
        /**
         * Obtient les flux des documents associés à un type de document
         */
        private getFluxForDocument(idDossier, infoDocument, identifiant, paramsEditiques);
        /**
...
declare module ApiInstuctionCredit.Service {
    class OrigineApportService {
        ...
        private listerParamOrigineApport(dateDeTraitement, idCaisse);
    }
}
...
declare module ApiInstuctionCredit.Service.Data {
    class DossierService {
         ...
         */
        rechercherDossier(versWsdl: number, dateDeTraitement: string, applicationCharge: number, criteresDeRecherche: Modele.ICriteresRechercheDossier, nombreMaximumResultat: number): ng.IPromise<Modele.IDossierResume[]>;
        /**
         * Permet de récupérer le contenu du dossier sélectionné
         */
        ouvrirDossier(versWsdl: string, identifiantDossier: string, date: string, codeApplication: string, actionSurDossier: string): ng.IPromise<Modele.IDossierSchema>;
        /**
...
declare module ApiInstuctionCredit.Service.Data {
    class OffreService {
         ...
         * @param forcerGestion
         */
        editerOffrePret(idDossier: string, document: Modele.IInfoDocument, modeEdition: Enum.Edition.Mode, forcerEdition?: boolean, forcerGestion?: boolean): ng.IPromise<Modele.IResultatEditionOffreDescription>;
        /**
...
declare module ApiInstuctionCredit.Service.Data {
    class OffreSignatureElectroniqueService {
        ...
        lireDocumentActeSignatureElectronique(idDossier: string, idDocComplet: string, listeCreditInterneSchema: Array<ApiInstuctionCredit.Modele.ICreditInterneSchema>): ng.IPromise<Modele.IDocumentSignatureElectroniqueDescription>;
...
declare module ApiInstuctionCredit.Service.Data {
    class WsService {
        ...
        /**
         * Récupération de l'id agent "pour le compte de" dans le context
         */
        private getIdAgentPourLeCompteDe();
    }
}
...
declare module ApiInstuctionCredit.Modele {
    ...
    interface IAccessoireLieProduit extends IAccessoire {
        ...
        montantFraisReelsCalcule?: number;
    }
...
declare module ApiInstuctionCredit.Modele {
    ...
    class DetailAssure implements IDetailAssure {
        ...
        static getStatutDecision(listeCodeEtatAccessoire: Array<number>, hasAssuranceCNP: boolean): string;
        /**
...
declare module ApiInstuctionCredit.Modele {
    interface IResultatEditionOffre {
        documentOffre: IDocument;
    ...
    interface IResultatEditionOffreDescription {
        documentOffreDescription: IDocumentDescription;
...
declare module ApiInstuctionCredit.Modele {
    ...
    interface IResultatEligibiliteSignature {
        ...
        messagesPieco: Array<string>;
        messageContelec: Array<string>;
    }
    interface IContexteElectronique {
        estSignatureElectroniqueActivee: boolean;
        estSignatureElectroniqueEligible: IResultatEligibiliteSignature;
        estSignatureElectroniqueAgregationEligible: boolean;
    }
...
declare module ApiInstuctionCredit.Service.Data {
    ...
    class CatalogueCommunService {
         ...
         */
        chargerTypeEdsBackOffice(dateDeTraitement: string): ng.IPromise<Modele.IScTypeEds[]>;
        /**
         ...
         */
        listerTypeRole(dateDeTraitement: string): ng.IPromise<Modele.IScTypeRole[]>;
    }
}
...
declare module ApiInstuctionCredit.Service.Data {
    ...
    class CatalogueOrigineApportService {
         ...
         * @param dateDeTraitement
         */
        listerParametreOrigineApport(dateDeTraitement: string): ng.IPromise<Modele.Parametrage.IScParamOrigineApport[]>;
    }
}
...
declare module ApiInstuctionCredit.Modele {
    ...
    class Proposition implements IProposition {
        ...
        isPropositionValide: boolean;
        checked: boolean;
        constructor(planSchema: IPlanFinancementSchema, raf: number, listeCreditInterne: Array<ICreditInterne>);
    }
}
...
declare module ApiInstuctionCredit.Modele {
    ...
    class MandatSignature implements IMandatSignature {
        ...
        private _dateSignature;
        lectureSeule: boolean;
        constructor(payeur: ApiInstuctionCredit.Modele.IPayeur);
        descriptionPayeur: string;
        numeroCredit: string;
        libelleProduit: string;
        referenceUniqueMand: string;
...
declare module ApiInstuctionCredit {
    class EditionTableauDocumentsControleur implements MyWay.UI.ISelectionChangeHandler {
        static $inject: any[];
        nbElements: number;
        tableauDocuments: MyWay.UI.ImwTableOptions;
        ...
        onSelectionChange(selectedObject: ApiInstuctionCredit.Modele.IInfoDocument): void;
    }
}
