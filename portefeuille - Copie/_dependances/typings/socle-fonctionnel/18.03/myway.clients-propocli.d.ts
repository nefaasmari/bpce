...
declare module propoClient.Service {
    class PropoClientRestService {
         ...
         * @param forcer
         */
        recupererGestionDossierVente(codeEtablissement: string, identifiantDossierVente: number, codeEdsExternePFContexte: number, typeEdsExterneContexte: string, forcer?: boolean): ng.IPromise<Modeles.GestionDossierVente.IGestionDossierVente>;
        /**
