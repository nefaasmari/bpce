...
declare module Avenants.Business.Modeles {
    ...
    abstract class AbstractAccessoire implements IAccessoire {
         ...
         */
        setTauxMontant(taux: number, montant: number): void;
        /**
...
declare module Avenants.Business.Modeles {
    ...
    class Assurance implements IAssurance {
        ...
        private _listeComposantesSocle;
        ...
        listeComposantesSocle: Array<IComposante>;
        ...
        setComposantes(suppressionComposantesOption: boolean, composantesSocle: Array<IComposante>, tauxAccessoire: number): void;
        private deleteComposantesOptions();
        private setComposantesSocle(composantesSocle);
        private setTauxComposanteDeces(tauxAccessoire);
...
declare module Avenants.Business.Modeles {
    ...
    class CreditChInit {
        ...
        private getDureeCredit(uniteDureeCreditInit, creditOrigine, produit);
        private getDureeCreditInit(uniteDureeCreditInit, uniteDureeCreditOrigine, dureeAjusteCreditSuiteRecalcul);
        private getValeurUniteDureeCredit(uniteDuree);
...
declare module Avenants.Business.Modeles {
    ...
    class DataContractualisationForm implements IDataContractualisationForm {
        ...
        private _listeDocEditionLocale;
        ...
        constructor(ar: IAvenantResume, typeLoi: string, codeAgentDefaut: string, agentDecideur: MyWay.Model.Agent, dataSed: ISignatureElectronique, dataIndus: IEditionIndustrielle, dataJustificatif: IDataJustificatif, showChoixActionSimulation: boolean);
        ...
        setAllDocumentsChecked(docs: Array<IDocLocal>): void;
         ...
         */
        private getListeDocEdition(isSimulation, avenant, isSed);
         ...
         */
        private getModeEdition(dataSedEligible, dataIndusEligible, isSimulation);
        private getListeDocsForAvenantEditable(liste, checkedDefault?, disabledDefault?);
    }
}
...
declare module Avenants.Business.Modeles {
    ...
    interface IDataContractualisationForm {
        avenantResume: Modeles.IAvenantResume;
        dateDecision: Date;
        dateReception: Date;
        dateSignature: Date;
        dateEdition: Date;
    ...
    interface IDocumentPieco {
        libelle: string;
        listeReferencesDocument: Array<string>;
        codeType: string;
    }
...
declare module Avenants.Business.Modeles {
    ...
    class InfoObjet implements IInfoObjet {
        ...
        protected affichageChampTerrainInit(creditObjet: RestInfoObjet.ICreditObjet): Array<boolean>;
...
declare module Avenants.Business.Modeles {
    ...
    class PersonneAssurableGarantBuilder {
        ...
        private static getLibelleLongPersonne(p);
...
declare module Avenants.Business.Modeles {
    ...
    class EcheanceALaCarteV2 implements IEcheanceALaCarte {
        numeroPhase: number;
        numeroRelatif: number;
        ...
        private getMontantEcheanceMaj(palier, numeroEcheanceScission);
...
declare module Avenants.Business.Modeles {
    ...
    interface IPhase {
        ...
        reportNouvelleDureeToDernierePhase(newDuree: number): void;
    ...
    interface IPalier {
        ...
        isPopinPalierDirecteur: boolean;
        tauxMinimum: number;
        tauxMaximum: number;
        tauxInit: number;
...
declare module Avenants.Business.Modeles {
    ...
    class Palier implements IPalier {
        ...
        private getElementModifiableParAvenant(palierRest, codeTypePhase, numeroEcheanceCredit, isChangementProduit);
        ...
        private getModeCalculTaux(credit, produit, phaseByProduit, palierByProduit, conditionTauxProduit, withChangementProduit);
        private getActiverTaux(modeCalculTaux, credit, phaseByProduit, palierByProduit, codeTauxCreditDirecteurByProduit, withChangementProduit?);
        private getTauxMinMax(credit, modalite, palierByProduit, produit);
        private fctShowIndicePalier(modeCalculTaux);
        private fctShowMargePalier(modeCalculTaux);
        private fctActiverMargePalier(modeCalculTaux, credit, phaseByProduit, codeTauxCreditDirecteurByProduit, withChangementProduit, parametreRevision);
...
declare module Avenants.Business.Modeles {
    ...
    class Phase implements IPhase {
        ...
        private getLibelleErreurTauxDirecteur(credit, isPhaseDirectrice, libelleErreurTauxPhase, paliers);
        ...
        private getLibelleErreurMargeDirecteur(credit, isPhaseDirectrice, paliers);
...
declare module Avenants.Business.ToolsFunctionals {
    ...
    class FonctionsPhasePalier {
        ...
        /**
         * Permet de mettre à jour le statu d'absorption de la phase par rapport au palier.
...
declare module Avenants.Business.ToolsFunctionals {
    ...
    class PeriodicitePhase {
        ...
        static impactPeriodicitePhase(phaseSel: Modeles.IPhase, phases: Array<Modeles.IPhase>, credit: RestGestion.InformationCredit.ICredit, isChangementProduit: boolean, nuepDebutPhase: number, nuepFinPhase: number, listeAccessoires: Array<RestAvenantParam.Produit.IAccessoire>): Array<Modeles.IPhase>;
        static reportPeriodicite(phaseSel: Modeles.IPhase, phases: Array<Modeles.IPhase>, isChangementProduit: boolean): Array<Modeles.IPhase>;
        static scissionPhase(phaseSelectionne: Modeles.IPhase, phaseAvailables: Array<Modeles.IPhase>, credit: RestGestion.InformationCredit.ICredit, nuepDebutPhase: number, nuepFinPhase: number, listeAccessoires: Array<RestAvenantParam.Produit.IAccessoire>): Array<Modeles.IPhase>;
        protected static miseAjourErreurPhasePalier(phases: Array<Modeles.IPhase>, numeroPhaseEnCours: number, messageErreurScissions: Array<string>): Array<Modeles.IPhase>;
        protected static getDateDebutFinPhase(credit: RestGestion.InformationCredit.ICredit): Array<Date>;
        protected static verificationDureePeriodiciteSansScission(phaseSelUniteDureePhase: string, phaseSelDuree: number, phaseSelPeriodiciteCalculInterets: Modeles.IPeriodicitePhase, phaseSelPeriodiciteInteret: Modeles.IPeriodicitePhase, phaseSelPeriodiciteAmortissement: Modeles.IPeriodicitePhase): Array<string>;
        protected static verficationSissionApplicable(nuepDebutPhase: number, numeroEcheanceCredit: number, nbEcheance: number, phaseSelPeriodiciteCalculInt: Modeles.IPeriodicitePhase, phaseSelUniteDureePhase: string, phaseSelPeriodiciteAmor: Modeles.IPeriodicitePhase, phaseSelPeriodiciteInt: Modeles.IPeriodicitePhase, isPhase: boolean): Array<string>;
        protected static verficationSissionPossible(nbEcheancePhase: number, isPhase: boolean, phasePeriodiciteCalculInt: Modeles.IPeriodicitePhase, phaseUniteDureePhase: string, phasePeriodiciteAmor: Modeles.IPeriodicitePhase, phasePeriodiciteInt: Modeles.IPeriodicitePhase): Array<string>;
        ...
        static modificationPalierTauxInteretNouveau(nouveauPalier: Modeles.IPalier, numeroEcheanceCreditS882: number, dureeNouvellePhase: number, periodiciteIntPhase: Modeles.IPeriodicitePhase, periodiciteAmorPhase: Modeles.IPeriodicitePhase): Modeles.IPalier;
        ...
        static miseAJourPalierTaux(palierPhaseEnCours: Array<Modeles.IPalier>, palierEnCours: Modeles.IPalier, nouveauPalier: Modeles.IPalier, numeroNouvellePhase: number, numeroEcheanceCreditS882: number): Array<Modeles.IPalier>;
        static miseAJourPhases(phaseInits: Array<Modeles.IPhase>, phaseSel: Modeles.IPhase, nouvellePhase: Modeles.IPhase): Array<Modeles.IPhase>;
...
declare module Avenants.Business.Modeles {
    ...
    class AvenantReportFinPretBuilder {
        ...
        private static getSecurisationActiv(creditOrigine);
        private static getEtatAvantAvenant(accessoire);
        private static getEtatActuel(accessoire);
    }
}
...
declare module Avenants.Business.Modeles {
    interface IReportFinPret {
        ...
        datesAccessoire: Array<IDateReportFinPret>;
...
declare module Avenants.Business.Modeles {
    ...
    class AvenantDescriptionFactory {
         ...
         */
        private getDataRestAvenant(codeEtablissement, caraFinan, creditCurrentInfoCredit, produitCredit, listeIndice, palierCredit, dataPersonnes, dataObjet, dataGaranties, vraiCreditOrigine, listeTypesSinistres);
    }
}
...
declare module Avenants.Business.Modeles {
    ...
    class AvenantDescription extends AvenantDescriptionBehavior implements IAvenantDescription {
        ...
        isVariationDureeProduit: boolean;
        ...
        gestionAte(phaseEnCours: Modeles.IPhase, phasesM: Array<Modeles.IPhase>, resultAte: Modeles.IAte, numeroEcheanceCreditS882: number, numeroEcheanceDebutPhase: number, numeroEcheanceFinPhase: number): void;
        addGarantie(): void;
        ...
        private getLibelleNouveauProduit(codeTypeAcces, creditByCaraFinan);
...
declare module Avenants.Business.Modeles {
    ...
    class AvenantResumeBuilder {
         ...
         */
        static getResult(elt: RestAvenant.Recherche.IAvenant | RestAvenant.Recherche.ISimulation, codeAvenantSimulation: Commun.Enum.CodeAvenantSimulation, dateTraitement: string, listeHabs: Array<RestGestion.HabilitationCredit.IHabilitation>, dataBuild: Modeles.IDataBuildAvenantResume): Modeles.IAvenantResume;
...
declare module Avenants.Business.Modeles {
    ...
    class DocumentIndus implements IDocumentIndus {
        ...
        filesInput: Array<File>;
        file: File;
        constructor(listeLibelleRelatifDocument: Array<RestEligibilite.ILibelleRelatifDocument>, listeDataDocumentIndus: Array<IDataDocumentIndus>);
        supprimerDoc(): void;
        private geLibellePieco(libelleRelatifDocument, dataDocumentIndus);
        /**
         ...
         */
        private getLibelleDocWithoutExtension(libelleLong);
...
declare module Avenants.Business.Modeles {
    ...
    class DocumentPiecoBulder {
        getResult(listeInfoGeneriques: Array<RestEligibilite.IInfoGenerique>, objetLibelle: RestEligibilite.ILibelleRelatifDocument): IDocumentPieco;
    }
    class DocumentPiecoBulderHelper {
        static getCodeTypeDocument(listeDocs: Array<RestEligibilite.IInfoGenerique>): string;
        static getReferencesDocuments(listeDocs: Array<RestEligibilite.IInfoGenerique>): Array<string>;
    }
}
...
declare module Avenants.Business.Modeles {
    ...
    class EditionIndustrielle implements IEditionIndustrielle {
        ...
        listeFlyers: Array<IDocument>;
        isGDEPresent: boolean;
        constructor(resultGDE: Array<Modeles.IDocumentPieco>, eligibilite: RestEligibilite.IEligibilite);
        private getFlyer(doc);
        getListeDocumentPIECO(eligibilite: RestEligibilite.IEligibilite): Array<Modeles.IDocumentPieco>;
        /**
         * Liste de documents disponibles pour envoi unitaire dans GDE
         */
        private getListeDocumentIndus(listeLibelle, listeDataDocumentIndus);
...
declare module Avenants.Business.Modeles {
    ...
    import RestCaraFinan = Avenants.Rest.Modeles.DossierCreditAvenant.CaracteristiqueFinan;
    import GestionModel = Avenants.Business.Modeles;
    class ImpressionDossierBuilder {
        static getReferencesDossier(impressionDossier: RestAvenantImprDossier.IImpressionDossier): Array<GestionModel.IDocumentPieco>;
        static getDocumentModel(document: RestAvenantImprDossier.IDocument): GestionModel.IDocumentPieco;
...
declare module Avenants.Business.Modeles {
    ...
    class DataJustificatifBuilder {
        static getResult(listeHabs: Array<RestGestion.HabilitationCredit.IHabilitation>, listeGarantiesApplicables: Array<RestAvenant.CaracteristiqueFinan.IGarantieApplicable>, listeGarantieExistante: Array<RestAvenant.CaracteristiqueFinan.IGarantieExistante>, listeGarantieSuretePerso: Array<RestAvenant.CaracteristiqueFinan.IGarantieSuretePerso>): IDataJustificatif;
        /**
         * Le bloc doit s'afficher pour un avenant (si on est dans ce builder c'est un avenant)
         * Et habiitation particulière
         */
        private static getShowBlocJustificatif(listeGarantieResume, listeHabs);
...
declare module Avenants.Business.Modeles {
    class ParametresLotBuilder {
        static getParametres(codeEtablissement: string, numeroOrdre: number, fichierBase64: string, nomFichier: string): MyWay.Services.Impression.DocumentImpressionLot;
    }
}
...
declare module Avenants.Business.Modeles {
    ...
    class CaracteristiqueFinanAccessoireBuilder {
        ...
        private static calculDatesAccessoire(credit, phase, accessoire);
        private static getPremiereDateUtile(dateEffet, dateEcheance);
        private static getAccessoireAvenant(dataCommonCaraFinan, a, dateEffet, codeTypeAcces, credit, isAvenantReportFinPret, typeAvenant, frais?, reportFinPret?);
        ...
        private static getRealDateDebutApplication22(creditDateFinCredit, accessoire, periodicite);
        private static getRealDateFinApplication22(creditDateFinCredit, accessoire, rfpEcheancesReportees, periodicite);
        private static findLastAccessoire22CreditOrigine(credit);
        private static getRealDateDebutApplication21(periodicite, numeroQuantiemeDateEcheance, dateEffet, typeAvenant, dateDebutApplication);
        private static getRealDateFinApplication21(periodicite, dateDebutApplication, numeroQuantiemeDateEcheance, dateEffet, typeAvenant, realDateDebutApplication21, echeancesReportees);
    }
}
...
declare module Avenants.Business.Modeles {
    ...
    class CaracteristiqueFinanPhaseBuilder {
        ...
        static getPhase(p: IPhase, infoCredit: RestGestionInfoCredit.ICredit, numeroRelatifSimulationAvenant: number, dateFinPrefiReelleByCredit: Date, isAvenantAte: boolean, isChangementProduit: boolean, isCreditDirecteurIndiceActif: boolean, numeroJeuIndiceRevision: number): RestAvenantCaraFinan.IPhase;
        private static getListeEcheancesALaCarteV2(listePalier, codeEtablissement, identifiantCredit, isChangementProduit);
        private static getEcheanceALaCarteV2(palier, echeanceALaCarte, codeEtablissement, identifiantCredit, isChangementProduit);
         ...
         */
        private static getListePalierTauxAmortissement(numeroPhaseModele, phaseByRest, numeroRelatifSimulationAvenant, listePalier, isChangementProduit);
        private static getPalierTauxAmortissement(numeroPhaseModele, p, numeroRelatifSimulationAvenant, numeroPremiereEcheance, numeroDerniereEcheance, elementModifiableParAvenant, isChangementProduit);
        /**
         * IParametreRevisionTaux
         */
        private static getListeParametresRevisionTaux(p, numeroRelatifSimulationAvenant, isAvenantAte, isChangementProduit, isCreditDirecteur, numeroJeuIndiceRevision);
        ...
        private static getParametreRevisionTauxAte(p, numeroRelatifSimulationAvenant);
...
declare module Avenants.Business.ToolsFunctionals {
    class CaraFinan {
        ...
        /**
         * Ce paramètre définit le type de l'avenant, attention à ne pas le modifier ou alors il faut être certain de ses répercussions
         */
        static getCodeTypeModificationCredit(listeModificationCredit: Array<Commun.Enum.ModificationCredit>, isCreditWithAjustementEcheances: boolean, isAvecChangementProduit: boolean, isSecurisationOpenByReportFinPret: boolean, isEntierementVerse: boolean): string;
    }
}
...
declare module Avenants.Business.Modeles {
    ...
    class CreditAvenantFinancier implements ICreditAvenantFinancier {
         ...
         */
        private getPhaseReference(credit);
         ...
         */
        private getDureeResiduelle(credit);
        ...
        private getConditionTaux(produitCredit, dateTraitement);
...
declare module Avenants.Business.Modeles {
     ...
     * !! Il est dépendant d'un autre décorateur, il faut d'abord initialisé AvenantAssuranceDataDecorateur
     */
    class AvenantAssuranceDecorateur extends AvenantDecorateur {
         ...
         * -> C'est dans le cadre d'un avenant de personnes -> le changement entraine la modifications des personnes
         */
        setListePersonnesAssurable(listePersonneAssurableGarant: Array<IPersonneAssurableGarant>): void;
        /**
...
declare module Avenants.Business.Modeles {
    ...
    class AvenantCreditDecorateur extends AvenantDecorateur {
         ...
         */
        private getIsCreditWithAjustementEcheances(phases);
        ...
        private getNumeroPremiereEcheanceLastPalierPhaseO(phaseInits);
        private getNouvellePhaseAMSupOrigine(creditChangePdt, phaseCreditOrigines, phaseEnCoursCreditOrigineNumeroPhase, initialisationPhases);
    }
}
...
declare module Avenants.Business.ToolsFunctionals {
    ...
    class FonctionsAte {
        ...
        static scissionEltCalculAccessoires(assurances: Array<Modeles.IAssurance>, numeroPhaseEnCours: number, isSecondeScissionAte: boolean): Array<Modeles.IAssurance>;
...
declare module Avenants.Business.ToolsFunctionals {
    ...
    class ModificationCrd {
        ...
        static getInteretCompOuReport(afficheInteretCompensateur: boolean, caseInteretCompensateur: boolean, creditOrigine: RestDossierCreditGestion.InformationCredit.ICredit): number;
