...
declare namespace ICBusiness.ModelsTransformers {
    ...
    class SurfaceFinanciere {
        ...
        private static mapDetailSyntheseEpargne();
...
declare namespace ICBusiness.Services.Dossier {
    interface ISurfaceFinanciereService {
        getSurfaceFinanciere(idDossier: string, dateDeTraitement: string, codeEtablissement: number): ng.IPromise<Models.Emprunteur.ISurfaceFinanciere>;
    }
    class SurfaceFinanciereService implements ISurfaceFinanciereService {
        ...
        static $inject: Array<string>;
        constructor($q: ng.IQService, elementSchemaService: ICRest.Services.ElementSchema.IElementSchemaService, creditParametreService: ICRest.CreditParametre.Services.ICreditParametreService);
        getSurfaceFinanciere(idDossier: string, dateDeTraitement: string, codeEtablissement: number): ng.IPromise<Models.Emprunteur.ISurfaceFinanciere>;
    }
}
