...
declare module Avenants.Rest.Services {
    ...
    interface IParametresService {
        getParamsStandard(codeEtablissement: string, dateTraitement: string, numeroCredit: string): ng.IPromise<ModelGestion.PalierCredit.IPalierCredit>;
    }
...
declare module Avenants.Rest.Services {
    ...
    interface ISignatureService {
        getEligibilite(codeEtablissement: string, dateTraitement: string, idCredit: string, caraFinan: ModelAvenant.CaracteristiqueFinan.ICaracteristiqueFinan, avenant: ModelAvenant.Recherche.IAvenant, codeNatureFinancementCredit: string, isEligibilite: boolean, typeEdition: Commun.Enum.TypeEdition): ng.IPromise<ModelEligibilite.IEligibilite>;
...
declare module Avenants.Rest.Modeles.AvenantCreditParam.Eligibilite {
    ...
    class CriteresAppelBuilder {
        getResult(codeEtablissement: number, dateTraitement: string, idCredit: string, caraFinan: RestAvenant.CaracteristiqueFinan.ICaracteristiqueFinan, avenant: RestAvenant.Recherche.IAvenant, codeNatureFinancementCredit: string, isEligibilite: boolean, typeEdition: Commun.Enum.TypeEdition): ICriteresAppel;
        private getDonneesGeneral(codeEtablissement, dateTraitement, isEligibilite, typeEdition);
        /**
...
declare module Avenants.Rest.Modeles.DossierCreditGestion.Parametres {
