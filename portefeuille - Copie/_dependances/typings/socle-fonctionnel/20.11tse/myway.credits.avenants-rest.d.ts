...
declare module Avenants.Rest.Services {
    ...
    interface IParametresService {
        ...
        getParametreTypeSinistre(codeEtablissement: string, dateTraitement: string, numeroCredit: string, codeTypeSinistre?: string): ng.IPromise<ModelGestion.Parametre.IParametre>;
    }
