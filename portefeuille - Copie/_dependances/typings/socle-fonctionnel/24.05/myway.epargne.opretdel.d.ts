...
declare module operationRetraitDepot {
    class Constantes {
        ...
        static habilitations: {
            ...
            CODE_HABILITATION_SHJE15: string;
            CODE_HABILITATION_SHJE16: string;
        };
        /**
         * Code forage.
         */
        ...
        static codeModeFinancier: {
            MODE_FINANCIER_OPERATIONS_DIVERSES: string;
            MODE_FINANCIER_ESPECES: string;
            MODE_FINANCIER_CHEQUE_RECU: string;
            MODE_FINANCIER_VIREMENT_INTERNE: string;
            MODE_FINANCIER_ESPECES_DIVERS: string;
            MODE_FINANCIER_CHEQUE_BANQUE: string;
            MODE_FINANCIER_DIVERS: string;
        };
        /**
...
declare module operationRetraitDepot.Controleurs {
    class IdentificationExtourneRegulControleur {
        ...
        estEntreeSyntheseClient: boolean;
        verrouillageRice: boolean;
...
declare module operationRetraitDepot.Controleurs {
    ...
    class OperationDistanceControleur {
        ...
        /** le mode financier qui a été choisi. */
        ...
        /** Ouverture par défaut du bloc signataires. */
        ouvertureDefautBlocSignataires: boolean;
        /** Habilitation forçage dépot / retrait  */
        estHabiliteSHJE15: boolean;
        estHabiliteSHJE16: boolean;
...
declare module operationRetraitDepot.Controleurs {
    ...
    class OperationFinanciereControleur {
        ...
        ouvertureDefautBlocSignataires: boolean;
        /** Operation multiple */
        estEnModeOperationsMultiples: boolean;
        /** astuce pour détruire et reconstruire la fenetre d'opperation  */
        estAfficherCommunOpeFiRegul: boolean;
        /** Collection de d'operation  */
        nombreOperationFinanciere: number;
        operationFinancierePrecedent: myway.comOpesFinancieres.Model.OperationFinanciere;
        /** Affichage popup verification operation */
        estPopupAfficher: boolean;
        /** Habilitation forçage dépot / retrait  */
        estHabiliteSHJE15: boolean;
        estHabiliteSHJE16: boolean;
        codeModeFinancierEspeceDivers07: string;
        ...
        annuler(): void;
        /**
         * Clic sur le bouton Operations Multiples dans l'IHM
         */
        operationsMultiples(): void;
        /**
         * Clic sur le bouton de Validation de l'opération financière dans l'IHM
         */
        validationOperationBouton(): void;
        /**
         * Modale confirmation
         */
        modaleConfirmation(): ng.IPromise<any>;
        /**
         * Validation de l'opération financière
         */
        validationOperation(): void;
        /**
         * Dans un mode financier 07 afficher modal pour confirmer l'operation
         */
        confirmation(): void;
        /**
        ...
        private suiviCommercialPuisSortieApplication();
        private sortieOuRelanceApplication();
        private gestionImpressionBordereauEtSortieApplication(bordereauMyWay);
        impressionBordereauMyWay(operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere): void;
    }
}
...
declare module operationRetraitDepot.Services {
    ...
    class OperationFinanciereDepotRetraitService {
        ...
        private codeSensVirSansContrePartieExtourne;
        static $inject: string[];
         ...
         * @param estDepot Indique si c'est un depot, sinon c'est un retrait
         */
        creationObjetPostOperationFinanciereDepotRetrait(operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere, estDepot: boolean, estSignataireRepresentantLegal: boolean, codeFonctionnalite?: string, donneesContexte?: Modeles.ContexteModel): OperationFinanciereDepotRetrait.IOperationFinanciere;
        /**
        ...
        gestionPopupSeuilPlafond(operationFinanciere: myway.comOpesFinancieres.Model.OperationFinanciere, estHabiliteSHJE15: boolean, estHabiliteSHJE16: boolean): ng.IPromise<myway.comOpesFinancieres.Model.OperationFinanciere>;
        /**
...
declare module operationRetraitDepot.Controleurs {
    class PopupVerificationOperationController {
