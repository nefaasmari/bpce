...
declare namespace ContentieuxDirectives.Commun.Constantes.Inject {
    ...
    namespace Modal {
        ...
        const designationPersonne: string;
...
declare namespace ContentieuxDirectives.Services.ModifEvenement {
    class ModifEvenementService {
        ...
        ouvrirModaleModifEvenement(evt: ContentieuxServices.Modeles.Agenda.IEvenementAgenda, designationPersonne: string): ng.IPromise<ContentieuxServices.Modeles.Agenda.IEvenementAgenda>;
...
declare namespace ContentieuxDirectives.Commun.Constantes {
    ...
    namespace modificationEvenement {
        ...
        const COMMENTAIRE_TROP_LONG: string;
        const COMMENTAIRE_OBLIGATOIRE: string;
...
declare namespace ContentieuxDirectives {
    class ModificationEvenementModalControleur {
        ...
        constructor($modalInstance: angular.ui.bootstrap.IModalServiceInstance, noteAlerteService: ContentieuxServices.Services.Agenda.INoteAlerteService, evenementAModifier: ContentieuxServices.Modeles.Agenda.IEvenementAgenda, designationPersonne: string);
        valider(evt: ContentieuxServices.Modeles.Agenda.IEvenementAgenda): void;
        annuler(): void;
        fermer(): void;
        isSaisieValide(): boolean;
        private mapEvenement(evenementAModifier);
        private getTitreModal(designation);
    }
}
...
declare namespace ContentieuxDirectives.Directives.Agenda {
    class ModificationEvenementControleur {
        ...
        evenement: ContentieuxServices.Modeles.Agenda.IEvenementAgenda;
        caracteresRestants: number;
        nombreCaractereAutorise: number;
        dateJour: Date;
        msgDateInvalide: string;
        msgCommentaireInvalide: string;
        codeTypeProcedure: string;
        isEvenementPrioritaire: boolean;
        constructor();
        isCommentaireValide(): void;
        isDateValide(): void;
        isProcedure(): boolean;
        getNumeroPriorite(): void;
        getTailleCommentaire(): number;
    }
}
