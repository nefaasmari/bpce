...
declare module myflow.libcommon {
    class AccesParametrageController extends BaselibCommonControleur {
        private $location;
        protected modalService: MyWay.UI.ModalService;
        protected lisaService: myflow.libcommon.LisaService;
        protected perimetreService: myflow.libcommon.PerimetreService;
        protected serviceAgentExtended: MyWay.Services.ServiceAgentExtended;
        lisaType: libcommon.MyflowContextParametrerLisaType;
        constructor($location: ng.ILocationService, modalService: MyWay.UI.ModalService, lisaService: myflow.libcommon.LisaService, perimetreService: myflow.libcommon.PerimetreService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        /**
         * Préparation des élements de redirection vers catalogue des motifs
         */
        redirectionParametrageMyFlow(): void;
    }
}

declare module myflow.libcommon {
    function accesParametrageDirective(): ng.IDirective;
}
