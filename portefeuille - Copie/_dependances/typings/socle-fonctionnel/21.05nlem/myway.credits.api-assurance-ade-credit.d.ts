...
declare namespace AssuranceAdeCredit.ModelTransformers {
    ...
    class PropositionAssuranceTransformer {
        ...
        static parseEntreeEnregistrement(idDossier: string, proposition: Modeles.Proposition.IPropositionsAssurance): Modeles.Rest.EnregistrerPersAssur.IEntreePersonnalisationAssurance[];
        ...
        private static parseGarantiesChoisies(prop);
        private static parsePersonnalisationApe(garantie);
        private static parsePersonnalisationAde(garantie);
        /** Parse les données retournées suite à la création d'une proposition */
        static parseRetourCreation(dataRetour: CreerPropAssurance.ISortiePropositionAssurances[], initialQuotite: number): Modeles.Proposition.IPropositionsAssurance;
        ...
        private static parseConfigurationsGeneriques(dataRetour);
        /**
         ...
         */
        private static mapCreditWithForm(creditCouverture, prop);
        private static parseConfigurationsInitialesPersonne(dataRetour);
        private static parseGarantiesSocles(garanties);
...
declare namespace AssuranceAdeCredit.Services {
    interface IPropositionAssuranceService {
        ...
        creerPropositionAssurance(idDossier: string, idPersonnes: string[], idCredits: string[], codeCollectivite: string, quotite: number, tarifDerogatoire: boolean): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
        /** Récupère les données de la proposition d'assurance (sans mise à jour) */
        lirePropositionAssurance(idDossier: string, idCredits: string[], nomPropositions: Modeles.INomProposition[]): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
        /** Récupère les données de la proposition (avec actualisation des données) */
        majPropositionAssurance(idDossier: string, idCredits: string[], nomPropositions: Modeles.INomProposition[], quotite: number, tarifDerogatoire: boolean, actualQuotite: number): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
        /**
         ...
         */
        mapDatasEntreesPropAssurancesAfterDelete(propositionAssurance: Modeles.Proposition.IPropositionsAssurance, deletedAssuranceByAssure: Modeles.Proposition.IDeletedAssuranceByAssure[], idDossier: string, tarificationDerogatoireValue: boolean): Modeles.Rest.MajPropAssurance.IEntreePropositionAssurances[];
        /**
        ...
        enregistrerPersonnalisationAssurance(idDossier: string, proposition: Modeles.Proposition.IPropositionsAssurance): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
    }
    class PropositionAssuranceService implements IPropositionAssuranceService {
         ...
         */
        majPropositionAssurance(idDossier: string, idCredits: string[], nomPropositions: Modeles.INomProposition[], quotite: number, tarificationDerogatoire: boolean, actualQuotite: number): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
        enregistrerPersonnalisationAssurance(idDossier: string, proposition: Modeles.Proposition.IPropositionsAssurance): ng.IPromise<Modeles.Proposition.IPropositionsAssurance>;
        /**
         ...
         */
        private getDataEntree(idDossier, nomProposition, idCredits, quotite?, tarificationDerogatoire?);
        /**
         ...
         */
        private getDataCreerEntree(idDossier, idPersonne, idCredits, idProposition, codeCollectivite, quotite?, tarificationDerogatoire?);
        /** Parse les données en retour des services de création/maj/lecture de proposition d'assurance */
        private traitementSortiePropositionAssurances<T>(dataRetour, initialQuotite?);
    }
}
...
declare namespace AssuranceAdeCredit {
    class AssuranceAdeControleur {
        ...
        private displayTabsetModeExpert();
...
declare namespace AssuranceAdeCredit.Modeles.Proposition {
    ...
    interface IGarantieOption extends IGarantieSocle {
        options: IOption[];
    }
    /** Représente les données d'une garantie option APE (Assurance Perte Emploi) */
    interface IGarantieApe extends IGarantieOption {
        devise: string;
...
declare namespace AssuranceAdeCredit.Services.FormSettings {
    ...
    interface IAdeFormSettingsService {
        getSettings(isConsultation: boolean, isCreation: boolean, assurance: Modeles.IAssuranceForm, viewModel: Modeles.IViewModel, listCollectivite: Modeles.ICodeLabel<string>[], tarificationDerogatoireActif: () => boolean): IAdeFormSettings;
    }
