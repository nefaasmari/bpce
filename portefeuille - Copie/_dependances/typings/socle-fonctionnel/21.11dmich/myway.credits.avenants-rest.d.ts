...
declare module Avenants.Rest.Services {
    ...
    interface IServicesObjetService {
        getServiceObjExistantAvenant(codeEtablissement: string, numeroCredit: string, dateTraitement: string, codeAvenantSimulation: string, codeRoleCreditAvenant: string, numeroRelatif: string, numeroRelatifSimulationAvenant: string, dateEffetContrat: string): ng.IPromise<Modeles.IServicesObjet>;
    }
