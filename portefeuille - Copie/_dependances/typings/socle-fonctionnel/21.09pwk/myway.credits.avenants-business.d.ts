...
declare module Avenants.Business.ToolsFunctionals {
    ...
    class ModificationTauxProgAmor {
        ...
        static miseAJourPalierProgAmorToutePhase(palierProgAmorSel: Modeles.IPalierProgAmor, phases: Array<Modeles.IPhase>, creditCodeRoleCreditAvenant: string): Array<Modeles.IPhase>;
