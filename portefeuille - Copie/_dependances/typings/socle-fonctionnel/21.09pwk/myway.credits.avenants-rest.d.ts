...
declare module Avenants.Rest.Services {
    ...
    interface IParametresService {
        ...
        getParametreAssurancePeutCouvrirSinistre(codeEtablissement: string, dateTraitement: string, codeTypeAssurance?: string, codeTypeSinistre?: string): ng.IPromise<ModelGestion.Parametre.IParametre>;
    }
...
declare module Avenants.Rest.Services {
    ...
    interface ISignatureService {
        getEligibilite(codeEtablissement: string, dateTraitement: string, idCredit: string, caraFinan: ModelAvenant.CaracteristiqueFinan.ICaracteristiqueFinan, avenant: ModelAvenant.Recherche.IAvenant, codeNatureFinancementCredit: string, isEligibilite: boolean, typeEditionPieco: Commun.Enum.TypeEditionPieco, isEcureuilCredit: boolean): ng.IPromise<ModelEligibilite.IEligibilite>;
...
declare module Avenants.Rest.Modeles.AvenantCreditParam.Eligibilite {
    ...
    class CriteresAppelBuilder {
        static getResult(codeEtablissement: number, dateTraitement: string, idCredit: string, caraFinan: RestAvenant.CaracteristiqueFinan.ICaracteristiqueFinan, avenant: RestAvenant.Recherche.IAvenant, codeNatureFinancementCredit: string, isEligibilite: boolean, typeEditionPieco: Commun.Enum.TypeEditionPieco, isEcureuilCredit: boolean): ICriteresAppel;
         ...
         */
        private static getListeDonneesUnCarac(idCredit, codeExistenceCreditTxRevisable, credit, listeIdGarantie, listeIdAssurance, typeEditionPieco, isEcureuilCredit);
