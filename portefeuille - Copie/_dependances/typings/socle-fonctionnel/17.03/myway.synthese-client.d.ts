...
declare module syntheseClient.Constantes {
    class Constantes {
        ...
        static indicateurSynchroSynthese: string;
    }
}
...
declare module syntheseClient {
    class VueSyntheseControleur {
        ...
        listeSyntheseClientEntiteTitulaire: Array<Modeles.Profil.ISyntheseClientEntiteTitulaire>;
        static $inject: string[];
        constructor(objetSynthese: syntheseClient.Modeles.SyntheseGlobale.ISyntheseDonneesClient, syntheseInitialisationService: syntheseClient.Service.SyntheseInitialisationService, $route: ng.route.IRouteService, tools: Service.SyntheseToolsService, syntheseClientUtilitaireService: Service.SyntheseClientUtilitaireService, syntheseProduitService: Service.SyntheseProduitService, syntheseClientDonneesService: Service.SyntheseClientDonneesService, syntheseTypeBlocs: Service.Typologiesblocs);
        init(): void;
        idSyntheseCourante: string;
...
declare module syntheseClient.Service {
    ...
    class SyntheseClientChargementService {
         ...
         */
        initialisationChargement(rechargement?: boolean, indicateur?: string): void;
        /**
...
declare module syntheseClient.Service {
    class SyntheseClientRisquesAlertesService {
         ...
         * @param libelleEtatDossier{string}
         */
        afficherEtatDossierClient(codeEtatCompletudeDossier: string): string;
        /**
...
declare module syntheseClient.Service {
    ...
    class SyntheseToolsService implements ITools {
        ...
        static $inject: string[];
        flagLogActive: boolean;
        constructor(modalService: any, mwNotificationService: MyWay.UI.IMwNotificationService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
...
declare module syntheseClient.Directive {
    ...
    function SyntheseBlocCustomDirective($compile: ng.ICompileService, syntheseClientDonneesService: syntheseClient.Service.SyntheseClientDonneesService, syntheseInitialisationService: syntheseClient.Service.SyntheseInitialisationService): ng.IDirective;
}
...
declare module syntheseClient.Directive {
    interface IScopeScElementProduit extends ng.IScope {
        ...
        listeObject: string;
        object: syntheseClient.Modeles.Produits.IListeSyntheseClientProduitInfoCommune;
        complement: string;
        titre: string;
        id: string;
        avecMarquage: string;
