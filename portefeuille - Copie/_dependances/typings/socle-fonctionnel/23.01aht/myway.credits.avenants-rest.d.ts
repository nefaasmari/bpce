...
declare module Avenants.Rest.Constantes.Flux {
    module DossierCreditCestion {
        const getCaraCredit: any;
        const getHabilitationGlobal: Array<Modeles.DossierCreditGestion.HabilitationCredit.IHabilitation>;
        const getInfoCreditSQEC1: Modeles.DossierCreditGestion.InformationCredit.IInformationCredit;
        const getInfoCreditSQECSQED: Modeles.DossierCreditGestion.InformationCredit.IInformationCredit;
        const getJustificatifCredit: Modeles.DossierCreditGestion.CaracteristiqueCredit.IDonneeCredit;
        const getParametre: Modeles.DossierCreditGestion.Parametre.IParametre;
    }
    module DossierCreditAvenant {
        const getRecherche: Modeles.DossierCreditAvenant.Recherche.IRecherche;
        const getSignatureElectronique: Modeles.DossierCreditAvenant.Caracteristique.ICaracteristique;
        const getServicesObjet: Modeles.DossierCreditAvenant.ServicesObjet.IServicesObjet;
    }
    module AvenantCreditParam {
        const getProduit: Modeles.AvenantCreditParam.Produit.IProduit;
    }
    module CreditParametre {
        const getListerParamApplicatif: Array<Modeles.CreditParametre.ListerParamApplicatif.IScParamApplicatif>;
    }
    module Structure {
        const getPosteFonctionnelAgent: Modeles.Structure.PosteFonctionnelAgent.IPosteFonctionnelAgent;
    }
}

declare module Avenants.Rest.Constantes.Flux {
    module DossierCreditAvenant {
        const postGetCaraFinan: Modeles.DossierCreditAvenant.CaracteristiqueFinan.ICaracteristiqueFinan;
    }
}
...
declare module Avenants.Rest.Services {
    ...
    class RestService implements IRestService {
        ...
        sendPutRequest<T, U, V>(urlService: string, data: U, params?: V, timeout?: number): ng.IPromise<T>;
        sendDeleteRequest<T, U, V>(urlService: string, data?: U, params?: V): ng.IPromise<T>;
        consume<T, U, V>(typeMethode: MyWay.Services.MethodEnum, urlService: string, params?: U, data?: V, timeout?: number): ng.IPromise<any>;
        /**
