...
declare module propoClient.Modeles.CompteursDossiers {
    ...
    interface ICompteursDossiers {
        ...
        /**
         * nombre de dossiers de vente en attente d'envoi de mail pour signature
         */
        nbDossierAttenteEnvoi: number;
    }
}
...
declare module propoClient.Service {
    class PropoClientUtilsService {
        ...
        /**
         * permet de restituer l'ordre d'affichage d'un canal
         * @param codeCanal
         */
        getOrdreAffichageCanal(codeCanal: string): string;
        /**
        ...
        /**
         * Permet de définir si un dossier est géré au sein d'un panier de dossiers ou non
         * @param codeStatutEtape {string}
         */
        isDossierGereEnPanier(codeStatutEtape: string): boolean;
        /**
...
declare module propoClient.Directive {
    interface ICanalPropo {
        codeCanal: string;
        nbPropo: number;
        libelleCanal: string;
        iconeCanal: string;
        ordreAffichageCanal: string;
    }
    class PropoClientFooterControleur {
        ...
        private propoClientUtilsService;
        private historiqueDossier;
        private compteursDossier;
        private tabCanal;
        btnSignerPanierActions: Array<ICanalPropo>;
        blnAfficherBoutonMultipleSignerPanier: boolean;
        blnAfficherBoutonSimpleSignerPanier: boolean;
        blnAfficherBoutonGererPanier: boolean;
        blnAfficherBoutonFaireSigner: boolean;
        blnAfficherFooter: boolean;
        blnFinInitFooter: boolean;
        nbDossiers: number;
        nbDossiersEnAttenteEnvoi: number;
        nbDossiersGeresEnPanier: number;
        boutonMultipleIsOpened: boolean;
        static $inject: string[];
        constructor($scope: IScopeEcpElementProduit, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, propoCompteursDossiersRestService: Service.PropoCompteursDossiersRestService, propoClientRestService: Service.PropoClientRestService, propoClientUtilsService: Service.PropoClientUtilsService);
        initFooter(): void;
        analyserListeDossiers(): void;
        initBoutonMultipleSigner(): void;
        calculerNombresDossiers(): void;
        calculerIndicateursAffichage(): void;
        goToSignature(): void;
        goToGestionPanier(): void;
        goToSignaturePanier(codeCanal?: string): void;
        afficherBoutonFaireSigner(): boolean;
        afficherBoutonSimpleSignerPanier(): boolean;
        afficherBoutonMultipleSignerPanier(): boolean;
        afficherBoutonGererPanier(): boolean;
