...
declare namespace ICBusiness.Services.Assurances {
    ...
    interface IAssurancesService {
        ...
        ouvrirDossierExterne(dossier: Models.Assurances.IDossierExterne): ng.IPromise<void>;
    }
    /** Services relatifs aux assurances */
