...
declare module GGOCommunEpi.Services {
    ...
    interface IAuthentificationService {
        ...
        doProvisioning(signataire: Types.Authentification.IClientSignataireAuthentification, usager: Types.Authentification.IUsager): ng.IPromise<any>;
        ...
        leverOpposition(param: Modele.IOppositionPutQuery, data: Modele.IInfoOpposition): ng.IPromise<Modele.IInfoOpposition>;
    }
    class ErreurModel {
        idService: string;
        message: string;
    ...
    class AuthentificationService implements IAuthentificationService {
        ...
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $http: ng.IHttpService, urlBapiAuthenticationFactor: string, clientIdHomol: string, clientIdProd: string, environnement: string, urlOAuth: string);
        getActivationSecurespace(codeEtablissement: string): ng.IPromise<boolean>;
         ...
         */
        leverOpposition(parametres: Modele.IOppositionPutQuery, objet: Modele.IInfoOpposition): ng.IPromise<Modele.IInfoOpposition>;
        decoderRaison(raison: any, message?: string): string;
    }
}
...
declare module GGOCommunEpi {
    ...
    class MediasEsignature {
        ...
        private supprimerOppo();
        private getDonneesOppo();
        retourSynthese(): void;
