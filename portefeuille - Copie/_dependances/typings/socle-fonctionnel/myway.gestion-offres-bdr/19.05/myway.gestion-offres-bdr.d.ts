...
declare module GestionGeneriqueOffres.Services {
    interface ILiasseService {
        ...
        preparerLiasseV2(donneesInitiales: Types.DonneesInitiales): ng.IPromise<void>;
    ...
    class LiasseService implements ILiasseService {
        ...
        private creerLiasseCenet(produitCenet, donneesInitiales, listeAdministrateursCenet, indicateurSignatureCenet);
        private creerLiassePrincipale(listeProduitCompo, donneesInitiales, liassesSupplementaires);
        /**
