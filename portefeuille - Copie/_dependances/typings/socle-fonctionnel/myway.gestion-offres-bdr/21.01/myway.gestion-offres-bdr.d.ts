...
declare module GestionGeneriqueOffres.Services {
    ...
    class DonneesInitialesService implements IDonneesInitialesService {
        ...
        constructor($q: ng.IQService, constantes: GestionGeneriqueOffres.Constantes.Definitions, progressionChargement: Types.ProgressionChargement, contexteGgoService: Services.ContexteGgoService, contexteGgoStockageService: Services.ContexteGgoStockageService, entiteTitulaireBdrService: Services.IEntiteTitulaireBdrService, tiersService: Services.TiersService, catalogueService: Services.ICatalogueService, parametrageBlocsService: Services.IParametrageBlocsService, offreDonneesService: Services.OffreDonneesService, chargementFichiersComposantService: Services.ChargementFichiersComposantService, procurationService: Services.IProcurationService, lienInterlocuteurService: Services.ILienInterlocuteurService);
        get(): ng.IPromise<Types.DonneesInitiales>;
...
declare module GestionGeneriqueOffres.Composition {
    ...
    class RecapControleur {
        ...
        private miseAJourDossierCenet(isDeployeMySign);
        ...
        private alimenterDonneesConnexesLiasseUnitaire(donneeesAuthentification, dossierSignature, catalogue, enveloppeOffre, liasse);
        private alimenterContexteGgoEditique(donneeesAuthentification, dossierSignature, catalogue, enveloppeOffre, liasse);
        private alimenterOffre(dossierSignature, catalogue, enveloppeOffre);
        private detetrminerNumeroCompte(dossierSignature);
        private alimenterListeContratCarte(dossierSignature, catalogue);
