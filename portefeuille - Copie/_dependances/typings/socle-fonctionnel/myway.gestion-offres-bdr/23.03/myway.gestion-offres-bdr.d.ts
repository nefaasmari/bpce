...
declare module GestionGeneriqueOffres.Composition {
    ...
    class RecapControleur {
        ...
        private isSolCapPresent(listeLiasses);
        ...
        private alimenterComplementActe(dossierSignature);
