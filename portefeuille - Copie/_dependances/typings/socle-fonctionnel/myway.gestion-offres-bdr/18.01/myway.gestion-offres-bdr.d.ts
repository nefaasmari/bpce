...
declare module GestionGeneriqueOffres.Services {
    interface IProcurationService {
        ...
        procuration: Types.Tiers.IProcuration[];
    }
...
declare module GestionGeneriqueOffres.Services {
    ...
    class CompositionOffreService implements ICompositionOffreService {
        ...
        formatterErreurProduitService(compositionProduit: Types.CompositionOffreProduit): string;
        /**
         ...
         */
        extraireFamilleActeGestionPourProduit(produit: Types.CompositionOffreProduit): string;
        /**
...
declare module GestionGeneriqueOffres.Services {
    ...
    class SauvegardeContexteService implements ISauvegardeContexteService {
        ...
        private actionsService;
        private routageEditique;
        private static DEBRANCHEMENT_GGHO_CODE_PS_CARTE_SECURACCES;
        private static DEBRANCHEMENT_GGHO_CODE_ACTE_GESTION;
...
declare module GestionGeneriqueOffres.Services {
    interface IMiseEnGestionBdrService {
        ...
        recupererListeProduitServiceClasseeParOrdre(): Types.CompositionOffreProduit[];
    ...
    class MiseEnGestionBdrService implements IMiseEnGestionBdrService {
        ...
        listeProduitServicesAMettreEnGestion: Types.CompositionOffreProduit[];
        private classerProduitService(produitsServicesAClasser);
        private classerProduitServiceParNiveauDePriorite(produitsServicesAClasser);
        private classerProduitServiceParTypeAction(produitsServicesAClasser);
        /**
         ...
         */
        trouverProduitServiceOriginalComposition(produitATrouver: Types.CompositionOffreProduit): Types.CompositionOffreProduit;
        /**
         ...
         */
        private resoudreCompteRenduDeMiseEnGestion(produit, compteRenduMiseEnGestion);
        /**
         ...
         */
        private testerErreurPresentePourProduit(produit, compteRendu);
        /**
         * Renvoie le premier message d'erreur significatif pour le produit en erreur
         */
        private renvoyerPremiereErreurPourProduit(phase, produit, compteRendu);
        private fabriquerDonneesDeMiseEnGestion(produit, compteRendu);
        gererDebranchement(produitService: Types.CompositionOffreProduit): ng.IPromise<boolean>;
        mettreEnGestion(produitService: Types.CompositionOffreProduit): ng.IPromise<boolean>;
        /**
         * CRI : Renvoie le P/S actuellement en MEG
         */
        recupererProduitServiceEnCoursDeTraitement(): Types.CompositionOffreProduit;
        formaterProduitServiceFacturation(): Types.CompositionOffreProduit;
        initialisaterListeProduitServiceAMettreEnGestion(): void;
        recupererListeProduitServiceClasseeParOrdre(): Types.CompositionOffreProduit[];
        /**
         ...
         */
        miseAJourEtatOffre(): ng.IPromise<Types.IEnveloppeOffreReponse>;
        /**
         ...
         */
        actualiserReferenceContrat(): void;
    }
}
...
declare module GestionGeneriqueOffres.Composition {
    class MiseEnGestionControleur {
        ...
        private sauvegardeContexteService;
        static $inject: string[];
        constructor($scope: ng.IScope, actionsService: Services.ActionsService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, sauvegardeContexteService: Services.ISauvegardeContexteService);
        init(): void;
    }
}
