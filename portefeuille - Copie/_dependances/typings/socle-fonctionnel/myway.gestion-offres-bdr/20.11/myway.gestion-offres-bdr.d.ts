...
declare module GestionGeneriqueOffres.Services {
    ...
    class LienInterlocuteurService implements ILienInterlocuteurService {
        ...
        getInterlocuteursListe(identifiantPersonne: number): ng.IPromise<Types.TiersCorporate.IInterlocuteur>;
        /**
         * Enrichit la liste des liens en y ajoutant un objet Procuration construit à partir des données fournies en paramètre
         * @param identifiant
         * @param nom
         * @param dateDebutValidite
         * @param dateFinValidite
         */
        private enrichirListeLiensInterlocuteurs(identifiant, nom, dateDebutValidite, dateFinValidite);
        /**
...
declare module GestionGeneriqueOffres.Services {
    ...
    class SauvegardeDossierVenteService implements ISauvegardeDossierVenteService {
         ...
         */
        modifierDossierVenteCeNet(identifiantPersonneContrat: number, codeTypeProduitService: string, idExterneDossierVente: string, libelleResume: string, typeAction?: GestionGeneriqueOffres.Enums.Rest.TypeActionDossierVente): ng.IPromise<boolean>;
        /**
        ...
        private mettreAJourDossierViaRest(typeAction, dossier);
        /**
         ...
         * @param dossier
         */
        private procederAbandonDossier(authInfo, typeAction, dossier);
        /**
         ...
         */
        private abandonnerSignatureElectroniqueDansIdn(typeAction, codeEtablissement, identifiantTransactionContract, identifiantDocumentNumerise, identifiantPersonneContrat);
        /**
         ...
         * @param identifiantDocumentNumerise
         */
        private parametresCorrectsPourAbandonSignature(typeAction, codeEtablissement, identifiantTransactionContract, identifiantDocumentNumerise, identifiantPersonneContrat);
        /**
...
declare module GestionGeneriqueOffres.Composition {
    ...
    class RecapControleur {
        ...
        private miseAJourDossierCenet();
        private finaliserDossierCeNet(produitCeNet, codeActeGestion, donneesInitiales, idExterneDossierCeNet);
        private cloturerDossierCeNet(produitCeNet, codeActeGestion, donneesInitiales);
...
declare module GestionGeneriqueOffres.Composition {
    class EditiqueControleur {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, modaleService: MyWay.UI.ModalService, contexteGgoStockageService: Services.ContexteGgoStockageService, $location: ng.ILocationService, gestionEditiqueService: Services.GestionEditiqueService, constantes: GestionGeneriqueOffres.Constantes.Definitions);
