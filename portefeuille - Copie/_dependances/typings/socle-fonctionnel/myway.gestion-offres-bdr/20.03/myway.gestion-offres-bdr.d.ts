...
declare module GestionGeneriqueOffres.Services {
    interface ISauvegardeDossierVenteService {
         ...
         */
        sauvegarder(codeActionContexte: string, indicateurs: Constantes.IndicateursDeMiseAJourEPI, executer: boolean, passageContractualisation: boolean, questionDVP?: any, contractualisationActe?: Myway.Ressource.ContractualisationActe.IContractualisationActe, modeSignature?: string, transactionIcg?: string, compteRenduOperationFonctionnelle?: Types.DossierDeVente.CompteRenduOperationFonctionnelle, indicateurEnvoiMail?: string, indicateurExemplairePapier?: string, modeEnvoiDocumentPapier?: string, indicateurImpressionEffectuee?: string, isLiassePMNonSigne?: boolean, liasseEncours?: GGOCommunEpi.Modele.ILiasse, listeLiasses?: GGOCommunEpi.Modele.IDossierSignature, codeRetourAppliExterne?: string, valeurReponseAppliExterne?: string, indicateurBlocageFinalisation?: string, indicateurExecutionImmediate?: string, indicateurGestionPiece?: string): ng.IPromise<Types.DossierDeVente.GestionDossierVente>;
    }
    ...
    class SauvegardeDossierVenteService implements ISauvegardeDossierVenteService {
         ...
         */
        modifierDossierVenteCeNet(identifiantPersonneContrat: number, codeTypeProduitService: string, idExterneDossierVente: string, libelleResume: string, typeAction?: GestionGeneriqueOffres.Enums.Rest.TypeActionDossierVente): ng.IPromise<void>;
        /**
         ...
         */
        private alimenterGestionDossierVentePourRest(authInfo, identifiantDossierVente, numeroEntiteTitulaire);
        /**
...
declare module GestionGeneriqueOffres.Types {
    ...
    class Action {
        ...
        classeBouton: string;
        private ngKeyDown(event);
        private ngKeyUp(event);
        private _ngClick;
        /**
