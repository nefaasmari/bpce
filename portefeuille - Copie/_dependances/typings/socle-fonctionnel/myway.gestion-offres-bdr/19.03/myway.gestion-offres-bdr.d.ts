...
declare module GestionGeneriqueOffres.Services {
    class GestionEditiqueService {
         ...
         * @return {ng.IPromise}
         */
        verifierEligibiliteComplet: (donneesSignerContrat?: Types.IFormulaireAuthentification, acteSecondaire?: any, listeLiasse?: any, listeSignataire?: myway.comContract.modeles.ISignataireComplet[]) => ng.IPromise<void>;
...
declare module GestionGeneriqueOffres.Services {
    ...
    class SauvegardeDossierVenteService implements ISauvegardeDossierVenteService {
        ...
        /**
         * Préparer le dossier de vente pour les PMs
         */
        private preparerDVPM;
        /**
...
declare module GestionGeneriqueOffres.Services {
    ...
    class SauvegardeContexteService implements ISauvegardeContexteService {
         ...
         * @returns {ng.IPromise} promise
         */
        sauvegarderContexteEditique(typeProfessionnel?: string): ng.IPromise<{}>;
...
declare module GestionGeneriqueOffres.Services {
    ...
    class ValidationFormulaireService implements IValidationFormulaireService {
         ...
         */
        validerComposition: () => void;
        preparerDonneesCreerLiasse: () => void;
...
declare module GestionGeneriqueOffres.Composition {
    class CompteRenduControleur {
        ...
        private listeLiasse;
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $timeout: ng.ITimeoutService, contexteGgoStockageService: Services.ContexteGgoStockageService, sauvegardeDossierVenteService: Services.SauvegardeDossierVenteService, messagesService: Services.MessagesService, $location: ng.ILocationService);
        /**
         * Permet de rafraîchir la synthèse NSDK avec la nouvelle offre souscrite
         */
...
declare module GestionGeneriqueOffres.Composition {
    ...
    class RecapControleur {
        ...
        constructor($scope: ng.IScope, $rootScope: ng.IRootScopeService, $timeout: ng.ITimeoutService, $location: ng.ILocationService, $anchorScroll: ng.IAnchorScrollService, $q: ng.IQService, donneesInitiales: Types.DonneesInitiales, actionsService: Services.ActionsService, constantes: GestionGeneriqueOffres.Constantes.Definitions, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, gestionEditiqueService: Services.GestionEditiqueService, sauvegardeContexteService: Services.ISauvegardeContexteService, modalService: MyWay.UI.IModalService, donneesMiseEnGestionService: Services.IDonneesMiseEnGestionService, compositionOffreService: Services.CompositionOffreService, servicesAuthentification: GestionGeneriqueOffres.Services.AuthentificationService, entiteTitulaireBdrService: Services.IEntiteTitulaireBdrService, codeTypeProduitServicePrincipalOffre: Types.CodeTypeProduitServicePrincipalOffre, signataireService: Services.SignatairesService, liasseService: Services.LiassePmService);
...
declare module GestionGeneriqueOffres.Services {
    interface ILiassePmServiceService {
        listeLiasse: Array<Types.CompositionOffreProduit>;
        listeActeGestionEligibilitePM: Array<any>;
        creerLiasse(contexteGGO: Types.ContexteGgo, donneesInitiales?: Types.DonneesInitiales, descendantsP?: Types.CompositionOffreProduit): void;
    ...
    class LiassePmService implements ILiassePmServiceService {
        private $q;
        private $timeout;
        private serviceAgentExtended;
        private compositionOffreService;
        ...
        private actionsService;
        private enveloppeOffreService;
        static liassePmServiceId: string;
        _listeLiasse: Array<Types.CompositionOffreProduit>;
        _listeActeGestionEligibilitePM: Array<any>;
        private _compositionOffre;
        private _numeroEntiteTitulaire;
        static URL_CLIENT: string;
        static URL_DOCUMENTPARAMETRE: string;
        promises: MyWay.Services.IPromesse<any>[];
        promisesNombreLiasse: MyWay.Services.IPromesse<any>[];
        listePromisesIndex: Array<any>;
        private _offreDonnees;
        static $inject: string[];
        constructor($q: ng.IQService, $timeout: ng.ITimeoutService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, compositionOffreService: Services.CompositionOffreService, signataireService: Services.SignatairesService, servicesAuthentification: GestionGeneriqueOffres.Services.AuthentificationService, entiteTitulaireBdrService: Services.IEntiteTitulaireBdrService, codeTypeProduitServicePrincipalOffre: Types.CodeTypeProduitServicePrincipalOffre, constantes: GestionGeneriqueOffres.Constantes.Definitions, offreDonneesService: Services.IOffreDonneesService, actionsService: Services.ActionsService, enveloppeOffreService: Services.IEnveloppeOffreService);
        getClient(codeEtablissement: string, idPersonne: number, typeCompositionRelation: string, indexLiasse: number): ng.IPromise<GestionGeneriqueOffres.Types.ITiers>;
        getDocumentParametre(listeActes: Array<string>, codeCanal: string, codeModeMiseGestion: string, codeTypeMarcheDocumentEntreprise: string): ng.IPromise<GestionGeneriqueOffres.Types.IDocumentParametre>;
        listeLiasse: Array<Types.CompositionOffreProduit>;
        listeActeGestionEligibilitePM: Array<any>;
        private callServiceRest(params, methode, url, idService, important, indexLiasse?);
        creerLiasse: (contexteGGO: Types.ContexteGgo, donneesInitiales?: Types.DonneesInitiales, descendantsP?: Types.CompositionOffreProduit) => void;
        filtrerLiasse: (donneesInitiales: Types.DonneesInitiales, debranchementLisa?: number) => void;
        isActeGestionExiste: (liasse: Types.CompositionOffreProduit) => boolean;
        ajouterSignataire: (indexLiasse: number) => myway.comContract.modeles.ISignataireComplet[];
        getNombreLiasse: (donneesInitiales: Types.DonneesInitiales, debranchementLisa?: number) => void;
        getDonneesEligibilite: (donneesInitiales: Types.DonneesInitiales, produitService: any) => myway.comContract.ContractualisationActe.Modeles.IActe;
        getDonneesProduitsServices: (donneesInitiales: Types.DonneesInitiales) => Composition.IDonneesEligibiliteProduits;
    }
}
...
declare module GestionGeneriqueOffres.Constantes {
    ...
    class LisaConfig {
        ...
        static DEBRANCHEMENT_COMPO_ELGB_SIGN_PM: number;
        static DEBRANCHEMENT_ELGB_SIGN_PM_AUTHENTIFICATION: number;
        static DEBRANCHEMENT_RECAP_ELGB_SIGN_PM: number;
        static DEBRANCHEMENT_CPT_RENDU_ELGB_SIGN_PM: number;
    ...
    class Contexte {
         ...
         */
        static LISTE_LIASSE_PM: string;
        /**
         * Contexte DONNEES_SIGNER_CONTRAT  pour les PM
         */
        static CONTEXTE_DONNEES_SIGNER_CONTRAT: string;
        /**
         * Indicateur si on réedite les documents en AV
         */
        static CONTEXTE_IS_EDITIQUE_REEDITION: string;
    }
