...
declare module GestionGeneriqueOffres.Services {
    ...
    class EnveloppeOffreAjaxImplService implements IEnveloppeOffreService {
         ...
         */
        private url();
        private dedoublonnerListeEnveloppesOffreProduitService(listeEnveloppesOffreProduitService);
    }
...
declare module GestionGeneriqueOffres.Services {
    interface IProcurationService {
        ...
        getPersonnesLieesEligiblesPortCarte(catalogue: Types.CatalogueSouscriptionAvenant): ng.IPromise<Types.Tiers.IProcuration[]>;
        personnesLieesEligiblesPortCarte: Types.Tiers.Procuration[];
    }
    class ProcurationService implements IProcurationService {
        ...
        private tiersParticulierInformationService;
        private lienInterlocuteurService;
        procuration: Types.Tiers.Procuration[];
        personnesLieesEligiblesPortCarte: Types.Tiers.Procuration[];
        static procurationServiceId: string;
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, constantes: GestionGeneriqueOffres.Constantes.Definitions, contexteGgoStockageService: Services.IContexteGgoStockageService, tiersService: Services.ITiersService, procurationService: Services.ITiersProcurationService, tiersParticulierInformationService: Services.ITiersParticulierInformationService, lienInterlocuteurService: Services.ILienInterlocuteurService);
        getProcuration(identifiantPersonne: number): ng.IPromise<Types.Tiers.Procuration[]>;
        getPersonnesLieesEligiblesPortCarte(catalogue: Types.CatalogueSouscriptionAvenant): ng.IPromise<Types.Tiers.Procuration[]>;
        /**
         * Détecte si une personne identifiée par identifiantPersonneAVerifier est ajoutable à la liste listePersonnesEligibles (retourne true si la personne n'est pas déjà présente dans la liste).
         * @param identifiantPersonneAVerifier
         * @param listePersonnesEligibles
         */
        private estAjoutableDansListePersonnesEligiblesPorteursCarte(identifiantPersonneAVerifier, listePersonnesEligibles, infosInterlocuteurs);
        /**
         * Valorise un objet de type IProcuration à partir des paramètres founris en entrée de la méthode.
         * @param codeEtablissement
         * @param identifiantPersonne
         * @param caracteristiqueProduit
         */
        private valoriserProcuration(codeEtablissement, identifiantPersonne, caracteristiqueProduit);
    }
}

declare module GestionGeneriqueOffres.Services {
    interface ILienInterlocuteurService {
        getLienEtInterlocuteur(personne: Types.Tiers.Personne): ng.IPromise<any>;
        lienInterlocuteur: Types.Tiers.Procuration[];
        getInterlocuteursListe(identifiantPersonne: number): ng.IPromise<Types.TiersCorporate.IInterlocuteur>;
    }
    interface ILienEnRejet {
        identifiantPersonne: number;
        typeLien: string;
    }
    class LienInterlocuteurService implements ILienInterlocuteurService {
        private $q;
        private serviceAgentExtended;
        private interlocuteurListeService;
        static lienInterlocuteurServiceId: string;
        private listeLien;
        private listeLiensInterlocuteur;
        private _dateDebutValiditeDefaut;
        private _dateFinValiditeDefaut;
        private _codeEtablissement;
        private listeLiensRejets;
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, interlocuteurListeService: Services.Rest.TiersCorporate.IInterlocuteurListeRestService);
        /**
         *
         * @param personne
         */
        ...
        lienInterlocuteur: Types.Tiers.Procuration[];
        /**
         * Accès au service rest interloucteurListe
         * @param identifiantPersonne
         */
        getInterlocuteursListe(identifiantPersonne: number): ng.IPromise<Types.TiersCorporate.IInterlocuteur>;
        /**
         * Enrichit la liste des liens en y ajoutant un objet Procuration construit à partir des données fournies en paramètre OU enrichit la liste des liens en situation de rejet
         * @param identifiant
         * @param nom
         * @param dateDebutValidite
         * @param dateFinValidite
         */
        private traiterListePorteursPotentiels(identifiant, nom, dateDebutValidite, dateFinValidite, typeLien);
        /**
         * Ajoute un nouveau lien de porteur de carte potentiel à la liste correspondante, s'il ne s'y trouve pas déjà.
         * @param lien
         */
        private ajouterNouveauLienPorteurCarte(lien);
        /**
         * Indique si les paramètres en entrée correspondent à un lien déjà rejeté par le traitement
         * @param identifiant
         * @param typeLien
         */
        private lienTrouveDansRejets(identifiant, typeLien);
        /**
         * Ajoute un nouveau lien en rejet à la liste des rejets s'il ne s'y trouve pas déjà
         * @param identifiant
         * @param typeLien
         */
        private ajouterNouveauLienEnRejet(identifiant, typeLien);
        /**
         * Construit un objet Procuration à minima à partir des quelques données fournies en paramètre
         * @param identifiantPersonne
         * @param nomFamille
         * @param dateDebutEffet
         * @param dateFinEffet
         */
        private creerObjetProcurationAMinima(identifiantPersonne, nomFamille, dateDebutEffet, dateFinEffet);
        /**
         * Ajoute si besoin une occurrence correspondant au titulaire à la liste des liens
         * @param identifiantTitulaire
         * @param nomTitulaire
         */
        private completerListeLiensAvecTitulaire(identifiantTitulaire, nomTitulaire);
        /**
         * Indique si la date de début est conforme fonctionnellement (càd <= à la date du jour)
         * @param date
         */
        private dateDebutEstConforme(date);
        /**
         * Indique si la date de fin est conforme fonctionnellement (càd >= à date du jour)
         * @param date
         */
        private dateFinEstConforme(date);
    }
}
...
declare module GestionGeneriqueOffres.Services {
    ...
    interface ICatalogueService {
         ...
         */
        sendGetRequest(data: ICatalogueGetCatalogueQuery, contexteGgo: Types.ContexteGgo): ng.IPromise<Types.CatalogueNode>;
        /**
    ...
    class CatalogueAjaxImplService implements ICatalogueService {
         ...
         * @return Une promesse contenant la réponse du web service
         */
        sendGetRequest(query: ICatalogueGetCatalogueQuery, contexteGgo: Types.ContexteGgo): ng.IPromise<Types.CatalogueNode>;
        modifierPorteursCartesCatalogue(catalogue: Types.CatalogueSouscriptionAvenant, numeroPersonneIdentifiee: number): Types.CatalogueSouscriptionAvenant;
        recupererProduitsCartes(node: Types.CatalogueSouscriptionAvenant): Types.Produit[];
        /**
         * Renvoie un tableau de produits avec leurs références contrat
         * En souscription ce tableau contient les P/S repris
         * En avenant ce tableau contient les P/S de l'offre
...
declare module GestionGeneriqueOffres.Services {
    ...
    class GestionEditiqueService {
         ...
         */
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, constantes: GestionGeneriqueOffres.Constantes.Definitions, contractualisationActeService: myway.comContract.Services.ContractualisationActeService, contexteGgoStockageService: Services.ContexteGgoStockageService, entiteTitulaireBdrService: Services.IEntiteTitulaireBdrService, signataireService: Services.SignatairesService, compositionOffreService: Services.ICompositionOffreService, catalogueService: Services.ICatalogueService, codeTypeProduitServicePrincipalOffre: Types.CodeTypeProduitServicePrincipalOffre, liasseService: Services.LiasseService);
        /**
         * TODO
         * @param {void}
         * @return {ng.IPromise}
         ...
         * @return {ng.IPromise}
         */
        verifierEligibiliteComplet(donneesSignerContrat?: Types.Authentification.IFormulaireAuthentification, acteSecondaire?: any, listeLiasse?: any, listeSignataire?: myway.comContract.modeles.ISignataireComplet[], reeditionContratOuverture?: boolean): ng.IPromise<void>;
        getDonneesEligibilite(reeditionContratOuverture?: boolean): myway.comContract.ContractualisationActe.Modeles.IActe;
...
declare module GestionGeneriqueOffres.Services {
    ...
    class SauvegardeDossierVenteService implements ISauvegardeDossierVenteService {
        ...
        /**
         *  Permet de consommer la ressource dossierNumerique en mode DELETE.
         * @param {annulationDossier: Myway.Ressource.DossierNumerique.IAnnulationDossier}
         * @returns {ng.IPromise<MyWay.Contractualisation.Ressources.DossierNumerique.IDossierNumerique>}.
         */
         ...
         * @returns {ng.IPromise<MyWay.Contractualisation.Ressources.DossierNumerique.IDossierNumerique>}.
         */
        postCancelTransactionWithQstn(cancelTransactionInput: Myway.Ressource.DossierNumerique.ICancelTransactionInput): ng.IPromise<Myway.Ressource.DossierNumerique.ICancelTransactionOutput>;
        deleteTransactionIcg(idTransactionIcg: string, idPersonne: number): ng.IPromise<boolean>;
        /**
        ...
        private initialiserIdentifiantsOccurence;
        /**
        ...
        private ajouterIdDossierCeNet(compoDV, idDossierCeNet);
        /**
         * Teste l'existence d'une compositionDetail donnée dans la liste des compositions (true : déjà existence; false : inexistante)
         * @param listeCompositionDonneeDetail
         * @param referenceExterneRecherchee
         */
        private testerExistenceCompositionDetail(listeCompositionDonneeDetail, referenceExterneRecherchee);
        /**
         ...
         * S'il existe, on modifie son état à partir du paramètre typeAction
         * Si il y a eu tentative de mise à jour on retourne true, false sinon.
         */
        modifierDossierVenteCeNet(identifiantPersonneContrat: number, codeTypeProduitService: string, idExterneDossierVente: string, libelleResume: string, isDeployeMySign: boolean, typeAction?: GestionGeneriqueOffres.Enums.Rest.TypeActionDossierVente): ng.IPromise<boolean>;
        /**
         * Indique si la modification du Dossier de Vente CeNet est permise (true => permise)
         * @param identifiantPersonneContrat
         * @param codeTypeProduitService
         * @param idExterneDossierVente
         * @param libelleResume
         */
        private donneesPermettentModificationDossierVente(identifiantPersonneContrat, codeTypeProduitService, idExterneDossierVente, libelleResume);
        /**
         * Détermine le type d'action à appliquer au dossier de vente. Si une action précise est transmise, elle est conservée et retournée en l'état. Sinon on annule le dossier CeNet concerné.
         * @param codeTypeProduitService
         * @param typeAction
         */
        private determinerTypeActionSurDossierVente(codeTypeProduitService, typeAction?);
        /**
         * Indique si la modification du dossier passé en paramètre est autorisée - dépend de la compatibilité type d'action-dossier (true => mise à jour autorisée)
         * @param typeAction
         * @param dossier
         */
        private etatDossierVenteCompatiblePourModification(typeAction, dossier);
        private mettreAJourDossierViaRest(typeAction, dossier, isDeployeMySign);
        /**
         * Procède à l'abandon/clôture du dossier dans l'application IDN
         * @param authInfo
         * @param typeAction
         * @param dossier
         */
        private procederAbandonDossier(authInfo, typeAction, dossier, isDeployeMySign);
        /**
         * Modifie le dossier dans l'application Dossier de Vente
         * @param typeAction
         * @param dossierVenteAModifier
         */
        private modifierDossierDansDossierDeVente(authInfo, typeAction, dossierConcerne);
        /**
         * Abandon de la signature électronique dans IDN suite à une annulation ou clôture du Dossier de vente CeNet.
         * @param typeAction
         * @param codeEtablissement
         * @param identifiantTransactionContract
         * @param identifiantDocumentNumerise
         */
        private abandonnerSignatureElectroniqueDansIdn(typeAction, codeEtablissement, identifiantTransactionContract, identifiantDocumentNumerise, identifiantPersonneContrat, isDeployeMySign);
        /**
         * Indique si les paramètres sont correctement renseignés et permettent l'abanadon de la signature électronique dans IDN (true => corrects)
         * @param typeAction
         * @param codeEtablissement
         * @param identifiantTransactionContract
         * @param identifiantDocumentNumerise
         */
        private parametresCorrectsPourAbandonSignature(typeAction, codeEtablissement, identifiantDocumentNumerise, identifiantPersonneContrat);
        /**
         * Restitue un objet de type GestionDossierVenteGetDossierVenteQuery à partir des paramètres fournis en entrée.
         * @param authInfo
         * @param identifiantDossierVente
         */
        private alimenterObjetQueryPourGetDossierVente(authInfo, identifiantDossierVente);
        /**
         * Restitue un objet de type GestionDossierVente à partir des paramètres fournis en entrée.
         * @param authInfo
         * @param identifiantDossierVente
         * @param numeroEntiteTitulaire
         */
        private alimenterGestionDossierVentePourRest(authInfo, identifiantDossierVente, numeroEntiteTitulaire, typeAction?);
        /**
         * Recherche dans historique, le dernier dossier (quel que soit son état => qu'il soit à l'état terminé ou non), à partir du libellé transmis en paramètre.
         * @param historique
         * @param libelleAChercher
         */
        private rechercherDossierDansHistorique(historique, idExterne, libelleAChercher);
        private rechercherHistoriqueDossierCeNet(identifiantPersonneContrat);
        rechercherDernierDossierCeNet(identifiantPersonneContrat: number, idDossierVenteCeNet?: string): ng.IPromise<Types.HistoriqueDossier.IListeDossier>;
        getMessageResultatModificationDossierVenteCeNet(): string;
    }
}
...
declare module GestionGeneriqueOffres.Services {
    interface ISauvegardeContexteService {
        ...
        sauvegarderContexteDomilisPro(produitService: Types.CompositionOffreProduit): ng.IPromise<any>;
    ...
    interface IContratEntreeDomilisPro {
        sigle: string;
        domTrans: string;
        codeEtablissement: string;
        guichet: string;
        numeroPersonne: string;
        identifiantEDSDomiciliationEntiteTitulaire: string;
        identifiantEDSGestionEntiteTitulaire: string;
    ...
    interface IContratStockeGed {
        idGed: string;
        codeNature: string;
    }
    interface ISvgContexte {
        contexteGgoGgho: GestionGeneriqueOffres.Types.IContexteGgho;
        isTreated: boolean;
    }
    class SauvegardeContexteService implements ISauvegardeContexteService {
        ...
        private dossierNumeriqueConsultationIdnRestService;
        static sauvegardeContexteServiceId: string;
        compteSupport: any;
        listeLiasse: GGOCommunEpi.Modele.IDossierSignature;
        ...
        private determinerAutorisationSignatureDansCeNet();
        /**
         * @ngdoc method
        ...
        sauvegarderContexteDomilisPro(produitService: Types.CompositionOffreProduit): ng.IPromise<void>;
        formatterCodesBancaires(numeroDeCompte: string, codeGuichet: string, codeEtablissement: string): string;
        sauvegarderContexteGGHO(produit: Types.CompositionOffreProduit, param: IParametreGGHO): ng.IPromise<{}>;
        sauvegarderContexteGghoEpi(param: IParametreGGHO): ng.IPromise<void>;
        /**
         * @ngdoc method
         ...
         */
        lancerSPAEditique(modeReedition?: boolean, isSignatureElectronique?: boolean): void;
        getListeContexteGgHoEpi(): Array<ISvgContexte>;
        private traiterContextGgoGgho();
        /**
         * @ngdoc method
         ...
         * @returns {ng.IPromise} promise
         */
        sauvegarderContexteEditique(typeProfessionnel?: string, reeditionContratOuverture?: boolean): ng.IPromise<any>;
        private construireQueryEnveloppeOffreContexte;
        /**
         * On fait un peu de mapping pour fournir a la ressource quelque chose sans les n° d'entité/personne pour recherche.
         * On en profite pour patcher les modeTraitementProduitService incorrectement positionnés à 2 pour les produits
        ...
        private balayerTousProduitsServices;
        private construireQueryEnveloppeOffreContenuEtReference;
        getEnveloppeOffre: () => ng.IPromise<Types.IEnveloppeOffreReponse>;
        private supprimerEspaces;
        getListeProduitsServices(pCompositionOffre?: Types.CompositionOffre, pCodeSousFamilleActeDeGestion?: string, pCodeGuichet?: string): GestionGeneriqueOffres.Types.IContexteProduitService[];
        ...
        private traitementProduitService(descendant, pCodeSousFamilleActeDeGestion?);
        private constructionProduitService(descendant, etatDuProduit, pCodeGuichet?);
        constructionContexteContractualisation(refProduit?: string, typeProfessionnel?: string, reeditionContratOuverture?: boolean): Myway.Ressource.ContractualisationActe.IContractualisationActe;
        ...
        determinerApplicationAppelante(typeClient: string): string;
        getListeContratCarte(contexteGgho: GestionGeneriqueOffres.Types.IContexteGgho, listeCodeSituationFamiliale: Types.DonneesDelocalisees.CodeSituationFamiliale[], listeCodeCivilite: Types.DonneesDelocalisees.CodeCivilite[], listePaysNationalite: Types.DonneesDelocalisees.PaysNationalite[], personne: Types.Tiers.IParticulierInformation, libelleLongCarte: string): Types.IContratCarte[];
    }
}
...
declare module GestionGeneriqueOffres.Services {
    ...
    class ValidationFormulaireService implements IValidationFormulaireService {
        ...
        private enveloppeOffreService;
        private offreDonneesService;
        private offreRechercheService;
        private oppositionInfoOppositionRestService;
        private contractualisationActeService;
        private documentFiltreRestService;
        private composition;
        private contexte;
        ...
        getEnveloppeOffre(): ng.IPromise<any>;
        getCompositionOffre(): Types.CompositionOffre;
        recupererDocumentsGED(attributaire: Types.Document.IAttributaire, codeTypeStockage: string, codeEtablissement: string): ng.IPromise<Types.Document.IFiltrerDocumentOutput>;
        private miseAJourEtatOffre(etatOffre);
        private recupererEtatOffre();
        private creerOpposition(oppoACreer);
        ...
        private verifierProduitsServicesModifiesDEIPro(compositionOffre, codeSousFamilleActeDeGestion);
        /**
         * Cette fonction permet de détecter la gestion d'un P/S quelconque en Ouverture / AV dans le panier
         * et retourne TRUE dans ce cas précis et FALSE si il n'y a aucun P/S en Ouverture / AV dans le panier
         */
        private confirmerPresencePSDansPanier(compositionOffre, codeSousFamilleActeDeGestion, codeProduitService);
        produitEstSupportOffrePro: (codeProduitService: string) => boolean;
        /**
         * Cette fonction permet de détecter la gestion d'un service Domilis en Ouverture / AV dans le panier
         * et retourne TRUE dans ce cas précis et FALSE si il n'y a aucun service Découvert en Ouverture / AV dans le panier
         */
        private confirmerGestionDomilisDansPanier(compositionOffre, codeSousFamilleActeDeGestion);
        /**
         * Cette fonction permet de détecter la gestion d'un service Internet Pro dans le panier
         * et retourne TRUE dans ce cas précis et FALSE si il n'y a aucun service internet Pro dans le panier
         */
        private confirmerInternetProDansPanierOU(compositionOffre);
        private confirmerInternetProDansPanierAV();
        /**
        ...
        validerComposition(): void;
        /**
         * Réédition du contrat d'ouverture
         */
        reediterContratOuverture(avecControle: boolean, dateOuvertureOffre: any): ng.IPromise<Types.Reedition>;
...
declare module GestionGeneriqueOffres.Utilitaires {
    ...
    class Utils {
         ...
         * 131350008004123456789 ==> 13135-00080-04123456789 si non spécifié par [sansEtabNiGuichet]
         * 131350008004123456789 ==> 04123456789 si spécifié par [sansEtabNiGuichet]
         * @param [numeroCompte] le n° de compte non formatté
         * @param [sansEtabNiGuichet] enlève le code établissement et le code guichet du n° de compte non formatté
         * @return le n° de compte formatté, vide si le numéro de compte = INDEFINI, inchangé si longueur < 10 caractères en entrée.
         */
        static formatterNumeroCompte(numeroCompte: string, sansEtabNiGuichet?: boolean): string;
...
declare module GestionGeneriqueOffres.Services {
    ...
    class ChargementFichiersComposantService implements IChargementFichiersComposantService {
         ...
         */
        private traiterNiveauDePrioriteDeChargement(index, defer);
...
declare module GestionGeneriqueOffres.Services {
    ...
    class DonneesInitialesService implements IDonneesInitialesService {
        ...
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, constantes: GestionGeneriqueOffres.Constantes.Definitions, progressionChargement: Types.ProgressionChargement, contexteGgoService: Services.ContexteGgoService, contexteGgoStockageService: Services.ContexteGgoStockageService, entiteTitulaireBdrService: Services.IEntiteTitulaireBdrService, tiersService: Services.TiersService, catalogueService: Services.ICatalogueService, parametrageBlocsService: Services.IParametrageBlocsService, offreDonneesService: Services.OffreDonneesService, chargementFichiersComposantService: Services.ChargementFichiersComposantService, procurationService: Services.IProcurationService, lienInterlocuteurService: Services.ILienInterlocuteurService);
        get(): ng.IPromise<Types.DonneesInitiales>;
        private terminerTraitementEnErreur(message);
        /**
         * Chargement catalogue offre (appel de la ressource souscription / avenant
         */
        private traiterCatalogue(codeActeGestionPrincipal, identifiantProduitServiceOffre, contexteGgo, entitesTitulaires);
        /**
         * Chargement de toutes les personnes qui figurent dans la composition des entités passées en paramètre
         */
        private traiterPersonnesEtParametrage(contexteGgo, entitesTitulaires);
        private traiterPersonnesEtParametrageWrapper(entitesTitulaires);
        private traiterProcuration(personnes);
        private traiterPersonnesLieesEligiblesPortCarte(catalogue);
        private traiterProcurationWrapper(personnes);
        private traiterPersonnesLieesEligiblesPortCarteWrapper(catalogue);
        private chargerLiensEtInterlocuteur(personnes);
        private determinerTypeClientTitulaire(personnes);
        private traiterCatalogueWrapper(data);
        /**
         * Traitement des entités titulaires. On passe au traitement des personnes une fois que toutes les
         * entités sont chargées.
         */
        private traiterEntitesTitulaires(contexteGgo, entites);
        private traiterEntitesTitulairesWrapper(contexteGgo);
...
declare module GestionGeneriqueOffres.Composition {
    class CompoControleur {
        ...
        ajouterBoutonReeditionContratOuverture(): void;
        afficherListeSignataires: boolean;
    }
}
...
declare module GestionGeneriqueOffres.Composition {
    ...
    class DefautModaleControleur {
        ...
        private estModalePorteursCartes;
        private liste;
        ...
        private basculerEtatCoches(items);
    }
}
...
declare module GestionGeneriqueOffres.Page.Erreur {
    class ValeurContexte {
        label: string;
        aCode: boolean;
        code: string;
        aLibelle: boolean;
        ...
        valeur: string;
        constructor();
        static newCodeLibelle(label: string, code: any, libelle: any): ValeurContexte;
        static newCode(label: string, code: any): ValeurContexte;
        static newLibelle(label: string, libelle: any): ValeurContexte;
        calculerValeur(): void;
    }
    class GroupeContexte {
        libelle: string;
        valeurs: ValeurContexte[];
        ...
        ajouterValeur(valeur: ValeurContexte): void;
        getValeur(): string;
    }
    class TableauContexte {
        groupes: GroupeContexte[];
        constructor();
        ajouterGroupe(nomGroupe: string): GroupeContexte;
        ajouterValeur(nomGroupe: string, valeur: ValeurContexte): void;
        getGroupe(nomGroupe: string): GroupeContexte;
    }
    class Guid {
        static newGuid(): Guid;
        static S4(): string;
    ...
    interface IErreur2Scope extends ng.IScope {
        constantes: GestionGeneriqueOffres.Constantes.Definitions;
        source: string;
        message: string;
        cause: any;
    ...
    class Erreur2Controleur {
        ...
        ctx: TableauContexte;
        location: Object;
        currentStepInfo: MyWay.Services.Context.StepInfoExtended;
        test: any;
        contexte: Types.ContexteGgo;
        constructor($scope: IErreur2Scope, $rootScope: ng.IRootScopeService, $location: ng.ILocationService, $http: ng.IHttpService, constantes: GestionGeneriqueOffres.Constantes.Definitions, contexteGgoStockageService: Services.ContexteGgoStockageService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        private analyserStackTrace();
...
declare module GestionGeneriqueOffres.Composition {
    ...
    interface IDonneesConnexesLiasse {
        liasse: GGOCommunEpi.Modele.ILiasse;
        cleContexteEditique: string;
        codeDebranchement: string;
        contexteEditique: GestionGeneriqueOffres.Types.IContexteEditique;
        DvComposition?: Types.DossierDeVente.GestionDossierVente;
        contexteGghoEpi?: GestionGeneriqueOffres.Types.IContexteGgho;
    }
    interface IContextePanierSemd {
        codeEtablissementContrat: string;
        codeGuichetContrat: string;
        identifiantAgence: string;
        entiteTitulaire: GGOCommunEpi.Modele.IEntiteLiasse;
        referenceProduitServiceContrat: string;
        titulaire: number;
        libelleEntete: string;
        listeDonneesConnexesLiasse: Array<IDonneesConnexesLiasse>;
        complementActe: IComplementActe;
    }
    class ErreurModel {
        idService: string;
        message: string;
    ...
    class RecapControleur {
        ...
        private estModePanierSemdActif;
        private reeditionContratOuverture;
        constructor($scope: ng.IScope, $timeout: ng.ITimeoutService, $location: ng.ILocationService, $anchorScroll: ng.IAnchorScrollService, $q: ng.IQService, donneesInitiales: Types.DonneesInitiales, actionsService: Services.ActionsService, constantes: GestionGeneriqueOffres.Constantes.Definitions, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, gestionEditiqueService: Services.GestionEditiqueService, modalService: MyWay.UI.IModalService, compositionOffreService: Services.CompositionOffreService, entiteTitulaireBdrService: Services.IEntiteTitulaireBdrService, signataireService: Services.SignatairesService, liasseService: Services.LiasseService, sauvegardeDossierVenteService: Services.SauvegardeDossierVenteService, messagesService: Services.MessagesService, catalogueService: Services.ICatalogueService, enveloppeOffreService: Services.IEnveloppeOffreService, sauvegardeContexteService: Services.SauvegardeContexteService, tiersParticulierInformationService: Services.ITiersParticulierInformationService, donneesMiseEnGestionService: Services.IDonneesMiseEnGestionService, referenceProduitPrincipalOffre: Types.ReferenceProduitPrincipalOffre, codeTypeProduitServicePrincipalOffre: Types.CodeTypeProduitServicePrincipalOffre, tiersService: Services.ITiersService, contexteGgoStockageService: Services.IContexteGgoStockageService);
        private determinerModePanierParActe(contractualisationActe);
        private miseAJourDossierCenet(isDeployeMySign, modeSemd?);
        private finaliserDossierCeNet(produitCeNet, codeActeGestion, donneesInitiales, idExterneDossierCeNet, isDeployeMySign);
        private cloturerDossierCeNetSemd(produitCeNet, codeActeGestion, donneesInitiales, idExterneDossierCeNet, isDeployeMySign);
        private cloturerDossierCeNet(produitCeNet, codeActeGestion, donneesInitiales, isDeployeMySign);
        poursuivreEditique(reeditionContratOuverture?: boolean): void;
        creerLiasse(estReeditionContratOuverture: boolean): ng.IPromise<void>;
        testerEligibiliteOffrePrincipalePM(): ng.IPromise<void>;
        /**
         * Détermine la valeur qui sera affecté au Lisa.next pour la navigation mode "Panier" ou mode "Classique".
         * @param contractualisationActeLiassePrincipale
         */
        private definirDebranchementLisaApresRecap(contractualisationActeLiassePrincipale);
        /**
         * Méthode récursive dont le rôle est de déterminer si une liasse est éligible au mode "Panier" ou non. A la 1ère liasse non éligible la récursivité s'arrête et l'offre est considérée globalement non éligible au mode "Panier".
         * @param listeLiasses
         * @param indexLiasse
         */
        private determinerEligibilitePanierPourDossierRecursif(listeLiasses, indexLiasse);
        /**
         * Détermine si une liasse donnée est éligible au mode panier SEMD via la méthode verifierEligibiliteReduit (true => liasse éligible au mode "Panier")
         * @param liasse
         */
        private determinerEligibiliteModePannierPourUneLiasse(liasse);
        /**
         * Alimente le contexte nécessaire à la SPA ESignature EPI pour poursuivre le processus Panier SEMD
         */
        private alimenterContextePourCheminPanierSemd();
        /**
         * Alimente les données concernant les liasses tranmsises dans le contexte pour un traitement Panier SEMD
         * @param donneeesAuthentification
         * @param dossierSignature
         * @param catalogue
         * @param enveloppeOffre
         */
        private alimenterListeDonneesConnexesLiasse(donneeesAuthentification, dossierSignature, catalogue, enveloppeOffre);
        private alimenterDonneesConnexesLiasseUnitaire(donneeesAuthentification, dossierSignature, catalogue, enveloppeOffre, liasse, numeroLiasse);
        private traiterContextGghoEpi(promesseContexteEditique);
        private alimenterContexteGgoEditique(donneeesAuthentification, dossierSignature, catalogue, enveloppeOffre, liasse, numeroLiasse);
        private alimenterOffre(dossierSignature, enveloppeOffre, catalogue, liasse);
        private recherchePorteurSolCap(contexte, listeSignataire, identifiantClient);
        private getPorteursSolCap(typeSelection, codeEtablissement, identifiantClient, typeEnrolement, typeTraitement, identifiantPersonne);
        private callServiceRest(params, methode, url, idService, important, estAppelePourBapi?);
        private isSolCapPresent(panier);
        private detetrminerNumeroCompte(dossierSignature);
        private alimenterListeContratCarte(dossierSignature, catalogue, liasse);
        private determinerDebranchementEditiqueModePanierSemd(donneesConnexesLiasse);
        private alimenterComplementActe(dossierSignature, reeditionContratOuverture?);
...
declare module GestionGeneriqueOffres.Services {
    interface IDossierNumeriqueConsultationIdnRestService {
        recupererListeDocumentsActeIdn(param: Types.DossierNumerique.ConsultationIdn.IDossierNumeriqueConsultationIdnRecupererDocumentsIdnQuery): ng.IPromise<Types.DossierNumerique.ConsultationIdn.IRecupererDocumentsIdnOutput>;
        recupererInfosDossierNumeriqueV3(parametres: Types.DossierNumeriqueV3.DossierNumerique.IDossierNumeriqueGetDossierNumeriqueQuery): ng.IPromise<Types.DossierNumeriqueV3.DossierNumerique.IDossierNumerique>;
    }
    /**
     * Classe permettant d'effectuer la communication avec la ressource dossiernumerique.
     */
    class DossierNumeriqueConsultationIdnRestService implements IDossierNumeriqueConsultationIdnRestService {
        private serviceAgentExtended;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        /**
         * Méthode de restitution des documents associés à un acte IDN
         * @param {Types.DossierNumerique.ConsultationIdn.IDossierNumeriqueConsultationIdnQuery} parametres : Les données à passer en entrée de la ressource
         */
        recupererListeDocumentsActeIdn(parametres: Types.DossierNumerique.ConsultationIdn.IDossierNumeriqueConsultationIdnRecupererDocumentsIdnQuery): ng.IPromise<Types.DossierNumerique.ConsultationIdn.IRecupererDocumentsIdnOutput>;
        recupererInfosDossierNumeriqueV3(parametres: Types.DossierNumeriqueV3.DossierNumerique.IDossierNumeriqueGetDossierNumeriqueQuery): ng.IPromise<Types.DossierNumeriqueV3.DossierNumerique.IDossierNumerique>;
    }
}
...
declare module GestionGeneriqueOffres.Services {
    class DossierNumeriqueRequestFactory {
        ...
        private cancelTransactionInput;
        private listeParametreQuery;
        constructor(methode: MyWay.Services.MethodEnum, dossierNumerique: Myway.Ressource.DossierNumerique.IDossierNumerique, annulationDossier: Myway.Ressource.DossierNumerique.IAnnulationDossier, cancelTransactionInput: Myway.Ressource.DossierNumerique.ICancelTransactionInput, listeParametreQuery?: any);
...
declare module GestionGeneriqueOffres.Services {
    ...
    class ActeFactory {
        ...
        createActeFromContractualisationActeV3(identifiantIDN: string, identifiantDossierVente: number): Myway.Ressource.DossierNumerique.V3.IActe;
    }
}
...
declare module GestionGeneriqueOffres.Services {
    interface ILiasseService {
        ...
        listeLiasse: Array<GGOCommunEpi.Modele.ILiasse>;
        /**
         ...
         */
        preparerLiasseV2(donneesInitiales: Types.DonneesInitiales, estReeditionContratOuverture?: boolean): ng.IPromise<boolean>;
    ...
    class LiasseService implements ILiasseService {
        ...
        _listeLiasse: Array<GGOCommunEpi.Modele.ILiasse>;
        private _compositionOffre;
        private _typeProfessionnel;
        private _numeroEntiteTitulaire;
        ...
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, compositionOffreService: Services.CompositionOffreService, signataireService: Services.SignatairesService, servicesAuthentification: GGOCommunEpi.Services.AuthentificationService, entiteTitulaireBdrService: Services.IEntiteTitulaireBdrService, codeTypeProduitServicePrincipalOffre: Types.CodeTypeProduitServicePrincipalOffre, constantes: GestionGeneriqueOffres.Constantes.Definitions, offreDonneesService: Services.IOffreDonneesService, enveloppeOffreService: Services.IEnveloppeOffreService, donneesMiseEnGestionService: Services.IDonneesMiseEnGestionService, contexteGgoStockageService: Services.ContexteGgoStockageService, dossierNumeriqueConsultationIdnRestService: Services.DossierNumeriqueConsultationIdnRestService);
        ...
        private rechercherContexteCeNet();
        private creerLiasseSupplementaires(listeProduitCompo, donneesInitiales, casReeditionContratOuverture);
        private creerLiasseCarte(produitCarte, donneesInitiales, index);
        private creerLiasseCenet(produitCenet, donneesInitiales, listeAdministrateursCenet, indicateurSignatureCenet, creerDossier, finaliserDossier, isSouscriptionCENET, libelleResume, idExterneCeNet);
        private creerLiasseDomilis(produitDomilis, donneesInitiales);
        private creerLiassePrincipale(donneesInitiales);
        /**
         * Ajout d'un produit/service non annulé à la liste des produits
         * @param produit
         */
        ajouterProduit(produit: Types.CompositionOffreProduit): void;
        ...
        private creerLiasseSecuraccess(donneesSecurAccess, donneesInitiales, solCapIdentifiant);
...
declare module GestionGeneriqueOffres.Services {
    interface IOffreRechercheRestService {
        recupererListeOffres(param: Types.OffreRecherche.IOffreRechercheQuery): ng.IPromise<Types.OffreRecherche.IContainer>;
    }
    /**
     * Classe permettant d'effectuer la communication avec la ressource opposition.
     */
    class OffreRechercheRestService implements IOffreRechercheRestService {
        private serviceAgentExtended;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        /**
         * Méthode de restitution des offres
         * @param {ypes.OffreRecherche.IOffreRechercheQuery} parametres : Les données à passer en entrée de la ressource
         */
        recupererListeOffres(parametres: Types.OffreRecherche.IOffreRechercheQuery): ng.IPromise<Types.OffreRecherche.IContainer>;
        /**
         * Méthode de construction de l'url du web service
         * @author S0080162
         * @return L'url du web service
...
declare module GestionGeneriqueOffres.Services {
    interface IOppositionInfoOppositionRestService {
        creerOpposition(data: Types.Opposition.IInfoOpposition): ng.IPromise<Types.Opposition.IInfoOpposition>;
        leverOpposition(param: Types.Opposition.IOppositionPutQuery, data: Types.Opposition.IInfoOpposition): ng.IPromise<Types.Opposition.IInfoOpposition>;
    }
    /**
     * Classe permettant d'effectuer la communication avec la ressource opposition.
     */
    class OppositionInfoOppositionRestService implements IOppositionInfoOppositionRestService {
        private serviceAgentExtended;
        private qService;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended, qService: ng.IQService);
        /**
         * Méthode de création d'une opposition
         * @param {Types.Opposition.IInfoOpposition} data : Les données à passer en entrée de la ressource
         */
        creerOpposition(objet: Types.Opposition.IInfoOpposition): ng.IPromise<Types.Opposition.IInfoOpposition>;
        /**
         * Méthode de levée d'une opposition
         * @param {Types.Opposition.IInfoOpposition} data : Les données à passer en entrée de la ressource
         */
        leverOpposition(parametres: Types.Opposition.IOppositionPutQuery, objet: Types.Opposition.IInfoOpposition): ng.IPromise<Types.Opposition.IInfoOpposition>;
        /**
         * Méthode de construction de l'url du web service
         * @author S0080162
         * @return L'url du web service
...
declare module GestionGeneriqueOffres.Popup.Information {
    class Input {
    ...
    class Controleur {
        private dataInput;
        svcAngularModal: ng.ui.bootstrap.IModalServiceInstance;
        svcContexte: Services.ContexteGgoService;
        static id: string;
        static serviceAngularModalInstance: string;
        context: any;
        infoData: string;
        infoDataContexte: string;
        nomSPA: string;
        infoBuildSPA: any;
        infoBuildLIB: any;
        $scope: ng.IScope;
        static $inject: string[];
        constructor(dataInput: Input, svcAngularModal: ng.ui.bootstrap.IModalServiceInstance, svcContexte: Services.ContexteGgoService, nomSPA: string);
        actionEnCours: boolean;
        titre: string;
        static getOptions(): ng.ui.bootstrap.IModalSettings;
        RecupContexteGGO(): void;
        private replacer(match, pIndent, pKey, pVal, pEnd);
        private prettyPrint(obj);
        /**
         * Action de fermeture de la popin
         * @returns {void}
         */
        onFermer(): void;
        /**
         * Action d'annulation des modifications de données de la popin
         * @returns {void}
         */
        onAnnuler(): void;
        /**
         * Action de validation des données de la popin
         * @returns {void}
         */
        onValider(): void;
        getMetaName(metaName: string): string;
        readInfoBuild(typeJS: number): void;
    }
}
...
declare module GestionGeneriqueOffres.Types {
    ...
    class Action {
        ...
        classeBouton: string;
        ngKeyDown(event: JQueryKeyEventObject): void;
        ngKeyUp(event: JQueryKeyEventObject): void;
        private _ngClick;
        /**
...
declare module GestionGeneriqueOffres.Types.DossierNumerique {
    class DossierNumeriqueFactory {
        ...
        createAnnulationDossierFromIdDossier(identifiantDossierIdn: string, codeEtablissementFinancier: string, codeApplication: string): Myway.Ressource.DossierNumerique.IAnnulationDossier;
        createCancelTransactionFromIdTransactionIcg(identifiantTransactionIcg: string, codeAction: string): Myway.Ressource.DossierNumerique.ICancelTransactionInput;
        createDossierNumeriqueV3FromContractualisationActe(contractualisationActe: Myway.Ressource.ContractualisationActe.IContractualisationActe, identifiantDossierVente: number, codeEtablissementFinancier: string, codeApplication: string): Myway.Ressource.DossierNumerique.V3.IDossierNumerique;
    }
}
...
declare module GestionGeneriqueOffres.Types {
    interface IReedition {
        /**
         * Indique si la réédition peut-être effectuée sans aucun message informatif ou d'alerte
         */
        reeditionSansAlerte: boolean;
        /**
         * Indique la présence d'une modification du panier en cours
         */
        presenceModifEnCours: boolean;
        /**
         * Indique la présence d'un abonnement CE Net (ou équivalent) dans le panier
         */
        presenceCeNet: boolean;
    }
    class Reedition implements IReedition {
        private _reeditionSansAlerte;
        reeditionSansAlerte: boolean;
        private _presenceModifEnCours;
        presenceModifEnCours: boolean;
        private _presenceCeNet;
        presenceCeNet: boolean;
        constructor(reedition: IReedition);
    }
}
...
declare module GestionGeneriqueOffres.Constantes {
    ...
    module Contexte {
        ...
        /**
         * Contexte Type Client Titulaire Identifié (PM ou EI)
         */
        const TYPE_CLIENT_TITULAIRE: string;
        /**
        ...
        /**
         * Contexte indicateur précisant si la signature électronique du service SOL CAP PRO est bloquée via table SU1P
         */
        const BLOCAGE_SOLCAP_SU1P: string;
        /**
         * Contexte indicateur précisant si la mise en opposition 0828 sur CCE est interdite via table SU1P
         */
        const AUCUNE_OPPO_SU1P: string;
        /**
         * Indicateur précisant si une opposition a été positionnée sur le compte support de l'offre
         */
        const OPPOSITION_BLOCAGE_CCE: string;
        const IDNT_IDN: string;
        const CONTRACTUALISATION_DOMILIS: string;
        /**
         * Indicateur précisant s'il s'agit d'une demande de réédition du contrat d'ouverture offre
         */
        const REEDITION_CONTRAT_OUVERTURE: string;
    }
    ...
    module DossierVente {
        const DOSSIER_FINI: string;
        const DOSSIER_A_ACTIVER: string;
        const DOSSIER_A_SIGNER: string;
        const DOSSIER_A_SIGNER_SEMD: string;
        const DOSSIER_VENTE_FINALISEE: string;
    }
    module CeNet {
        const TYPE_PRODUIT: string;
        const ID_DOSSIER_FACTICE: string;
        const RESUME_DOSSIER_VENTE: string;
        const REFERENCE_RESUME: string;
        const REFERENCE_METIER: string;
    }
    module CodeMotifOpposition {
        const EN_ATTENTE_SIGNATURE: string;
    }
}
...
declare module GestionGeneriqueOffres.Constantes {
    module ClesContexte {
        ...
        const SIGNATURE_AUTORISEE_DANS_CENET: string;
    }
}
...
declare module GestionGeneriqueOffres.Constantes {
    module ContractualisationActeConstants {
        ...
        const CANCEL_TRANSACTION_WITH_QSTNPOST: string;
        const DELETE_TRANSACTION_ICG: string;
        const RESSOURCE_REST_URL_CONSULTATION_IDN: string;
        const RESSOURCE_REST_URL_DOSSIER_NUMERIQUE_V3_GET: string;
    }
...
declare module GestionGeneriqueOffres.Constantes {
    module LisaConfig {
        ...
        const DEPART_COMPO_ARRIVEE_RECAP: number;
        ...
        const DEBRANCHEMENT_SPA_EDITIQUE_HORS_OFFRE_EPI: number;
        ...
        const DEBRANCHEMENT_DOMILIS_PRO: number;
        ...
        const DEBRANCHEMENT_DOMILIS_VALEUR_ACTION: {
            CREATION: string;
            AVENANT: string;
        };
        ...
        const DEBRANCHEMENT_GGHO_EPI: number;
        const EVENEMENT_RETOUR_IFRAME: string;
        const LISTE_DEBRANCHEMENTS_MODE_PANIER_SEMD: {
            debranchement: number;
            codeDebranchement: string;
            cleContexteEditique: string;
        }[];
    }
...
declare module GestionGeneriqueOffres.Enums {
    module Rest {
        enum TypeActionDossierVente {
            ACTIVER,
            ANNULER,
            CLOTURER,
            SIGNER,
...
declare module GestionGeneriqueOffres.Types.Document {
    interface IAttributaire {
        /**
         * CodeTypeAttrb
         */
    ...
    interface IFiltrerDocumentOutput {
        indicateurCompletude: string;
        nombreDocuments: number;
        documents: Array<IDocumentFiltre>;
    }
    interface IDocumentFiltre extends IBaseDocument {
        nomFichier: string;
    ...
    interface IBaseDocument {
        ...
        moyenAcquisitionLibLong: string;
        /**
         * Libellé court
         */
        moyenAcquisitionLib: string;
        /**
         * numérique
         */
        origineAcquisition: string;
        origineAcquisitionLibLong: string;
        /**
         * libellé court
         */
        origineAcquisitionLib: string;
         ...
         * FormatRestitution
         */
        formatRestitution: string;
    }
    interface IPostFiltrerDocumentInput {
        donneesContextuelles: IDonneesContextuelles;
        critereFiltreDocument: ICritereFiltreDocument;
    }
    interface IDonneesContextuelles {
        /**
         * code Etablissement
         */
        codeEtablissement: string;
    ...
    interface ICritereFiltreDocument {
        /**
...
declare module GestionGeneriqueOffres.Types.DonneesDelocalisees {
    type CodeCivilite = {
        Value: string;
        Key: string;
    };
    type CodeSituationFamiliale = {
        Value: string;
        Key: string;
    };
    type PaysNationalite = {
        ...
        codeGroupePays: string;
        typeIdentifiantMIF2: string;
    };
}

declare module GestionGeneriqueOffres.Types.DossierNumerique.ConsultationIdn {
    interface IDossierNumeriqueConsultationIdnRecupererDocumentsIdnQuery {
        /**
         * Identifiant acte IDN
         */
        idActeIdn: string;
        /**
         * Code application: par exemple : "CONTELEC" , "MYWAY"
         */
        codeApplication: string;
    }
    interface IDocumentIdn {
        /**
         * Nom Document IDN
         */
        nomDocument: string;
    ...
    interface IRecupererDocumentsIdnOutput {
        /**
         * Code Retour
         */
        codeRetour: number;
...
declare module GestionGeneriqueOffres.Types.DossierNumeriqueV3.DossierNumerique {
    interface IDossierNumeriqueGetDossierNumeriqueQuery {
        /**
         * Identifiant du dossier numérique
         */
        ...
        codeApplication: string;
        /**
         * A renseigner à true pour récupérer les documents, false sinon
         */
    ...
    interface IActe {
        ...
        etatDossier: string;
        /**
         * estSignatureXML = true si OPC non sensible, false sinon
         */
        estSignatureXml: string;
    }
    ...
    interface IDocument {
        ...
        /**
         * Indicateur Eligibilite Icg
         */
        indicateurEligibiliteIcg: boolean;
        /**
         * Indicateur Restituable
         */
    ...
    interface ISignataire {
        ...
        numUsagerBAD: string;
        /**
         * Enumération permettant de définir le moyen de restitution des documents signés à la personne. Cette données provient de l’éligibilité de la personne (segment de réponse 907, champ ECTEQMR)
         */
        moyenRestitution: string;
        /**
         * Demande de création Secur'Esp@ce
         */
        demandeCreationSecure: boolean;
    }
    ...
    interface IStockageDocument {
        ...
        /**
         * code type attributaire du document. Il correspond à un code défini dans le catalogue GED
         * CONTRAT("Contrat")
         * PERSONNE("Personne")
         * CLIENT_BANCAIRE("ClientBancaire")
         * DOSSIER_VENTE("DossierVente")
         * PROSPECT("Prospect")
         */
    ...
    interface ISignatureEntite {
         ...
         */
        ancreSignature: string;
        /**
         * rang de la signature
         */
        rangSignature: number;
        /**
         * code Etablissement
         */
        codeEtablissement: string;
    ...
    interface IFinDossierVisaInput {
        /**
    ...
    interface IFinDossierVisaOutput {
        /**
         * Identifiant de l'acte IDN
         */
        idActeIdn: string;
...
declare module GestionGeneriqueOffres.Types.HistoriqueDossier {
    ...
    interface IListeDossier {
        ...
        /**
         * Libellé complémentaire pour stocker une référence (ex : référence contrat Ce Net)
         */
        libelleJSONMetierReference: string;
        /**
         * Identifiant document numérisé établi par l'application IDN
         * Format :
         * concaténation des données suivantes :
...
declare module GestionGeneriqueOffres.Types.TiersCorporate {
...
declare module GestionGeneriqueOffres.Types.OffreRecherche {
    interface IOffreRechercheQuery {
        /**
...
declare module GestionGeneriqueOffres.Types.Opposition {
    interface IInfoOpposition {
        codeMotif: string;
        libelleMotif: string;
        /**
         * 'A' : Application
        ...
        indicateurCreationAutomatique?: boolean;
        dateHeureEcritureDB2?: string;
        listeJustificatif: Array<IJustificatif>;
        identifiantPersonne: number;
        designationPersonne: string;
        civilite?: string;
        identifiantEntiteTitulaire?: number;
        compteBancaire: ICompteBancaire;
        infoCreation: IInfoCreation;
        infoModification?: IInfoModification;
        infoSuppression?: IInfoSuppression;
        /**
         * Contient des données spécifiques concaténées selon le code motif oppo.
         * Cf. règle de gestion plus bas.
         */
        zoneSpecifique?: string;
        coffre?: ICoffre;
        virement?: IVirement;
        soldeMinimum?: ISoldeMinimum;
        livret?: ILivret;
        livretConditionnel?: ILivretConditionnel;
        chequeFormule?: IChequeFormule;
        chequePaiement?: IChequePaiement;
        tutelle?: ITutelle;
        tutelleCuratelle?: ITutelleCuratelle;
        prelevementNNE?: IPrelevementNNE;
        prelevementSaufNNE?: IPrelevementSaufNNE;
        prelevementSepa?: IPrelevementSepa;
        prelevementSepaCreancierMandat?: IPrelevementSepaCreancierMandat;
    }
    interface IOppositionPutQuery {
        /**
         * indique si ça concerne une main levée (suppression)
         */
        suppressionRequise: boolean;
        /**
         * indique si la main levée concerne une opposition programmée
         */
        oppositionProgrammee: boolean;
    }
    ...
    interface IInfoCreation {
        dateCreation: string;
        heureCreation: number;
        commentaireCreation: string;
    }
    interface IInfoSuppression {
        dateSuppression: string;
        heureSuppression: number;
        commentaireSuppression: string;
    }
    interface IInfoModification {
        dateModification: string;
        heureModification: number;
    ...
    interface ICoffre {
         ...
         * '5'
         */
        codeEvenementDeclencheurOppo: string;
        /**
         * Perte de clé
         * Vol de clé
         * Perte de carte
         * Vol de carte
         * Effraction du coffre
         */
        libelleEvenementDeclencheurOppo: string;
    }
    interface IVirement {
    ...
    interface ILivret {
        ...
        /**
         * 'O' - avec pièce d'identité ('A')
         * 'N' - sans pièce d'identité ('S')
         */
        indicateurPresencePieceIdentite: boolean;
    }
    interface ILivretConditionnel {
        commentaireSpecifique: string;
    }
    interface IChequeFormule {
        /**
         * 'F'
         * 'P'
         * 'R'
        ...
        /**
         * Indique le numéro du dernier chèque d'un carnet ou d'une série.
         */
        numeroDerniereFormule: number;
    }
    interface IChequePaiement {
        /**
         * 'F'
         * 'P'
         * 'R'
    ...
    interface IPrelevementSepa {
        ...
        /**
         * Pas d'autorisation
         * Contestation du débiteur Résiliation / Révocation
         */
        libelleEvenementDeclencheurOppo: string;
    }
    interface IPrelevementSepaCreancierMandat {
        /**
         * 'A'
         * 'C'
         * 'R'
        ...
        libelleEvenementDeclencheurOppo: string;
        /**
         * Référence d'identification d'un créancier dans le système SEPA. Format pour la France : PPXXZZZEEEEEE PP / Code Pays ISO : FR pour les CE
         * XX / Clé de contrôle
         * ZZZ / code activité
         * EEEEEE / No national émetteur
         */
        identifiantCreancier: string;
        /**
         * Identifie un mandat dans la gestion des opérations SEPA pour un créancier donné
         */
        referenceMandat: string;
    }
    interface ISoldeMinimum {
        solde: number;
        codeMonnaie: string;
    }
    interface IJustificatif {
         ...
         */
        codeActionSurOppo: string;
        /**
         * Code maquette bordereau. Ex. : B_0301 pour la maquette B_0301.docx
         */
        codeMaquetteBorderau: string;
        /**
         * Code maquette bordereau. Ex. : 467 pour la maquette 0301
         */
        codeMaquetteMsi: string;
        /**
         * Indique si le justificatif doit être numérisé et mis dans la GED
         */
        topAcquisitionObligatoire: boolean;
    }
}
...
declare module GestionGeneriqueOffres.Composition {
    ...
    class CompositionController {
        ...
        private procurationService;
        private erreurService;
        private lienEtInterlocuteurService;
        ...
        private estAbonnementCENetCompteOuEquivalent(codePS);
        ...
        /**
         * Retourne, à partir d'une liste fournie en paramètre, l'identifiant de la personne EI trouvée dans la liste.
         * @param listePorteursPotentiels
         */
        private rechercherIdentifiantEI(listePorteursPotentiels);
        /**
         * Filtre une liste fournie en entrée, de sorte à ce qu'elle retourne uniquement l'EI s'il y est présent, ou toute la liste s'il ne s'y trouve pas.
         * @param listeAFiltrer
         */
        private filtrerListeSiEI(listeAFiltrer);
        /**
...
declare module GestionGeneriqueOffres.Composition {
    class EditiqueControleur {
        ...
        private codeRetourEditiqueGGHO;
        private messageRetourEditiqueGGHO;
        private typeProfessionnel;
        private listeLiasses;
        private blocageOppo;
        private contractualisationActe;
        static $inject: string[];
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, modaleService: MyWay.UI.ModalService, contexteGgoStockageService: Services.ContexteGgoStockageService, $location: ng.ILocationService, gestionEditiqueService: Services.GestionEditiqueService, constantes: GestionGeneriqueOffres.Constantes.Definitions, oppositionInfoOppositionRestService: Services.IOppositionInfoOppositionRestService);
        private controlerRetourEditique();
        private updateDocumentsGeneres();
        /**
         * Complète l'objet listeDocumentAProduire de contractualisationActe passé en paramètre
         * @param documentsGeneres
         * @param contractualisationActe
         */
        private completerDocumentsAProduire(documentsGeneres, contractualisationActe);
    }
}
...
declare module GestionGeneriqueOffres.Services.Rest.Document {
    interface IFiltreRestService {
        recupererDocumentsGED(donnees: Types.Document.IPostFiltrerDocumentInput): ng.IPromise<Types.Document.IFiltrerDocumentOutput>;
    }
    /**
     * Classe permettant d'effectuer la communication avec la ressource 'document'.
     */
    class FiltreRestService implements IFiltreRestService {
        private serviceAgentExtended;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        /**
         * Méthode de restitution des documents stockés en GED
         */
        recupererDocumentsGED(donnees: Types.Document.IPostFiltrerDocumentInput): ng.IPromise<Types.Document.IFiltrerDocumentOutput>;
        /**
         * Méthode de construction de l'url du web service
...
declare module GestionGeneriqueOffres.Services.Rest.Tiers {
    interface IPortefeuilleQuery {
        codeEtablissement: string;
        identifiantRelationEconomique?: number;
        identifiantTiers?: number;
    }
    interface IPortefeuilleRestService {
        getPortefeuille(params: IPortefeuilleQuery): ng.IPromise<Types.Tiers.ITiersPortefeuille>;
    }
    /**
     * Classe permettant d'effectuer la communication avec la ressource dossier de vente.
     */
    class PortefeuilleRestService implements IPortefeuilleRestService {
        private serviceAgentExtended;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        /**
...
declare module GestionGeneriqueOffres.Services.Rest.TiersCorporate {
    interface IInterlocuteurListeQuery {
        codeEtablissement: string;
        identifiantPersonne: number;
        typeInterlocuteur: string;
        codeApplicationCartographie: string;
        filtreClients: boolean;
    }
    interface IInterlocuteurListeRestService {
        getInterlocuteurListe(params: IInterlocuteurListeQuery): ng.IPromise<Types.TiersCorporate.IInterlocuteur>;
    }
    /**
     * Classe permettant d'effectuer la communication avec la ressource dossier de vente.
     */
    class InterlocuteurListeRestService implements IInterlocuteurListeRestService {
        private serviceAgentExtended;
        static $inject: string[];
        constructor(serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        /**
