...
declare namespace ICBusiness.Constantes.ParametrageApplicatif {
    ...
    namespace Decision {
        const bt95DesactivationNewAccordPreteur: string;
    }
}
...
declare namespace ICBusiness.Services.ParametrageApplicatif {
    interface IParametrageAppicatifService {
        ...
        newHeaderV2Actif(dateDeTraitement: string, codeEtablissement: string): ng.IPromise<boolean>;
        ...
        /**
         * Indique si la on utilise l'ancienne méthode pour griser le bouton "Accorder le dossier"
         * @param dateDeTraitement
         * @param codeEtablissement
         */
        desactivationNouvelleMethodeAccordPreteur(dateDeTraitement: string, codeEtablissement: string): ng.IPromise<boolean>;
    }
}
...
declare namespace ICBusiness.Services.ParametrageApplicatif {
    interface IParametrageAppicatifRemanentService {
        ...
        /**
         * Méthode pour savoir si le nouveau header est actif
         * @param dateDeTraitement date de traitement
         * @param codeEtablissement code établissement
         */
        newHeaderV2Actif(dateDeTraitement: string, codeEtablissement: string): boolean;
        /**
