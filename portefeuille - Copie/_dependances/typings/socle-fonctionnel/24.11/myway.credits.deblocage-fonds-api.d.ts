...
declare module DeblocageFonds.Commun.Services {
    class UtilServices {
        ...
        /**
         * Renvoie l'identifiant DNC correspondant à un dossier d'instruction
         * @param codeEtablissement
         * @param identifiantDossierInstruction
         */
        calculeReferenceDNC(codeEtablissement: string, identifiantDossierInstruction: string): string;
    }
}
