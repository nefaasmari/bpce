...
declare module myflow.libcommon {
    class MyfHeaderController {
        ...
        isFromRedirectionExterne: string;
        isNotRedirectionExterne: boolean;
        constructor(lisaService: myflow.libcommon.LisaService, perimetreService: myflow.libcommon.PerimetreService, $window: ng.IWindowService, $scope: myflow.libcommon.IScope);
        showRecherSimple(): void;
        fermerApp(): void;
    }
}
...
declare module myflow.libcommon {
    ...
    const HABILITATION: {
        ...
        ACM_RA_GESTIONNAIRE_CLOTURE: number;
    };
    ...
    const PROVENANCE: {
        ...
        "SYNTHESE_CLIENT_BT_AUTRE_APPLICATION": string;
    };
    const PROVENANCE_RECHERCHE_BENEFICIAIRE: {
        "CLIENT": string;
        "NON_CLIENT": string;
        "NON_CLIENT_PRO": string;
        "COLLABORATEUR": string;
    };
    const MAX_NUM_RECHERCHE_SIMPLE: {
        "dicoIdntClnt": number;
        "dicoNumrDemn": number;
        "dicoIdntCont": number;
    };
    const RECHERCHE_SIMPLE_PAR_DEFAUT: {
        "PERSONNE": string;
    };
    const PROVENANCE_SPA_MYFLOW_II: {
        "SYNTHESE": string;
        "LISTE": string;
    };
    const NOM_FONCTIONNEL_CRITERE_DEMANDE: {
        "CONTRAT": string;
    };
    const NOM_CONTRAT_RECHERCHE_SIMPLE: {
...
declare module myflow.libcommon {
    ...
    interface ISPAListeLisaParams {
        ...
        nomFonctRech: string;
        operaRech: string;
        choixRechercheSelectionLabel?: string;
        provenance?: string;
    }
    interface IChoixSelectionRechercheSimple {
        nomFonctionnel: string;
        label: string;
        description: string;
        format: number;
        operators: Array<IOperatorsEntity>;
        preselectable: boolean;
        monoValue: boolean;
        sortable: boolean;
    }
    interface IOperatorsEntity {
        label: string;
        operator: string;
    }
}
...
declare module myflow.libcommon {
    class MyfSliderController {
        private $scope;
        listOfSliderItem: Array<MyfSliderItemController>;
        initItemName: string;
        ...
        onClickItemList(sliderItem: MyfSliderItemController): void;
        setselecteditem(slideName: string): void;
        addSlider(sliderItemConfig: MyfSliderItemController): void;
    }
}

declare module myflow.libcommon {
    interface ImyfSliderAttributes extends ng.IAttributes {
        setselecteditem: any;
    }
    function myfSliderDirective(): ng.IDirective;
}

declare module myflow.libcommon {
    class MyfSliderItemController {
        private $scope;
        isSelected: boolean;
        sliderItemConfig: {
            name: string;
...
declare module myflow.libcommon {
    interface IScopeSliderItemConfig extends ng.IScope {
        myfSliderItemCtrl: MyfSliderItemController;
    }
    function myfSliderItemDirective(): ng.IDirective;
}

declare module myflow.libcommon {
    enum LisaEtapeSortie_ACCD_TABL_BORD_DEMN {
        GERR_DEMN_TACH = 2,
        RECH_DEMN_PRST_TACH = 3,
        TRTR_DEMN_PRST = 4,
    }
    enum LisaEtapeSortie_ACCD_DEMN_PRST {
        ACCD_TABL_BORD_DEMN = 1,
        TRTR_DEMN_PRST = 3,
    }
    enum LisaEtapeSortie_ACCD_CTLG_MOTF {
        TRTR_DEMN_PRST = 1,
    }
    abstract class BaselibCommonControleur implements libcommon.IlisaController {
        protected lisaService: myflow.libcommon.LisaService;
        ...
        constructor(lisaService: myflow.libcommon.LisaService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, modalService: MyWay.UI.ModalService);
         ...
         */
        lisaNextViewToMyflow1<T extends libcommon.IMyflowContext>(codeSortie: number, context: T, pages: Array<libcommon.IMyflowLisaReturnSteps>): void;
    }
}
...
declare module myflow.libcommon {
    ...
    interface ITableauEtablissementMysys {
        Etablissement: Array<IEtablissementMysys>;
    }
}
...
declare module myflow.libcommon {
    class CommunService {
        ...
        provenanceRechercheSimple: string;
        choixSelectionRechercheSimpleLabel: string;
        private myflowStep;
        static $inject: string[];
        additionalHeaders: {
            "pragma": string;
        ...
        constructor($q: ng.IQService, requeteHTTPService: myflow.libcommon.RequeteHTTPService, perimetreService: myflow.libcommon.PerimetreService, serviceAgent: MyWay.Services.ServiceAgent, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        isProvenanceSyntheseClient(provenanceLisa: string): boolean;
        isProvenanceRechercheParBeneficiaire(provenanceLisa: string): boolean;
        getProperties(codeCaisse: string): ng.IPromise<{}>;
        setProvenanceRechercheSimple(provenance: string): void;
        setSelectionChoixRechercheSimpleLabel(choixSelectionLabel: string): void;
        /**
         * Methode qui renvoie le contexte de données myflowStep.
         */
        getMyflowStep(): ng.IPromise<any>;
        /**
         * Methode qui renvoie le contexte d'une donnée.
         */
        getContextFromServiceAgent(context: string): ng.IPromise<any>;
        /**
         ...
         */
        getInformationsEtablissement(_codeEtablissement: string): ng.IPromise<ITableauEtablissementMysys>;
        /**
         * Récupère le sigle de l'etablissement
         * @param _codeEtablissement
         * @return resultat de la promesse
         */
        getSigleEtablissement(codeEtablissement: string): ng.IPromise<string>;
        /**
        ...
        /**
         * Methode qui retourne l'url de recuperation des établissemnts
         */
        urlGetInformationsEtablissement(): string;
    }
}
...
declare module myflow.libcommon {
    /**
     * Interface représentant un objet d'entrée de la recherche
     */
    interface IRechercheStructureEdsQuery {
        typeRechercheEDS: number;
        codeEtablissement: string;
        typeEDS: string;
    }
    interface IStructureEds {
        codeEtablissement: string;
    ...
    class StructureService {
        ...
        $q: ng.IQService;
        private serviceAgentExtended;
        private requeteHTTPService;
        rechercheStructureLoader: boolean;
        constructor($http: ng.IHttpService, $q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, requeteHTTPService: myflow.libcommon.RequeteHTTPService);
        getRechercheStructure(query: IRechercheStructureEdsQuery): ng.IPromise<Array<IStructureEds>>;
        getRechercheStructure3(query: IRechercheStructureEdsQuery): ng.IPromise<Array<IStructureEds>>;
        getRechercheStructureAuth(query: IRechercheStructureEdsQuery): ng.IPromise<Array<IStructureEds>>;
        getRechercheStructureL(query: IRechercheStructureEdsQuery): ng.IPromise<any>;
    }
}

declare module myflow.libcommon {
    const RECHERCHE_TIERS_PERSONNE_PHYSIQUE: string;
    const RECHERCHE_TIERS_PERSONNE_MORALE: string;
    const RECHERCHE_TIERS_SIREN: string;
    const RECHERCHE_TIERS_SIEGE_SOCIAL: string;
    const URL_REST_TIERS_RECHERCHE: string;
    const URL_REST_TIERS_IDENTIFICATION: string;
    const URL_REST_TIERS_CORPORATE_INFORMATION: string;
    interface ITiersRechercheQuery {
        codeEtablissement: string;
        codeTypeRecherche: TypeRechercheTiers;
    ...
    enum TypeRechercheTiers {
        RechercheParRice = 1,
        RechercheParNumCarteBancaire = 2,
        RechercheParPersonnePhysique = 3,
        RechercheParIdContrat = 4,
        RechercheParIdClientBad = 5,
        RechercheParMedia = 6,
        RechercheParSiren = 7,
        RechercheParSiegeSocial = 8,
        RechercheParIdEbics = 9,
    }
    interface ITiersIdentification {
        codeEtablissement: string;
        identifiantPersonne: string;
    }
    interface ITierscorporateInformationQuery {
        codeEtablissement: string;
        idPersonne: number;
    }
    interface IArrayTierscorporateInformationQuery {
        codeEtablissement: string;
        listIdPersonne: Array<number>;
    }
    class TiersService {
        private $q;
        private serviceAgentExtended;
        rechercheTiersLoader: boolean;
        constructor($q: ng.IQService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended);
        /**
         * Recherche personnne physique
         * @param query
         */
        getRechercheTiers(query: ITiersRechercheQuery): ng.IPromise<Array<ITiers>>;
        getRechercheTiersIdentification(query: ITierscorporateInformationQuery): ng.IPromise<ITiers>;
        getRechercheListTiersIdentification(query: IArrayTierscorporateInformationQuery): ng.IPromise<Array<ITiers>>;
        getCodeTypeRecherche(formulaireRecherche: ITiersRechercheQuery): string;
    }
}
...
declare module myflow.libcommon {
    ...
    type MyflowContextParametrerLisaType = "parametrer";
    ...
    interface IMyflowParametrer extends IMyflowContext {
        lisaType: MyflowContextParametrerLisaType;
    }
...
declare module myflow.libcommon {
    class LisaService {
        ...
        constructor($q: ng.IQService, serviceAgent: MyWay.Services.ServiceAgent, tokenService: myway.portail.api.token.TokenService, perimetreService: myflow.libcommon.PerimetreService, communService: CommunService);
...
declare module myflow.libcommon {
    class RechercheSimpleController extends BaselibCommonControleur {
        private $location;
        protected modalService: MyWay.UI.ModalService;
        protected lisaService: myflow.libcommon.LisaService;
        protected perimetreService: myflow.libcommon.PerimetreService;
        protected serviceAgentExtended: MyWay.Services.ServiceAgentExtended;
        $q: ng.IQService;
        communService: myflow.libcommon.CommunService;
        private $window;
        chargementRecherche: boolean;
        choixSelectionner: IChoixSelectionRechercheSimple;
        choixRecherche: Array<IChoixSelectionRechercheSimple>;
        messageErreurRecherche: string;
        numPersonneOrDemande: any;
        messageToDisplay: boolean;
        constructor($location: ng.ILocationService, modalService: MyWay.UI.ModalService, lisaService: myflow.libcommon.LisaService, perimetreService: myflow.libcommon.PerimetreService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $q: ng.IQService, communService: myflow.libcommon.CommunService, $window: ng.IWindowService);
        /**
         * handle on select sur la combo box de recherche personne ou demande
         * @param $item
         * @param $model
         * @param $label
         * @param $event
         */
        onSelectSearchPersonneOrDemande(rechercheSimple: any, $model: any, $label: any, $event: any): void;
        searchPersonneOrDemandeByEnter(event: any, objetMetier: string, codeSortie: number): void;
        redirectionListePageOrNot(params: ISPAListeLisaParams, codeSortie: number): void;
        /**
         * permet d'obtenir la longueur max de champs à rechercher
         */
        getMaxLengthRecherche(): any;
        redirectionListePage(params: ISPAListeLisaParams, codeSortie: number): void;
        setChoixRechercheSimple(codeCaisse: string): void;
        setChoixRechercheSimpleParDefaut(): void;
        private setChoixSelectionnerByLabel(choixRechercheSelectionLabel);
        setChoixRecherche(propertiesRechercheSimple: Array<IChoixSelectionRechercheSimple>): void;
        private setRechercheContratProperties(propertieDisponiblesRechercheSimple);
        reloadRechercheCorbeille(params: ISPAListeLisaParams): void;
        switchRedirectionRechercheSimple(params: ISPAListeLisaParams, codeSortie: number): void;
    }
}

declare module myflow.libcommon {
    function rechercheSimpleDirective(): ng.IDirective;
}

declare module myflow.libcommon {
    class RechercheParBeneficiaireController extends BaselibCommonControleur {
        protected modalService: MyWay.UI.ModalService;
        protected lisaService: myflow.libcommon.LisaService;
        protected perimetreService: myflow.libcommon.PerimetreService;
        protected serviceAgentExtended: MyWay.Services.ServiceAgentExtended;
        private $window;
        communService: myflow.libcommon.CommunService;
        constructor(modalService: MyWay.UI.ModalService, lisaService: myflow.libcommon.LisaService, perimetreService: myflow.libcommon.PerimetreService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, $window: ng.IWindowService, communService: myflow.libcommon.CommunService);
        openModalRechercheParBeneficiaire(): void;
        reloadRechercheCorbeille(params: ISPAListeLisaParams): void;
        switchRedirectionRechercheBeneficiaire(params: ISPAListeLisaParams, codeSortie: number): void;
    }
}

declare module myflow.libcommon {
    function rechercheParBeneficiaireDirective(): ng.IDirective;
}
...
declare module myflow.libcommon {
    class ModalRBeneficiaireTemplateData {
        listId: Array<number>;
        typeBeneficiaire: TypeBeneficiaire;
        maxItemsSelected: number;
    }
    class ModalRBeneficiaireControlleur {
        private $modalInstance;
        ...
        protected perimetreService: myflow.libcommon.PerimetreService;
        protected serviceAgentExtended: MyWay.Services.ServiceAgentExtended;
        regimes: Array<Object>;
        static $inject: string[];
        sexeConfig: Array<MyWay.Services.IKeyValuePair<string, string>>;
        contratConfig: Array<MyWay.Services.IKeyValuePair<TypeRechercheTiers, string>>;
        listAgence: Array<any>;
        listGuichets: Array<string>;
        formClientDateNaissanceIsOpen: boolean;
        dateNaissanceMax: Date;
        colonnesPersonnesPhysique: Array<string>;
        colonnesPersonnesMorale: Array<string>;
        listpersonnesSelectedMax: number;
        results: Array<ITiers>;
        nonClientData: IPersonneNonClient;
        collaborateurData: IPersonneCollaborateur;
        disableByTypeRechercheTiers: number;
        cleRib: string;
        isFormInValid: boolean;
        formClient: IFormClient;
        formNonClient: IFormNonClient;
        formCollaborateur: IFormCollaborateur;
        personnesSelected: Array<Beneficiaire>;
        typeBeneficiaire: TypeBeneficiaire;
        typeRechercheClient: TypeRecherche;
        typeRechercheNonClient: TypeRecherche;
        identifiantRecherche: string;
        lineSelected: number;
        tableauLoader: boolean;
        constructor($modalInstance: angular.ui.bootstrap.IModalServiceInstance, $q: ng.IQService, structureService: StructureService, tiersService: TiersService, mwNotificationService: MyWay.UI.IMwNotificationService, perimetreService: myflow.libcommon.PerimetreService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, data: ModalRBeneficiaireTemplateData);
        private initModal(data);
        onClickSlide(item: any): void;
        tabSelected(typeSelected: TypeBeneficiaire): void;
        valider(): void;
        preparePersonneSelected(): void;
        annuler(): void;
        rechercher(): void;
        rechercheClient(): ng.IPromise<Array<any>>;
        getCodeTypeRecherche(): TypeRechercheTiers;
        reinitialiser(): void;
        calculerAffichage(inputName: string): void;
        isDisableByTypeRechercheTiers(inputName: string): boolean;
        getAgenceById(id: number): any;
        isFormEmpty(): boolean;
        calculerCleRib(): void;
        getTelephone(): string;
        reinitialiserBouton(formClientPp: any, formClientPm: any, formNonClientPp: any, formNonClientPm: any, formCollab: any): void;
        disableRechercherBouton(formClientPp: any, formClientPm: any, formNonClientPp: any, formNonClientPm: any, formCollab: any): boolean;
        disableValiderBouton(): boolean;
        isChargementTableau(): boolean;
        isNoResult(): boolean;
        keyUpHandler(event: any): void;
        isInvalidInputNom(): boolean;
        isInvalidInputPrenom(): boolean;
        isInValidInputWithDollar(input: string): boolean;
        isRecherchePersonnePhysique(): boolean;
        isInvalidCodeTel(): boolean;
    }
}

declare module myflow.libcommon {
    const beneficiaireTypeCollaborateur: string;
    const beneficiaireTypeNonClient: string;
    const beneficiaireTypeClient: string;
    type TypeBeneficiaire = typeof beneficiaireTypeClient | typeof beneficiaireTypeNonClient | typeof beneficiaireTypeCollaborateur;
    class Beneficiaire {
        constructor();
        client: ITiers;
        nonClient: IPersonneNonClient;
        collaborateur: IPersonneCollaborateur;
        type: TypeBeneficiaire;
    }
    enum TypeRecherche {
        ClientPhysique = 10,
        ClientMorale = 11,
        NonClientPhysique = 20,
        NonClientMorale = 21,
    }
    interface IPersonneNonClient {
        nom?: string;
        prenom?: string;
        raisonSociale?: string;
    }
    interface IPersonneCollaborateur {
        nom?: string;
        prenom?: string;
        login?: string;
    }
...
declare module myflow.libcommon {
    class ConfigTiers {
        static sexeConfig: Array<MyWay.Services.IKeyValuePair<string, string>>;
        static contratConfig: Array<MyWay.Services.IKeyValuePair<TypeRechercheTiers, string>>;
        static colonnesPersonnesPhysique: Array<string>;
        static colonnesPersonnesMorale: Array<string>;
        static getColonnesPersonnesPhysique(): Array<string>;
        static getColonnesPersonnesMorale(): Array<string>;
        static getSexeConfig(): Array<MyWay.Services.IKeyValuePair<string, string>>;
        static getContratConfig(): Array<MyWay.Services.IKeyValuePair<TypeRechercheTiers, string>>;
        static getFormClient(): IFormClient;
        static getFormNonClient(): IFormNonClient;
        static getFormCollaborateur(): IFormCollaborateur;
        static getMaxDateConfig(): Date;
        static getPersonneNonClient(): IPersonneNonClient;
        static getPersonneCollaborateur(): IPersonneCollaborateur;
    }
}

declare module myflow.libcommon {
    interface IFormClient {
        nomFamilleOuUsage?: string;
        prenom?: string;
        dateNaissance?: Date;
        sexe?: MyWay.Services.IKeyValuePair<string, string>;
        agence?: IStructureEds;
        email?: string;
        numBAD?: string;
        typeContrat?: TypeRechercheTiers;
        idContrat?: string;
        codeTel?: string;
        numTel?: string;
    ...
    interface IFormNonClient {
        nomFamilleOuUsage?: string;
        prenom?: string;
        raisonSociale?: string;
    }
    interface IFormCollaborateur {
        nomFamilleOuUsage?: string;
        prenom?: string;
        login?: string;
    }
...
declare module myflow.libcommon {
    interface ITiers {
        ...
        donneePersonneMorale: string;
        adresse: IAdresse;
        listMedia: IListMedia[];
        listeMotifsConfidentialite: any[];
    }
    interface IAdresse {
    ...
    interface IDonneePersonnePhysique {
        ...
        indicateurStatutAutoEnt: string;
    }
...
declare module myflow.libcommon {
    ...
    interface ITachesEnMasse {
        ...
        commentaire: string;
        /**
         * boolean pour savoir si on notifie la personne de cette affectation
         */
        notifierPersonneAffectee?: boolean;
    }
}
