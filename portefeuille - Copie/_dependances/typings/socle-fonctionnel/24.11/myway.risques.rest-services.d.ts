...
declare namespace Contentieux.RestServices.Modeles.Creance {
    interface ICompteSupport {
         ...
         */
        numeroOrdreCompteCre: number;
        detail: IDetail;
    }
    interface IDetail {
        libelleLongCompte: string;
        numeroOrdreCompteCre: number;
        indic1erComptePayeur: string;
        indic2emeComptePayeur: string;
        indicSaisieRum: string;
        codeModeReglement: string;
        codeTypeDomiciliation: string;
        numeroChronoPrelev: number;
        libelleLongCompteMod: string;
        valeurParamLibelle: string;
        dateDebutValidite: string;
        dateDerniereMAJ: string;
        identifiantAgentAppliMAJ: string;
        dateFinValidite: string;
        codeStatutComptePayeur: string;
        rangComptePayeurPrincipal: number;
        dateSignatureMandatDebi: string;
        codeTypeOrigineFlux: string;
        indicateurSuppressionPoss: string;
        numeroAccordRecouvrement: number;
        referenceMandat: string;
        numeroDossierContentieux: number;
        codeTypeOrigineCompteCredit: string;
        codeGuichet: string;
    }
}
...
declare namespace Contentieux.RestServices.Services {
    interface ITiersService {
        ...
        getIdentification(codeEtablissement: string, idTiers: number): ng.IPromise<Modeles.Tiers.IIdentification>;
    }
...
declare namespace Contentieux.RestServices.Commun.Constantes.Url {
    ...
    namespace Tiers {
        const urlTiersIdentification: string;
    }
    namespace Eds {
        const urlCaracteristique: string;
