...
declare namespace ICBusiness.Constantes.Inject {
    namespace Services {
        ...
        const dossierGreenService: string;
...
declare namespace ICBusiness.Enum {
    ...
    enum CodePageEnum {
        ...
        clientModalCreditExistant = 2001,
        clientModaleDroitEpargneLogement = 2002,
        projet = 3,
        projetDescription = 301,
        projetReamenagement = 302,
        projetObjetFinance = 303,
        projetMontant = 304,
        projetObjetGarantie = 305,
        projetGarant = 306,
        projetExpertise = 307,
        financement = 4,
        ...
        gestionAdminAvisSLAB = 706,
        gestionAdminSuivisPlanifies = 707,
        decisionPreteur = 8,
...
declare namespace ICBusiness.Constantes.Anomalie {
    ...
    namespace ThemeSpecifiqueControle {
        ...
        const idsAnoNonForcable: string[];
    }
}
...
declare namespace ICBusiness.Constantes {
    ...
    namespace ClasseNeo {
        ...
        /**
         * Identifiant de classe pour la mise à jour du bloc notes
         */
        const blocNotesMaj: string;
        /**
        ...
        const creditPhaseAmortissementMaj: string;
        /**
...
declare namespace ICBusiness.Constantes {
    namespace Credit {
        ...
        const modeExpressionDureeFixe: number;
        ...
        const optionsImpactList: () => Models.Common.CodeLabel<number>[];
    }
}
...
declare namespace ICBusiness.Constantes.Documents {
    ...
    namespace TypeDocument {
        ...
        const propCommFinHabLoiConsoOuAutreLoi: string;
    }
    /**
...
declare namespace ICBusiness.Constantes.Dossier {
    ...
    namespace Green {
        const codeImmatAppel: string;
        const modalConsult: string;
        const modalModif: string;
    }
}
...
declare namespace ICBusiness.Constantes {
    namespace Emprunteur {
        ...
        const typeRolePersonneAssure: Models.Common.ICodeLabel<string>;
...
declare namespace ICBusiness.Constantes.Green {
    /**
     * liste des tops éligibilité qui autorisent le débranchement
     */
    const eligibiliteAutoriseDebranchement: string[];
    const completudeValide: string;
}
...
declare namespace ICBusiness.Constantes {
    ...
    namespace ListeConstantes {
        ...
        /**
         * Code pour la liste des niveaux de LBO
         */
        const niveauLBO: string;
    }
}
...
declare namespace ICBusiness.Constantes.Optimisation {
    ...
    const listeModalitesOptim: (isImmo: boolean) => Models.Common.ICodeLabel<string>[];
}
...
declare namespace ICBusiness.Constantes.ParametrageApplicatif {
    ...
    namespace MyWayV2 {
        const bt95NewTotem: string;
    }
    namespace ProduitLissageProDefi {
        const bt95OptimisationActive: string;
    }
    namespace Green {
        const bt95ProjetActif: string;
    }
    namespace NAdePro {
        const bt95ProjetActif: string;
        const bt95AutrePersonneAAjouter: string;
        const bt95DesactivationOptimCodeCollectivite: string;
    }
    namespace Ptz2024 {
        const bt95ActivationPtz2024: string;
    }
    namespace LBO {
        const bt95ActivationLBO: string;
    }
    namespace LIASSE {
        const bt95ActivationLiassePropoCo: string;
    }
    namespace IMPACT {
        const bt95ActivationCreditImpact: string;
    }
}
...
declare namespace ICBusiness.Constantes.ParametreFonctionnel {
    namespace Idws {
        ...
        /** Savoir si on affiche le taux d'usure sur les tuiles de crédits */
        const tauxUsure: string;
        /** si le dossier est éligible au DPE si l'adresse du bien financé est située en France métropolitaine.
         * En effet le DPE est seulement facultatif pour un bien en Outre Mer
         */
        const eligibleDPE: string;
        /** Savoir si on affiche le totem MRH */
        const totemMRH: string;
        /** PTZ 2024
         * La zone QPV ANRU est elle gérée
         */
        const zoneQpvAnru: string;
        /** PTZ 2024
         * La zone Montant des Travaux ENergie FOSsile est elle gérée
         */
        const zoneTrvxEnergieFossile: string;
        /** PTZ 2024
         * Le lien Saisir autre montant
         */
        const lienSaisirAutreMontant: string;
        /** PTZ 2024
         * Le lien Saisir autre durée
         */
        const lienSaisirAutreDuree: string;
        /** PTZ 2024
         * La case qui indique que l'emprunteur refuse d'avoir un PTZ sur son dossier
         */
        const zoneRefusPtzEmprunteur: string;
        /** pour gérer la visibilité des boutons CNP pour la nade pro */
        const creerDossierCNP: string;
        const consulterDetailDecisionCNP: string;
        const telechargerDocumentCNP: string;
        /** pour le crédit impact */
        const optionPretImpact: string;
    }
}
...
declare namespace ICBusiness.Constantes.Projet {
    ...
    namespace DPE {
        const longueurFixeIdentifiantDPE: number;
    }
}
...
declare namespace ICBusiness.Rules {
    class PreciseLengthRule implements IValidationRule {
        ...
        constructor(value: () => string, length: () => number, allowEmpty?: boolean);
        validate(): IValidationRuleResult;
    }
}
...
declare namespace ICBusiness.Tools {
    class CodeLabel {
        ...
        static findOrFirst<T extends string | number | boolean>(list: Models.Common.ICodeLabel<T>[], code: T): Models.Common.ICodeLabel<T>;
...
declare namespace ICBusiness.ModelsTransformers {
     ...
     */
    class Assurance {
        static mapAssureSignataire(assurancesCompletes: RestModel.SchemaComplet.IAssuranceComplet[], signataireComplets: ICRest.Modeles.SchemaComplet.IPersonnePhysiqueComplet[]): BusinessModel.IAssureSignataire;
...
declare namespace ICBusiness.ModelsTransformers {
     ...
     */
    class BlocNotes {
        static mapBlocNotes(blocNoteslecture: ICRest.Modeles.DefinirBlocNotes.IBlocNotesLecture): Models.BlocNotes.IBlocNotes;
        /**
         * Map blocNotesComplet vers un IBlocNote
         * TODO: Vérifier si problèmatique de ne plus remonter les anomalies
         * @param blocNotes
         */
        static mapBlocNotesFromSchemaComplet(blocNotes?: ICRest.Modeles.SchemaComplet.IBlocNotesComplet): Models.BlocNotes.IBlocNotes;
    }
}
...
declare namespace ICBusiness.ModelsTransformers {
    class Anomalie {
         ...
         * @param anomalie
         */
        static mapAnomalie(anomalie: ICRest.Modeles.LireElement.IAnomalieLecture | ICRest.Modeles.DefinirBlocNotes.IAnomalieLecture | ICRest.Modeles.CalculerFraisNotaire.IAnomalieLecture | ICRest.Modeles.FermerDossier.IAnomalieLecture | ICRest.Modeles.SignerOffrePret.IAnomalieLecture): ICBusiness.Models.Common.IAnomalieLecture;
...
declare namespace ICBusiness.ModelsTransformers {
    ...
    class Dossier {
        ...
        static mapDossierNumeriqueCredit(dnc: ICRest.Modeles.SchemaComplet.IDossierNumeriqueCreditComplet): Models.Dossier.IDNC;
    }
}
...
declare namespace ICBusiness.ModelsTransformers {
     ...
     */
    class Credit {
        static mapCalculCredit(credit: ICRest.Modeles.CalculerCreditInterne.ICreditInterneLecture, listeLBO?: Models.Common.CodeLabel<string>[]): Models.Financement.ICreditLecture;
        static majCredit(credit: Models.Financement.ICreditInterne, codeDeviseDossier: string, modeDefi: boolean): ICRest.Modeles.MajElements.ICreditInterneMaj;
...
declare namespace ICBusiness.ModelsTransformers {
    import RModel = ICRest.Modeles;
    import BModel = ICBusiness.Models.Green;
    class DossierGreen {
        static mapDossierGreen(complet: RModel.SchemaComplet.IDossierGreenComplet): BModel.IDossierGreen;
        private static mapCouleurMarqueur(topEligibilite);
        private static mapReferenceGreen(complet);
        private static mapObjetGreen(refId, complet);
        private static mapCaracterisationGreen(complet);
    }
}
...
declare namespace ICBusiness.ModelsTransformers {
    class TauxPVH {
        static mapGrilleTauxPVH(grille: ICRest.Modeles.LireElement.IGrilleDeTauxLecture): Models.Pvh.ITauxPVH[];
    }
}
...
declare namespace ICBusiness.Models.InformationsPtz {
    ...
    interface IInfoComplementairePTZ {
        ...
        montantMaxRFRCoutOperationPlan: number;
    }
}
...
declare namespace ICBusiness.Models.Assurances {
     ...
     */
    interface IAssure extends IInfoAssureBase {
        dateNaissance: string;
        codeRole: string;
    ...
    interface IAssureSignataire {
        assures: IAssure[];
        signataires: IInfoAssureBase[];
    }
}
...
declare namespace ICBusiness.Models.Common {
    interface IObjetARafraichir {
        idws: string;
        codeObjetARafraichir: number;
    }
}
...
declare namespace ICBusiness.Models.EditionOffre {
    ...
    interface IInfoDocument {
         ...
         */
        numPersonne: string;
        identifiantLiasse?: string;
        documentsLiasse?: IInfoDocument[];
    }
    interface IEditionDocEnfantLiasse {
        idDocument: string;
        anomalies: ICRest.Modeles.LireElement.IAnomalieLecture[];
    }
}
...
declare namespace ICBusiness.Models.Financement {
    ...
    interface ICreditLecture {
        ...
        libelle: string;
        topLBO?: boolean;
        niveauLBO?: ICBusiness.Models.Common.CodeLabel<string>;
    }
}
...
declare namespace ICBusiness.Models.Financement {
    ...
    interface ICreditInterne extends ICreditInterneBase {
        ...
        precisionTaux: number;
        topLBO: boolean;
        niveauLBO: Models.Common.CodeLabel<string>;
        etatPretImpact: Models.Common.CodeLabel<number>;
        bonificationImpact?: number;
        dpeCibleImpact?: string;
    }
...
declare namespace ICBusiness.Models.Green {
    interface IDossierGreen {
        idws: string;
        identifiantGreen: string;
        topEligibilite: string;
        libelleTopEligibilite: string;
        topCompletude: string;
        libelleTopCompletude: string;
        montantProjet: number;
        montantFinance: number;
        objetsGreen: IObjetGreen[];
        estDebranchementPossible: boolean;
        estDossierValide: boolean;
        estMarque: boolean;
        estComplet: boolean;
        couleur: ICBusiness.Enum.CouleurEnum;
    }
    interface IObjetGreen {
        idws: string;
        idwsReference: string;
        libelle: string;
        caracterisations: ICaracterisationGreen[];
    }
    interface ICaracterisationGreen {
        idws: string;
        libelle: string;
        montant: number;
    }
...
declare namespace ICBusiness.Models.Navigation.LisaContract.ADD {
    interface IGreenContext {
        codeEtablissement: string;
        identifiantDossierGreen: string;
        CodeImmatAppel: string;
        ModalAcces: string;
        MontReference: number;
        IdentObjetCaract: string;
        CodeTypeObjetCaract: string;
        LibObjetCaract: string;
    }
}
declare namespace ICBusiness.Models.Navigation.LisaContract.DNCPRO {
    interface IDncProContext {
        appelDNC: string;
        codeEtablissement: string;
...
declare namespace ICBusiness.Models.Navigation.LisaContract.NADEPRO {
    interface IParamsNAde {
        idsPersonnes: string[];
        idsCredits?: string[];
        idPlan: string;
        idAssurance?: string;
    }
    interface INAdeProContext {
        codeApplication: Enum.CodeApplicationEnum;
        dateInstruction: string;
        idCompteDe: string;
        identifiantDossier: string;
...
declare namespace ICBusiness.Models.ProjetImmo {
    ...
    interface ITravauxFinancesComplet {
        idws: string;
        coutTravaux: number;
        coutTravauxEnergieFossile: number;
...
declare namespace ICBusiness.Models.SignataireElectronique {
    ...
    interface ISignataire {
        ...
        nomMandataire: string;
        vertuMandataire: string;
        controleSignataireBulletinAdhesion: ICBusiness.Models.Common.IVisibilite;
    }
}
...
declare namespace ICBusiness.Services.Assurances {
    ...
    interface IAssurancesService {
        ...
        getAssureSignataire(idDossier: string): ng.IPromise<Models.Assurances.IAssureSignataire>;
        ...
        transmettrePropositionCnpPourAdeOld(identifiantDossier: string, assuranceByAssure: Models.Assurances.IAssure, forcerControles?: boolean): ng.IPromise<Models.Assurances.IPropositionCnp>;
        transmettrePropositionCnpSignataire(identifiantDossier: string, identifiantSignataire: string, forcerControles?: boolean): ng.IPromise<Models.Assurances.IPropositionCnp>;
        /**
        ...
        addAssure(idDossier: string, personne: Models.Emprunteur.IPersonne): ng.IPromise<Models.Emprunteur.IPersonne>;
    }
    /** Services relatifs aux assurances */
    class AssurancesService implements IAssurancesService {
         ...
         * @param assurance
         */
        private transmettrePropositionCnpInternalOld(identifiantDossier, forcerControles, assurance);
        /**
         * Transmet la proposition d'assurance à la CNP en faisant des vérifications au préalable
         * @param identifiantDossier
         * @param assuranceByAssure
...
declare namespace ICBusiness.Services.BlocNotes {
    interface IBlocNotesService {
        /**
         * Récupère le bloc note via lireSchemaComplet
         * Si aucun bloc note complet, on retourne un bloc note vide
         * @param idDossier
         */
        lireBlocNotes(idDossier: string): ng.IPromise<Models.BlocNotes.IBlocNotes>;
        /**
         * Mise à jour du bloc note
         * Si on a pas d'idws de bloc note, on passe par un definirBlocNotes pour l'initialiser
         * @param idDossier
         * @param blocNotes
         */
        mettreAJourBlocNotes(idDossier: string, blocNotes: Models.BlocNotes.IBlocNotes): ng.IPromise<Models.BlocNotes.IBlocNotes>;
    }
    class BlocNotesService implements IBlocNotesService {
        ...
        private elementService;
        static $inject: string[];
        constructor(blocNotesServiceRest: ICRest.Services.BlocNotes.IBlocNotesService, schemaService: Services.Common.IElementSchemaService, elementService: ICRest.Services.Element.IElementService);
        lireBlocNotes(idDossier: string): ng.IPromise<Models.BlocNotes.IBlocNotes>;
        /**
         * Mise à jour du bloc note
         * Si on a pas d'idws de bloc note, on passe par un definirBlocNotes pour l'initialiser
         ...
         */
        private definirBlocNotes(idDossier, typeBlocNotes, valeurBlocNotes);
    }
}
...
declare namespace ICBusiness.Services.Catalogue {
    interface ICatalogueService {
         ...
         * Renvoie la liste des motifs pour remboursement anticipé
         */
        getListeNiveauLBO(dateTraitement: string): ng.IPromise<Models.Common.ICodeLabel<string>[]>;
    }
...
declare namespace ICBusiness.Services.Dossier {
    interface IDossierService {
         ...
         * @param sauvegarde
         */
        fermerDossier(identifiantDossier: string, sauvegarde: boolean): ng.IPromise<Models.Common.IAnomalieLecture[]>;
        /**
        ...
        rafraichir(idDossier: string, objets: ICBusiness.Models.Common.IObjetARafraichir[]): ng.IPromise<void>;
    }
    class DossierService implements IDossierService {
        ...
        private elementSchemaService;
        static $inject: string[];
        constructor(dossierService: ICRest.Services.Dossier.IDossierService, syntheseService: ICRest.Services.Synthese.ISyntheseService, elementService: ICRest.Services.Element.IElementService, schemaService: ICRest.Services.Schema.ISchemaService, restService: ICRest.Services.IRestService, elementSchemaService: Services.Common.IElementSchemaService);
        creerDossier(dateDeTraitement: string, canalDeCreation: string, codeApplication: Enum.CodeApplicationEnum, codeDevise: string, pourLeCompteDe?: string): ng.IPromise<Models.Dossier.IResultatCreationDossier>;
        creerDossierPVH(dateDeTraitement: string, canalDeCreation: string, codeApplication: number, codeDevise: string, idClientBancaire: string, pourLeCompteDe?: string): ng.IPromise<Models.Dossier.IResultatCreationDossier>;
        creerDossierAvecProjetImmo(dateDeTraitement: string, canalDeCreation: string, codeDevise: string, idClientBanquaire: string, pourLeCompteDe?: string): ng.IPromise<Models.Dossier.IDossierSchema>;
        validerAccordClient(idDossier: string, idPlanFinancement: string): ng.IPromise<void>;
...
declare namespace ICBusiness.Services.Dossier {
    interface IVerifierEligibilite {
        calculerEligibilite(identifiantDossier: string, identifiantPlan?: string): ng.IPromise<Models.Dossier.IResultatEligibilite[]>;
    }
...
declare namespace ICBusiness.Services {
    interface IDNCService {
        ...
        getDossierNumeriqueCredit(idDossier: string): ng.IPromise<Models.Dossier.IDNC>;
    }
    class DNCService implements IDNCService {
        ...
        private schemaService;
        static $inject: string[];
        constructor($q: ng.IQService, qualiteDossierService: ICRest.Services.QualiteDossier.IQualiteDossierService, contexteEditionService: Services.Edition.IContexteEditionService, dossierNumeriqueService: ICRest.Services.Dossier.IDossierNumeriqueService, schemaService: Services.Common.IElementSchemaService);
        getControleDefi(idDossier: string): ng.IPromise<Models.DNCDefi.IControleDEFI[]>;
        isDNCActif(idDossier: string): ng.IPromise<boolean>;
        getReferenceRegroupement(idDossier: string): ng.IPromise<string>;
        miseAJourDossierNumerique(idDossier: string): ng.IPromise<void>;
...
declare namespace ICBusiness.Services.Edition {
    interface IEditionOffreService {
        ...
        editerLiasse(idDossier: string, identifiantWsDocument: string, infoDoc: ICBusiness.Models.EditionOffre.IInfoDocument): ng.IPromise<Models.Impression.IImpression>;
    }
    class EditionOffreService implements IEditionOffreService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, parametrageApplicatifService: Services.ParametrageApplicatif.IParametrageAppicatifService, controlerService: ICRest.Services.Controle.IControleService, editionOffreService: ICRest.Services.EditionOffre.IEditionOffreService, editerDocumentService: ICRest.Services.Dossier.IEditerDocumentsService);
        /**
         * Méthode pour savoir si le forçage des anomalies bloquantes levées par le contrôle avant l'édition de l'offre est possible
         * @param codeEtablissement
         * @param dateTraitement
        ...
        private editerDocumentEnfant(idDossier, identifiantWsDocument, infoDoc, indexDocEnfant, retourDoc);
    }
}
...
declare namespace ICBusiness.Services.Emprunteur {
    ...
    interface IPersonneService {
        ...
        getPersonnesAssurables(idDossier: string): ng.IPromise<Models.Emprunteur.IPersonnePhysique[]>;
        /**
...
declare namespace ICBusiness.Services.Financement {
    interface IBonificationService {
         ...
         * @param idDossier
         */
        calculerBonificationsDossier(idDossier: string, dateTraitement: string): ng.IPromise<void>;
    }
...
declare namespace ICBusiness.Services.Financement {
    interface ICreditService {
         ...
         * @param financeRaf
         */
        calculerCreditInterne(idDossier: string, idCredit: string, financeRaf?: boolean, listeLBO?: Models.Common.CodeLabel<string>[]): ng.IPromise<Models.Financement.ICalculCredit>;
        /**
    ...
    class CreditService implements ICreditService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, creditService: ICRest.Services.Dossier.CreditService, elementService: ICRest.Services.Element.IElementService, schemaService: Services.Common.IElementSchemaService, catalogueService: Services.Catalogue.ICatalogueService, creditParametreService: ICRest.CreditParametre.Services.ICreditParametreService, creditEpargneLogementService: ICRest.Services.Dossier.ICreditEpargneLogementService, remiseTauxService: ICRest.Services.Dossier.IDefinirRemiseTauxService);
        ajouterCreditInterneEtRechageCredit(idDossier: string, idPlanFinancement: string, idProduit: string, montantEmprunte: number, initMontant: boolean, enOptim: boolean, tauxMontage: number): ng.IPromise<Models.Financement.ICreditInterne>;
        ajouterCreditInterne(idDossier: string, idPlanFinancement: string, idProduit: string, montantEmprunte: number, initMontant: boolean, enOptim: boolean, tauxMontage: number): ng.IPromise<Models.Financement.ICreditInterneBase>;
        majVentilationDefi(idDossier: string, idProjet: string, montantProjetDefi: number): ng.IPromise<void>;
        majCreditInterne(idDossier: string, credit: Models.Financement.ICreditInterne, codeDeviseDossier: string, modeDefi?: boolean): ng.IPromise<void>;
...
declare namespace ICBusiness.Services.Financement {
    interface IEditerDocumentsService {
        ...
        editerProposition(idDossier: string, idPlan: string, typeLoiScrivener: number): ng.IPromise<Models.Impression.IImpression>;
        /**
    ...
    class EditerDocumentsService implements IEditerDocumentsService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, editerDocumentsService: ICRest.Services.Dossier.IEditerDocumentsService, editerDocumentFZHCOPTService: ICRest.Services.Edition.IEditerDocumentFZHCOPTService);
        editerTableauAmortissement(idDossier: string, idDocument: string): ng.IPromise<Models.Financement.ITableauAmortissement>;
        private getParamEditiqueProposition();
        editerProposition(idDossier: string, idPlan: string, typeLoiScrivener: number): ng.IPromise<Models.Impression.IImpression>;
        editerOptimisation(idDossier: string, idPlan: string): ng.IPromise<string>;
...
declare namespace ICBusiness.Services.Financement {
    interface IPlanFinancementService {
         ...
         * @param idDossier
         */
        lirePlanFinancement(idDossier: string, dateTraitement: string): ng.IPromise<Models.Financement.IPlanFinancement>;
        ...
        getCriteresOptim(idDossier: string, idPlan: string, isImmo: boolean): ng.IPromise<Models.Financement.Optimisation.ICriteresOptimisation>;
        ...
        getDefaultPlanId(idDossier: string): string;
    }
    class PlanFinancementService implements IPlanFinancementService {
        ...
        private catalogueService;
        static $inject: string[];
        constructor($q: ng.IQService, planFinancementService: ICRest.Services.PlanFinancement.IPlanFinancementService, elementSchemaService: Services.Common.IElementSchemaService, elementService: ICRest.Services.Element.IElementService, catalogueService: Services.Catalogue.ICatalogueService);
        ajouterPlanFinancement(idDossier: string, idProjet: string): ng.IPromise<Models.Financement.IRetourPlanFinancementAjout>;
        copierPlanFinancement(idDossier: string, idPlanACopier: string): ng.IPromise<Models.Financement.IRetourPlanFinancementAjout>;
        majPlanFinancement(idDossier: string, data: Models.Financement.IPlanFinancementMajRequest): ng.IPromise<void>;
        lirePlanFinancement(idDossier: string, dateTraitement: string): ng.IPromise<Models.Financement.IPlanFinancement>;
...
declare namespace ICBusiness.Services.Green {
    interface IDossierGreenService {
        getDossier(idDossier: string): ng.IPromise<ICBusiness.Models.Green.IDossierGreen>;
        getContextLisa(dossierGreen: ICBusiness.Models.Green.IDossierGreen, projet: ICBusiness.Models.Projet.IProjet, codeEtablissement: string, consultation: boolean): ICBusiness.Models.Navigation.LisaContract.ADD.IGreenContext;
    }
    class DossierGreenService implements IDossierGreenService {
        private schemaService;
        static $inject: Array<string>;
        constructor(schemaService: Services.Common.IElementSchemaService);
        getDossier(idDossier: string): ng.IPromise<ICBusiness.Models.Green.IDossierGreen>;
...
declare namespace ICBusiness.Services.Habilitation {
    interface IHabilitationService {
        ...
        /**
         * Détermine si le nouveau totem est actif ou non en rapport aux fonctions pilotes de l'agent
         * @param identifiantElementStructure
         * @param identifiantEntiteConnecte
         */
        newTotemV2Actif(identifiantElementStructure: string, identifiantEntiteConnecte: string): ng.IPromise<boolean>;
    }
...
declare namespace ICBusiness.Services.ImpressionService {
    interface IImpressionService {
        ...
        editerPiecesEtControle(idDossier: string, typePiece: Enum.EnumTypePiece, numeroPlanFinancement: number): ng.IPromise<void>;
...
declare namespace ICBusiness.Services.MultiRisqueHabitation {
    interface IMultiRisqueHabitationService {
        ...
        getInformationsDevisMrh(idDossier: string): ng.IPromise<string[]>;
    ...
    class MultiRisqueHabitationService implements IMultiRisqueHabitationService {
        ...
        static $inject: string[];
        constructor(elementService: ICRest.Services.Element.IElementService, schemaService: ICRest.Services.ElementSchema.IElementSchemaService, dossierMRHService: ICRest.Services.Dossier.IDossierMRHService);
        /**
         * Méthode pour récupérer la liste de l'historique des événements
         * @param idDossier
         */
...
declare namespace ICBusiness.Services.ParametrageApplicatif {
    interface IParametrageAppicatifService {
        ...
        optimisationActiveProDefi(dateDeTraitement: string, codeEtablissement: string): ng.IPromise<boolean>;
        checkActivationProjetGreen(dateDeTraitement: string, codeEtablissement: string): ng.IPromise<boolean>;
        checkActivationProjetNAdePro(dateDeTraitement: string, codeEtablissement: string): ng.IPromise<boolean>;
        checkActivationAutrePersonneAAjouter(dateDeTraitement: string, codeEtablissement: string): ng.IPromise<boolean>;
        desactivationNadeProOptimCodeCollectivite(dateDeTraitement: string, codeEtablissement: string): ng.IPromise<boolean>;
        checkActivationPtz2024(dateDeTraitement: string, codeEtablissement: string): ng.IPromise<boolean>;
        checkActivationLBO(dateDeTraitement: string, codeEtablissement: string): ng.IPromise<boolean>;
        checkActivationLiasse(dateDeTraitement: string, codeEtablissement: string): ng.IPromise<boolean>;
        checkActivationPretImpact(dateDeTraitement: string, codeEtablissement: string): ng.IPromise<boolean>;
    }
}
...
declare namespace ICBusiness.Services.ParametrageApplicatif {
    interface IParametrageAppicatifRemanentService {
        ...
        /**
         * Méthode pour savoir si l'avis SLAB est affiché (retourne faux en attendant le résultat de la promesse)
         * @param idDossier
         * @param idProjet
         */
        getAvisSLABVisibilite(idDossier: string, idProjet: string): boolean;
        /**
         * Permet de supprimer le paramètre applicatif remanent lié à l'avis SLAB
         */
        supprimerPafoAvisSLABFromCache(): void;
    }
    /**
    ...
    class ParametrageAppicatifRemanentService implements IParametrageAppicatifRemanentService {
        ...
        private parametreFonctionnelService;
        static $inject: string[];
        constructor(parametrageApplicatifService: Services.ParametrageApplicatif.IParametrageAppicatifService, parametreFonctionnelService: Services.ParametreFonctionnel.IParametreFonctionnelService);
        checkFicheSuiveuseActive(dateDeTraitement: string, codeEtablissement: string): boolean;
        transfereNeoProActif(codeEtablissement: string, date: string): boolean;
        transfereNeoConsoActif(codeEtablissement: string, date: string): boolean;
        transfereNeoImmoActif(codeEtablissement: string, date: string): boolean;
...
declare namespace ICBusiness.Services.ParametreFonctionnel {
    interface IParametreFonctionnelService {
        ...
        /**
         * Permet de récupérer le paramètre fonctionnel indiquant s'il faut afficher ou non le taux d'usure des crédits
         * @param idDossier
         * @param idPlanFinancement
         */
        getAffichageTauxUsureParametreFonctionnel(idDossier: string, idPlanFinancement: string): ng.IPromise<Models.ParametreFonctionnel.IParametreFonctionnel>;
        /**
         * Permet de récupérer le paramètre fonctionnel indiquant si le type d'acquisition est obligatoire non bloquant (asterisque)
         * @param idDossier
         * @param idProjet
         */
        getEligibleDPEParametreFonctionnel(idDossier: string, idProjet: string): ng.IPromise<Models.ParametreFonctionnel.IParametreFonctionnel>;
        /**
         * Permet de récupérer le paramètre fonctionnel indiquant si le totem MRH est visible
         * @param idDossier
         * @param idProjet
         */
        getTotemMRHParametreFonctionnel(idDossier: string): ng.IPromise<Models.ParametreFonctionnel.IParametreFonctionnel>;
        /**
         * Permet de savoir si la zone Qpv Anru est gérée ou non
         * @param idDossier
         * @param idProjet
         */
        getQpvAnruParametreFonctionnel(idDossier: string, idProjet: string): ng.IPromise<Models.ParametreFonctionnel.IParametreFonctionnel>;
        /**
         * Permet de savoir si la zone Travaux ENergie FOSsile est gérée ou non
         * @param idDossier
         * @param idProjet
         */
        getTravauxEnergieFossileParametreFonctionnel(idDossier: string, idProjet: string): ng.IPromise<Models.ParametreFonctionnel.IParametreFonctionnel>;
        getRefusPtzEmprunteurParametreFonctionnel(idDossier: string, idPlan: string): ng.IPromise<Models.ParametreFonctionnel.IParametreFonctionnel>;
        /**
         * Permet de savoir si le lien Saisir autre montant est visible ou non
         * @param idDossier
         * @param idCredit
         */
        getSaisirAutreMontantParametreFonctionnel(idDossier: string, idCredit: string): ng.IPromise<Models.ParametreFonctionnel.IParametreFonctionnel>;
        /**
         * Permet de savoir si le lien Saisir autre durée est visible ou non
         * @param idDossier
         * @param idCredit
         */
        getSaisirAutreDureeParametreFonctionnel(idDossier: string, idCredit: string): ng.IPromise<Models.ParametreFonctionnel.IParametreFonctionnel>;
        /**
         * Permet de savoir si le champ option impact est visible ou non
         * @param idDossier
         * @param idCredit
         */
        getOptionPretImpactParametreFonctionnel(idDossier: string, idCredit: string): ng.IPromise<Models.ParametreFonctionnel.IParametreFonctionnel>;
    }
    class ParametreFonctionnelService implements IParametreFonctionnelService {
        ...
        private mapParametreFonctionnel(codeParametre, idObjetConcerne, visible?, actif?, caracteristiques?);
    }
}
...
declare namespace ICBusiness.Services.Pvh {
    interface IPvhService {
        ...
        /**
         * Récupère la liste des taux PVH
         * @param idDossier
         * @param idCredit
         */
        recupererGrilleTaux(idDossier: string, idCredit: string): ng.IPromise<Models.Pvh.ITauxPVH[]>;
    }
...
declare namespace ICBusiness.Services.RedacteurActe {
    interface IRedacteurActeService {
         ...
         * @param redacteurActe
         */
        definirRedacteurActe(identifiantDossier: string, redacteurActe: Models.RedacteurActe.IRedacteurActe): ng.IPromise<string[]>;
        /**
...
declare namespace ICBusiness.Services.RemiseOffre {
    ...
    interface IRemiseOffreService {
         ...
         */
        remiseOffre(idDossier: string, date: string, forcageGlobal: boolean): ng.IPromise<ICBusiness.Models.RemiseOffre.IRemiseOffre>;
    }
    /**
    ...
    class RemiseOffreService implements IRemiseOffreService {
         ...
         */
        remiseOffre(idDossier: string, dateRemise: string, forcageGlobal: boolean): ng.IPromise<ICBusiness.Models.RemiseOffre.IRemiseOffre>;
    }
}
...
declare namespace ICBusiness.Services.SignatureElectronique {
    interface ISignatureElectroniqueService {
         ...
         *
         * @param idActe identifiant IDN de l'acte de signature
         * @param idDocument identifiant IDN du document
         */
        lireDocActSigElecV2(idActe: string, idDocument: string): ng.IPromise<ICBusiness.Models.SignatureElectronique.IResultatLectureDocumentActeSignature>;
        /**
    ...
    class SignatureElectroniqueService implements ISignatureElectroniqueService {
         ...
         * @param idDocument identifiant IDN du document
         */
        lireDocActSigElecV2(idMySign: string, idIDN: string): ng.IPromise<ICBusiness.Models.SignatureElectronique.IResultatLectureDocumentActeSignature>;
        /**
