...
declare module Avenants.Rest.Services {
    interface IRestService {
        /**
         * Ex�cution de la requ�te GET, les donn�es r�cup�r�es sont mises en cache
         * @param urlService
         * @param params : param�tres dans le query
         * @param fromCache: optionnel: true par d�faut
         ...
         * @param urlService
         * @param data : donn�es dans le BODY
         * @param params: optionnel, param�tres dans le query
         * @param timeout: optionnel
         */
    ...
    class RestService implements IRestService {
        ...
        /**
         * Certains RetourQR n�cessitent un ajustement des donn�es pour avoir le comportement souhait�
        ...
        private isUrlRepondeur(urlService, urlRepondeur);
    }
}
