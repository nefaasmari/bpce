...
declare module GestionCreditApi.Controleur {
    class PopinJustificatifControleur implements MyWay.UI.ISelectionChangeHandler {
        ...
        constructor(data: Modeles.Justificatifs.PopinJustificatifDeblocageDeFonds, $modalInstance: ng.ui.bootstrap.IModalServiceInstance);
        ...
        /**
         * Permet de saoivir si on affiche le bouton de modification de justificatif ou non
         * @param indexJustificatif
         */
        estAfficheBoutonModificationJustificatif(indexJustificatif: number): boolean;
        /**
...
declare module GestionCreditApi.Modeles.Justificatifs {
    ...
    interface IElementJustificatif {
        ...
        montantJustifiePtzTravaux: number;
        /**
         * Montant justifié global pour un PTZ
         */
        montantJustifieGlobalPtz: number;
        /**
         * Montant à verser
         */
        montantAVerser: number;
    ...
    interface IDonneeVersementDossier {
        ...
        /**
         * Montant restant à justifier global, sur un dossier, après la prise en compte d'un nouveau justificatif, pour un PTZ (Pret à Taux Zéro)
         */
...
declare module GestionCreditApi.Modeles.Justificatifs {
    ...
    class NatureJustif implements INatureJustif {
        ...
        codeJustificatifPeriodique: string;
        codeNiveauJustificatif: string;
        constructor(codeClasseJustificatif: string, libelleCodeClasse: string, sousClasseJustificatif: string, libelleSousClasse: string, codeNatureJustificatif: string, libelleNatureJustificatif: string, codeCategorieJustificatif: string, libelleCategorieJustificatif: string, codeJustificatifPeriodique: string, codeNiveauJustificatif: string);
        static recupererListeNatureJustificatifInitialise(): Array<Modeles.Justificatifs.INatureJustif>;
    }
}
...
declare module GestionCreditApi.Modeles.Justificatifs {
    class PopinJustificatifDeblocageDeFonds {
         ...
         */
        estDernierJustificatif(index: number): boolean;
        justificatifAEteSaisie(index: number): boolean;
        /**
...
declare module GestionCreditApi.Services {
    class AuthentificationServices {
        private servicesAgentExtended;
        static $inject: string[];
        private authentificationInfo;
        constructor(servicesAgentExtended: MyWay.Services.ServiceAgentExtended);
        /**
...
declare module GestionCreditApi.Services {
    class JustificatifServices {
        ...
        ouvrirModalJustificatif(objetTuile: Modeles.Justificatifs.PopinJustificatifDeblocageDeFonds): ng.IPromise<any>;
        /**
         * Permet d'appeler le service rest de justificatifVersementDossier en POST
         * @param codeAction
         * @param justificatifs
         */
        postJustificatifVersementDossier(codeAction: Enums.CodeAction.JustificatifVersementDossier, justificatifs: Modeles.Justificatifs.IDonneeVersementDossier): ng.IPromise<Modeles.Justificatifs.IDonneeVersementDossier>;
    }
}
