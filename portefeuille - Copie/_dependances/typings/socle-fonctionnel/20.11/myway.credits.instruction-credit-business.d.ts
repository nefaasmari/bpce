...
declare namespace ICBusiness.Constantes {
    ...
    namespace ClasseNeo {
        ...
        /**
         * Identifiant de classe pour la liste des primo accedant ptz
         */
        const primoAccedantPtz: string;
        /**
...
declare namespace ICBusiness.Constantes {
    namespace Data {
        ...
        /**
         * Détail de l'objet financé: garanties achèvement
         */
        const listeGarantieAchevement: Models.Common.ICodeLabel<number>[];
    }
}
...
declare namespace ICBusiness.Constantes.ParametrageApplicatif {
    ...
    namespace Cegc {
        ...
        const trnasmissionCEGCActif: string;
        /**
...
declare namespace ICBusiness.Constantes.Projet {
    ...
    namespace ObjetFinance {
        ...
        const messageErrSurfaceHabitable: string;
        const maxSurfaceTerrain: number;
        const messageErrSurfaceTerrain: string;
        const minDateEntreePatrEtDateAcq: string;
        const maxDateEntreePatrEtDateAcq: string;
        const messageErrDateAcquisition: string;
        const messageErrDateEstimation: string;
...
declare namespace ICBusiness.Constantes {
    ...
    namespace SignatureElectronique {
        namespace Etat {
            const ETAT_SIGNATURE_DEMANDE: string;
        }
    }
}
...
declare namespace ICBusiness.Tools {
    class CodeLabel {
        ...
        static find<T extends string | number>(list: Models.Common.ICodeLabel<T>[], codeLabel: Models.Common.ICodeLabel<T>): Models.Common.ICodeLabel<T>;
    }
}
...
declare namespace ICBusiness.Tools {
    class Garantie {
         ...
         * @param garantie
         */
        static calculerMontantOuTauxCouvertureGlobale(garantie: Models.Garanties.IGarantie): void;
    }
}
...
declare namespace ICBusiness.Models.Garanties {
    ...
    interface IResultatTratiementCEGC {
...
declare namespace ICBusiness.Models.ProjetImmo {
    interface IProjetImmo extends Projet.IProjetCommun {
...
declare namespace ICBusiness.Models.ObjetFinance {
    ...
    interface IProjetImmobilier {
        ...
        codeMiseOeuvrProjetPro: Common.ICodeLabel<number>;
        pourcentageProprietaireApreOper: number;
        typeProprietaire: Common.ICodeLabel<number>;
    ...
    interface ITravauxFinances {
        ...
        typeLogementBatimentSous: Common.ICodeLabel<number>;
    ...
    interface IBatimentHabitableFinance {
        ...
        typeLogement1: Common.ICodeLabel<number>;
    ...
    interface IConstructionFinancee {
        idws: string;
        idTerrSousJacent: string;
        typeContratConstruction: Common.ICodeLabel<number>;
        typeLogement1: Common.ICodeLabel<number>;
        typeLogement: Common.ICodeLabel<string>;
        nombreLogementConstruction: number;
        ...
        surfHabitationCreeParConstruction: number;
        surfAnnx: number;
        presUneGarantieAcheTravaux: Common.ICodeLabel<number>;
    }
    ...
    interface IBienSousJacent {
        ...
        modeFinancier: Common.ICodeLabel<number>;
        natureGarnt: Common.ICodeLabel<number>;
        modeAcqsBien: Common.ICodeLabel<number>;
        surfTerr: number;
...
declare namespace ICBusiness.ModelsTransformers {
    ...
    class Emprunteur {
        ...
        private static getICodeLabelOrNull(code, label);
...
declare namespace ICBusiness.ModelsTransformers {
    ...
    class Garantie {
        ...
        private static defineModeFinancement(convention, estFinance, typeFraisGarantie);
        static mapListeGarantie(garantiesComplet: RestModel.SchemaComplet.IGarantieComplet[], creditInternes: RestModel.SchemaComplet.ICreditInterneComplet[]): BusinessModel.IGarantieBase[];
        ...
        static mapResultatCEGC(result: ICRest.Modeles.TraiterReponseCEGC.IResultatTraitementCegc): Models.Garanties.IResultatTratiementCEGC;
    }
}
...
declare namespace ICBusiness.ModelsTransformers {
    ...
    class Projet {
         ...
         * @param bienFinance Partie bien finance du projet
         */
        static mapProjetImmo(projet: RestModel.SchemaComplet.IProjetImmobilierComplet): Models.ProjetImmo.IProjetImmo;
        /**
        ...
        static mapProjetImmobilierMaj(data: Models.ProjetImmo.IProjetImmo, isPro: boolean): ICRest.Modeles.MajElements.IProjetImmobilierMaj;
        ...
        static mapDescriptionProjetMajRequest(idProjet: string, canalRelation: string, origineCommerciale: number, typeVente: number, hasPrescripteur: boolean): ICRest.Modeles.MajElement.IDossierMaj;
        static mapProjetImmobilierLecture(projetImmobilier: ICRest.Modeles.LireElement.IProjetImmobilierLecture): Models.Projet.IProjetImmobilierLecture;
        static mapProjetImmoMaj(idProjet: string, codeConditionDerogationPourPtz: number, projImm: Models.Projet.IProjetImmobilierLecture): ICRest.Modeles.MajElements.IProjetImmobilierMaj;
    }
}
...
declare namespace ICBusiness.Services.Decision {
    interface IDecisionService {
        ...
        /**
         * Donne la liste des avis
         * @param identifiantDossier
         */
        getAvis(identifiantDossier: string): ng.IPromise<Models.Decision.IAvis[]>;
        /**
         * Méthode pour calculer le niveau de délégation de décision d'un agent
         * @param idDossier
         * @param idAgent
         */
        calculerDelegationDecision(idDossier: string, idAgent: string): ng.IPromise<Models.Decision.IResultatCalculDelegation>;
    }
...
declare namespace ICBusiness.Services.Dossier {
    interface IDossierService {
         ...
         */
        creerDossier(dateDeTraitement: string, canalDeCreation: string, codeApplication: Enum.CodeApplicationEnum, codeDevise: string, pourLeCompteDe?: string): ng.IPromise<Models.Dossier.IDossierSchema>;
    ...
    class DossierService implements IDossierService {
        ...
        private schemaService;
        static $inject: string[];
        constructor(dossierService: ICRest.Services.Dossier.IDossierService, syntheseService: ICRest.Services.Synthese.ISyntheseService, elementService: ICRest.Services.Element.IElementService, schemaService: ICRest.Services.Schema.ISchemaService);
        creerDossier(dateDeTraitement: string, canalDeCreation: string, codeApplication: Enum.CodeApplicationEnum, codeDevise: string, pourLeCompteDe?: string): ng.IPromise<Models.Dossier.IDossierSchema>;
        creerDossierAvecProjetImmo(dateDeTraitement: string, canalDeCreation: string, codeDevise: string, idClientBanquaire: string, pourLeCompteDe?: string): ng.IPromise<Models.Dossier.IDossierSchema>;
        validerAccordClient(idDossier: string, idPlanFinancement: string): ng.IPromise<void>;
        sauverDossier(idDossier: string): ng.IPromise<void>;
...
declare namespace ICBusiness.Services.Dossier {
    interface IEtatDossierService {
        ...
        getSousEtatDossierPourTransfertConformité(): Enum.SousEtatDossier[];
...
declare namespace ICBusiness.Services.Dossier {
    interface IParametresService {
         ...
         * @param identifiantDossier
         */
        getListePrimoAccedantPtz(identifiantDossier: string): ng.IPromise<Models.Common.ICodeLabel<number>[]>;
        /**
         * Renvoie la liste des statuts d'occupation logement
         * @param identifiantDossier
         */
        getListeStatutOccupationLogement(identifiantDossier: string, conditionDerogatoirePtz: number): ng.IPromise<Models.Common.ICodeLabel<number>[]>;
        /**
    ...
    type FiltreListerConstante = "FiltrePrimoPTZ" | "FiltreStatutOccupationLogement" | "FiltreUsageDuBien" | "FiltreModeOccupation" | "FiltreCadreFiscal" | "FiltrePerformanceEnergetique" | "FiltreCategorieEmprunteur";
...
declare namespace ICBusiness.Eds.Services {
...
declare namespace ICBusiness.Services.Emprunteur {
    interface IEmprunteurService {
        ...
        mettreAJourIntervenants(identifiantDossier: string, emprunteur: Models.Emprunteur.IEmprunteur, surfaceFinanciere: Models.Emprunteur.ISurfaceFinanciere, encours?: Models.MontantEncoursEpargneLogement.IEncoursEpargneLogement, pourLeCompteDe?: string): ng.IPromise<void>;
...
declare namespace ICBusiness.Services.Financement {
    interface IAccessoiresService {
        ...
        listeTiersReversement(dateTraitement: string, codeEtablissement: string, typeRolePersonne: string, intitule: string, codePostal: string): ng.IPromise<Array<Models.Financement.IListerTiersAccesoire>>;
    ...
    class AccessoiresService implements IAccessoiresService {
        ...
        static $inject: string[];
        private dateVide;
        constructor($q: ng.IQService, accessoiresService: ICRest.Services.Dossier.IAccessoiresService, catalogueService: ICRest.Services.Dossier.ICatalogueService, elementsService: ICRest.Services.Element.IElementService, planFinancementService: ICBusiness.Services.Financement.IPlanFinancementService, creditParam: ICRest.CreditParametre.Services.ICreditParametreService, creditPhaseService: ICBusiness.Services.Financement.ICreditPhaseService);
        ajouterAccessoireLieProduit(idDossier: string, idCredit: string, codeTypeAccessoire: string): ng.IPromise<Models.Financement.IIdentifiantsAccessoire>;
        ajouterAccessoireComplementaire(idDossier: string, idCredit: string, codeTypeAccessoire: string, codeSousTypeAccessoire: string): ng.IPromise<Models.Financement.IIdentifiantsAccessoire>;
        supprimerAccessoire(idDossier: string, idAccessoire: string): ng.IPromise<void>;
        listerAccessoiresDisponibles(idDossier: string, idCredit: string): ng.IPromise<Models.Financement.IFrais[]>;
        ...
        listeTiersReversement(dateTraitement: string, codeEtablissement: string, typeRolePersonne: string, intitule: string, codePostal: string): ng.IPromise<Array<Models.Financement.IListerTiersAccesoire>>;
        supprimerTiersReversement(idDossier: string, idAccessoire: string): ng.IPromise<void>;
        private setMontantTauxAccessoire(montant, taux, idCatlParametreRverTiers, codeSousTypeAccessoire, accessoire);
        updateAccessoireControles(idDossier: string, accessoire: Models.Financement.IAccessoire): ng.IPromise<Models.Financement.IAccessoire>;
        updateAccessoirePhaseControlesValue(idDossier: string, accessoire: Models.Financement.IAccessoire): ng.IPromise<Models.Financement.IAccessoire>;
    }
}
...
declare namespace ICBusiness.Services.Financement {
    interface ICreditService {
         ...
         * @param idCredit
         */
        getCreditInterneSansAccessoires(idDossier: string, idCredit: string, planFinancementId: string, dateTraitement: string, codeEtablissement: number): ng.IPromise<Models.Financement.ICreditInterne>;
        /**
    ...
    class CreditService implements ICreditService {
        ...
        private creditParametreService;
        static $inject: string[];
        constructor($q: ng.IQService, creditService: ICRest.Services.Dossier.CreditService, elementService: ICRest.Services.Element.IElementService, schemaService: Services.Common.IElementSchemaService, creditParametreService: ICRest.CreditParametre.Services.ICreditParametreService);
        ajouterCreditInterne(idDossier: string, idPlanFinancement: string, idProduit: string, montantEmprunte: number, initMontant: boolean, enOptim: boolean, tauxMontage: number): ng.IPromise<Models.Financement.ICreditInterne>;
        majCreditInterne(idDossier: string, credit: Models.Financement.ICreditInterne): ng.IPromise<void>;
        supprimerCreditInterne(idDossier: string, idCredit: string): ng.IPromise<void>;
        calculerCreditInterne(idDossier: string, idCredit: string, financeRaf?: boolean): ng.IPromise<Models.Financement.ICalculCredit>;
...
declare namespace ICBusiness.Services.Financement {
    ...
    class EditerDocumentsService implements IEditerDocumentsService {
        ...
        static $inject: string[];
        constructor(editerDocumentsService: ICRest.Services.Dossier.EditerDocumentsService);
        editerTableauAmortissement(idDossier: string, idDocument: string): ng.IPromise<Models.Financement.ITableauAmortissement>;
    }
}
...
declare namespace ICBusiness.Services.Financement {
    ...
    interface IPlanFinancementService {
        ...
        getPlanFinancementComplet(idDossier: string): ng.IPromise<RestModel.SchemaComplet.IPlanFinancementComplet>;
    ...
    class PlanFinancementService implements IPlanFinancementService {
        ...
        private dossierService;
        static $inject: string[];
        constructor(planFinancementService: ICRest.Services.PlanFinancement.IPlanFinancementService, schemaService: Services.Common.IElementSchemaService, elementService: ICRest.Services.Element.IElementService, dossierService: ICRest.Services.Schema.ISchemaService);
        ajouterPlanFinancement(idDossier: string, idProjet: string): ng.IPromise<Models.Financement.IRetourPlanFinancementAjout>;
        majPlanFinancement(idDossier: string, data: Models.Financement.IPlanFinancementMajRequest): ng.IPromise<void>;
        /**
         * Utilisé dans accessoire service et permet d'éviter de faire tout le traitement du plan financier et de se concentrer uniquement sur l'accessoire que l'on souhaite
         * @param idDossier
         */
        getPlanFinancementComplet(idDossier: string): ng.IPromise<RestModel.SchemaComplet.IPlanFinancementComplet>;
        lirePlanFinancement(idDossier: string): ng.IPromise<Models.Financement.IPlanFinancement>;
...
declare namespace ICBusiness.Services.Financement {
    ...
    class ProduitService implements IProduitService {
        ...
        static $inject: string[];
        constructor(produitService: ICRest.Services.Produit.IProduitService);
        listerProduits(idDossier: string, idProjet: string, idPlanFinancement: string, codeDevise: string): ng.IPromise<Models.Financement.IFamilleProduit[]>;
    }
}
...
declare namespace ICBusiness.Services.Garanties {
    ...
    interface IGarantiesService {
         ...
         */
        loadGarantie(idDossier: string, dateTraitement: string, codeEtab: string, idGarantie: string, idPlanFi: string, excludeListerConvention?: boolean): ng.IPromise<Models.Garanties.IGarantie>;
        /**
         * Liste les garanties
         * @param idDossier
         */
        ...
        traiterReponseCEGC(idDossier: string): ng.IPromise<Models.Garanties.IResultatTratiementCEGC>;
    ...
    class GarantiesService implements IGarantiesService {
         ...
         */
        private getObjetPorteEnGarantieMajAndVersementPromise(idDossier, bienPorte, bienPorteOrigine);
...
declare namespace ICBusiness.Services.ImpressionService {
    interface IImpressionService {
        ...
        lireBase64PdfWithIdDossier(fluxDonnees: Blob, nomDocument: string, idDossier: string): MyWay.Services.IPromesse<void>;
        lireBase64Pdf(fluxDonneesString: string, nomDocument: string): MyWay.Services.IPromesse<void>;
    ...
    class ImpressionService implements IImpressionService {
        ...
        editerDocument(idDossier: string, idDocument: string, identifiantWs: string, paramsEditiques: ICRest.Impression.Models.IParamEditique[], niveauTraitement: number, modeEdition: number, formatEditique: number, codeSignature: number, forceControleGestion: boolean, forceControleEdition?: boolean): ng.IPromise<ICBusiness.Models.Impression.IImpression>;
        editerOffrePret(idDossier: string, idDocument: string, identifiantWs: string, paramsEditiques: any[], niveauTraitement: number, modeEdition: number, formatEditique: number, codeSignature: number, forceControleGestion: boolean, forceControleEdition?: boolean): ng.IPromise<ICBusiness.Models.Impression.IImpression>;
        convertirBase64Pdf(fluxDonnees: string, nomDocument: string, idDossier: string): MyWay.Services.IPromesse<void>;
        lireBase64PdfWithIdDossier(fluxDonnees: Blob, nomDocument: string, idDossier: string): MyWay.Services.IPromesse<void>;
        lireBase64Pdf(fluxDonneesString: string, nomDocument: string): MyWay.Services.IPromesse<void>;
        /**
...
declare namespace ICBusiness.Services.Projet {
    interface IObjetFinanceService {
         ...
         */
        majDetailObjetFinance(identifiantDossier: string, detailInitial: Models.ObjetFinance.IDetailObjetFinance, projet: Models.ObjetFinance.IProjetImmobilier, batimentHabitableFinance: Models.ObjetFinance.IBatimentHabitableFinance, constructionFinancee: Models.ObjetFinance.IConstructionFinancee, travauxFinances: Models.ObjetFinance.ITravauxFinances, terrainFinance: Models.ObjetFinance.ITerrainFinance, soulteFinance: Models.ObjetFinance.ISoulteFinance, bienSousJacent: Models.ObjetFinance.IBienSousJacent): ng.IPromise<void>;
    }
    class ObjetFinanceService {
        private appelSGFGASService;
        private elementService;
        static $inject: string[];
        constructor(appelSGFGASService: ICBusiness.Services.Financement.IAppelSGFGASService, elementService: ICRest.Services.Element.IElementService);
        getDetailObjetFinance(identifiantDossier: string, projetId: string, emprunteurId: string, listIdws: string[]): ng.IPromise<Models.ObjetFinance.IDetailObjetFinance>;
        majDetailObjetFinance(identifiantDossier: string, detailInitial: Models.ObjetFinance.IDetailObjetFinance, projet: Models.ObjetFinance.IProjetImmobilier, batimentHabitableFinance: Models.ObjetFinance.IBatimentHabitableFinance, constructionFinancee: Models.ObjetFinance.IConstructionFinancee, travauxFinances: Models.ObjetFinance.ITravauxFinances, terrainFinance: Models.ObjetFinance.ITerrainFinance, soulteFinance: Models.ObjetFinance.ISoulteFinance, bienSousJacent: Models.ObjetFinance.IBienSousJacent): ng.IPromise<void>;
    }
}
...
declare var projetComplet: {
    "listeElementComplet": {
        ...
        "ensgnPres": string;
        "libelleLong1": string;
        "libelleCanalDeDistribution": any;
        "libelleOrigineCommissionProjet": string;
        "libelleMiseEnOeuvre": string;
        "libelleTechniqueVente": string;
        "montantEstmVenl": number;
        ...
        "listeCritereEligibiliteFEI": any;
        "critereEligibiliteFEI": string;
        "bienAVendreComplet": any;
        "typeObjetFinancier": string;
        "typeObjetRegle": string;
        "coutTotalObjet": number;
        "description": string;
        "bienConsommationFinance": any;
        "bienEquipementProComplet": any;
...
declare namespace ICBusiness.Services.Projet {
    interface IProjetService {
         ...
         * @param idProjet Identifiant du projet
         */
        definirProjet(idDossier: string, typeObjetCommercial: string, typeObjetReglemente: string, natureProjet?: Enum.NatureProjetEnum): ng.IPromise<void>;
        /**
         * Recupere les donnees de description d'un projet.
         * @param idDossier L'identifiant du dossier concerne.
         */
         ...
         * @param idDossier L'identifiant du dossier concerne.
         */
        getProjetImmobilier(idDossier: string): ng.IPromise<Models.Projet.IProjet>;
        /**
        ...
        getProjetImmobiliersByProjects(identifiantDossier: string, idsProjet: string[]): ng.IPromise<Models.Projet.IProjetImmobilierLecture[]>;
        mettreAJourProjetImmobilier(identifiantDossier: string, idProjet: string, emprunteur: Models.Emprunteur.IEmprunteur): ng.IPromise<void>;
        updateProjetImmo(idDossier: string, projet: Models.ProjetImmo.IProjetImmo, updateProjet: boolean, updateBienFinance: boolean): ng.IPromise<void>;
    }
...
declare namespace ICBusiness.Services.RedacteurActe {
    interface IRedacteurActeService {
         ...
         * @param dossier
         */
        mettreAJourDatePrevisionnelleSignatureNotaire(idDossier: string, datePrevSigneNotaire: string, pourLeCompteDe?: string): ng.IPromise<void>;
        /**
...
declare namespace ICBusiness.Services.SignatureElectronique {
    interface ISignatureElectroniqueService {
         ...
         */
        annulerActSigneElecGen(idDossier: string, codeSignature: number, motifAnnulation: string): ng.IPromise<void>;
...
declare namespace ICBusiness.Services.SuivisPlanifies {
    ...
    interface ISuivisPlanifiesService {
        ...
        updateSuiviPlanifie(idDossier: string, sP: Models.SuivisPlanifies.ISuivisPlanifies, pourLeCompteDe?: string): ng.IPromise<void>;
...
declare namespace ICBusiness.Services.TransfertBo {
    ...
    class TransfertBoService implements ITransfertBoService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, transfertDecisionService: ICRest.Services.TransfertDecision.ITransfertDecisionService);
        /**
...
declare namespace ICBusiness.Services.TransfertDecision {
    ...
    class TransfertDecisionService implements ITransfertDecisionService {
        private transfertDecisionService;
        static $inject: string[];
        constructor(transfertDecisionService: ICRest.Services.TransfertDecision.ITransfertDecisionService);
        /**
...
declare namespace ICBusiness.Services.Transfert {
    ...
    class TransfertService implements ITransfertService {
         ...
         * @param bLancerControleDossier
         */
        private transfererDossierViaIdentifiant(typeTransfert, idDossier, infoTransfert, bLancerControleDossier);
    }
}
