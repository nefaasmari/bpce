...
declare namespace ICCreditComponents.Services {
    ...
    class EditionOffreService implements IEditionOffreService {
        ...
        /**
         * Méthode pour créer un IInfoDocument depuis IImpression
         * @param flux
         */
        private creerInfoDocument(doc, flux);
        /**
...
declare namespace ICCreditComponents.Services {
    ...
    class PrendreDecisionPreteur implements IPrendreDecisionPreteur {
        ...
        private popinService;
        retourControleDecision: ICBusiness.Models.Dossier.IControleDossier;
        anomalieNonBloquante: boolean;
        static $inject: string[];
        constructor(controleSyntheseService: ICCreditComponents.Controle.IControleSyntheseService, popinService: ICCreditComponents.Services.IPopinService);
        controleAvantDecision(dateInstruction: string, idDossier: string): ng.IPromise<ICBusiness.Models.Dossier.IControleDossier>;
        /**
...
declare namespace ICCreditComponents.Services {
    interface IFooterCreditService {
        ...
        transfererPourDecisionAction(delegate: () => ng.IPromise<void>): void;
        transfererPourDecisionVisible(delegate: () => boolean): void;
        transfererPourConformiteAction(delegate: () => ng.IPromise<void>): void;
        transfererPourConformiteVisible(delegate: () => boolean): void;
        transfererPourBoAction(delegate: () => ng.IPromise<void>): void;
        transfererPourBoVisible(delegate: () => boolean): void;
    ...
    class FooterCreditService implements IFooterCreditService {
        ...
        private _transfererPourBoVisible;
