...
declare namespace ContentieuxDirectives.Services.OptionEditique {
    interface IOptionEditiqueService {
        ouvrirModaleModifierOptionEditique(adresse: ContentieuxServices.Modeles.Personne.IAdressePostale, afficherSignatureGestionnaire: boolean, optionSignature: boolean, afficherBlocDecouvertAutorise: boolean, optionBlocDecouvertAutorise: boolean): ng.IPromise<[ContentieuxServices.Modeles.Personne.IAdressePostale, boolean, boolean]>;
    }
    class OptionEditiqueService implements IOptionEditiqueService {
        ...
        static $inject: string[];
        constructor($q: ng.IQService, modalService: MyWay.UI.IModalService);
        ouvrirModaleModifierOptionEditique(adresseCourrier: ContentieuxServices.Modeles.Personne.IAdressePostale, afficherSignatureGestionnaire: boolean, optionSignature: boolean, afficherBlocDecouvertAutorise: boolean, optionBlocDecouvertAutorise: boolean): ng.IPromise<[ContentieuxServices.Modeles.Personne.IAdressePostale, boolean, boolean]>;
    }
}
...
declare namespace ContentieuxDirectives {
    class ModificationEvenementModalControleur {
        ...
        constructor($modalInstance: angular.ui.bootstrap.IModalServiceInstance, noteAlerteService: ContentieuxServices.Services.Agenda.INoteAlerteService, evenementAModifier: ContentieuxServices.Modeles.Agenda.IEvenementAgenda, $scope: ng.IScope);
...
declare namespace ContentieuxDirectives {
    class OptionEditiqueModalControleur {
        ...
        constructor($modalInstance: angular.ui.bootstrap.IModalServiceInstance, adresseCourrier: ContentieuxServices.Modeles.Personne.IAdressePostale, afficherSignatureGestionnaire: boolean, optionSignature: boolean, afficherBlocDecouvertAutorise: boolean, optionBlocDecouvertAutorise: boolean);
        valider(): void;
        annuler(): void;
        fermer(): void;
    }
