...
declare module GestionCreditApi.Controleur {
    class PopinJustificatifControleur implements MyWay.UI.ISelectionChangeHandler {
        ...
        private popinInitial;
        constructor(data: Modeles.Justificatifs.PopinJustificatifDeblocageDeFonds, $modalInstance: ng.ui.bootstrap.IModalServiceInstance, authentificationServices: Services.AuthentificationServices, justificatifServices: Services.JustificatifServices);
        /**
         * Appel getJustVersementDossier et stock la valeur
         */
        private recuperationValeurJustificatifsEnregistre();
         ...
         */
        valider(): void;
        private changementTypeJustificatif();
        /**
...
declare module GestionCreditApi.Modeles.Justificatifs {
    class DonneeVersementDossier implements IDonneeVersementDossier {
        ...
        constructor(infosJustificatifsRecu: Modeles.Justificatifs.IVersementDossierGlobal, popin: Modeles.Justificatifs.PopinJustificatifDeblocageDeFonds, numeroUser: string, identifiantCaisse: number);
        private ajoutValeurJustificatif(popin, numeroUser, identifiantCaisse);
...
declare module GestionCreditApi.Modeles.Justificatifs {
    class PopinJustificatifDeblocageDeFonds {
        ...
        codeDevise: string;
        constructor(montants: MontantGlobaux, codeDevise: string, estDejaTraite: boolean);
        /**
...
declare module GestionCreditApi.Services {
    class JustificatifServices {
         ...
         * @param justificatifs
         */
        getJustificatifVersementDossier(codeEtablissement: string, identifiantCredit: string, identifiantDossierGestion: string): ng.IPromise<Modeles.Justificatifs.IVersementDossierGlobal>;
        /**
...
declare module GestionCreditApi.Services {
    class RestServices {
         ...
         */
        getJustificatifDossier(codeEtablissement: string, identifiantDossierGestion: string, identifiantCredit: string, dateTraitement: string): ng.IPromise<Modeles.Justificatifs.IVersementDossierGlobal>;
        /**
...
declare module GestionCreditApi.Directives {
    class DetailControleJustificatifControleur {
        ...
        constructor();
        estAuthoriseModifierMontantJustifie(): boolean;
