...
declare module ApiInstuctionCredit.Outils {
    class OutilDate {
        ...
        /**
         * Récupération la date au format YYYY-MM-DD
         * @param date
         */
        static getDateFormatYYYYMMDD(date: string): string;
        /**
         * Controle si la date est supérieur à la date du jour, si oui renvoie la date du jour
         * @param date
         */
        static controleDateDuJour(date: string): string;
        static isBeforeDateDuJour(date: string): boolean;
    }
}
...
declare module ApiInstuctionCredit.Modele {
    class PiecoBuilder {
         ...
         * @param oProcessus
         */
        private getHistControle(histControles, oProcessus);
...
declare module ApiInstuctionCredit {
    ...
    class PiecoControlesControleur {
         ...
         * @param controle
         */
        getClassAncienEtat(controle: ApiModel.IControleManuelDescription): string;
    }
}
