...
declare module GestionGeneriqueOffres.Services {
    ...
    class CatalogueAjaxImplService implements ICatalogueService {
        ...
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgent, qService: ng.IQService, parametrageBlocsService: Services.IParametrageBlocsService, tiersService: Services.TiersService, entiteTitulaireService: Services.IEntiteTitulaireService, offreDonneesService: Services.OffreDonneesService);
        /**
         * Requête d'appel du web service avec le verbe d'action GET
         * @author S0076105
         * @param Objet contenant les champs permettant d'effectuer l'appel au web service
    ...
    class CatalogueMockImplService implements ICatalogueService {
        ...
        private static _instanceReferencesProduits;
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgent, mockLoaderService: GestionGeneriqueOffres.Services.MockLoaderService, qService: ng.IQService, parametrageBlocsService: Services.IParametrageBlocsService, tiersService: Services.TiersService, entiteTitulaireService: Services.IEntiteTitulaireService, offreDonneesService: Services.OffreDonneesService);
        /**
         * Requête d'appel du web service avec le verbe d'action GET
         * @author S0076105
         * @param Objet contenant les champs permettant d'effectuer l'appel au web service
...
declare module GestionGeneriqueOffres.Services {
    class GestionEditiqueService {
        ...
        contractualisationActe: myway.comContract.ContractualisationActe.Modeles.IContractualisationActe;
...
declare module GestionGeneriqueOffres.Services {
    /**
     * Interface de définition de la ressource élémentaire "entretiencommercial/resultatEntretien".
     */
    interface IEntretienCommercialService {
        sendPostRequest(entretienCommercial: Types.IResultat): ng.IPromise<Types.IResultat>;
    }
    /**
     * Classe permettant d'effectuer la communication avec la ressource REST "entretiencommercial/resultatEntretien".
     */
    class EntretienCommercialAjaxImplService implements IEntretienCommercialService {
        private serviceAgent;
        private qService;
        private static _instance;
        static $inject: string[];
         ...
         * Permet aux différents composants de l'application (directives/services/controleurs ...) de récupérer les données
         * chargées via sendPostRequest
         * @return Objet EntretienCommercial
         */
        getEntretienCommercial(): Types.Resultat;
        /**
         * Méthode de construction de l'url du web service
         * @return L'url du web service
         */
    ...
    class EntretienCommercialService {
        static entretienCommercialServiceId: string;
    }
}
...
declare module GestionGeneriqueOffres.Composition {
    ...
    class RecapitulatifSection {
        ...
        private contexteGgoStockageService;
        private catalogueService;
        referenceProduitPrincipalOffre: Types.ReferenceProduitPrincipalOffre;
        modeAcces: string;
        modeAffichage: string;
        compatibiliteTarification: boolean;
        compositionOffre: Types.CompositionOffre;
...
declare module GestionGeneriqueOffres.Services {
    ...
    class SauvegardeContexteService implements ISauvegardeContexteService {
        ...
        constructionContexteContractualisation(): myway.comContract.ContractualisationActe.Modeles.IContractualisationActe;
...
declare module GestionGeneriqueOffres.Types {
    ...
    class Resultat {
        ...
        indicProduitServiceObligatoire: string;
        constructor(resultat: IResultat);
    }
}
...
declare module GestionGeneriqueOffres.Constantes {
    ...
    class Evenements {
         ...
         * Activation/désactivation du mode debug
         */
        static DESACTIVER_BLOQUEUR: string;
        /**
