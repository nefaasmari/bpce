...
declare module GestionGeneriqueOffres.Types {
    ...
    class DonneesContextuelles {
         ...
         */
        donneesGeneriquesTousProduits: DossierDeVente[];
        ...
        constructor(modeAcces: ModeAcces, modeAffichage: ModeAffichage, contexteAppel: ContexteAppel, personnes: Personne[], entitesTitulaires: InformationEntiteTitulaire[], offreSouscrite: OffreSouscrite, etablissement: Etablissement, dossierVente: DossierDeVente[], donneesGeneriquesTousProduits: DossierDeVente[], donneesGeneriques: Types.DonneesGeneriques, catalogue: Types.CatalogueNode, composition: Types.CompositionOffre, donneesMiseEnGestion: Types.DonneesMiseEnGestion[], donneesProduit: DonneesProduit, referencesProduits: ReferenceProduit[], listeSignataires: myway.comContract.modeles.ISignataireComplet[], lienVersComposition: Types.CompositionOffreProduit);
    }
}
