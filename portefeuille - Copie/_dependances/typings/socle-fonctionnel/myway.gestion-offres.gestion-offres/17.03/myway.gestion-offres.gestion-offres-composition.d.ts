...
declare module GestionGeneriqueOffres.Services {
    interface IActionsService {
        /**
         * Renvoie vrai si un bouton existe déjà dans la barre
         * @param {string} id : l'id du bouton recherché
         * @returns vrai si l'id a été trouvé, faux sinon
         */
        actionExiste(id: string): boolean;
        /**
...
declare module GestionGeneriqueOffres.Services {
    class GestionEditiqueService {
        ...
        /**
         * Calcul de l'acte de gestion associé au compte support de l'offre
         * @returns Acte de gestion associé au compte support de l'offre
         */
        private getActeGestionCompteSupport();
...
declare module GestionGeneriqueOffres.Composition {
    ...
    class TarificationControleur implements ITarificationControleur {
        ...
        private _activationBoutonDetailsEnCours;
        private _activationBoutonPersonnaliserEnCours;
        private _listeConditionNegociable;
        private _messageErreur;
        static $inject: string[];
        /**
         * @ngdoc constructor
        ...
        activationAffichageApresNego: boolean;
        ...
        getListeConditionNegociable(): ng.IPromise<{}>;
        getAvenantConditionNegociable(): ng.IPromise<{}>;
        getTarificationDetailsPopin(): void;
        getTarificationPersonnalisationPopin(): void;
        /**
         * Pop-in Details pour Offres Hors Bouquet Liberté
         */
        getTarificationDetailsPopinHBL(): void;
        /**
         * Pop-in Personnalisation pour Offres Hors Bouquet Liberté
         */
        getTarificationPersonnalisationPopinHBL(): void;
    }
}
...
declare module GestionGeneriqueOffres.Composition {
    ...
    class TarificationModaleControleur {
        ...
        promotionsManuelles: Types.CodePromotionManuelle[];
        tarificationOffreSynthese: any;
        valider(): void;
        retour(): void;
        terminerTraitementEnErreur(message: string): void;
...
declare module GestionGeneriqueOffres.Composition {
    interface ITarificationModaleHBLScope extends ng.IScope {
        modalDatas: any;
        estCalculPossible: boolean;
        estConditionNegociableModifie: boolean;
        tauxReduction: number;
        tauxApplication: number;
        estConditionModifie: boolean;
    }
    class TarificationModaleHBLControleur {
        private $scope;
        private data;
        private $modalInstance;
        private constantes;
        ...
        tauxApplication: number;
        estConditionModifie: boolean;
        constructor($scope: ITarificationModaleHBLScope, data: any, $modalInstance: ng.ui.bootstrap.IModalServiceInstance, constantes: GestionGeneriqueOffres.Constantes.Definitions);
        valider(): void;
        retour(): void;
        terminerTraitementEnErreur(message: string): void;
        majTaux($item: any, $model: any): void;
        calculTaux(application: boolean): void;
        calculApresNego(): void;
...
declare module GestionGeneriqueOffres.Services {
     ...
     */
    interface ITarificationOffreConditionService {
        estChange: boolean;
        compteSelectionne: MyWay.Model.Contrat;
        conditionSelectionne: Types.IConditionNegociable;
        getListeConditionNegociable(datas: any): ng.IPromise<{}>;
        getAvenantConditionNegociable(datas: any): ng.IPromise<{}>;
        putConditionNegociable(datas: Types.IConditionNegocOffre): any;
        postConditionNegociable(datas: Types.IConditionNegocOffre): any;
    }
    /**
     * Classe permettant d'effectuer la communication avec la ressource REST "tarification\tarificationOffreDetail".
     */
    class TarificationOffreConditionService implements ITarificationOffreConditionService {
        private constantes;
        private modalService;
        private serviceAgent;
        private $q;
        ...
        compteSelectionne: MyWay.Model.Contrat;
        conditionSelectionne: Types.IConditionNegociable;
        static tarificationOffreConditionServiceId: string;
        static $inject: string[];
        constructor(constantes: GestionGeneriqueOffres.Constantes.Definitions, modalService: MyWay.UI.IModalService, serviceAgent: MyWay.Services.ServiceAgent, $q: ng.IQService);
        /**
         * Requête d'appel de la ressource avec le verbe d'action GET
         * @param Objet contenant les champs permettant d'effectuer l'appel
         * @return Une promesse contenant la réponse
         */
        getListeConditionNegociable(datas: any): ng.IPromise<Types.IConditionNegociable[]>;
        postConditionNegociable(datas: Types.IConditionNegocOffre): ng.IPromise<{}>;
        putConditionNegociable(datas: Types.IConditionNegocOffre): ng.IPromise<{}>;
        getAvenantConditionNegociable(datas: any): ng.IPromise<{}>;
    }
}
...
declare module GestionGeneriqueOffres.Services {
    interface ITarificationOffreService {
        ...
        getPromotionManuelle(): ng.IPromise<Types.IPromotionManuelle>;
        getPromotionCaisseEtSystematique(): ng.IPromise<{}>;
        getCodePrestation(): number;
    }
    /**
     * Classe permettant d'effectuer la communication avec la ressource REST "tarification/tarificationOffrePromotion".
     */
    class TarificationOffreService implements ITarificationOffreService {
        ...
        private promotionManuelleService;
        estModifie: boolean;
        activationBoutonValider: boolean;
        activationBoutonCalculer: boolean;
        promotionsApresBestOf: Types.IPromotionAppliquee[];
        ...
        getPromotionManuelle(_date?: any): ng.IPromise<Types.IPromotionManuelle>;
...
declare module GestionGeneriqueOffres.Types {
    ...
    class DonneesInitiales {
        ...
        /**
         * Le dossier de vente (VAD seulment)
         */
         ...
         */
        etatNav: EtatNav;
        constructor(etatNav: EtatNav, entitesTitulaires: Types.InformationEntiteTitulaire[], personnes: Types.Tiers.Personne[], catalogue: CatalogueNode, contexteGgo: Types.ContexteGgo, dossierVente: Types.DossierVente);
    }
}
...
declare module GestionGeneriqueOffres.Types {
    ...
    class CodePromotionManuelle {
        ...
        typePSSocleComplementaire: string;
        libelleRemise: string;
        constructor(codePromotionManuelle: Types.ICodePromotionManuelle);
    }
}
