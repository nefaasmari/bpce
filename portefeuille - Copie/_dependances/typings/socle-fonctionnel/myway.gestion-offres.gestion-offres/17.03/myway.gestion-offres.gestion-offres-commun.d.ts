...
declare module GestionGeneriqueOffres.Types {
    ...
    class CompositionOffre {
         ...
         */
        testerAssemblageDejaDetenu: (assemblage: Types.CatalogueNode, detenteur: Types.InformationEntiteTitulaire | Types.Tiers.Personne, testFunc?: (compositionOffreProduit: Types.CompositionOffreProduit) => boolean) => Types.CompositionOffreProduit[] | Types.CompositionOffreProduit;
        /**
