...
declare module GestionGeneriqueOffres.Services {
    ...
    class GestionDossierVenteAjaxImplService implements IGestionDossierVenteService {
        ...
        private static _instance;
        static $inject: string[];
        constructor(serviceAgent: MyWay.Services.ServiceAgent, qService: ng.IQService, commentaireService: Services.CommentaireService);
        /**
         * Méthode de restitution du dossier de vente
         * @param {IGestionDossierVenteGetDossierVenteQuery} data : Les données à passer en entrée de la ressource, dont notamment
         * l'identifiant du dossier de vente.
...
declare module GestionGeneriqueOffres.Services {
    interface IActionsService {
        ...
        /**
         * Initialise la barre d'actions depuis le dossier de vente
         */
        initialiserDepuisDossierDeVente(listeActionPossible: Types.DossierDeVente.ActionPossible[]): void;
    }
    class ActionsService implements IActionsService {
        ...
        /**
         * Initialise la barre d'actions depuis le dossier de vente
         * @param {Types.DossierDeVente.ActionPossible[]} listeActionPossible Les actions renvoyées par le dossier de vente
         * @returns rien
         */
        initialiserDepuisDossierDeVente: (listeActionPossible: Types.DossierDeVente.ActionPossible[]) => void;
        constructor(constantes: GestionGeneriqueOffres.Constantes.Definitions);
...
declare module GestionGeneriqueOffres.Services {
    interface ISauvegardeDossierVenteService {
         ...
         *
         * Seul le paramètre codeActionContexte est obligatoire, il correspond au code action sur 4 positions (INIT, ENRG etc).
         ...
         */
        sauvegarder(codeActionContexte: string, indicateurEnvoiMail?: string, indicateurExemplairePapier?: string, modeEnvoiDocumentPapier?: string, indicateurImpressionEffectuee?: string, codeRetourAppliExterne?: string, valeurReponseAppliExterne?: string, indicateurBlocageFinalisation?: string, indicateurExecutionImmediate?: string, indicateurGestionPiece?: string): ng.IPromise<Types.DossierDeVente.GestionDossierVente>;
    }
...
declare module GestionGeneriqueOffres.Composition {
    ...
    class TitrePrincipal {
        ...
        constructor($scope: ng.IScope, $location: ng.ILocationService, $anchorScroll: ng.IAnchorScrollService, $timeout: ng.ITimeoutService, modalService: MyWay.UI.IModalService, contexteGgoStockageService: Services.ContexteGgoStockageService, constantes: GestionGeneriqueOffres.Constantes.Definitions, catalogueService: Services.ICatalogueService, erreurService: Services.ErreurService, signatairesService: Services.SignatairesService, tiersService: Services.ITiersService, commentaireService: Services.CommentaireService, gestionDossierVenteService: Services.IGestionDossierVenteService, referenceProduitPrincipalOffre: Types.ReferenceProduitPrincipalOffre);
        numeroDeCompte: string;
    }
}
...
declare module GestionGeneriqueOffres.Types {
    ...
    class Action {
         ...
         */
        enCours: boolean;
        private _toujoursPresent;
        /**
         * Les boutons "toujoursPresent" ne sont pas effacés lorsque la barre d'action est initialisée depuis le dossier de vente.
         * Ils peuvent par contre être individuellement supprimés via supprimerAction
         */
        toujoursPresent: boolean;
        private _rang;
        /**
         * Rang d'affichage du bouton.
         * Les rangs négatifs sont affichés à gauche du plus grand vers le plus petit (en allant vers le centre)
         * Les rangs positifs sont affichés à droite du plus petit au plus grand (en allant vers l'extérieur)
         * Pas de rang à 0 (rien ne sera affiché !)
         * Si il y a trop de boutons pour l'espace disponible, il se passera n'importe quoi.
         *
         * |                                                                                   |
         * | [..-3..] [..-2..] [..-1..]                        [..1..] [..2..] [..3..] [..4..] |
         * |                                                                                   |
        ...
        private _data;
        /**
         * Des données banalisées associées au bouton. En l'occurence, pour le dossier de vente, le code action fonctionnelle.
         */
        data: any;
