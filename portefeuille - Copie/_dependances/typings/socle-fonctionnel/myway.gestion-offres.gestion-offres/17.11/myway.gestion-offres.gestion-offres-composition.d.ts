...
declare module GestionGeneriqueOffres.Services {
    ...
    class SauvegardeDossierVenteService implements ISauvegardeDossierVenteService {
         ...
         */
        sauvegarder: () => void;
        constructor($rootScope: ng.IRootScopeService, $q: ng.IQService, constantes: GestionGeneriqueOffres.Constantes.Definitions, compositionOffreService: Services.CompositionOffreService, erreurService: Services.ErreurService, gestionDossierVenteService: Services.IGestionDossierVenteService, contexteGgoStockageService: Services.IContexteGgoStockageService);
    }
}
...
declare module GestionGeneriqueOffres.Services {
    interface IRechargeDossierDeVenteService {
         ...
         */
        getDossierDeVente(produit: Types.CompositionOffreProduit, idBloc: string): Types.DossierDeVente.IDonneesGeneriques[];
    }
