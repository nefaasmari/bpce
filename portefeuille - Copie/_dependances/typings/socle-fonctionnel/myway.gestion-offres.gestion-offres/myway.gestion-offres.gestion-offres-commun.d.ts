...
declare module GestionGeneriqueOffres.Types {
    ...
    class RetourDonneesMetier {
         ...
         */
        donnees: Types.DossierDeVente.DonneesGeneriques;
        constructor(erreur: ErreurGestionGeneriqueOffre, modeFinancier: string, donnees: Types.DossierDeVente.DonneesGeneriques);
    }
    /**
...
declare module GestionGeneriqueOffres.Types.DossierDeVente {
    ...
    class ActeurContexte {
        ...
        referenceExterneAgentContexte: number;
        constructor(ac: IActeurContexte);
    }
    ...
    class DonneePrincipale {
        ...
        numeroEntiteTitulairePrincipale: number;
        constructor(dp: IDonneePrincipale);
    }
    class DossierVente {
        private _codeEtablissement;
        codeEtablissement: string;
    ...
    class GestionDossierVente {
        ...
        constructor(gdv: IGestionDossierVente);
    }
    class Partenaire {
