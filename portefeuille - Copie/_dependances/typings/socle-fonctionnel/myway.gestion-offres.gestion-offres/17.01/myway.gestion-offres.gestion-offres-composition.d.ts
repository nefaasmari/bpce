...
declare module GestionGeneriqueOffres.Composition {
    ...
    class TarificationModaleControleur {
        ...
        suppressionPromoPutRequest(promotion: any): ng.IPromise<Types.ITarificationOffrePromotion>;
...
declare module GestionGeneriqueOffres.Services {
    ...
    class TarificationOffreService implements ITarificationOffreService {
        ...
        /**
         * Vérification si le PS est dans le panier
         *
         * @param {number} _identifiantProduitService
         * @return {boolean}
         */
        verifierPresencePS(_identifiantProduitService: number): boolean;
        /**
