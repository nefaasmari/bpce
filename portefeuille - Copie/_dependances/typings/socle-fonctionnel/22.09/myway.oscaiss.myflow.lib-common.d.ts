...
declare module myflow.libcommon {
    ...
    const HABILITATION: {
        ...
        GESTION_FILTRES: number;
        GESTION_INDICATEURS: number;
    };
    enum StackChart {
        width = 720,
        height = 275,
...
declare module myflow.libcommon {
    ...
    type ActionTachesMyflow = typeof ACTION_TRANSFERT;
    /**
     * type pour les messages d'informations sur les taches transférées depuis myflow 1.
     */
