...
declare module myway.transProduitEngage {
    ...
    class ProduitEngageController {
        ...
        produitEngageFormulaireInitiale: ProduitEngageFormulaire;
        infoPartageTracab: IInfoPartageTracab;
        chargementEncours: boolean;
        static $inject: string[];
        constructor($scope: ng.IScope, $parse: ng.IParseService, serviceAgentExtended: MyWay.Services.ServiceAgentExtended, produitEngageService: ProduitEngageService);
        private initParamPartageTracab();
        ...
        private initIhmEnModeRecap();
        private isModeRechargementDvRecapOuvertureOffre();
    }
}
...
declare module myway.transProduitEngage {
    class ProduitEngageFormulaire {
        ...
        private estModifieTauxPartage();
        private estModifieOrganismeBeneficiaire();
        private estModifieDomaineTracabilite();
        infoPartageTracab: IInfoPartageTracab;
        donneesRestPartageTracab: DonneesPartageTracab;
        setFormulaireProduitEngage(infoPartageTracab: IInfoPartageTracab): void;
        private getElementPartageOuTracabList(typeRecherche, liste, infoPartageTracab);
    ...
    class DonneesPartageTracab {
        ...
        infoPartageTracab: InfoPartageTracab;
    }
}
...
declare module myway.transProduitEngage {
    ...
    class InfoPartageTracab implements IInfoPartageTracab {
        codeEtablissement: string;
        codeGuichet: string;
        numeroCompte: string;
        indicateurPartage: string;
        ...
        libelleTracab: string;
        libellePartage: string;
        constructor(infoPartTracab: InfoPartageTracab);
    }
}
