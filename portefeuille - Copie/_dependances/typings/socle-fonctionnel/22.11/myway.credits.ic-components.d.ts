...
declare namespace ICCreditComponents.Navigation {
    class TotemCreditService {
        ...
        static $inject: string[];
        constructor($timeout: ng.ITimeoutService, labelService: Services.IlabelService, etatDossierService: ICBusiness.Services.Dossier.IEtatDossierService, controleSyntheseService: Controle.IControleSyntheseService, paramApplicatifRemanentService: ICBusiness.Services.ParametrageApplicatif.IParametrageAppicatifRemanentService, loggerService: ICCommon.Logger.FullLoggerService, preferenceService: ICBusiness.Services.Preferences.IPreferencesService, suiviEditionsService: ICBusiness.Services.SuiviEditions.ISuiviEditionsService, habilitationService: ICBusiness.Services.Habilitation.IHabilitationService, queryMultiCallService: ICCommon.Services.IRetryRequestService);
        /**
         * Mise en place des dépendances
         * @param navigationService
         * @param context
