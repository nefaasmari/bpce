...
declare module Avenants.Commun.Tools {
    class Object {
        ...
        /**
         * Valide si la chaine n'est pas vide et contient des caractères (pas que des espaces)
         */
...
declare module Avenants.Commun.ToolsFunctionals {
    class DateEffet {
         ...
         * @param dateEcheancePrev
         * @param periodicite
         * @param isNextDate: true: date dans le futur ; false: date dans le passé
         */
        static getDateEffetTestable(dateEcheancePrev: Date, periodicite: string, isNextDate: boolean): Date;
        /**
...
declare module Avenants.Commun.ToolsFunctionals {
    ...
    class PeriodiciteHelper {
        ...
        static listePeriode(codes: Array<string>): Array<IPeriode>;
        static getPeriode(code: string): IPeriode;
    }
}
