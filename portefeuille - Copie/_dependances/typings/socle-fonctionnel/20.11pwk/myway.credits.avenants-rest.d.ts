...
declare module Avenants.Rest.Services {
    ...
    class RestService implements IRestService {
        ...
        private getDatat<T, U, V>(typeMethode, urlService, params?, data?, timeout?);
        /**
...
declare module Avenants.Rest.Constantes {
    module MockAno {
        const rechercheService: Modeles.DossierCreditAvenant.Recherche.IRecherche;
        const caracteristiqueService: Modeles.DossierCreditGestion.CaracteristiqueCredit.IListeCredits;
        const infoCreditService: Modeles.DossierCreditGestion.InformationCredit.IInformationCredit;
        const produitCreditService: Modeles.AvenantCreditParam.Produit.IProduit;
        const caraFinanRechercheService: Modeles.DossierCreditAvenant.CaracteristiqueFinan.ICaracteristiqueFinan;
        const palierCreditService: Modeles.DossierCreditGestion.PalierCredit.IPalierCredit;
        const habilitationGlobalService: Array<Modeles.DossierCreditGestion.HabilitationCredit.IHabilitation>;
        const eligibiliteProduit: Modeles.AvenantCreditService.EligibiliteChangePdt.IEligibiliteChangePdt;
        const produitCreditChangePdt: Modeles.AvenantCreditParam.Produit.IProduit;
        const informationObjetService: Modeles.DossierCreditAvenant.InformationObjet.IInformationObjet;
        const justificatifCredit: Modeles.DossierCreditGestion.CaracteristiqueCredit.IDonneeCredit;
        const putAjustementEcheances: Modeles.AvenantCreditService.AjustementEcheances.IAjustementEcheances;
    }
}
