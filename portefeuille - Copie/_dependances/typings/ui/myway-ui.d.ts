...
declare module MyWay.UI {
    interface IMwScrollEditionService {
        getScroll(): any;
        /**
         * Calcule la distance (en px) entre le bas de l'élément en paramètre jusqu'au bas de l'élément main, return 0 par défaut
         */
        setScroll(scroll: boolean): any;
    }
}

declare module MyWay.UI {
    interface IMwTuilePanelEditionService {
        getModeEdition(): any;
        getModeEditionTuile(tuile: any): any;
        /**
         * Calcule la distance (en px) entre le bas de l'élément en paramètre jusqu'au bas de l'élément main, return 0 par défaut
         */
        setModeEdition(modeEdition: any): any;
    }
}
...
declare module MyWay.UI {
    ...
    class NavigationService implements INavigationService {
        ...
        constructor($rootScope: ng.IRootScopeService, totemEvent: IMwEvents, $timeout: ng.ITimeoutService, $location: ng.ILocationService, $document: ng.IDocumentService, mwSmoothScroll: MyWay.UI.IMwSmoothScrollService, anchorScroll: ng.IAnchorScrollService);
        init(navigation: Array<TotemComponent>, origine?: string, scroll?: boolean): void;
        /**
         * Return la proprieté _navigation. PErme td esavoir si la page contient le composant
         */
        getNavigationArray(): Array<TotemComponent>;
...
declare module MyWay.UI {
    ...
    class MwPanelEditionController {
        private $scope;
        private mwTuilePanelEditionService;
        isModeEdition: boolean;
        texteBouton: string;
        static $inject: string[];
        constructor($scope: IMwPanelEditionControllerScope, mwTuilePanelEditionService: IMwTuilePanelEditionService);
        toggleMode(): void;
    }
}
...
declare module MyWay.UI {
    ...
    interface ImwTableOptions {
        ...
        disabledItemsCheckbox?: Array<Object>;
...
declare module MyWay.UI {
    ...
    class MwAbstractTuileController {
        ...
        protected mwTuilePanelEditionService: IMwTuilePanelEditionService;
        id: string;
        modeEdition: boolean;
        tabIndex: number;
        config: iMwConfigTuile;
        service: IMwTuilePanelEditionService;
        constructor($scope: IMwTuileControllerScope, $exceptionHandler: ng.IExceptionHandlerService, mwTuilePanelEditionService: IMwTuilePanelEditionService, $document: ng.IAugmentedJQuery);
        setEditionOn(): void;
        setEditionOff(): void;
        ...
        lineAfter(ligne: string): boolean;
    }
...
declare module MyWay.UI {
    ...
    class NavigationCtrl {
        ...
        constructor($scope: IScopeNavigation, navigationService: NavigationService, $element: ng.IAugmentedJQuery, $rootScope: ng.IRootScopeService);
    ...
    class NavigationSectionCtrl {
        ...
        private _NavigationService;
        private sideBarPosition;
        constructor($scope: ng.IScope, navigationService: NavigationService, $element: ng.IAugmentedJQuery, $location: ng.ILocationService, $anchorScroll: ng.IAnchorScrollService, $timeout: ng.ITimeoutService);
        /**
         * Appeler lorsque l'utilisateur clic sur un lien de la navigation.
         */
        setActiveSection(page: TotemPage, section: TotemSection, scroll: boolean): void;
        goToAnchor(section: TotemSection): void;
        isSectionActive(section: TotemSection): boolean;
    }
